...
public static final int
    ...
    /** Minimum depth in current depth units that will be output. Any values less than Â‘Min DepthÂ’ will be mapped to 0 during the conversion between disparity and depth. Set before streaming*/
    RS_OPTION_R200_DEPTH_CLAMP_MIN = 33,
    /** Maximum depth in current depth units that will be output. Any values greater than Â‘Max DepthÂ’ will be mapped to 0 during the conversion between disparity and depth. Set before streaming*/
