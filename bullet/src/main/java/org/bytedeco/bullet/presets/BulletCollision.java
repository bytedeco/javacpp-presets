...
public class BulletCollision implements InfoMapper {
    ...
    public void map(InfoMap infoMap) {
        infoMap
            ...
            .put(new Info("btAlignedObjectArray<GIM_BVH_DATA>").pointerTypes("GIM_BVH_DATA_Array"))
            .put(new Info("btAlignedObjectArray<GIM_BVH_TREE_NODE>").pointerTypes("GIM_BVH_TREE_NODE_Array"))
            .put(new Info("btAlignedObjectArray<GIM_CONTACT>").pointerTypes("GIM_CONTACT_Array"))
            .put(new Info("btAlignedObjectArray<GIM_PAIR>").pointerTypes("GIM_PAIR_Array"))
