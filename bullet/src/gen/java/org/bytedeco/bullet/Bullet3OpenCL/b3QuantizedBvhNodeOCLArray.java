...
public class b3QuantizedBvhNodeOCLArray extends Pointer {
	...
	public b3QuantizedBvhNodeOCLArray(@ByVal cl_context ctx, @ByVal cl_command_queue queue, @Cast("size_t") long initialCapacity/*=0*/, @Cast("bool") boolean allowGrowingCapacity/*=true*/) { super((Pointer)null); allocate(ctx, queue, initialCapacity, allowGrowingCapacity); }
	...
	public b3QuantizedBvhNodeOCLArray(@ByVal cl_context ctx, @ByVal cl_command_queue queue) { super((Pointer)null); allocate(ctx, queue); }
