...
@Name("b3OpenCLArray<b3GpuChildShape>") @NoOffset @Properties(inherit = org.bytedeco.bullet.presets.Bullet3OpenCL.class)
public class b3GpuChildShapeOCLArray extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public b3GpuChildShapeOCLArray(Pointer p) { super(p); }

	public b3GpuChildShapeOCLArray(@ByVal cl_context ctx, @ByVal cl_command_queue queue, @Cast("size_t") long initialCapacity/*=0*/, @Cast("bool") boolean allowGrowingCapacity/*=true*/) { super((Pointer)null); allocate(ctx, queue, initialCapacity, allowGrowingCapacity); }
	...
	public b3GpuChildShapeOCLArray(@ByVal cl_context ctx, @ByVal cl_command_queue queue) { super((Pointer)null); allocate(ctx, queue); }
