...
public class btAlignedObjectArray_bool extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public btAlignedObjectArray_bool(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public btAlignedObjectArray_bool(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public btAlignedObjectArray_bool position(long position) {
        return (btAlignedObjectArray_bool)super.position(position);
    }
    @Override public btAlignedObjectArray_bool getPointer(long i) {
        return new btAlignedObjectArray_bool((Pointer)this).offsetAddress(i);
    }

	public native @ByRef @Name("operator =") btAlignedObjectArray_bool put(@Const @ByRef btAlignedObjectArray_bool other);
	public btAlignedObjectArray_bool() { super((Pointer)null); allocate(); }
	private native void allocate();

	/**Generally it is best to avoid using the copy constructor of an btAlignedObjectArray, and use a (const) reference to the array instead. */
	public btAlignedObjectArray_bool(@Const @ByRef btAlignedObjectArray_bool otherArray) { super((Pointer)null); allocate(otherArray); }
	private native void allocate(@Const @ByRef btAlignedObjectArray_bool otherArray);
	...
	public native void copyFromArray(@Const @ByRef btAlignedObjectArray_bool otherArray);
}
