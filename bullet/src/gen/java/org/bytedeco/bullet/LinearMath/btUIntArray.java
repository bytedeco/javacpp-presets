...
@Name("btAlignedObjectArray<unsigned int>") @NoOffset @Properties(inherit = org.bytedeco.bullet.presets.LinearMath.class)
public class btUIntArray extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public btUIntArray(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public btUIntArray(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public btUIntArray position(long position) {
        return (btUIntArray)super.position(position);
    }
    @Override public btUIntArray getPointer(long i) {
        return new btUIntArray((Pointer)this).offsetAddress(i);
    }

	public native @ByRef @Name("operator =") btUIntArray put(@Const @ByRef btUIntArray other);
	public btUIntArray() { super((Pointer)null); allocate(); }
	private native void allocate();

	/**Generally it is best to avoid using the copy constructor of an btAlignedObjectArray, and use a (const) reference to the array instead. */
	public btUIntArray(@Const @ByRef btUIntArray otherArray) { super((Pointer)null); allocate(otherArray); }
	private native void allocate(@Const @ByRef btUIntArray otherArray);
	...
	public native void copyFromArray(@Const @ByRef btUIntArray otherArray);
}
