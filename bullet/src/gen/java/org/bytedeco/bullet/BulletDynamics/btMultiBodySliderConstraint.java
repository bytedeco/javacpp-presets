...
public class btMultiBodySliderConstraint extends btMultiBodyConstraint {
    ...
    public btMultiBodySliderConstraint(Pointer p) { super(p); }

	public btMultiBodySliderConstraint(btMultiBody body, int link, btRigidBody bodyB, @Const @ByRef btVector3 pivotInA, @Const @ByRef btVector3 pivotInB, @Const @ByRef btMatrix3x3 frameInA, @Const @ByRef btMatrix3x3 frameInB, @Const @ByRef btVector3 jointAxis) { super((Pointer)null); allocate(body, link, bodyB, pivotInA, pivotInB, frameInA, frameInB, jointAxis); }
	private native void allocate(btMultiBody body, int link, btRigidBody bodyB, @Const @ByRef btVector3 pivotInA, @Const @ByRef btVector3 pivotInB, @Const @ByRef btMatrix3x3 frameInA, @Const @ByRef btMatrix3x3 frameInB, @Const @ByRef btVector3 jointAxis);
	public btMultiBodySliderConstraint(btMultiBody bodyA, int linkA, btMultiBody bodyB, int linkB, @Const @ByRef btVector3 pivotInA, @Const @ByRef btVector3 pivotInB, @Const @ByRef btMatrix3x3 frameInA, @Const @ByRef btMatrix3x3 frameInB, @Const @ByRef btVector3 jointAxis) { super((Pointer)null); allocate(bodyA, linkA, bodyB, linkB, pivotInA, pivotInB, frameInA, frameInB, jointAxis); }
	private native void allocate(btMultiBody bodyA, int linkA, btMultiBody bodyB, int linkB, @Const @ByRef btVector3 pivotInA, @Const @ByRef btVector3 pivotInB, @Const @ByRef btMatrix3x3 frameInA, @Const @ByRef btMatrix3x3 frameInB, @Const @ByRef btVector3 jointAxis);
	...
	public native @Const @ByRef btVector3 getJointAxis();

	public native void setJointAxis(@Const @ByRef btVector3 jointAxis);
