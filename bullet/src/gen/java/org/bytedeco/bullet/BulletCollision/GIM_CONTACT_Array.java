...
public class GIM_CONTACT_Array extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public GIM_CONTACT_Array(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public GIM_CONTACT_Array(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public GIM_CONTACT_Array position(long position) {
        return (GIM_CONTACT_Array)super.position(position);
    }
    @Override public GIM_CONTACT_Array getPointer(long i) {
        return new GIM_CONTACT_Array((Pointer)this).offsetAddress(i);
    }

	public native @ByRef @Name("operator =") GIM_CONTACT_Array put(@Const @ByRef GIM_CONTACT_Array other);
	public GIM_CONTACT_Array() { super((Pointer)null); allocate(); }
	private native void allocate();

	/**Generally it is best to avoid using the copy constructor of an btAlignedObjectArray, and use a (const) reference to the array instead. */
	public GIM_CONTACT_Array(@Const @ByRef GIM_CONTACT_Array otherArray) { super((Pointer)null); allocate(otherArray); }
	private native void allocate(@Const @ByRef GIM_CONTACT_Array otherArray);
	...
	public native void copyFromArray(@Const @ByRef GIM_CONTACT_Array otherArray);
}
