...
public class btBox2dBox2dCollisionAlgorithm extends btActivatingCollisionAlgorithm {
    ...
    public btBox2dBox2dCollisionAlgorithm(Pointer p) { super(p); }

	public btBox2dBox2dCollisionAlgorithm(@Const @ByRef btCollisionAlgorithmConstructionInfo ci) { super((Pointer)null); allocate(ci); }
	...
	public btBox2dBox2dCollisionAlgorithm(btPersistentManifold mf, @Const @ByRef btCollisionAlgorithmConstructionInfo ci, @Const btCollisionObjectWrapper body0Wrap, @Const btCollisionObjectWrapper body1Wrap) { super((Pointer)null); allocate(mf, ci, body0Wrap, body1Wrap); }
