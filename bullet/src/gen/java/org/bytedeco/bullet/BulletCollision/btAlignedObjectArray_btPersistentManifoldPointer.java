...
public class btAlignedObjectArray_btPersistentManifoldPointer extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public btAlignedObjectArray_btPersistentManifoldPointer(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public btAlignedObjectArray_btPersistentManifoldPointer(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public btAlignedObjectArray_btPersistentManifoldPointer position(long position) {
        return (btAlignedObjectArray_btPersistentManifoldPointer)super.position(position);
    }
    @Override public btAlignedObjectArray_btPersistentManifoldPointer getPointer(long i) {
        return new btAlignedObjectArray_btPersistentManifoldPointer((Pointer)this).offsetAddress(i);
    }

	public native @ByRef @Name("operator =") btAlignedObjectArray_btPersistentManifoldPointer put(@Const @ByRef btAlignedObjectArray_btPersistentManifoldPointer other);
	public btAlignedObjectArray_btPersistentManifoldPointer() { super((Pointer)null); allocate(); }
	private native void allocate();

	/**Generally it is best to avoid using the copy constructor of an btAlignedObjectArray, and use a (const) reference to the array instead. */
	public btAlignedObjectArray_btPersistentManifoldPointer(@Const @ByRef btAlignedObjectArray_btPersistentManifoldPointer otherArray) { super((Pointer)null); allocate(otherArray); }
	private native void allocate(@Const @ByRef btAlignedObjectArray_btPersistentManifoldPointer otherArray);
	...
	public native void copyFromArray(@Const @ByRef btAlignedObjectArray_btPersistentManifoldPointer otherArray);
}
