...
public class btCompoundCollisionAlgorithm extends btActivatingCollisionAlgorithm {
    ...
    public btCompoundCollisionAlgorithm(Pointer p) { super(p); }

	public btCompoundCollisionAlgorithm(@Const @ByRef btCollisionAlgorithmConstructionInfo ci, @Const btCollisionObjectWrapper body0Wrap, @Const btCollisionObjectWrapper body1Wrap, @Cast("bool") boolean isSwapped) { super((Pointer)null); allocate(ci, body0Wrap, body1Wrap, isSwapped); }
	...
	public native btCollisionAlgorithm getChildAlgorithm(int n);
