...
public class btQuantizedBvh extends Pointer {
	...
	public native @Cast("QuantizedNodeArray*") @ByRef btAlignedObjectArray_btQuantizedBvhNode getLeafNodeArray();
	...
	public native @Cast("QuantizedNodeArray*") @ByRef btAlignedObjectArray_btQuantizedBvhNode getQuantizedNodeArray();

	public native @Cast("BvhSubtreeInfoArray*") @ByRef btAlignedObjectArray_btBvhSubtreeInfo getSubtreeInfoArray();
