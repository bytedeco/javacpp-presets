...
public class btSphereTriangleCollisionAlgorithm extends btActivatingCollisionAlgorithm {
    ...
    public btSphereTriangleCollisionAlgorithm(Pointer p) { super(p); }

	public btSphereTriangleCollisionAlgorithm(btPersistentManifold mf, @Const @ByRef btCollisionAlgorithmConstructionInfo ci, @Const btCollisionObjectWrapper body0Wrap, @Const btCollisionObjectWrapper body1Wrap, @Cast("bool") boolean swapped) { super((Pointer)null); allocate(mf, ci, body0Wrap, body1Wrap, swapped); }
	private native void allocate(btPersistentManifold mf, @Const @ByRef btCollisionAlgorithmConstructionInfo ci, @Const btCollisionObjectWrapper body0Wrap, @Const btCollisionObjectWrapper body1Wrap, @Cast("bool") boolean swapped);

	public btSphereTriangleCollisionAlgorithm(@Const @ByRef btCollisionAlgorithmConstructionInfo ci) { super((Pointer)null); allocate(ci); }
