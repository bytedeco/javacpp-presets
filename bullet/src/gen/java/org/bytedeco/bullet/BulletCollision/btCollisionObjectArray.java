...
public class btCollisionObjectArray extends Pointer {
    ...
    public btCollisionObjectArray(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public btCollisionObjectArray(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public btCollisionObjectArray position(long position) {
        return (btCollisionObjectArray)super.position(position);
    }
    @Override public btCollisionObjectArray getPointer(long i) {
        return new btCollisionObjectArray((Pointer)this).offsetAddress(i);
    }

	public native @ByRef @Name("operator =") btCollisionObjectArray put(@Const @ByRef btCollisionObjectArray other);
	public btCollisionObjectArray() { super((Pointer)null); allocate(); }
	private native void allocate();

	/**Generally it is best to avoid using the copy constructor of an btAlignedObjectArray, and use a (const) reference to the array instead. */
	public btCollisionObjectArray(@Const @ByRef btCollisionObjectArray otherArray) { super((Pointer)null); allocate(otherArray); }
	private native void allocate(@Const @ByRef btCollisionObjectArray otherArray);
	...
	public native void copyFromArray(@Const @ByRef btCollisionObjectArray otherArray);
}
