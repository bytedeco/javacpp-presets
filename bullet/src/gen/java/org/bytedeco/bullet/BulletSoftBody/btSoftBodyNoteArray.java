...
public class btSoftBodyNoteArray extends Pointer {
    ...
    public btSoftBodyNoteArray(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public btSoftBodyNoteArray(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public btSoftBodyNoteArray position(long position) {
        return (btSoftBodyNoteArray)super.position(position);
    }
    @Override public btSoftBodyNoteArray getPointer(long i) {
        return new btSoftBodyNoteArray((Pointer)this).offsetAddress(i);
    }

	public native @ByRef @Name("operator =") btSoftBodyNoteArray put(@Const @ByRef btSoftBodyNoteArray other);
	public btSoftBodyNoteArray() { super((Pointer)null); allocate(); }
	private native void allocate();

	/**Generally it is best to avoid using the copy constructor of an btAlignedObjectArray, and use a (const) reference to the array instead. */
	public btSoftBodyNoteArray(@Const @ByRef btSoftBodyNoteArray otherArray) { super((Pointer)null); allocate(otherArray); }
	private native void allocate(@Const @ByRef btSoftBodyNoteArray otherArray);
	...
	public native void copyFromArray(@Const @ByRef btSoftBodyNoteArray otherArray);
}
