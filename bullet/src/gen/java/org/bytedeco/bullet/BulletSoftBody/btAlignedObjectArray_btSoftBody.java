...
public class btAlignedObjectArray_btSoftBody extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public btAlignedObjectArray_btSoftBody(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public btAlignedObjectArray_btSoftBody(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public btAlignedObjectArray_btSoftBody position(long position) {
        return (btAlignedObjectArray_btSoftBody)super.position(position);
    }
    @Override public btAlignedObjectArray_btSoftBody getPointer(long i) {
        return new btAlignedObjectArray_btSoftBody((Pointer)this).offsetAddress(i);
    }

	public native @ByRef @Name("operator =") btAlignedObjectArray_btSoftBody put(@Const @ByRef btAlignedObjectArray_btSoftBody other);
	public btAlignedObjectArray_btSoftBody() { super((Pointer)null); allocate(); }
	private native void allocate();

	/**Generally it is best to avoid using the copy constructor of an btAlignedObjectArray, and use a (const) reference to the array instead. */
	public btAlignedObjectArray_btSoftBody(@Const @ByRef btAlignedObjectArray_btSoftBody otherArray) { super((Pointer)null); allocate(otherArray); }
	private native void allocate(@Const @ByRef btAlignedObjectArray_btSoftBody otherArray);
	...
	public native void copyFromArray(@Const @ByRef btAlignedObjectArray_btSoftBody otherArray);
}
