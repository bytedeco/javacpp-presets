...
public class btSoftBodyConcaveCollisionAlgorithm extends btCollisionAlgorithm {
    ...
    public btSoftBodyConcaveCollisionAlgorithm(Pointer p) { super(p); }

	public btSoftBodyConcaveCollisionAlgorithm(@Const @ByRef btCollisionAlgorithmConstructionInfo ci, @Const btCollisionObjectWrapper body0Wrap, @Const btCollisionObjectWrapper body1Wrap, @Cast("bool") boolean isSwapped) { super((Pointer)null); allocate(ci, body0Wrap, body1Wrap, isSwapped); }
