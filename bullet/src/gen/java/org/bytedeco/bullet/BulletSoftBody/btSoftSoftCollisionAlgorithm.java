...
public class btSoftSoftCollisionAlgorithm extends btCollisionAlgorithm {
    ...
    public btSoftSoftCollisionAlgorithm(Pointer p) { super(p); }

	public btSoftSoftCollisionAlgorithm(@Const @ByRef btCollisionAlgorithmConstructionInfo ci) { super((Pointer)null); allocate(ci); }
	...
	public btSoftSoftCollisionAlgorithm(btPersistentManifold mf, @Const @ByRef btCollisionAlgorithmConstructionInfo ci, @Const btCollisionObjectWrapper body0Wrap, @Const btCollisionObjectWrapper body1Wrap) { super((Pointer)null); allocate(mf, ci, body0Wrap, body1Wrap); }
