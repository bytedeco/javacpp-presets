...
@Name("b3AlignedObjectArray<float>") @NoOffset @Properties(inherit = org.bytedeco.bullet.presets.Bullet3Common.class)
public class b3FloatArray extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public b3FloatArray(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public b3FloatArray(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public b3FloatArray position(long position) {
        return (b3FloatArray)super.position(position);
    }
    @Override public b3FloatArray getPointer(long i) {
        return new b3FloatArray((Pointer)this).offsetAddress(i);
    }

	public native @ByRef @Name("operator =") b3FloatArray put(@Const @ByRef b3FloatArray other);
	public b3FloatArray() { super((Pointer)null); allocate(); }
	private native void allocate();

	/**Generally it is best to avoid using the copy constructor of an b3AlignedObjectArray, and use a (const) reference to the array instead. */
	public b3FloatArray(@Const @ByRef b3FloatArray otherArray) { super((Pointer)null); allocate(otherArray); }
	private native void allocate(@Const @ByRef b3FloatArray otherArray);
	...
	public native void copyFromArray(@Const @ByRef b3FloatArray otherArray);
