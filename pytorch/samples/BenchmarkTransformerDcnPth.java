 ...
 *
 *   # then benchmark:
 *   java ... samples.BenchmarkTransformerDcnPth \
 ...
 *   java ... samples.BenchmarkTransformerDcnPth --train-if-missing
 * </pre>
 */
public class BenchmarkTransformerDcnPth {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (!Files.isRegularFile(pth)) {
            ...
            System.out.println("  or: java ... samples.BenchmarkTransformerDcnPth --train-if-missing");
