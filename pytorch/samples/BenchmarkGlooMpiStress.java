 ...
 *   <li>True multi-rank: {@code mpirun -n 2 java ... samples.BenchmarkGlooMpiStress --mpi-worker}</li>
 * </ul>
 *
 * <p>Launch modes:
 * <pre>
 *   # single JVM: Gloo stress + MPI world=1 probe/collectives/threads
 *   java ... samples.BenchmarkGlooMpiStress
 *
 ...
 *   mpirun -n 2 java ... samples.BenchmarkGlooMpiStress --mpi-worker
 * </pre>
 */
