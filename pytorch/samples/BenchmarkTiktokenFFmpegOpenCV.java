 ...
 *      samples.BenchmarkTiktokenFFmpegOpenCV
 * }</pre>
 */
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (!ffmpegAvailable) {
            ...
            section("FFmpeg video metadata", () -> {
                var vf = org.bytedeco.pytorch.utils.ffmpeg.FFmpegLoader.openVideo(testVideo.toString());
                try {
            ...
            section("FFmpeg video decode", () -> {
                try (var vf = org.bytedeco.pytorch.utils.ffmpeg.FFmpegLoader.openVideo(testVideo.toString())) {
            ...
            section("FFmpeg audio metadata", () -> {
                var af = org.bytedeco.pytorch.utils.ffmpeg.FFmpegLoader.openAudio(testAudio.toString());
                try {
            ...
            section("FFmpeg audio decode", () -> {
                try (var af = org.bytedeco.pytorch.utils.ffmpeg.FFmpegLoader.openAudio(testAudio.toString())) {
                    Tensor wave = af.read();
        ...
        if (!opencvAvailable) {
            ...
            section("OpenCV MatToTensor roundtrip", () -> {
                ...
                org.bytedeco.pytorch.utils.opencv.MatToTensor.toMat(
                        org.bytedeco.pytorch.utils.opencv.MatToTensor.fromMat(mat));
