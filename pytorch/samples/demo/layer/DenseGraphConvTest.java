...
//        torch.cuda.empty_cache(); // 兼容GPU场景
    ...
    public static void main(String[] args) {
        Result result = JUnitCore.runClasses(DenseGraphConvTest.class);
        ...
        if (!result.wasSuccessful()) {
            throw new RuntimeException("DenseGraphConvTest had " + result.getFailureCount() + " failures");
        }
        System.out.println("✅ DenseGraphConvTest all tests passed");
    }
