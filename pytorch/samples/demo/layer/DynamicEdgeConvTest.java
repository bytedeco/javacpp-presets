...
//        torch.cuda.empty_cache();
    ...
    public static void main(String[] args) {
        Result result = JUnitCore.runClasses(DynamicEdgeConvTest.class);
        ...
        if (!result.wasSuccessful()) {
            throw new RuntimeException("DynamicEdgeConvTest had " + result.getFailureCount() + " failures");
        }
        System.out.println("✅ DynamicEdgeConvTest all tests passed");
    }
