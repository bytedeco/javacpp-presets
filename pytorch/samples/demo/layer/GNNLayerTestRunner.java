...
public class GNNLayerTestRunner {
    ...
    private static void run(String name, Runnable test) {
        try {
            ...
            failed++;
            System.err.println("❌ [" + name + "] " + t.getClass().getSimpleName() + ": " + t.getMessage());
    ...
    public static void main(String[] args) {
        ...
        run("testAntiSymmetric", () -> testAntiSymmetric());
        run("testARMA", () -> testARMA());
        run("testAGNN", () -> testAGNN());
        run("testAPPNP", () -> testAPPNP());
        
        run("testClusterGCN", () -> testClusterGCN());
        run("testCuGraphRGCN", () -> testCuGraphRGCN());
        run("testCuGraphSAGE", () -> testCuGraphSAGE());
        run("testCuGraphGAT", () -> testCuGraphGAT());
        run("testCG", () -> testCG());
        run("testCheb", () -> testCheb());

        run("testDirGNN", () -> testDirGNN());
        run("testDNA", () -> testDNA());
        run("testDynamicEdge", () -> testDynamicEdge());
        
        run("testEG", () -> testEG());
        run("testFA", () -> testFA());
        run("testFiLM", () -> testFiLM());
        run("testFastRGCN", () -> testFastRGCN());
        run("testFeaSt", () -> testFeaSt());
        run("testFusedGAT", () -> testFusedGAT());
        
        run("testGPS", () -> testGPS());
        run("testGINE", () -> testGINE());
        run("testGEN", () -> testGEN());
        run("testGMM", () -> testGMM());
        run("testGCN2", () -> testGCN2());
        run("testGravNet", () -> testGravNet());
        run("testGatedGraph", () -> testGatedGraph());
        run("testGraphConv", () -> testGraphConv());
//        testGraph();
        run("testGeneral", () -> testGeneral());
        run("testGATv2", () -> testGATv2());
        
        run("testHEAT", () -> testHEAT());
        run("testHAN", () -> testHAN());
        run("testHypergraph", () -> testHypergraph());
        run("testHetero", () -> testHetero());
        run("testHGT", () -> testHGT());
        
        run("testLG", () -> testLG());
        run("testLE", () -> testLE());
        run("testMF", () -> testMF());
        run("testMixHop", () -> testMixHop());
        run("testNNConv", () -> testNNConv());
        
        run("testResGated", () -> testResGated());
        run("testRGCN", () -> testRGCN());
        run("testRGAT", () -> testRGAT());
        
        run("testSG", () -> testSG());
        run("testSigned", () -> testSigned());
        run("testSimple", () -> testSimple());
        run("testSuperGAT", () -> testSuperGAT());
        run("testSSG2", () -> testSSG2());
        run("testSuperGAT2", () -> testSuperGAT2());
        run("testSpline", () -> testSpline());

        run("testPAN", () -> testPAN());
        run("testPDN", () -> testPDN());
        run("testPPF", () -> testPPF());
        run("testPointGNN", () -> testPointGNN());
        run("testPointNet", () -> testPointNet());
        run("testPointTransformer", () -> testPointTransformer());
        
        run("testTAG", () -> testTAG());
        run("testX", () -> testX());
        run("testWL", () -> testWL());
        run("testWLContinuous", () -> testWLContinuous());
        
  
        System.out.println("\n🎉 所有算子基础测试完成！");
        System.out.println("结果: passed=" + passed + " failed=" + failed);
        if (failed > 0) {
            throw new RuntimeException("GNNLayerTestRunner failures: " + failed);
        }
    }
