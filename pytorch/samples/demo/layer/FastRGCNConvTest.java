...
//        }
    ...
    public static void main(String[] args) {
        Result result = JUnitCore.runClasses(FastRGCNConvTest.class);
        ...
        if (!result.wasSuccessful()) {
            throw new RuntimeException("FastRGCNConvTest had " + result.getFailureCount() + " failures");
        }
        System.out.println("✅ FastRGCNConvTest all tests passed");
    }
