...
//        torch.clear_autograd_graph();
    ...
    public static void main(String[] args) {
        Result result = JUnitCore.runClasses(DenseGINConvTest.class);
        ...
        if (!result.wasSuccessful()) {
            throw new RuntimeException("DenseGINConvTest had " + result.getFailureCount() + " failures");
        }
        System.out.println("✅ DenseGINConvTest all tests passed");
    }
