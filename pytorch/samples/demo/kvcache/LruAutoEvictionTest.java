...
public class LruAutoEvictionTest {
    public static void main(String[] args) throws InterruptedException {
        ...
        CoWBlockManager manager = new CoWBlockManager(totalPhysicalBlocks, numLayers, blockSize, headDim, kFloat().value);
        ...
        for (int i = 0; i < totalRequests; i++) {
            ...
            executor.submit(() -> {
                try {
                    ...
                    PagedKvBuffer kv = new PagedKvBuffer(sid, manager,numLayers);
