...
//
//    // Local abstract base for V11 demo (not the library CoWBlockManagerV2)
//    abstract static class DemoCoWBlockManagerV2 {
//        protected int totalBlocks;
//        protected final java.util.Queue<Integer> freePool = new java.util.concurrent.ConcurrentLinkedQueue<>();
//        private final java.util.concurrent.locks.ReentrantLock globalLock = new java.util.concurrent.locks.ReentrantLock();
//        protected final java.util.concurrent.ConcurrentHashMap<String, Long> sessionLastActive = new java.util.concurrent.ConcurrentHashMap<>();
//
//        public DemoCoWBlockManagerV2(int totalBlocks, int layers, int blockSize, int headDim, int dtype) {
//            this.totalBlocks = totalBlocks;
//            for (int i = 0; i < totalBlocks; i++) freePool.add(i);
//        }
//        public int getFreeBlockCount() { return freePool.size(); }
//        public int getBlockSize() { return 256; }
//        public java.util.concurrent.locks.ReentrantLock getGlobalLock() { return globalLock; }
//        public void releaseSession(String sessionId) {}
//        boolean evictOldestSession(String excludeId) { return false; }
//        public abstract java.util.List<Integer> allocateBlocks(int neededBlocks, String sessionId, org.bytedeco.pytorch.llm.kvcache.PagedKvBufferV3 kvBuffer);
//    }
//
//    public static class CoWBlockManagerV9 extends DemoCoWBlockManagerV2 {
