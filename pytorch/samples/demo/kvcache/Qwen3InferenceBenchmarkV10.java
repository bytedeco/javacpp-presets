...
//        private final CoWBlockManager blockManager; // V9版本块管理器
//        private final ConcurrentHashMap<String, PagedKvBuffer> kvBufferMap; // PagedKV缓存
...
//
//            // 初始化V9块管理器（核心组件）
//            this.blockManager = new CoWBlockManager(TOTAL_BLOCKS, NUM_LAYERS, BLOCK_SIZE, HEAD_DIM, DTYPE);
//
//            // 初始化缓存映射
...
//            PagedKvBuffer kvBuffer = kvBufferMap.computeIfAbsent(sessionId,
//                    k -> new PagedKvBuffer(sessionId, blockManager, NUM_LAYERS));
...
//         */
//        private void prefillKVCache(Tensor input, PagedKvBuffer kvBuffer, CacheEntry cacheMeta) {
...
//         * 使用V9块管理器更新KV缓存
//         */
//        private void updateKVCacheWithV9Manager(Tensor token, PagedKvBuffer kvBuffer, CacheEntry cacheMeta, String sessionId) {
//            // 为新Token分配块
...
//         */
//        private void optimizeKVCacheWithPageAttentionV3(PagedKvBuffer kvBuffer, CacheEntry cacheMeta, String sessionId) {
//            // 1. 获取当前会话的物理块
...
//            // 关闭PagedKvBuffer
//            PagedKvBuffer kvBuffer = kvBufferMap.remove(sessionId);
//            if (kvBuffer != null) {
//                kvBuffer.close();
//            }
//
...
//                    CoWBlockManager.EVICT_COUNT.sum(),
//                    CoWBlockManager.WAIT_COUNT.sum());
//        }
//
//        /**
//         * 清理所有资源
