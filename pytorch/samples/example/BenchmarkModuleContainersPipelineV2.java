...
public class BenchmarkModuleContainersPipelineV2 {
...
//        public ComplexLayerA(Pointer p, LinearImpl fc1, LinearImpl fc2) { super(p);
//            this.fc1 = fc1;
//            this.fc2 = fc2;
//        }
...
//        public ComplexLayerB(Pointer p, LinearImpl gate, LinearImpl proj) { super(p);
//            this.gate = gate;
//            this.proj = proj;
//        }
        public Tensor forward(Tensor x) {
...
//        public PairTupleLayer(Pointer p, LinearImpl left, LinearImpl right) { super(p);
//            this.left = left;
//            this.right = right;
//        }
...
//        public ModuleListModelA(Pointer p) { super(p); blocks = null; head = null; }
        public Tensor forward(Tensor x) {
            x = blocks.get(0).forward(x);
//            x = blocks.get(1).forward_tensor(x);
...
//        public ModuleListModelB(Pointer p) { super(p); blocks = null; head = null; }
        public Tensor forward(Tensor x) {
            x = blocks.get(0).forward(x);
            x = blocks.get(1).forward_tensor(x);
//            x = blocks.get(2).forward_tensor(x);
...
//        public ModuleDictModelA(Pointer p) { super(p); dict = null; }
        public Tensor forward(Tensor x) {
            x = dict.get("stem").forward(x);
            x = dict.get("body").forward_tensor(x);
//            return dict.get("head").forward_tensor(x);
...
//        public ModuleDictModelPair(Pointer p) { super(p); dict = null; }
        public T_TensorTensor_T forwardT_TensorTensor_T(Tensor a, Tensor b) {
