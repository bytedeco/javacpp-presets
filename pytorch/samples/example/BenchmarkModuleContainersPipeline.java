...
public class BenchmarkModuleContainersPipeline {
    public static final class ComplexLayerA extends Module {
        ...
        public Tensor forward(Tensor x, Tensor y) {
            return forward(x.add(y));
        }
        public Tensor forward(Tensor x, Tensor y, Tensor z) {
            return forward(x.add(y).add(z));
        }
    }
    ...
    public static final class ModuleListModelA extends Module {
        ...
        public Tensor forward(Tensor x) {
            x = blocks.get(0).forward(x);
            x = blocks.get(1).forward(x);
    ...
    public static final class ModuleListModelB extends Module {
        ...
        public Tensor forward(Tensor x) {
            Tensor b0 = blocks.get(0).forward(x);
            Tensor b1 = blocks.get(1).forward(b0);
            x = blocks.get(2).forward(x, b0, b1);
            return head.forward(x);
        }
    }
    ...
    public static final class ModuleDictModelA extends Module {
        ...
        public Tensor forward(Tensor x) {
            Tensor y = dict.get("body").forward(x);
            x = dict.get("stem").forward(x, y);
            return dict.get("head").forward(x);
        }
    }
    ...
    public static final class ModuleDictModelPair extends Module {
        ...
        public T_TensorTensor_T forwardT_TensorTensor_T(Tensor a, Tensor b) {
            Tensor ea = dict.get("left_enc").forward(a);
            Tensor eb = dict.get("right_enc").forward(b);
