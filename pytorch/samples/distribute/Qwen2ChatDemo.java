 ...
 *   java distribute.Qwen2ChatDemo --tiny
 *
 *   # real Hub model (requires network + ~1GB disk; set HF_TOKEN if gated)
 *   java distribute.Qwen2ChatDemo Qwen/Qwen2-0.5B-Instruct
 *
 *   # local snapshot directory
 *   java distribute.Qwen2ChatDemo --dir /path/to/snapshot
 * </pre>
 */
public final class Qwen2ChatDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if ("--tiny".equals(mode)) {
            ...
            if (args.length < 2) {
                System.err.println("Usage: distribute.Qwen2ChatDemo --dir <snapshot>");
                System.exit(2);
                return;
            }
