...
public class Expression {
     ...
     * </ul>
     */
    public Expression over(org.bytedeco.pytorch.data.dataframe.window.WindowSpec spec) {
        if (this instanceof AggExpr) {
            AggExpr a = (AggExpr) this;
            org.bytedeco.pytorch.data.dataframe.window.WindowFunction.Kind kind = aggOpToWindowKind(a.op);
            org.bytedeco.pytorch.data.dataframe.window.WindowFunction wf =
                org.bytedeco.pytorch.data.dataframe.window.WindowFunction.agg(kind, a.child);
        ...
        org.bytedeco.pytorch.data.dataframe.window.WindowFunction wf =
            org.bytedeco.pytorch.data.dataframe.window.WindowFunction.agg(
                org.bytedeco.pytorch.data.dataframe.window.WindowFunction.Kind.FIRST, this);
        return new WindowExpr(wf, spec);
    }

    private static org.bytedeco.pytorch.data.dataframe.window.WindowFunction.Kind aggOpToWindowKind(AggOp op) {
        switch (op) {
            case SUM: return org.bytedeco.pytorch.data.dataframe.window.WindowFunction.Kind.SUM;
            case MEAN: return org.bytedeco.pytorch.data.dataframe.window.WindowFunction.Kind.MEAN;
            case MIN: return org.bytedeco.pytorch.data.dataframe.window.WindowFunction.Kind.MIN;
            case MAX: return org.bytedeco.pytorch.data.dataframe.window.WindowFunction.Kind.MAX;
            case COUNT: case LEN: return org.bytedeco.pytorch.data.dataframe.window.WindowFunction.Kind.COUNT;
            case STD: return org.bytedeco.pytorch.data.dataframe.window.WindowFunction.Kind.STD;
            case VAR: return org.bytedeco.pytorch.data.dataframe.window.WindowFunction.Kind.VAR;
            case FIRST: return org.bytedeco.pytorch.data.dataframe.window.WindowFunction.Kind.FIRST;
            case LAST: return org.bytedeco.pytorch.data.dataframe.window.WindowFunction.Kind.LAST;
            case MEDIAN: return org.bytedeco.pytorch.data.dataframe.window.WindowFunction.Kind.MEDIAN;
            case PRODUCT: return org.bytedeco.pytorch.data.dataframe.window.WindowFunction.Kind.PRODUCT;
            default: return org.bytedeco.pytorch.data.dataframe.window.WindowFunction.Kind.FIRST;
        }
    }
    ...
    /**
     * Window function expression. Requires a {@link org.bytedeco.pytorch.data.dataframe.window.WindowSpec}
     * (via {@link #over}); evaluates to a full column aligned with source rows.
     */
    static final class WindowExpr extends Expression {
        final org.bytedeco.pytorch.data.dataframe.window.WindowFunction fn;
        final org.bytedeco.pytorch.data.dataframe.window.WindowSpec spec;
        private DataFrame cachedDf;
        private Column cachedCol;

        WindowExpr(org.bytedeco.pytorch.data.dataframe.window.WindowFunction fn,
        ...
        private Column compute(DataFrame df) {
            ...
            cachedCol = org.bytedeco.pytorch.data.dataframe.window.WindowExecutor.evaluate(df, fn, spec);
            cachedDf = df;
            return cachedCol;
        }
    ...
    static Expression windowFn(org.bytedeco.pytorch.data.dataframe.window.WindowFunction fn) {
