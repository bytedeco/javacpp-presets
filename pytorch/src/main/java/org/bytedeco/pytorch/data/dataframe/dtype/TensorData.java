...
//    }
    ...
    public static TensorData fromTensor(Tensor t) {
        return org.bytedeco.pytorch.data.dataframe.tensor.TensorBridge.toTensorData(t);
    }
    ...
    public static TensorData fromTensor(Tensor t, boolean attachNative) {
        return org.bytedeco.pytorch.data.dataframe.tensor.TensorBridge.toTensorData(t, attachNative);
    }

    /** Convert this cell to a javacpp-pytorch {@link Tensor} (prefers attached native). */
    public Tensor toTensor() {
        return org.bytedeco.pytorch.data.dataframe.tensor.TensorBridge.toTensor(this);
    }

    public static TensorData fromNDArray(org.bytedeco.pytorch.data.numpy.NDArray arr) {
        return org.bytedeco.pytorch.data.dataframe.tensor.TensorBridge.toTensorData(arr);
    }

    public org.bytedeco.pytorch.data.numpy.NDArray toNDArray() {
        return org.bytedeco.pytorch.data.dataframe.tensor.TensorBridge.toNDArray(this);
    }
