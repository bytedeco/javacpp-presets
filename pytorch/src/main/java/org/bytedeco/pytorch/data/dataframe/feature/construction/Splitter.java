package org.bytedeco.pytorch.data.dataframe.feature.construction;
 ...
 import org.bytedeco.pytorch.data.dataframe.dtype.StringData;
            ...
            for (Object value : values) {
                ...
                if (value == null) {
                    ...
                    if (value instanceof AbstractDataValue) {
                        Object rawValue = ( (value instanceof org.bytedeco.pytorch.data.dataframe.dtype.DataValue) ? ((org.bytedeco.pytorch.data.dataframe.dtype.DataValue)value).toArrowCompatible() : value );
