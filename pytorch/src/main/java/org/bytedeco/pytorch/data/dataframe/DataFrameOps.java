...
public final class DataFrameOps {
    ...
    public static final class FeatureLabelSplit {
        ...
        public FeatureLabelSplit transformFeatures(
                org.bytedeco.pytorch.data.dataframe.feature.pipeline.Pipeline pipe)
                throws Exception {
            if (pipe == null) return this;
            DataFrame Xt = pipe.fitTransform(X);
            return new FeatureLabelSplit(Xt, y, featureCols, labelCols);
        ...
        public org.bytedeco.pytorch.data.dataframe.dataset.DataFrameDataset toDataset() {
            return org.bytedeco.pytorch.data.dataframe.dataset.DataFrameDataset.of(X, y);
        }

        public org.bytedeco.pytorch.data.dataframe.dataset.DataFrameDataset toDataset(
                org.bytedeco.pytorch.data.dataframe.dataset.DataFrameDataset.Options opts) {
            return org.bytedeco.pytorch.data.dataframe.dataset.DataFrameDataset.of(X, y, opts);
        }
    }
}
