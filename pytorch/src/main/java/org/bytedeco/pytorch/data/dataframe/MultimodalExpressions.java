...
import org.bytedeco.pytorch.data.dataframe.dtype.BinaryData;
...
public final class MultimodalExpressions {
    ...
    public static final class ImageNameSpace {
        ...
        public Expression toEmbedding(String modelId) {
            return org.bytedeco.pytorch.data.dataframe.ai.AiFunctions.embedImage(parent, modelId);
        }
    ...
    public static final class AudioNameSpace {
        ...
        public Expression toEmbedding(String modelId) {
            return org.bytedeco.pytorch.data.dataframe.ai.AiFunctions.embedAudio(parent, modelId);
        }
    }
    ...
    public static final class VideoNameSpace {
        ...
        public Expression toEmbedding() {
            return org.bytedeco.pytorch.data.dataframe.ai.AiFunctions.embedVideo(parent, "hash-video");
        }
        public Expression toEmbedding(String modelId) {
            return org.bytedeco.pytorch.data.dataframe.ai.AiFunctions.embedVideo(parent, modelId);
        }
    }
    ...
    public static final class TextNameSpace {
        ...
        public Expression toEmbedding(String modelId) {
            return org.bytedeco.pytorch.data.dataframe.ai.AiFunctions.embedText(parent, modelId);
        }
    }
