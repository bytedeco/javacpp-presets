...
//    }
    ...
    public static VectorData fromTensor(org.bytedeco.pytorch.Tensor t) {
        return org.bytedeco.pytorch.data.dataframe.tensor.TensorBridge.toVectorData(t);
    }

    public static VectorData fromTensor(org.bytedeco.pytorch.Tensor t, String vectorName) {
        return org.bytedeco.pytorch.data.dataframe.tensor.TensorBridge.toVectorData(t, vectorName);
    }
