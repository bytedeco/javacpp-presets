...
public final class WeightMaps {
    ...
    /** Plain Qwen3 text LM — HF keys already match {@link Qwen3ForCausalLM}. */
    ...
    /**
     * GLM-Edge / ChatGLM: HF names already match {@link GlmForCausalLM}
    ...
    public static WeightMap forModelType(String modelType) {
        ...
        String res = "org/bytedeco/pytorch/llm/transformers/weight_maps/" + t + "_hf.json";
        try {
