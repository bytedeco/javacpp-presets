...
/** SPI for external GGUF runners (llama.cpp, etc.). */
public interface GgufRuntime extends AutoCloseable {
    void load(Path model, GgufHardwareControls controls) throws Exception;
    ChatCompletionResponse chat(ChatCompletionRequest request) throws Exception;
    void unload();
    @Override default void close() { unload(); }
}
