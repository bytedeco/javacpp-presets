...
/** GLM-4-MoE / GLM-5 / GLM-5.2 injection plan. */
public final class GlmMoeFamilyInject {

    private GlmMoeFamilyInject() {}

    public static LayerInjectPlan plan(KtModelFamily family) {
        KtModelFamily f = family != null ? family : KtModelFamily.GLM4_MOE;
