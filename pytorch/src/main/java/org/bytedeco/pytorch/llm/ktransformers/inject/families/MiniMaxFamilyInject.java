...
/** MiniMax-M2/M2.1/M2.5/M3 MoE injection plan. */
public final class MiniMaxFamilyInject {

    private MiniMaxFamilyInject() {}

    public static LayerInjectPlan plan(KtModelFamily family) {
        KtModelFamily f = family != null ? family : KtModelFamily.MINIMAX_M2;
        return LayerInjectPlan.builder(f)
                ...
                .quantLinearGlobs(
                        ...
                        "*.w1", "*.w2", "*.w3")
                .moeFfnGlobs("*.experts.*", "*.block_sparse_moe.*")
