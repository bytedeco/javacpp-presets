...
/**
 * DeepSeek-V2/V3/R1/V4-Flash injection: MLA attention + routed MoE FFN.
 */
public final class DeepSeekFamilyInject {

    private DeepSeekFamilyInject() {}

    public static LayerInjectPlan plan(KtModelFamily family) {
        KtModelFamily f = family != null ? family : KtModelFamily.DEEPSEEK_V3;
        return LayerInjectPlan.builder(f)
                ...
                .note("family", f.name())
                .note("attn", "MLA compressed KV")
                .note("moe", "DeepSeek routed experts + shared expert")
                .build();
    }
}
