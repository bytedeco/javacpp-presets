...
/** LLaMA 4 dense (or lightly sparse) injection plan. */
public final class Llama4FamilyInject {

    private Llama4FamilyInject() {}

    public static LayerInjectPlan plan(KtModelFamily family) {
        KtModelFamily f = family != null ? family : KtModelFamily.LLAMA4;
