...
public class FunctionalAlphaDropout extends Module {
    ...
    public FunctionalAlphaDropout(float p) {
        super("FunctionalAlphaDropout");
        this.p = p;
    }
    ...
    public Tensor forward(Tensor x) {
        ...
        return torch.alpha_dropout(x, p, this.is_training());
    }
}
