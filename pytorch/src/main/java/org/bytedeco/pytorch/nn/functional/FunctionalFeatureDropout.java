...
public class FunctionalFeatureDropout extends Module {
    static {
    ...
    public FunctionalFeatureDropout(float p) {
        super("FunctionalFeatureDropout");
        this.p = p;
    }
    ...
    public Tensor forward(Tensor x) {
        ...
        return torch.feature_dropout(x, p, this.is_training());
    }
}
