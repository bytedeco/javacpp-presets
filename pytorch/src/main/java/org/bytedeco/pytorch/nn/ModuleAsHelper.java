 ...
 * {@link org.bytedeco.pytorch.nn.modules.container.SequentialImpl#push_back(Module)} entry point.
 *
 ...
 */
public final class ModuleAsHelper {
    ...
    public static void remember(Module module) {
    ...
    public static Module recover(Module module) {
        if (module == null || module.isNull()) {
            return module;
        }
     ...
     */
    public static <T extends Module> T wrap(Module module, Class<T> targetClass) {
        try {
            long key = keyOf(module);
     ...
     * </ol>
     */
    public static void pushBackModule(SequentialImpl seq, Module module, String name) {
        remember(module);
