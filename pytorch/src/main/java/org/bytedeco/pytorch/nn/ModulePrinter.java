...
public final class ModulePrinter {
    ...
    private static String linearAttrs(Module m) {
        try {
            org.bytedeco.pytorch.nn.modules.LinearImpl t = m.as(org.bytedeco.pytorch.nn.modules.LinearImpl.class);
            if (t == null) return "";
    ...
    private static String convAttrs(Module m, int spatialDims) {
        try {
            org.bytedeco.pytorch.nn.modules.Conv2dImpl t = m.as(org.bytedeco.pytorch.nn.modules.Conv2dImpl.class);
            if (t == null) return "";
    ...
    private static String batchNormAttrs(Module m) {
        try {
            org.bytedeco.pytorch.nn.modules.BatchNorm2dImplBase t = m.as(org.bytedeco.pytorch.nn.modules.BatchNorm2dImplBase.class);
            if (t == null) return "";
    ...
    private static String groupNormAttrs(Module m) {
        try {
            org.bytedeco.pytorch.nn.modules.GroupNormImpl t = m.as(org.bytedeco.pytorch.nn.modules.GroupNormImpl.class);
            if (t == null) return "";
    ...
    private static String layerNormAttrs(Module m) {
        try {
            org.bytedeco.pytorch.nn.modules.LayerNormImpl t = m.as(org.bytedeco.pytorch.nn.modules.LayerNormImpl.class);
            if (t == null) return "";
    ...
    private static String dropoutAttrs(Module m) {
        try {
            org.bytedeco.pytorch.nn.modules.DropoutImpl t = m.as(org.bytedeco.pytorch.nn.modules.DropoutImpl.class);
            if (t == null) return "";
    ...
    private static String rnnStackedAttrs(Module m) {
        try {
            StringBuilder sb = new StringBuilder();
            org.bytedeco.pytorch.nn.modules.LSTMImpl l = m.as(org.bytedeco.pytorch.nn.modules.LSTMImpl.class);
            if (l != null) {
            ...
            org.bytedeco.pytorch.nn.modules.GRUImpl g = m.as(org.bytedeco.pytorch.nn.modules.GRUImpl.class);
            if (g != null) {
            ...
            org.bytedeco.pytorch.nn.modules.RNNImpl r = m.as(org.bytedeco.pytorch.nn.modules.RNNImpl.class);
            if (r != null) {
    ...
    private static String rnnCellAttrs(Module m) {
        try {
            StringBuilder sb = new StringBuilder();
            org.bytedeco.pytorch.nn.modules.LSTMCellImpl l = m.as(org.bytedeco.pytorch.nn.modules.LSTMCellImpl.class);
            if (l != null) {
            ...
            org.bytedeco.pytorch.nn.modules.GRUCellImpl g = m.as(org.bytedeco.pytorch.nn.modules.GRUCellImpl.class);
            if (g != null) {
            ...
            org.bytedeco.pytorch.nn.modules.RNNCellImpl r = m.as(org.bytedeco.pytorch.nn.modules.RNNCellImpl.class);
            if (r != null) {
    ...
    private static String embeddingAttrs(Module m) {
        try {
            org.bytedeco.pytorch.nn.modules.EmbeddingImpl t = m.as(org.bytedeco.pytorch.nn.modules.EmbeddingImpl.class);
            if (t == null) return "";
    ...
    private static String formatShape(Tensor t) {
        try {
            long[] sizes = org.bytedeco.pytorch.nn.ModulePrinterShapeHelper.sizesAsArray(t.sizes());
            StringBuilder sb = new StringBuilder("[");
