...
public class FiLMConvTest {
    ...
    public void testForwardShape() {
        ...
        FiLMConv filmConv = new FiLMConv(inChannels, outChannels, numRelations, new AnyModule(relu));
    ...
    public void testNumericalAccuracy() {
        ...
        try (NoGradGuard guard = new NoGradGuard()) {
            ...
            filmConv.lins[0].weight().copy_(lin0Weight);
            filmConv.lins[0].bias().copy_(torch.zeros(new long[]{1}));
            ...
            filmConv.filmLin.weight().copy_(filmWeight);
            filmConv.filmLin.bias().copy_(torch.zeros(new long[]{2}));
        }
...
//        }
    ...
    public void testEdgeCases() {
        ...
        // 场景3：未指定 edge_type（验证异常抛出）
        assertThrows(UnsupportedOperationException.class, () ->
                filmConv.forward(x, edgeIndex));
