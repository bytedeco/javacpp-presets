...
public class PrefixCacheBenchmark {
    public static void main(String[] args) throws InterruptedException {
        ...
        CoWBlockManagerV4 manager = new CoWBlockManagerV4(totalBlocks, numLayers, 16, headDim, kFloat().value);
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            executor.submit(() -> {
                ...
                try (PagedKvBufferV3 kv = new PagedKvBufferV3(sid, manager, numLayers)) {
                    ...
                    int prefixBlock = manager.getOrAllocateBlock(SYSTEM_PROMPT_HASH, sid);
