 ...
 *   <li><b>Uniform SPI</b> — {@link org.bytedeco.pytorch.dataframe.vectorstore.VectorStore}
 *       for upsert / delete / knn search / drop; factory via
 *       {@link org.bytedeco.pytorch.dataframe.vectorstore.VectorStores}.</li>
 *   <li><b>Full clients (Redis-style)</b> — also see
 *       {@link org.bytedeco.pytorch.dataframe.milvus.Milvus},
 *       {@link org.bytedeco.pytorch.dataframe.opensearch.OpenSearch},
 *       {@link org.bytedeco.pytorch.dataframe.mongo.Mongo},
 *       {@link org.bytedeco.pytorch.dataframe.pgvector.PgVector}
 *       for official-package-shaped APIs + DataFrame to/read.</li>
 *   <li><b>Optional plugins</b> — implement
 *       {@link org.bytedeco.pytorch.dataframe.vectorstore.VectorStoreProvider}
 ...
 *       {@link org.bytedeco.pytorch.dataframe.vectorstore.memory.InMemoryVectorStore}
