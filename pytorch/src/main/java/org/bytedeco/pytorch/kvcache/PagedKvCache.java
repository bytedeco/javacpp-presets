package org.bytedeco.pytorch.kvcache;
 ...
 * (vLLM / PagedAttention style), inspired by CoWBlockManagerV9.
 *
 * <ul>
 ...
 * {@link org.bytedeco.pytorch.distributed.PagedKvCache}.
 */
public class PagedKvCache implements AutoCloseable {
    ...
    private static final class PrefixNode {
        ...
        List<Integer> sharedBlocks;
        List<List<Integer>> sharedBlocksAllLayers;
        long lruKey;

        PrefixNode(int token) { this.token = token; }
    }
