/*
 * Ported from torch-rechub-scala: torchrec/models/knowledge_tracing/DKT.scala (DKTPlus)
 *
 * DKT+: Deep Knowledge Tracing with Regularization parameters.
 * Same architecture as DKT; stores lambdaR/W1/W2 for extended SLM loss.
 */
...
public class DKTPlus extends Module {
    ...
    private final float lambdaRParam;
    private final float lambdaW1Param;
    private final float lambdaW2Param;

    public DKTPlus(long numConcepts) {
        this(numConcepts, 64, 1, 0.2f, 0.0f, 0.0f, 0.0f, DeviceSupport.backend());
    }
    ...
    public DKTPlus(
            ...
            String device) {
        super("DKTPlus");
        this.lambdaRParam = lambdaR;
        this.lambdaW1Param = lambdaW1;
        this.lambdaW2Param = lambdaW2;
    ...
    public float lambdaR() { return lambdaRParam; }
    public float lambdaW1() { return lambdaW1Param; }
    public float lambdaW2() { return lambdaW2Param; }
}
