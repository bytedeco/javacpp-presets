/*
 * Ported from torch-rechub-scala: torchrec/models/knowledge_tracing/AKT.scala (SimpleKT)
 *
 * SimpleKT: Simplified Knowledge Tracing — cross-attention without difficulty modeling.
 */
...
public class SimpleKT extends Module {
    ...
    public SimpleKT(long numConcepts) {
    ...
    public Tensor forward(Tensor conceptIds, Tensor responses) {
        ...
        // Note: Scala clamps qIds with maxScalar = maxInteractionId (same as interaction),
        // not maxQId — mirror source exactly.
