...
/** Base metric interface for RAG evaluation. */
public interface Metric {
    String name();
    double score(SingleTurnSample sample, LlmJudge judge);
    default double score(SingleTurnSample sample) { return score(sample, null); }
}
