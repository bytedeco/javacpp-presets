 ...
 */
package org.bytedeco.pytorch.utils.audio.functional;
...
public final class F {
    ...
    public static Tensor trim(Tensor waveform, int sampleRate, float topDb) {
        ...
        org.bytedeco.pytorch.utils.librosa.effects.Effects.TrimResult tr =
                org.bytedeco.pytorch.utils.librosa.effects.Effects.trim(mono, sampleRate, topDb, 0.02f);
        int start = tr.start;
        int end = tr.end;
        if (end <= start) {
