...
public final class ContextRecall implements Metric {
    @Override public String name() { return "context_recall"; }
    ...
    public double score(SingleTurnSample s, LlmJudge judge) {
        ...
        String combined = String.join(" ", ctxs);
        return HeuristicJudge.wordF1(ref, combined);
    }
}
