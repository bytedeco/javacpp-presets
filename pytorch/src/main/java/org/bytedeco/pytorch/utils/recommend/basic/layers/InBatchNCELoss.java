/*
 * Ported from torch-rechub-scala: torchrec/basic/layers/LossFunc.scala (InBatchNCELoss, BPRLoss)
 */
...
public class InBatchNCELoss extends Module {
    ...
    public InBatchNCELoss(float temperature, long ignoreIndex, String reduction) {
        super("InBatchNCELoss");
        this.temperature = temperature;
        this.ignoreIndex = ignoreIndex;
        this.reduction = reduction;
    }

    public Tensor forward(Tensor embeddings, Tensor itemEmbeddings, Tensor targets) {
        Tensor logits = torch.matmul(embeddings, itemEmbeddings.t()).div(new Scalar(temperature));
