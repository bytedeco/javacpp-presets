...
public class TensorIteratorBase extends MetaBase {
  ...
  public native @ByVal @Cast("at::TensorIteratorBase::StrideVector*") SmallLongVector compatible_stride(@Cast("int64_t") long element_size);
  ...
  public native @ByVal @Cast("at::TensorIteratorBase::StrideVector*") SmallLongVector get_dim_strides(int dim);
  public native @ByVal @Cast("at::TensorIteratorBase::StrideVector*") SmallLongVector get_strides();
  public native @ByVal @Cast("at::TensorIteratorBase::StrideVector*") SmallLongVector get_inner_strides();
  public native @ByVal @Cast("at::TensorIteratorBase::PtrVector*") SmallLongVector get_base_ptrs();
