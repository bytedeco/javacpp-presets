...
public class SigmoidImpl extends SigmoidImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::SigmoidImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
