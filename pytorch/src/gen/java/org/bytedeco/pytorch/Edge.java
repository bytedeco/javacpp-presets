...
public class Edge extends Pointer {
  ...
  @NoException private native void allocate(@SharedPtr Node function_, @Cast("uint32_t") int input_nr_);

  /** Convenience method to test if an edge is valid. */
  public native @Cast("bool") @NoException boolean is_valid();

  // Required for use in associative containers.
  public native @Cast("bool") @Name("operator ==") @NoException boolean equals(@Const @ByRef Edge other);

  public native @Cast("bool") @Name("operator !=") @NoException boolean notEquals(@Const @ByRef Edge other);
