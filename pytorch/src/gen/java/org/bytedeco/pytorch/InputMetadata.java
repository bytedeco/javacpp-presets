...
public class InputMetadata extends Pointer {
  ...
  public InputMetadata(
        @Const @ByVal TensorOptions options,
        @ByVal @Cast("torch::autograd::MetadataShape*") NonlinearityType input_shape,
        @Cast("bool") boolean is_tensor_subclass) { super((Pointer)null); allocate(options, input_shape, is_tensor_subclass); }
  private native void allocate(
        @Const @ByVal TensorOptions options,
        @ByVal @Cast("torch::autograd::MetadataShape*") NonlinearityType input_shape,
