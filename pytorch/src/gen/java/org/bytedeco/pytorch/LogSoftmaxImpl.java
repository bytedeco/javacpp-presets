...
public class LogSoftmaxImpl extends LogSoftmaxImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::LogSoftmaxImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
