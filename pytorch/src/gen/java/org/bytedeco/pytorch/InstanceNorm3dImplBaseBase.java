...
public class InstanceNorm3dImplBaseBase extends InstanceNorm3dImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::NormImplBase<3,torch::nn::InstanceNorm3dImpl,torch::nn::InstanceNormOptions>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
