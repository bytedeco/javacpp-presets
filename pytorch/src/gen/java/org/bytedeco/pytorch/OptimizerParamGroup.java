...
public class OptimizerParamGroup extends Pointer {
  ...
  public OptimizerParamGroup(@StdMove TensorVector params) { super((Pointer)null); allocate(params); }
  private native void allocate(@StdMove TensorVector params);
  public OptimizerParamGroup(@StdMove TensorVector params, @UniquePtr OptimizerOptions options) { super((Pointer)null); allocate(params, options); }
  private native void allocate(@StdMove TensorVector params, @UniquePtr OptimizerOptions options);
