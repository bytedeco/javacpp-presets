...
public class ConstantPad3dImplCloneable extends Module {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::Cloneable<torch::nn::ConstantPad3dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
