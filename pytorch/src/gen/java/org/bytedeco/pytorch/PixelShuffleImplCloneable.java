...
public class PixelShuffleImplCloneable extends Module {
    ...
    public PixelShuffleImplCloneable(Module pointer) { super((Pointer)null); allocate(pointer); }
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::Cloneable<torch::nn::PixelShuffleImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
    @Override public Module asModule() { return asModule(this); }
    @Namespace public static native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::Module, torch::nn::Cloneable<torch::nn::PixelShuffleImpl>>") Module asModule(@SharedPtr PixelShuffleImplCloneable pointer);
