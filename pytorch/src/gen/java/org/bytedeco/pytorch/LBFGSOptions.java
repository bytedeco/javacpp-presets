...
public class LBFGSOptions extends OptimizerCloneableLBFGSOptions {
  ...
  public native @Cast("int64_t*") @ByRef @NoException LongPointer max_iter();
  public native @ByRef @NoException LongOptional max_eval();
  public native @ByRef @NoException DoublePointer tolerance_grad();
  public native @ByRef @NoException DoublePointer tolerance_change();
  public native @Cast("int64_t*") @ByRef @NoException LongPointer history_size();
  public native @ByRef @NoException StringOptional line_search_fn();
