...
public class Assign extends Stmt {
  ...
  public Assign(@IntrusivePtr("torch::jit::Tree") @Cast({"", "c10::intrusive_ptr<torch::jit::Tree>&"}) Tree tree) { super((Pointer)null); allocate(tree); }
  ...
  public static native @ByVal Assign create(
        ...
        @Const @ByRef ExprMaybe rhs,
        @Const @ByRef ExprMaybe type);

  public native @ByVal ExprList lhs_list();

  public native @ByVal Expr lhs();

  public native @ByVal ExprMaybe rhs();
