...
public class ReplicationPad1dImplBase extends ReplicationPad1dImplCloneable {
    ...
    public ReplicationPad1dImplBase(Module pointer) { super((Pointer)null); allocate(pointer); }
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::ReplicationPadImpl<1,torch::nn::ReplicationPad1dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
