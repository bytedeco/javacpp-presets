...
public class ReflectionPad1dImplBase extends ReflectionPad1dImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::ReflectionPadImpl<1,torch::nn::ReflectionPad1dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
