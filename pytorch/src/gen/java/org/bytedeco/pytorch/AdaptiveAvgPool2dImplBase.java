...
public class AdaptiveAvgPool2dImplBase extends AdaptiveAvgPool2dImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::AdaptiveAvgPoolImpl<2,torch::ExpandingArrayWithOptionalElem<2>,torch::nn::AdaptiveAvgPool2dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
