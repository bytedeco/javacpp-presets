...
public class LeakyReLUImpl extends LeakyReLUImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::LeakyReLUImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
