...
@Name("c10::HeaderOnlyArrayRef<torch::jit::NamedValue>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class NamedValueHeaderOnlyArrayRef extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public NamedValueHeaderOnlyArrayRef(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public NamedValueHeaderOnlyArrayRef(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public NamedValueHeaderOnlyArrayRef position(long position) {
        return (NamedValueHeaderOnlyArrayRef)super.position(position);
    }
    @Override public NamedValueHeaderOnlyArrayRef getPointer(long i) {
        return new NamedValueHeaderOnlyArrayRef((Pointer)this).offsetAddress(i);
    }
  ...
  /* implicit */ public NamedValueHeaderOnlyArrayRef() { super((Pointer)null); allocate(); }
private native void allocate();
  ...
  public NamedValueHeaderOnlyArrayRef(@Const NamedValue data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  private native void allocate(@Const NamedValue data, @Cast("size_t") long length);

  /** Construct a HeaderOnlyArrayRef from a range. */
  public NamedValueHeaderOnlyArrayRef(@Const NamedValue begin, @Const NamedValue end) { super((Pointer)null); allocate(begin, end); }
  ...
  public native @Const @ByVal NamedValueHeaderOnlyArrayRef slice(@Cast("size_t") long N, @Cast("size_t") long M);

  /** slice(n) - Chop off the first N elements of the array. */
  public native @Const @ByVal NamedValueHeaderOnlyArrayRef slice(@Cast("size_t") long N);
