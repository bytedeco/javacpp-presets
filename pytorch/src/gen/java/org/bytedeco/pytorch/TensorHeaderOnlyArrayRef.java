...
@Name("c10::HeaderOnlyArrayRef<torch::Tensor>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class TensorHeaderOnlyArrayRef extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TensorHeaderOnlyArrayRef(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public TensorHeaderOnlyArrayRef(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public TensorHeaderOnlyArrayRef position(long position) {
        return (TensorHeaderOnlyArrayRef)super.position(position);
    }
    @Override public TensorHeaderOnlyArrayRef getPointer(long i) {
        return new TensorHeaderOnlyArrayRef((Pointer)this).offsetAddress(i);
    }
  ...
  /* implicit */ public TensorHeaderOnlyArrayRef() { super((Pointer)null); allocate(); }
private native void allocate();
  ...
  public TensorHeaderOnlyArrayRef(@Const Tensor data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  private native void allocate(@Const Tensor data, @Cast("size_t") long length);

  /** Construct a HeaderOnlyArrayRef from a range. */
  public TensorHeaderOnlyArrayRef(@Const Tensor begin, @Const Tensor end) { super((Pointer)null); allocate(begin, end); }
  ...
  public native @Const @ByVal TensorHeaderOnlyArrayRef slice(@Cast("size_t") long N, @Cast("size_t") long M);

  /** slice(n) - Chop off the first N elements of the array. */
  public native @Const @ByVal TensorHeaderOnlyArrayRef slice(@Cast("size_t") long N);
