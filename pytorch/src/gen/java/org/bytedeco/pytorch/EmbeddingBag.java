...
public class EmbeddingBag extends EmbeddingBagImplModuleHolder {
  ...
  /** See the documentation for {@code torch::nn::EmbeddingBagFromPretrainedOptions}
   *  class to learn what optional arguments are supported for this function. */
  public static native @ByVal EmbeddingBag from_pretrained(
        @Const @ByRef Tensor embeddings,
        @Const @ByRef(nullValue = "torch::nn::EmbeddingBagFromPretrainedOptions{}") EmbeddingBagFromPretrainedOptions options);
  public static native @ByVal EmbeddingBag from_pretrained(
        @Const @ByRef Tensor embeddings);
}
