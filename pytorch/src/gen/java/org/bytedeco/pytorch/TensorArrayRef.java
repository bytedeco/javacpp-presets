...
@Name("c10::ArrayRef<at::Tensor>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class TensorArrayRef extends Pointer {
    ...
    @Override public TensorArrayRef getPointer(long i) {
        return new TensorArrayRef((Pointer)this).position(position + i);
    }
...
private native void allocate();
  ...
  public TensorArrayRef(@Const @ByRef Tensor OneElt) { super((Pointer)null); allocate(OneElt); }
  private native void allocate(@Const @ByRef Tensor OneElt);
  ...
  public native @ByVal @Cast("const c10::ArrayRef<at::Tensor>::iterator*") Tensor begin();
  public native @ByVal @Cast("const c10::ArrayRef<at::Tensor>::iterator*") Tensor end();

  // These are actually the same as iterator, since ArrayRef only
  // gives you const iterators.
  public native @ByVal @Cast("const c10::ArrayRef<at::Tensor>::const_iterator*") Tensor cbegin();
  public native @ByVal @Cast("const c10::ArrayRef<at::Tensor>::const_iterator*") Tensor cend();
   ...
   *  \{ */
  public native @StdMove TensorVector vec();
