...
public class ReflectionPad1dImplCloneable extends Module {
    ...
    public ReflectionPad1dImplCloneable(Module pointer) { super((Pointer)null); allocate(pointer); }
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::Cloneable<torch::nn::ReflectionPad1dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
