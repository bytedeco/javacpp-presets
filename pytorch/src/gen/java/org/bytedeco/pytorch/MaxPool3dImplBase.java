...
public class MaxPool3dImplBase extends MaxPool3dImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::MaxPoolImpl<3,torch::nn::MaxPool3dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
