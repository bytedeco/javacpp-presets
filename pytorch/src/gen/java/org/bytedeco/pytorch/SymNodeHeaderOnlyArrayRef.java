...
@Name("c10::HeaderOnlyArrayRef<c10::intrusive_ptr<c10::SymNodeImpl> >") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class SymNodeHeaderOnlyArrayRef extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public SymNodeHeaderOnlyArrayRef(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public SymNodeHeaderOnlyArrayRef(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public SymNodeHeaderOnlyArrayRef position(long position) {
        return (SymNodeHeaderOnlyArrayRef)super.position(position);
    }
    @Override public SymNodeHeaderOnlyArrayRef getPointer(long i) {
        return new SymNodeHeaderOnlyArrayRef((Pointer)this).offsetAddress(i);
    }
  ...
  /* implicit */ public SymNodeHeaderOnlyArrayRef() { super((Pointer)null); allocate(); }
private native void allocate();
  ...
  public SymNodeHeaderOnlyArrayRef(@Const @IntrusivePtr("c10::SymNodeImpl") SymNode data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  ...
  public SymNodeHeaderOnlyArrayRef(@Const @IntrusivePtr("c10::SymNodeImpl") SymNode begin, @Const @IntrusivePtr("c10::SymNodeImpl") SymNode end) { super((Pointer)null); allocate(begin, end); }
  ...
  public native @Const @ByVal SymNodeHeaderOnlyArrayRef slice(@Cast("size_t") long N, @Cast("size_t") long M);

  /** slice(n) - Chop off the first N elements of the array. */
  public native @Const @ByVal SymNodeHeaderOnlyArrayRef slice(@Cast("size_t") long N);
