...
public class Object extends Pointer {
  ...
  public Object(@ByVal WeakOrStrongTypePtr type, @Cast("size_t") long numSlots) { super((Pointer)null); allocate(type, numSlots); }
  private native void allocate(@ByVal WeakOrStrongTypePtr type, @Cast("size_t") long numSlots);

  public Object(@ByVal StrongTypePtr type, @Cast("size_t") long numSlots) { super((Pointer)null); allocate(type, numSlots); }
  private native void allocate(@ByVal StrongTypePtr type, @Cast("size_t") long numSlots);

  public static native @ByVal ObjPtr create(
  ...
  public static native @ByVal ObjPtr create(@SharedPtr("c10::ClassType") @ByVal ClassType classType, @Cast("size_t") long numSlots);
  ...
  public native @ByVal ObjPtr copy_to_weak_compilation_ref();

  public native void unsafe_make_weak_compilation_ref();

  public native @ByVal ObjPtr copy();

  public native @ByVal ObjPtr deepcopy(
