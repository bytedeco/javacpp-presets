...
public class GELUImpl extends GELUImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::GELUImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
