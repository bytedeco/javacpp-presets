...
public class MaxUnpool2dImpl extends MaxUnpool2dImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::MaxUnpool2dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
