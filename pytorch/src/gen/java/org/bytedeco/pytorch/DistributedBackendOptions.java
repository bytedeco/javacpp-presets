...
public class DistributedBackendOptions extends Pointer {
  ...
  public native @IntrusivePtr("c10d::ProcessGroup") @Cast({"", "c10::intrusive_ptr<c10d::ProcessGroup>&"}) ProcessGroup process_group(); public native DistributedBackendOptions process_group(ProcessGroup setter);
  public native @IntrusivePtr("c10d::Backend") @Cast({"", "c10::intrusive_ptr<c10d::Backend>&"}) Backend split_from(); public native DistributedBackendOptions split_from(Backend setter);
  public native @Cast("bool") boolean enable_reconfigure(); public native DistributedBackendOptions enable_reconfigure(boolean setter);
}
