...
public class LSTMImplBase extends LSTMImplCloneable {
    ...
    public LSTMImplBase(Module pointer) { super((Pointer)null); allocate(pointer); }
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::detail::RNNImplBase<torch::nn::LSTMImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
