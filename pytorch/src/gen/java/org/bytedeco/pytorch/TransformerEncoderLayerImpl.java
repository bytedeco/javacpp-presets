...
public class TransformerEncoderLayerImpl extends TransformerEncoderLayerImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::TransformerEncoderLayerImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
