...
public class ConvolutionDescriptor extends Pointer {
  ...
  public native void set(@ByVal @Cast("cudnnDataType_t*") Pointer dataType, int dim, IntPointer pad, IntPointer stride, IntPointer upscale, int groups, @Cast("bool") boolean allow_tf32);
  public native void set(@ByVal @Cast("cudnnDataType_t*") Pointer dataType, int dim, IntBuffer pad, IntBuffer stride, IntBuffer upscale, int groups, @Cast("bool") boolean allow_tf32);
  public native void set(@ByVal @Cast("cudnnDataType_t*") Pointer dataType, int dim, int[] pad, int[] stride, int[] upscale, int groups, @Cast("bool") boolean allow_tf32);
}
