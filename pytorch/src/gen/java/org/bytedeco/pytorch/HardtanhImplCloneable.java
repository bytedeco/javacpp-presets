...
@Name("torch::nn::Cloneable<torch::nn::HardtanhImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class HardtanhImplCloneable extends Module {
    static { Loader.load(); }
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::Cloneable<torch::nn::HardtanhImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
