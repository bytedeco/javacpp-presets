...
@Name("std::vector<std::unique_ptr<torch::autograd::FunctionPreHook> >") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class FunctionPreHookVector extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FunctionPreHookVector(Pointer p) { super(p); }
    public FunctionPreHookVector()       { allocate();  }
