...
public class DetectAnomalyGuard extends Pointer {
  ...
  public DetectAnomalyGuard(@Cast("bool") boolean check_nan/*=true*/) { super((Pointer)null); allocate(check_nan); }
  private native void allocate(@Cast("bool") boolean check_nan/*=true*/);
