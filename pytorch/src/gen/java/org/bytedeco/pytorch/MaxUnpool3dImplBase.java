...
public class MaxUnpool3dImplBase extends MaxUnpool3dImplCloneable {
    ...
    public MaxUnpool3dImplBase(Module pointer) { super((Pointer)null); allocate(pointer); }
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::MaxUnpoolImpl<3,torch::nn::MaxUnpool3dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
