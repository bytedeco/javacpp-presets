...
public class ResolverVector extends Pointer {
    ...
    @Index(function = "at") public native @SharedPtr Resolver get(@Cast("size_t") long i);
    public native ResolverVector put(@Cast("size_t") long i, Resolver value);

    public native @ByVal Iterator insert(@ByVal Iterator pos, @SharedPtr Resolver value);
    ...
    @NoOffset @Name("iterator") public static class Iterator extends Pointer {
        ...
        public native @Name("operator *") @SharedPtr @Const Resolver get();
    }
