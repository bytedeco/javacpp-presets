...
@NoOffset @Name("std::tuple<torch::Tensor,std::vector<torch::Tensor> >") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class T_TensorTensorVector_T extends Pointer {
    static { Loader.load(); }
