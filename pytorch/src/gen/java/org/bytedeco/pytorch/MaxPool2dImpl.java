...
public class MaxPool2dImpl extends MaxPool2dImplBase {
    ...
    public MaxPool2dImpl(Module pointer) { super((Pointer)null); allocate(pointer); }
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::MaxPool2dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
