...
public class AdaptiveMaxPool1dImpl extends AdaptiveMaxPool1dImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::AdaptiveMaxPool1dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
