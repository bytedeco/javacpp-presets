...
public class MaxUnpool2dImplBase extends MaxUnpool2dImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::MaxUnpoolImpl<2,torch::nn::MaxUnpool2dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
