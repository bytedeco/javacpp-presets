 ...
 *  See the documentation for {@code SoftMarginLossImpl} class to learn what methods it
 *  provides, and examples of how to use {@code SoftMarginLoss} with {@code torch::nn::SoftMarginLossOptions}.
