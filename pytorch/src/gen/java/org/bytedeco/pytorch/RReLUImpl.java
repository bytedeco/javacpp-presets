...
public class RReLUImpl extends RReLUImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::RReLUImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
