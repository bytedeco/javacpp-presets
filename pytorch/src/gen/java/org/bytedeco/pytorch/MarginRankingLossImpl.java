...
public class MarginRankingLossImpl extends MarginRankingLossImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::MarginRankingLossImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
