...
@Name("c10::ArrayRef<int64_t>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class LongArrayRef extends LongHeaderOnlyArrayRef {
    static { Loader.load(); }


   public LongArrayRef() { super((Pointer)null); allocate(); }
