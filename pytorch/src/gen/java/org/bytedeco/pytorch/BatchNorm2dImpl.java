...
public class BatchNorm2dImpl extends BatchNorm2dImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::BatchNorm2dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
