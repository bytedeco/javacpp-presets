...
private native void allocate(@Cast("int64_t") long in_features, @Cast("int64_t") long n_classes, @ByVal @Cast("std::vector<int64_t>*") LongVector cutoffs);
  public native @Cast("int64_t*") @ByRef @NoException LongPointer in_features();
  public native @Cast("int64_t*") @ByRef @NoException LongPointer n_classes();
  public native @Cast("std::vector<int64_t>*") @ByRef @NoException LongVector cutoffs();
  public native @ByRef @NoException DoublePointer div_value();
  public native @Cast("bool*") @ByRef @NoException BoolPointer head_bias();
}
