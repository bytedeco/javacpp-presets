...
public class UpsampleMode extends Pointer {
    ...
    @Namespace @Name("c10::get<0>") public static native @ByRef kNearest get0(@ByRef UpsampleMode container);
    @ValueSetter public native UpsampleMode put(@ByRef kNearest value);
    public @ByRef kLinear get1() { return get1(this); }
    @Namespace @Name("c10::get<1>") public static native @ByRef kLinear get1(@ByRef UpsampleMode container);
    @ValueSetter public native UpsampleMode put(@ByRef kLinear value);
    public @ByRef kBilinear get2() { return get2(this); }
    @Namespace @Name("c10::get<2>") public static native @ByRef kBilinear get2(@ByRef UpsampleMode container);
    @ValueSetter public native UpsampleMode put(@ByRef kBilinear value);
    public @ByRef kBicubic get3() { return get3(this); }
    @Namespace @Name("c10::get<3>") public static native @ByRef kBicubic get3(@ByRef UpsampleMode container);
    @ValueSetter public native UpsampleMode put(@ByRef kBicubic value);
    public @ByRef kTrilinear get4() { return get4(this); }
    @Namespace @Name("c10::get<4>") public static native @ByRef kTrilinear get4(@ByRef UpsampleMode container);
