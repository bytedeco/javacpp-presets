...
public class AdaptiveMaxPool1dImplBase extends AdaptiveMaxPool1dImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::AdaptiveMaxPoolImpl<1,torch::ExpandingArray<1>,torch::nn::AdaptiveMaxPool1dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
