...
public class AliasInfo extends Pointer {
  ...
  public AliasInfo(@Cast("bool") boolean is_write, @Const @ByRef OrderedStringSet before_qual_strings, @Const @ByRef OrderedStringSet after_qual_strings) { super((Pointer)null); allocate(is_write, before_qual_strings, after_qual_strings); }
  private native void allocate(@Cast("bool") boolean is_write, @Const @ByRef OrderedStringSet before_qual_strings, @Const @ByRef OrderedStringSet after_qual_strings);
