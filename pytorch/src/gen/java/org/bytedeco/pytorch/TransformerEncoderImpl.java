...
public class TransformerEncoderImpl extends TransformerEncoderImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::TransformerEncoderImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
