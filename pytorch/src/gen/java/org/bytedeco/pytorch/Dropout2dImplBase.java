...
public class Dropout2dImplBase extends Dropout2dImplCloneable {
    ...
    public Dropout2dImplBase(Module pointer) { super((Pointer)null); allocate(pointer); }
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::detail::_DropoutNd<torch::nn::Dropout2dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
