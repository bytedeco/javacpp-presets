...
@Name("c10::intrusive_ptr<c10::ivalue::Object>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class ObjPtr extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ObjPtr(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ObjPtr(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ObjPtr position(long position) {
        return (ObjPtr)super.position(position);
    }
    @Override public ObjPtr getPointer(long i) {
        return new ObjPtr((Pointer)this).offsetAddress(i);
    }


  public ObjPtr() { super((Pointer)null); allocate(); }
  @NoException(true) private native void allocate();

  public ObjPtr(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0) { super((Pointer)null); allocate(arg0); }
  ...
  public ObjPtr(Object target, @ByVal DontIncreaseRefcount arg1) { super((Pointer)null); allocate(target, arg1); }
  @NoException(true) private native void allocate(Object target, @ByVal DontIncreaseRefcount arg1);

  

  public ObjPtr(@ByRef(true) ObjPtr rhs) { super((Pointer)null); allocate(rhs); }
  @NoException(true) private native void allocate(@ByRef(true) ObjPtr rhs);
   ...
   */
  public native @NoException(true) Object release();
   ...
   */
  public static native @ByVal ObjPtr reclaim(Object owning_ptr);
   ...
   * ownership.
   */
  public static native @ByVal ObjPtr reclaim_copy(Object owning_ptr);
   ...
   */
  public static native @ByVal ObjPtr unsafe_steal_from_new(Object raw_ptr);
   ...
   */
  public static native @ByVal ObjPtr unsafe_reclaim_from_nonowning(Object raw_ptr);
}
