...
public class BatchNorm3dImplBaseBase extends BatchNorm3dImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::NormImplBase<3,torch::nn::BatchNorm3dImpl,torch::nn::BatchNormOptions>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
