...
public class SharedAnyModuleVector extends Pointer {
    ...
    public SharedAnyModuleVector(AnyModule value) { this(1); put(0, value); }
    public SharedAnyModuleVector(AnyModule ... array) { this(array.length); put(array); }
    ...
    public native @ByVal Iterator insert(@ByVal Iterator pos, @SharedPtr("torch::nn::AnyModule") AnyModule value);
    ...
    @NoOffset @Name("iterator") public static class Iterator extends Pointer {
        ...
        public native @Name("operator *") @SharedPtr("torch::nn::AnyModule") @Const AnyModule get();
    }
