...
public class NamedIValuePolicy extends Pointer {
    ...
    public NamedIValuePolicy() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public NamedIValuePolicy(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public NamedIValuePolicy(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public NamedIValuePolicy position(long position) {
        return (NamedIValuePolicy)super.position(position);
    }
    @Override public NamedIValuePolicy getPointer(long i) {
        return new NamedIValuePolicy((Pointer)this).offsetAddress(i);
    }
