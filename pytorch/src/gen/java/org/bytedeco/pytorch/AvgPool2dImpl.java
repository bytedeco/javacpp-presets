...
public class AvgPool2dImpl extends AvgPool2dImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::AvgPool2dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
