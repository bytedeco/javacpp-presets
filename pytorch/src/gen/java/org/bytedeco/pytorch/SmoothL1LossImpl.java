...
public class SmoothL1LossImpl extends SmoothL1LossImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::SmoothL1LossImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
