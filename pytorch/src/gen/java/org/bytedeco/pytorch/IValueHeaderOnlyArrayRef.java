...
@Name("c10::HeaderOnlyArrayRef<c10::IValue>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class IValueHeaderOnlyArrayRef extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public IValueHeaderOnlyArrayRef(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public IValueHeaderOnlyArrayRef(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public IValueHeaderOnlyArrayRef position(long position) {
        return (IValueHeaderOnlyArrayRef)super.position(position);
    }
    @Override public IValueHeaderOnlyArrayRef getPointer(long i) {
        return new IValueHeaderOnlyArrayRef((Pointer)this).offsetAddress(i);
    }
  ...
  /* implicit */ public IValueHeaderOnlyArrayRef() { super((Pointer)null); allocate(); }
private native void allocate();
  ...
  public IValueHeaderOnlyArrayRef(@Const IValue data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  private native void allocate(@Const IValue data, @Cast("size_t") long length);

  /** Construct a HeaderOnlyArrayRef from a range. */
  public IValueHeaderOnlyArrayRef(@Const IValue begin, @Const IValue end) { super((Pointer)null); allocate(begin, end); }
  ...
  public native @Const @ByVal IValueHeaderOnlyArrayRef slice(@Cast("size_t") long N, @Cast("size_t") long M);

  /** slice(n) - Chop off the first N elements of the array. */
  public native @Const @ByVal IValueHeaderOnlyArrayRef slice(@Cast("size_t") long N);
