...
@Name("c10::HeaderOnlyArrayRef<c10::Argument>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class ArgumentHeaderOnlyArrayRef extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ArgumentHeaderOnlyArrayRef(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ArgumentHeaderOnlyArrayRef(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ArgumentHeaderOnlyArrayRef position(long position) {
        return (ArgumentHeaderOnlyArrayRef)super.position(position);
    }
    @Override public ArgumentHeaderOnlyArrayRef getPointer(long i) {
        return new ArgumentHeaderOnlyArrayRef((Pointer)this).offsetAddress(i);
    }
  ...
  /* implicit */ public ArgumentHeaderOnlyArrayRef() { super((Pointer)null); allocate(); }
private native void allocate();
  ...
  public ArgumentHeaderOnlyArrayRef(@Const Argument data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  private native void allocate(@Const Argument data, @Cast("size_t") long length);

  /** Construct a HeaderOnlyArrayRef from a range. */
  public ArgumentHeaderOnlyArrayRef(@Const Argument begin, @Const Argument end) { super((Pointer)null); allocate(begin, end); }
  ...
  public native @Const @ByVal ArgumentHeaderOnlyArrayRef slice(@Cast("size_t") long N, @Cast("size_t") long M);

  /** slice(n) - Chop off the first N elements of the array. */
  public native @Const @ByVal ArgumentHeaderOnlyArrayRef slice(@Cast("size_t") long N);
