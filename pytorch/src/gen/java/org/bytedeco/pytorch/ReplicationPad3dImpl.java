...
public class ReplicationPad3dImpl extends ReplicationPad3dImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::ReplicationPad3dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
