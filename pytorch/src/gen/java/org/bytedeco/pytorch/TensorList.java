...
@Name("c10::List<at::Tensor>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class TensorList extends Pointer {
  ...
  public TensorList(@Const @ByRef TensorList arg0) { super((Pointer)null); allocate(arg0); }
  private native void allocate(@Const @ByRef TensorList arg0);
  public native @ByRef @Name("operator =") TensorList put(@Const @ByRef TensorList arg0);
   ...
   */
  public native @ByVal Tensor extract(long pos);
   ...
   */
  public native void set(long pos, @ByVal Tensor value);
   ...
   */
  public native @ByVal @Cast("c10::List<at::Tensor>::iterator*") TensorListIterator begin();

  /**
   * Returns an iterator to the element following the last element of the container.
   * This element acts as a placeholder; attempting to access it results in undefined behavior.
   */
  public native @ByVal @Cast("c10::List<at::Tensor>::iterator*") TensorListIterator end();
   ...
   */
  public native @ByVal @Cast("c10::List<at::Tensor>::iterator*") TensorListIterator insert(@ByVal @Cast("c10::List<at::Tensor>::iterator*") TensorListIterator pos, @Const @ByRef Tensor value);
   ...
   * May invalidate any references, pointers, or iterators referring to contained elements. Any past-the-end iterators may also be invalidated.
   */
  public native void push_back(@Const @ByRef Tensor value);
   ...
   * May invalidate any references, pointers, or iterators referring to contained elements. Any past-the-end iterators may also be invalidated.
   */
  public native void append(@ByVal TensorList lst);
   ...
   * May invalidate any references, pointers, or iterators referring to contained elements. Any past-the-end iterators may also be invalidated.
   */
  public native @ByVal @Cast("c10::List<at::Tensor>::iterator*") TensorListIterator erase(@ByVal @Cast("c10::List<at::Tensor>::iterator*") TensorListIterator pos);

  /**
   * Removes the elements in the range [first, last).
   * May invalidate any references, pointers, or iterators referring to contained elements. Any past-the-end iterators may also be invalidated.
   */
  public native @ByVal @Cast("c10::List<at::Tensor>::iterator*") TensorListIterator erase(@ByVal @Cast("c10::List<at::Tensor>::iterator*") TensorListIterator first, @ByVal @Cast("c10::List<at::Tensor>::iterator*") TensorListIterator last);
   ...
   * May invalidate any references, pointers, or iterators referring to contained elements. Any past-the-end iterators may also be invalidated.
   */
  public native void resize(long count, @Const @ByRef Tensor value);
