...
public class RNNCellOptionsBase extends Pointer {
  ...
  public RNNCellOptionsBase(
        @Cast("int64_t") long input_size,
        @Cast("int64_t") long hidden_size,
        @Cast("bool") boolean bias,
        @Cast("int64_t") long num_chunks) { super((Pointer)null); allocate(input_size, hidden_size, bias, num_chunks); }
  private native void allocate(
        @Cast("int64_t") long input_size,
        @Cast("int64_t") long hidden_size,
        @Cast("bool") boolean bias,
        @Cast("int64_t") long num_chunks);
