...
public class TensorArg extends Pointer {
  ...
  public native @ByRef Tensor tensor(); public native TensorArg tensor(Tensor setter);
  ...
  public TensorArg(@ByVal Tensor tensor, @Cast("const char*") BytePointer name, int pos) { super((Pointer)null); allocate(tensor, name, pos); }
  private native void allocate(@ByVal Tensor tensor, @Cast("const char*") BytePointer name, int pos);
  public TensorArg(@ByVal Tensor tensor, String name, int pos) { super((Pointer)null); allocate(tensor, name, pos); }
  private native void allocate(@ByVal Tensor tensor, String name, int pos);
