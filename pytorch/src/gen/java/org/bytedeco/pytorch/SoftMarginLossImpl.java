...
public class SoftMarginLossImpl extends SoftMarginLossImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::SoftMarginLossImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
