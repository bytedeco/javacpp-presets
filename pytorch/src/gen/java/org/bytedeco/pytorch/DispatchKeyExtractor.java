...
public class DispatchKeyExtractor extends Pointer {
  ...
  public native @ByVal DispatchKeySet getDispatchKeySetFromRawDispatchKeySet(
        @ByVal DispatchKeySet ks,
        @ByVal(nullValue = "c10::DispatchKeySet(c10::DispatchKeySet::FULL)") DispatchKeySet key_mask);
  public native @ByVal DispatchKeySet getDispatchKeySetFromRawDispatchKeySet(
        @ByVal DispatchKeySet ks);

  public native @ByVal DispatchKeySet getDispatchKeySetBoxed(@Const IValueVector stack);

  public native @Const @ByRef bitset dispatchArgIndicesReverse();
