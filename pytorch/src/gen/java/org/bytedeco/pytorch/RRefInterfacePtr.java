...
@Name("c10::intrusive_ptr<c10::RRefInterface>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class RRefInterfacePtr extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public RRefInterfacePtr(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public RRefInterfacePtr(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public RRefInterfacePtr position(long position) {
        return (RRefInterfacePtr)super.position(position);
    }
    @Override public RRefInterfacePtr getPointer(long i) {
        return new RRefInterfacePtr((Pointer)this).offsetAddress(i);
    }


  public RRefInterfacePtr() { super((Pointer)null); allocate(); }
  @NoException(true) private native void allocate();

  public RRefInterfacePtr(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0) { super((Pointer)null); allocate(arg0); }
  ...
  public RRefInterfacePtr(RRefInterface target, @ByVal DontIncreaseRefcount arg1) { super((Pointer)null); allocate(target, arg1); }
  @NoException(true) private native void allocate(RRefInterface target, @ByVal DontIncreaseRefcount arg1);

  

  public RRefInterfacePtr(@ByRef(true) RRefInterfacePtr rhs) { super((Pointer)null); allocate(rhs); }
  @NoException(true) private native void allocate(@ByRef(true) RRefInterfacePtr rhs);
  ...
  public native @Name("operator ->") @NoException(true) RRefInterface access();

  public native @Cast("bool") @Name("operator bool") @NoException(true) boolean asBoolean();

  public native @NoException(true) void reset();

  public native @NoException(true) void swap(@ByRef RRefInterfacePtr rhs);
   ...
   */
  public native @NoException(true) RRefInterface release();
   ...
   */
  public static native @ByVal RRefInterfacePtr reclaim(RRefInterface owning_ptr);
   ...
   * ownership.
   */
  public static native @ByVal RRefInterfacePtr reclaim_copy(RRefInterface owning_ptr);
   ...
   */
  public static native @ByVal RRefInterfacePtr unsafe_steal_from_new(RRefInterface raw_ptr);
   ...
   */
  public static native @ByVal RRefInterfacePtr unsafe_reclaim_from_nonowning(RRefInterface raw_ptr);
}
