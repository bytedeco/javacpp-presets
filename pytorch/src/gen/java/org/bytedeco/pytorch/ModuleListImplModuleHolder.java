...
@Name("torch::nn::ModuleHolder<torch::nn::ModuleListImpl>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class ModuleListImplModuleHolder extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ModuleListImplModuleHolder(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ModuleListImplModuleHolder(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ModuleListImplModuleHolder position(long position) {
   ...
   *  actually used. */
  public ModuleListImplModuleHolder() { super((Pointer)null); allocate(); }
   ...
   *  a value is assigned. */
  /* implicit */ public ModuleListImplModuleHolder(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0) { super((Pointer)null); allocate(arg0); }
private native void allocate(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0);
  ...
  /* implicit */ public ModuleListImplModuleHolder(@SharedPtr @Cast({"", "std::shared_ptr<torch::nn::ModuleListImpl>"}) ModuleListImpl module) { super((Pointer)null); allocate(module); }
private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<torch::nn::ModuleListImpl>"}) ModuleListImpl module);
  ...
  public native @Name("operator ->") ModuleListImpl access();

  /** Forwards to the contained module. */

  /** Returns a reference to the contained module. */
  public native @ByRef @Name("operator *") ModuleListImpl multiply();

  /** Returns a const reference to the contained module. */

  /** Returns a shared pointer to the underlying module. */
  public native @SharedPtr @Cast({"", "std::shared_ptr<torch::nn::ModuleListImpl>"}) ModuleListImpl ptr();
