...
@Name("c10::HeaderOnlyArrayRef<jbyte>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class ByteHeaderOnlyArrayRef extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ByteHeaderOnlyArrayRef(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ByteHeaderOnlyArrayRef(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ByteHeaderOnlyArrayRef position(long position) {
        return (ByteHeaderOnlyArrayRef)super.position(position);
    }
    @Override public ByteHeaderOnlyArrayRef getPointer(long i) {
        return new ByteHeaderOnlyArrayRef((Pointer)this).offsetAddress(i);
    }
  ...
  /* implicit */ public ByteHeaderOnlyArrayRef() { super((Pointer)null); allocate(); }
private native void allocate();
  ...
  public ByteHeaderOnlyArrayRef(@Const BytePointer data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  private native void allocate(@Const BytePointer data, @Cast("size_t") long length);
  public ByteHeaderOnlyArrayRef(@Const ByteBuffer data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  private native void allocate(@Const ByteBuffer data, @Cast("size_t") long length);
  public ByteHeaderOnlyArrayRef(@Const byte[] data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  private native void allocate(@Const byte[] data, @Cast("size_t") long length);

  /** Construct a HeaderOnlyArrayRef from a range. */
  public ByteHeaderOnlyArrayRef(@Const BytePointer begin, @Const BytePointer end) { super((Pointer)null); allocate(begin, end); }
  private native void allocate(@Const BytePointer begin, @Const BytePointer end);
  public ByteHeaderOnlyArrayRef(@Const ByteBuffer begin, @Const ByteBuffer end) { super((Pointer)null); allocate(begin, end); }
  private native void allocate(@Const ByteBuffer begin, @Const ByteBuffer end);
  public ByteHeaderOnlyArrayRef(@Const byte[] begin, @Const byte[] end) { super((Pointer)null); allocate(begin, end); }
  ...
  public native @Const @ByVal ByteHeaderOnlyArrayRef slice(@Cast("size_t") long N, @Cast("size_t") long M);

  /** slice(n) - Chop off the first N elements of the array. */
  public native @Const @ByVal ByteHeaderOnlyArrayRef slice(@Cast("size_t") long N);
