...
public class ThresholdImpl extends ThresholdImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::ThresholdImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
