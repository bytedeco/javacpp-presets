...
public class Float8_e8m0fnu extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public Float8_e8m0fnu(Pointer p) { super(p); }

  public native @Cast("uint8_t") byte x(); public native Float8_e8m0fnu x(byte setter);
  ...
  public Float8_e8m0fnu() { super((Pointer)null); allocate(); }
  private native void allocate();

  public Float8_e8m0fnu(@Cast("uint8_t") byte bits, @ByVal from_bits_t arg1) { super((Pointer)null); allocate(bits, arg1); }
  private native void allocate(@Cast("uint8_t") byte bits, @ByVal from_bits_t arg1);
  public Float8_e8m0fnu(float value) { super((Pointer)null); allocate(value); }
