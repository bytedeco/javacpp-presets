...
@Name("c10::HeaderOnlyArrayRef<int64_t>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class LongHeaderOnlyArrayRef extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public LongHeaderOnlyArrayRef(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public LongHeaderOnlyArrayRef(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public LongHeaderOnlyArrayRef position(long position) {
        return (LongHeaderOnlyArrayRef)super.position(position);
    }
    @Override public LongHeaderOnlyArrayRef getPointer(long i) {
        return new LongHeaderOnlyArrayRef((Pointer)this).offsetAddress(i);
    }
  ...
  /* implicit */ public LongHeaderOnlyArrayRef() { super((Pointer)null); allocate(); }
private native void allocate();
  ...
  public LongHeaderOnlyArrayRef(@Cast("const int64_t*") LongPointer data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  private native void allocate(@Cast("const int64_t*") LongPointer data, @Cast("size_t") long length);
  public LongHeaderOnlyArrayRef(@Cast("const int64_t*") LongBuffer data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  private native void allocate(@Cast("const int64_t*") LongBuffer data, @Cast("size_t") long length);
  public LongHeaderOnlyArrayRef(@Cast("const int64_t*") long[] data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  ...
  public LongHeaderOnlyArrayRef(@Cast("const int64_t*") LongPointer begin, @Cast("const int64_t*") LongPointer end) { super((Pointer)null); allocate(begin, end); }
  private native void allocate(@Cast("const int64_t*") LongPointer begin, @Cast("const int64_t*") LongPointer end);
  public LongHeaderOnlyArrayRef(@Cast("const int64_t*") LongBuffer begin, @Cast("const int64_t*") LongBuffer end) { super((Pointer)null); allocate(begin, end); }
  private native void allocate(@Cast("const int64_t*") LongBuffer begin, @Cast("const int64_t*") LongBuffer end);
  public LongHeaderOnlyArrayRef(@Cast("const int64_t*") long[] begin, @Cast("const int64_t*") long[] end) { super((Pointer)null); allocate(begin, end); }
  ...
  public native @Const @ByVal LongHeaderOnlyArrayRef slice(@Cast("size_t") long N, @Cast("size_t") long M);

  /** slice(n) - Chop off the first N elements of the array. */
  public native @Const @ByVal LongHeaderOnlyArrayRef slice(@Cast("size_t") long N);
