...
@Name("c10::ArrayRef<c10::Symbol>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class SymbolArrayRef extends SymbolHeaderOnlyArrayRef {
    static { Loader.load(); }


   public SymbolArrayRef() { super((Pointer)null); allocate(); }
