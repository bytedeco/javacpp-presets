...
public class MemoryFormatType extends MemoryFormattEnumerationType {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public MemoryFormatType(Pointer p) { super(p); }

public native @StdString BytePointer str();
@MemberGetter public static native TypeKind Kind();
// global singleton
public static native @ByVal @Cast("c10::MemoryFormatTypePtr*") SingletonTypePtr get();
}
