...
public class Dispatcher extends Pointer {
  ...
  public native @StdVector OperatorName getAllOpNamesForDispatchKey(DispatchKey k);
  public native @StdVector OperatorName getAllOpNamesForDispatchKey(@Cast("c10::DispatchKey") short k);
