...
@Name("c10::ArrayRef<c10::SymInt>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
...
private native void allocate();
  ...
  public SymIntArrayRef(@Const @ByRef SymInt OneElt) { super((Pointer)null); allocate(OneElt); }
  private native void allocate(@Const @ByRef SymInt OneElt);

  /** Construct an ArrayRef from a pointer and length. */
  public SymIntArrayRef(@Const SymInt data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  private native void allocate(@Const SymInt data, @Cast("size_t") long length);

  /** Construct an ArrayRef from a range. */
  public SymIntArrayRef(@Const SymInt begin, @Const SymInt end) { super((Pointer)null); allocate(begin, end); }
  private native void allocate(@Const SymInt begin, @Const SymInt end);
  ...
  public native @Const @ByPtr SymInt begin();
  public native @Const @ByPtr SymInt end();
