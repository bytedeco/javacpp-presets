...
@Name("c10::ArrayRef<c10::SymInt>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class SymIntArrayRef extends SymIntHeaderOnlyArrayRef {
    static { Loader.load(); }


   public SymIntArrayRef() { super((Pointer)null); allocate(); }
