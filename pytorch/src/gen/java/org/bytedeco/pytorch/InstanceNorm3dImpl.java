...
public class InstanceNorm3dImpl extends InstanceNorm3dImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::InstanceNorm3dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
