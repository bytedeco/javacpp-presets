...
@Name("c10::ArrayRef<at::Dimname>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class DimnameArrayRef extends DimnameHeaderOnlyArrayRef {
    static { Loader.load(); }
