...
public class CUDAGuard extends Pointer {
  ...
  public CUDAGuard(@Cast("c10::DeviceIndex") byte device_index) { super((Pointer)null); allocate(device_index); }
  private native void allocate(@Cast("c10::DeviceIndex") byte device_index);
