...
public class TensorTensorTensorTensorVectorTuple extends Pointer {
    ...
    public TensorTensorTensorTensorVectorTuple(@ByRef Tensor value0, @ByRef Tensor value1, @ByRef Tensor value2, @StdMove TensorVector value3) { allocate(value0, value1, value2, value3); }
    private native void allocate(@ByRef Tensor value0, @ByRef Tensor value1, @ByRef Tensor value2, @StdMove TensorVector value3);
    ...
    public @StdMove TensorVector get3() { return get3(this); }
    @Namespace @Name("std::get<3>") public static native @StdMove TensorVector get3(@ByRef TensorTensorTensorTensorVectorTuple container);
}
