...
@Name("torch::nn::Cloneable<torch::nn::MaxUnpool1dImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class MaxUnpool1dImplCloneable extends Module {
    static { Loader.load(); }
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::Cloneable<torch::nn::MaxUnpool1dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
