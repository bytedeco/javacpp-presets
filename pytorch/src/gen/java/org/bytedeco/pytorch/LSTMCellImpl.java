...
public class LSTMCellImpl extends LSTMCellImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::LSTMCellImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
