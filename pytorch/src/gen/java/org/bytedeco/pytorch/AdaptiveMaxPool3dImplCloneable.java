...
@Name("torch::nn::Cloneable<torch::nn::AdaptiveMaxPool3dImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class AdaptiveMaxPool3dImplCloneable extends Module {
    static { Loader.load(); }
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::Cloneable<torch::nn::AdaptiveMaxPool3dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
