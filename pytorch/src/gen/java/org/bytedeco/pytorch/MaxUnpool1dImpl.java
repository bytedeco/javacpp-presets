...
public class MaxUnpool1dImpl extends MaxUnpool1dImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::MaxUnpool1dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
