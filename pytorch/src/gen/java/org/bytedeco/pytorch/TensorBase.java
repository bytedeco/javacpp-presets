...
// #endif
   ...
   *  }</pre> */
  public native @Cast("unsigned") @Name("register_hook<std::function<void(at::TensorBase)> >") int register_hook(@ByRef(true) VoidTensorHook hook);
  public native @Cast("unsigned") @Name("register_hook<std::function<at::TensorBase(at::TensorBase)> >") int register_hook(@ByRef(true) TensorTensorHook hook);
