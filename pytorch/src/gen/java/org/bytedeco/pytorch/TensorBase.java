...
public class TensorBase extends AbstractTensor {
  ...
  public native @Const @ByRef TensorImplPtr getIntrusivePtr();

  public native @ByVal TensorImplPtr unsafeReleaseIntrusivePtr();
  ...
  public native @ByVal QuantizerPtr quantizer();
