 ...
 *  */
@Name("c10::SmallVector<int64_t,at::kDimVectorStaticSize>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class DimVector extends DimVectorImpl {
  ...
  public native @Const @ByRef @Name("operator =") DimVector put(@Const @ByRef DimVector RHS);
