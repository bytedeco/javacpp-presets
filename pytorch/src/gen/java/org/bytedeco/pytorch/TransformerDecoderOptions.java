...
public class TransformerDecoderOptions extends Pointer {
  ...
  public native @ByRef @NoException(true) TransformerDecoderOptions num_layers(@Cast("int64_t") long setter);
  public native @ByRef @NoException(true) TransformerDecoderOptions norm(@ByVal AnyModule setter);
}
