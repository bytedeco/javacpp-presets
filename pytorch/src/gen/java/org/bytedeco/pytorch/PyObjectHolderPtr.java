...
@Name("c10::intrusive_ptr<c10::ivalue::PyObjectHolder>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class PyObjectHolderPtr extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public PyObjectHolderPtr(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public PyObjectHolderPtr(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public PyObjectHolderPtr position(long position) {
        return (PyObjectHolderPtr)super.position(position);
    }
    @Override public PyObjectHolderPtr getPointer(long i) {
        return new PyObjectHolderPtr((Pointer)this).offsetAddress(i);
    }


  public PyObjectHolderPtr() { super((Pointer)null); allocate(); }
  @NoException(true) private native void allocate();

  public PyObjectHolderPtr(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0) { super((Pointer)null); allocate(arg0); }
  ...
  public PyObjectHolderPtr(PyObjectHolder target, @ByVal DontIncreaseRefcount arg1) { super((Pointer)null); allocate(target, arg1); }
  @NoException(true) private native void allocate(PyObjectHolder target, @ByVal DontIncreaseRefcount arg1);

  

  public PyObjectHolderPtr(@ByRef(true) PyObjectHolderPtr rhs) { super((Pointer)null); allocate(rhs); }
  @NoException(true) private native void allocate(@ByRef(true) PyObjectHolderPtr rhs);
  ...
  public native @Name("operator ->") @NoException(true) PyObjectHolder access();

  public native @Cast("bool") @Name("operator bool") @NoException(true) boolean asBoolean();

  public native @NoException(true) void reset();

  public native @NoException(true) void swap(@ByRef PyObjectHolderPtr rhs);
   ...
   */
  public native @NoException(true) PyObjectHolder release();
   ...
   */
  public static native @ByVal PyObjectHolderPtr reclaim(PyObjectHolder owning_ptr);
   ...
   * ownership.
   */
  public static native @ByVal PyObjectHolderPtr reclaim_copy(PyObjectHolder owning_ptr);
   ...
   */
  public static native @ByVal PyObjectHolderPtr unsafe_steal_from_new(PyObjectHolder raw_ptr);
   ...
   */
  public static native @ByVal PyObjectHolderPtr unsafe_reclaim_from_nonowning(PyObjectHolder raw_ptr);
}
