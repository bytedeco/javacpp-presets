...
public class SymNode extends Pointer {
  ...
  public native @Cast("bool") boolean guard_or_false(@Cast("const char*") BytePointer file, @Cast("int64_t") long line);
  public native @Cast("bool") boolean guard_or_false(String file, @Cast("int64_t") long line);
  public native @Cast("bool") boolean statically_known_true(@Cast("const char*") BytePointer file, @Cast("int64_t") long line);
  public native @Cast("bool") boolean statically_known_true(String file, @Cast("int64_t") long line);
  public native @Cast("bool") boolean guard_or_true(@Cast("const char*") BytePointer file, @Cast("int64_t") long line);
