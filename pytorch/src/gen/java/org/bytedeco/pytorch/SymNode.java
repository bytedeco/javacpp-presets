...
@Name("c10::intrusive_ptr<c10::SymNodeImpl>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class SymNode extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public SymNode(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public SymNode(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public SymNode position(long position) {
        return (SymNode)super.position(position);
    }
    @Override public SymNode getPointer(long i) {
        return new SymNode((Pointer)this).offsetAddress(i);
    }
  ...
  public SymNode(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0) { super((Pointer)null); allocate(arg0); }
  ...
  public SymNode(SymNodeImpl target, @ByVal DontIncreaseRefcount arg1) { super((Pointer)null); allocate(target, arg1); }
  @NoException(true) private native void allocate(SymNodeImpl target, @ByVal DontIncreaseRefcount arg1);

  

  public SymNode(@ByRef(true) SymNode rhs) { super((Pointer)null); allocate(rhs); }
  @NoException(true) private native void allocate(@ByRef(true) SymNode rhs);
  ...
  public native @Name("operator ->") @NoException(true) SymNodeImpl access();

  public native @Cast("bool") @Name("operator bool") @NoException(true) boolean asBoolean();

  public native @NoException(true) void reset();

  public native @NoException(true) void swap(@ByRef SymNode rhs);
   ...
   */
  public native @NoException(true) SymNodeImpl release();
   ...
   */
  public static native @ByVal SymNode reclaim(SymNodeImpl owning_ptr);
   ...
   * ownership.
   */
  public static native @ByVal SymNode reclaim_copy(SymNodeImpl owning_ptr);
   ...
   */
  public static native @ByVal SymNode unsafe_steal_from_new(SymNodeImpl raw_ptr);
   ...
   */
  public static native @ByVal SymNode unsafe_reclaim_from_nonowning(SymNodeImpl raw_ptr);
}
