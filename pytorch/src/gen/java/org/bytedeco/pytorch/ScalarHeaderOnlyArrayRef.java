...
@Name("c10::HeaderOnlyArrayRef<at::Scalar>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class ScalarHeaderOnlyArrayRef extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ScalarHeaderOnlyArrayRef(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ScalarHeaderOnlyArrayRef(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ScalarHeaderOnlyArrayRef position(long position) {
        return (ScalarHeaderOnlyArrayRef)super.position(position);
    }
    @Override public ScalarHeaderOnlyArrayRef getPointer(long i) {
        return new ScalarHeaderOnlyArrayRef((Pointer)this).offsetAddress(i);
    }
  ...
  /* implicit */ public ScalarHeaderOnlyArrayRef() { super((Pointer)null); allocate(); }
private native void allocate();
  ...
  public ScalarHeaderOnlyArrayRef(@Const Scalar data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  private native void allocate(@Const Scalar data, @Cast("size_t") long length);

  /** Construct a HeaderOnlyArrayRef from a range. */
  public ScalarHeaderOnlyArrayRef(@Const Scalar begin, @Const Scalar end) { super((Pointer)null); allocate(begin, end); }
  ...
  public native @Const @ByVal ScalarHeaderOnlyArrayRef slice(@Cast("size_t") long N, @Cast("size_t") long M);

  /** slice(n) - Chop off the first N elements of the array. */
  public native @Const @ByVal ScalarHeaderOnlyArrayRef slice(@Cast("size_t") long N);
