...
@Name("torch::data::datasets::BatchDataset<javacpp::Dataset<torch::Tensor,torch::Tensor>,std::vector<torch::data::Example<torch::Tensor,torch::Tensor> > >") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class BatchDataset extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public BatchDataset(Pointer p) { super(p); }
