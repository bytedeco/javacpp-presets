...
package org.bytedeco.pytorch.data.options;
...
private native void allocate(@Cast("size_t") long batch_size);
   ...
   *  {@code print(...)} behavior. See {@link org.bytedeco.pytorch.DataLoaderConfigPrinter}. */
  @Override public String toString() { return org.bytedeco.pytorch.DataLoaderConfigPrinter.format(this); }
}
