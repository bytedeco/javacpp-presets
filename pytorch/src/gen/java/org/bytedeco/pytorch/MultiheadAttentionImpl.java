...
public class MultiheadAttentionImpl extends MultiheadAttentionImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::MultiheadAttentionImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
