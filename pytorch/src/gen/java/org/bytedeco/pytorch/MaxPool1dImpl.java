...
public class MaxPool1dImpl extends MaxPool1dImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::MaxPool1dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
