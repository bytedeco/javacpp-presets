...
public class SymbolicShapeMeta extends Pointer {
  ...
  public native @ByRef @Cast("c10::SymDimVector*") @NoOffset SmallLongVector sizes_(); public native SymbolicShapeMeta sizes_(SmallLongVector setter);
  public native @ByRef @Cast("c10::SymDimVector*") @NoOffset SmallLongVector strides_(); public native SymbolicShapeMeta strides_(SmallLongVector setter);
  ...
  public native @ByRef @Cast("c10::SmallVector<int64_t,5>*") SmallLongVector materialized_sizes_(); public native SymbolicShapeMeta materialized_sizes_(SmallLongVector setter);
  public native @ByRef @Cast("c10::SmallVector<int64_t,5>*") SmallLongVector materialized_strides_(); public native SymbolicShapeMeta materialized_strides_(SmallLongVector setter);
  ...
  public native @Cast("bool") boolean has_materialized_sizes();
  public native @Cast("bool") boolean has_materialized_strides();
  ...
  public native @ByVal LongArrayRef materialized_sizes();

  public native @ByVal LongArrayRef materialized_strides();
