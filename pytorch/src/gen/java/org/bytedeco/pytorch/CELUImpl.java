...
public class CELUImpl extends CELUImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::CELUImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
