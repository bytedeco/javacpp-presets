...
public class ReplicationPad2dImpl extends ReplicationPad2dImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::ReplicationPad2dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
