...
@Name("c10::HeaderOnlyArrayRef<size_t>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class SizeTHeaderOnlyArrayRef extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public SizeTHeaderOnlyArrayRef(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public SizeTHeaderOnlyArrayRef(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public SizeTHeaderOnlyArrayRef position(long position) {
        return (SizeTHeaderOnlyArrayRef)super.position(position);
    }
    @Override public SizeTHeaderOnlyArrayRef getPointer(long i) {
        return new SizeTHeaderOnlyArrayRef((Pointer)this).offsetAddress(i);
    }
  ...
  /* implicit */ public SizeTHeaderOnlyArrayRef() { super((Pointer)null); allocate(); }
private native void allocate();
  ...
  public SizeTHeaderOnlyArrayRef(@Cast("const size_t*") SizeTPointer data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  ...
  public SizeTHeaderOnlyArrayRef(@Cast("const size_t*") SizeTPointer begin, @Cast("const size_t*") SizeTPointer end) { super((Pointer)null); allocate(begin, end); }
  ...
  public native @Const @ByVal SizeTHeaderOnlyArrayRef slice(@Cast("size_t") long N, @Cast("size_t") long M);

  /** slice(n) - Chop off the first N elements of the array. */
  public native @Const @ByVal SizeTHeaderOnlyArrayRef slice(@Cast("size_t") long N);
