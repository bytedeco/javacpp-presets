...
public class ConvTranspose2dImpl extends ConvTranspose2dImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::ConvTranspose2dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
