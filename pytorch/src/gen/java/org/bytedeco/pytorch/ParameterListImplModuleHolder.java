...
@Name("torch::nn::ModuleHolder<torch::nn::ParameterListImpl>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class ParameterListImplModuleHolder extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ParameterListImplModuleHolder(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ParameterListImplModuleHolder(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ParameterListImplModuleHolder position(long position) {
        return (ParameterListImplModuleHolder)super.position(position);
    }
    @Override public ParameterListImplModuleHolder getPointer(long i) {
        return new ParameterListImplModuleHolder((Pointer)this).position(position + i);
    }
   ...
   *  actually used. */
  public ParameterListImplModuleHolder() { super((Pointer)null); allocate(); }
   ...
   *  a value is assigned. */
  /* implicit */ public ParameterListImplModuleHolder(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0) { super((Pointer)null); allocate(arg0); }
private native void allocate(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0);
  ...
  /* implicit */ public ParameterListImplModuleHolder(@SharedPtr @Cast({"", "std::shared_ptr<torch::nn::ParameterListImpl>"}) ParameterListImpl module) { super((Pointer)null); allocate(module); }
private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<torch::nn::ParameterListImpl>"}) ParameterListImpl module);
  ...
  public native @Name("operator ->") ParameterListImpl access();

  /** Forwards to the contained module. */

  /** Returns a reference to the contained module. */
  public native @ByRef @Name("operator *") ParameterListImpl multiply();

  /** Returns a const reference to the contained module. */

  /** Returns a shared pointer to the underlying module. */
  public native @SharedPtr @Cast({"", "std::shared_ptr<torch::nn::ParameterListImpl>"}) ParameterListImpl ptr();

  /** Returns a pointer to the underlying module. */
  public native ParameterListImpl get();
