...
@Name("c10::List<int64_t>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class LongList extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public LongList(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public LongList(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public LongList position(long position) {
        return (LongList)super.position(position);
    }
    @Override public LongList getPointer(long i) {
        return new LongList((Pointer)this).offsetAddress(i);
    }
   ...
   */
  public LongList() { super((Pointer)null); allocate(); }
  ...
  public LongList(@Const @ByRef LongList arg0) { super((Pointer)null); allocate(arg0); }
  private native void allocate(@Const @ByRef LongList arg0);
  public native @ByRef @Name("operator =") LongList put(@Const @ByRef LongList arg0);
   ...
   */
  public native long extract(long pos);
   ...
   */
  public native void set(long pos, long value);
   ...
   */
  public native @ByVal @Cast("c10::List<int64_t>::iterator*") LongListIterator begin();

  /**
   * Returns an iterator to the element following the last element of the container.
   * This element acts as a placeholder; attempting to access it results in undefined behavior.
   */
  public native @ByVal @Cast("c10::List<int64_t>::iterator*") LongListIterator end();
   ...
   */
  public native @ByVal @Cast("c10::List<int64_t>::iterator*") LongListIterator insert(@ByVal @Cast("c10::List<int64_t>::iterator*") LongListIterator pos, @Cast("const int64_t") long value);
   ...
   * May invalidate any references, pointers, or iterators referring to contained elements. Any past-the-end iterators may also be invalidated.
   */
  public native void push_back(@Cast("const int64_t") long value);
   ...
   * May invalidate any references, pointers, or iterators referring to contained elements. Any past-the-end iterators may also be invalidated.
   */
  public native void append(@ByVal LongList lst);
   ...
   * May invalidate any references, pointers, or iterators referring to contained elements. Any past-the-end iterators may also be invalidated.
   */
  public native @ByVal @Cast("c10::List<int64_t>::iterator*") LongListIterator erase(@ByVal @Cast("c10::List<int64_t>::iterator*") LongListIterator pos);

  /**
   * Removes the elements in the range [first, last).
   * May invalidate any references, pointers, or iterators referring to contained elements. Any past-the-end iterators may also be invalidated.
   */
  public native @ByVal @Cast("c10::List<int64_t>::iterator*") LongListIterator erase(@ByVal @Cast("c10::List<int64_t>::iterator*") LongListIterator first, @ByVal @Cast("c10::List<int64_t>::iterator*") LongListIterator last);
   ...
   * May invalidate any references, pointers, or iterators referring to contained elements. Any past-the-end iterators may also be invalidated.
   */
  public native void resize(long count, @Cast("const int64_t") long value);
   ...
   */
  public native @Cast("bool") boolean is(@Const @ByRef LongList rhs);
