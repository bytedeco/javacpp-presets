...
public class SavedTensorDefaultHooks extends Pointer {
  ...
  public static native @Cast("std::pair<c10::SafePyObject,c10::SafePyObject>*") @Optional Pointer get_hooks(@Cast("bool") boolean ignore_is_tracing/*=false*/);
  ...
  public static native void disable(
        @StdString BytePointer error_message,
        @Cast("const bool") boolean fail_if_non_empty/*=true*/);
  public static native void disable(
        @StdString BytePointer error_message);
  public static native void disable(
        @StdString String error_message,
        @Cast("const bool") boolean fail_if_non_empty/*=true*/);
  public static native void disable(
        @StdString String error_message);
