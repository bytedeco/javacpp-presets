...
@Name("c10::HeaderOnlyArrayRef<std::optional<at::Tensor> >") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class TensorOptionalHeaderOnlyArrayRef extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TensorOptionalHeaderOnlyArrayRef(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public TensorOptionalHeaderOnlyArrayRef(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public TensorOptionalHeaderOnlyArrayRef position(long position) {
        return (TensorOptionalHeaderOnlyArrayRef)super.position(position);
    }
    @Override public TensorOptionalHeaderOnlyArrayRef getPointer(long i) {
        return new TensorOptionalHeaderOnlyArrayRef((Pointer)this).offsetAddress(i);
    }
  ...
  /* implicit */ public TensorOptionalHeaderOnlyArrayRef() { super((Pointer)null); allocate(); }
private native void allocate();
  ...
  public TensorOptionalHeaderOnlyArrayRef(@Const TensorOptional data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  ...
  public TensorOptionalHeaderOnlyArrayRef(@Const TensorOptional begin, @Const TensorOptional end) { super((Pointer)null); allocate(begin, end); }
  ...
  public native @Const @ByVal TensorOptionalHeaderOnlyArrayRef slice(@Cast("size_t") long N, @Cast("size_t") long M);

  /** slice(n) - Chop off the first N elements of the array. */
  public native @Const @ByVal TensorOptionalHeaderOnlyArrayRef slice(@Cast("size_t") long N);
