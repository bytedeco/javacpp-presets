...
public class AdamW extends Optimizer {
   ...
   public AdamW(@ByVal OptimizerParamGroupVector param_groups,
   ...
   public AdamW(@ByVal OptimizerParamGroupVector param_groups) { super((Pointer)null); allocate(param_groups); }
   private native void allocate(@ByVal OptimizerParamGroupVector param_groups);
   public AdamW(
