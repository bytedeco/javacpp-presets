...
public class Tensor extends TensorBase {
  ...
  @SharedPtr private native void allocate(@Const @ByRef Tensor tensor);
  ...
  @SharedPtr private native void allocate(@Const @ByRef TensorBase base);
  /*implicit*/
  ...
  //example
  //Tensor * add(Tensor & b);
  public native void __dispatch__backward(@ByVal @Cast("at::TensorList*") TensorArrayRef inputs, @Const @ByRef(nullValue = "c10::optional<at::Tensor>{}") TensorOptional gradient, @ByVal(nullValue = "c10::optional<bool>(c10::nullopt)") BoolOptional retain_graph, @Cast("bool") boolean create_graph/*=false*/);
  public native void __dispatch__backward(@ByVal @Cast("at::TensorList*") TensorArrayRef inputs);
  ...
  public native @Cast({"", "std::vector<torch::Tensor>"}) @StdMove TensorVector tensor_split(@ByVal @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector long[] indices, @Cast("int64_t") long dim/*=0*/);
  public native @Cast({"", "std::vector<torch::Tensor>"}) @StdMove TensorVector tensor_split(@ByVal @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector long... indices);
  ...
  public native @Cast({"", "std::vector<torch::Tensor>"}) @StdMove TensorVector split(@ByVal @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector long[] split_size, @Cast("int64_t") long dim/*=0*/);
  public native @Cast({"", "std::vector<torch::Tensor>"}) @StdMove TensorVector split(@ByVal @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector long... split_size);
  ...
  public native @Cast({"", "std::vector<torch::Tensor>"}) @StdMove TensorVector unsafe_split_with_sizes(@ByVal @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector long[] split_sizes, @Cast("int64_t") long dim/*=0*/);
  public native @Cast({"", "std::vector<torch::Tensor>"}) @StdMove TensorVector unsafe_split_with_sizes(@ByVal @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector long... split_sizes);
  ...
  public native @Cast({"", "std::vector<torch::Tensor>"}) @StdMove TensorVector split_with_sizes(@ByVal @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector long[] split_sizes, @Cast("int64_t") long dim/*=0*/);
  public native @Cast({"", "std::vector<torch::Tensor>"}) @StdMove TensorVector split_with_sizes(@ByVal @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector long... split_sizes);
  ...
  public native @Cast({"", "std::vector<torch::Tensor>"}) @StdMove TensorVector hsplit(@ByVal @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector long... indices);
  ...
  public native @Cast({"", "std::vector<torch::Tensor>"}) @StdMove TensorVector vsplit(@ByVal @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector long... indices);
  ...
  public native @Cast({"", "std::vector<torch::Tensor>"}) @StdMove TensorVector dsplit(@ByVal @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector long... indices);
  ...
  public native void _backward(@ByVal @Cast("at::TensorList*") TensorArrayRef inputs, @Const @ByRef TensorOptional gradient, @ByVal BoolOptional keep_graph, @Cast("bool") boolean create_graph);
