...
public class Tensor extends TensorBase {
  ...
  public native @ByVal Tensor roll_symint(@ByVal SymIntArrayRef shifts, @ByVal(nullValue = "at::IntArrayRef{}") @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector long... dims);
  ...
  public native @ByVal Tensor _to_sparse_bsr(@ByVal @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector long[] blocksize, @ByVal(nullValue = "c10::optional<int64_t>(c10::nullopt)") LongOptional dense_dim);
  public native @ByVal Tensor _to_sparse_bsr(@ByVal @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector long... blocksize);
  ...
  public native @ByVal Tensor _to_sparse_bsc(@ByVal @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector long[] blocksize, @ByVal(nullValue = "c10::optional<int64_t>(c10::nullopt)") LongOptional dense_dim);
  public native @ByVal Tensor _to_sparse_bsc(@ByVal @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector long... blocksize);
