...
public class Tensor extends TensorBase {
  ...
  public native @ByRef Tensor rename_(@Cast("at::DimnameList*") @Optional ArgumentArrayRef names);
  public native @ByVal Tensor rename(@Cast("at::DimnameList*") @Optional ArgumentArrayRef names);
  public native @ByVal Tensor align_to(@ByVal @Cast("at::DimnameList*") ArgumentArrayRef names);
  public native @ByVal Tensor align_to(@ByVal @Cast("at::DimnameList*") ArgumentArrayRef order, @Cast("int64_t") long ellipsis_idx);
  public native @ByVal Tensor align_as(@Const @ByRef Tensor other);
  public native @ByVal Tensor refine_names(@ByVal @Cast("at::DimnameList*") ArgumentArrayRef names);
  ...
  public native @ByVal Tensor bincount_symint(@Const @ByRef(nullValue = "std::optional<at::Tensor>{}") TensorOptional weights, @ByVal(nullValue = "c10::SymInt(0)") SymInt minlength);
  public native @ByVal Tensor bincount_symint();
  ...
  public native @ByVal Tensor flatten(@ByVal @Cast("at::DimnameList*") ArgumentArrayRef dims, @ByVal Dimname out_dim);
  ...
  public native @ByVal Tensor unflatten(@ByVal Dimname dim, @ByVal LongArrayRef sizes, @ByVal @Cast("at::DimnameList*") ArgumentArrayRef names);
  public native @ByVal Tensor unflatten(@ByVal Dimname dim, @ByVal @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector("int64_t") long[] sizes, @ByVal @Cast("at::DimnameList*") ArgumentArrayRef names);
  public native @ByVal Tensor unflatten_symint(@ByVal Dimname dim, @ByVal SymIntArrayRef sizes, @ByVal @Cast("at::DimnameList*") ArgumentArrayRef names);
  ...
  public native @ByVal T_TensorTensor_T kthvalue_symint(@ByVal SymInt k, @Cast("int64_t") long dim/*=-1*/, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal T_TensorTensor_T kthvalue_symint(@ByVal SymInt k);
  ...
  public native @ByVal T_TensorTensor_T kthvalue_symint(@ByVal SymInt k, @ByVal Dimname dim, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal T_TensorTensor_T kthvalue_symint(@ByVal SymInt k, @ByVal Dimname dim);
  ...
  public native @ByVal Tensor logsumexp(@ByVal @Cast("at::DimnameList*") ArgumentArrayRef dim, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal Tensor logsumexp(@ByVal @Cast("at::DimnameList*") ArgumentArrayRef dim);
  ...
  public native @ByVal Tensor mean(@ByVal @Cast("at::DimnameList*") ArgumentArrayRef dim, @Cast("bool") boolean keepdim/*=false*/, @ByVal(nullValue = "std::optional<at::ScalarType>(::std::nullopt)") ScalarTypeOptional dtype);
  public native @ByVal Tensor mean(@ByVal @Cast("at::DimnameList*") ArgumentArrayRef dim);
  ...
  public native @ByVal Tensor sum(@ByVal @Cast("at::DimnameList*") ArgumentArrayRef dim, @Cast("bool") boolean keepdim/*=false*/, @ByVal(nullValue = "std::optional<at::ScalarType>(::std::nullopt)") ScalarTypeOptional dtype);
  public native @ByVal Tensor sum(@ByVal @Cast("at::DimnameList*") ArgumentArrayRef dim);
  ...
  public native @ByVal Tensor std(@ByVal @Cast("at::DimnameList*") ArgumentArrayRef dim, @Cast("bool") boolean unbiased, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal Tensor std(@ByVal @Cast("at::DimnameList*") ArgumentArrayRef dim, @Cast("bool") boolean unbiased);
  public native @ByVal Tensor std(@ByVal @Cast("at::DimnameList*") ArgumentArrayRef dim, @Const @ByRef(nullValue = "std::optional<at::Scalar>(::std::nullopt)") ScalarOptional correction, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal Tensor std(@ByVal @Cast("at::DimnameList*") ArgumentArrayRef dim);
  ...
  public native @ByVal Tensor var(@ByVal @Cast("at::DimnameList*") ArgumentArrayRef dim, @Cast("bool") boolean unbiased, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal Tensor var(@ByVal @Cast("at::DimnameList*") ArgumentArrayRef dim, @Cast("bool") boolean unbiased);
  public native @ByVal Tensor var(@ByVal @Cast("at::DimnameList*") ArgumentArrayRef dim, @Const @ByRef(nullValue = "std::optional<at::Scalar>(::std::nullopt)") ScalarOptional correction, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal Tensor var(@ByVal @Cast("at::DimnameList*") ArgumentArrayRef dim);
  ...
  public native @ByVal Tensor norm(@Const @ByRef ScalarOptional p, @ByVal @Cast("at::DimnameList*") ArgumentArrayRef dim, @Cast("bool") boolean keepdim, ScalarType dtype);
  public native @ByVal Tensor norm(@Const @ByRef ScalarOptional p, @ByVal @Cast("at::DimnameList*") ArgumentArrayRef dim, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal Tensor norm(@Const @ByRef ScalarOptional p, @ByVal @Cast("at::DimnameList*") ArgumentArrayRef dim);
  ...
  public native @ByVal Tensor nonzero_static_symint(@ByVal SymInt size, @Cast("int64_t") long fill_value/*=-1*/);
  public native @ByVal Tensor nonzero_static_symint(@ByVal SymInt size);
  ...
  public native @ByVal Tensor multinomial_symint(@ByVal SymInt num_samples, @Cast("bool") boolean replacement/*=false*/, @ByVal(nullValue = "std::optional<at::Generator>(::std::nullopt)") GeneratorOptional generator);
  public native @ByVal Tensor multinomial_symint(@ByVal SymInt num_samples);
