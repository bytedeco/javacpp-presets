...
public class SharedModuleVector extends Pointer {
    ...
    public SharedModuleVector(@Cast({"", "std::shared_ptr<torch::nn::Module>"}) Module value) { this(1); put(0, value); }
    public SharedModuleVector(@Cast({"", "std::shared_ptr<torch::nn::Module>"}) Module ... array) { this(array.length); put(array); }
    ...
    @Index(function = "at") public native @SharedPtr @Cast({"", "std::shared_ptr<torch::nn::Module>"}) Module get(@Cast("size_t") long i);
    public native SharedModuleVector put(@Cast("size_t") long i, Module value);

    public native @ByVal Iterator insert(@ByVal Iterator pos, @SharedPtr @Cast({"", "std::shared_ptr<torch::nn::Module>"}) Module value);
    ...
    @NoOffset @Name("iterator") public static class Iterator extends Pointer {
        ...
        public native @Name("operator *") @SharedPtr @Cast({"", "std::shared_ptr<torch::nn::Module>"}) Module get();
    }
