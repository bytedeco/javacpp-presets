...
@Name("torch::nn::ModuleHolder<torch::nn::TanhshrinkImpl>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class TanhshrinkImplModuleHolder extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TanhshrinkImplModuleHolder(Pointer p) { super(p); }
   ...
   *  a value is assigned. */
  /* implicit */ public TanhshrinkImplModuleHolder(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0) { super((Pointer)null); allocate(arg0); }
private native void allocate(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0);
  ...
  /* implicit */ public TanhshrinkImplModuleHolder(@SharedPtr @Cast({"", "std::shared_ptr<torch::nn::TanhshrinkImpl>"}) TanhshrinkImpl module) { super((Pointer)null); allocate(module); }
private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<torch::nn::TanhshrinkImpl>"}) TanhshrinkImpl module);
  ...
  public native @Name("operator ->") TanhshrinkImpl access();

  /** Forwards to the contained module. */

  /** Returns a reference to the contained module. */
  public native @ByRef @Name("operator *") TanhshrinkImpl multiply();

  /** Returns a const reference to the contained module. */

  /** Returns a shared pointer to the underlying module. */
  public native @SharedPtr @Cast({"", "std::shared_ptr<torch::nn::TanhshrinkImpl>"}) TanhshrinkImpl ptr();

  /** Returns a pointer to the underlying module. */
  public native TanhshrinkImpl get();
