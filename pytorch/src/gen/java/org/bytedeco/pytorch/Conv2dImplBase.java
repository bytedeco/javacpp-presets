...
public class Conv2dImplBase extends Conv2dImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::ConvNdImpl<2,torch::nn::Conv2dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
