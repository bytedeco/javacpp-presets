...
@Name("c10::intrusive_ptr<c10::ivalue::Future>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class FuturePtr extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FuturePtr(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FuturePtr(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public FuturePtr position(long position) {
        return (FuturePtr)super.position(position);
    }
    @Override public FuturePtr getPointer(long i) {
        return new FuturePtr((Pointer)this).offsetAddress(i);
    }


  public FuturePtr() { super((Pointer)null); allocate(); }
  @NoException(true) private native void allocate();

  public FuturePtr(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0) { super((Pointer)null); allocate(arg0); }
  ...
  public FuturePtr(Future target, @ByVal DontIncreaseRefcount arg1) { super((Pointer)null); allocate(target, arg1); }
  @NoException(true) private native void allocate(Future target, @ByVal DontIncreaseRefcount arg1);

  

  public FuturePtr(@ByRef(true) FuturePtr rhs) { super((Pointer)null); allocate(rhs); }
  @NoException(true) private native void allocate(@ByRef(true) FuturePtr rhs);
  ...
  public native @Name("operator ->") @NoException(true) Future access();

  public native @Cast("bool") @Name("operator bool") @NoException(true) boolean asBoolean();

  public native @NoException(true) void reset();

  public native @NoException(true) void swap(@ByRef FuturePtr rhs);
   ...
   */
  public native @NoException(true) Future release();
   ...
   */
  public static native @ByVal FuturePtr reclaim(Future owning_ptr);
   ...
   * ownership.
   */
  public static native @ByVal FuturePtr reclaim_copy(Future owning_ptr);
   ...
   */
  public static native @ByVal FuturePtr unsafe_steal_from_new(Future raw_ptr);
   ...
   */
  public static native @ByVal FuturePtr unsafe_reclaim_from_nonowning(Future raw_ptr);
}
