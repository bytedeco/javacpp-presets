...
public class TensorGeometry extends Pointer {
  ...
  public TensorGeometry(@ByVal @Cast("c10::SymIntArrayRef*") SymIntRef sizes) { super((Pointer)null); allocate(sizes); }
  private native void allocate(@ByVal @Cast("c10::SymIntArrayRef*") SymIntRef sizes);
