...
public class LPPool1dImpl extends LPPool1dImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::LPPool1dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
