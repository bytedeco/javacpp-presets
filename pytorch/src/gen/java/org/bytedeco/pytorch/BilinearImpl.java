...
public class BilinearImpl extends BilinearImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::BilinearImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
