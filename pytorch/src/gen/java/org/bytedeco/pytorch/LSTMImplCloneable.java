...
@Name("torch::nn::Cloneable<torch::nn::LSTMImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class LSTMImplCloneable extends Module {
    static { Loader.load(); }
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::Cloneable<torch::nn::LSTMImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
