...
public class RpcAgent extends Pointer {
  ...
  @Virtual(true) public native @IntrusivePtr("c10::ivalue::Future") @Cast({"", "c10::intrusive_ptr<c10::ivalue::Future>&"}) Future send(
  ...
  @Virtual public native @Const({true, false, true}) @ByRef WorkerInfo getWorkerInfo();
  ...
  public static native @Name("torch::distributed::rpc::getCurrentRpcAgent") @SharedPtr @Cast("std::shared_ptr<torch::distributed::rpc::RpcAgent>") RpcAgent getCurrentRpcAgent();

  // Set the current RPC agent.
  public static native @Name("torch::distributed::rpc::setCurrentRpcAgent") void setCurrentRpcAgent(@SharedPtr @Cast("std::shared_ptr<torch::distributed::rpc::RpcAgent>") RpcAgent agent);
  ...
  @Virtual(true) protected native void addGilWaitTime(@Const @ByVal Microseconds gilWaitTime);
}
