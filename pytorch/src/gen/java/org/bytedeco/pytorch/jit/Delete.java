...
public class Delete extends Stmt {
  ...
  public Delete(@IntrusivePtr("torch::jit::Tree") @Cast({"", "c10::intrusive_ptr<torch::jit::Tree>&"}) Tree tree) { super((Pointer)null); allocate(tree); }
  ...
  public static native @ByVal Delete create(@Const @ByRef SourceRange range, @Const @ByRef ExprList targets);
}
