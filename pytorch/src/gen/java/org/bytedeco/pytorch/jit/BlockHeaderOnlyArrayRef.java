...
@Name("c10::HeaderOnlyArrayRef<torch::jit::Block*>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class BlockHeaderOnlyArrayRef extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public BlockHeaderOnlyArrayRef(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public BlockHeaderOnlyArrayRef(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public BlockHeaderOnlyArrayRef position(long position) {
        return (BlockHeaderOnlyArrayRef)super.position(position);
    }
    @Override public BlockHeaderOnlyArrayRef getPointer(long i) {
        return new BlockHeaderOnlyArrayRef((Pointer)this).offsetAddress(i);
    }
  ...
  /* implicit */ public BlockHeaderOnlyArrayRef() { super((Pointer)null); allocate(); }
private native void allocate();
  ...
  public BlockHeaderOnlyArrayRef(@Cast("torch::jit::Block**") PointerPointer data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  private native void allocate(@Cast("torch::jit::Block**") PointerPointer data, @Cast("size_t") long length);
  public BlockHeaderOnlyArrayRef(@ByPtrPtr Block data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  private native void allocate(@ByPtrPtr Block data, @Cast("size_t") long length);

  /** Construct a HeaderOnlyArrayRef from a range. */
  public BlockHeaderOnlyArrayRef(@Cast("torch::jit::Block**") PointerPointer begin, @Cast("torch::jit::Block**") PointerPointer end) { super((Pointer)null); allocate(begin, end); }
  private native void allocate(@Cast("torch::jit::Block**") PointerPointer begin, @Cast("torch::jit::Block**") PointerPointer end);
  public BlockHeaderOnlyArrayRef(@ByPtrPtr Block begin, @ByPtrPtr Block end) { super((Pointer)null); allocate(begin, end); }
  ...
  public native @Const @ByVal BlockHeaderOnlyArrayRef slice(@Cast("size_t") long N, @Cast("size_t") long M);

  /** slice(n) - Chop off the first N elements of the array. */
  public native @Const @ByVal BlockHeaderOnlyArrayRef slice(@Cast("size_t") long N);
