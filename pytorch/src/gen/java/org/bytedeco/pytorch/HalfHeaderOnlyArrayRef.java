...
@Name("c10::HeaderOnlyArrayRef<c10::impl::ScalarTypeToCPPTypeT<c10::ScalarType::Half> >") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class HalfHeaderOnlyArrayRef extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public HalfHeaderOnlyArrayRef(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public HalfHeaderOnlyArrayRef(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public HalfHeaderOnlyArrayRef position(long position) {
        return (HalfHeaderOnlyArrayRef)super.position(position);
    }
    @Override public HalfHeaderOnlyArrayRef getPointer(long i) {
        return new HalfHeaderOnlyArrayRef((Pointer)this).offsetAddress(i);
    }
  ...
  /* implicit */ public HalfHeaderOnlyArrayRef() { super((Pointer)null); allocate(); }
private native void allocate();
  ...
  public HalfHeaderOnlyArrayRef(@Const Half data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  private native void allocate(@Const Half data, @Cast("size_t") long length);

  /** Construct a HeaderOnlyArrayRef from a range. */
  public HalfHeaderOnlyArrayRef(@Const Half begin, @Const Half end) { super((Pointer)null); allocate(begin, end); }
  ...
  public native @Const @ByVal HalfHeaderOnlyArrayRef slice(@Cast("size_t") long N, @Cast("size_t") long M);

  /** slice(n) - Chop off the first N elements of the array. */
  public native @Const @ByVal HalfHeaderOnlyArrayRef slice(@Cast("size_t") long N);
