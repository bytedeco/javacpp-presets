...
@Name("torch::nn::Cloneable<torch::nn::AdaptiveLogSoftmaxWithLossImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class AdaptiveLogSoftmaxWithLossImplCloneable extends Module {
    static { Loader.load(); }
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::Cloneable<torch::nn::AdaptiveLogSoftmaxWithLossImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
