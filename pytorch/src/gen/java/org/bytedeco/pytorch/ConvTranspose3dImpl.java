...
public class ConvTranspose3dImpl extends ConvTranspose3dImplBase {
  ...
  public ConvTranspose3dImpl(@ByVal @Cast("torch::nn::ConvTranspose3dOptions*") Conv3dTransposeOptions options_) { super((Pointer)null); allocate(options_); }
  @NoDeallocator private native void allocate(@ByVal @Cast("torch::nn::ConvTranspose3dOptions*") Conv3dTransposeOptions options_);
