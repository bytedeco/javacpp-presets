...
@Name("c10::HeaderOnlyArrayRef<bool>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class BoolHeaderOnlyArrayRef extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public BoolHeaderOnlyArrayRef(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public BoolHeaderOnlyArrayRef(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public BoolHeaderOnlyArrayRef position(long position) {
        return (BoolHeaderOnlyArrayRef)super.position(position);
    }
    @Override public BoolHeaderOnlyArrayRef getPointer(long i) {
        return new BoolHeaderOnlyArrayRef((Pointer)this).offsetAddress(i);
    }
  ...
  /* implicit */ public BoolHeaderOnlyArrayRef() { super((Pointer)null); allocate(); }
private native void allocate();
  ...
  public BoolHeaderOnlyArrayRef(@Cast("const bool*") BoolPointer data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  private native void allocate(@Cast("const bool*") BoolPointer data, @Cast("size_t") long length);
  public BoolHeaderOnlyArrayRef(@Cast("const bool*") boolean[] data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  ...
  public BoolHeaderOnlyArrayRef(@Cast("const bool*") BoolPointer begin, @Cast("const bool*") BoolPointer end) { super((Pointer)null); allocate(begin, end); }
  private native void allocate(@Cast("const bool*") BoolPointer begin, @Cast("const bool*") BoolPointer end);
  public BoolHeaderOnlyArrayRef(@Cast("const bool*") boolean[] begin, @Cast("const bool*") boolean[] end) { super((Pointer)null); allocate(begin, end); }
  ...
  public native @Const @ByVal BoolHeaderOnlyArrayRef slice(@Cast("size_t") long N, @Cast("size_t") long M);

  /** slice(n) - Chop off the first N elements of the array. */
  public native @Const @ByVal BoolHeaderOnlyArrayRef slice(@Cast("size_t") long N);
