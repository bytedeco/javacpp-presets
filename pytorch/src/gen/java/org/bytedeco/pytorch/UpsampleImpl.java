...
public class UpsampleImpl extends UpsampleImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::UpsampleImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
