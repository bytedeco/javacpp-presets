...
public class BatchNorm3dImplBase extends BatchNorm3dImplBaseBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::BatchNormImplBase<3,torch::nn::BatchNorm3dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
