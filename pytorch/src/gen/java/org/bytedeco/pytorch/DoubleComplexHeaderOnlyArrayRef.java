...
@Name("c10::HeaderOnlyArrayRef<c10::complex<double> >") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class DoubleComplexHeaderOnlyArrayRef extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public DoubleComplexHeaderOnlyArrayRef(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public DoubleComplexHeaderOnlyArrayRef(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public DoubleComplexHeaderOnlyArrayRef position(long position) {
        return (DoubleComplexHeaderOnlyArrayRef)super.position(position);
    }
    @Override public DoubleComplexHeaderOnlyArrayRef getPointer(long i) {
        return new DoubleComplexHeaderOnlyArrayRef((Pointer)this).offsetAddress(i);
    }
  ...
  /* implicit */ public DoubleComplexHeaderOnlyArrayRef() { super((Pointer)null); allocate(); }
private native void allocate();
  ...
  public DoubleComplexHeaderOnlyArrayRef(@Const DoubleComplex data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  private native void allocate(@Const DoubleComplex data, @Cast("size_t") long length);

  /** Construct a HeaderOnlyArrayRef from a range. */
  public DoubleComplexHeaderOnlyArrayRef(@Const DoubleComplex begin, @Const DoubleComplex end) { super((Pointer)null); allocate(begin, end); }
  ...
  public native @Const @ByVal DoubleComplexHeaderOnlyArrayRef slice(@Cast("size_t") long N, @Cast("size_t") long M);

  /** slice(n) - Chop off the first N elements of the array. */
  public native @Const @ByVal DoubleComplexHeaderOnlyArrayRef slice(@Cast("size_t") long N);
