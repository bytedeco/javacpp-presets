...
// Targeting ../cuda/CUDAErrorLogCapture.java
...
// Targeting ../cuda/CaptureInfo.java



@Namespace("c10::cuda") public static native @ByVal CaptureInfo captureInfoMayInitCtx(CUstream_st stream);
...
@Namespace("c10::CachingDeviceAllocator") public enum RecordContext {
  NEVER(0),
...
// Targeting ../cuda/HostSegmentInfo.java
...
@Namespace("c10::CachingDeviceAllocator") public static native TraceEntry.Action parseTraceEntryAction(@StringView @Cast("const char*") BytePointer action);
@Namespace("c10::CachingDeviceAllocator") public static native @Cast("c10::CachingDeviceAllocator::TraceEntry::Action") int parseTraceEntryAction(@StringView String action);
...
@Namespace("c10::cuda::CUDACachingAllocator") public static native void createOrIncrefPool(
    byte device,
    @ByVal LongPair mempool_id,
    @SharedPtr CUDAAllocator allocator_ptr/*=nullptr*/);
@Namespace("c10::cuda::CUDACachingAllocator") public static native void createOrIncrefPool(
    byte device,
    @ByVal LongPair mempool_id);
@Namespace("c10::cuda::CUDACachingAllocator") public static native void setUseOnOOM(
    byte device,
    @ByVal LongPair mempool_id,
    @Cast("bool") boolean use_on_oom);
@Namespace("c10::cuda::CUDACachingAllocator") public static native void setNoSplit(byte device, @ByVal LongPair mempool_id);
@Namespace("c10::cuda::CUDACachingAllocator") public static native int getPoolUseCount(byte device, @ByVal LongPair mempool_id);
...
@Namespace("c10::cuda::CUDACachingAllocator") public static native @Cast("bool") boolean supportsUserMetadata();
...
@Namespace("c10::cuda::CUDACachingAllocator") public static native void annotateMemory(@Const Pointer ptr, @StdString BytePointer metadata);
@Namespace("c10::cuda::CUDACachingAllocator") public static native void annotateMemory(@Const Pointer ptr, @StdString String metadata);
