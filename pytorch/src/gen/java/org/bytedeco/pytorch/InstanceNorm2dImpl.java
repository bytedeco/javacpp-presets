...
public class InstanceNorm2dImpl extends InstanceNorm2dImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::InstanceNorm2dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
