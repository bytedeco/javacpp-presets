...
@Name("c10::HeaderOnlyArrayRef<c10::intrusive_ptr<c10::ivalue::Future> >") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class FutureHeaderOnlyArrayRef extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FutureHeaderOnlyArrayRef(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FutureHeaderOnlyArrayRef(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public FutureHeaderOnlyArrayRef position(long position) {
        return (FutureHeaderOnlyArrayRef)super.position(position);
    }
    @Override public FutureHeaderOnlyArrayRef getPointer(long i) {
        return new FutureHeaderOnlyArrayRef((Pointer)this).offsetAddress(i);
    }
  ...
  /* implicit */ public FutureHeaderOnlyArrayRef() { super((Pointer)null); allocate(); }
private native void allocate();
  ...
  public FutureHeaderOnlyArrayRef(@Const @IntrusivePtr("c10::ivalue::Future") Future data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  ...
  public FutureHeaderOnlyArrayRef(@Const @IntrusivePtr("c10::ivalue::Future") Future begin, @Const @IntrusivePtr("c10::ivalue::Future") Future end) { super((Pointer)null); allocate(begin, end); }
  ...
  public native @Const @ByVal FutureHeaderOnlyArrayRef slice(@Cast("size_t") long N, @Cast("size_t") long M);

  /** slice(n) - Chop off the first N elements of the array. */
  public native @Const @ByVal FutureHeaderOnlyArrayRef slice(@Cast("size_t") long N);
