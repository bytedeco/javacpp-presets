...
public class GRU extends GRUImplModuleHolder {
    static { Loader.load(); }

     public GRU(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0) { super((Pointer)null); allocate(arg0); }
    private native void allocate(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0); public GRU(@SharedPtr @Cast({"", "std::shared_ptr<torch::nn::GRUImpl>"}) GRUImpl module) { super((Pointer)null); allocate(module); }
