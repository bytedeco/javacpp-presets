...
public class GroupNormImpl extends GroupNormImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::GroupNormImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
