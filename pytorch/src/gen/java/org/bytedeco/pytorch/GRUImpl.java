...
public class GRUImpl extends GRUImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::GRUImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
