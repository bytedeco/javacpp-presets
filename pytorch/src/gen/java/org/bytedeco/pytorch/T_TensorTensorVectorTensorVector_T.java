...
public class T_TensorTensorVectorTensorVector_T extends Pointer {
    ...
    public T_TensorTensorVectorTensorVector_T(@ByRef Tensor value0, @ByRef TensorVector value1, @ByRef TensorVector value2) { allocate(value0, value1, value2); }
    private native void allocate(@ByRef Tensor value0, @ByRef TensorVector value1, @ByRef TensorVector value2);
    ...
    @Namespace @Name("std::get<1>") public static native @ByRef TensorVector get1(@ByRef T_TensorTensorVectorTensorVector_T container);
    public @ByRef TensorVector get2() { return get2(this); }
    @Namespace @Name("std::get<2>") public static native @ByRef TensorVector get2(@ByRef T_TensorTensorVectorTensorVector_T container);
}
