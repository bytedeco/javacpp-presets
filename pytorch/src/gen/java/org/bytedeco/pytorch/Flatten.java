...
public class Flatten extends FlattenImplModuleHolder {
    static { Loader.load(); }

     public Flatten(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0) { super((Pointer)null); allocate(arg0); }
    private native void allocate(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0); public Flatten(@SharedPtr @Cast({"", "std::shared_ptr<torch::nn::FlattenImpl>"}) FlattenImpl module) { super((Pointer)null); allocate(module); }
