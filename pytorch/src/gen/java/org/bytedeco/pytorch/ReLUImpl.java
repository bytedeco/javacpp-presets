...
public class ReLUImpl extends ReLUImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::ReLUImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
