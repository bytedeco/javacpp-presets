...
@Name("c10::HeaderOnlyArrayRef<c10::ScalarType>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class ScalarTypeHeaderOnlyArrayRef extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ScalarTypeHeaderOnlyArrayRef(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ScalarTypeHeaderOnlyArrayRef(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ScalarTypeHeaderOnlyArrayRef position(long position) {
        return (ScalarTypeHeaderOnlyArrayRef)super.position(position);
    }
    @Override public ScalarTypeHeaderOnlyArrayRef getPointer(long i) {
        return new ScalarTypeHeaderOnlyArrayRef((Pointer)this).offsetAddress(i);
    }
  ...
  /* implicit */ public ScalarTypeHeaderOnlyArrayRef() { super((Pointer)null); allocate(); }
private native void allocate();
  ...
  public ScalarTypeHeaderOnlyArrayRef(@Cast("c10::ScalarType*") BytePointer data, @Cast("size_t") long length) { super((Pointer)null); allocate(data, length); }
  ...
  public ScalarTypeHeaderOnlyArrayRef(@Cast("c10::ScalarType*") BytePointer begin, @Cast("c10::ScalarType*") BytePointer end) { super((Pointer)null); allocate(begin, end); }
  ...
  public native @Const @ByVal ScalarTypeHeaderOnlyArrayRef slice(@Cast("size_t") long N, @Cast("size_t") long M);

  /** slice(n) - Chop off the first N elements of the array. */
  public native @Const @ByVal ScalarTypeHeaderOnlyArrayRef slice(@Cast("size_t") long N);
