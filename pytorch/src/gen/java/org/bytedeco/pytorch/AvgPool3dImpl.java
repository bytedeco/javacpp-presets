...
public class AvgPool3dImpl extends AvgPool3dImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::AvgPool3dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
