...
public class BatchNorm2dImplBaseBase extends BatchNorm2dImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::NormImplBase<2,torch::nn::BatchNorm2dImpl,torch::nn::BatchNormOptions>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
