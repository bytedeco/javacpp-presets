...
@Name("c10::intrusive_ptr<torch::jit::Tree>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class TreeRef extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TreeRef(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public TreeRef(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public TreeRef position(long position) {
        return (TreeRef)super.position(position);
    }
    @Override public TreeRef getPointer(long i) {
        return new TreeRef((Pointer)this).offsetAddress(i);
    }


  public TreeRef() { super((Pointer)null); allocate(); }
  @NoException(true) private native void allocate();

  public TreeRef(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0) { super((Pointer)null); allocate(arg0); }
  ...
  public TreeRef(Tree target, @ByVal DontIncreaseRefcount arg1) { super((Pointer)null); allocate(target, arg1); }
  @NoException(true) private native void allocate(Tree target, @ByVal DontIncreaseRefcount arg1);

  

  public TreeRef(@ByRef(true) TreeRef rhs) { super((Pointer)null); allocate(rhs); }
  @NoException(true) private native void allocate(@ByRef(true) TreeRef rhs);
   ...
   */
  public native @NoException(true) Tree release();
   ...
   */
  public static native @ByVal TreeRef reclaim(Tree owning_ptr);
   ...
   * ownership.
   */
  public static native @ByVal TreeRef reclaim_copy(Tree owning_ptr);
   ...
   */
  public static native @ByVal TreeRef unsafe_steal_from_new(Tree raw_ptr);
   ...
   */
  public static native @ByVal TreeRef unsafe_reclaim_from_nonowning(Tree raw_ptr);
}
