...
@Name("std::vector<std::vector<bool> >") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class BoolVectorVector extends Pointer {
    ...
    public BoolVector front() { return get(0); }
    public BoolVector back() { return get(size() - 1); }
