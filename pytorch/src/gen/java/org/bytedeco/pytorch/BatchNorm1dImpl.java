...
public class BatchNorm1dImpl extends BatchNorm1dImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::BatchNorm1dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
