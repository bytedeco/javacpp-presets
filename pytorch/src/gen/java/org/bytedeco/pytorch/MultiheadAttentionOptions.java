...
public class MultiheadAttentionOptions extends Pointer {
  ...
  public native @Cast("int64_t*") @ByRef @NoException LongPointer embed_dim();
  ...
  public native @Cast("bool*") @ByRef @NoException BoolPointer add_bias_kv();
  public native @Cast("bool*") @ByRef @NoException BoolPointer add_zero_attn();
  public native @Cast("int64_t*") @ByRef @NoException LongPointer kdim();
  public native @Cast("int64_t*") @ByRef @NoException LongPointer vdim();
}
