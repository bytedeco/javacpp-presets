...
@Name("torch::nn::ModuleHolder<torch::nn::PixelShuffleImpl>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class PixelShuffleImplModuleHolder extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public PixelShuffleImplModuleHolder(Pointer p) { super(p); }
   ...
   *  a value is assigned. */
  /* implicit */ public PixelShuffleImplModuleHolder(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0) { super((Pointer)null); allocate(arg0); }
private native void allocate(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0);
  ...
  /* implicit */ public PixelShuffleImplModuleHolder(@SharedPtr @Cast({"", "std::shared_ptr<torch::nn::PixelShuffleImpl>"}) PixelShuffleImpl module) { super((Pointer)null); allocate(module); }
private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<torch::nn::PixelShuffleImpl>"}) PixelShuffleImpl module);
  ...
  public native @Name("operator ->") PixelShuffleImpl access();
  ...
  public native @SharedPtr @Cast({"", "std::shared_ptr<torch::nn::PixelShuffleImpl>"}) PixelShuffleImpl ptr();

  /** Returns a pointer to the underlying module. */
  public native PixelShuffleImpl get();
