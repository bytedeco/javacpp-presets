...
public class SELU extends SELUImplModuleHolder {
    static { Loader.load(); }

     public SELU(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0) { super((Pointer)null); allocate(arg0); }
    private native void allocate(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0); public SELU(@SharedPtr @Cast({"", "std::shared_ptr<torch::nn::SELUImpl>"}) SELUImpl module) { super((Pointer)null); allocate(module); }
