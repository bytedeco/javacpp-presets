...
public class HuberLossImplCloneable extends Module {
    ...
    public HuberLossImplCloneable(Module pointer) { super((Pointer)null); allocate(pointer); }
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::Cloneable<torch::nn::HuberLossImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
