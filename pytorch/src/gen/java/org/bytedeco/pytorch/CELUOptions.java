...
/** Options for the {@code CELU} module.
 * 
 *  Example:
 *  <pre>{@code
...
public class CELUOptions extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public CELUOptions() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public CELUOptions(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public CELUOptions(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public CELUOptions position(long position) {
  ...
  public native @ByRef @NoException(true) CELUOptions alpha(double setter);
