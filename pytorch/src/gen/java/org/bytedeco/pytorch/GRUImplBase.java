...
public class GRUImplBase extends GRUImplCloneable {
    ...
    public GRUImplBase(Module pointer) { super((Pointer)null); allocate(pointer); }
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::detail::RNNImplBase<torch::nn::GRUImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
