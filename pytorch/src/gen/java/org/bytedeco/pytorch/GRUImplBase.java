...
public class GRUImplBase extends GRUImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::detail::RNNImplBase<torch::nn::GRUImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
