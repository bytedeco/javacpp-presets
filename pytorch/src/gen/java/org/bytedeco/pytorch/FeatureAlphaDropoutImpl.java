...
public class FeatureAlphaDropoutImpl extends FeatureAlphaDropoutImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::FeatureAlphaDropoutImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
