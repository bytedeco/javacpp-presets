...
public class ReplicationPad2dImplBase extends ReplicationPad2dImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::ReplicationPadImpl<2,torch::nn::ReplicationPad2dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
