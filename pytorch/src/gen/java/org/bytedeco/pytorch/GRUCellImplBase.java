...
public class GRUCellImplBase extends GRUCellImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::detail::RNNCellImplBase<torch::nn::GRUCellImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
