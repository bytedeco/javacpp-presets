...
public class ASGD extends Optimizer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ASGD(Pointer p) { super(p); }

  public ASGD(
        @Const @ByRef OptimizerParamGroupVector param_groups,
        @ByVal(nullValue = "torch::optim::ASGDOptions{}") ASGDOptions defaults) { super((Pointer)null); allocate(param_groups, defaults); }
  private native void allocate(
        @Const @ByRef OptimizerParamGroupVector param_groups,
        @ByVal(nullValue = "torch::optim::ASGDOptions{}") ASGDOptions defaults);
  public ASGD(
        @Const @ByRef OptimizerParamGroupVector param_groups) { super((Pointer)null); allocate(param_groups); }
  private native void allocate(
        @Const @ByRef OptimizerParamGroupVector param_groups);
  public ASGD(@ByVal TensorVector params, @ByVal(nullValue = "torch::optim::ASGDOptions{}") ASGDOptions defaults) { super((Pointer)null); allocate(params, defaults); }
  private native void allocate(@ByVal TensorVector params, @ByVal(nullValue = "torch::optim::ASGDOptions{}") ASGDOptions defaults);
  public ASGD(@ByVal TensorVector params) { super((Pointer)null); allocate(params); }
