...
public class Adamax extends Optimizer {
    ...
    public Adamax(Pointer p) { super(p); }

  public Adamax(
        @Const @ByRef OptimizerParamGroupVector param_groups,
        @ByVal(nullValue = "torch::optim::AdamaxOptions{}") AdamaxOptions defaults) { super((Pointer)null); allocate(param_groups, defaults); }
  private native void allocate(
        @Const @ByRef OptimizerParamGroupVector param_groups,
        @ByVal(nullValue = "torch::optim::AdamaxOptions{}") AdamaxOptions defaults);
  public Adamax(
        @Const @ByRef OptimizerParamGroupVector param_groups) { super((Pointer)null); allocate(param_groups); }
  private native void allocate(
        @Const @ByRef OptimizerParamGroupVector param_groups);
  public Adamax(@ByVal TensorVector params, @ByVal(nullValue = "torch::optim::AdamaxOptions{}") AdamaxOptions defaults) { super((Pointer)null); allocate(params, defaults); }
  private native void allocate(@ByVal TensorVector params, @ByVal(nullValue = "torch::optim::AdamaxOptions{}") AdamaxOptions defaults);
  public Adamax(@ByVal TensorVector params) { super((Pointer)null); allocate(params); }
