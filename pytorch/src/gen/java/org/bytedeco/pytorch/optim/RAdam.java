...
public class RAdam extends Optimizer {
    ...
    public RAdam(Pointer p) { super(p); }

  public RAdam(
        @Const @ByRef OptimizerParamGroupVector param_groups,
        @ByVal(nullValue = "torch::optim::RAdamOptions{}") RAdamOptions defaults) { super((Pointer)null); allocate(param_groups, defaults); }
  private native void allocate(
        @Const @ByRef OptimizerParamGroupVector param_groups,
        @ByVal(nullValue = "torch::optim::RAdamOptions{}") RAdamOptions defaults);
  public RAdam(
        @Const @ByRef OptimizerParamGroupVector param_groups) { super((Pointer)null); allocate(param_groups); }
  private native void allocate(
        @Const @ByRef OptimizerParamGroupVector param_groups);
  public RAdam(@ByVal TensorVector params, @ByVal(nullValue = "torch::optim::RAdamOptions{}") RAdamOptions defaults) { super((Pointer)null); allocate(params, defaults); }
  private native void allocate(@ByVal TensorVector params, @ByVal(nullValue = "torch::optim::RAdamOptions{}") RAdamOptions defaults);
  public RAdam(@ByVal TensorVector params) { super((Pointer)null); allocate(params); }
