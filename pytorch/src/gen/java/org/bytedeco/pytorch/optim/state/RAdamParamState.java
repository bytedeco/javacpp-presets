...
public class RAdamParamState extends OptimizerCloneableRAdamParamState {
    static { Loader.load(); }
    /** Default native constructor. */
    public RAdamParamState() { super((Pointer)null); allocate(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public RAdamParamState(Pointer p) { super(p); }
    @UniquePtr @Name("std::make_unique<torch::optim::RAdamParamState>") private native void allocate();
