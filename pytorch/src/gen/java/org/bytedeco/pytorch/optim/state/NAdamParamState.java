...
public class NAdamParamState extends OptimizerCloneableNAdamParamState {
    static { Loader.load(); }
    /** Default native constructor. */
    public NAdamParamState() { super((Pointer)null); allocate(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public NAdamParamState(Pointer p) { super(p); }
    @UniquePtr @Name("std::make_unique<torch::optim::NAdamParamState>") private native void allocate();
  ...
  public native @ByRef @NoException(true) DoublePointer mu_product();
