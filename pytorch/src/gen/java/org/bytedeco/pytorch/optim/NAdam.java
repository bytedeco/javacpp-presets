...
public class NAdam extends Optimizer {
    ...
    public NAdam(Pointer p) { super(p); }

  public NAdam(
        @Const @ByRef OptimizerParamGroupVector param_groups,
        @ByVal(nullValue = "torch::optim::NAdamOptions{}") NAdamOptions defaults) { super((Pointer)null); allocate(param_groups, defaults); }
  private native void allocate(
        @Const @ByRef OptimizerParamGroupVector param_groups,
        @ByVal(nullValue = "torch::optim::NAdamOptions{}") NAdamOptions defaults);
  public NAdam(
        @Const @ByRef OptimizerParamGroupVector param_groups) { super((Pointer)null); allocate(param_groups); }
  private native void allocate(
        @Const @ByRef OptimizerParamGroupVector param_groups);
  public NAdam(@ByVal TensorVector params, @ByVal(nullValue = "torch::optim::NAdamOptions{}") NAdamOptions defaults) { super((Pointer)null); allocate(params, defaults); }
  private native void allocate(@ByVal TensorVector params, @ByVal(nullValue = "torch::optim::NAdamOptions{}") NAdamOptions defaults);
  public NAdam(@ByVal TensorVector params) { super((Pointer)null); allocate(params); }
