...
public class Adadelta extends Optimizer {
    ...
    public Adadelta(Pointer p) { super(p); }

  public Adadelta(
        @Const @ByRef OptimizerParamGroupVector param_groups,
        @ByVal(nullValue = "torch::optim::AdadeltaOptions{}") AdadeltaOptions defaults) { super((Pointer)null); allocate(param_groups, defaults); }
  private native void allocate(
        @Const @ByRef OptimizerParamGroupVector param_groups,
        @ByVal(nullValue = "torch::optim::AdadeltaOptions{}") AdadeltaOptions defaults);
  public Adadelta(
        @Const @ByRef OptimizerParamGroupVector param_groups) { super((Pointer)null); allocate(param_groups); }
  private native void allocate(
        @Const @ByRef OptimizerParamGroupVector param_groups);
  public Adadelta(@ByVal TensorVector params, @ByVal(nullValue = "torch::optim::AdadeltaOptions{}") AdadeltaOptions defaults) { super((Pointer)null); allocate(params, defaults); }
  private native void allocate(@ByVal TensorVector params, @ByVal(nullValue = "torch::optim::AdadeltaOptions{}") AdadeltaOptions defaults);
  public Adadelta(@ByVal TensorVector params) { super((Pointer)null); allocate(params); }
