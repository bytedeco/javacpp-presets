...
public class Rprop extends Optimizer {
    ...
    public Rprop(Pointer p) { super(p); }

  public Rprop(
        @Const @ByRef OptimizerParamGroupVector param_groups,
        @ByVal(nullValue = "torch::optim::RpropOptions{}") RpropOptions defaults) { super((Pointer)null); allocate(param_groups, defaults); }
  private native void allocate(
        @Const @ByRef OptimizerParamGroupVector param_groups,
        @ByVal(nullValue = "torch::optim::RpropOptions{}") RpropOptions defaults);
  public Rprop(
        @Const @ByRef OptimizerParamGroupVector param_groups) { super((Pointer)null); allocate(param_groups); }
  private native void allocate(
        @Const @ByRef OptimizerParamGroupVector param_groups);
  public Rprop(@ByVal TensorVector params, @ByVal(nullValue = "torch::optim::RpropOptions{}") RpropOptions defaults) { super((Pointer)null); allocate(params, defaults); }
  private native void allocate(@ByVal TensorVector params, @ByVal(nullValue = "torch::optim::RpropOptions{}") RpropOptions defaults);
  public Rprop(@ByVal TensorVector params) { super((Pointer)null); allocate(params); }
