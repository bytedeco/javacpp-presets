...
public class CosineSimilarityImpl extends CosineSimilarityImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::CosineSimilarityImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
