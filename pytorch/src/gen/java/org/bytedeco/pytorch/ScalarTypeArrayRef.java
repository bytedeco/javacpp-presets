...
@Name("c10::ArrayRef<c10::ScalarType>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class ScalarTypeArrayRef extends ScalarTypeHeaderOnlyArrayRef {
    static { Loader.load(); }


   public ScalarTypeArrayRef() { super((Pointer)null); allocate(); }
