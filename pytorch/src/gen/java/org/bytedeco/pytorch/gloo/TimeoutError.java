...
public class TimeoutError extends Error {
    ...
    public TimeoutError(Pointer p) { super(p); }

  public TimeoutError(@StdString BytePointer msg) { super((Pointer)null); allocate(msg); }
  private native void allocate(@StdString BytePointer msg);
  public TimeoutError(@StdString String msg) { super((Pointer)null); allocate(msg); }
