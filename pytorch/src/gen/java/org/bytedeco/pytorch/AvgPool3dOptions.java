...
@Name("torch::nn::AvgPoolOptions<3>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class AvgPool3dOptions extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public AvgPool3dOptions(Pointer p) { super(p); }

  public AvgPool3dOptions(@ByVal @Cast("torch::ExpandingArray<3>*") LongPointer kernel_size) { super((Pointer)null); allocate(kernel_size); }
  ...
  public native @Cast("bool*") @ByRef @NoException BoolPointer count_include_pad();
  public native @ByRef @NoException LongOptional divisor_override();
}
