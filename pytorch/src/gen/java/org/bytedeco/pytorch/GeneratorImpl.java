...
public class GeneratorImpl extends Pointer {
  ...
  // Reserves `increment` Philox outputs and writes 1-element int64 tensors
  ...
  public native void philox_state(
        @Cast("uint64_t") long increment,
        @ByRef Tensor seed,
        @ByRef Tensor offset,
        @ByRef Tensor intragraph_offset);
