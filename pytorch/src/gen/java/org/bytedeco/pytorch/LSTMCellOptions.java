...
/** Options for the {@code LSTMCell} module.
 * 
 *  Example:
 *  <pre>{@code
...
public class LSTMCellOptions extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public LSTMCellOptions(Pointer p) { super(p); }

  public LSTMCellOptions(@Cast("int64_t") long input_size, @Cast("int64_t") long hidden_size) { super((Pointer)null); allocate(input_size, hidden_size); }
