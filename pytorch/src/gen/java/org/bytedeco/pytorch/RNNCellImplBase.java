...
public class RNNCellImplBase extends RNNCellImplCloneable {
    ...
    public RNNCellImplBase(Module pointer) { super((Pointer)null); allocate(pointer); }
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::detail::RNNCellImplBase<torch::nn::RNNCellImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
