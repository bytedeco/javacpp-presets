...
@Name("c10::intrusive_ptr<c10::GeneratorImpl>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class GeneratorImplPtr extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public GeneratorImplPtr(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public GeneratorImplPtr(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public GeneratorImplPtr position(long position) {
        return (GeneratorImplPtr)super.position(position);
    }
    @Override public GeneratorImplPtr getPointer(long i) {
        return new GeneratorImplPtr((Pointer)this).offsetAddress(i);
    }


  public GeneratorImplPtr() { super((Pointer)null); allocate(); }
  @NoException(true) private native void allocate();

  public GeneratorImplPtr(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0) { super((Pointer)null); allocate(arg0); }
  ...
  public GeneratorImplPtr(GeneratorImpl target, @ByVal DontIncreaseRefcount arg1) { super((Pointer)null); allocate(target, arg1); }
  @NoException(true) private native void allocate(GeneratorImpl target, @ByVal DontIncreaseRefcount arg1);

  

  public GeneratorImplPtr(@ByRef(true) GeneratorImplPtr rhs) { super((Pointer)null); allocate(rhs); }
  @NoException(true) private native void allocate(@ByRef(true) GeneratorImplPtr rhs);
  ...
  public native @Name("operator ->") @NoException(true) GeneratorImpl access();

  public native @Cast("bool") @Name("operator bool") @NoException(true) boolean asBoolean();

  public native @NoException(true) void reset();

  public native @NoException(true) void swap(@ByRef GeneratorImplPtr rhs);
   ...
   */
  public native @NoException(true) GeneratorImpl release();
   ...
   */
  public static native @ByVal GeneratorImplPtr reclaim(GeneratorImpl owning_ptr);
   ...
   * ownership.
   */
  public static native @ByVal GeneratorImplPtr reclaim_copy(GeneratorImpl owning_ptr);
   ...
   */
  public static native @ByVal GeneratorImplPtr unsafe_steal_from_new(GeneratorImpl raw_ptr);
   ...
   */
  public static native @ByVal GeneratorImplPtr unsafe_reclaim_from_nonowning(GeneratorImpl raw_ptr);
}
