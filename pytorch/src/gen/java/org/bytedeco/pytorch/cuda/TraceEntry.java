...
@Namespace("c10::CachingDeviceAllocator") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch_cuda.class)
public class TraceEntry extends Pointer {
  ...
  public enum Action {
    ...
    SEGMENT_ALLOC(3), // a call to device allocation to get more memory from the OS
    SEGMENT_FREE(4), // a call to device deallocation to return memory to the OS
    ...
    SNAPSHOT(7), // a call to snapshot, used to correlate memory snapshots to trace
              // events
    OOM(8), // the allocator threw an OutOfMemoryError (addr_ is the amount of
         // free bytes reported by device memory)
    ANNOTATE(9);// metadata attached post facto to a live allocation (addr_ is
  ...
  private native void allocate(
        ...
        @Cast("c10::approx_time_t") long time);
  public TraceEntry(
        @Cast("c10::CachingDeviceAllocator::TraceEntry::Action") int action,
        byte device,
        @Cast("size_t") long addr,
        @Cast("size_t") long size,
        Pointer stream,
  ...
  // (just set to 0).
  public native @Cast("size_t") long addr_(); public native TraceEntry addr_(long setter);
  public native @SharedPtr GatheredContext context_(); public native TraceEntry context_(GatheredContext setter);
  public native Pointer stream_(); public native TraceEntry stream_(Pointer setter);
  public native @Cast("size_t") long size_(); public native TraceEntry size_(long setter);
  public native @ByRef LongPair mempool_(); public native TraceEntry mempool_(LongPair setter);
