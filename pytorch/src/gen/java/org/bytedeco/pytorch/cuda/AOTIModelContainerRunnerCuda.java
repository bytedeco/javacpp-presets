...
public class AOTIModelContainerRunnerCuda extends AOTIModelContainerRunner {
  ...
  public AOTIModelContainerRunnerCuda(
        ...
        @StdString BytePointer device_str,
        @StdString BytePointer cubin_dir,
        @ByRef StringTensorUMap constants) { super((Pointer)null); allocate(model_so_path, num_models, device_str, cubin_dir, constants); }
  private native void allocate(
        @StdString BytePointer model_so_path,
        @Cast("size_t") long num_models,
        @StdString BytePointer device_str,
        @StdString BytePointer cubin_dir,
        @ByRef StringTensorUMap constants);
  public AOTIModelContainerRunnerCuda(
        @StdString String model_so_path,
        @Cast("size_t") long num_models,
        @StdString String device_str,
        @StdString String cubin_dir,
        @ByRef StringTensorUMap constants) { super((Pointer)null); allocate(model_so_path, num_models, device_str, cubin_dir, constants); }
  private native void allocate(
        @StdString String model_so_path,
