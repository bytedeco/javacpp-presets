...
public class MemPool extends Pointer {
  ...
  public MemPool(
        @SharedPtr CUDAAllocator allocator/*=nullptr*/,
  ...
  public native @ByVal LongPair id();
  public native int use_count();
  public native byte device();
  public static native @ByVal LongPair graph_pool_handle(@Cast("bool") boolean is_user_created/*=true*/);
  public static native @ByVal LongPair graph_pool_handle();
}
