...
public class CUDAAllocator extends DeviceAllocator {
  ...
  public native @ByVal SnapshotInfo snapshot(
        @ByVal(nullValue = "c10::MempoolId_t({0, 0})") LongPair mempool_id,
        @Cast("bool") boolean include_traces/*=true*/);
  public native @ByVal SnapshotInfo snapshot();
  ...
  public native void createOrIncrefPool(
        byte arg0,
        @ByVal LongPair arg1);
  public native void setUseOnOOM(
        byte device,
        @ByVal LongPair mempool_id,
        @Cast("bool") boolean use_on_oom);
  public native void setNoSplit(byte device, @ByVal LongPair mempool_id);
  ...
  public native void recordHistory(
        ...
        @Const @ByRef StringVector skip_actions);
  public native void recordHistory(
        @Cast("bool") boolean enabled,
        @ByVal @Cast("c10::cuda::CUDACachingAllocator::CreateContextFn*") Pointer context_recorder,
        @Cast("size_t") long alloc_trace_max_entries,
        @Cast("c10::CachingDeviceAllocator::RecordContext") int when,
        @Cast("bool") boolean clearHistory,
        @Const @ByRef StringVector skip_actions);
  ...
  public native @Cast("bool") boolean supportsUserMetadata();
  public native void setUserMetadata(@StdString BytePointer arg0);
  public native void setUserMetadata(@StdString String arg0);
  ...
  public native void annotateMemory(
        @Const Pointer arg0,
