...
public class SegmentInfo extends Pointer {
  ...
  public native int registration_counter(); public native SegmentInfo registration_counter(int setter);
  ...
  public native Pointer stream(); public native SegmentInfo stream(Pointer setter); // Records the address of the underlying stream
  ...
  public native @ByRef LongPair owner_private_pool_id(); public native SegmentInfo owner_private_pool_id(LongPair setter);
