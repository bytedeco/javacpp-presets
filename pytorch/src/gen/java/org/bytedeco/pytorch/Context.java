...
public class Context extends Pointer {
  ...
  public static native @Cast("bool") boolean ckSDPASupported();
  public static native @Cast("bool") boolean ckGemmSupported();
  ...
  public native @Cast("bool") boolean preferCublasltGroupedGemm();
  public native void setPreferCublasltGroupedGemm(@Cast("bool") boolean arg0);
