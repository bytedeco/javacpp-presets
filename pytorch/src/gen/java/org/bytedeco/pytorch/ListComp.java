...
public class ListComp extends Expr {
    ...
    public ListComp(Pointer p) { super(p); }

  public ListComp(@IntrusivePtr("torch::jit::Tree") @Cast({"", "c10::intrusive_ptr<torch::jit::Tree>&"}) Tree tree) { super((Pointer)null); allocate(tree); }
  private native void allocate(@IntrusivePtr("torch::jit::Tree") @Cast({"", "c10::intrusive_ptr<torch::jit::Tree>&"}) Tree tree);
  public native @ByVal Expr elt();
  public native @ByVal Expr target();
  public native @ByVal Expr iter();
  // TODO: no ifs for now
  public static native @ByVal ListComp create(
        @Const @ByRef SourceRange range,
        @Const @ByRef Expr elt,
