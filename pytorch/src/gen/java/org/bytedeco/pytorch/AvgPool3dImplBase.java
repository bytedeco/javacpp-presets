...
public class AvgPool3dImplBase extends AvgPool3dImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::AvgPoolImpl<3,torch::nn::AvgPool3dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
