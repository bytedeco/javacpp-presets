...
public class RNNBaseMode extends Pointer {
    ...
    @Namespace @Name("c10::get<0>") public static native @ByRef kLSTM get0(@ByRef RNNBaseMode container);
    @ValueSetter public native RNNBaseMode put(@ByRef kLSTM value);
    public @ByRef kGRU get1() { return get1(this); }
    @Namespace @Name("c10::get<1>") public static native @ByRef kGRU get1(@ByRef RNNBaseMode container);
    ...
    @Namespace @Name("c10::get<3>") public static native @ByRef kRNN_RELU get3(@ByRef RNNBaseMode container);
