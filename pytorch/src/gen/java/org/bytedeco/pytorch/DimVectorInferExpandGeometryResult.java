...
public class DimVectorInferExpandGeometryResult extends Pointer {
  ...
  public DimVectorInferExpandGeometryResult(@ByVal @Cast({"int64_t*", "std::vector<int64_t>&"}) @StdVector long[] sizes_, @Cast("size_t") long ndim) { super((Pointer)null); allocate(sizes_, ndim); }
  private native void allocate(@ByVal @Cast({"int64_t*", "std::vector<int64_t>&"}) @StdVector long[] sizes_, @Cast("size_t") long ndim);
}
