...
public class PReLUImpl extends PReLUImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::PReLUImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
