...
public class RangeValue extends SugaredValue {
  ...
  public RangeValue(
        ...
        @ByVal(nullValue = "std::optional<int64_t>(std::nullopt)") LongOptional static_len) { super((Pointer)null); allocate(loc, m, input, static_len); }
  private native void allocate(
        @Const @ByRef SourceRange loc,
        @ByRef GraphFunction m,
        @ByVal ValueVector input,
        @ByVal(nullValue = "std::optional<int64_t>(std::nullopt)") LongOptional static_len);
  public RangeValue(
        @Const @ByRef SourceRange loc,
        @ByRef GraphFunction m,
