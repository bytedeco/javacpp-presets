...
public class BatchNorm2dImplBase extends BatchNorm2dImplBaseBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::BatchNormImplBase<2,torch::nn::BatchNorm2dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
