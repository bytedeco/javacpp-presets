...
@Name("c10::impl::ListElementReference<c10::complex<double>,c10::detail::ListImpl::list_type::iterator>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class DoubleComplexElementReference extends Pointer {
    static { Loader.load(); }
