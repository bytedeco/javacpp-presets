...
public class MaybeOwnedTraitsTensor extends Pointer {
    ...
    public MaybeOwnedTraitsTensor() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public MaybeOwnedTraitsTensor(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public MaybeOwnedTraitsTensor(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public MaybeOwnedTraitsTensor position(long position) {
        return (MaybeOwnedTraitsTensor)super.position(position);
    }
    @Override public MaybeOwnedTraitsTensor getPointer(long i) {
        return new MaybeOwnedTraitsTensor((Pointer)this).offsetAddress(i);
    }
