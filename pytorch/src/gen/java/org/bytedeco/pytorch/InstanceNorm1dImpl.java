...
public class InstanceNorm1dImpl extends InstanceNorm1dImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::InstanceNorm1dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
