...
public class SpatialTransformerDescriptor extends Pointer {
  ...
  public native void set(@ByVal @Cast("cudnnDataType_t*") Pointer dataType, int dim, IntPointer size);
  public native void set(@ByVal @Cast("cudnnDataType_t*") Pointer dataType, int dim, IntBuffer size);
  public native void set(@ByVal @Cast("cudnnDataType_t*") Pointer dataType, int dim, int[] size);
}
