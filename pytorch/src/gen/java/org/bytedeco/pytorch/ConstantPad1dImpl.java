...
public class ConstantPad1dImpl extends ConstantPad1dImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::ConstantPad1dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
