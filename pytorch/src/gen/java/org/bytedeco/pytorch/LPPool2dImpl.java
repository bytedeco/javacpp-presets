...
public class LPPool2dImpl extends LPPool2dImplBase {
    ...
    public LPPool2dImpl(Module pointer) { super((Pointer)null); allocate(pointer); }
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::LPPool2dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
