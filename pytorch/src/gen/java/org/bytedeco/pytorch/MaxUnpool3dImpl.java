...
public class MaxUnpool3dImpl extends MaxUnpool3dImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::MaxUnpool3dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
