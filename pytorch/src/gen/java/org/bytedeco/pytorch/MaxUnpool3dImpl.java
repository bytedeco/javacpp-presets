...
public class MaxUnpool3dImpl extends MaxUnpool3dImplBase {
    ...
    public MaxUnpool3dImpl(Module pointer) { super((Pointer)null); allocate(pointer); }
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::MaxUnpool3dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
