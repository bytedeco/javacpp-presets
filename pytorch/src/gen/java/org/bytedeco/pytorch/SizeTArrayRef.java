...
private native void allocate();
  ...
  public native @ByVal @Cast("const c10::ArrayRef<size_t>::iterator*") SizeTPointer begin();
  public native @ByVal @Cast("const c10::ArrayRef<size_t>::iterator*") SizeTPointer end();

  // These are actually the same as iterator, since ArrayRef only
  // gives you const iterators.
  public native @ByVal @Cast("const c10::ArrayRef<size_t>::const_iterator*") SizeTPointer cbegin();
  public native @ByVal @Cast("const c10::ArrayRef<size_t>::const_iterator*") SizeTPointer cend();
