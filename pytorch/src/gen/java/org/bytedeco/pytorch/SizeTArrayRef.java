...
@Name("c10::ArrayRef<size_t>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class SizeTArrayRef extends SizeTHeaderOnlyArrayRef {
    static { Loader.load(); }


   public SizeTArrayRef() { super((Pointer)null); allocate(); }
