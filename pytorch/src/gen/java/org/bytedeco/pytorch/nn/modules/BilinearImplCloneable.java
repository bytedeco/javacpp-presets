...
@Name("torch::nn::Cloneable<torch::nn::BilinearImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class BilinearImplCloneable extends Module {
    static { Loader.load(); }
