...
@Name("torch::nn::Cloneable<torch::nn::TransformerDecoderLayerImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class TransformerDecoderLayerImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TransformerDecoderLayerImplCloneable(Pointer p) { super(p); }
