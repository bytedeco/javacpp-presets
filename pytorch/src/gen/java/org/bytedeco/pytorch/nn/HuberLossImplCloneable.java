...
@Name("torch::nn::Cloneable<torch::nn::HuberLossImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class HuberLossImplCloneable extends Module {
    static { Loader.load(); }
