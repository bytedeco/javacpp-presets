...
@Name("torch::nn::Cloneable<torch::nn::AdaptiveAvgPool2dImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class AdaptiveAvgPool2dImplCloneable extends Module {
    static { Loader.load(); }
