...
/** Options for {@code torch::nn::functional::log_softmax}.
 * 
 *  Example:
 *  <pre>{@code
...
public class LogSoftmaxFuncOptions extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public LogSoftmaxFuncOptions(Pointer p) { super(p); }

  public LogSoftmaxFuncOptions(@Cast("int64_t") long dim) { super((Pointer)null); allocate(dim); }
