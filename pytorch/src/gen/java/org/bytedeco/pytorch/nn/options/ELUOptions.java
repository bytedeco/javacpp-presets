...
/** Options for the {@code ELU} module.
 * 
 *  Example:
 *  <pre>{@code
...
public class ELUOptions extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public ELUOptions() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ELUOptions(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ELUOptions(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public ELUOptions position(long position) {
  ...
  public native @ByRef @NoException(true) ELUOptions alpha(double setter);
