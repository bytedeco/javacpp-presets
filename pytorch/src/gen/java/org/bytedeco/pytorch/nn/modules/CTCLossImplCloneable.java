...
@Name("torch::nn::Cloneable<torch::nn::CTCLossImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class CTCLossImplCloneable extends Module {
    static { Loader.load(); }
