...
@Name("torch::nn::Cloneable<torch::nn::ZeroPad3dImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class ZeroPad3dImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ZeroPad3dImplCloneable(Pointer p) { super(p); }
