...
@Name("torch::nn::Cloneable<torch::nn::AvgPool2dImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class AvgPool2dImplCloneable extends Module {
    static { Loader.load(); }
