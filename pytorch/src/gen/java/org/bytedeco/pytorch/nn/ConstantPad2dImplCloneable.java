...
@Name("torch::nn::Cloneable<torch::nn::ConstantPad2dImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class ConstantPad2dImplCloneable extends Module {
    static { Loader.load(); }
