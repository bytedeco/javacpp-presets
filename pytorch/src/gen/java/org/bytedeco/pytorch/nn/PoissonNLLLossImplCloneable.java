...
@Name("torch::nn::Cloneable<torch::nn::PoissonNLLLossImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class PoissonNLLLossImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public PoissonNLLLossImplCloneable(Pointer p) { super(p); }
