...
@Name("torch::nn::Cloneable<torch::nn::ConvTranspose2dImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class ConvTranspose2dImplCloneable extends Module {
    static { Loader.load(); }
