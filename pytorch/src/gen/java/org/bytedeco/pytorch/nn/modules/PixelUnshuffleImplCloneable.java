...
@Name("torch::nn::Cloneable<torch::nn::PixelUnshuffleImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class PixelUnshuffleImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public PixelUnshuffleImplCloneable(Pointer p) { super(p); }
