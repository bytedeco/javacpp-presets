...
@Name("torch::nn::Cloneable<torch::nn::SoftplusImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class SoftplusImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public SoftplusImplCloneable(Pointer p) { super(p); }
