...
@Name("torch::nn::Cloneable<torch::nn::ModuleListImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class ModuleListImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ModuleListImplCloneable(Pointer p) { super(p); }
