...
@Name("torch::nn::Cloneable<torch::nn::SELUImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class SELUImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public SELUImplCloneable(Pointer p) { super(p); }
