...
@Name("torch::nn::Cloneable<torch::nn::AdaptiveMaxPool1dImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class AdaptiveMaxPool1dImplCloneable extends Module {
    static { Loader.load(); }
