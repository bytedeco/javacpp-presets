...
@Name("torch::nn::Cloneable<torch::nn::GRUImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class GRUImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public GRUImplCloneable(Pointer p) { super(p); }
