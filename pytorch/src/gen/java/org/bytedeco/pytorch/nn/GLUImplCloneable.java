...
@Name("torch::nn::Cloneable<torch::nn::GLUImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class GLUImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public GLUImplCloneable(Pointer p) { super(p); }
