...
@Name("torch::nn::Cloneable<torch::nn::SiLUImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class SiLUImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public SiLUImplCloneable(Pointer p) { super(p); }
