...
@Name("torch::nn::Cloneable<torch::nn::CosineEmbeddingLossImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class CosineEmbeddingLossImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public CosineEmbeddingLossImplCloneable(Pointer p) { super(p); }
