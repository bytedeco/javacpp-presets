...
@Name("torch::nn::Cloneable<torch::nn::MishImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class MishImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public MishImplCloneable(Pointer p) { super(p); }
