...
@Name("torch::nn::Cloneable<torch::nn::Dropout3dImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class Dropout3dImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public Dropout3dImplCloneable(Pointer p) { super(p); }
