...
@Name("torch::nn::Cloneable<torch::nn::ConstantPad3dImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class ConstantPad3dImplCloneable extends Module {
    static { Loader.load(); }
