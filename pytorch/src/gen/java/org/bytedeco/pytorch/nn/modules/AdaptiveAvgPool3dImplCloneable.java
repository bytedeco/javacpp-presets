...
@Name("torch::nn::Cloneable<torch::nn::AdaptiveAvgPool3dImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class AdaptiveAvgPool3dImplCloneable extends Module {
    static { Loader.load(); }
