...
@Name("torch::nn::Cloneable<torch::nn::LPPool1dImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class LPPool1dImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public LPPool1dImplCloneable(Pointer p) { super(p); }
