...
@Name("torch::nn::Cloneable<torch::nn::FeatureAlphaDropoutImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class FeatureAlphaDropoutImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FeatureAlphaDropoutImplCloneable(Pointer p) { super(p); }
