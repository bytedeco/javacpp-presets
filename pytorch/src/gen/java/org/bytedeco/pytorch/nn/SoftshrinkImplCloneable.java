...
@Name("torch::nn::Cloneable<torch::nn::SoftshrinkImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class SoftshrinkImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public SoftshrinkImplCloneable(Pointer p) { super(p); }
