...
@Name("torch::nn::Cloneable<torch::nn::ZeroPad1dImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class ZeroPad1dImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ZeroPad1dImplCloneable(Pointer p) { super(p); }
