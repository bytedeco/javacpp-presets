...
@Name("torch::nn::Cloneable<torch::nn::CrossMapLRN2dImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class CrossMapLRN2dImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public CrossMapLRN2dImplCloneable(Pointer p) { super(p); }
