...
@Name("torch::nn::Cloneable<torch::nn::FlattenImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class FlattenImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FlattenImplCloneable(Pointer p) { super(p); }
