...
@Name("torch::nn::Cloneable<torch::nn::BatchNorm1dImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class BatchNorm1dImplCloneable extends Module {
    static { Loader.load(); }
