...
@Name("torch::nn::Cloneable<torch::nn::AdaptiveAvgPool1dImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class AdaptiveAvgPool1dImplCloneable extends Module {
    static { Loader.load(); }
