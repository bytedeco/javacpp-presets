...
@Name("torch::nn::Cloneable<torch::nn::SoftmaxImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class SoftmaxImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public SoftmaxImplCloneable(Pointer p) { super(p); }
