...
@Name("torch::nn::Cloneable<torch::nn::ParameterListImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class ParameterListImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ParameterListImplCloneable(Pointer p) { super(p); }
