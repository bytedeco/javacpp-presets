...
@Name("torch::nn::Cloneable<torch::nn::InstanceNorm2dImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class InstanceNorm2dImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public InstanceNorm2dImplCloneable(Pointer p) { super(p); }
