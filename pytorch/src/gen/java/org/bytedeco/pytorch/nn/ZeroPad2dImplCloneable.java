...
@Name("torch::nn::Cloneable<torch::nn::ZeroPad2dImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class ZeroPad2dImplCloneable extends Module {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ZeroPad2dImplCloneable(Pointer p) { super(p); }
