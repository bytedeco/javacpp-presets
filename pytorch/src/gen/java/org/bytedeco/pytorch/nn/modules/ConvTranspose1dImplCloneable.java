...
@Name("torch::nn::Cloneable<torch::nn::ConvTranspose1dImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class ConvTranspose1dImplCloneable extends Module {
    static { Loader.load(); }
