...
@Name("torch::nn::Cloneable<torch::nn::AvgPool1dImpl>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class AvgPool1dImplCloneable extends Module {
    static { Loader.load(); }
