...
@Name("c10::HeaderOnlyArrayRef<at::Tag>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class TagHeaderOnlyArrayRef extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TagHeaderOnlyArrayRef(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public TagHeaderOnlyArrayRef(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public TagHeaderOnlyArrayRef position(long position) {
        return (TagHeaderOnlyArrayRef)super.position(position);
    }
    @Override public TagHeaderOnlyArrayRef getPointer(long i) {
        return new TagHeaderOnlyArrayRef((Pointer)this).offsetAddress(i);
    }
  ...
  /* implicit */ public TagHeaderOnlyArrayRef() { super((Pointer)null); allocate(); }
private native void allocate();
  ...
  public native @Const @ByVal TagHeaderOnlyArrayRef slice(@Cast("size_t") long N, @Cast("size_t") long M);

  /** slice(n) - Chop off the first N elements of the array. */
  public native @Const @ByVal TagHeaderOnlyArrayRef slice(@Cast("size_t") long N);

  /** \}
   *  \name Operator Overloads
   *  \{ */
  public native @Const @ByRef @Name("operator []") Tag get(@Cast("size_t") long Index);
