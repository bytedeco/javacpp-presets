...
public class ConstantString extends Pointer {
  ...
  public ConstantString(@ByVal @Cast("c10::string_view*") Pointer str) { super((Pointer)null); allocate(str); }
  private native void allocate(@ByVal @Cast("c10::string_view*") Pointer str);
  ...
  public static native @ByVal ConstantStringPtr create(@ByVal @Cast("c10::string_view*") Pointer str_);
