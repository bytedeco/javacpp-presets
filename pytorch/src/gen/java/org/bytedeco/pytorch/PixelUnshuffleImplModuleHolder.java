...
@Name("torch::nn::ModuleHolder<torch::nn::PixelUnshuffleImpl>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class PixelUnshuffleImplModuleHolder extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public PixelUnshuffleImplModuleHolder(Pointer p) { super(p); }
   ...
   *  a value is assigned. */
  /* implicit */ public PixelUnshuffleImplModuleHolder(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0) { super((Pointer)null); allocate(arg0); }
private native void allocate(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0);
  ...
  /* implicit */ public PixelUnshuffleImplModuleHolder(@SharedPtr @Cast({"", "std::shared_ptr<torch::nn::PixelUnshuffleImpl>"}) PixelUnshuffleImpl module) { super((Pointer)null); allocate(module); }
private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<torch::nn::PixelUnshuffleImpl>"}) PixelUnshuffleImpl module);
  ...
  public native @Name("operator ->") PixelUnshuffleImpl access();

  /** Forwards to the contained module. */

  /** Returns a reference to the contained module. */
  public native @ByRef @Name("operator *") PixelUnshuffleImpl multiply();

  /** Returns a const reference to the contained module. */

  /** Returns a shared pointer to the underlying module. */
  public native @SharedPtr @Cast({"", "std::shared_ptr<torch::nn::PixelUnshuffleImpl>"}) PixelUnshuffleImpl ptr();

  /** Returns a pointer to the underlying module. */
  public native PixelUnshuffleImpl get();
