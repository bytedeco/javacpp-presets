...
public class TypeMeta extends Pointer {
  ...
  @NoException private native void allocate(@Const @ByRef TypeMeta src);

  /**
   * Assignment operators.
   */
  public native @ByRef @Name("operator =") @NoException TypeMeta put(@Const @ByRef TypeMeta src);

  public native @ByRef @Name("operator =") @NoException TypeMeta put(ScalarType scalar_type);
  /**
   * Returns the type id.
   */
  public native @ByVal @NoException TypeIdentifier id();
  /**
   * true if we represent some ScalarType type
   */
  public native @Cast("bool") @NoException boolean isScalarType();
  /**
   ...
   */
  public native @Cast("size_t") @NoException long itemsize();
  /**
   * Returns the new function pointer for individual items.
   */
  public native @Cast("caffe2::TypeMeta::New*") @NoException TypeMetaData.New newFn();
  /**
   * Returns the placement new function pointer for individual items.
   */
  public native @Cast("caffe2::TypeMeta::PlacementNew*") @NoException TypeMetaData.PlacementNew placementNew();
  /**
   * Returns the typed copy function pointer for individual iterms.
   */
  public native @Cast("caffe2::TypeMeta::Copy*") @NoException TypeMetaData.Copy copy();
  /**
   * Returns the destructor function pointer for individual items.
   */
  public native @Cast("caffe2::TypeMeta::PlacementDelete*") @NoException TypeMetaData.PlacementDelete placementDelete();
  public native @Cast("caffe2::TypeMeta::Delete*") @NoException TypeMetaData.Delete deleteFn();
  /**
   * Returns a printable name for the type.
   */
  public native @ByVal @Cast("c10::string_view*") @NoException Pointer name();
