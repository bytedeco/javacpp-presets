...
@Name("c10::ArrayRef<at::indexing::TensorIndex>") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class TensorIndexArrayRef extends TensorIndexHeaderOnlyArrayRef {
    static { Loader.load(); }


   public TensorIndexArrayRef() { super((Pointer)null); allocate(); }
