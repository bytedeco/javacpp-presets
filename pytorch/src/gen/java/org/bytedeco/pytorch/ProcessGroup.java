...
public class ProcessGroup extends CustomClassHolder {
  ...
  // compatibility.
  public native @Deprecated @IntrusivePtr("c10d::Work") @Cast({"", "c10::intrusive_ptr<c10d::Work>&"}) Work gather_into_tensor(
        @ByRef Tensor outputBuffer,
        @ByRef Tensor inputBuffer,
        @Const @ByRef(nullValue = "c10d::GatherOptions()") GatherOptions opts);
  public native @Deprecated @IntrusivePtr("c10d::Work") @Cast({"", "c10::intrusive_ptr<c10d::Work>&"}) Work gather_into_tensor(
  ...
  public native @IntrusivePtr("c10d::Work") @Cast({"", "c10::intrusive_ptr<c10d::Work>&"}) Work reconfigure(@Const @ByRef ReconfigureOptions opts);
  ...
  public native @IntrusivePtr("c10d::Window") @Cast({"", "c10::intrusive_ptr<c10d::Window>&"}) Window new_window(
        @Const @ByRef(nullValue = "std::optional<at::Tensor>(std::nullopt)") TensorOptional tensor);
  public native @IntrusivePtr("c10d::Window") @Cast({"", "c10::intrusive_ptr<c10d::Window>&"}) Window new_window();
  ...
  // Hooks.hpp.
  public native void registerAbortHook(@Cast("int64_t") long hook_id, @ByVal @Cast("c10d::AbortHook*") Func hook);

  public native void unregisterAbortHook(@Cast("int64_t") long hook_id);

  

  public native void unregisterPreHook(@Cast("int64_t") long hook_id);

  

  public native void unregisterPostHook(@Cast("int64_t") long hook_id);
  ...
  public native @Cast("int64_t") long firePreHook(
        HookOpName name,
        @Cast("bool") boolean async_op,
        @Cast("int64_t") long root,
        @Const @ByRef TensorVector input_tensors,
        @Const @ByRef(nullValue = "std::vector<at::Tensor>{}") TensorVector output_tensors);
  public native @Cast("int64_t") long firePreHook(
        HookOpName name,
        @Cast("bool") boolean async_op,
        @Cast("int64_t") long root,
        @Const @ByRef TensorVector input_tensors);
  public native @Cast("int64_t") long firePreHook(
        @Cast("c10d::HookOpName") byte name,
        @Cast("bool") boolean async_op,
        @Cast("int64_t") long root,
        @Const @ByRef TensorVector input_tensors,
        @Const @ByRef(nullValue = "std::vector<at::Tensor>{}") TensorVector output_tensors);
  ...
  public native @Cast("int64_t") long firePreHook(
        ...
        @Cast("bool") boolean async_op,
        @Cast("int64_t") long root,
        @Const @ByRef Tensor input_tensor,
  ...
  public native @Cast("int64_t") long firePreHook(HookOpName name, @Cast("bool") boolean async_op, @Cast("int64_t") long root);
  public native @Cast("int64_t") long firePreHook(@Cast("c10d::HookOpName") byte name, @Cast("bool") boolean async_op, @Cast("int64_t") long root);

  // Fire registered post-hooks for a collective, correlated with the matching
  // pre-hook via op_id.
  public native void firePostHook(
        HookOpName name,
        @Cast("bool") boolean async_op,
        @Cast("int64_t") long op_id,
