...
public class BilinearOptions extends Pointer {
  ...
  public native @Cast("int64_t*") @ByRef @NoException LongPointer in1_features();
  public native @Cast("int64_t*") @ByRef @NoException LongPointer in2_features();
  public native @Cast("int64_t*") @ByRef @NoException LongPointer out_features();
