...
public class ConvTranspose2dImplBaseBase extends ConvTranspose2dImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::ConvNdImpl<2,torch::nn::ConvTranspose2dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
