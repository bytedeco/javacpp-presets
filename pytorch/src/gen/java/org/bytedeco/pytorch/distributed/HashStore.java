...
public class HashStore extends Store {
    static { Loader.load(); }
    /** Default native constructor. */
    public HashStore() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public HashStore(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public HashStore(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public HashStore position(long position) {
        return (HashStore)super.position(position);
    }
    @Override public HashStore getPointer(long i) {
        return new HashStore((Pointer)this).offsetAddress(i);
    }

  public native @IntrusivePtr("c10d::Store") @Cast({"", "c10::intrusive_ptr<c10d::Store>&"}) Store clone();

  public native void set(@StdString BytePointer key, @Cast("const std::vector<uint8_t>*") @ByRef ByteVector data);
  public native void set(@StdString String key, @Cast("const std::vector<uint8_t>*") @ByRef ByteVector data);
