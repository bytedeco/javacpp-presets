...
public class InstanceNorm2dImplBase extends InstanceNorm2dImplBaseBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::InstanceNormImpl<2,torch::nn::InstanceNorm2dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
