...
public class MaxPool1dImplBase extends MaxPool1dImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::MaxPoolImpl<1,torch::nn::MaxPool1dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
