...
private native void allocate();
  ...
  private native void allocate(@Const SymNode data, @Cast("size_t") long length);

  /** Construct an ArrayRef from a range. */
  public SymNodeArrayRef(@Const SymNode begin, @Const SymNode end) { super((Pointer)null); allocate(begin, end); }
  private native void allocate(@Const SymNode begin, @Const SymNode end);
  ...
  public native @Const SymNode data();

  /** size - Get the array size. */
  public native @Cast("const size_t") long size();

  /** front - Get the first element. */
  public native @Const @ByRef SymNode front();

  /** back - Get the last element. */
  public native @Const @ByRef SymNode back();
   ...
   *  \{ */
  public native @Const @ByRef @Name("operator []") SymNode get(@Cast("size_t") long Index);

  /** Vector compatibility */
  
  ///
  public native @Const @ByRef SymNode at(@Cast("size_t") long Index);
   ...
   *  \{ */
  public native @StdVector SymNode vec();
