...
@Name("c10::ArrayRef<c10::intrusive_ptr<c10::SymNodeImpl> >") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class SymNodeArrayRef extends SymNodeHeaderOnlyArrayRef {
    static { Loader.load(); }


   public SymNodeArrayRef() { super((Pointer)null); allocate(); }
