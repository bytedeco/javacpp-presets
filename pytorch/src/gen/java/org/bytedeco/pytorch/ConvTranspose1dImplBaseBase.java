...
public class ConvTranspose1dImplBaseBase extends ConvTranspose1dImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::ConvNdImpl<1,torch::nn::ConvTranspose1dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
