...
@Name("c10::ArrayRef<c10::intrusive_ptr<c10::ivalue::Future> >") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class FutureArrayRef extends FutureHeaderOnlyArrayRef {
    static { Loader.load(); }


   public FutureArrayRef() { super((Pointer)null); allocate(); }
