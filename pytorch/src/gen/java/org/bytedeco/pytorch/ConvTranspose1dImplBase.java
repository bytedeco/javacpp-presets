...
public class ConvTranspose1dImplBase extends ConvTranspose1dImplBaseBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::ConvTransposeNdImpl<1,torch::nn::ConvTranspose1dImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
