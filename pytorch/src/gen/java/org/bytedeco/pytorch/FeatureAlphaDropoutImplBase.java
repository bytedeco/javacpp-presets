...
public class FeatureAlphaDropoutImplBase extends FeatureAlphaDropoutImplCloneable {
    ...
    public FeatureAlphaDropoutImplBase(Module pointer) { super((Pointer)null); allocate(pointer); }
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::detail::_DropoutNd<torch::nn::FeatureAlphaDropoutImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
