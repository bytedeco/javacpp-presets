...
public class FeatureAlphaDropoutImplBase extends FeatureAlphaDropoutImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::detail::_DropoutNd<torch::nn::FeatureAlphaDropoutImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
