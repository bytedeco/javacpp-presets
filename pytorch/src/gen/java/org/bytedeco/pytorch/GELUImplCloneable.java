...
public class GELUImplCloneable extends Module {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::Cloneable<torch::nn::GELUImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
