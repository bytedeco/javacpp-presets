...
@Name("c10::intrusive_ptr<at::Quantizer>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class QuantizerPtr extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public QuantizerPtr(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public QuantizerPtr(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public QuantizerPtr position(long position) {
        return (QuantizerPtr)super.position(position);
    }
    @Override public QuantizerPtr getPointer(long i) {
        return new QuantizerPtr((Pointer)this).offsetAddress(i);
    }


  public QuantizerPtr() { super((Pointer)null); allocate(); }
  @NoException(true) private native void allocate();

  public QuantizerPtr(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0) { super((Pointer)null); allocate(arg0); }
  ...
  public QuantizerPtr(Quantizer target, @ByVal DontIncreaseRefcount arg1) { super((Pointer)null); allocate(target, arg1); }
  @NoException(true) private native void allocate(Quantizer target, @ByVal DontIncreaseRefcount arg1);

  

  public QuantizerPtr(@ByRef(true) QuantizerPtr rhs) { super((Pointer)null); allocate(rhs); }
  @NoException(true) private native void allocate(@ByRef(true) QuantizerPtr rhs);
  ...
  public native @Name("operator ->") @NoException(true) Quantizer access();

  public native @Cast("bool") @Name("operator bool") @NoException(true) boolean asBoolean();

  public native @NoException(true) void reset();

  public native @NoException(true) void swap(@ByRef QuantizerPtr rhs);
   ...
   */
  public native @NoException(true) Quantizer release();
   ...
   */
  public static native @ByVal QuantizerPtr reclaim(Quantizer owning_ptr);
   ...
   * ownership.
   */
  public static native @ByVal QuantizerPtr reclaim_copy(Quantizer owning_ptr);
   ...
   */
  public static native @ByVal QuantizerPtr unsafe_steal_from_new(Quantizer raw_ptr);
   ...
   */
  public static native @ByVal QuantizerPtr unsafe_reclaim_from_nonowning(Quantizer raw_ptr);
}
