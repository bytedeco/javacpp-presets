...
@Name("torch::nn::FractionalMaxPoolOptions<1>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class FractionalMaxPool1dOptions extends Pointer {
  ...
  public native @Cast("c10::optional<torch::ExpandingArray<1> >*") @ByRef @NoException LongExpandingArrayOptional output_size();
  public native @Cast("c10::optional<torch::nn::FractionalMaxPoolOptions<1>::ExpandingArrayDouble>*") @ByRef @NoException DoubleExpandingArrayOptional output_ratio();
  public native @ByRef @NoException Tensor _random_samples();
}
