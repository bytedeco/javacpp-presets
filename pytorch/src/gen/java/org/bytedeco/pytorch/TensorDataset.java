...
public class TensorDataset extends TensorExampleDataset {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TensorDataset(Pointer p) { super(p); }

  /** Creates a {@code TensorDataset} from a vector of tensors. */
  public TensorDataset(@Cast({"", "std::vector<at::Tensor>"}) @StdMove TensorVector tensors) { super((Pointer)null); allocate(tensors); }
  private native void allocate(@Cast({"", "std::vector<at::Tensor>"}) @StdMove TensorVector tensors);
