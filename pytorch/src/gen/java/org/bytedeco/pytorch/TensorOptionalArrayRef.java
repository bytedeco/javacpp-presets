...
@Name("c10::ArrayRef<std::optional<at::Tensor> >") @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class TensorOptionalArrayRef extends TensorOptionalHeaderOnlyArrayRef {
    static { Loader.load(); }


   public TensorOptionalArrayRef() { super((Pointer)null); allocate(); }
