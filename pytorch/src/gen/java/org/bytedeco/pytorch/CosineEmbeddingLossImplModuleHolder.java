...
@Name("torch::nn::ModuleHolder<torch::nn::CosineEmbeddingLossImpl>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class CosineEmbeddingLossImplModuleHolder extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public CosineEmbeddingLossImplModuleHolder(Pointer p) { super(p); }
   ...
   *  a value is assigned. */
  /* implicit */ public CosineEmbeddingLossImplModuleHolder(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0) { super((Pointer)null); allocate(arg0); }
private native void allocate(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0);
  ...
  /* implicit */ public CosineEmbeddingLossImplModuleHolder(@SharedPtr @Cast({"", "std::shared_ptr<torch::nn::CosineEmbeddingLossImpl>"}) CosineEmbeddingLossImpl module) { super((Pointer)null); allocate(module); }
private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<torch::nn::CosineEmbeddingLossImpl>"}) CosineEmbeddingLossImpl module);
  ...
  public native @Name("operator ->") CosineEmbeddingLossImpl access();

  /** Forwards to the contained module. */

  /** Returns a reference to the contained module. */
  public native @ByRef @Name("operator *") CosineEmbeddingLossImpl multiply();

  /** Returns a const reference to the contained module. */

  /** Returns a shared pointer to the underlying module. */
  public native @SharedPtr @Cast({"", "std::shared_ptr<torch::nn::CosineEmbeddingLossImpl>"}) CosineEmbeddingLossImpl ptr();

  /** Returns a pointer to the underlying module. */
  public native CosineEmbeddingLossImpl get();
