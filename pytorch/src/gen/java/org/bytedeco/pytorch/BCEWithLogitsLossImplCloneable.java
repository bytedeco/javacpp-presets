...
public class BCEWithLogitsLossImplCloneable extends Module {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::dynamic_pointer_cast<torch::nn::Cloneable<torch::nn::BCEWithLogitsLossImpl>, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
