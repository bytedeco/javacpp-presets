...
public class Apply extends Expr {
  ...
  public Apply(@IntrusivePtr("torch::jit::Tree") @Cast({"", "c10::intrusive_ptr<torch::jit::Tree>&"}) Tree tree) { super((Pointer)null); allocate(tree); }
  ...
  public static native @ByVal Apply create(
        @Const @ByRef SourceRange range,
        @Const @ByRef Expr callee,
        @Const @ByRef ExprList inputs,
        @Const @ByRef AttributeList attributes);
}
