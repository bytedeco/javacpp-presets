...
public class TransformerDecoderImpl extends TransformerDecoderImplCloneable {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::TransformerDecoderImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
