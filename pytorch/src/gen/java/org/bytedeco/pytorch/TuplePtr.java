...
@Name("c10::intrusive_ptr<c10::ivalue::Tuple>") @NoOffset @Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class TuplePtr extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TuplePtr(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public TuplePtr(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public TuplePtr position(long position) {
        return (TuplePtr)super.position(position);
    }
    @Override public TuplePtr getPointer(long i) {
        return new TuplePtr((Pointer)this).offsetAddress(i);
    }


  public TuplePtr() { super((Pointer)null); allocate(); }
  @NoException(true) private native void allocate();

  public TuplePtr(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0) { super((Pointer)null); allocate(arg0); }
  ...
  public TuplePtr(Tuple target, @ByVal DontIncreaseRefcount arg1) { super((Pointer)null); allocate(target, arg1); }
  @NoException(true) private native void allocate(Tuple target, @ByVal DontIncreaseRefcount arg1);

  

  public TuplePtr(@ByRef(true) TuplePtr rhs) { super((Pointer)null); allocate(rhs); }
  @NoException(true) private native void allocate(@ByRef(true) TuplePtr rhs);
   ...
   */
  public native @NoException(true) Tuple release();
   ...
   */
  public static native @ByVal TuplePtr reclaim(Tuple owning_ptr);
   ...
   * ownership.
   */
  public static native @ByVal TuplePtr reclaim_copy(Tuple owning_ptr);
   ...
   */
  public static native @ByVal TuplePtr unsafe_steal_from_new(Tuple raw_ptr);
   ...
   */
  public static native @ByVal TuplePtr unsafe_reclaim_from_nonowning(Tuple raw_ptr);
}
