...
public class MaxPool3dImpl extends MaxPool3dImplBase {
    ...
    @Namespace private native @SharedPtr @Name("SHARED_PTR_NAMESPACE::static_pointer_cast<torch::nn::MaxPool3dImpl, torch::nn::Module>") void allocate(@SharedPtr Module pointer);
