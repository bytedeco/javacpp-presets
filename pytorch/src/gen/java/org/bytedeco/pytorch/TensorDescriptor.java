...
public class TensorDescriptor extends Pointer {
  ...
  public native void set(@ByVal @Cast("cudnnDataType_t*") Pointer dataType, @ByVal LongArrayRef sizes, @ByVal LongArrayRef strides, @Cast("size_t") long pad/*=0*/);
  public native void set(@ByVal @Cast("cudnnDataType_t*") Pointer dataType, @ByVal LongArrayRef sizes, @ByVal LongArrayRef strides);
  public native void set(@ByVal @Cast("cudnnDataType_t*") Pointer dataType, @ByVal @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector long[] sizes, @ByVal @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector long[] strides, @Cast("size_t") long pad/*=0*/);
  public native void set(@ByVal @Cast("cudnnDataType_t*") Pointer dataType, @ByVal @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector long[] sizes, @ByVal @Cast({"int64_t*", "c10::ArrayRef<int64_t>", "std::vector<int64_t>&"}) @StdVector long... strides);
