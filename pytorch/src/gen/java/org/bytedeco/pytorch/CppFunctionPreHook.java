...
public class CppFunctionPreHook extends FunctionPreHook {
  ...
  public native @ByVal @Cast("torch::autograd::variable_list*") @Name("operator ()") TensorVector apply(@Cast("const torch::autograd::variable_list*") @ByRef TensorVector values);
