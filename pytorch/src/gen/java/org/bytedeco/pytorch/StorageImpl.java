...
public class StorageImpl extends Pointer {
  ...
  public native void unsafe_set_nbytes(@Cast("size_t") long size_bytes);
  ...
  public native @Cast("bool") boolean throw_on_immutable_data_ptr();
  ...
  public native @Cast("bool") boolean throw_on_mutable_data_ptr();
}
