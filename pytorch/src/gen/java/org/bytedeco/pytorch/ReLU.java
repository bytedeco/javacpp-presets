...
public class ReLU extends ReLUImplModuleHolder {
    static { Loader.load(); }

     public ReLU(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0) { super((Pointer)null); allocate(arg0); }
    private native void allocate(@ByVal @Cast("std::nullptr_t*") PointerPointer arg0); public ReLU(@SharedPtr @Cast({"", "std::shared_ptr<torch::nn::ReLUImpl>"}) ReLUImpl module) { super((Pointer)null); allocate(module); }
