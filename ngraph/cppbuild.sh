...
sedinplace 's/"-DARCH_OPT_FLAGS=.*/-DARCH_OPT_FLAGS=-Wno-error \n -DMKLDNN_USE_MKL=NONE/g' cmake/external_mkldnn_v1.cmake
sedinplace 's/\${MKLML_LIB_DIR}\/\${MKLDNN_LIB_DIR}//g' cmake/external_mkldnn_v1.cmake
sedinplace 's/\${NGRAPH_LIBRARY_OUTPUT_DIRECTORY}\/\${MKLML_LIB}//g' cmake/external_mkldnn_v1.cmake
sedinplace 's/\${NGRAPH_LIBRARY_INSTALL_SRC_DIRECTORY}\/\${MKLML_LIB}//g' cmake/external_mkldnn_v1.cmake
sedinplace 's/ \${MKLML_LIB} / /g' cmake/external_mkldnn_v1.cmake




sedinplace 's/\${NGRAPH_ARCHIVE_OUTPUT_DIRECTORY}\/\${MKLML_IMPLLIB}//g' cmake/external_mkldnn_v1.cmake
sedinplace 's/\${NGRAPH_LIBRARY_OUTPUT_DIRECTORY}\/\${MKLML_IMPLLIB}//g' cmake/external_mkldnn_v1.cmake
sedinplace 's/ \${MKLML_LIB_DIR}\/\${MKLDNN_LIB_DIR} / /g' cmake/external_mkldnn_v1.cmake

sedinplace 's/CopyMKL//g' cmake/external_mkldnn_v1.cmake
