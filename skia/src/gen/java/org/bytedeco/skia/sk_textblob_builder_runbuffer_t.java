...
public class sk_textblob_builder_runbuffer_t extends Pointer {
    ...
    public native Pointer glyphs(); public native sk_textblob_builder_runbuffer_t glyphs(Pointer glyphs);
    public native Pointer pos(); public native sk_textblob_builder_runbuffer_t pos(Pointer pos);
    public native Pointer utf8text(); public native sk_textblob_builder_runbuffer_t utf8text(Pointer utf8text);
    public native Pointer clusters(); public native sk_textblob_builder_runbuffer_t clusters(Pointer clusters);
}
