...
// Targeting ../gr_direct_context_t.java


// Targeting ../gr_recording_context_t.java
...
// Targeting ../sk_runtimeeffect_t.java


// Targeting ../sk_runtimeeffect_uniform_t.java
...
public static native void gr_recording_context_unref(gr_recording_context_t context);
public static native int gr_recording_context_get_max_surface_sample_count_for_color_type(gr_recording_context_t context, @Cast("sk_colortype_t") int colorType);
public static native @Cast("gr_backend_t") int gr_recording_context_get_backend(gr_recording_context_t context);

// GrDirectContext

public static native gr_direct_context_t gr_direct_context_make_gl(@Const gr_glinterface_t glInterface);
public static native gr_direct_context_t gr_direct_context_make_gl_with_options(@Const gr_glinterface_t glInterface, @Const gr_context_options_t options);
public static native gr_direct_context_t gr_direct_context_make_vulkan(@Const @ByVal gr_vk_backendcontext_t vkBackendContext);
public static native gr_direct_context_t gr_direct_context_make_vulkan_with_options(@Const @ByVal gr_vk_backendcontext_t vkBackendContext, @Const gr_context_options_t options);
public static native gr_direct_context_t gr_direct_context_make_metal(Pointer device, Pointer queue);
public static native gr_direct_context_t gr_direct_context_make_metal_with_options(Pointer device, Pointer queue, @Const gr_context_options_t options);

// TODO: the overloads with GrContextOptions

public static native @Cast("bool") boolean gr_direct_context_is_abandoned(gr_direct_context_t context);
public static native void gr_direct_context_abandon_context(gr_direct_context_t context);
public static native void gr_direct_context_release_resources_and_abandon_context(gr_direct_context_t context);
public static native @Cast("size_t") long gr_direct_context_get_resource_cache_limit(gr_direct_context_t context);
public static native void gr_direct_context_set_resource_cache_limit(gr_direct_context_t context, @Cast("size_t") long maxResourceBytes);
public static native void gr_direct_context_get_resource_cache_usage(gr_direct_context_t context, IntPointer maxResources, @Cast("size_t*") SizeTPointer maxResourceBytes);
public static native void gr_direct_context_get_resource_cache_usage(gr_direct_context_t context, IntBuffer maxResources, @Cast("size_t*") SizeTPointer maxResourceBytes);
public static native void gr_direct_context_get_resource_cache_usage(gr_direct_context_t context, int[] maxResources, @Cast("size_t*") SizeTPointer maxResourceBytes);
public static native void gr_direct_context_flush(gr_direct_context_t context);
public static native @Cast("bool") boolean gr_direct_context_submit(gr_direct_context_t context, @Cast("bool") boolean syncCpu);
public static native void gr_direct_context_flush_and_submit(gr_direct_context_t context, @Cast("bool") boolean syncCpu);
public static native void gr_direct_context_reset_context(gr_direct_context_t context, @Cast("uint32_t") int state);
public static native void gr_direct_context_dump_memory_statistics(@Const gr_direct_context_t context, sk_tracememorydump_t dump);
public static native void gr_direct_context_free_gpu_resources(gr_direct_context_t context);
public static native void gr_direct_context_perform_deferred_cleanup(gr_direct_context_t context, long ms);
public static native void gr_direct_context_purge_unlocked_resources_bytes(gr_direct_context_t context, @Cast("size_t") long bytesToPurge, @Cast("bool") boolean preferScratchResources);
public static native void gr_direct_context_purge_unlocked_resources(gr_direct_context_t context, @Cast("bool") boolean scratchResourcesOnly);
...
public static native void sk_canvas_clear_color4f(sk_canvas_t arg0, @ByVal sk_color4f_t arg1);
...
public static native void sk_canvas_draw_color4f(sk_canvas_t ccanvas, @ByVal sk_color4f_t color, @Cast("sk_blendmode_t") int mode);
...
public static native sk_image_t sk_image_new_from_encoded(sk_data_t encoded);
public static native sk_image_t sk_image_new_from_texture(gr_recording_context_t context, @Const gr_backendtexture_t texture, @Cast("gr_surfaceorigin_t") int origin, @Cast("sk_colortype_t") int colorType, @Cast("sk_alphatype_t") int alpha, sk_colorspace_t colorSpace, sk_image_texture_release_proc releaseProc, Pointer releaseContext);
public static native sk_image_t sk_image_new_from_adopted_texture(gr_recording_context_t context, @Const gr_backendtexture_t texture, @Cast("gr_surfaceorigin_t") int origin, @Cast("sk_colortype_t") int colorType, @Cast("sk_alphatype_t") int alpha, sk_colorspace_t colorSpace);
...
public static native sk_image_t sk_image_make_texture_image(@Const sk_image_t cimage, gr_direct_context_t context, @Cast("bool") boolean mipmapped);
...
public static native sk_image_t sk_image_make_with_filter_legacy(@Const sk_image_t cimage, @Const sk_imagefilter_t filter, @Const sk_irect_t subset, @Const sk_irect_t clipBounds, sk_irect_t outSubset, sk_ipoint_t outOffset);
public static native sk_image_t sk_image_make_with_filter(@Const sk_image_t cimage, gr_recording_context_t context, @Const sk_imagefilter_t filter, @Const sk_irect_t subset, @Const sk_irect_t clipBounds, sk_irect_t outSubset, sk_ipoint_t outOffset);
...
public static native @Cast("bool") boolean sk_image_is_valid(@Const sk_image_t image, gr_recording_context_t context);
...
public static native sk_imagefilter_t sk_imagefilter_new_dilate(float radiusX, float radiusY, sk_imagefilter_t input, @Const sk_imagefilter_croprect_t cropRect);
public static native sk_imagefilter_t sk_imagefilter_new_erode(float radiusX, float radiusY, sk_imagefilter_t input, @Const sk_imagefilter_croprect_t cropRect);
...
public static native @Cast("bool") boolean sk_path_is_convex(@Const sk_path_t cpath);
...
public static native @Cast("bool") boolean sk_pixmap_erase_color4f(@Const sk_pixmap_t cpixmap, @Const sk_color4f_t color, sk_colorspace_t colorspace, @Const sk_irect_t subset);
...
public static native sk_shader_t sk_shader_new_blend(@Cast("sk_blendmode_t") int mode, @Const sk_shader_t dst, @Const sk_shader_t src);
public static native sk_shader_t sk_shader_new_lerp(float t, @Const sk_shader_t dst, @Const sk_shader_t src);
...
public static native sk_surface_t sk_surface_new_backend_texture(gr_recording_context_t context, @Const gr_backendtexture_t texture, @Cast("gr_surfaceorigin_t") int origin, int samples, @Cast("sk_colortype_t") int colorType, sk_colorspace_t colorspace, @Const sk_surfaceprops_t props);
public static native sk_surface_t sk_surface_new_backend_render_target(gr_recording_context_t context, @Const gr_backendrendertarget_t target, @Cast("gr_surfaceorigin_t") int origin, @Cast("sk_colortype_t") int colorType, sk_colorspace_t colorspace, @Const sk_surfaceprops_t props);
public static native sk_surface_t sk_surface_new_render_target(gr_recording_context_t context, @Cast("bool") boolean budgeted, @Const sk_imageinfo_t cinfo, int sampleCount, @Cast("gr_surfaceorigin_t") int origin, @Const sk_surfaceprops_t props, @Cast("bool") boolean shouldCreateWithMips);

public static native sk_surface_t sk_surface_new_metal_layer(gr_recording_context_t context, @Const Pointer layer, @Cast("gr_surfaceorigin_t") int origin, int sampleCount, @Cast("sk_colortype_t") int colorType, sk_colorspace_t colorspace, @Const sk_surfaceprops_t props, @Cast("const void**") PointerPointer drawable);
public static native sk_surface_t sk_surface_new_metal_layer(gr_recording_context_t context, @Const Pointer layer, @Cast("gr_surfaceorigin_t") int origin, int sampleCount, @Cast("sk_colortype_t") int colorType, sk_colorspace_t colorspace, @Const sk_surfaceprops_t props, @Cast("const void**") @ByPtrPtr Pointer drawable);
public static native sk_surface_t sk_surface_new_metal_view(gr_recording_context_t context, @Const Pointer mtkView, @Cast("gr_surfaceorigin_t") int origin, int sampleCount, @Cast("sk_colortype_t") int colorType, sk_colorspace_t colorspace, @Const sk_surfaceprops_t props);
...
public static native void sk_surface_flush_and_submit(sk_surface_t surface, @Cast("bool") boolean syncCpu);
public static native gr_recording_context_t sk_surface_get_recording_context(sk_surface_t surface);
