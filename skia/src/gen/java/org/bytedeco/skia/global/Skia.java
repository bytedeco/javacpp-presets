...
public static native @Cast("bool") boolean sk_region_contains(sk_region_t r, @Const sk_region_t region); 
public static native @Cast("bool") boolean sk_region_contains2(sk_region_t r, int x, int y);
public static native @Cast("bool") boolean sk_region_intersects_rect(sk_region_t r, @Const sk_irect_t rect); 
