...
public class gr_vk_imageinfo_t extends Pointer {
    ...
    public native @Cast("uint32_t") int fImageUsageFlags(); public native gr_vk_imageinfo_t fImageUsageFlags(int setter);
    public native @Cast("uint32_t") int fSampleCount(); public native gr_vk_imageinfo_t fSampleCount(int setter);
    ...
    public native @Cast("uint32_t") int fSharingMode(); public native gr_vk_imageinfo_t fSharingMode(int setter);
}
