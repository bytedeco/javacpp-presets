...
public class PyArray_ArrayDescr extends Pointer {
    ...
    @Override public PyArray_ArrayDescr position(long position) {
        ...
        public native PyArray_Descr base(); public native PyArray_ArrayDescr base(PyArray_Descr base);
        public native PyObject shape(); public native PyArray_ArrayDescr shape(PyObject shape);       /* a tuple */
}
