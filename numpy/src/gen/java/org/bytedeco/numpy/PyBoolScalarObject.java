...
public class PyBoolScalarObject extends Pointer {
    ...
    @Override public PyBoolScalarObject position(long position) {
        ...
        public native @ByRef PyObject ob_base(); public native PyBoolScalarObject ob_base(PyObject ob_base);
        public native @Cast("npy_bool") byte obval(); public native PyBoolScalarObject obval(byte obval);
}
