...
public class NpyAuxData extends PyObject {
    ...
    public native NpyAuxData_FreeFunc free(); public native NpyAuxData free(NpyAuxData_FreeFunc free);
    public native NpyAuxData_CloneFunc clone(); public native NpyAuxData clone(NpyAuxData_CloneFunc clone);
    /* To allow for a bit of expansion without breaking the ABI */
    public native Pointer reserved(int i); public native NpyAuxData reserved(int i, Pointer reserved);
