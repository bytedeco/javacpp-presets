...
public class PyScalarObject extends Pointer {
    ...
    @Override public PyScalarObject position(long position) {
        ...
        public native @ByRef PyObject ob_base(); public native PyScalarObject ob_base(PyObject ob_base);
        public native @Cast("char") byte obval(); public native PyScalarObject obval(byte obval);
}
