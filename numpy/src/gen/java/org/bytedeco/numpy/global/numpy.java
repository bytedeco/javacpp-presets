...
public static final int NPY_SIZEOF_HASH_T = NPY_SIZEOF_LONG;
// #else
// #endif
...
public static final int
        ...
        NPY_HEAPSORT = 1,
        NPY_MERGESORT = 2;
public static final int NPY_NSORTS = (NPY_MERGESORT + 1);
...
public static native @ByRef PyBoolScalarObject _PyArrayScalar_BoolValues(int i); public static native void _PyArrayScalar_BoolValues(int i, PyBoolScalarObject _PyArrayScalar_BoolValues);
...
public static native @ByRef PyTypeObject PyBigArray_Type(); public static native void PyBigArray_Type(PyTypeObject PyBigArray_Type);

public static native @ByRef PyTypeObject PyArray_Type(); public static native void PyArray_Type(PyTypeObject PyArray_Type);

public static native @ByRef PyTypeObject PyArrayDescr_Type(); public static native void PyArrayDescr_Type(PyTypeObject PyArrayDescr_Type);

public static native @ByRef PyTypeObject PyArrayFlags_Type(); public static native void PyArrayFlags_Type(PyTypeObject PyArrayFlags_Type);

public static native @ByRef PyTypeObject PyArrayIter_Type(); public static native void PyArrayIter_Type(PyTypeObject PyArrayIter_Type);

public static native @ByRef PyTypeObject PyArrayMultiIter_Type(); public static native void PyArrayMultiIter_Type(PyTypeObject PyArrayMultiIter_Type);

public static native int NPY_NUMUSERTYPES(); public static native void NPY_NUMUSERTYPES(int NPY_NUMUSERTYPES);

public static native @ByRef PyTypeObject PyBoolArrType_Type(); public static native void PyBoolArrType_Type(PyTypeObject PyBoolArrType_Type);

public static native @ByRef PyTypeObject PyGenericArrType_Type(); public static native void PyGenericArrType_Type(PyTypeObject PyGenericArrType_Type);

public static native @ByRef PyTypeObject PyNumberArrType_Type(); public static native void PyNumberArrType_Type(PyTypeObject PyNumberArrType_Type);

public static native @ByRef PyTypeObject PyIntegerArrType_Type(); public static native void PyIntegerArrType_Type(PyTypeObject PyIntegerArrType_Type);

public static native @ByRef PyTypeObject PySignedIntegerArrType_Type(); public static native void PySignedIntegerArrType_Type(PyTypeObject PySignedIntegerArrType_Type);

public static native @ByRef PyTypeObject PyUnsignedIntegerArrType_Type(); public static native void PyUnsignedIntegerArrType_Type(PyTypeObject PyUnsignedIntegerArrType_Type);

public static native @ByRef PyTypeObject PyInexactArrType_Type(); public static native void PyInexactArrType_Type(PyTypeObject PyInexactArrType_Type);

public static native @ByRef PyTypeObject PyFloatingArrType_Type(); public static native void PyFloatingArrType_Type(PyTypeObject PyFloatingArrType_Type);

public static native @ByRef PyTypeObject PyComplexFloatingArrType_Type(); public static native void PyComplexFloatingArrType_Type(PyTypeObject PyComplexFloatingArrType_Type);

public static native @ByRef PyTypeObject PyFlexibleArrType_Type(); public static native void PyFlexibleArrType_Type(PyTypeObject PyFlexibleArrType_Type);

public static native @ByRef PyTypeObject PyCharacterArrType_Type(); public static native void PyCharacterArrType_Type(PyTypeObject PyCharacterArrType_Type);

public static native @ByRef PyTypeObject PyByteArrType_Type(); public static native void PyByteArrType_Type(PyTypeObject PyByteArrType_Type);

public static native @ByRef PyTypeObject PyShortArrType_Type(); public static native void PyShortArrType_Type(PyTypeObject PyShortArrType_Type);

public static native @ByRef PyTypeObject PyIntArrType_Type(); public static native void PyIntArrType_Type(PyTypeObject PyIntArrType_Type);

public static native @ByRef PyTypeObject PyLongArrType_Type(); public static native void PyLongArrType_Type(PyTypeObject PyLongArrType_Type);

public static native @ByRef PyTypeObject PyLongLongArrType_Type(); public static native void PyLongLongArrType_Type(PyTypeObject PyLongLongArrType_Type);

public static native @ByRef PyTypeObject PyUByteArrType_Type(); public static native void PyUByteArrType_Type(PyTypeObject PyUByteArrType_Type);

public static native @ByRef PyTypeObject PyUShortArrType_Type(); public static native void PyUShortArrType_Type(PyTypeObject PyUShortArrType_Type);

public static native @ByRef PyTypeObject PyUIntArrType_Type(); public static native void PyUIntArrType_Type(PyTypeObject PyUIntArrType_Type);

public static native @ByRef PyTypeObject PyULongArrType_Type(); public static native void PyULongArrType_Type(PyTypeObject PyULongArrType_Type);

public static native @ByRef PyTypeObject PyULongLongArrType_Type(); public static native void PyULongLongArrType_Type(PyTypeObject PyULongLongArrType_Type);

public static native @ByRef PyTypeObject PyFloatArrType_Type(); public static native void PyFloatArrType_Type(PyTypeObject PyFloatArrType_Type);

public static native @ByRef PyTypeObject PyDoubleArrType_Type(); public static native void PyDoubleArrType_Type(PyTypeObject PyDoubleArrType_Type);

public static native @ByRef PyTypeObject PyLongDoubleArrType_Type(); public static native void PyLongDoubleArrType_Type(PyTypeObject PyLongDoubleArrType_Type);

public static native @ByRef PyTypeObject PyCFloatArrType_Type(); public static native void PyCFloatArrType_Type(PyTypeObject PyCFloatArrType_Type);

public static native @ByRef PyTypeObject PyCDoubleArrType_Type(); public static native void PyCDoubleArrType_Type(PyTypeObject PyCDoubleArrType_Type);

public static native @ByRef PyTypeObject PyCLongDoubleArrType_Type(); public static native void PyCLongDoubleArrType_Type(PyTypeObject PyCLongDoubleArrType_Type);

public static native @ByRef PyTypeObject PyObjectArrType_Type(); public static native void PyObjectArrType_Type(PyTypeObject PyObjectArrType_Type);

public static native @ByRef PyTypeObject PyStringArrType_Type(); public static native void PyStringArrType_Type(PyTypeObject PyStringArrType_Type);

public static native @ByRef PyTypeObject PyUnicodeArrType_Type(); public static native void PyUnicodeArrType_Type(PyTypeObject PyUnicodeArrType_Type);

public static native @ByRef PyTypeObject PyVoidArrType_Type(); public static native void PyVoidArrType_Type(PyTypeObject PyVoidArrType_Type);
...
@NoException public static native PyObject PyArray_New(PyTypeObject arg0, int arg1, @Cast("npy_intp*") SizeTPointer arg2, int arg3, @Cast("npy_intp*") SizeTPointer arg4, Pointer arg5, int arg6, int arg7, PyObject arg8);
@NoException public static native PyObject PyArray_NewFromDescr(PyTypeObject arg0, PyArray_Descr arg1, int arg2, @Cast("npy_intp*") SizeTPointer arg3, @Cast("npy_intp*") SizeTPointer arg4, Pointer arg5, int arg6, PyObject arg7);
...
@NoException public static native @Cast("npy_bool") byte PyArray_CheckStrides(int arg0, int arg1, @Cast("npy_intp") long arg2, @Cast("npy_intp") long arg3, @Cast("npy_intp*") SizeTPointer arg4, @Cast("npy_intp*") SizeTPointer arg5);
...
@NoException public static native int PyArray_CompareUCS4(@Cast("npy_ucs4*") IntPointer arg0, @Cast("npy_ucs4*") IntPointer arg1, @Cast("size_t") long arg2);
@NoException public static native int PyArray_CompareUCS4(@Cast("npy_ucs4*") IntBuffer arg0, @Cast("npy_ucs4*") IntBuffer arg1, @Cast("size_t") long arg2);
@NoException public static native int PyArray_CompareUCS4(@Cast("npy_ucs4*") int[] arg0, @Cast("npy_ucs4*") int[] arg1, @Cast("size_t") long arg2);
...
@NoException public static native @Cast("npy_intp") long PyArray_MultiplyList(@Cast("npy_intp*") SizeTPointer arg0, int arg1);
@NoException public static native int PyArray_MultiplyIntList(IntPointer arg0, int arg1);
@NoException public static native int PyArray_MultiplyIntList(IntBuffer arg0, int arg1);
@NoException public static native int PyArray_MultiplyIntList(int[] arg0, int arg1);
@NoException public static native Pointer PyArray_GetPtr(PyArrayObject arg0, @Cast("npy_intp*") SizeTPointer arg1);
@NoException public static native int PyArray_CompareLists(@Cast("npy_intp*") SizeTPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, int arg2);
...
@NoException public static native PyObject PyArray_Zeros(int arg0, @Cast("npy_intp*") SizeTPointer arg1, PyArray_Descr arg2, int arg3);
@NoException public static native PyObject PyArray_Empty(int arg0, @Cast("npy_intp*") SizeTPointer arg1, PyArray_Descr arg2, int arg3);
...
@NoException public static native PyObject PyArray_IntTupleFromIntp(int arg0, @Cast("npy_intp*") SizeTPointer arg1);
@NoException public static native int PyArray_TypeNumFromName(@Cast("char*") BytePointer arg0);
@NoException public static native int PyArray_TypeNumFromName(@Cast("char*") ByteBuffer arg0);
@NoException public static native int PyArray_TypeNumFromName(@Cast("char*") byte[] arg0);
...
public static native @ByRef PyTypeObject PyTimeIntegerArrType_Type(); public static native void PyTimeIntegerArrType_Type(PyTypeObject PyTimeIntegerArrType_Type);

public static native @ByRef PyTypeObject PyDatetimeArrType_Type(); public static native void PyDatetimeArrType_Type(PyTypeObject PyDatetimeArrType_Type);

public static native @ByRef PyTypeObject PyTimedeltaArrType_Type(); public static native void PyTimedeltaArrType_Type(PyTypeObject PyTimedeltaArrType_Type);

public static native @ByRef PyTypeObject PyHalfArrType_Type(); public static native void PyHalfArrType_Type(PyTypeObject PyHalfArrType_Type);

public static native @ByRef PyTypeObject NpyIter_Type(); public static native void NpyIter_Type(PyTypeObject NpyIter_Type);
...
@NoException public static native int NpyIter_GotoMultiIndex(NpyIter arg0, @Cast("npy_intp*") SizeTPointer arg1);
...
public static native @Cast("NPY_CASTING") int NPY_DEFAULT_ASSIGN_CASTING(); public static native void NPY_DEFAULT_ASSIGN_CASTING(int NPY_DEFAULT_ASSIGN_CASTING);
...
public static native Pointer PyArray_API(int i); public static native void PyArray_API(int i, Pointer PyArray_API);
public static native @Cast("void**") PointerPointer PyArray_API(); public static native void PyArray_API(PointerPointer PyArray_API);
// #else
// #if defined(PY_ARRAY_UNIQUE_SYMBOL)
// #else
// #endif
...
public static native @ByRef PyTypeObject PyUFunc_Type(); public static native void PyUFunc_Type(PyTypeObject PyUFunc_Type);
...
@NoException public static native void PyUFunc_f_f_As_d_d(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_f_f_As_d_d(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_f_f_As_d_d(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_d_d(@Cast("char**") PointerPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_d_d(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_d_d(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_d_d(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_f_f(@Cast("char**") PointerPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_f_f(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_f_f(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_f_f(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_g_g(@Cast("char**") PointerPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_g_g(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_g_g(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_g_g(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_F_F_As_D_D(@Cast("char**") PointerPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_F_F_As_D_D(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_F_F_As_D_D(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_F_F_As_D_D(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
...
@NoException public static native void PyUFunc_G_G(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_G_G(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_O_O(@Cast("char**") PointerPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_O_O(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_O_O(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_O_O(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_ff_f_As_dd_d(@Cast("char**") PointerPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_ff_f_As_dd_d(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_ff_f_As_dd_d(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_ff_f_As_dd_d(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_ff_f(@Cast("char**") PointerPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_ff_f(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_ff_f(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_ff_f(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_dd_d(@Cast("char**") PointerPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_dd_d(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_dd_d(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_dd_d(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_gg_g(@Cast("char**") PointerPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_gg_g(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_gg_g(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_gg_g(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_FF_F_As_DD_D(@Cast("char**") PointerPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_FF_F_As_DD_D(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_FF_F_As_DD_D(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_FF_F_As_DD_D(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
...
@NoException public static native void PyUFunc_GG_G(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_GG_G(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_OO_O(@Cast("char**") PointerPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_OO_O(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_OO_O(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_OO_O(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_O_O_method(@Cast("char**") PointerPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_O_O_method(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_O_O_method(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_O_O_method(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_OO_O_method(@Cast("char**") PointerPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_OO_O_method(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_OO_O_method(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_OO_O_method(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_On_Om(@Cast("char**") PointerPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_On_Om(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_On_Om(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_On_Om(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
...
@NoException public static native void PyUFunc_e_e(@Cast("char**") PointerPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_e_e(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_e_e(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_e_e(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_e_e_As_f_f(@Cast("char**") PointerPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_e_e_As_f_f(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_e_e_As_f_f(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_e_e_As_f_f(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_e_e_As_d_d(@Cast("char**") PointerPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_e_e_As_d_d(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_e_e_As_d_d(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_e_e_As_d_d(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_ee_e(@Cast("char**") PointerPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_ee_e(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_ee_e(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_ee_e(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_ee_e_As_ff_f(@Cast("char**") PointerPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_ee_e_As_ff_f(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_ee_e_As_ff_f(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_ee_e_As_ff_f(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_ee_e_As_dd_d(@Cast("char**") PointerPointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_ee_e_As_dd_d(@Cast("char**") @ByPtrPtr BytePointer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_ee_e_As_dd_d(@Cast("char**") @ByPtrPtr ByteBuffer arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
@NoException public static native void PyUFunc_ee_e_As_dd_d(@Cast("char**") @ByPtrPtr byte[] arg0, @Cast("npy_intp*") SizeTPointer arg1, @Cast("npy_intp*") SizeTPointer arg2, Pointer arg3);
...
public static native Pointer PyUFunc_API(int i); public static native void PyUFunc_API(int i, Pointer PyUFunc_API);
public static native @Cast("void**") PointerPointer PyUFunc_API(); public static native void PyUFunc_API(PointerPointer PyUFunc_API);
// #else
// #if defined(PY_UFUNC_UNIQUE_SYMBOL)
// #else
// #endif
