...
public class npy_stride_sort_item extends Pointer {
    ...
    public native @Cast("npy_intp") long perm(); public native npy_stride_sort_item perm(long perm);
    public native @Cast("npy_intp") long stride(); public native npy_stride_sort_item stride(long stride);
}
