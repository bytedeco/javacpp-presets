...
public class PyUFunc_PyFuncData extends Pointer {
    ...
    @Override public PyUFunc_PyFuncData position(long position) {
        ...
        public native int nin(); public native PyUFunc_PyFuncData nin(int nin);
        public native int nout(); public native PyUFunc_PyFuncData nout(int nout);
        public native PyObject callable(); public native PyUFunc_PyFuncData callable(PyObject callable);
}
