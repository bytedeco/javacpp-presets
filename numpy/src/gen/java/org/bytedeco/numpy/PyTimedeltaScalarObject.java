...
public class PyTimedeltaScalarObject extends Pointer {
    ...
    @Override public PyTimedeltaScalarObject position(long position) {
        ...
        public native @ByRef PyObject ob_base(); public native PyTimedeltaScalarObject ob_base(PyObject ob_base);
        public native @Cast("npy_timedelta") long obval(); public native PyTimedeltaScalarObject obval(long obval);
        public native @ByRef PyArray_DatetimeMetaData obmeta(); public native PyTimedeltaScalarObject obmeta(PyArray_DatetimeMetaData obmeta);
}
