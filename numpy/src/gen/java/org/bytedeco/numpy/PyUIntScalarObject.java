...
public class PyUIntScalarObject extends Pointer {
    ...
    @Override public PyUIntScalarObject position(long position) {
        ...
        public native @ByRef PyObject ob_base(); public native PyUIntScalarObject ob_base(PyObject ob_base);
        public native @Cast("unsigned int") int obval(); public native PyUIntScalarObject obval(int obval);
}
