...
public class npy_clongdouble extends Pointer {
 ...
 public native @Cast("npy_longdouble") double real(); public native npy_clongdouble real(double real);
public native @Cast("npy_longdouble") double imag(); public native npy_clongdouble imag(double imag); }
