...
public class PyArray_Dims extends Pointer {
    ...
    @Override public PyArray_Dims position(long position) {
        ...
        public native @Cast("npy_intp*") SizeTPointer ptr(); public native PyArray_Dims ptr(SizeTPointer ptr);
        public native int len(); public native PyArray_Dims len(int len);
}
