...
public class PyArray_DatetimeMetaData extends Pointer {
    ...
    public native @Cast("NPY_DATETIMEUNIT") int base(); public native PyArray_DatetimeMetaData base(int base);
    public native int num(); public native PyArray_DatetimeMetaData num(int num);
}
