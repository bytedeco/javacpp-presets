...
public class cl_ulong16 extends Pointer {
    static { Loader.load(); }
    ...
    @Override public cl_ulong16 getPointer(long i) {
        return new cl_ulong16((Pointer)this).position(position + i);
    }

    public native @Cast("cl_ulong") int s(int i); public native cl_ulong16 s(int i, int setter);
    @MemberGetter public native @Cast("cl_ulong*") IntPointer s();
