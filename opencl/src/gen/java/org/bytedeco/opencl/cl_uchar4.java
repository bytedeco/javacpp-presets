...
public class cl_uchar4 extends Pointer {
    static { Loader.load(); }
    ...
    @Override public cl_uchar4 getPointer(long i) {
        return new cl_uchar4((Pointer)this).position(position + i);
    }

    public native @Cast("cl_uchar") int s(int i); public native cl_uchar4 s(int i, int setter);
