...
public class cl_uchar2 extends Pointer {
    static { Loader.load(); }
    ...
    @Override public cl_uchar2 getPointer(long i) {
        return new cl_uchar2((Pointer)this).position(position + i);
    }

    public native @Cast("cl_uchar") int s(int i); public native cl_uchar2 s(int i, int setter);
