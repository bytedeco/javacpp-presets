...
public class cl_ushort8 extends Pointer {
    static { Loader.load(); }
    ...
    @Override public cl_ushort8 getPointer(long i) {
        return new cl_ushort8((Pointer)this).position(position + i);
    }

    public native @Cast("cl_ushort") int s(int i); public native cl_ushort8 s(int i, int setter);
