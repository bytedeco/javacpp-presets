...
public class cl_uchar8 extends Pointer {
    static { Loader.load(); }
    ...
    @Override public cl_uchar8 getPointer(long i) {
        return new cl_uchar8((Pointer)this).position(position + i);
    }

    public native @Cast("cl_uchar") int s(int i); public native cl_uchar8 s(int i, int setter);
