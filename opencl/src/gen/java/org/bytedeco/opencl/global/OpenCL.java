...
public static final int CL_TARGET_OPENCL_VERSION = 310;
// #endif
...
public static final int CL_VERSION_3_1 =  1;
// #endif
...
public static final int __CL_HAS_ANON_UNION__ = 1;
...
// Targeting ../cl_device_integer_dot_product_acceleration_properties.java
...
public static final int CL_DEVICE_MAX_WORK_ITEM_SIZES =                    0x1005;    /* deprecated */
// #ifdef CL_VERSION_3_1
...
// #endif
// #ifdef CL_VERSION_3_1
public static final int CL_DEVICE_UUID =                                   0x106A;
public static final int CL_DRIVER_UUID =                                   0x106B;
public static final int CL_DEVICE_LUID_VALID =                             0x106C;
public static final int CL_DEVICE_LUID =                                   0x106D;
public static final int CL_DEVICE_NODE_MASK =                              0x106E;
// #endif
// #ifdef CL_VERSION_3_0
...
// #endif
// #ifdef CL_VERSION_3_1
public static final int CL_DEVICE_INTEGER_DOT_PRODUCT_CAPABILITIES =       0x1073;
public static final int CL_DEVICE_INTEGER_DOT_PRODUCT_ACCELERATION_PROPERTIES_8BIT = 0x1074;
public static final int CL_DEVICE_INTEGER_DOT_PRODUCT_ACCELERATION_PROPERTIES_4x8BIT_PACKED = 0x1075;
public static final int CL_DEVICE_SPIRV_EXTENDED_INSTRUCTION_SETS =        0x12B9;
public static final int CL_DEVICE_SPIRV_EXTENSIONS =                       0x12BA;
public static final int CL_DEVICE_SPIRV_CAPABILITIES =                     0x12BB;
// #endif
...
/* Size Constants */
public static final int CL_UUID_SIZE = 16;
public static final int CL_LUID_SIZE = 8;

/* cl_device_integer_dot_product_capabilities - bitfield */
public static final int CL_DEVICE_INTEGER_DOT_PRODUCT_INPUT_4x8BIT_PACKED =   (1 << 0);
public static final int CL_DEVICE_INTEGER_DOT_PRODUCT_INPUT_4x8BIT =          (1 << 1);
...
public static native @Cast("cl_int") int clGetKernelSuggestedLocalWorkSize(_cl_command_queue command_queue,
                                  _cl_kernel kernel,
                                  @Cast("cl_uint") int work_dim,
                                  @Cast("const size_t*") SizeTPointer global_work_offset,
                                  @Cast("const size_t*") SizeTPointer global_work_size,
                                  @Cast("size_t*") SizeTPointer suggested_local_work_size);
