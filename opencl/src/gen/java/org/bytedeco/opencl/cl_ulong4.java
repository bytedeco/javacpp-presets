...
public class cl_ulong4 extends Pointer {
    static { Loader.load(); }
    ...
    @Override public cl_ulong4 getPointer(long i) {
        return new cl_ulong4((Pointer)this).position(position + i);
    }

    public native @Cast("cl_ulong") int s(int i); public native cl_ulong4 s(int i, int setter);
