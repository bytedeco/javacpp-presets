...
public class spinMJPGOption extends Pointer {
    ...
    public native @Cast("unsigned int") int width(); public native spinMJPGOption width(int setter);

    /** Height of source image */
    public native @Cast("unsigned int") int height(); public native spinMJPGOption height(int setter);
