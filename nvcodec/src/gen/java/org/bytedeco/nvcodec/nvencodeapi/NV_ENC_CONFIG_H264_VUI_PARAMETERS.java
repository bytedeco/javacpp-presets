...
public class NV_ENC_CONFIG_H264_VUI_PARAMETERS extends Pointer {
    ...
    public native @Cast("NV_ENC_VUI_VIDEO_FORMAT") int videoFormat(); public native NV_ENC_CONFIG_H264_VUI_PARAMETERS videoFormat(int setter);
    ...
    public native @Cast("NV_ENC_VUI_COLOR_PRIMARIES") int colourPrimaries(); public native NV_ENC_CONFIG_H264_VUI_PARAMETERS colourPrimaries(int setter);
    /** [in]: Specifies the opto-electronic transfer characteristics to use (as defined in Annex E of the ITU-T Specification) */
    public native @Cast("NV_ENC_VUI_TRANSFER_CHARACTERISTIC") int transferCharacteristics(); public native NV_ENC_CONFIG_H264_VUI_PARAMETERS transferCharacteristics(int setter);
    ...
    public native @Cast("NV_ENC_VUI_MATRIX_COEFFS") int colourMatrix(); public native NV_ENC_CONFIG_H264_VUI_PARAMETERS colourMatrix(int setter);
    ...
    public native @Cast("uint32_t") int timingInfoPresentFlag(); public native NV_ENC_CONFIG_H264_VUI_PARAMETERS timingInfoPresentFlag(int setter);
    /** [in]: Specifies the number of time units of the clock(as defined in Annex E of the ITU-T Specification). */
    public native @Cast("uint32_t") int numUnitInTicks(); public native NV_ENC_CONFIG_H264_VUI_PARAMETERS numUnitInTicks(int setter);
    /** [in]: Specifies the frequency of the clock(as defined in Annex E of the ITU-T Specification). */
    public native @Cast("uint32_t") int timeScale(); public native NV_ENC_CONFIG_H264_VUI_PARAMETERS timeScale(int setter);
