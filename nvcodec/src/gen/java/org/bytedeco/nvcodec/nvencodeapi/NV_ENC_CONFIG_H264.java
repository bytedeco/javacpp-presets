...
public class NV_ENC_CONFIG_H264 extends Pointer {
    ...
    /** [in]: Set to 1 to enable writing of clock timestamp sets in picture timing SEI.  Note that this flag will be ignored for D3D12 interface. */
    public native @Cast("uint32_t") @NoOffset int enableTimeCode(); public native NV_ENC_CONFIG_H264 enableTimeCode(int setter);
    ...
    /** [in]: Specifies the FMO Mode. Check support for FMO using ::NV_ENC_CAPS_SUPPORT_FMO caps. */
    ...
    public native @Cast("NV_ENC_BIT_DEPTH") int outputBitDepth(); public native NV_ENC_CONFIG_H264 outputBitDepth(int setter);
    ...
    public native @Cast("NV_ENC_BIT_DEPTH") int inputBitDepth(); public native NV_ENC_CONFIG_H264 inputBitDepth(int setter);
    ...
    public native @Cast("NV_ENC_TEMPORAL_FILTER_LEVEL") int tfLevel(); public native NV_ENC_CONFIG_H264 tfLevel(int setter);
