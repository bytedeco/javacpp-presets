...
public class NV_ENC_PIC_PARAMS extends Pointer {
    ...
    /** [in]: Specifies temporal distance for reference picture (NVENC_EXTERNAL_ME_HINT::refidx = 0) used during external ME with NV_ENC_INITIALIZE_PARAMS::enablePTD = 1 . meHintRefPicDist[0] is for L0 hints and meHintRefPicDist[1] is for L1 hints.
    ...
    /** [in]: Difference between the current picture number and the picture number of the most likely reference picture (0 = unknown or unspecified) */
    public native @Cast("int32_t") int diffPicNumHint(); public native NV_ENC_PIC_PARAMS diffPicNumHint(int setter);
