...
public class NV_ENC_REGISTER_RESOURCE extends Pointer {
    ...
    /** [in]: Chroma offset for input buffer when NV_ENC_BUFFER_USAGE::bufferUsage is set to NV_ENC_INPUT_IMAGE
    ...
    public native @Cast("uint32_t") int chromaOffsetIn(int i); public native NV_ENC_REGISTER_RESOURCE chromaOffsetIn(int i, int setter);
    @MemberGetter public native @Cast("uint32_t*") IntPointer chromaOffsetIn();
