...
public class NV_ENC_PIC_PARAMS_H264 extends Pointer {
    ...
    /** [in]: Specifies the clock timestamp sets used in picture timing SEI. Applicable only when NV_ENC_CONFIG_H264::enableTimeCode is set to 1. */
    public native @ByRef NV_ENC_TIME_CODE timeCode(); public native NV_ENC_PIC_PARAMS_H264 timeCode(NV_ENC_TIME_CODE setter);
    /** [in]: Reserved and must be set to 0. */
