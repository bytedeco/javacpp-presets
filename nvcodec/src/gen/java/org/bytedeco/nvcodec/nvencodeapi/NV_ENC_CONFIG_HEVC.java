...
public class NV_ENC_CONFIG_HEVC extends Pointer {
    ...
    public native @Cast("uint32_t") @NoOffset int reserved0(); public native NV_ENC_CONFIG_HEVC reserved0(int setter);
    /** [in]: Enable ref pic list modification flag in PPS. */
    public native @Cast("uint32_t") @NoOffset int enableRefPicListModification(); public native NV_ENC_CONFIG_HEVC enableRefPicListModification(int setter);
    /** [in]: Reserved bitfields.*/
    ...
    /** [in]: Specifies the maximum number of reference frames in the DPB.*/
