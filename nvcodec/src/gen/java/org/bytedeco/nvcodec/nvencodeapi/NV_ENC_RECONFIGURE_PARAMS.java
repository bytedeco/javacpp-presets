...
public class NV_ENC_RECONFIGURE_PARAMS extends Pointer {
    ...
    public native @Cast("uint32_t") int reserved(); public native NV_ENC_RECONFIGURE_PARAMS reserved(int setter);
    ...
    public native @Cast("uint32_t") @NoOffset int reserved1(); public native NV_ENC_RECONFIGURE_PARAMS reserved1(int setter);
    /** [in]: Reserved and must be set to 0 */
    public native @Cast("uint32_t") int reserved2(); public native NV_ENC_RECONFIGURE_PARAMS reserved2(int setter);
