...
public class NV_ENC_MEONLY_PARAMS extends Pointer {
    ...
    public native @Cast("uint32_t") int reserved(); public native NV_ENC_MEONLY_PARAMS reserved(int setter);
    ...
    /** [in]: Reserved and must be set to 0 */
    public native @Cast("uint32_t") int reserved2(); public native NV_ENC_MEONLY_PARAMS reserved2(int setter);
    ...
    public native Pointer reserved3(int i); public native NV_ENC_MEONLY_PARAMS reserved3(int i, Pointer setter);
