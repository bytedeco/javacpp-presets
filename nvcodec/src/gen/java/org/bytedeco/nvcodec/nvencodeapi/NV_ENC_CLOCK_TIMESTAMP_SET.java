...
public class NV_ENC_CLOCK_TIMESTAMP_SET extends Pointer {
    ...
    /** [in] Specifies the LSB part of 'counting_type' */
    public native @Cast("uint32_t") @NoOffset int countingTypeLSB(); public native NV_ENC_CLOCK_TIMESTAMP_SET countingTypeLSB(int setter);
    ...
    /** [in] Specifies the MSB part of 'counting_type' */
    public native @Cast("uint32_t") @NoOffset int countingTypeMSB(); public native NV_ENC_CLOCK_TIMESTAMP_SET countingTypeMSB(int setter);
