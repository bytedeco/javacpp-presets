...
public class NV_ENC_RC_PARAMS extends Pointer {
    ...
    /** [in]: Target CQ (Constant Quality) level for VBR mode (range 0-51 for H264/HEVC, 0-63 for AV1 with 0-automatic)  */
    ...
    public native @Cast("NV_ENC_LOOKAHEAD_LEVEL") int lookaheadLevel(); public native NV_ENC_RC_PARAMS lookaheadLevel(int setter);
    /** [in]: Specifies the bit rate ratio for each view of MV-HEVC except the base view.
                                                                                                 The base view bit rate ratio = 100 - (sum of bit rate ratio of all other views). */
    public native @Cast("uint8_t") byte viewBitrateRatios(int i); public native NV_ENC_RC_PARAMS viewBitrateRatios(int i, byte setter);
    @MemberGetter public native @Cast("uint8_t*") BytePointer viewBitrateRatios();
    public native @Cast("uint8_t") byte reserved3(); public native NV_ENC_RC_PARAMS reserved3(byte setter);
    public native @Cast("uint32_t") int reserved1(); public native NV_ENC_RC_PARAMS reserved1(int setter);
 }
