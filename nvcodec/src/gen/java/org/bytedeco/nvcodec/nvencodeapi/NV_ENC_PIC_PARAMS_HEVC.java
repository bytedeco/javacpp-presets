...
public class NV_ENC_PIC_PARAMS_HEVC extends Pointer {
    ...
    public native @Cast("uint32_t") @NoOffset int temporalConfigUpdate(); public native NV_ENC_PIC_PARAMS_HEVC temporalConfigUpdate(int setter);
    ...
    public native @Cast("uint32_t") int reserved1(); public native NV_ENC_PIC_PARAMS_HEVC reserved1(int setter);
    /** [in]: Deprecated. */
    ...
    /** [in]: Specifies the clock timestamp sets used in time code SEI. Applicable only when NV_ENC_CONFIG_HEVC::enableTimeCodeSEI is set to 1. */
    public native @ByRef NV_ENC_TIME_CODE timeCode(); public native NV_ENC_PIC_PARAMS_HEVC timeCode(NV_ENC_TIME_CODE setter);
    ...
    public native @Cast("uint32_t") int numTemporalLayers(); public native NV_ENC_PIC_PARAMS_HEVC numTemporalLayers(int setter);
    /** [in]: Specifies the view id of the picture */
    public native @Cast("uint32_t") int viewId(); public native NV_ENC_PIC_PARAMS_HEVC viewId(int setter);
    /** [in]: Specifies the 3D reference displays information SEI message.
                                                                            Applicable only when NV_ENC_CONFIG_HEVC::outputHevc3DReferenceDisplayInfo is set to 1. */
    public native HEVC_3D_REFERENCE_DISPLAY_INFO p3DReferenceDisplayInfo(); public native NV_ENC_PIC_PARAMS_HEVC p3DReferenceDisplayInfo(HEVC_3D_REFERENCE_DISPLAY_INFO setter);
    /** [in]: Specifies the Content light level information SEI syntax*/
    public native CONTENT_LIGHT_LEVEL pMaxCll(); public native NV_ENC_PIC_PARAMS_HEVC pMaxCll(CONTENT_LIGHT_LEVEL setter);
    /** [in]: Specifies the Mastering display colour volume SEI syntax*/
    public native MASTERING_DISPLAY_INFO pMasteringDisplay(); public native NV_ENC_PIC_PARAMS_HEVC pMasteringDisplay(MASTERING_DISPLAY_INFO setter);
    /** [in]: Reserved and must be set to 0. */
