...
public class NV_ENC_LOOKAHEAD_PIC_PARAMS extends Pointer {
    ...
    /** [in]: Specifies input picture type. Client required to be set explicitly by the client if the client has not set NV_ENC_INITIALIZE_PARAMS::enablePTD to 1 while calling NvEncInitializeEncoder. */
    ...
    public native @Cast("NV_ENC_BUFFER_FORMAT") int bufferFmt(); public native NV_ENC_LOOKAHEAD_PIC_PARAMS bufferFmt(int setter);
    /** [in]: Specifies bit-wise OR of encode picture flags used for the corresponding EncodePicture call. See ::NV_ENC_PIC_FLAGS enum. */
    public native @Cast("uint32_t") int encodePicFlags(); public native NV_ENC_LOOKAHEAD_PIC_PARAMS encodePicFlags(int setter);
    /** [in]: Reserved and must be set to 0 */
