...
public class NVENC_EXTERNAL_ME_HINT_COUNTS_PER_BLOCKTYPE extends Pointer {
    ...
    /** [in]: Supported for AV1 only. Specifies the number of candidates per SB. */
    public native @Cast("uint32_t") @NoOffset int numCandsPerSb(); public native NVENC_EXTERNAL_ME_HINT_COUNTS_PER_BLOCKTYPE numCandsPerSb(int setter);
