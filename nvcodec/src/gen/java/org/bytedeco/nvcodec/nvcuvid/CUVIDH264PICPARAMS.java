...
public class CUVIDH264PICPARAMS extends Pointer {
    ...
    public native int num_ref_frames(); public native CUVIDH264PICPARAMS num_ref_frames(int setter);
    ...
    public native @Cast("unsigned char") byte bit_depth_luma_minus8(); public native CUVIDH264PICPARAMS bit_depth_luma_minus8(byte setter);
    public native @Cast("unsigned char") byte bit_depth_chroma_minus8(); public native CUVIDH264PICPARAMS bit_depth_chroma_minus8(byte setter);
    ...
    public native @Cast("unsigned int") @NoOffset int mb_adaptive_frame_field_flag(); public native CUVIDH264PICPARAMS mb_adaptive_frame_field_flag(int setter);  // bit 0 represent SPS flag mb_adaptive_frame_field_flag
                                                    // if bit 1 is not set, flag is ignored. Bit 1 is set to maintain backward compatibility
    public native @Cast("unsigned int") @NoOffset int Reserved1(); public native CUVIDH264PICPARAMS Reserved1(int setter);
