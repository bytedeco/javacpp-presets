...
public class CUVIDDECODECAPS extends Pointer {
    ...
    /** OUT: 1 if decode statistics are supported, 0 otherwise             */
    public native @Cast("unsigned char") byte bIsDecodeStatsSupported(); public native CUVIDDECODECAPS bIsDecodeStatsSupported(byte setter);
    public native @Cast("unsigned char") byte reserved4(int i); public native CUVIDDECODECAPS reserved4(int i, byte setter);
    @MemberGetter public native @Cast("unsigned char*") BytePointer reserved4();               /* Reserved for future use - set to zero                                */
    /** Reserved for future use - set to zero                              */
