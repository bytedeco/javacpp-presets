...
public class CUVIDPARSERPARAMS extends Pointer {
    ...
    /** IN: Utilize minimum picIdx from dpb to allow memory saving at the
                                                             decoder layer, use cuvidReconfigureDecoder() to increase the
                                                             decode surfaces if needed  (perf may get impacted)                  */
    public native @Cast("unsigned int") @NoOffset int bMemoryOptimize(); public native CUVIDPARSERPARAMS bMemoryOptimize(int setter);
