...
public class CUVIDDECODECREATEINFO extends Pointer {
    ...
    */
    ...
    /** IN: bitwise OR of different features in cuvidDecodeFeature*/
    public native @Cast("unsigned long") long enableDecodeFeatures(); public native CUVIDDECODECREATEINFO enableDecodeFeatures(long setter);
    /** Reserved for future use - set to zero */
