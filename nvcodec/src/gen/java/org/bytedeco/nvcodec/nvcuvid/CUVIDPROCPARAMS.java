...
public class CUVIDPROCPARAMS extends Pointer {
    ...
    /** IN: pitch in bytes of raw YUV output (should be aligned to 4 bytes)        */
    ...
    /** Extension of CUVIDPROCPARAMS */
    public native CUVIDPROCPARAMSEXT pCuvidProcExt(); public native CUVIDPROCPARAMS pCuvidProcExt(CUVIDPROCPARAMSEXT setter);
}
