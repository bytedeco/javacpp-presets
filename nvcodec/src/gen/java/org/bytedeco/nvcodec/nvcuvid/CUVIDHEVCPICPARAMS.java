...
public class CUVIDHEVCPICPARAMS extends Pointer {
    ...
    public native @Cast("unsigned char") byte mv_hevc_enable(); public native CUVIDHEVCPICPARAMS mv_hevc_enable(byte setter);
    public native @Cast("unsigned char") byte nuh_layer_id(); public native CUVIDHEVCPICPARAMS nuh_layer_id(byte setter);
    public native @Cast("unsigned char") byte default_ref_layers_active_flag(); public native CUVIDHEVCPICPARAMS default_ref_layers_active_flag(byte setter);
    public native @Cast("unsigned char") byte NumDirectRefLayers(); public native CUVIDHEVCPICPARAMS NumDirectRefLayers(byte setter);
    public native @Cast("unsigned char") byte max_one_active_ref_layer_flag(); public native CUVIDHEVCPICPARAMS max_one_active_ref_layer_flag(byte setter);
    public native @Cast("unsigned char") byte poc_lsb_not_present_flag(); public native CUVIDHEVCPICPARAMS poc_lsb_not_present_flag(byte setter);
    public native @Cast("unsigned char") byte NumActiveRefLayerPics0(); public native CUVIDHEVCPICPARAMS NumActiveRefLayerPics0(byte setter);
    public native @Cast("unsigned char") byte NumActiveRefLayerPics1(); public native CUVIDHEVCPICPARAMS NumActiveRefLayerPics1(byte setter);
