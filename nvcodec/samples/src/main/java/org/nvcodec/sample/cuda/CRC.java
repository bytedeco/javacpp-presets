package org.nvcodec.sample.cuda;

import org.nvcodec.sample.dispose.Disposable;
...
import static org.nvcodec.sample.util.CudaUtil.checkCudaApiCall;
...
public class CRC implements Disposable {
    ...
    public CRC(CUctx_st device, int bufferSize) {
        ...
        try {
            ...
            String path = getClass().getClassLoader().getResource("crc.ptx").getPath().substring(1);
