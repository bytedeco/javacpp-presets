package org.bytedeco.nvcodec.sample.encoder;

import org.bytedeco.nvcodec.sample.exceptions.CudaException;
import org.bytedeco.nvcodec.sample.util.CudaUtil;
import org.bytedeco.nvcodec.sample.dispose.Disposable;
...
public class DumpVidMemOutput implements Disposable {
    ...
    public DumpVidMemOutput(CUctx_st device, int bfrSize, String outputFilePath, boolean useCUStream) {
        this.device = device;
