...
@Name("caffe::GaussianFiller<double>") @NoOffset @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class DoubleGaussianFiller extends DoubleFiller {
    static { Loader.load(); }
