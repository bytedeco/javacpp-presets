...
@Name("std::vector<boost::shared_ptr<caffe::Net<double> > >") @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class DoubleNetSharedVector extends Pointer {
    static { Loader.load(); }
