 ...
 */
@Name("caffe::InnerProductLayer<float>") @NoOffset @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class FloatInnerProductLayer extends FloatLayer {
    static { Loader.load(); }
