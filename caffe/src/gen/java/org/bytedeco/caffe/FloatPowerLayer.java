...
/**
 * \brief Computes {@code  y = (\alpha x + \beta) ^ \gamma },
 *        as specified by the scale {@code  \alpha }, shift {@code  \beta },
 *        and power {@code  \gamma }.
 */
@Name("caffe::PowerLayer<float>") @NoOffset @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class FloatPowerLayer extends FloatNeuronLayer {
    static { Loader.load(); }
   ...
   *   - power (\b optional, default 1) the power {@code  \gamma }
   */
