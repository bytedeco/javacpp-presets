...
public class ParameterParameter extends Message {
    static { Loader.load(); }
    ...
    @Override public ParameterParameter getPointer(long i) {
        return new ParameterParameter((Pointer)this).position(position + i);
    }
