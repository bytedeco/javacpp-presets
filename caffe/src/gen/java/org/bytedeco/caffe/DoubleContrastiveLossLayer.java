...
@Name("caffe::ContrastiveLossLayer<double>") @NoOffset @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class DoubleContrastiveLossLayer extends DoubleLossLayer {
    static { Loader.load(); }
