...
public class SoftmaxParameter extends Message {
    static { Loader.load(); }
    ...
    @Override public SoftmaxParameter getPointer(long i) {
        return new SoftmaxParameter((Pointer)this).position(position + i);
    }
