...
@Name("std::vector<std::vector<caffe::Blob<float>*> >") @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class FloatBlobVectorVector extends Pointer {
    static { Loader.load(); }
