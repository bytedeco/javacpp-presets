 ...
 */
@Name("caffe::ConvolutionLayer<float>") @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class FloatConvolutionLayer extends FloatBaseConvolutionLayer {
    static { Loader.load(); }
