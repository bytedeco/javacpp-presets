...
/**
 * \brief TanH hyperbolic tangent non-linearity {@code 
 ...
 */
@Name("caffe::TanHLayer<float>") @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class FloatTanHLayer extends FloatNeuronLayer {
    static { Loader.load(); }
