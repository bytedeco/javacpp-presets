...
@Name("caffe::RecurrentLayer<double>") @NoOffset @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class DoubleRecurrentLayer extends DoubleLayer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public DoubleRecurrentLayer(Pointer p) { super(p); }

  public DoubleRecurrentLayer(@Const @ByRef LayerParameter param) { super((Pointer)null); allocate(param); }
