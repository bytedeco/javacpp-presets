 ...
 */
@Platform(value = {"linux-x86_64", "macosx-x86_64"}, extension = "-gpu") @Name("caffe::CuDNNReLULayer<float>") @NoOffset @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
