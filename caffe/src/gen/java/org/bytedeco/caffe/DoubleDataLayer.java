...
@Name("caffe::DataLayer<double>") @NoOffset @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class DoubleDataLayer extends DoubleBasePrefetchingDataLayer {
    static { Loader.load(); }
