 ...
 */
@Name("caffe::ImageDataLayer<float>") @NoOffset @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class FloatImageDataLayer extends FloatBasePrefetchingDataLayer {
    static { Loader.load(); }
