...
@Name("caffe::DropoutLayer<double>") @NoOffset @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class DoubleDropoutLayer extends DoubleNeuronLayer {
    static { Loader.load(); }
