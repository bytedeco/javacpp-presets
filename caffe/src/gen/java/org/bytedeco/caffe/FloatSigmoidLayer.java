...
/**
 * \brief Sigmoid function non-linearity {@code 
 *         y = (1 + \exp(-x))^{-1}
 ...
 */
@Name("caffe::SigmoidLayer<float>") @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class FloatSigmoidLayer extends FloatNeuronLayer {
    static { Loader.load(); }
