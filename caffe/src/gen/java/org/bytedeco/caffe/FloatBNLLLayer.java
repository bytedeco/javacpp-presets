...
/**
 * \brief Computes {@code  y = x + \log(1 + \exp(-x)) } if {@code  x > 0 };
 *        {@code  y = \log(1 + \exp(x)) } otherwise.
 *
 ...
 *      }
 */
@Name("caffe::BNLLLayer<float>") @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class FloatBNLLLayer extends FloatNeuronLayer {
    static { Loader.load(); }
