...
// #ifdef USE_CUDNN
@Platform(value = {"linux-x86_64", "macosx-x86_64"}, extension = "-gpu") @Name("caffe::CuDNNLCNLayer<float>") @NoOffset @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class FloatCuDNNLCNLayer extends FloatLRNLayer {
    static { Loader.load(); }
