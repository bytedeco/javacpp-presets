...
@Name("caffe::ReductionLayer<double>") @NoOffset @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class DoubleReductionLayer extends DoubleLayer {
    static { Loader.load(); }
