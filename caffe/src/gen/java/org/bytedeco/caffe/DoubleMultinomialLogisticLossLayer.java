...
@Name("caffe::MultinomialLogisticLossLayer<double>") @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class DoubleMultinomialLogisticLossLayer extends DoubleLossLayer {
    static { Loader.load(); }
