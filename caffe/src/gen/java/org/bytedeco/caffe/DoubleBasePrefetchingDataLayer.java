...
@Name("caffe::BasePrefetchingDataLayer<double>") @NoOffset @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class DoubleBasePrefetchingDataLayer extends DoubleBaseDataLayer {
  ...
  public DoubleBasePrefetchingDataLayer(@Const @ByRef LayerParameter param) { super((Pointer)null); allocate(param); }
