...
@Name("caffe::DummyDataLayer<double>") @NoOffset @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class DoubleDummyDataLayer extends DoubleLayer {
    static { Loader.load(); }
