...
@Name("caffe::PositiveUnitballFiller<double>") @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class DoublePositiveUnitballFiller extends DoubleFiller {
    static { Loader.load(); }
