...
/** \brief Fills a Blob with uniformly distributed values {@code  x\sim U(a, b) }. */
@Name("caffe::UniformFiller<float>") @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class FloatUniformFiller extends FloatFiller {
    static { Loader.load(); }
