...
@Name("caffe::PowerLayer<double>") @NoOffset @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class DoublePowerLayer extends DoubleNeuronLayer {
    static { Loader.load(); }
