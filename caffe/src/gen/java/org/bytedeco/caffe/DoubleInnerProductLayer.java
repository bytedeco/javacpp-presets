...
@Name("caffe::InnerProductLayer<double>") @NoOffset @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class DoubleInnerProductLayer extends DoubleLayer {
    static { Loader.load(); }
