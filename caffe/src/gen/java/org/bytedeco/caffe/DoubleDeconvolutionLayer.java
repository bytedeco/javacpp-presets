...
@Name("caffe::DeconvolutionLayer<double>") @Properties(inherit = org.bytedeco.caffe.presets.caffe.class)
public class DoubleDeconvolutionLayer extends DoubleBaseConvolutionLayer {
    static { Loader.load(); }
