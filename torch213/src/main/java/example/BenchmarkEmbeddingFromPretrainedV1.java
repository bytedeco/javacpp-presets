...
public class BenchmarkEmbeddingFromPretrainedV1 {
    ...
    private static void runEmbeddingBagBench() {
        ...
        Tensor indices = arange(new org.bytedeco.pytorch.Scalar(0), new org.bytedeco.pytorch.Scalar(8192)).remainder(new Scalar(2048));
        Tensor offsets = arange(new org.bytedeco.pytorch.Scalar(0), new org.bytedeco.pytorch.Scalar(128)).mul(new Scalar(64));
