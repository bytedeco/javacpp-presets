...
// #endif
    ...
    */
    public native @Cast("bool") boolean openROM(@StdString BytePointer rom, @StdString BytePointer md5, @Cast("uInt8**") PointerPointer image, IntPointer size);
    public native @Cast("bool") boolean openROM(@StdString BytePointer rom, @StdString BytePointer md5, @Cast("uInt8**") @ByPtrPtr BytePointer image, IntPointer size);
    public native @Cast("bool") boolean openROM(@StdString String rom, @StdString String md5, @Cast("uInt8**") @ByPtrPtr ByteBuffer image, IntBuffer size);
    public native @Cast("bool") boolean openROM(@StdString BytePointer rom, @StdString BytePointer md5, @Cast("uInt8**") @ByPtrPtr byte[] image, int[] size);
    public native @Cast("bool") boolean openROM(@StdString String rom, @StdString String md5, @Cast("uInt8**") @ByPtrPtr BytePointer image, IntPointer size);
    public native @Cast("bool") boolean openROM(@StdString BytePointer rom, @StdString BytePointer md5, @Cast("uInt8**") @ByPtrPtr ByteBuffer image, IntBuffer size);
    public native @Cast("bool") boolean openROM(@StdString String rom, @StdString String md5, @Cast("uInt8**") @ByPtrPtr byte[] image, int[] size);
