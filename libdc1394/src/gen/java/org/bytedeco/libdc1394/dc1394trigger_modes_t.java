...
public class dc1394trigger_modes_t extends Pointer {
    static { Loader.load(); }
    ...
    @Override public dc1394trigger_modes_t getPointer(long i) {
        return new dc1394trigger_modes_t((Pointer)this).position(position + i);
    }

    public native @Cast("uint32_t") int num(); public native dc1394trigger_modes_t num(int setter);
    public native @Cast("dc1394trigger_mode_t") int modes(int i); public native dc1394trigger_modes_t modes(int i, int setter);
