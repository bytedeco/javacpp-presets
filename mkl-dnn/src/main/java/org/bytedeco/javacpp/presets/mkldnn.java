...
public class mkldnn implements InfoMapper {
    public void map(InfoMap infoMap) {
        infoMap//.put(new Info().enumerate())
               ...
               .put(new Info("mkldnn_engine_t").valueTypes("mkldnn_engine").pointerTypes("@ByPtrPtr mkldnn_engine"))

               .put(new Info("const_mkldnn_engine_t").valueTypes("@Const mkldnn_engine").pointerTypes("@Const @ByPtrPtr mkldnn_engine"))
               .put(new Info("mkldnn_primitive_desc_iterator_t").valueTypes("mkldnn_primitive_desc_iterator").pointerTypes("@ByPtrPtr mkldnn_primitive_desc_iterator"))
               .put(new Info("const_mkldnn_primitive_desc_iterator_t").valueTypes("@Const mkldnn_primitive_desc_iterator").pointerTypes("@Const @ByPtrPtr mkldnn_primitive_desc_iterator"))
               .put(new Info("mkldnn_primitive_desc_t").valueTypes("mkldnn_primitive_desc").pointerTypes("@ByPtrPtr mkldnn_primitive_desc"))
               .put(new Info("const_mkldnn_primitive_desc_t").valueTypes("@Const mkldnn_primitive_desc").pointerTypes("@Const @ByPtrPtr mkldnn_primitive_desc"))
               .put(new Info("mkldnn_primitive_attr_t").valueTypes("mkldnn_primitive_attr").pointerTypes("@ByPtrPtr mkldnn_primitive_attr"))
               .put(new Info("const_mkldnn_primitive_attr_t").valueTypes("@Const mkldnn_primitive_attr").pointerTypes("@Const @ByPtrPtr mkldnn_primitive_attr"))
               .put(new Info("mkldnn_post_ops_t").valueTypes("mkldnn_post_ops").pointerTypes("@ByPtrPtr mkldnn_post_ops"))
               .put(new Info("const_mkldnn_post_ops_t").valueTypes("@Const mkldnn_post_ops").pointerTypes("@Const @ByPtrPtr mkldnn_post_ops"))
               .put(new Info("mkldnn_primitive_t").valueTypes("mkldnn_primitive").pointerTypes("@ByPtrPtr mkldnn_primitive"))
               .put(new Info("const_mkldnn_primitive_t").valueTypes("@Const mkldnn_primitive").pointerTypes("@Const @ByPtrPtr mkldnn_primitive"))
               .put(new Info("mkldnn_stream_t").valueTypes("mkldnn_stream").pointerTypes("@ByPtrPtr mkldnn_stream"))
               .put(new Info("const_mkldnn_stream_t").valueTypes("@Const mkldnn_stream").pointerTypes("@Const @ByPtrPtr mkldnn_stream"))
