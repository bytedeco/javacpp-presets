...
public static class mkldnn_wino_desc_t extends Pointer {
    ...
    public native int m(); public native mkldnn_wino_desc_t m(int m);
    ...
    public native int nb_ic(); public native mkldnn_wino_desc_t nb_ic(int nb_ic);
    public native int nb_oc(); public native mkldnn_wino_desc_t nb_oc(int nb_oc);
...
public static class mkldnn_primitive_at_t extends Pointer {
    ...
    public native @Const mkldnn_primitive primitive(); public native mkldnn_primitive_at_t primitive(@Const mkldnn_primitive primitive);
...
@Namespace("mkldnn") public static class rnn_forward extends primitive {
    ...
    public static class primitive_desc extends mkldnn_primitive_desc_handle {
        ...
        public native @ByVal memory.primitive_desc weights_src_iter_primitive_desc();
