...
public class mkldnn_pooling_desc_t extends Pointer {
    ...
    @Override public mkldnn_pooling_desc_t getPointer(long i) {
        return new mkldnn_pooling_desc_t((Pointer)this).position(position + i);
    }
    ...
    @MemberGetter public native IntPointer kernel();
