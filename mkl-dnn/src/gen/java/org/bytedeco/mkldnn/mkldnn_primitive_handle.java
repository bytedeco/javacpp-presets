...
public class mkldnn_primitive_handle extends Pointer {
    ...
    ///
    ///
    public mkldnn_primitive_handle(mkldnn_primitive t, @Cast("bool") boolean weak/*=false*/) { super((Pointer)null); allocate(t, weak); }
    private native void allocate(mkldnn_primitive t, @Cast("bool") boolean weak/*=false*/);
    public mkldnn_primitive_handle(mkldnn_primitive t) { super((Pointer)null); allocate(t); }
    private native void allocate(mkldnn_primitive t);
    ...
    public native mkldnn_primitive get(@Cast("bool") boolean allow_emtpy/*=false*/);
