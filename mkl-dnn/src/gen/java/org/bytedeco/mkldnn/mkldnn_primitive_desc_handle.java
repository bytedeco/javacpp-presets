...
public class mkldnn_primitive_desc_handle extends Pointer {
    ...
    ///
    ///
    public mkldnn_primitive_desc_handle(mkldnn_primitive_desc t, @Cast("bool") boolean weak/*=false*/) { super((Pointer)null); allocate(t, weak); }
    private native void allocate(mkldnn_primitive_desc t, @Cast("bool") boolean weak/*=false*/);
    public mkldnn_primitive_desc_handle(mkldnn_primitive_desc t) { super((Pointer)null); allocate(t); }
    private native void allocate(mkldnn_primitive_desc t);
    ...
    public native mkldnn_primitive_desc get(@Cast("bool") boolean allow_emtpy/*=false*/);
