...
public class mkldnn_stream_handle extends Pointer {
    ...
    ///
    ///
    public mkldnn_stream_handle(mkldnn_stream t, @Cast("bool") boolean weak/*=false*/) { super((Pointer)null); allocate(t, weak); }
    private native void allocate(mkldnn_stream t, @Cast("bool") boolean weak/*=false*/);
    public mkldnn_stream_handle(mkldnn_stream t) { super((Pointer)null); allocate(t); }
    private native void allocate(mkldnn_stream t);
    ...
    public native mkldnn_stream get(@Cast("bool") boolean allow_emtpy/*=false*/);
