...
@Namespace("sentencepiece") public static native void SetMinLogLevel(int v);
...
// Targeting ../SentencePieceNormalizer.java



// Converts the utf8 byte spans into Unicode char span.
@Namespace("sentencepiece") public static native void ConvertToUnicodeAlignment(@StdString String orig, @StdString String norm,
...
@Namespace("sentencepiece") public static native void SetDataDir(@StdString String data_dir);
