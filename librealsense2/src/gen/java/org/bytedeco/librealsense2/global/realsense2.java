...
* @param frame [in]         Left or right camera frame of size 256x144
* @param rect_sides [out]   The four rectangle side sizes in pixels with the order of top, bottom, left, and right
* @param error [out]        If non-null, receives any error that occurs during this call, otherwise, errors are ignored
*/
...
// #include "rs_types.h"
    ...
    */
    ...
    public static final int
        ...
        /** Number of enumeration values. Not a valid input: intended to be used in for-loops. */
        RS2_OPTION_COUNT = RS2_OPTION_AMBIENT_LIGHT + 18;
