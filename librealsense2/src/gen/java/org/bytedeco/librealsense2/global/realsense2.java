...
// #include "rs_types.h"
   ...
   */
    ...
    /**
    * get option name
    * @param options [in]     options object
    * @param option [in]      option id to be checked
    * @param error [out]     if non-null, receives any error that occurs during this call, otherwise, errors are ignored
...
*/
public static native rs2_frame_queue rs2_create_frame_queue(int capacity, @Cast("rs2_error**") PointerPointer error);
public static native rs2_frame_queue rs2_create_frame_queue(int capacity, @ByPtrPtr rs2_error error);
...
* @param device [in]  input RealSense device
* @param error [out]  if non-null, receives any error that occurs during this call, otherwise, errors are ignored
* @return            list of stream profiles that given subdevice can provide, should be released by rs2_delete_profiles_list
*/
public static native rs2_stream_profile_list rs2_get_stream_profiles(rs2_sensor device, @Cast("rs2_error**") PointerPointer error);
public static native rs2_stream_profile_list rs2_get_stream_profiles(rs2_sensor device, @ByPtrPtr rs2_error error);
