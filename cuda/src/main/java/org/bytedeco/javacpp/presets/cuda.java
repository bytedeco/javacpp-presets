 ...
 * @author Samuel Audet
 */
@Properties(names = {"linux-x86_64", "linux-arm", "linux-arm64", "linux-ppc64", "macosx-x86_64", "windows-x86_64"}, value = {
    ...
    @Platform(value = "windows-x86_64", includepath = "C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v7.0/include/",
                                        preloadpath = "C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v7.0/bin/",
                                           linkpath = "C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v7.0/lib/x64/") },
