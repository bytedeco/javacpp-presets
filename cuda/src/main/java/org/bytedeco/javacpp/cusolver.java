...
@Opaque public static class syevjInfo extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public syevjInfo() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public syevjInfo(Pointer p) { super(p); }
}

@Opaque public static class gesvdjInfo extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
