...
public static native @Cast("cublasStatus_t") int cublasSgetrsBatched( cublasContext handle, 
                                                            ...
                                                            @Cast("float**") PointerPointer Barray, 
                                                            int ldb, 
                                                            IntPointer info,
                                                            int batchSize);
public static native @Cast("cublasStatus_t") int cublasSgetrsBatched( cublasContext handle, 
...
public static native @Cast("cublasStatus_t") int cublasDgetrsBatched( cublasContext handle, 
                                                           ...
                                                           int lda, 
                                                           @Const IntPointer devIpiv, 
                                                           @Cast("double**") PointerPointer Barray, 
                                                           int ldb, 
                                                           IntPointer info,
                                                           int batchSize);
public static native @Cast("cublasStatus_t") int cublasDgetrsBatched( cublasContext handle, 
...
public static native @Cast("cublasStatus_t") int cublasCgetrsBatched( cublasContext handle, 
                                                            ...
                                                            int lda, 
                                                            @Const IntPointer devIpiv, 
                                                            @Cast("cuComplex**") PointerPointer Barray, 
                                                            int ldb, 
                                                            IntPointer info,
                                                            int batchSize);
public static native @Cast("cublasStatus_t") int cublasCgetrsBatched( cublasContext handle, 
                                                            ...
                                                            int lda, 
                                                            @Const IntPointer devIpiv, 
                                                            @Cast("cuComplex**") @ByPtrPtr float2 Barray, 
                                                            int ldb, 
                                                            IntPointer info,
                                                            int batchSize);
public static native @Cast("cublasStatus_t") int cublasCgetrsBatched( cublasContext handle, 
...
public static native @Cast("cublasStatus_t") int cublasZgetrsBatched( cublasContext handle, 
                                                            ...
                                                            int lda, 
                                                            @Const IntPointer devIpiv, 
                                                            @Cast("cuDoubleComplex**") PointerPointer Barray, 
                                                            int ldb, 
                                                            IntPointer info,
                                                            int batchSize);
public static native @Cast("cublasStatus_t") int cublasZgetrsBatched( cublasContext handle, 
                                                            ...
                                                            int lda, 
                                                            @Const IntPointer devIpiv, 
                                                            @Cast("cuDoubleComplex**") @ByPtrPtr double2 Barray, 
                                                            int ldb, 
                                                            IntPointer info,
                                                            int batchSize);
public static native @Cast("cublasStatus_t") int cublasZgetrsBatched( cublasContext handle, 
