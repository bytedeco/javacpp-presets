...
public static native @Cast("cublasStatus_t") int cublasHgemmBatched(cublasContext handle,
                                                          ...
                                                          int k,
                                                          @Const __half alpha,  
                                                          @Cast("const __half**") PointerPointer Aarray, 
                                                          int lda,
                                                          @Cast("const __half**") PointerPointer Barray,
                                                          int ldb, 
                                                          @Const __half beta,  
                                                          @Cast("__half**") PointerPointer Carray,
                                                          int ldc,
                                                          int batchCount);
public static native @Cast("cublasStatus_t") int cublasHgemmBatched(cublasContext handle,
                                                          @Cast("cublasOperation_t") int transa,
...
public static native @Cast("cublasStatus_t") int cublasGemmBatchedEx(cublasContext handle, 
                                                      ...
                                                      int k,
                                                      @Const Pointer alpha,  
                                                      @Cast("const void**") PointerPointer Aarray, 
                                                      @Cast("cudaDataType") int Atype,
                                                      int lda,
                                                      @Cast("const void**") PointerPointer Barray,
                                                      @Cast("cudaDataType") int Btype,
                                                      int ldb, 
                                                      @Const Pointer beta,  
                                                      @Cast("void**") PointerPointer Carray,
                                                      @Cast("cudaDataType") int Ctype,
                                                      int ldc,
                                                      int batchCount,
                                                      @Cast("cudaDataType") int computeType,
...
public static native @Cast("cublasStatus_t") int cublasGemmBatchedEx(cublasContext handle, 
                                                      ...
                                                      int k,
                                                      @Const Pointer alpha,  
                                                      @Cast("const void**") @ByPtrPtr Pointer Aarray, 
                                                      @Cast("cudaDataType") int Atype,
                                                      int lda,
                                                      @Cast("const void**") @ByPtrPtr Pointer Barray,
                                                      @Cast("cudaDataType") int Btype,
                                                      int ldb, 
                                                      @Const Pointer beta,  
                                                      @Cast("void**") @ByPtrPtr Pointer Carray,
                                                      @Cast("cudaDataType") int Ctype,
                                                      int ldc,
                                                      int batchCount,
                                                      @Cast("cudaDataType") int computeType,
