...
public class nccl extends org.bytedeco.javacpp.presets.nccl {
    static { Loader.load(); }
...
@Opaque public static class ncclComm extends Pointer {
...
public static class ncclUniqueId extends Pointer {
    static { Loader.load(); }
