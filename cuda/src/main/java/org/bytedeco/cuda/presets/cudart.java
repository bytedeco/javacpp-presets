...
@Properties(inherit = javacpp.class, names = {"linux-x86_64", "linux-arm64", "linux-ppc64le", "macosx-x86_64", "windows-x86_64"}, value = {
    @Platform(include = {"<cuda.h>", "<crt/host_defines.h>", "<device_types.h>", "<driver_types.h>", "<surface_types.h>", "<texture_types.h>",
              ...
              includepath = {"/usr/local/cuda-13.4/include/", "/usr/local/cuda/include/", "/usr/include/"},
              link = {"cudart@.13", "cuda@.1#"}, linkpath = {"/usr/local/cuda-13.4/lib/", "/usr/local/cuda/lib/", "/usr/lib/"}),
    @Platform(value = {"linux-x86_64", "linux-arm64", "linux-ppc64le"}, linkpath = {"/usr/local/cuda-13.4/lib64/", "/usr/local/cuda/lib64/", "/usr/lib64/"}),
    @Platform(value = "macosx-x86_64",  includepath =  "/Developer/NVIDIA/CUDA-13.4/include/",
                                           linkpath = {"/Developer/NVIDIA/CUDA-13.4/lib/", "/usr/local/cuda/lib/"}),
    @Platform(value = "windows-x86_64",     preload = "cudart64_13",
                                        includepath = "C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v13.4/include/",
                                        preloadpath = {"C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v13.4/bin/",
                                                       "C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v13.4/bin/x64/"},
                                           linkpath = "C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v13.4/lib/x64/") },
...
public class cudart implements InfoMapper {
    ...
    public void map(InfoMap infoMap) {
        infoMap.put(new Info("__volatile__", "__no_return__", "__noinline__", "__forceinline__", "__thread__", "__restrict__", "__grid_constant__",
                             ...
                             "__tile_global__", "__tile__", "__tile_builtin__", "__NV_SILENCE_HOST_DEPRECATION_BEGIN", "__NV_SILENCE_HOST_DEPRECATION_END",
                             "__CUDA_FP16_INLINE__", "__CUDA_FP16_FORCEINLINE__", "__CUDA_BF16_INLINE__", "__CUDA_BF16_FORCEINLINE__",
                             "__CUDA_API_PTSZ", "__CLZ_RETURN_TYPE", "__CLZ_PARAMETER_TYPE", "__CLZLL_PARAMETER_TYPE").cppTypes().annotations().cppText(""))
...
//               .put(new Info("cuda_runtime_api.h").linePatterns("#define cudaSignalExternalSemaphoresAsync.*", "#define cudaGetDeviceProperties.*").skip())
               .put(new Info("cuda.h").linePatterns("#define cuDeviceTotalMem.*", "#define cuMemBatchDecompressAsync.*").skip())
               ...
               .put(new Info("__CUDA_FP16_DECL__", "__CUDA_BF16_DECL__", "__float_simpl_sinf(float)", "__float_simpl_cosf(float)",
                             ...
                             "cuMemRetainAllocationHandle", "cudaWGLGetDevice", "cuWGLGetDevice",
                             "CUcoredumpCallbackHandle").skip())
               ...
               .put(new Info("CUcheckpointOperationHandle").valueTypes("CUIcheckpointOperation_st").pointerTypes("@ByPtrPtr CUIcheckpointOperation_st"))
