...
public class NppiWarpPerspectiveBatchCXR extends Pointer {
    ...
    public native int nSrcStep(); public native NppiWarpPerspectiveBatchCXR nSrcStep(int nSrcStep);
    public native Pointer pDst(); public native NppiWarpPerspectiveBatchCXR pDst(Pointer pDst);        /* device memory pointer */
    public native int nDstStep(); public native NppiWarpPerspectiveBatchCXR nDstStep(int nDstStep);
    public native @Cast("Npp64f*") DoublePointer pCoeffs(); public native NppiWarpPerspectiveBatchCXR pCoeffs(DoublePointer pCoeffs);   /* device memory pointer to the tranformation matrix with double precision floating-point coefficient values to be used for this image */
    public native @Cast("Npp64f") double aTransformedCoeffs(int i, int j); public native NppiWarpPerspectiveBatchCXR aTransformedCoeffs(int i, int j, double aTransformedCoeffs);
