...
public class nvmlVgpuVersion_t extends Pointer {
    ...
    public native @Cast("unsigned int") int minVersion(); public native nvmlVgpuVersion_t minVersion(int minVersion);
    /** Maximum vGPU version. */
    public native @Cast("unsigned int") int maxVersion(); public native nvmlVgpuVersion_t maxVersion(int maxVersion);
}
