...
public class nvmlValue_t extends Pointer {
    ...
    public native int siVal(); public native nvmlValue_t siVal(int setter);
    ...
    public native @Cast("unsigned short") short usVal(); public native nvmlValue_t usVal(short setter);
}
