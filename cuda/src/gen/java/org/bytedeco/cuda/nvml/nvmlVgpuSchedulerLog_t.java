...
public class nvmlVgpuSchedulerLog_t extends Pointer {
    ...
    /** Flag to check Adaptive Round Robin scheduler mode */
    public native @Cast("unsigned int") int isEnabledARR(); public native nvmlVgpuSchedulerLog_t isEnabledARR(int setter);
