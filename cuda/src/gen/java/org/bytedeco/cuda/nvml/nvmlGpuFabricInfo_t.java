...
public class nvmlGpuFabricInfo_t extends Pointer {
    ...
    public native @Cast("char") byte clusterUuid(int i); public native nvmlGpuFabricInfo_t clusterUuid(int i, byte setter);
    @MemberGetter public native @Cast("char*") BytePointer clusterUuid();
    ...
    /** ID of the fabric partition to which this GPU belongs */
    public native @Cast("unsigned int") int partitionId(); public native nvmlGpuFabricInfo_t partitionId(int setter);
