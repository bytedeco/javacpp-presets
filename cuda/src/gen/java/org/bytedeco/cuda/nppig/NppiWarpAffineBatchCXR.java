...
public class NppiWarpAffineBatchCXR extends Pointer {
    ...
    public native int nSrcStep(); public native NppiWarpAffineBatchCXR nSrcStep(int nSrcStep);
    public native Pointer pDst(); public native NppiWarpAffineBatchCXR pDst(Pointer pDst);        /* device memory pointer */
    public native int nDstStep(); public native NppiWarpAffineBatchCXR nDstStep(int nDstStep);
    public native @Cast("Npp64f*") DoublePointer pCoeffs(); public native NppiWarpAffineBatchCXR pCoeffs(DoublePointer pCoeffs);   /* device memory pointer to the tranformation matrix with double precision floating-point coefficient values to be used for this image */
    public native @Cast("Npp64f") double aTransformedCoeffs(int i, int j); public native NppiWarpAffineBatchCXR aTransformedCoeffs(int i, int j, double aTransformedCoeffs);
