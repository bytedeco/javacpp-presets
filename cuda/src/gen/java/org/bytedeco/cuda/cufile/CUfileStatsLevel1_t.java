...
public class CUfileStatsLevel1_t extends Pointer {
    ...
    public native @ByRef CUfileOpCounter_t readv_ops(); public native CUfileStatsLevel1_t readv_ops(CUfileOpCounter_t setter);         // cuFileReadv operations
    public native @ByRef CUfileOpCounter_t writev_ops(); public native CUfileStatsLevel1_t writev_ops(CUfileOpCounter_t setter);        // cuFileWritev operations
    public native @Cast("uint64_t") long readv_bytes(); public native CUfileStatsLevel1_t readv_bytes(long setter);                // Total bytes read via cuFileReadv
    public native @Cast("uint64_t") long writev_bytes(); public native CUfileStatsLevel1_t writev_bytes(long setter);               // Total bytes written via cuFileWritev
    public native @Cast("uint64_t") long readv_bw_bytes_per_sec(); public native CUfileStatsLevel1_t readv_bw_bytes_per_sec(long setter);     // cuFileReadv bandwidth (bytes/sec)
    public native @Cast("uint64_t") long writev_bw_bytes_per_sec(); public native CUfileStatsLevel1_t writev_bw_bytes_per_sec(long setter);    // cuFileWritev bandwidth (bytes/sec)
    public native @Cast("uint64_t") long readv_lat_avg_us(); public native CUfileStatsLevel1_t readv_lat_avg_us(long setter);           // Average cuFileReadv latency (microseconds)
    public native @Cast("uint64_t") long writev_lat_avg_us(); public native CUfileStatsLevel1_t writev_lat_avg_us(long setter);          // Average cuFileWritev latency (microseconds)
    public native @Cast("uint64_t") long readv_ops_per_sec(); public native CUfileStatsLevel1_t readv_ops_per_sec(long setter);          // cuFileReadv operations per second
    public native @Cast("uint64_t") long writev_ops_per_sec(); public native CUfileStatsLevel1_t writev_ops_per_sec(long setter);         // cuFileWritev operations per second
    public native @Cast("uint64_t") long readv_lat_sum_us(); public native CUfileStatsLevel1_t readv_lat_sum_us(long setter);           // Sum of cuFileReadv latencies
    public native @Cast("uint64_t") long writev_lat_sum_us(); public native CUfileStatsLevel1_t writev_lat_sum_us(long setter);          // Sum of cuFileWritev latencies
}
