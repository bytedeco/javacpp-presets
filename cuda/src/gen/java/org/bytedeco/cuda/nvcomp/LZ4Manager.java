 ...
 * invalid output.
 *
 * \note If user_stream is specified, the lifetime of the LZ4Manager must not
...
public class LZ4Manager extends PimplManager {
  ...
  public LZ4Manager(
      ...
      @Const @ByRef(nullValue = "nvcompBatchedLZ4CompressOpts_t(nvcompBatchedLZ4CompressDefaultOpts)") nvcompBatchedLZ4CompressOpts_t compress_opts,
      @Const @ByRef(nullValue = "nvcompBatchedLZ4DecompressOpts_t(nvcompBatchedLZ4DecompressDefaultOpts)") nvcompBatchedLZ4DecompressOpts_t decompress_opts,
