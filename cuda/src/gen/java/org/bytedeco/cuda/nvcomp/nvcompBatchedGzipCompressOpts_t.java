...
public class nvcompBatchedGzipCompressOpts_t extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public nvcompBatchedGzipCompressOpts_t() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public nvcompBatchedGzipCompressOpts_t(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public nvcompBatchedGzipCompressOpts_t(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public nvcompBatchedGzipCompressOpts_t position(long position) {
        return (nvcompBatchedGzipCompressOpts_t)super.position(position);
    }
    @Override public nvcompBatchedGzipCompressOpts_t getPointer(long i) {
        return new nvcompBatchedGzipCompressOpts_t((Pointer)this).offsetAddress(i);
    }
   ...
   */
  public native @Cast("char") byte reserved(int i); public native nvcompBatchedGzipCompressOpts_t reserved(int i, byte setter);
