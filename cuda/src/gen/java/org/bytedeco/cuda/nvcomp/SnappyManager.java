...
public class SnappyManager extends PimplManager {
  ...
  @Deprecated public SnappyManager(
      @Cast("size_t") long uncomp_chunk_size, @Const @ByRef nvcompBatchedSnappyOpts_t format_opts, CUstream_st user_stream,
  ...
  @Deprecated public SnappyManager(
      @Cast("size_t") long uncomp_chunk_size, @Const @ByRef nvcompBatchedSnappyOpts_t format_opts, CUstream_st user_stream,
      int device_id) { super((Pointer)null); allocate(uncomp_chunk_size, format_opts, user_stream, device_id); }
  @Deprecated private native void allocate(
      @Cast("size_t") long uncomp_chunk_size, @Const @ByRef nvcompBatchedSnappyOpts_t format_opts, CUstream_st user_stream,
      int device_id);
}
