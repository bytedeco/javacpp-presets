 ...
 * invalid output.
 *
 * \note If user_stream is specified, the lifetime of the BitcompManager instance must not
 * extend beyond that of the user_stream.
 */
@Namespace("nvcomp") @Properties(inherit = org.bytedeco.cuda.presets.nvcomp.class)
public class BitcompManager extends PimplManager {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public BitcompManager(Pointer p) { super(p); }
  ...
  public BitcompManager(
      ...
      @Const @ByRef(nullValue = "nvcompBatchedBitcompCompressOpts_t(nvcompBatchedBitcompCompressDefaultOpts)") nvcompBatchedBitcompCompressOpts_t compress_opts,
      @Const @ByRef(nullValue = "nvcompBatchedBitcompDecompressOpts_t(nvcompBatchedBitcompDecompressDefaultOpts)") nvcompBatchedBitcompDecompressOpts_t decompress_opts,
