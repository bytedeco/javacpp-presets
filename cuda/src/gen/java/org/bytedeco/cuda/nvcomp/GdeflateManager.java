...
public class GdeflateManager extends PimplManager {
  ...
  public GdeflateManager(
      @Cast("size_t") long uncomp_chunk_size, @Const @ByRef nvcompBatchedGdeflateOpts_t format_opts,
  ...
  public GdeflateManager(
      @Cast("size_t") long uncomp_chunk_size, @Const @ByRef nvcompBatchedGdeflateOpts_t format_opts) { super((Pointer)null); allocate(uncomp_chunk_size, format_opts); }
  private native void allocate(
      @Cast("size_t") long uncomp_chunk_size, @Const @ByRef nvcompBatchedGdeflateOpts_t format_opts);
  ...
  @Deprecated public GdeflateManager(
      @Cast("size_t") long uncomp_chunk_size, @Const @ByRef nvcompBatchedGdeflateOpts_t format_opts,
