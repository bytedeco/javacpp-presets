 ...
 *
 * \note If user_stream is specified, the lifetime of the GdeflateManager instance must not
 * extend beyond that of the user_stream.
 */
@Namespace("nvcomp") @Properties(inherit = org.bytedeco.cuda.presets.nvcomp.class)
public class GdeflateManager extends PimplManager {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public GdeflateManager(Pointer p) { super(p); }
   ...
   */
  public GdeflateManager(
      @Cast("size_t") long uncomp_chunk_size,
      @Const @ByRef(nullValue = "nvcompBatchedGdeflateCompressOpts_t(nvcompBatchedGdeflateCompressDefaultOpts)") nvcompBatchedGdeflateCompressOpts_t compress_opts,
      @Const @ByRef(nullValue = "nvcompBatchedGdeflateDecompressOpts_t(nvcompBatchedGdeflateDecompressDefaultOpts)") nvcompBatchedGdeflateDecompressOpts_t decompress_opts,
