...
public class cudaPointerAttributes extends Pointer {
    ...
    /**
     * Locality domain ordinal for device allocations localized to a locality domain, or
     * -1 when the allocation is not localized to a locality domain.
     */
        public native int localityDomainOrdinal(); public native cudaPointerAttributes localityDomainOrdinal(int setter);
        public native long unused(); public native cudaPointerAttributes unused(long setter); // union with long unused maintains struct size across platforms because reserved is long
    /**
     * Must be zero
     */
    public native long reserved(int i); public native cudaPointerAttributes reserved(int i, long setter);
    @MemberGetter public native CLongPointer reserved();
}
