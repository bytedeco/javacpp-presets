...
public class cudaResourceDesc extends Pointer {
    ...
    public native @Cast("cudaResourceType") int resType(); public native cudaResourceDesc resType(int setter);
            ...
            @Name("res.reserved.reserved") public native int res_reserved_reserved(int i); public native cudaResourceDesc res_reserved_reserved(int i, int setter);
            @Name("res.reserved.reserved") @MemberGetter public native IntPointer res_reserved_reserved();

    /** Flags (must be zero) */
    public native @Cast("unsigned int") int flags(); public native cudaResourceDesc flags(int setter);
}
