...
public class cudaLaunchAttributeValue extends Pointer {
     ...
     */
        @Name("preferredClusterDim.x") public native @Cast("unsigned int") int preferredClusterDim_x(); public native cudaLaunchAttributeValue preferredClusterDim_x(int setter);
        @Name("preferredClusterDim.y") public native @Cast("unsigned int") int preferredClusterDim_y(); public native cudaLaunchAttributeValue preferredClusterDim_y(int setter);
        @Name("preferredClusterDim.z") public native @Cast("unsigned int") int preferredClusterDim_z(); public native cudaLaunchAttributeValue preferredClusterDim_z(int setter);
    ...
    public native @Cast("unsigned int") int nvlinkUtilCentricScheduling(); public native cudaLaunchAttributeValue nvlinkUtilCentricScheduling(int setter);
    /** Value of launch attribute ::cudaLaunchAttributePortableClusterSizeMode*/
    public native @Cast("cudaLaunchAttributePortableClusterMode") int portableClusterSizeMode(); public native cudaLaunchAttributeValue portableClusterSizeMode(int setter);
    /** Value of launch attribute ::cudaLaunchAttributeSharedMemoryMode. 
                                                    See ::cudaSharedMemoryMode for acceptable values.*/
    public native @Cast("cudaSharedMemoryMode") int sharedMemoryMode(); public native cudaLaunchAttributeValue sharedMemoryMode(int setter);
}
