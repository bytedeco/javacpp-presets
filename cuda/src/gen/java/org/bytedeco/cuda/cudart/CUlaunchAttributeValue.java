...
public class CUlaunchAttributeValue extends Pointer {
    ...
    public native @Cast("CUlaunchAttributePortableClusterMode") int portableClusterSizeMode(); public native CUlaunchAttributeValue portableClusterSizeMode(int setter);
    /** Value of launch attribute ::CU_LAUNCH_ATTRIBUTE_SHARED_MEMORY_MODE. 
                                                  See ::CUsharedMemoryMode for acceptable values.*/
    public native @Cast("CUsharedMemoryMode") int sharedMemoryMode(); public native CUlaunchAttributeValue sharedMemoryMode(int setter);
}
