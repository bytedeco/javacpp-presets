...
public class cudaMemLocation extends Pointer {
    ...
    public native @Cast("cudaMemLocationType") int type(); public native cudaMemLocation type(int setter);
        ...
        public native int id(); public native cudaMemLocation id(int setter);
            /** Device ID */
            @Name("localized.deviceId") public native @Cast("unsigned char") byte localized_deviceId(); public native cudaMemLocation localized_deviceId(byte setter);
            /** Locality domain ID */
            @Name("localized.localityDomainId") public native @Cast("unsigned char") byte localized_localityDomainId(); public native cudaMemLocation localized_localityDomainId(byte setter);
}
