...
public class cudaFuncAttributes extends Pointer {
    ...
    *
    * This attribute is ignored if the sharedMemoryMode function or launch
    * attribute is set.
    *
    * This attribute cannot be used to access oversized shared memory.
    ...
    * See ::cudaFuncSetAttribute
    */
   public native @Cast("cudaSharedMemoryMode") int sharedMemoryMode(); public native cudaFuncAttributes sharedMemoryMode(int setter);
