...
public class cudaKernelNodeParamsV2 extends Pointer {
    ...
    @Override public cudaKernelNodeParamsV2 getPointer(long i) {
        ...
        public native CUkern_st kern(); public native cudaKernelNodeParamsV2 kern(CUkern_st setter); 
        /** functionType = cudaKernelFucntionTypeFunction */
        public native CUfunc_st cuFunc(); public native cudaKernelNodeParamsV2 cuFunc(CUfunc_st setter);
...
//     #endif
    ...
    public native @Cast("cudaKernelFunctionType") int functionType(); public native cudaKernelNodeParamsV2 functionType(int setter);
}
