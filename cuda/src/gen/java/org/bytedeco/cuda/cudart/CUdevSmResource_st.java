...
public class CUdevSmResource_st extends Pointer {
    ...
    /** Locality domain that the SM must be located on. Only valid if
                                                       CU_DEV_SM_RESOURCE_GROUP_LOCALITY_DOMAIN_ID is set in flags. If the backfill flag is set,
                                                       SMs may be assigned from other locality domains. */
    public native @Cast("unsigned int") int localityDomainId(); public native CUdevSmResource_st localityDomainId(int setter);
}
