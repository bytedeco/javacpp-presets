...
public class CUmemLocation_v1 extends Pointer {
    ...
    public native @Cast("CUmemLocationType") int type(); public native CUmemLocation_v1 type(int setter);
        ...
        public native int id(); public native CUmemLocation_v1 id(int setter);
            /** Device ID */
            @Name("localized.deviceId") public native @Cast("unsigned char") byte localized_deviceId(); public native CUmemLocation_v1 localized_deviceId(byte setter);
            /** Locality domain ID */
            @Name("localized.localityDomainId") public native @Cast("unsigned char") byte localized_localityDomainId(); public native CUmemLocation_v1 localized_localityDomainId(byte setter);
}
