 ...
 * @param pBufferRequestInfo Additional information about the requested buffer.
 */
@Convention("CUPTIAPI") @Properties(inherit = org.bytedeco.cuda.presets.cupti.class)
public class CUpti_BuffersCallbackRequestFunc_v2 extends FunctionPointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public    CUpti_BuffersCallbackRequestFunc_v2(Pointer p) { super(p); }
    protected CUpti_BuffersCallbackRequestFunc_v2() { allocate(); }
    private native void allocate();
    public native void call(@Cast("uint8_t**") PointerPointer buffer, @Cast("size_t*") SizeTPointer size, @Cast("size_t*") SizeTPointer maxNumRecords, CUpti_BufferCallbackRequestInfo pBufferRequestInfo);
}
