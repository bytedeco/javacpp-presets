 ...
 * @param pBufferCompleteInfo Additional information about the completed buffer.
 */
@Convention("CUPTIAPI") @Properties(inherit = org.bytedeco.cuda.presets.cupti.class)
public class CUpti_BuffersCallbackCompleteFunc_v2 extends FunctionPointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public    CUpti_BuffersCallbackCompleteFunc_v2(Pointer p) { super(p); }
    protected CUpti_BuffersCallbackCompleteFunc_v2() { allocate(); }
    private native void allocate();
    public native void call(@Cast("uint8_t*") BytePointer buffer, @Cast("size_t") long size, @Cast("size_t") long validSize, CUpti_BufferCallbackCompleteInfo pBufferCompleteInfo);
}
