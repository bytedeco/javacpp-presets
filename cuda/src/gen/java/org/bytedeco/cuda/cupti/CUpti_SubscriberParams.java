...
public class CUpti_SubscriberParams extends Pointer {
     ...
     * If 0, requesting to disallow multiple subscribers.
     * If 1, requesting to allow multiple subscribers.
    ...
    public native @Cast("uint8_t") byte padding(int i); public native CUpti_SubscriberParams padding(int i, byte setter);
    @MemberGetter public native @Cast("uint8_t*") BytePointer padding();
}
