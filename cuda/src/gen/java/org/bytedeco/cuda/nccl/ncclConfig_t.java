...
public class ncclConfig_t extends Pointer {
  ...
  public native int launchOrderImplicit(); public native ncclConfig_t launchOrderImplicit(int setter);
  public native int numRmaSig(); public native ncclConfig_t numRmaSig(int setter);
  public native int rmaEagerInit(); public native ncclConfig_t rmaEagerInit(int setter);
  public native int hostCftMode(); public native ncclConfig_t hostCftMode(int setter);
}
