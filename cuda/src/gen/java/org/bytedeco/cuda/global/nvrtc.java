 ...
 *
 * @param prog [in]       CUDA Runtime Compilation program.
 * @param TileIRSizeRet [out] Size of the generated cuda_tile IR.
 * @return
 *   - \link #nvrtcResult NVRTC_SUCCESS \endlink
 *   - \link #nvrtcResult NVRTC_ERROR_INVALID_INPUT \endlink
 *   - \link #nvrtcResult NVRTC_ERROR_INVALID_PROGRAM \endlink
 ...
 * @see     ::nvrtcGetTileIR
 */
public static native @Cast("nvrtcResult") int nvrtcGetTileIRSize(_nvrtcProgram prog, @Cast("size_t*") SizeTPointer TileIRSizeRet);
 ...
 *
 * @param prog [in] CUDA Runtime Compilation program.
 * @param TileIR [out]  Generated cuda_tile IR.
 * @return
 *   - \link #nvrtcResult NVRTC_SUCCESS \endlink
 *   - \link #nvrtcResult NVRTC_ERROR_INVALID_INPUT \endlink
 *   - \link #nvrtcResult NVRTC_ERROR_INVALID_PROGRAM \endlink
 ...
 */
public static native @Cast("nvrtcResult") int nvrtcGetTileIR(_nvrtcProgram prog, @Cast("char*") BytePointer TileIR);
public static native @Cast("nvrtcResult") int nvrtcGetTileIR(_nvrtcProgram prog, @Cast("char*") ByteBuffer TileIR);
public static native @Cast("nvrtcResult") int nvrtcGetTileIR(_nvrtcProgram prog, @Cast("char*") byte[] TileIR);
 ...
 */
public static final int NVRTC_INSTALL_HEADERS_SKIP_IF_EXISTS =     0x0;
/**
 * \ingroup bundled_headers
 * \brief Clear existing directory contents before installation.
 *        Guarantees consistency by removing any existing files first.
 */
public static final int NVRTC_INSTALL_HEADERS_FORCE_OVERWRITE =    0x1;
/**
 * \ingroup bundled_headers
 ...
 */
public static final int NVRTC_INSTALL_HEADERS_NO_WAIT =            0x2;
 ...
 *
 * @param installPath [in] Path where headers should be extracted (UTF-8 encoded).
 *                           The directory will be created if it doesn't exist.
 * @param flags [in]       NVRTC_INSTALL_HEADERS_* flags:
 ...
 * @param errorLog [out]   Optional pointer to receive detailed error message on failure.
 ...
 */
public static native @Cast("nvrtcResult") int nvrtcInstallBundledHeaders(@Cast("const char*") BytePointer installPath, @Cast("unsigned int") int flags,
                                       @Cast("const char**") PointerPointer errorLog);
public static native @Cast("nvrtcResult") int nvrtcInstallBundledHeaders(@Cast("const char*") BytePointer installPath, @Cast("unsigned int") int flags,
                                       @Cast("const char**") @ByPtrPtr BytePointer errorLog);
public static native @Cast("nvrtcResult") int nvrtcInstallBundledHeaders(String installPath, @Cast("unsigned int") int flags,
                                       @Cast("const char**") @ByPtrPtr ByteBuffer errorLog);
public static native @Cast("nvrtcResult") int nvrtcInstallBundledHeaders(@Cast("const char*") BytePointer installPath, @Cast("unsigned int") int flags,
                                       @Cast("const char**") @ByPtrPtr byte[] errorLog);
public static native @Cast("nvrtcResult") int nvrtcInstallBundledHeaders(String installPath, @Cast("unsigned int") int flags,
                                       @Cast("const char**") @ByPtrPtr BytePointer errorLog);
public static native @Cast("nvrtcResult") int nvrtcInstallBundledHeaders(@Cast("const char*") BytePointer installPath, @Cast("unsigned int") int flags,
                                       @Cast("const char**") @ByPtrPtr ByteBuffer errorLog);
public static native @Cast("nvrtcResult") int nvrtcInstallBundledHeaders(String installPath, @Cast("unsigned int") int flags,
                                       @Cast("const char**") @ByPtrPtr byte[] errorLog);
// Targeting ../nvrtc/nvrtcBundledHeadersInfo.java
 ...
 *
 * @param info [out] Pointer to structure to receive header information.
 * @param errorLog [out] Optional pointer to receive detailed error message on failure.
 *                         If non-NULL, \p *errorLog will be set to point to a string
 *                         describing the error cause. Note: subsequent API calls from
 *                         the same thread may overwrite this message.
 ...
 */
public static native @Cast("nvrtcResult") int nvrtcGetBundledHeadersInfo(nvrtcBundledHeadersInfo info,
                                       @Cast("const char**") PointerPointer errorLog);
public static native @Cast("nvrtcResult") int nvrtcGetBundledHeadersInfo(nvrtcBundledHeadersInfo info,
                                       @Cast("const char**") @ByPtrPtr BytePointer errorLog);
public static native @Cast("nvrtcResult") int nvrtcGetBundledHeadersInfo(nvrtcBundledHeadersInfo info,
 ...
 *
 * @param installPath [in] Path where headers were previously installed.
 ...
 *     (removal failed)
 */
public static native @Cast("nvrtcResult") int nvrtcRemoveBundledHeaders(@Cast("const char*") BytePointer installPath,
                                      @Cast("const char**") PointerPointer errorLog);
public static native @Cast("nvrtcResult") int nvrtcRemoveBundledHeaders(@Cast("const char*") BytePointer installPath,
                                      @Cast("const char**") @ByPtrPtr BytePointer errorLog);
public static native @Cast("nvrtcResult") int nvrtcRemoveBundledHeaders(String installPath,
                                      @Cast("const char**") @ByPtrPtr ByteBuffer errorLog);
public static native @Cast("nvrtcResult") int nvrtcRemoveBundledHeaders(@Cast("const char*") BytePointer installPath,
                                      @Cast("const char**") @ByPtrPtr byte[] errorLog);
public static native @Cast("nvrtcResult") int nvrtcRemoveBundledHeaders(String installPath,
 ...
 *       - Default: \c true
 *
 *     - \c --fno-signed-zeros (\c -fno-signed-zeros)
 *      
 *       This option instructs the optimizer not to distinguish between +-0.
 *
 *     - \c --ffinite-math-only (\c -ffinite-math-only)
 *      
 *       This option instructs the optimizer to assume that values are not 
 *       nan or +-inf.
 * 
 ...
 *
 *   - Language Dialect
 *     - \c --std={c++03|c++11|c++14|c++17|c++20|c++23} (\c -std)
 * 
 ...
 *
 *     - \c --Wconversion (\c -Wconversion)
 *
 *       Generate a warning when an implicit numeric conversion may narrow the value in the 
 *       target type (e.g. \c long \c long narrowed to \c int)
 *  
 ...
 *         - \c conversion: generate an error when an implicit numeric conversion may 
 *                          narrow the value in the target type (e.g. \c long \c long 
 *                          narrowed to \c int)
 *
 *     - \c --fmax-errors=<number> (\c -fmax-errors)
 *    
 *       Specify the maximum number of errors to emit before compilation is aborted;
