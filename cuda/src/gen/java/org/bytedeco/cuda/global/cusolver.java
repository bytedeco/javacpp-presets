...
public static final int CUSOLVER_VER_BUILD = 89;
...
public static native @Cast("cusolverStatus_t") int cusolverDnIRSParamsSetTol(
            cusolverDnIRSParams params,
            @Cast("cudaDataType") int data_type,
            double val );
...
public static native @Cast("cusolverStatus_t") int cusolverDnIRSParamsSetSolverPrecisions(
            cusolverDnIRSParams params,
            @Cast("cudaDataType") int solver_main_precision,
            @Cast("cudaDataType") int solver_lowest_precision );
...
public static native @Cast("cusolverStatus_t") int cusolverDnIRSParamsGetNiters(
            cusolverDnIRSParams params,
...
public static native @Cast("cusolverStatus_t") int cusolverDnIRSParamsGetOuterNiters(
            cusolverDnIRSParams params,
...
public static native @Cast("cusolverStatus_t") int cusolverDnIRSXgesv(
        ...
        @Cast("cudaDataType") int inout_data_type,
        @Cast("cusolver_int_t") int n, @Cast("cusolver_int_t") int nrhs,
