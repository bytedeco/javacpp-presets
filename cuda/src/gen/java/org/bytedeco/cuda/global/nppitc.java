 ...
 * 
 */
public static native @Cast("NppStatus") int nppiFusedAbsDiff_Threshold_GTVal_Ctx(@Cast("NppDataType") int eSrcDstType, @Cast("NppiChannels") int eSrcDstChannels,
                                     @Const Pointer pSrc1, int nSrc1Step,
                                     @Const Pointer pSrc2, int nSrc2Step,
                                     Pointer pDst, int nDstStep, @ByVal NppiSize oSizeROI, 
                                     @Const Pointer pThreshold, @Const Pointer pvalue,
 ...
 * 
 */
public static native @Cast("NppStatus") int nppiFusedAbsDiff_Threshold_GTVal_I_Ctx(@Cast("NppDataType") int eSrcDstType, @Cast("NppiChannels") int eSrcDstChannels,
                                       Pointer pSrcDst, int nSrcDstStep,  
                                       @Const Pointer pSrc2, int nSrc2Step,
                                       @ByVal NppiSize oSizeROI,
                                       @Const Pointer pThreshold, @Const Pointer pvalue,
                                       @ByVal NppStreamContext nppStreamCtx); 
