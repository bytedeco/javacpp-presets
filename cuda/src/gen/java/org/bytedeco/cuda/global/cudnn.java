...
public static final int CUDNN_MINOR = 26;
...
public static final int CUDNN_GRAPH_MINOR = 26;
...
public static final int
    ...
    /** Byte-addressed boolean type. @since cuDNN 9.25.0 */
    CUDNN_DATA_BYTE_BOOLEAN                  = 22,
    /** Unsigned FP8 with 5-bit exponent, 3-bit mantissa, for block scaling. @since cuDNN 9.26.0 */
...
public static final int
    ...
    /** FP8 descale factor for Q. @since cuDNN 9.25.0 */
    CUDNN_ATTR_OPERATION_SDPA_FWD_DESCALE_QDESC         = 2822,
    /** FP8 descale factor for K. @since cuDNN 9.25.0 */
    CUDNN_ATTR_OPERATION_SDPA_FWD_DESCALE_KDESC         = 2823,
    /** FP8 descale factor for V. @since cuDNN 9.25.0 */
    CUDNN_ATTR_OPERATION_SDPA_FWD_DESCALE_VDESC         = 2824,
    /** FP8 descale factor for S. @since cuDNN 9.25.0 */
    CUDNN_ATTR_OPERATION_SDPA_FWD_DESCALE_SDESC         = 2825,
    /** FP8 scale factor for S. @since cuDNN 9.25.0 */
    CUDNN_ATTR_OPERATION_SDPA_FWD_SCALE_SDESC           = 2826,
    /** FP8 scale factor for O. @since cuDNN 9.25.0 */
    CUDNN_ATTR_OPERATION_SDPA_FWD_SCALE_ODESC           = 2827,
    /** FP8 absolute maximum of S. @since cuDNN 9.25.0 */
    CUDNN_ATTR_OPERATION_SDPA_FWD_AMAX_SDESC            = 2828,
    /** FP8 absolute maximum of O. @since cuDNN 9.25.0 */
...
public static final int
     ...
     *     Input tensor descriptors representing the FP8 descale (dequantization) factors for Q, K, V,
     *     and the post-softmax scores S, respectively. Used only for FP8 attention.
     *     - CUDNN_TYPE_BACKEND_DESCRIPTOR; one element of descriptor type CUDNN_BACKEND_TENSOR_DESCRIPTOR.
     *     - For per-tensor FP8: a (1, 1, 1, 1) tensor of type CUDNN_DATA_FLOAT. All four are required
     *       when Q, K, and V are FP8.
     *     - For MXFP8 (block-scaled FP8): DESCALE_Q/K/V are instead CUDNN_DATA_FP8_E8M0 per-block scale
     *       tensors (one E8M0 factor per 32-element block, in the F8_128x4 reordered layout), and
     *       DESCALE_S is not used. MXFP8 mode is selected when DESCALE_Q is an E8M0 tensor.
     *
     *   CUDNN_ATTR_OPERATION_SDPA_FWD_SCALE_SDESC
     *   CUDNN_ATTR_OPERATION_SDPA_FWD_SCALE_ODESC
     *     Input tensor descriptors representing the FP8 scale (quantization) factors for the
     *     post-softmax scores S and the output O, respectively. Used only for per-tensor FP8 attention.
     *     - CUDNN_TYPE_BACKEND_DESCRIPTOR; one element of descriptor type CUDNN_BACKEND_TENSOR_DESCRIPTOR.
     *     - Single element must be of type CUDNN_DATA_FLOAT.
     *     - Tensor must be of dimensions (1, 1, 1, 1).
     *     - Optional attribute. Required when Q, K, and V are FP8. Not used for MXFP8 (block-scaled FP8).
     *
     *   CUDNN_ATTR_OPERATION_SDPA_FWD_AMAX_SDESC
     *   CUDNN_ATTR_OPERATION_SDPA_FWD_AMAX_ODESC
     *     Output tensor descriptors representing the FP8 absolute maximum of the post-softmax scores S
     *     and the output O, respectively. Used only for FP8 attention.
     *     - CUDNN_TYPE_BACKEND_DESCRIPTOR; one element of descriptor type CUDNN_BACKEND_TENSOR_DESCRIPTOR.
     *     - Single element must be of type CUDNN_DATA_FLOAT.
     *     - Tensor must be of dimensions (1, 1, 1, 1).
     *     - Optional attribute. AMAX_ODESC is required when Q, K, and V are FP8; AMAX_SDESC is optional.
     *       For MXFP8 (block-scaled FP8) only AMAX_ODESC applies (optional); AMAX_SDESC is not used.
     *
     * Finalization:
     *   CUDNN_STATUS_BAD_PARAM
...
public static final int CUDNN_OPS_MINOR = 26;
...
public static final int CUDNN_ADV_MINOR = 26;
 ...
 * Target label values must be in [1, A - 1], where A is the alphabet size, including the CTC
 * blank label, from probsDesc. Label 0 is reserved for the CTC blank label.
 *
 * @param handle [in]              cuDNN handle.
...
public static final int CUDNN_CNN_MINOR = 26;
