 ...
 * Build version
 */
public static final int NPP_VER_BUILD = 58;
...
public static final int
    ...
    NPP_RESIZE_FACTOR_ERROR                 = -24,
    NPP_INTERPOLATION_ERROR                 = -23,
    NPP_MIRROR_FLIP_ERROR                   = -22,
    NPP_MOMENT_00_ZERO_ERROR                = -21,
    NPP_THRESHOLD_NEGATIVE_LEVEL_ERROR      = -20,
    NPP_THRESHOLD_ERROR                     = -19,
    NPP_FFT_FLAG_ERROR                      = -18,
    NPP_FFT_ORDER_ERROR                     = -17,
    /**  Step is less or equal zero. */
    NPP_STEP_ERROR                          = -16,
    /** Not supported mode error.*/
    NPP_NOT_SUPPORTED_MODE_ERROR            = -14,
    NPP_CONTEXT_MATCH_ERROR                 = -13,
    NPP_SCALE_RANGE_ERROR                   = -12,
 ...
 * Manages a growing device scratch buffer (high-water-mark) and a per-function
 * size cache to eliminate repeated nppiXxxGetBufferHostSize queries.
 * Create with nppiWorkspaceCreate(), destroy with nppiWorkspaceDestroy().
 * For framework-managed memory (PyTorch, TensorRT, Triton) use
 * nppiWorkspaceSetExternal() to inject a pre-allocated device pointer.
 */
/** Opaque workspace handle; 0 = no workspace. */
