...
public static final int
     ...
     * Additionally, the legacy range profiling API i.e. the cuptiProfiler* APIs from the
     * header cupti_profiler_target.h are not supported on Rubin and newer GPU
     * architectures. Use the new cuptiRangeProfiler* APIs from the header
     * cupti_range_profiler.h as a substitute on these architectures.
     */
 ...
 * v130400 : CUDA Toolkit 13.4
 * v130401 : CUDA Toolkit 13.4 with CUPTI update 1
 */
public static final int CUPTI_API_VERSION = 130401;
...
public static final int CUPTI_INVALID_DEVICE_ID =   ((int) 0xFFFFFFFF);
public static final int CUPTI_INVALID_CONTEXT_ID =  0;
public static final int CUPTI_INVALID_STREAM_ID =   0;
...
public static final int
   ...
   * record structure is \ref CUpti_ActivityMemset5.
   */
   ...
   * The corresponding activity record structure is \ref CUpti_ActivityKernel13
   */
   ...
   * structure is \ref CUpti_ActivityDevice6.
   */
   ...
   * The corresponding activity record structure is \ref CUpti_ActivityCudaEvent2.
   */
  ...
  /**
   * This activity can not be directly enabled or disabled when using predefined records.
   ...
   * For user defined activity records, this activity kind must be explicitly enabled
   * through API cuptiActivityEnable_v2()
   * The corresponding activity record structure is
   ...
   * The corresponding activity record structure is \ref CUpti_ActivityGreenContext3.
   */
...
*/
public static final int CUPTI_NVLINK_INVALID_PORT = ((int) 0xFFFFFFFF);
...
// Targeting ../cupti/CUpti_ActivityFieldLayoutEntry.java


// Targeting ../cupti/CUpti_ActivityRecordLayout.java


// Targeting ../cupti/CUpti_ActivityFieldSelection.java


// Targeting ../cupti/CUpti_Activity.java


// Targeting ../cupti/CUpti_ActivityMemcpy7.java



/**
 * \brief Enum identifiers for fields to trace memory copies.
 *
 * These field IDs are used to reference specific fields when dynamically
 * selecting or parsing activity records of CUPTI_ACTIVITY_KIND_MEMCPY.
 */
/** enum CUpti_ActivityMemcpyFieldIds */
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_MEMCPY.
   */
  MEMCPY_FIELD_KIND = 0,
  ...
  /**
   * uint8_t srcKind;
   * Memory kind of the source location.
  ...
  /**
   * uint8_t dstKind;
   * Memory kind of the destination location.
   * @see CUpti_ActivityMemoryKind
   */
  ...
  /**
   * uint8_t flags;
   * Flags associated with the memory copy.
  ...
  /**
   * uint64_t bytes;
   * Number of bytes copied during the memory operation.
   */
  MEMCPY_FIELD_BYTES = 5,

  /**
   * uint64_t start;
   * Start timestamp of the memory copy, in nanoseconds.
  ...
  /**
   * uint64_t end;
   * End timestamp of the memory copy, in nanoseconds.
   * A value of 0 indicates timestamp couldn't be collected.
   */
  MEMCPY_FIELD_END = 7,
  ...
  /**
   * uint32_t deviceId;
   * ID of the device where the memory copy occurred.
   */
  MEMCPY_FIELD_DEVICE_ID = 8,

  /**
   * uint32_t contextId;
   * ID of the CUDA context where the memory copy occurred.
   */
  MEMCPY_FIELD_CONTEXT_ID = 9,

  /**
   * uint32_t streamId;
   * ID of the stream where the memory copy occurred.
   */
  MEMCPY_FIELD_STREAM_ID = 10,

  /**
   * uint64_t correlationId;
   * Correlation ID assigned to this memory copy.
   ...
   * ID of the CUDA Graph node that launched this memory copy.
  ...
  /**
   * uint32_t graphId;
   * ID of the CUDA Graph that launched this memory copy.
   * 0 if not launched via a CUDA Graph.
   */
  ...
  /**
   * uint32_t channelID;
   * ID of the hardware channel on which this memory copy was executed.
   */
  MEMCPY_FIELD_CHANNEL_ID = 14,

  /**
   * CUpti_ChannelType channelType;
   * Type of the hardware channel used.
   */
  ...
  /**
   * uint64_t copyCount;
   * Number of individual memcpy operations traced in this record.
   ...
   */
  MEMCPY_FIELD_SOURCE_GRAPH_ID = 18,
   ...
   * This field will be 0 if the memcpy is not launched through graph launch APIs.
   */
  MEMCPY_FIELD_SOURCE_GRAPH_NODE_ID = 19,
...
/**
 * \brief Enum identifiers for fields to trace peer-to-peer memory copies.
 *
 * These field IDs are used to reference specific fields when dynamically
 * selecting or parsing activity records of CUPTI_ACTIVITY_KIND_MEMCPY2.
 */
/** enum CUpti_ActivityMemcpy2FieldIds */
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_MEMCPY2.
   */
  MEMCPY2_FIELD_KIND = 0,

  /**
   * uint8_t copyKind;
   * Type of memory copy. ALways CUPTI_ACTIVITY_MEMCPY_KIND_P2P.
   * @see CUpti_ActivityMemcpyKind
   */
  ...
  /**
   * uint8_t srcKind;
   * Kind of source memory used in the copy.
   * @see CUpti_ActivityMemoryKind
   */
  ...
  /**
   * uint8_t dstKind;
   * Kind of destination memory used in the copy.
   * @see CUpti_ActivityMemoryKind
   */
  ...
  /**
   * uint64_t bytes;
   * Number of bytes transferred during the memory copy.
   */
  MEMCPY2_FIELD_BYTES = 5,

  /**
   * uint64_t start;
   * Start timestamp for the memory copy (in nanoseconds).
   * A value of 0 indicates timestamp couldn't be collected.
   */
  ...
  /**
   * uint64_t end;
   * End timestamp for the memory copy (in nanoseconds).
   * A value of 0 indicates timestamp couldn't be collected.
   */
  MEMCPY2_FIELD_END = 7,
  ...
  /**
   * uint32_t deviceId;
   * Device where the memory copy is occurring.
   */
  MEMCPY2_FIELD_DEVICE_ID = 8,

  /**
   * uint32_t contextId;
   * CUDA context where the memory copy is occurring.
   */
  MEMCPY2_FIELD_CONTEXT_ID = 9,

  /**
   * uint32_t streamId;
   * Stream in which the memory copy is occurring.
   */
  MEMCPY2_FIELD_STREAM_ID = 10,

  /**
   * uint32_t srcDeviceId;
   * Device from which memory is being copied.
   */
  MEMCPY2_FIELD_SRC_DEVICE_ID = 11,

  /**
   * uint32_t srcContextId;
   * CUDA context owning the source memory.
   */
  MEMCPY2_FIELD_SRC_CONTEXT_ID = 12,

  /**
   * uint32_t dstDeviceId;
   * Device to which memory is being copied.
   */
  MEMCPY2_FIELD_DST_DEVICE_ID = 13,

  /**
   * uint32_t dstContextId;
   * CUDA context owning the destination memory.
   */
  ...
  /**
   * uint64_t graphNodeId;
   * ID of the graph node that launched this memcpy.
   * 0 if not launched via a CUDA Graph.
   */
  ...
  /**
   * uint32_t graphId;
   * ID of the CUDA Graph associated with this memory copy.
   * 0 if not launched via a CUDA Graph.
   */
  ...
  /**
   * uint32_t channelID;
   * Hardware channel ID used for the memory copy.
   */
  MEMCPY2_FIELD_CHANNEL_ID = 18,

  /**
   * CUpti_ChannelType channelType;
   * Type of the hardware channel.
   */
...
// Targeting ../cupti/CUpti_ActivityMemset5.java



/**
 * \brief Enum identifiers for fields to trace memset operations.
 *
 * These field IDs are used to reference specific fields when dynamically
 * selecting or parsing activity records of CUPTI_ACTIVITY_KIND_MEMSET.
 */
/** enum CUpti_ActivityMemsetFieldIds */
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_MEMSET.
   */
  MEMSET_FIELD_KIND = 0,

  /**
   * uint32_t value;
   * Value being written to memory by the memset.
   */
  ...
  /**
   * uint64_t start;
   * Start timestamp for the memset operation (in nanoseconds).
   * A value of 0 indicates timestamp couldn't be collected.
   */
  ...
  /**
   * uint64_t end;
   * End timestamp for the memset operation (in nanoseconds).
   * A value of 0 indicates timestamp couldn't be collected.
   */
  MEMSET_FIELD_END = 4,
  ...
  /**
   * uint32_t deviceId;
   * Device on which the memset is occurring.
   */
  MEMSET_FIELD_DEVICE_ID = 5,

  /**
   * uint32_t contextId;
   * CUDA context where the memset is occurring.
   */
  MEMSET_FIELD_CONTEXT_ID = 6,

  /**
   * uint32_t streamId;
   * Stream where the memset is occurring.
   */
  MEMSET_FIELD_STREAM_ID = 7,

  /**
   * uint64_t correlationId;
   * Correlation ID assigned to this memset operation.
   * Matches the correlation ID in the CUDA driver/runtime API activity record that launched it.
   */
  ...
  /**
   * uint16_t flags;
   * Flags associated with the memset.
   * @see CUpti_ActivityFlag
   */
  ...
  /**
   * uint64_t graphNodeId;
   * CUDA Graph node ID that executed this memset.
   */
  MEMSET_FIELD_GRAPH_NODE_ID = 11,

  /**
   * uint32_t graphId;
   * CUDA Graph ID that executed this memset.
   */
  MEMSET_FIELD_GRAPH_ID = 12,

  /**
   * uint32_t channelID;
   * Hardware channel ID used by the memset.
   */
  MEMSET_FIELD_CHANNEL_ID = 13,

  /**
   * CUpti_ChannelType channelType;
   * Type of hardware channel used by the memset.
   */
   ...
   */
  MEMSET_FIELD_SOURCE_GRAPH_ID = 16,
   ...
   * This field will be 0 if the memset is not launched through graph launch APIs.
   */
  MEMSET_FIELD_SOURCE_GRAPH_NODE_ID = 17,
  /**
   * Total number of defined fields.
   */
  MEMSET_FIELD_MAX = 18;
...
/**
 * \brief Enum identifiers for fields to trace memory allocation and free operation.
 ...
 *
 * These field IDs are used to reference specific fields when dynamically
 * selecting or parsing activity records of CUPTI_ACTIVITY_KIND_MEMORY2.
 */
/** enum CUpti_ActivityMemoryFieldIds */
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_MEMORY2.
   */
  MEMORY_FIELD_KIND = 0,
  ...
  /**
   * uint64_t correlationId;
   * Correlation ID of the memory operation.
   */
  ...
  /**
   * uint64_t timestamp;
   * Start timestamp for the memory operation (in ns).
   */
  MEMORY_FIELD_TIMESTAMP = 6,

  /**
   * uint32_t processId;
   * ID of the process to which this record belongs.
   */
  MEMORY_FIELD_PROCESS_ID = 7,

  /**
   * uint32_t deviceId;
   * ID of the device where the memory operation is taking place.
   */
  ...
  /**
   * uint32_t isAsync;
   * Whether the memory operation happens through async memory APIs.
   */
  MEMORY_FIELD_IS_ASYNC = 11,

  /**
   * CUpti_ActivityMemoryPoolType memoryPoolConfig.memoryPoolType;
   * Type of the memory pool.
   */
  MEMORY_FIELD_POOL_TYPE = 12,

  /**
   * uint64_t memoryPoolConfig.address;
   * Base address of the memory pool.
   */
  MEMORY_FIELD_POOL_ADDRESS = 13,

  /**
   * uint64_t memoryPoolConfig.releaseThreshold;
   * Release threshold of the memory pool in bytes.
   */
  MEMORY_FIELD_POOL_RELEASE_THRESHOLD = 14,

  /**
   * uint64_t memoryPoolConfig.pool.size;
   * Size of memory pool in bytes.
   */
  MEMORY_FIELD_POOL_SIZE = 15,

  /**
   * uint64_t memoryPoolConfig.pool.processId;
   * Process ID of the memory pools.
   */
  MEMORY_FIELD_POOL_PROCESS_ID = 16,

  /**
   * uint64_t memoryPoolConfig.utilizedSize;
   * Utilized size of the memory pool.
   */
  MEMORY_FIELD_POOL_UTILIZED_SIZE = 17,

  /**
   * const char* source;
   * Shared object or binary that the memory allocation request comes from.
   */
...
/**
 * \brief Enum identifiers for fields to trace CUDA memory pool creation, destruction and
 * trimming.
 ...
 *
 * These field IDs are used to reference specific fields when dynamically
 * selecting or parsing activity records of CUPTI_ACTIVITY_KIND_MEMORY_POOL.
 */
/** enum CUpti_ActivityMemoryPoolFieldIds */
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_MEMORY_POOL.
   */
  ...
  /**
   * uint64_t correlationId;
   * Correlation ID assigned to this memory pool operation.
   * Matches the correlation ID in the CUDA driver/runtime API activity record that launched it.
   */
  ...
  /**
   * uint32_t deviceId;
   * ID of the device where the memory pool is created.
   */
  MEMORY_POOL_FIELD_DEVICE_ID = 5,

  /**
   * size_t minBytesToKeep;
   * Minimum bytes to keep of the memory pool.
   */
  ...
  /**
   * uint64_t size;
   * Size of the memory pool operation in bytes.
   */
  MEMORY_POOL_FIELD_SIZE = 8,

  /**
   * uint64_t releaseThreshold;
   * Release threshold of the memory pool.
   */
...
public static final int
    ...
    CUPTI_FUNC_EXECUTION_MODEL_HYBRID          = 3,
    // --- always add new constants to the end here ---
    CUPTI_FUNC_EXECUTION_MODEL_SIZE = 4,
    CUPTI_FUNC_EXECUTION_MODEL_FORCE_INT       = 0x7fffffff;
// Targeting ../cupti/CUpti_ActivityKernel13.java



/**
 * \brief Enum identifiers for fields to trace kernel operations.
 *
 * These field IDs are used to reference specific fields when dynamically
 * selecting or parsing activity records of CUPTI_ACTIVITY_KIND_CONCURRENT_KERNEL.
 */
/** enum CUpti_ActivityKernelFieldIds */
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always either CUPTI_ACTIVITY_KIND_KERNEL
  ...
  /**
   * uint8_t requested;
   * Indicates the cache configuration requested by the kernel.
  ...
  /**
   * uint8_t executed;
   * Indicates the cache configuration actually used during kernel execution.
   * Values are from CUfunc_cache enumeration.
   */
   ...
   * Specifies the shared memory configuration used for the kernel.
   ...
   * Number of registers required for each thread executing the kernel.
   */
  KERNEL_FIELD_REGISTERS_PER_THREAD = 4,

  /**
   * CUpti_ActivityPartitionedGlobalCacheConfig requested;
  ...
  /**
   * CUpti_ActivityPartitionedGlobalCacheConfig executed;
   * Partitioned global caching actually used during kernel execution.
   */
  KERNEL_FIELD_PARTITIONED_GLOBAL_CACHE_EXECUTED = 6,

  /**
   * uint64_t start;
   * Start timestamp for the kernel execution (in nanoseconds).
   * A value of 0 indicates timestamp couldn't be collected.
   */
  ...
  /**
   * uint64_t end;
   * End timestamp for the kernel execution (in nanoseconds).
   * A value of 0 indicates timestamp couldn't be collected.
   */
  KERNEL_FIELD_END = 8,
  ...
  /**
   * uint64_t completed;
   * Completion timestamp for the kernel execution, including all child kernels (in nanoseconds).
  ...
  /**
   * uint32_t deviceId;
   * ID of the device where the kernel is executing.
   */
  KERNEL_FIELD_DEVICE_ID = 10,

  /**
   * uint64_t contextId;
   * ID of the context where the kernel is executing.
   */
  KERNEL_FIELD_CONTEXT_ID = 11,

  /**
   * uint64_t streamId;
   * ID of the stream where the kernel is executing.
   */
  KERNEL_FIELD_STREAM_ID = 12,

  /**
   * int32_t gridX;
   * X-dimension of the grid size for the kernel.
   */
  KERNEL_FIELD_GRID_X = 13,

  /**
   * int32_t gridY;
   * Y-dimension of the grid size for the kernel.
   */
  KERNEL_FIELD_GRID_Y = 14,

  /**
   * int32_t gridZ;
   * Z-dimension of the grid size for the kernel.
   */
  KERNEL_FIELD_GRID_Z = 15,

  /**
   * int32_t blockX;
   * X-dimension of the block size for the kernel.
   */
  KERNEL_FIELD_BLOCK_X = 16,

  /**
   * int32_t blockY;
   * Y-dimension of the block size for the kernel.
   */
  KERNEL_FIELD_BLOCK_Y = 17,

  /**
   * int32_t blockZ;
   * Z-dimension of the block size for the kernel.
   */
  KERNEL_FIELD_BLOCK_Z = 18,

  /**
   * int32_t staticSharedMemory;
   * Amount of static shared memory allocated for the kernel, in bytes.
   */
  KERNEL_FIELD_STATIC_SHARED_MEMORY = 19,

  /**
   * int32_t dynamicSharedMemory;
   * Amount of dynamic shared memory reserved for the kernel, in bytes.
   */
  KERNEL_FIELD_DYNAMIC_SHARED_MEMORY = 20,

  /**
   * uint32_t localMemoryPerThread;
   * Amount of local memory reserved per thread, in bytes.
   */
  KERNEL_FIELD_LOCAL_MEMORY_PER_THREAD = 21,

  /**
   * uint64_t correlationId;
   * Correlation ID of the kernel,
   * Matches the correlation ID in the CUDA driver/runtime API activity record that launched it.
   */
  ...
  /**
   * int64_t gridId;
   * Unique grid ID assigned to the kernel at runtime.
   */
  KERNEL_FIELD_GRID_ID = 23,

  /**
   * const char* name;
   * Name of the kernel. Shared across all activity records for the same kernel.
   * */
  KERNEL_FIELD_NAME = 24,

  /**
   * uint64_t queued;
   * Timestamp when the kernel was queued in the command buffer (in nanoseconds).
  ...
  /**
   * uint64_t submitted;
   * Timestamp when the command buffer containing the kernel launch was submitted to the GPU (in nanoseconds).
   * CUPTI_TIMESTAMP_UNKNOWN if not collected.
   */
  ...
  /**
   * uint8_t launchType;
   * Indicates if the kernel was executed via a regular launch or a cooperative launch.
   ...
   * Indicates if CU_FUNC_ATTRIBUTE_PREFERRED_SHARED_MEMORY_CARVEOUT was updated for the kernel launch.
   */
  KERNEL_FIELD_IS_SHARED_MEMORY_CARVEOUT_REQUESTED = 28,

  /**
   * uint8_t sharedMemoryCarveoutRequested;
   * Shared memory carveout value requested for the function, as a percentage of the total resource.
   */
  KERNEL_FIELD_SHARED_MEMORY_CARVEOUT_REQUESTED = 29,

  /**
   * uint32_t sharedMemoryExecuted;
   * Shared memory size set by the driver, in bytes.
   */
  KERNEL_FIELD_SHARED_MEMORY_EXECUTED = 30,

  /**
   * uint64_t graphNodeId;
   * Unique ID of the graph node that launched this kernel through graph launch APIs.
   ...
   * Shared memory limit configuration for the kernel,
   * indicating if a higher per-block dynamic shared memory limit was opted.
   */
  KERNEL_FIELD_SHMEM_LIMIT_CONFIG = 32,

  /**
   * uint32_t graphId;
   * Unique ID of the graph that launched this kernel through graph launch APIs.
   * 0 if not launched through graph APIs.
   */
   ...
   * Pointer to the access policy window structure. Defined in cuda.h.
   */
  KERNEL_FIELD_ACCESS_POLICY_WINDOW = 34,

  /**
   * uint32_t channelID;
   * ID of the hardware channel on which the kernel is launched.
   */
  KERNEL_FIELD_CHANNEL_ID = 35,

  /**
   * CUpti_ChannelType channelType;
   * Type of the channel used for kernel launch.
   */
  KERNEL_FIELD_CHANNEL_TYPE = 36,

  /**
   * int32_t clusterX;
   * X-dimension of the cluster size for the kernel.
  ...
  /**
   * int32_t clusterY;
   * Y-dimension of the cluster size for the kernel.
   * Valid for devices with compute capability 9.0 and higher.
   */
  ...
  /**
   * int32_t clusterZ;
   * Z-dimension of the cluster size for the kernel.
   * Valid for devices with compute capability 9.0 and higher.
   */
   ...
   * Cluster scheduling policy for the kernel.
   * Refer to CUclusterSchedulingPolicy.
   * Valid for devices with compute capability 9.0 and higher.
   */
   ...
   * Total amount of local memory reserved for the kernel, in bytes.
   */
  KERNEL_FIELD_LOCAL_MEMORY_TOTAL = 41,

  /**
   * uint32_t maxPotentialClusterSize;
   * Maximum cluster size for the kernel.
   */
  KERNEL_FIELD_MAX_POTENTIAL_CLUSTER_SIZE = 42,

  /**
   * uint32_t maxActiveClusters;
   * Maximum number of clusters that could co-exist on the target device for the kernel.
   */
  ...
  /**
   * uint32_t sourceGraphId;
   * The unique graph ID of the node from which the kernel node was instantiated or last updated.
   * This field will be 0 if the kernel is not launched through graph launch APIs.
   */
  KERNEL_FIELD_SOURCE_GRAPH_ID = 47,

  /**
   * uint64_t sourceGraphNodeId;
   * The unique graph node ID of the node from which the kernel node was instantiated or last updated.
   * This field will be 0 if the kernel is not launched through graph launch APIs.
   */
  KERNEL_FIELD_SOURCE_GRAPH_NODE_ID = 48,
...
/**
 * \brief Enum identifiers for fields in CUpti_ActivityAPI.
 *
 * Each enum value corresponds to a field in CUpti_ActivityAPI and describes
 * the data type and purpose of that field.
 */
/** enum CUpti_ActivityApiFieldIds */
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always either CUPTI_ACTIVITY_KIND_DRIVER
   * or CUPTI_ACTIVITY_KIND_RUNTIME.
   */
  API_FIELD_KIND = 0,

  /**
   * CUpti_CallbackId cbid;
   * Callback ID of the CUDA driver/runtime API function.
   */
  API_FIELD_CBID = 1,

  /**
   * uint64_t start;
   * Start timestamp of the CUDA driver/runtime API call (in nanoseconds).
   */
  API_FIELD_START = 2,

  /**
   * uint64_t end;
   * End timestamp of the CUDA driver/runtime API call (in nanoseconds).
   */
  API_FIELD_END = 3,

  /**
   * uint32_t processId;
   * ID of the process executing the CUDA driver/runtime API call.
   */
  API_FIELD_PROCESS_ID = 4,

  /**
   * uint64_t threadId;
   * ID of the thread executing the CUDA driver/runtime API call.
   */
  API_FIELD_THREAD_ID = 5,

  /**
   * uint64_t correlationId;
   * Correlation ID assigned to this CUDA driver/runtime API invocation.
   * This ID matches the correlation ID of the associated kernel, memcpy, or memset
   * activity record that the API call initiated.
   */
  API_FIELD_CORRELATION_ID = 6,

  /**
   * uint32_t returnValue;
   * Return value of the CUDA driver/runtime API call (CUresult or cudaError_t).
   */
   ...
   */
  API_FIELD_MAX = 8;
// Targeting ../cupti/CUpti_ActivityApiCbidOptions.java


// Targeting ../cupti/CUpti_ActivityApiOptions.java
...
// Targeting ../cupti/CUpti_ActivityDevice6.java



/**
 * \brief Enum identifiers for fields in CUpti_ActivityDevice6.
 *
 * Each enum value corresponds to a field in CUpti_ActivityDevice6 and describes
 * the data type and purpose of that field.
 */
...
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_DEVICE.
   */
  DEVICE_FIELD_KIND = 0,
   ...
   * Global memory bandwidth available on the device (in kBytes/sec).
   */
  DEVICE_FIELD_GLOBAL_MEMORY_BANDWIDTH = 2,

  /**
   * uint64_t globalMemorySize;
   * Amount of global memory on the device (in bytes).
   */
  DEVICE_FIELD_GLOBAL_MEMORY_SIZE = 3,

  /**
   * uint32_t constantMemorySize;
   * Amount of constant memory on the device (in bytes).
   */
  DEVICE_FIELD_CONSTANT_MEMORY_SIZE = 4,

  /**
   * uint32_t l2CacheSize;
   * Size of the L2 cache on the device (in bytes).
   */
  DEVICE_FIELD_L2_CACHE_SIZE = 5,

  /**
   * uint32_t numThreadsPerWarp;
   * Number of threads per warp on the device.
   */
  DEVICE_FIELD_NUM_THREADS_PER_WARP = 6,

  /**
   * uint32_t coreClockRate;
   * Core clock rate of the device (in kHz).
   */
  ...
  /**
   * uint32_t maxIPC;
   * Maximum instructions per cycle possible on each device multiprocessor.
   */
...
/**
 * \brief Enum identifiers for fields to trace context.
 *
 * These field IDs are used to reference specific fields when dynamically
 * selecting or parsing activity records of CUPTI_ACTIVITY_KIND_CONTEXT.
 */
/** enum CUpti_ActivityContextFieldIds */
public static final int
 /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_CONTEXT.
   */
  ...
  /**
   * uint32_t deviceId;
   * The ID of the device associated with the context.
   */
  CONTEXT_FIELD_DEVICE_ID = 2,

  /**
   * uint16_t computeApiKind;
   * The compute API kind associated with the context.
   * \ref CUpti_ActivityComputeApiKind
   */
  CONTEXT_FIELD_COMPUTE_API_KIND = 3,

  /**
   * uint32_t nullStreamId;
   ...
   * Indicates whether the context is a green context.
   */
...
/**
 * \brief Enum identifiers for fields in CUpti_ActivityName.
 *
 * Each enum value corresponds to a field in CUpti_ActivityName
...
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of activity record: CUPTI_ACTIVITY_KIND_NAME.
   */
  NAME_FIELD_KIND = 0,

  /**
   * CUpti_ActivityObjectKind objectKind;
   * Kind of activity object being named.
   */
  NAME_FIELD_OBJECT_KIND = 1,

  /**
   * CUpti_ActivityObjectKindId objectId;
   * Identifier for the activity object being named.
   */
...
/**
 * \brief Enum identifiers for fields to trace NVTX markers/ranges.
 *
 * These field IDs are used to reference specific fields when dynamically
 * selecting or parsing activity records of CUPTI_ACTIVITY_KIND_MARKER.
 */
/** enum CUpti_ActivityMarkerFieldIds */
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_MARKER.
   */
  MARKER_FIELD_KIND = 0,
  ...
  /**
   * uint32_t processId;
   * The process ID of the process where the overhead is occurring.
   */
  MARKER_FIELD_PROCESS_ID = 4,

  /**
   * uint64_t threadId;
   * The thread ID of the process where the overhead is occurring.
   */
  ...
  /**
   * const char *domain;
   * Name of the domain to which this marker belongs.
   */
...
/**
 * \brief Enum identifiers for fields to trace detailed information for a marker.
 *
 * User must enable CUPTI_ACTIVITY_KIND_MARKER as well to get records for marker data.
 * These field IDs are used to reference specific fields when dynamically
 * selecting or parsing activity records of CUPTI_ACTIVITY_KIND_MARKER_DATA.
 */
/** enum CUpti_ActivityMarkerDataFieldIds */
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_MARKER_DATA.
   */
...
/**
 * \brief Enum identifiers for fields to trace CUPTI and driver overhead information.
 *
 * These field IDs are used to reference specific fields when dynamically
 * selecting or parsing activity records of CUPTI_ACTIVITY_KIND_OVERHEAD.
 */
/** enum CUpti_ActivityOverheadFieldIds */
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_OVERHEAD.
   */
  ...
  /**
   * uint64_t start;
   * The start timestamp for the overhead, in nanoseconds.
   */
  OVERHEAD_FIELD_START = 4,

  /**
   * uint64_t end;
   * The end timestamp for the overhead, in nanoseconds.
   */
  OVERHEAD_FIELD_END = 5,

  /**
   * uint64_t correlationId;
   * Correlation ID assigned to this overhead record.
   * Matches the correlation ID in the CUDA driver/runtime API activity record that launched it.
   */
   ...
   * Refer CUpti_ActivityOverheadKind enum and the corresponding structure to typecast
   * and access additional overhead data.
...
/**
 * \brief Enum identifiers for fields in CUpti_ActivityUnifiedMemoryCounter3.
 *
 * Each enum value corresponds to a field in CUpti_ActivityUnifiedMemoryCounter3
 * and describes the data type and purpose of that field.
 */
...
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of activity record: CUPTI_ACTIVITY_KIND_UNIFIED_MEMORY_COUNTER.
   */
  ...
  /**
   * uint64_t start;
   * Start timestamp of the counter (in ns).
   */
  UVM_COUNTER_FIELD_START = 3,

  /**
   * uint64_t end;
   * End timestamp of the counter (in ns).
   */
  ...
  /**
   * uint32_t srcId;
   * ID of the source CPU/device.
   */
  UVM_COUNTER_FIELD_SRC_ID = 6,

  /**
   * uint32_t dstId;
   * ID of the destination CPU/device.
   */
  UVM_COUNTER_FIELD_DST_ID = 7,

  /**
   * uint32_t streamId;
   * ID of the stream causing the transfer.
   */
  ...
  /**
   * uint32_t flags;
   * Flags associated with this record.
   */
  UVM_COUNTER_FIELD_FLAGS = 10,

  /**
   * uint64_t processors[5];
   * Bitmask of devices involved in the operation.
   */
...
/**
 * \brief Enum identifiers for fields to trace CUDA Event operations.
 *
 * These field IDs are used to reference specific fields when dynamically
 * selecting or parsing activity records of CUPTI_ACTIVITY_KIND_CUDA_EVENT.
 */
...
public static final int
  ...
  /**
   * uint64_t correlationId;
   * Correlation ID assigned to this CUDA Event operation.
   * Matches the correlation ID in the CUDA driver/runtime API activity record that launched it.
   */
   ...
   * The device-side timestamp on CUDA event record (in nanoseconds).
   * Collection of this field is disabled by default.
...
/**
 * \brief Enum identifiers for fields to trace CUDA Stream operations.
 * These field IDs are used to reference specific fields when dynamically
 * selecting or parsing activity records of CUPTI_ACTIVITY_KIND_STREAM.
 */
...
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_STREAM.
   */
  STREAM_FIELD_KIND = 0,
  ...
  /**
   * uint64_t correlationId;
   * Correlation ID assigned to this CUDA Stream operation.
   */
...
/**
 * \brief Enum identifiers for fields to trace various CUDA synchronization APIs.
 *
 * These field IDs are used to reference specific fields when dynamically
 * selecting or parsing activity records of CUPTI_ACTIVITY_KIND_SYNCHRONIZATION.
 */
/** enum CUpti_ActivitySynchronizationFieldIds */
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_SYNCHRONIZATION.
   */
  ...
  /**
   * uint64_t start;
   * The start timestamp for the synchronization operation (in nanoseconds).
   */
  ...
  /**
   * uint64_t correlationId;
   * Correlation ID assigned to this synchronization operation.
   * Matches the correlation ID in the CUDA driver/runtime API activity record that launched it.
   */
  ...
  /**
   * uint32_t contextId;
   * CUDA context where the operation is occurring.
   */
  SYNCHRONIZATION_FIELD_CONTEXT_ID = 5,

  /**
   * uint32_t streamId;
   * The compute stream where the synchronization operation is occurring.
   ...
   * The CUDA event ID for which the synchronization operation is called.
   * CUPTI_SYNCHRONIZATION_INVALID_VALUE indicates that the field is not applicable for this record.
   */
   ...
   * Similar field is added in CUpti_ActivityCudaEventFieldIds
   * to associate synchronization record to the CUDA Event record.
   *
   * The same CUDA event can be used multiple times, so the
   * event id will not be unique to correlate the synchronization
   * record with the latest CUDA Event record.
  ...
  /**
   * uint32_t returnValue;
   * The return value for the synchronization operation.
...
/**
 * \brief Enum identifiers for fields in CUpti_ActivityExternalCorrelation.
 *
...
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_EXTERNAL_CORRELATION.
   */
  EXTERNAL_CORRELATION_FIELD_KIND = 0,

  /**
   * CUpti_ExternalCorrelationKind externalKind;
   * Kind of external API this record correlated to.
   */
  EXTERNAL_CORRELATION_FIELD_EXTERNAL_KIND = 1,

  /**
   * uint64_t externalId;
   * Correlation ID of the associated non-CUDA API record.
   */
  EXTERNAL_CORRELATION_FIELD_EXTERNAL_ID = 2,

  /**
   * uint64_t correlationId;
   * Correlation ID of the associated CUDA driver or runtime API record.
   */
...
/**
 * \brief Enum identifiers for fields in CUpti_ActivityConfidentialComputeRotation.
 *
 * Each enum value corresponds to a field in CUpti_ActivityConfidentialComputeRotation
 * and describes the data type and purpose of that field.
 */
...
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_CONFIDENTIAL_COMPUTE_ROTATION.
   */
...
/**
 * \brief Enum identifiers for fields to trace JIT operations.
 *
 * These field IDs are used to reference specific fields when dynamically
 * selecting or parsing activity records of CUPTI_ACTIVITY_KIND_JIT.
 */
/** enum CUpti_ActivityJitFieldIds */
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_JIT.
   */
  JIT_FIELD_KIND = 0,

  /**
    * CUpti_ActivityJitEntryType jitEntryType;
    * The JIT entry type. \ref CUpti_ActivityJitEntryType
    */
  JIT_FIELD_ENTRY_TYPE = 1,

  /**
   * CUpti_ActivityJitOperationType jitOperationType;
   * The JIT operation type. \ref CUpti_ActivityJitOperationType
   */
  ...
  /**
   * uint64_t start;
   * The start timestamp for the JIT operation (in nanoseconds).
   */
  JIT_FIELD_START = 4,

  /**
   * uint64_t end;
   * The end timestamp for the JIT operation (in nanoseconds).
   */
  JIT_FIELD_END = 5,

  /**
   * uint64_t correlationId;
   * Correlation ID assigned to this JIT operation.
   * Matches the correlation ID in the CUDA driver/runtime API activity record that launched it.
   */
...
/**
 * \brief Enum identifiers for fields to trace graph execution.
 *
 * These field IDs are used to reference specific fields when dynamically
 * selecting or parsing activity records of CUPTI_ACTIVITY_KIND_GRAPH_TRACE.
 */
/** enum CUpti_ActivityGraphTraceFieldIds */
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_GRAPH_TRACE.
   */
...
/**
 * \brief Enum identifiers for fields in CUpti_ActivityDeviceGraphTrace.
 *
 * Each enum value corresponds to a field in CUpti_ActivityDeviceGraphTrace
 * and describes the data type and purpose of that field.
 */
...
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_DEVICE_GRAPH_TRACE.
   */
  DEVICE_GRAPH_TRACE_FIELD_KIND = 0,

  /**
   * uint32_t deviceId;
   * ID of the device where the first node of the graph is executed.
   */
  DEVICE_GRAPH_TRACE_FIELD_DEVICE_ID = 1,

  /**
   * uint64_t start;
   * Start timestamp for the graph execution (in ns).
   */
  DEVICE_GRAPH_TRACE_FIELD_START = 2,

  /**
   * uint64_t end;
   * End timestamp for the graph execution (in ns).
   */
  DEVICE_GRAPH_TRACE_FIELD_END = 3,

  /**
   * uint32_t graphId;
   * Unique ID of the graph that is launched.
   */
  DEVICE_GRAPH_TRACE_FIELD_GRAPH_ID = 4,

  /**
   * uint32_t launcherGraphId;
   * Unique ID of the graph that has launched this graph.
   */
  ...
  /**
   * uint64_t contextId;
   * ID of the context where the first node of the graph is executed.
   */
  DEVICE_GRAPH_TRACE_FIELD_CONTEXT_ID = 7,

  /**
   * uint64_t streamId;
   * ID of the stream where the graph is being launched.
   * This is the only record that has 64-bit streamId to accommodate
   * device-side created streams.
   */
...
/**
 * \brief Enum identifiers for fields to trace decompression operations.
 *
 * These field IDs are used to reference specific fields when dynamically
 * selecting or parsing activity records of CUPTI_ACTIVITY_KIND_MEM_DECOMPRESS.
 */
 ...
 public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_MEM_DECOMPRESS.
   */
  MEM_DECOMPRESS_FIELD_KIND = 0,

  /**
   * uint32_t deviceId;
   * The ID of the device where the decompression operation was recorded.
   */
  MEM_DECOMPRESS_FIELD_DEVICE_ID = 1,

  /**
   * uint32_t contextId;
   * The ID of the context where the decompression operation was recorded.
   */
  MEM_DECOMPRESS_FIELD_CONTEXT_ID = 2,

  /**
   * uint32_t streamId;
   * The compute stream where the decompression operation was recorded.
   */
  MEM_DECOMPRESS_FIELD_STREAM_ID = 3,

  /**
   * uint32_t channelId;
   * The ID of the HW channel on which the decompression operation was recorded.
   */
  MEM_DECOMPRESS_FIELD_CHANNEL_ID = 4,

  /**
   * CUpti_ChannelType channelType;
   * The type of the channel on which the decompression operation was recorded.
   */
  MEM_DECOMPRESS_FIELD_CHANNEL_TYPE = 5,

  /**
   * uint64_t correlationId;
   * Correlation ID assigned to this decompression operation.
   * Matches the correlation ID in the CUDA driver/runtime API activity record that launched it.
   */
   ...
   * The number of decompression operations in this batch.
   */
  MEM_DECOMPRESS_FIELD_NUMBER_OF_OPERATIONS = 7,

  /**
   * uint64_t sourceBytes;
   * The total number of bytes to be read and decompressed in the
   * batch operation.
   */
  ...
  /**
   * uint64_t start;
   * Start timestamp of the decompression operation, in nanoseconds.
   */
  MEM_DECOMPRESS_FIELD_START = 9,

  /**
   * uint64_t end;
   * End timestamp of the decompression operation, in nanoseconds.
   */
...
/**
 * \brief Enum identifiers for fields in CUpti_ActivityGraphHostNode.
 *
 * Each enum value corresponds to a field in CUpti_ActivityGraphHostNode
 * and describes the data type and purpose of that field.
 */
...
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_GRAPH_HOST_NODE.
   */
  GRAPH_HOST_NODE_FIELD_KIND = 0,

  /**
   * uint32_t streamId;
   * ID of the stream that waits for the graph host node to finish.
   */
  GRAPH_HOST_NODE_FIELD_STREAM_ID = 1,

  /**
   * uint32_t contextId;
   * ID of the CUDA context to which the waiting CUDA stream belongs.
   */
  GRAPH_HOST_NODE_FIELD_CONTEXT_ID = 2,

  /**
   * uint32_t deviceId;
   * ID of the CUDA device to which the CUDA context and stream belong.
   */
  GRAPH_HOST_NODE_FIELD_DEVICE_ID = 3,

  /**
   * uint64_t correlationId;
   * Correlation ID of the graph host node operation.
   */
  GRAPH_HOST_NODE_FIELD_CORRELATION_ID = 4,

  /**
   * uint32_t graphId;
   * Unique ID of the graph that executed this host node through graph launch.
   */
  GRAPH_HOST_NODE_FIELD_GRAPH_ID = 5,

  /**
   * uint64_t graphNodeId;
   * Unique ID of the graph node that executed this host node through graph launch.
   */
  GRAPH_HOST_NODE_FIELD_GRAPH_NODE_ID = 6,

  /**
   * uint32_t processId;
   * ID of the process where the host node is executing.
   */
  GRAPH_HOST_NODE_FIELD_PROCESS_ID = 7,

  /**
   * uint64_t threadId;
   * ID of the thread where the host node is executing.
   */
...
/**
 * \brief Enum identifiers for fields in CUpti_ActivityComputeEngineCtxSwitch.
 *
 * Each enum value corresponds to a field in CUpti_ActivityComputeEngineCtxSwitch
 * and describes the data type and purpose of that field.
 */
...
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_COMPUTE_ENGINE_CTX_SWITCH.
   */
  COMPUTE_ENGINE_CTX_SWITCH_FIELD_KIND = 0,

  /**
   * uint32_t contextId;
   * ID of the CUDA context.
   */
  COMPUTE_ENGINE_CTX_SWITCH_FIELD_CONTEXT_ID = 1,

  /**
   * uint64_t timestamp;
   * Timestamp at which the context switch operation occurs.
   */
  COMPUTE_ENGINE_CTX_SWITCH_FIELD_TIMESTAMP = 2,

  /**
   * CUpti_ComputeEngineCtxSwitchOperationType operationType;
   * Type of the Compute Engine Context switch operation.
   */
...
/**
 * \brief Enum identifiers for fields in CUpti_ActivityHostLaunch.
 *
 * Each enum value corresponds to a field in CUpti_ActivityHostLaunch
 * and describes the data type and purpose of that field.
 */
...
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_HOST_LAUNCH.
   */
  HOST_LAUNCH_FIELD_KIND = 0,

  /**
   * uint32_t streamId;
   * ID of the CUDA stream to which the waiting CUDA stream belongs.
   */
  ...
  /**
   * uint64_t correlationId;
   * Correlation ID of the host launch operation.
   */
  HOST_LAUNCH_FIELD_CORRELATION_ID = 4,

  /**
   * uint32_t processId;
   * ID of the process where the host function is executing.
   */
  HOST_LAUNCH_FIELD_PROCESS_ID = 5,

  /**
   * uint64_t threadId;
   * ID of the thread where the host function is executing.
   */
...
// Targeting ../cupti/CUpti_ActivityGreenContext3.java



/**
 * \brief Enum identifiers for fields to trace green context information.
 *
 * These field IDs are used to reference specific fields when dynamically
 * selecting or parsing activity records of CUPTI_ACTIVITY_KIND_GREEN_CONTEXT.
 */
/** enum CUpti_ActivityGreenContextFieldIds */
public static final int
  /**
   * CUpti_ActivityKind kind;
   * Kind of this activity record. Always CUPTI_ACTIVITY_KIND_GREEN_CONTEXT.
   */
   ...
   * The size (in 32-bit words) of the logical TPC mask.
   */
  GREEN_CONTEXT_FIELD_LOGICAL_TPC_MASK_SIZE = 6,

  /**
   * uint32_t logicalTpcMask[32];
   * The logical TPC mask for the green context.
   */
  ...
  /**
   * uint32_t workqueueChannelCount;
   * The number of HW channels assigned to this green context's work queue.
   */
  GREEN_CONTEXT_FIELD_WORKQUEUE_CHANNEL_COUNT = 11,

  /**
   * uint32_t workqueueChannelIds[32];
   * Array of HW channel IDs assigned to this green context's work queue.
   */
  GREEN_CONTEXT_FIELD_WORKQUEUE_CHANNEL_IDS = 12,

  /**
   * Total number of defined fields.
   */
  GREEN_CONTEXT_FIELD_MAX = 13;
...
public static final int
     ...
     * The value is a uint8_t.
     *
     * When this attribute is enabled, CUPTI activity records will
     * contain only the fields that are enabled for collection by the user.
     * This can help to reduce the size of each activity record and decrease
     * the overall memory consumption for activity collection.
     *
     * This attribute must be set before enabling any CUPTI activity kinds.
     * The activity kinds should be enabled/disabled using CUPTI API
     * \ref cuptiActivityEnable_v2 and \ref cuptiActivityDisable_v2 respectively.
     *
     * Minimum CUPTI Version: CUPTI_API_VERSION 130200 (CUDA 13.2) — beta.
     * Productized (no longer beta) in CUPTI_API_VERSION 130300 (CUDA 13.3).
     * The CUPTI version can be queried using \ref cuptiGetVersion() API.
     *
     * Refer these links for online documentation:
     *  CUPTI Activity User-Defined Records: https://docs.nvidia.com/cupti/main/main.html#cupti-user-defined-activity-records
     ...
     * If 1, multiple subscribers are allowed.
     * If 2, this option has not been set by a prior subscriber, if there were any. In this case, the subscriber is free to set it during cuptiSubscribe_v2 call.
     ...
     * The value is a uint8_t.
     *
     * If 0, HES (Hardware Events System) is disabled.
     * If 1, HES (Hardware Events System) is enabled.
     ...
     * The value is a uint8_t.
     *
     * If 0, allocation source library tracking is disabled.
     ...
     *
     * If 0, latency timestamp tracking is disabled.
     ...
     * The value is a uint8_t.
     *
     * This can be used to toggle collecting event device timestamps for CUDA event records.
     ...
     * The value is a uint8_t.
     *
     * This can be used to toggle collecting launch attributes for kernel records.
     ...
     * The value is a uint8_t.
     *
     * This can be used to toggle collecting device graph trace for graph records.
     ...
     * The value is a uint8_t.
     *
     * This attribute is only relevant for multi-subscriber mode. CUPTI currently does not support different subscribers to ask for node level trace and graph level trace concurrently.
     * If this flag is disabled, body nodes of a graph are reported under normal concurrent kernel/ memcpy/ memset records.
     * If this flag is enabled, body nodes of a graph are not reported under normal concurrent kernel/ memcpy/ memset records,
     * but the graph is entirely reported as part of a single graph trace record(if CUPTI_ACTIVITY_KIND_GRAPH_TRACE is enabled for the subscriber).
     * Note that this behavior is consistent across all subscribers, regardless of which activities each subscriber is enabling.
     *
     * If 0, multi-subscriber graph level trace is disabled.
     * If 1, multi-subscriber graph level trace is enabled.
     * The default value is 0.
     * Note that this attribute can be set by cuptiActivitySetAttribute_v2 and queried using cuptiActivityGetAttribute_v2 for the specified subscriber.
     ...
     *
     * This attribute specifies the method used by CUPTI to obtain thread IDs.
     ...
     *
     * This attribute allows registering a custom timestamp callback function that CUPTI will use instead of its default CPU timer.
 ...
 * \note This API will be deprecated in a future release. In CUDA 13.4 and later, the corresponding V2 API is
 * \ref cuptiGetTimestamp_v2. See the V1 to V2 API Migration section in the CUPTI
...
/**
 * \brief Get the CUPTI timestamp. If a subscriber registers a particular timestamp callback, this API will use that callback to get the timestamp.
 * In CUDA 13.3, this API falls back to cuptiGetTimestamp(). In CUDA 13.4 and later,
 * this API provides the timestamp callback registered by the requesting subscriber.
 *
 * Returns a timestamp normalized to correspond with the start and end
 * timestamps reported in the CUPTI activity records. The timestamp is
 * reported in nanoseconds.
...
/**
 * \brief Get the unique ID of a CUDA event
 *
 * Returns the unique ID of the CUDA event. The ID matches the eventId
 * field reported in \ref CUpti_ActivityCudaEvent2 activity records.
 *
 * @param event The CUDA event.
 * @param pEventId Returns the unique ID of the event.
 *
 * \retval CUPTI_SUCCESS
 * \retval CUPTI_ERROR_NOT_INITIALIZED
 * \retval CUPTI_ERROR_INVALID_PARAMETER if \p event or \p pEventId is NULL
 */
public static native @Cast("CUptiResult") int cuptiGetCudaEventId(CUevent_st event, @Cast("uint32_t*") IntPointer pEventId);
public static native @Cast("CUptiResult") int cuptiGetCudaEventId(CUevent_st event, @Cast("uint32_t*") IntBuffer pEventId);
public static native @Cast("CUptiResult") int cuptiGetCudaEventId(CUevent_st event, @Cast("uint32_t*") int[] pEventId);
 ...
 * \note This API will be deprecated in a future release. The corresponding V2 API is \ref cuptiActivityEnable_v2. See the
 * V1 to V2 API Migration section in the CUPTI documentation for more details.
 *
 ...
 * activity kind.
 * \note This API will be deprecated in a future release. The corresponding V2 API is \ref cuptiActivityEnableAndDump_v2. See
 * the V1 to V2 API Migration section in the CUPTI documentation for more details.
 *
 * @param kind The kind of activity record to collect
 *
 * \retval CUPTI_SUCCESS
 ...
 * default all activity kinds are disabled for collection.
 * \note This API will be deprecated in a future release. The corresponding V2 API is \ref cuptiActivityDisable_v2. See the
 * V1 to V2 API Migration section in the CUPTI documentation for more details.
 *
...
public static native @MemberGetter int CUpti_ActivityConfig_STRUCT_SIZE();
public static final int CUpti_ActivityConfig_STRUCT_SIZE = CUpti_ActivityConfig_STRUCT_SIZE();


/**
 * \brief Enable collection of a specific kind of activity record for the subscriber.
 *
 * Enable collection of a specific kind of activity record. Multiple
 * kinds can be enabled by calling this function multiple times. By
 * default all activity kinds are disabled for collection.
 ...
 * @param subscriber The subscriber handle.
 * @param kind The kind of activity record to collect
 * @param pActivityConfig The activity config. It can be NULL.
 *
 * \retval CUPTI_SUCCESS
 * \retval CUPTI_ERROR_NOT_INITIALIZED
 * \retval CUPTI_ERROR_NOT_COMPATIBLE if the activity kind cannot be enabled
 * \retval CUPTI_ERROR_INVALID_KIND if the activity kind is not supported
 */
public static native @Cast("CUptiResult") int cuptiActivityEnable_v2(@ByPtr CUpti_Subscriber_st subscriber, @Cast("CUpti_ActivityKind") int kind, CUpti_ActivityConfig pActivityConfig);

/**
 * \brief Disable collection of a specific kind of activity record for the subscriber.
 *
 * Disable collection of a specific kind of activity record. Multiple
 * kinds can be disabled by calling this function multiple times. By
 * default all activity kinds are disabled for collection.
 ...
 * \retval CUPTI_ERROR_INVALID_KIND if the activity kind is not supported
 */
public static native @Cast("CUptiResult") int cuptiActivityDisable_v2(@ByPtr CUpti_Subscriber_st subscriber, @Cast("CUpti_ActivityKind") int kind, CUpti_ActivityConfig pActivityConfig);

/**
 * \brief Enable collection of a specific kind of activity record. For certain activity kinds
 * it dumps existing records.
 *
 * In general, the behavior of this API is similar to the API \ref cuptiActivityEnable_v2 i.e. it
 * enables the collection of a specific kind of activity record.
 * Additionally, this API can help in dumping the records for activities which happened in
 * the past before enabling the corresponding activity kind.
 * The API allows to get records for the current resource allocations done in CUDA
 ...
 *
 * Before calling this function, the user must register buffer callbacks
 * to get the activity records by calling \ref cuptiActivityRegisterCallbacks_v2.
 * If the user does not register the buffers and calls API \ref cuptiActivityEnableAndDump_v2,
 * then CUPTI will enable the activity kind but not provide any records for that
 * activity kind.
 *
 * @param subscriber The subscriber handle.
 * @param kind The kind of activity record to collect
 * @param activityConfig The activity config. It can be NULL.
 *
 * \retval CUPTI_SUCCESS
 * \retval CUPTI_ERROR_NOT_INITIALIZED
 * \retval CUPTI_ERROR_UNKNOWN if buffer is not initialized.
 ...
 *
 * @param subscriber The subscriber handle. If NULL, the union of activity kinds enabled across all subscribers is returned.
 * @param buffer The buffer to store the enabled activity kinds. If NULL, the number of enabled activity kinds is returned in \p enabledKindsCount.
 * @param bufferSize The size of the buffer. If NULL, only the number of enabled activity kinds is returned in \p enabledKindsCount. If NULL and \p buffer is not NULL, CUPTI_ERROR_INVALID_PARAMETER is returned.
 * @param enabledKindsCount The number of enabled activity kinds. If NULL, CUPTI_ERROR_INVALID_PARAMETER is returned.
 *
 * \note If the provided buffer size is not sufficient to store all the enabled activity kinds, we populate the buffer with as much as we can, but return the true value of the number of enabled activity kinds in \p enabledKindsCount.
 *
 * \retval CUPTI_SUCCESS
 * \retval CUPTI_ERROR_INVALID_PARAMETER if \p enabledKindsCount is NULL or if \p subscriber is invalid.
 */
public static native @Cast("CUptiResult") int cuptiActivityGetEnabledKinds(@ByPtr CUpti_Subscriber_st subscriber, @Cast("CUpti_ActivityKind*") IntPointer buffer, @Cast("uint32_t*") IntPointer bufferSize, @Cast("uint32_t*") IntPointer enabledKindsCount);
public static native @Cast("CUptiResult") int cuptiActivityGetEnabledKinds(@ByPtr CUpti_Subscriber_st subscriber, @Cast("CUpti_ActivityKind*") IntBuffer buffer, @Cast("uint32_t*") IntBuffer bufferSize, @Cast("uint32_t*") IntBuffer enabledKindsCount);
public static native @Cast("CUptiResult") int cuptiActivityGetEnabledKinds(@ByPtr CUpti_Subscriber_st subscriber, @Cast("CUpti_ActivityKind*") int[] buffer, @Cast("uint32_t*") int[] bufferSize, @Cast("uint32_t*") int[] enabledKindsCount);

/**
 * \brief Get the size of the activity struct for a given CUPTI version.
 *
 * This API is applicable only for predefined activity structs.
 *
 * @param activityKind The activity kind to get the size for.
 * @param activityStructSize The size of the activity struct.
 * @param version The version of the CUPTI API.
 *                If 0, returns size for current version.
 *                If non-zero, returns size for the specified version.
 *                The version format is xxyyzz, e.g., 130000 for CUPTI 13.0, 130100 for CUPTI 13.1.
 *                The version of CUPTI can be queried using cuptiGetVersion API.
 *                Only versions >= 130000 are supported.
 *
 * \retval CUPTI_SUCCESS
 * \retval CUPTI_ERROR_INVALID_PARAMETER if \p activityStructSize is NULL
 * \retval CUPTI_ERROR_INVALID_KIND if \p activityKind is invalid.
 * \retval CUPTI_ERROR_NOT_SUPPORTED if \p version is non-zero and is less than 130000.
 */
 ...
 * to this function.
 * \note This API will be deprecated in a future release. The corresponding V2 API is \ref cuptiActivityGetNumDroppedRecords_v2.
 ...
 * \note This API will be deprecated in a future release. The corresponding V2 API is \ref cuptiActivityGetNextRecord_v2. See
 * the V1 to V2 API Migration section in the CUPTI documentation for more details.
 *
 * \retval CUPTI_SUCCESS
 * \retval CUPTI_ERROR_NOT_INITIALIZED
 ...
 * \note This API will be deprecated in a future release. The corresponding V2 API is \ref cuptiActivityRegisterCallbacks_v2.
 * See the V1 to V2 API Migration section in the CUPTI documentation for more details.
 *
 * \retval CUPTI_SUCCESS
...
// Targeting ../cupti/CUpti_BufferCallbackRequestInfo.java


// Targeting ../cupti/CUpti_BuffersCallbackRequestFunc_v2.java


// Targeting ../cupti/CUpti_BufferCallbackCompleteInfo.java


// Targeting ../cupti/CUpti_BuffersCallbackCompleteFunc_v2.java



/**
 * \brief Registers callback functions with CUPTI for activity buffer
 * handling for the subscriber.
 *
 * This function registers two callback functions to be used in asynchronous
 * buffer handling. If registered, activity record buffers are handled using
 * asynchronous requested/completed callbacks from CUPTI.
 ...
 * \retval CUPTI_SUCCESS
 * \retval CUPTI_ERROR_INVALID_PARAMETER if either \p
 * funcBufferRequested or \p funcBufferCompleted_v2 is NULL
 */
public static native @Cast("CUptiResult") int cuptiActivityRegisterCallbacks_v2(@ByPtr CUpti_Subscriber_st subscriber, CUpti_BuffersCallbackRequestFunc_v2 funcBufferRequested, CUpti_BuffersCallbackCompleteFunc_v2 funcBufferCompleted);
 ...
 * to flush all data.
 * Calling restrictions are the same as for cuptiActivityFlushAll.
 */
 ...
 *
 * This function can be called from application or control threads outside a CUPTI
 * callback. If called from a CUPTI callback, it must be called only from API trace
 * callbacks in CUPTI_CB_DOMAIN_RUNTIME_API or CUPTI_CB_DOMAIN_DRIVER_API callback
 * domains. Do not call this function from activity buffer callbacks or any other
 * non-API-trace callbacks, including callbacks related to state, resource,
 * synchronization, launch, memory operations, or graph activity.
 *
 ...
 * In case of multiple subscribers, use cuptiActivityGetAttribute_v2 to read the attribute for the subscriber.
 * \note This API will be deprecated in a future release. The corresponding V2 API is \ref cuptiActivityGetAttribute_v2. See
 * the V1 to V2 API Migration section in the CUPTI documentation for more details.
 *
 ...
 * \brief Read an activity API attribute.
 *
 * This function is similar to cuptiActivityGetAttribute.  Note that in case of multiple subscribers, only cuptiActivityGetAttribute_v2
 * can be used to read the attribute for the subscriber.
 *
 * Read an activity API attribute and return it in \p *value.
 *
 * @param subscriber The subscriber handle.
 ...
 * the \p value buffer is too small to hold the attribute value.
 */
public static native @Cast("CUptiResult") int cuptiActivityGetAttribute_v2(@ByPtr CUpti_Subscriber_st subscriber, @Cast("CUpti_ActivityAttribute") int attr,
  @Cast("size_t*") SizeTPointer valueSize, Pointer value);
 ...
 * In case of multiple subscribers, use cuptiActivitySetAttribute_v2 to write the attribute for the subscriber.
 * \note This API will be deprecated in a future release. The corresponding V2 API is \ref cuptiActivitySetAttribute_v2. See
 * the V1 to V2 API Migration section in the CUPTI documentation for more details.
 *
 ...
 * \retval CUPTI_SUCCESS
 * \retval CUPTI_ERROR_NOT_INITIALIZED
 * \retval CUPTI_ERROR_NOT_SUPPORTED if multiple subscribers are not allowed.
 * \retval CUPTI_ERROR_INVALID_PARAMETER if \p valueSize or \p value is NULL, or
 * if \p attr is not an activity attribute
 * \retval CUPTI_ERROR_PARAMETER_SIZE_NOT_SUFFICIENT Indicates that
 * the \p value buffer is too small to hold the attribute value.
 ...
 * the \p value buffer is too small to hold the attribute value.
 */
public static native @Cast("CUptiResult") int cuptiActivitySetAttribute_v2(@ByPtr CUpti_Subscriber_st subscriber, @Cast("CUpti_ActivityAttribute") int attr,
  @Cast("size_t*") SizeTPointer valueSize, Pointer value);
 ...
 * This API is not supported when multiple subscribers are allowed.
 * \note This API will be deprecated in a future release. The corresponding V2 activity attribute is
 * \ref CUPTI_ACTIVITY_ATTR_THREAD_ID_TYPE, which can be queried or modified via
 * \ref cuptiActivityGetAttribute_v2 and \ref cuptiActivitySetAttribute_v2.
 * See the V1 to V2 API Migration section in the CUPTI documentation for more details.
 *
 * \retval CUPTI_SUCCESS
 ...
 * \note This API will be deprecated in a future release. The corresponding V2 API is
 * \ref cuptiActivityPushExternalCorrelationId_v2. See the V1 to V2 API Migration
 * section in the CUPTI documentation for more details.
 *
 * \retval CUPTI_SUCCESS
 ...
 * \note This API will be deprecated in a future release. The corresponding V2 API is
 * \ref cuptiActivityPopExternalCorrelationId_v2. See the V1 to V2 API Migration
 * section in the CUPTI documentation for more details.
 *
 * \retval CUPTI_SUCCESS
 * \retval CUPTI_ERROR_INVALID_PARAMETER The external API kind is invalid.
 ...
 * for kernels whose records are provided through the struct \ref CUpti_ActivityKernel13.
 ...
 * \note This API will be deprecated in a future release. The corresponding V2 activity attribute is
 * \ref CUPTI_ACTIVITY_ATTR_ENABLE_KERNEL_LATENCY_TIMESTAMPS, which can be queried or modified via
 * \ref cuptiActivityGetAttribute_v2 and \ref cuptiActivitySetAttribute_v2.
 * See the V1 to V2 API Migration section in the CUPTI documentation for more details.
 ...
 * records are provided through the struct \ref CUpti_ActivityKernel13.
 * Default value is 0, i.e. these attributes are not collected.
 * \note This API will be deprecated in a future release. The corresponding V2 activity attribute is
 * \ref CUPTI_ACTIVITY_ATTR_ENABLE_KERNEL_LAUNCH_ATTRIBUTES, which can be queried or modified via
 * \ref cuptiActivityGetAttribute_v2 and \ref cuptiActivitySetAttribute_v2.
 * See the V1 to V2 API Migration section in the CUPTI documentation for more details.
 *
 ...
 * \note This API will be deprecated in a future release. In CUDA 13.4 and later, the corresponding
 * V2 activity attribute is \ref CUPTI_ACTIVITY_ATTR_TIMESTAMP_CALLBACK, which can be queried or
 * modified via \ref cuptiActivityGetAttribute_v2 and \ref cuptiActivitySetAttribute_v2.
 * See the V1 to V2 API Migration section in the CUPTI documentation for more details.
 *
 ...
 * If the kind CUPTI_ACTIVITY_KIND_GRAPH_TRACE is selected, then CUPTI_ACTIVITY_KIND_DEVICE_GRAPH_TRACE
 * records will also be emitted for device graphs. This applies for both Hardware Event System (HES) and SW
 * instrumentation method.
 * Otherwise records for device graphs will be collected at node granularity and the field 'isDeviceLaunched' for
 * memcpy, memset and kernel records will be set for device graph nodes. This collection is done only if
 * Hardware Event System (HES) is enabled.
 * This API needs to be called before initialization of CUDA and this setting should not be
 * changed during the profiling session.
 * \note This API will be deprecated in a future release. The corresponding V2 activity attribute is
 * \ref CUPTI_ACTIVITY_ATTR_ENABLE_DEVICE_GRAPH_TRACE, which can be queried or modified via
 * \ref cuptiActivityGetAttribute_v2 and \ref cuptiActivitySetAttribute_v2.
 * See the V1 to V2 API Migration section in the CUPTI documentation for more details.
 *
 ...
 * \note This API will be deprecated in a future release. The corresponding V2 API is \ref cuptiActivityEnableDriverApi_v2.
 * See the V1 to V2 API Migration section in the CUPTI documentation for more details.
 *
 ...
 * CUDA Driver APIs.
 *
 * \note This API is supported with user-defined activity records
 * (see \ref cuptiActivityEnable_v2 with \ref CUpti_ActivityConfig::fieldSelection).
 * When using user-defined records, the activity kind must first be registered via
 * \ref cuptiActivityEnable_v2 before calling this API to control per-cbid collection.
 * Support for cbid filtering with user-defined records requires CUPTI_API_VERSION 130400 or later.
 *
 * \note If cbid-level filtering is only needed at enable time and does not change thereafter,
 * the \ref CUpti_ActivityApiCbidOptions allowlist/denylist passed through
 * \ref cuptiActivityEnable_v2 is a simpler alternative to calling this API per cbid.
 *
 ...
 * if it is called after the API.
 * \note This API will be deprecated in a future release. The corresponding V2 API is \ref cuptiActivityEnableRuntimeApi_v2.
 * See the V1 to V2 API Migration section in the CUPTI documentation for more details.
 *
 ...
 * to the traditional software instrumentation and semaphore-based approach. HES-based
 * collection provides lower overhead and more accurate timing measurements.
 *
 ...
 * \note This API will be deprecated in a future release. The corresponding V2 activity attribute is
 * \ref CUPTI_ACTIVITY_ATTR_ENABLE_HES, which can be queried or modified via
 * \ref cuptiActivityGetAttribute_v2 and \ref cuptiActivitySetAttribute_v2.
 * See the V1 to V2 API Migration section in the CUPTI documentation for more details.
 *
 ...
 * \note This API will be deprecated in a future release. The corresponding V2 activity attribute is
 * \ref CUPTI_ACTIVITY_ATTR_ENABLE_ALLOCATION_SOURCE_TRACKING, which can be queried or modified via
 * \ref cuptiActivityGetAttribute_v2 and \ref cuptiActivitySetAttribute_v2.
 * See the V1 to V2 API Migration section in the CUPTI documentation for more details.
 *
 ...
 * \note This API will be deprecated in a future release. The corresponding V2 activity attribute is
 * \ref CUPTI_ACTIVITY_ATTR_ENABLE_ALL_SYNC_RECORDS, which can be queried or modified via
 * \ref cuptiActivityGetAttribute_v2 and \ref cuptiActivitySetAttribute_v2.
 * See the V1 to V2 API Migration section in the CUPTI documentation for more details.
 *
 ...
 * \note This API will be deprecated in a future release. The corresponding V2 activity attribute is
 * \ref CUPTI_ACTIVITY_ATTR_ENABLE_CUDA_EVENT_DEVICE_TIMESTAMPS, which can be queried or modified via
 * \ref cuptiActivityGetAttribute_v2 and \ref cuptiActivitySetAttribute_v2.
 * See the V1 to V2 API Migration section in the CUPTI documentation for more details.
 *
 ...
 * \note \b Thread-safety: this function is thread safe.
 * \note This API will be deprecated in a future release. The corresponding V2 API is \ref cuptiSubscribe_v2. See the V1 to V2 API Migration
 * section in the CUPTI documentation for more details.
 *
...
/**
 * \brief Get the enabled callbacks for a subscriber.
 *
 * @param subscriber The subscriber handle. If NULL, the union of callbacks (for that domain) enabled across all subscribers is returned.
 * @param domain The domain of the callbacks to get. If NULL, CUPTI_ERROR_INVALID_PARAMETER is returned.
 * @param buffer The buffer to store the enabled callbacks. If NULL, the number of enabled callbacks is returned in \p enabledCallbacksCount.
 * @param bufferSize The size of the buffer. If NULL, only the number of enabled callbacks is returned in \p enabledCallbacksCount. If NULL and \p buffer is not NULL, CUPTI_ERROR_INVALID_PARAMETER is returned.
 * @param enabledCallbacksCount The number of enabled callbacks. If NULL, CUPTI_ERROR_INVALID_PARAMETER is returned.
 *
 * \note If the provided buffer size is not sufficient to store all the enabled callbacks, we populate the buffer with as much as we can, but return the true value of the number of enabled callbacks in \p enabledCallbacksCount.
 *
 * \retval CUPTI_SUCCESS
 * \retval CUPTI_ERROR_INVALID_PARAMETER if \p enabledCallbacksCount is NULL, or if \p subscriber or \p domain is invalid.
 */
public static native @Cast("CUptiResult") int cuptiGetEnabledCallbacks(@ByPtr CUpti_Subscriber_st subscriber, @Cast("CUpti_CallbackDomain") int domain, @Cast("CUpti_CallbackId*") IntPointer buffer, @Cast("uint32_t*") IntPointer bufferSize, @Cast("uint32_t*") IntPointer enabledCallbacksCount);
public static native @Cast("CUptiResult") int cuptiGetEnabledCallbacks(@ByPtr CUpti_Subscriber_st subscriber, @Cast("CUpti_CallbackDomain") int domain, @Cast("CUpti_CallbackId*") int[] buffer, @Cast("uint32_t*") IntBuffer bufferSize, @Cast("uint32_t*") IntBuffer enabledCallbacksCount);
public static native @Cast("CUptiResult") int cuptiGetEnabledCallbacks(@ByPtr CUpti_Subscriber_st subscriber, @Cast("CUpti_CallbackDomain") int domain, @Cast("CUpti_CallbackId*") IntPointer buffer, @Cast("uint32_t*") int[] bufferSize, @Cast("uint32_t*") int[] enabledCallbacksCount);
public static native @Cast("CUptiResult") int cuptiGetEnabledCallbacks(@ByPtr CUpti_Subscriber_st subscriber, @Cast("CUpti_CallbackDomain") int domain, @Cast("CUpti_CallbackId*") int[] buffer, @Cast("uint32_t*") IntPointer bufferSize, @Cast("uint32_t*") IntPointer enabledCallbacksCount);
public static native @Cast("CUptiResult") int cuptiGetEnabledCallbacks(@ByPtr CUpti_Subscriber_st subscriber, @Cast("CUpti_CallbackDomain") int domain, @Cast("CUpti_CallbackId*") IntPointer buffer, @Cast("uint32_t*") IntBuffer bufferSize, @Cast("uint32_t*") IntBuffer enabledCallbacksCount);
public static native @Cast("CUptiResult") int cuptiGetEnabledCallbacks(@ByPtr CUpti_Subscriber_st subscriber, @Cast("CUpti_CallbackDomain") int domain, @Cast("CUpti_CallbackId*") int[] buffer, @Cast("uint32_t*") int[] bufferSize, @Cast("uint32_t*") int[] enabledCallbacksCount);
...
public static final int
    ...
    CUPTI_DRIVER_TRACE_CBID_cuMemGetLocationInfo                                           = 860,
    CUPTI_DRIVER_TRACE_CBID_cuCheckpointOperationComplete                                  = 861,
    CUPTI_DRIVER_TRACE_CBID_reserved862                                                    = 862,
    CUPTI_DRIVER_TRACE_CBID_cuGraphAddNode_v3                                              = 863,
    CUPTI_DRIVER_TRACE_CBID_cuGraphNodeSetParams_v2                                        = 864,
    CUPTI_DRIVER_TRACE_CBID_cuDeviceGetFabricClusterUuid                                   = 865,
    CUPTI_DRIVER_TRACE_CBID_cuDeviceGetCliqueCount                                         = 866,
    CUPTI_DRIVER_TRACE_CBID_cuDeviceGetCliqueInfo                                          = 867,
    CUPTI_DRIVER_TRACE_CBID_SIZE                                                           = 868,
...
// #if !defined(_CUPTI_RUNTIME_CBID_H_)
// #define _CUPTI_RUNTIME_CBID_H_
...
public static final int
    ...
    CUPTI_RUNTIME_TRACE_CBID_cuda531                                                       = 531,
    CUPTI_RUNTIME_TRACE_CBID_cuda532                                                       = 532,
    ...
    CUPTI_RUNTIME_TRACE_CBID_cuda545                                                       = 545,
    CUPTI_RUNTIME_TRACE_CBID_cuda546                                                       = 546,
    CUPTI_RUNTIME_TRACE_CBID_cuda547                                                       = 547,
    ...
    CUPTI_RUNTIME_TRACE_CBID_cuda553                                                       = 553,
    ...
    CUPTI_RUNTIME_TRACE_CBID_cuda559                                                       = 559,
    CUPTI_RUNTIME_TRACE_CBID_cuda560                                                       = 560,
    CUPTI_RUNTIME_TRACE_CBID_cuda561                                                       = 561,
    CUPTI_RUNTIME_TRACE_CBID_cudaStreamBeginRecaptureToGraph_v13030                        = 562,
    CUPTI_RUNTIME_TRACE_CBID_cudaStreamBeginRecaptureToGraph_ptsz_v13030                   = 563,
    CUPTI_RUNTIME_TRACE_CBID_cuda564                                                       = 564,
    CUPTI_RUNTIME_TRACE_CBID_cudaMemGetLocationInfo_v13040                                 = 565,
    CUPTI_RUNTIME_TRACE_CBID_SIZE                                                          = 566,
