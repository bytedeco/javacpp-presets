 ...
 */
public static native @Cast("const char*") BytePointer nvcompGetStatusString(@Cast("nvcompStatus_t") int status);
...
// Parsed from <nvcomp/formatSpec.hpp>
...
// Targeting ../nvcomp/CascadedFormatSpecHeader.java
...
// Targeting ../nvcomp/GzipFormatSpecHeader.java
 ...
 * \note To maximize decompression performance, users are encouraged to compress in smaller chunks, for example 64KiB.
 */
@MemberGetter public static native @Cast("const size_t") long nvcompANSDecompressionMaxAllowedChunkSize();
public static final long nvcompANSDecompressionMaxAllowedChunkSize = nvcompANSDecompressionMaxAllowedChunkSize();
 ...
 * \note To maximize decompression performance, users are encouraged to compress in smaller chunks, for example 64KiB.
 */
@MemberGetter public static native @Cast("const size_t") long nvcompBitcompDecompressionMaxAllowedChunkSize();
public static final long nvcompBitcompDecompressionMaxAllowedChunkSize = nvcompBitcompDecompressionMaxAllowedChunkSize();
 ...
 *
 * \note An asynchronous, faster version of batched Bitcomp asynchronous decompression
 ...
 * \note To maximize decompression performance, users are encouraged to compress in smaller chunks, for example 64KiB.
 */
@MemberGetter public static native @Cast("const size_t") long nvcompCascadedDecompressionMaxAllowedChunkSize();
public static final long nvcompCascadedDecompressionMaxAllowedChunkSize = nvcompCascadedDecompressionMaxAllowedChunkSize();
 ...
 *
 * \note Although chunk sizes up to 2GiB are theoretically possible, compression
 ...
 * \note To maximize decompression performance, users are encouraged to compress in smaller chunks, for example 64KiB.
 * \note The hardware Decompression Engine (DE) may have different maximum chunk size limits.
 * This can be queried through {@code cuDeviceGetAttribute} with {@code CU_DEVICE_ATTRIBUTE_MEM_DECOMPRESS_MAXIMUM_LENGTH}.
 */
@MemberGetter public static native @Cast("const size_t") long nvcompDeflateDecompressionMaxAllowedChunkSize();
public static final long nvcompDeflateDecompressionMaxAllowedChunkSize = nvcompDeflateDecompressionMaxAllowedChunkSize();
 ...
 * \note To maximize decompression performance, users are encouraged to compress in smaller chunks, for example 64KiB.
 */
@MemberGetter public static native @Cast("const size_t") long nvcompGdeflateDecompressionMaxAllowedChunkSize();
public static final long nvcompGdeflateDecompressionMaxAllowedChunkSize = nvcompGdeflateDecompressionMaxAllowedChunkSize();
 ...
 * \note To maximize decompression performance, users are encouraged to compress in smaller chunks, for example 64KiB, or use the lookahead algorithm.
 */
@MemberGetter public static native @Cast("const size_t") long nvcompGzipNaiveDecompressionMaxAllowedChunkSize();
public static final long nvcompGzipNaiveDecompressionMaxAllowedChunkSize = nvcompGzipNaiveDecompressionMaxAllowedChunkSize();
 ...
 * This can be queried through {@code cuDeviceGetAttribute} with {@code CU_DEVICE_ATTRIBUTE_MEM_DECOMPRESS_MAXIMUM_LENGTH}.
 */
@MemberGetter public static native @Cast("const size_t") long nvcompGzipLookaheadDecompressionMaxAllowedChunkSize();
public static final long nvcompGzipLookaheadDecompressionMaxAllowedChunkSize = nvcompGzipLookaheadDecompressionMaxAllowedChunkSize();
 ...
 * This can be queried through {@code cuDeviceGetAttribute} with {@code CU_DEVICE_ATTRIBUTE_MEM_DECOMPRESS_MAXIMUM_LENGTH}.
 */
@MemberGetter public static native @Cast("const size_t") long nvcompLZ4DecompressionMaxAllowedChunkSize();
public static final long nvcompLZ4DecompressionMaxAllowedChunkSize = nvcompLZ4DecompressionMaxAllowedChunkSize();
 ...
 * \note To maximize decompression performance, users are encouraged to compress in smaller chunks, for example 64KiB.
 */
@MemberGetter public static native @Cast("const size_t") long nvcompZstdDecompressionMaxAllowedChunkSize();
public static final long nvcompZstdDecompressionMaxAllowedChunkSize = nvcompZstdDecompressionMaxAllowedChunkSize();
 ...
 *
 * \note This function does not interact asynchronously with the device,
