 ...
 * @param aQuad Host memory array of 2D points. These points are the locations of the corners
 *      of the rotated ROI. 
 ...
 * @param aQuad Host memory array containing the destination quadrilateral.
 * @param aCoeffs Host memory array containing the resulting affine transform coefficients.
 * @return Error codes:
 ...
 * @param aQuad Host memory array that receives the resulting destination quadrangle.
 * @param aCoeffs Host memory array containing the affine transform coefficients.
 * @return Error codes:
 *         - NPP_SIZE_ERROR Indicates an error condition if any image dimension
 *           has zero or negative value
 *         - NPP_RECTANGLE_ERROR Indicates an error condition if width or height of
 ...
 * @param aCoeffs Host memory array containing the perspective transform coefficients.
 * @return Error codes:
 *         - NPP_SIZE_ERROR Indicates an error condition if any image dimension
 *           has zero or negative value
 *         - NPP_RECTANGLE_ERROR Indicates an error condition if width or height of
