...
public static final int NVML_GPU_INSTANCE_PROFILE_COUNT =        0xA;
...
/* CCU Stream State */
public static final int NVML_COUNTER_COLLECTION_UNIT_STREAM_STATE_DISABLE = 0;
public static final int NVML_COUNTER_COLLECTION_UNIT_STREAM_STATE_ENABLE =  1;
 ...
 *         - \ref NVML_ERROR_NOT_SUPPORTED     if this query is not supported by the device
 */
public static native @Cast("nvmlReturn_t") int nvmlDeviceCcuSetStreamState(nvmlDevice_st device, @Cast("unsigned int") int state);
