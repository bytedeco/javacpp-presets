...
public static final int
    ...
    /** Query if the GPU supports FSR and warm update */
...
public static final int NVML_FI_DEV_NVLINK_GET_POWER_THRESHOLD_MAX =    199;

/** MIG mode independent, MIG query capable device. 1=yes. 0=no. */
public static final int NVML_FI_DEV_IS_MIG_MODE_INDEPENDENT_MIG_QUERY_CAPABLE =   200;
...
/**Number of VL15 MADs dropped on a link in NVLink5 */
...
public static final int NVML_FI_MAX =                                              230;
...
public static final int NVML_CC_KEY_ROTATION_THRESHOLD_ATTACKER_ADVANTAGE_MAX = 75;
...
public static final int NVML_GPU_FABRIC_HEALTH_MASK_WIDTH_DEGRADED_BW = 0x11;
 ...
 *         - \ref NVML_ERROR_UNKNOWN                    On any unexpected error
 */
public static native @Cast("nvmlReturn_t") int nvmlDeviceGetVgpuTypeSupportedPlacements(nvmlDevice_st device, @Cast("nvmlVgpuTypeId_t") int vgpuTypeId, @Cast("nvmlVgpuPlacementList_t*") nvmlVgpuPlacementList_v1_t pPlacementList);
 ...
 *         - \ref NVML_ERROR_UNKNOWN                    On any unexpected error
 */
public static native @Cast("nvmlReturn_t") int nvmlDeviceGetVgpuTypeCreatablePlacements(nvmlDevice_st device, @Cast("nvmlVgpuTypeId_t") int vgpuTypeId, @Cast("nvmlVgpuPlacementList_t*") nvmlVgpuPlacementList_v1_t pPlacementList);
