...
public static native @Cast("cusparseStatus_t") int cusparseConstrainedGeMM(cusparseContext handle,
                        @Cast("cusparseOperation_t") int opA,
                        @Cast("cusparseOperation_t") int opB,
                        @Const Pointer alpha,
                        cusparseDnMatDescr matA,
...
public static native @Cast("cusparseStatus_t") int cusparseConstrainedGeMM_bufferSize(cusparseContext handle,
                                   @Cast("cusparseOperation_t") int opA,
                                   @Cast("cusparseOperation_t") int opB,
                                   @Const Pointer alpha,
                                   cusparseDnMatDescr matA,
