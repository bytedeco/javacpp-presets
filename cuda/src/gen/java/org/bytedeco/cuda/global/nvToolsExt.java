...
/*
* Copyright 2009-2024  NVIDIA Corporation.  All rights reserved.
*
* NOTICE TO USER:
*
...
/*
* Deprecation and upcoming removal warning for NVTX version 2
* This warning can be suppressed by defining NVTX_SUPPRESS_V2_DEPRECATION_WARNING
*/
// #ifndef NVTX_SUPPRESS_V2_DEPRECATION_WARNING
// #ifndef NVTX_V2_DEPRECATION_WARNING_MESSAGE
public static final String NVTX_V2_DEPRECATION_WARNING_MESSAGE = "DEPRECATION NOTICE:  NVTX 2 is deprecated and will be removed from toolkits that distribute it in their next major version (CUDA 12.9).  Please use NVTX 3 instead.  All NVTX 2 API functions are supported in version 3.  The implementation is now header-only, so you no longer need to link with and distribute a dynamic library to use NVTX.  Ensure you are explicitly using NVTX 3 by writing #include <nvtx3/nvToolsExt.h> instead of #include <nvToolsExt.h>.  Remove nvToolsExt from your link command and linker search paths, and stop deploying libnvToolsExt.so or nvToolsExt64_1.dll -- these binary libraries will not be shipped with NVTX 3 for C/C++ usage.  A new library called 'libnvtx3interop.so' or 'nvtx3interop.dll' will be provided for interop with other languages.  This message can be suppressed by defining NVTX_SUPPRESS_V2_DEPRECATION_WARNING before including the NVTX 2 headers.";
// #ifdef _MSC_VER
// #define NVTX_V2_WARNING_HELPER2(x) #x
// #define NVTX_V2_WARNING_HELPER(x) NVTX_V2_WARNING_HELPER2(x)
// #pragma message(__FILE__ ":" NVTX_V2_WARNING_HELPER(__LINE__) ": note: \"" NVTX_V2_DEPRECATION_WARNING_MESSAGE "\"\n")
// #else
// #pragma message NVTX_V2_DEPRECATION_WARNING_MESSAGE
// #endif
// #endif /* NVTX_V2_DEPRECATION_WARNING_MESSAGE */
// #endif /* NVTX_SUPPRESS_V2_DEPRECATION_WARNING */
