...
public static native fftw_plan fftw_plan_guru64_dft(int rank, @Const fftw_iodim64 dims,
...
public static native fftw_plan fftw_plan_guru64_dft_r2c(int rank, @Const fftw_iodim64 dims,
                                            int batch_rank, @Const fftw_iodim64 batch_dims,
                                            DoublePointer in, @Cast("fftw_complex*") DoublePointer out,
                                            @Cast("unsigned") int flags);
public static native fftw_plan fftw_plan_guru64_dft_r2c(int rank, @Const fftw_iodim64 dims,
...
public static native fftw_plan fftw_plan_guru64_dft_c2r(int rank, @Const fftw_iodim64 dims,
                                            int batch_rank, @Const fftw_iodim64 batch_dims,
                                            @Cast("fftw_complex*") DoublePointer in, DoublePointer out,
                                            @Cast("unsigned") int flags);
public static native fftw_plan fftw_plan_guru64_dft_c2r(int rank, @Const fftw_iodim64 dims,
...
public static native fftwf_plan fftwf_plan_guru64_dft(int rank, @Cast("const fftwf_iodim64*") fftw_iodim64 dims,
                                          int batch_rank, @Cast("const fftwf_iodim64*") fftw_iodim64 batch_dims,
                                          @Cast("fftwf_complex*") FloatPointer in, @Cast("fftwf_complex*") FloatPointer out,
                                          int sign, @Cast("unsigned") int flags);
public static native fftwf_plan fftwf_plan_guru64_dft(int rank, @Cast("const fftwf_iodim64*") fftw_iodim64 dims,
                                          int batch_rank, @Cast("const fftwf_iodim64*") fftw_iodim64 batch_dims,
...
public static native fftwf_plan fftwf_plan_guru64_dft_r2c(int rank, @Cast("const fftwf_iodim64*") fftw_iodim64 dims,
                                              int batch_rank, @Cast("const fftwf_iodim64*") fftw_iodim64 batch_dims,
                                              FloatPointer in, @Cast("fftwf_complex*") FloatPointer out,
                                              @Cast("unsigned") int flags);
public static native fftwf_plan fftwf_plan_guru64_dft_r2c(int rank, @Cast("const fftwf_iodim64*") fftw_iodim64 dims,
...
public static native fftwf_plan fftwf_plan_guru64_dft_c2r(int rank, @Cast("const fftwf_iodim64*") fftw_iodim64 dims,
                                              int batch_rank, @Cast("const fftwf_iodim64*") fftw_iodim64 batch_dims,
                                              @Cast("fftwf_complex*") FloatPointer in, FloatPointer out,
                                              @Cast("unsigned") int flags);
public static native fftwf_plan fftwf_plan_guru64_dft_c2r(int rank, @Cast("const fftwf_iodim64*") fftw_iodim64 dims,
