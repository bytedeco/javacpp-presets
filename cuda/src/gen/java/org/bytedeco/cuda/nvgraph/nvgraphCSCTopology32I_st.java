...
public class nvgraphCSCTopology32I_st extends Pointer {
  ...
  public native int nvertices(); public native nvgraphCSCTopology32I_st nvertices(int setter); // n+1
  public native int nedges(); public native nvgraphCSCTopology32I_st nedges(int setter); // nnz
  public native IntPointer destination_offsets(); public native nvgraphCSCTopology32I_st destination_offsets(IntPointer setter); // colPtr
  public native IntPointer source_indices(); public native nvgraphCSCTopology32I_st source_indices(IntPointer setter); // rowInd
}
