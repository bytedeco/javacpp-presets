...
public class fftw_iodim64 extends Pointer {
    ...
    public native int n(); public native fftw_iodim64 n(int setter);
    public native @Cast("size_t") long is(); public native fftw_iodim64 is(long setter);
    public native @Cast("size_t") long os(); public native fftw_iodim64 os(long setter);
}
