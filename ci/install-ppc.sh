...
docker exec -ti $DOCKER_CONTAINER_ID /bin/bash -xec "apt-get -y install oracle-java8-installer"  
docker exec -ti $DOCKER_CONTAINER_ID /bin/bash -xec "apt-get -y install maven "  
