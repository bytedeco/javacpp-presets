...
docker exec -ti $DOCKER_CONTAINER_ID /bin/bash -xec 'echo "deb [arch=ppc64el] http://ppa.launchpad.net/openjdk-r/ppa/ubuntu trusty-security main restricted universe multiverse" >> /etc/apt/sources.list'
