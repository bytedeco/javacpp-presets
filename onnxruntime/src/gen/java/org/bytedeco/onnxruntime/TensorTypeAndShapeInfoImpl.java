...
@Name("Ort::detail::TensorTypeAndShapeInfoImpl<OrtTensorTypeAndShapeInfo>") @Properties(inherit = org.bytedeco.onnxruntime.presets.onnxruntime.class)
public class TensorTypeAndShapeInfoImpl extends BaseTensorTypeAndShapeInfo {
    static { Loader.load(); }
    /** Default native constructor. */
    public TensorTypeAndShapeInfoImpl() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public TensorTypeAndShapeInfoImpl(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TensorTypeAndShapeInfoImpl(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public TensorTypeAndShapeInfoImpl position(long position) {
        return (TensorTypeAndShapeInfoImpl)super.position(position);
    }
    @Override public TensorTypeAndShapeInfoImpl getPointer(long i) {
        return new TensorTypeAndShapeInfoImpl((Pointer)this).offsetAddress(i);
    }
