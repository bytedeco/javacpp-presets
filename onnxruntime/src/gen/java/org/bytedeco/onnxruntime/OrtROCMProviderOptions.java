...
// #endif
   ...
   */
  public native int tunable_op_enable(); public native OrtROCMProviderOptions tunable_op_enable(int setter);
   ...
   */
  public native int tunable_op_tuning_enable(); public native OrtROCMProviderOptions tunable_op_tuning_enable(int setter);

  /** \brief Max tuning duration time limit for each instance of TunableOp.
   *   Defaults to 0 to disable the limit.
   */
  public native int tunable_op_max_tuning_duration_ms(); public native OrtROCMProviderOptions tunable_op_max_tuning_duration_ms(int setter);
