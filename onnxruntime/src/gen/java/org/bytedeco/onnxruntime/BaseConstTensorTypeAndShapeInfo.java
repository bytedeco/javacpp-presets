...
public class BaseConstTensorTypeAndShapeInfo extends Pointer {
  ...
  public native @Cast("const Ort::detail::Base<Ort::detail::Unowned<const OrtTensorTypeAndShapeInfo> >::contained_type*") @ByRef @Name("operator *") @NoException(true) UnownedAllocator multiply();
