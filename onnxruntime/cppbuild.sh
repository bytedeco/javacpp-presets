...
sedinplace 's/cublas cudnn_frontend/cublas CUDNN::cudnn_all cudnn_frontend/g' cmake/onnxruntime_providers_cuda.cmake
...
sedinplace 's/DNNL_TAG v.*)/DNNL_TAG v3.12.2)/g' cmake/external/dnnl.cmake
