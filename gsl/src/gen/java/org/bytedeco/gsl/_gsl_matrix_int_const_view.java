...
public class _gsl_matrix_int_const_view extends Pointer {
    ...
    @Override public _gsl_matrix_int_const_view getPointer(long i) {
        return new _gsl_matrix_int_const_view((Pointer)this).offsetAddress(i);
    }

  public native @ByRef gsl_matrix_int matrix(); public native _gsl_matrix_int_const_view matrix(gsl_matrix_int setter);
}
