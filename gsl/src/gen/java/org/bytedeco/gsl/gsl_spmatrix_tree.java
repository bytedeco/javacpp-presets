...
public class gsl_spmatrix_tree extends Pointer {
  ...
  public native Pointer tree(); public native gsl_spmatrix_tree tree(Pointer setter);       /* tree structure */
  public native Pointer node_array(); public native gsl_spmatrix_tree node_array(Pointer setter); /* preallocated array of tree nodes */
  public native @Cast("size_t") long n(); public native gsl_spmatrix_tree n(long setter);         /* number of tree nodes in use (<= nzmax) */
}
