...
public class gsl_min_fminimizer_type extends Pointer {
    static { Loader.load(); }
    ...
    @Override public gsl_min_fminimizer_type getPointer(long i) {
        return new gsl_min_fminimizer_type((Pointer)this).offsetAddress(i);
    }
    ...
    public native Set_Pointer_gsl_function_double_double_double_double_double_double set(); public native gsl_min_fminimizer_type set(Set_Pointer_gsl_function_double_double_double_double_double_double setter);
    ...
    public native Iterate_Pointer_gsl_function_DoublePointer_DoublePointer_DoublePointer_DoublePointer_DoublePointer_DoublePointer iterate(); public native gsl_min_fminimizer_type iterate(Iterate_Pointer_gsl_function_DoublePointer_DoublePointer_DoublePointer_DoublePointer_DoublePointer_DoublePointer setter);
  }
