...
public class gsl_multiroot_fsolver_type extends Pointer {
    ...
    @Override public gsl_multiroot_fsolver_type getPointer(long i) {
        return new gsl_multiroot_fsolver_type((Pointer)this).offsetAddress(i);
    }
    ...
    public native Alloc_Pointer_long alloc(); public native gsl_multiroot_fsolver_type alloc(Alloc_Pointer_long setter);
    ...
    public native Set_Pointer_gsl_multiroot_function_gsl_vector_gsl_vector_gsl_vector set(); public native gsl_multiroot_fsolver_type set(Set_Pointer_gsl_multiroot_function_gsl_vector_gsl_vector_gsl_vector setter);
    ...
    public native Iterate_Pointer_gsl_multiroot_function_gsl_vector_gsl_vector_gsl_vector iterate(); public native gsl_multiroot_fsolver_type iterate(Iterate_Pointer_gsl_multiroot_function_gsl_vector_gsl_vector_gsl_vector setter);
    ...
    public native @Name("free") Free_Pointer _free(); public native gsl_multiroot_fsolver_type _free(Free_Pointer setter);
  }
