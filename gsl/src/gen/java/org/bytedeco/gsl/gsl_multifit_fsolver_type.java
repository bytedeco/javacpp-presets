...
public class gsl_multifit_fsolver_type extends Pointer {
    static { Loader.load(); }
    ...
    @Override public gsl_multifit_fsolver_type getPointer(long i) {
        return new gsl_multifit_fsolver_type((Pointer)this).offsetAddress(i);
    }

    public native @Cast("const char*") BytePointer name(); public native gsl_multifit_fsolver_type name(BytePointer setter);
    public native @Cast("size_t") long size(); public native gsl_multifit_fsolver_type size(long setter);
    ...
    public native Alloc_Pointer_long_long alloc(); public native gsl_multifit_fsolver_type alloc(Alloc_Pointer_long_long setter);
    ...
    public native Set_Pointer_gsl_multifit_function_gsl_vector_gsl_vector_gsl_vector set(); public native gsl_multifit_fsolver_type set(Set_Pointer_gsl_multifit_function_gsl_vector_gsl_vector_gsl_vector setter);
    ...
    public native Iterate_Pointer_gsl_multifit_function_gsl_vector_gsl_vector_gsl_vector iterate(); public native gsl_multifit_fsolver_type iterate(Iterate_Pointer_gsl_multifit_function_gsl_vector_gsl_vector_gsl_vector setter);
    ...
    public native @Name("free") Free_Pointer _free(); public native gsl_multifit_fsolver_type _free(Free_Pointer setter);
  }
