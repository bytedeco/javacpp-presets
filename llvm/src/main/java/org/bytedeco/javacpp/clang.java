...
public static final int
  ...
  /** Objective-C's overall \\try-\\catch-\\finally statement.
   */
 ...
 */
@Namespace @Name("void") @Opaque public static class CXPrintingPolicy extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
