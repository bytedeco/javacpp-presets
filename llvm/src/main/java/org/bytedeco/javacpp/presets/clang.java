...
@Properties(inherit = LLVM.class, target = "org.bytedeco.javacpp.clang", value = {@Platform(value = {"linux-x86", "macosx", "windows-x86", "windows-x86_64"},
...
compiler = "cpp11", link = "clang"), @Platform(value = {"windows-x86", "windows-x86_64"}, link = {"libclang"})})
