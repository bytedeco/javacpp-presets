...
public class LLVM implements InfoMapper {
    ...
    public void map(InfoMap infoMap) {
        infoMap.put(new Info("LLVMOpaqueContext").pointerTypes("LLVMContextRef"))
               ...
               .put(new Info("LLVMDumpType", "LLVMConstGEP2", "LLVMConstInBoundsGEP2", "LLVMCreateOprofileJITEventListener", "LLVMRemarkVersion", "LLVMOrcDisposeObjectLayer", "LLVMOrcExecutionSessionGetJITDylibByName").skip());
    }
}
