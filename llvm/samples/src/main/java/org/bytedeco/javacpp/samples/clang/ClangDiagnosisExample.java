...
import org.bytedeco.javacpp.clang.CXDiagnosticSet;
...
import org.bytedeco.javacpp.clang.CXSourceRange;
...
public class ClangDiagnosisExample {
	...
	public static void main(String[] args) throws Exception {
		...
		URL resource = ClangDiagnosisExample.class.getResource("sample3.cc");
