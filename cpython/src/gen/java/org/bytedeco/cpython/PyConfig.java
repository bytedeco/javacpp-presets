...
public class PyConfig extends Pointer {
    ...
    public native @Cast("wchar_t*") Pointer dump_refs_file(); public native PyConfig dump_refs_file(Pointer setter);
...
// #endif
    ...
    public native @Cast("wchar_t*") Pointer stdlib_dir(); public native PyConfig stdlib_dir(Pointer setter);
