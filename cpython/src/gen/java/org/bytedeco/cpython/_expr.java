...
public class _expr extends Pointer {
    ...
    public native @Cast("_expr_kind") int kind(); public native _expr kind(int setter);
            ...
            @Name("v.Num.n") public native @Cast("object") PyObject v_Num_n(); public native _expr v_Num_n(PyObject setter);

            @Name("v.Str.s") public native @Cast("string") PyObject v_Str_s(); public native _expr v_Str_s(PyObject setter);
            ...
            @Name("v.Bytes.s") public native @Cast("bytes") PyObject v_Bytes_s(); public native _expr v_Bytes_s(PyObject setter);

            @Name("v.NameConstant.value") public native @Cast("singleton") PyObject v_NameConstant_value(); public native _expr v_NameConstant_value(PyObject setter);
