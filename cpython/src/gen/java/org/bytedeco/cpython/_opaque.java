...
public class _opaque extends Pointer {
    ...
    public native @Cast("const uint8_t*") BytePointer lo_next(); public native _opaque lo_next(BytePointer setter);
    public native @Cast("const uint8_t*") @Name("limit") BytePointer _limit(); public native _opaque _limit(BytePointer setter);
}
