...
public class _excepthandler extends Pointer {
    ...
    public native int end_lineno(); public native _excepthandler end_lineno(int setter);
    public native int end_col_offset(); public native _excepthandler end_col_offset(int setter);
}
