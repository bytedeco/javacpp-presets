...
/* Wrapper for header file /usr/local/include/libfreenect/libfreenect.h */
 ...
 * @return 0 on success, other values on error, platform/library dependant
 */
public static native int freenect_process_events_timeout(freenect_context ctx, @Cast("timeval*") Pointer timeout);
...
/* Wrapper for header file /usr/local/include/libfreenect/libfreenect-registration.h */
...
/* Wrapper for header file /usr/local/include/libfreenect/libfreenect-audio.h */
...
/* Wrapper for header file /usr/local/include/libfreenect/libfreenect_sync.h */
