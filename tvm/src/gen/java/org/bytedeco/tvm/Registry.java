...
public class Registry extends Pointer {
   ...
   */
  public static native @ByRef Registry Register(@Const @ByRef TVMString name, @Cast("bool") boolean override/*=false*/);
  public static native @ByRef Registry Register(@Const @ByRef TVMString name);  // NOLINT(*)
  /**
   * \brief Erase global function from registry, if exist.
   * @param name The name of the function.
   * @return Whether function exist.
   */
  public static native @Cast("bool") boolean Remove(@Const @ByRef TVMString name);
  /**
   ...
   */
  public static native @Const PackedFunc Get(@Const @ByRef TVMString name);  // NOLINT(*)
  /**
   * \brief Get the names of currently registered global function.
   * @return The names
   */
  public static native @StdVector TVMString ListNames();
