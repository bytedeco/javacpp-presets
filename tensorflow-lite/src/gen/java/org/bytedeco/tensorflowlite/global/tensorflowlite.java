...
@Namespace("tflite") public static native @UniquePtr Allocation GetAllocationFromFile(
    ...
    @Cast("bool") boolean allow_modifications/*=false*/);
@Namespace("tflite") public static native @UniquePtr Allocation GetAllocationFromFile(
    @Cast("const char*") BytePointer filename, ErrorReporter error_reporter);
@Namespace("tflite") public static native @UniquePtr Allocation GetAllocationFromFile(
...
@Namespace("tflite") public static native @UniquePtr Allocation GetAllocationFromFile(
    int fd, ErrorReporter error_reporter, @Cast("bool") boolean allow_modifications/*=false*/);
@Namespace("tflite") public static native @UniquePtr Allocation GetAllocationFromFile(
 ...
 * 
 *  If {@code model} is a null pointer, this function has no effect. */
 ...
 * 
 *  If {@code options} is a null pointer, this function has no effect. */
 ...
 * 
 *  If {@code interpreter} is a null pointer, this function has no effect. */
 ...
 * 
 *  If {@code signature_runner} is a null pointer, this function has no effect. */
...
// Targeting ../TfLiteBlockwiseQuantization.java
 ...
 *   * {@code kTfLiteNonCpu}: Tensor buffer is in non-CPU memory, such as AHWB, GPU
...
public static native @ByVal TfLiteTensor TfLiteTensorClone(@ByVal TfLiteTensor src);
 ...
 *  If any dimension is unknown, this is the same as {@code t->dims_signature}.
 *  If all dimensions are known, this is the same as {@code t->dims}.
 *  ({@code dims_signature} is NULL or empty if all dimensions are known.) */

///
///
public static native @Const TfLiteIntArray TfLiteTensorGetDimsSignature(@Const TfLiteTensor t);
...
public static native Pointer TfLiteKernelInitFailed();
...
public static native @ByVal TfLiteQuantization TfLiteQuantizationClone(@Const @ByRef TfLiteQuantization src);
...
@Namespace("tflite") public static native int GetBuiltinDataSize(@Cast("tflite::BuiltinOperator") int op);
