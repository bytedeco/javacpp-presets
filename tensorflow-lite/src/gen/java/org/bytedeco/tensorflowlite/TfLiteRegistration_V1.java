...
public class TfLiteRegistration_V1 extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public TfLiteRegistration_V1() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public TfLiteRegistration_V1(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TfLiteRegistration_V1(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public TfLiteRegistration_V1 position(long position) {
        return (TfLiteRegistration_V1)super.position(position);
    }
    @Override public TfLiteRegistration_V1 getPointer(long i) {
        return new TfLiteRegistration_V1((Pointer)this).offsetAddress(i);
    }
  ...
  public native Init_TfLiteContext_BytePointer_long init(); public native TfLiteRegistration_V1 init(Init_TfLiteContext_BytePointer_long setter);
  ...
  public native @Name("free") Free_TfLiteContext_Pointer _free(); public native TfLiteRegistration_V1 _free(Free_TfLiteContext_Pointer setter);
  ...
  public native Prepare_TfLiteContext_TfLiteNode prepare(); public native TfLiteRegistration_V1 prepare(Prepare_TfLiteContext_TfLiteNode setter);
  ...
  public native Invoke_TfLiteContext_TfLiteNode invoke(); public native TfLiteRegistration_V1 invoke(Invoke_TfLiteContext_TfLiteNode setter);
  ...
  public native Profiling_string_TfLiteContext_TfLiteNode profiling_string(); public native TfLiteRegistration_V1 profiling_string(Profiling_string_TfLiteContext_TfLiteNode setter);
  public native int builtin_code(); public native TfLiteRegistration_V1 builtin_code(int setter);
  public native @Cast("const char*") BytePointer custom_name(); public native TfLiteRegistration_V1 custom_name(BytePointer setter);
  public native int version(); public native TfLiteRegistration_V1 version(int setter);
}
