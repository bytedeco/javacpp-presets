...
// #ifndef DOXYGEN_
  ...
  public native @Cast("TfLiteStatus") int SetExecutionPlan(@StdVector IntPointer new_plan);
  public native @Cast("TfLiteStatus") int SetExecutionPlan(@StdVector IntBuffer new_plan);
  public native @Cast("TfLiteStatus") int SetExecutionPlan(@StdVector int[] new_plan);
// #endif  // DOXYGEN_SKIP
...
// #ifndef DOXYGEN_SKIP
  /** Adds {@code subgraphs_to_add} subgraphs, preserving pre-existing Subgraph
   *  entries. The value pointed to by {@code first_new_subgraph_index} will be set to
   *  the index of the first new subgraph if {@code first_new_subgraph_index} is
   *  non-null.
   *  WARNING: This is an experimental API and subject to change. */
  public native void AddSubgraphs(int subgraphs_to_add,
                      IntPointer first_new_subgraph_index/*=nullptr*/);
  public native void AddSubgraphs(int subgraphs_to_add);
  public native void AddSubgraphs(int subgraphs_to_add,
                      IntBuffer first_new_subgraph_index/*=nullptr*/);
  public native void AddSubgraphs(int subgraphs_to_add,
