...
// #endif  // DOXYGEN_SKIP
   ...
   *  If you need {@code SignatureRunner} without applying default delegates,
   *  use {@code BuiltinOpResolverWithoutDefaultDelegates}. */
   ...
   *  Services) invalidate any pointers to {@code TfLiteTensor} objects previously
   *  obtained with this Interpreter, as well as the underlying tensor data.
   *  This includes e.g. {@code input_tensor}, {@code output_tensor} and {@code tensor} methods,
   *  as well as e.g. {@code typed_input_tensor}, {@code typed_output_tensor}, and
   *  {@code typed_tensor} methods. */
   ...
   *  This will not affect {@code Invoke}s that happen after the cancellation.
   ...
   *  {@code prepare} and {@code invoke} function. In those functions, it's guaranteed
