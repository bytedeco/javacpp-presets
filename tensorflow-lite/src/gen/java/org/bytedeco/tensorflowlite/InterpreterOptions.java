...
public class InterpreterOptions extends Pointer {
  ...
  //
  // WARNING: This is an experimental API and subject to change.
  public native void SetShloCompositeInlining(@Cast("bool") boolean value);

  // If `true`, the interpreter will try to inline StableHLO Composite
  // operations that haven't been picked up by a delegate.
  //
  // WARNING: This is an experimental API and subject to change.
  public native @Cast("bool") boolean GetShloCompositeInlining();

  // Controls to update Tensor names with Signature input & output names.
  //
  // WARNING: This is an experimental API and subject to change.
  public native void SetUseSignatureTensorNames(@Cast("bool") boolean value);

  // If `true`, the interpreter will use the tensor names from the Signature
  // inputs and outputs.
  //
  // WARNING: This is an experimental API and subject to change.
  public native @Cast("bool") boolean GetUseSignatureTensorNames();
  ...
  //
  // WARNING: This is an experimental API and subject to change.
  public native void SetCompressQuantizationZeroPoints(@Cast("bool") boolean value);

  // Returns whether quantization zero-points compression is enabled.
  //
  // WARNING: This is an experimental API and subject to change.
  public native @Cast("bool") boolean GetCompressQuantizationZeroPoints();
}
