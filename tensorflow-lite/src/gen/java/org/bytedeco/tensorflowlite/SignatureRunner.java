...
public class SignatureRunner extends Pointer {
   ...
   *  subgraph. */
  public native @Cast("const char**") @StdVector PointerPointer subgraph_input_names();

  /** Read-only access to list of signature output names in the order of
   *  subgraph. */
  
  ///
  public native @Cast("const char**") @StdVector PointerPointer subgraph_output_names();
