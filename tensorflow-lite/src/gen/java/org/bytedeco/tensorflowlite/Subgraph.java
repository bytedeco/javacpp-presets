...
// #endif  // DOXYGEN_SKIP
  ...
  public native @Cast("TfLiteStatus") int SetTensorParametersReadOnly(
        ...
        @Cast("size_t") long external_buffer_id/*=kTfLiteNoBufferIdentifier*/);
  public native @Cast("TfLiteStatus") int SetTensorParametersReadOnly(
        int tensor_index, @Cast("TfLiteType") int type, @Cast("const char*") BytePointer name,
        @StdVector IntPointer dims, @ByVal TfLiteQuantization quantization,
  ...
  public native @Cast("TfLiteStatus") int SetTensorParametersReadWrite(
        ...
        @Cast("size_t") long external_buffer_id/*=0*/);
  public native @Cast("TfLiteStatus") int SetTensorParametersReadWrite(
        int tensor_index, @Cast("TfLiteType") int type, @Cast("const char*") BytePointer name,
        @StdVector IntPointer dims, @ByVal TfLiteQuantization quantization);
  public native @Cast("TfLiteStatus") int SetTensorParametersReadWrite(
  ...
  public native @Cast("TfLiteStatus") int SetTensorParametersReadWrite(
        ...
        @Const IntPointer dims_signature/*=nullptr*/, @Cast("size_t") long external_buffer_id/*=0*/);
  public native @Cast("TfLiteStatus") int SetTensorParametersReadWrite(
        int tensor_index, @Cast("TfLiteType") int type, @Cast("const char*") BytePointer name, @Cast("size_t") long ndims,
        @Const IntPointer dims, @ByVal TfLiteQuantization quantization);
  public native @Cast("TfLiteStatus") int SetTensorParametersReadWrite(
        ...
        @Cast("bool") boolean is_variable/*=false*/, @Cast("size_t") long ndims_signature/*=0*/,
        @Const IntBuffer dims_signature/*=nullptr*/, @Cast("size_t") long external_buffer_id/*=0*/);
  public native @Cast("TfLiteStatus") int SetTensorParametersReadWrite(
        int tensor_index, @Cast("TfLiteType") int type, String name, @Cast("size_t") long ndims,
        @Const IntBuffer dims, @ByVal TfLiteQuantization quantization);
  public native @Cast("TfLiteStatus") int SetTensorParametersReadWrite(
        ...
        @Cast("bool") boolean is_variable/*=false*/, @Cast("size_t") long ndims_signature/*=0*/,
        @Const int[] dims_signature/*=nullptr*/, @Cast("size_t") long external_buffer_id/*=0*/);
  public native @Cast("TfLiteStatus") int SetTensorParametersReadWrite(
        int tensor_index, @Cast("TfLiteType") int type, @Cast("const char*") BytePointer name, @Cast("size_t") long ndims,
        @Const int[] dims, @ByVal TfLiteQuantization quantization);
  public native @Cast("TfLiteStatus") int SetTensorParametersReadWrite(
  ...
  public native void SetTensorExternalBufferId(@Cast("size_t") long tensor_index,
                                   @Cast("size_t") long external_buffer_id);
  ...
  public native @Cast("tflite::resource::ResourceMap*") IntResourceBaseMap resources_ptr();
  ...
  public native @Const @ByRef SizeTSizeTMap GetExternalTensorBufferIdentifiers();
  ...
  public native @Cast("TfLiteStatus") int ReplaceNodeWithSubgraph(int execution_index,
                                         @Const @ByRef TfLiteNode node,
                                         int subgraph_index,
                                         @ByRef IntPointer last_inserted_execution_index);
  public native @Cast("TfLiteStatus") int ReplaceNodeWithSubgraph(int execution_index,
                                         @Const @ByRef TfLiteNode node,
                                         int subgraph_index,
                                         @ByRef IntBuffer last_inserted_execution_index);
  public native @Cast("TfLiteStatus") int ReplaceNodeWithSubgraph(int execution_index,
                                         @Const @ByRef TfLiteNode node,
                                         int subgraph_index,
                                         @ByRef int[] last_inserted_execution_index);

  // Inlines the composite nodes that have not been taken by a delegate.
  public native @Cast("TfLiteStatus") int InlineCompositeNodes();
}
