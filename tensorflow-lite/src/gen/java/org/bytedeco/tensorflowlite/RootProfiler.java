...
public class RootProfiler extends Profiler {
   ...
   *  different interpretations based on the actual Profiler instance
   *  and the {@code event_type}. */
  public native void AddEvent(@Cast("const char*") BytePointer tag, @Cast("tflite::profiling::RootProfiler::EventType") int event_type, @Cast("uint64_t") long elapsed_time,
                  @Cast("int64_t") long event_metadata1, @Cast("int64_t") long event_metadata2);
  public native void AddEvent(String tag, @Cast("tflite::profiling::RootProfiler::EventType") int event_type, @Cast("uint64_t") long elapsed_time,
                  @Cast("int64_t") long event_metadata1, @Cast("int64_t") long event_metadata2);
