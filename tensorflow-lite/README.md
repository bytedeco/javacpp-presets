 ...
 * TensorFlow Lite 2.15.0  https://www.tensorflow.org/lite
 ...
 * https://github.com/tensorflow/tensorflow/blob/v2.15.0/tensorflow/lite/examples/minimal/minimal.cc
...
<project>
    ...
    <dependencies>
        <dependency>
            ...
            <version>2.15.0-1.5.10-SNAPSHOT</version>
        </dependency>
    </dependencies>
    <build>
