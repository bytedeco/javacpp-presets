 ...
 * TensorFlow Lite 2.11.0  https://www.tensorflow.org/lite
 ...
 * https://github.com/tensorflow/tensorflow/blob/v2.11.0/tensorflow/lite/examples/minimal/minimal.cc
...
<project>
    ...
    <dependencies>
        <dependency>
            ...
            <version>2.11.0-1.5.9-SNAPSHOT</version>
        </dependency>
    </dependencies>
    <build>
