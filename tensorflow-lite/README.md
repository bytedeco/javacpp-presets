 ...
 * TensorFlow Lite 2.20.0  https://www.tensorflow.org/lite
 ...
 * https://github.com/tensorflow/tensorflow/blob/v2.20.0/tensorflow/lite/examples/minimal/minimal.cc
...
<project>
    ...
    <dependencies>
        <dependency>
            ...
            <version>2.20.0-1.5.13-SNAPSHOT</version>
        </dependency>
    </dependencies>
    <build>
