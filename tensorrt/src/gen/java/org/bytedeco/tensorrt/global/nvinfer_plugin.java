...
// Targeting ../nvinfer_plugin/INvPlugin.java
 ...
 // end nvinfer1 namespace
     ...
     *  spatial locations (within channel in which case acrossSpatial is false). @param channelShared Whether the scale
     *  weight(s) is shared across channels. @param eps Epsilon for not diviiding by zero.
     *  */
    ...
    /**
     *  \brief The LReLu plugin layer performs leaky ReLU for 4D tensors.
     * 
     *  Give an input value x, the PReLU layer computes the output as x if x > 0 and negative_slope x if x <= 0.
     * 
     *  Registered plugin type "LReLU_TRT". Registered plugin version "1".
     * 
     *  @param negSlope Negative_slope value.
     * 
     *  @deprecated Superseded by INetworkDefinition::addActivation and will be removed in TensorRT 8.0.
     *  */
     ...
     *  (stridexstride) x 1 x 1 shape. Registered plugin type "Reorg_TRT". Registered plugin version "1". @param stride
    ...
    /**
     *  \brief The Clip Plugin performs a clip operation on the input tensor.
     * 
     *  It clips the tensor values to a specified min and max. Any value less than clipMin are set to clipMin. Any
     *  values greater than clipMax are set to clipMax. For example, this plugin can be used to perform a Relu6
     *  operation by specifying clipMin=0.0 and clipMax=6.0.
     * 
