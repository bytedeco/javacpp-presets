...
public static final int TRT_MINOR_ENTERPRISE = 3;
public static final int TRT_PATCH_ENTERPRISE = 0;
public static final int TRT_BUILD_ENTERPRISE = 99;
 ...
 *  */
@Namespace("nvinfer1") public enum DLAWorkspaceAllocationStrategy {
...
//!
    ...
    public final int value;
    private DLAWorkspaceAllocationStrategy(int v) { this.value = v; }
    private DLAWorkspaceAllocationStrategy(DLAWorkspaceAllocationStrategy e) { this.value = e.value; }
    public DLAWorkspaceAllocationStrategy intern() { for (DLAWorkspaceAllocationStrategy e : values()) if (e.value == value) return e; return this; }
    @Override public String toString() { return intern().name(); }
}
 ...
 *  */
@Namespace("nvinfer1") public enum CollectiveOperation {
    /** All reduce. */
    kALL_REDUCE(0),
    /** All gather. */
    kALL_GATHER(1),
    ...
    private CollectiveOperation(CollectiveOperation e) { this.value = e.value; }
    public CollectiveOperation intern() { for (CollectiveOperation e : values()) if (e.value == value) return e; return this; }
    @Override public String toString() { return intern().name(); }
}
 ...
 *  */
@Namespace("nvinfer1") public enum MoEActType {
    kNONE(0),
    kSILU(1);

    public final int value;
    private MoEActType(int v) { this.value = v; }
    private MoEActType(MoEActType e) { this.value = e.value; }
    public MoEActType intern() { for (MoEActType e : values()) if (e.value == value) return e; return this; }
    @Override public String toString() { return intern().name(); }
}
 ...
 *  */
@Namespace("nvinfer1") public static native @Cast("bool") @NoException(true) boolean setInternalLibraryPath(String path);
@Namespace("nvinfer1") public static native @Cast("bool") @NoException(true) boolean setInternalLibraryPath(@Cast("const char*") BytePointer path);
...
// Targeting ../nvinfer/IPluginLayer.java
 ...
 // namespace v_1_0
 // namespace v_1_0
// Targeting ../nvinfer/ISafeSerializedNetworkArtifacts.java
...
;
/** enum class nvinfer1::MoEActType */
;
...
;
/** enum class nvinfer1::CollectiveOperation */
;
...
/** enum class nvinfer1::DLAWorkspaceAllocationStrategy */
;
...
// Targeting ../nvinfer/VMoELayer.java
...
// Targeting ../nvinfer/VDistCollectiveLayer.java
