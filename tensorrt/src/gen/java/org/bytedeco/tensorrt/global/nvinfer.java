...
public static final int NV_TENSORRT_MAJOR = 6;
...
public static final int NV_TENSORRT_BUILD = 5;

/** Shared object library major version number. */
public static final int NV_TENSORRT_SONAME_MAJOR = 6;
...
@Namespace("nvinfer1") public enum TensorFormat {
    ...
    kLINEAR(0),
    kNCHW(kLINEAR), /** <-- Deprecated, used for backward compatibility
     <p>
    ...
    kCHW2(1),
    kNC2HW2(kCHW2), /** <-- Deprecated, used for backward compatibility
     <p>
    ...
    kHWC8(2),
    kNHWC8(kHWC8), /** <-- Deprecated, used for backward compatibility
     <p>
