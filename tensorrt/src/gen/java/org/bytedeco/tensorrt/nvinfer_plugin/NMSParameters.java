...
public class NMSParameters extends Pointer {
    ...
    public native @Cast("bool") boolean shareLocation(); public native NMSParameters shareLocation(boolean shareLocation);
    public native int backgroundLabelId(); public native NMSParameters backgroundLabelId(int backgroundLabelId);
    public native int numClasses(); public native NMSParameters numClasses(int numClasses);
    public native int topK(); public native NMSParameters topK(int topK);
    public native int keepTopK(); public native NMSParameters keepTopK(int keepTopK);
    public native float scoreThreshold(); public native NMSParameters scoreThreshold(float scoreThreshold);
    public native float iouThreshold(); public native NMSParameters iouThreshold(float iouThreshold);
    public native @Cast("bool") boolean isNormalized(); public native NMSParameters isNormalized(boolean isNormalized);
}
