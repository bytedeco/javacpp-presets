...
public class IInt8LegacyCalibrator extends IInt8Calibrator {
    ...
    //!
    //!
    public native @NoException(true) CalibrationAlgoType getAlgorithm();
    ...
    //!
    //!
    public native @NoException(true) double getQuantile();
    ...
    //!
    //!
    public native @NoException(true) double getRegressionCutoff();
    ...
    //!
    //!
    public native @Const @NoException(true) Pointer readHistogramCache(@Cast("std::size_t*") @ByRef LongPointer length);
    public native @Const @NoException(true) Pointer readHistogramCache(@Cast("std::size_t*") @ByRef LongBuffer length);
    public native @Const @NoException(true) Pointer readHistogramCache(@Cast("std::size_t*") @ByRef long[] length);
     ...
     *  */
    public native @NoException(true) void writeHistogramCache(@Const Pointer ptr, @Cast("std::size_t") long length);
}
