...
public class IIfConditionalBoundaryLayer extends ILayer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public IIfConditionalBoundaryLayer(Pointer p) { super(p); }

    /**
     *  \brief Get a pointer to the IIfConditional associated with this boundary layer.
     *  */
    public native @NoException(true) IIfConditional getConditional();
}
