...
public class INetworkDefinition extends INoCopy {
    ...
    //!
    //!
    public native @NoException(true) IMoELayer addMoE(@ByRef ITensor hiddenStates, @ByRef ITensor selectedExpertsForTokens, @ByRef ITensor scoresForSelectedExperts);
    ...
    //!
    //!
    public native @NoException(true) IDistCollectiveLayer addDistCollective(@ByRef ITensor input, CollectiveOperation distCollectiveOp,
            ReduceOperation reduceOp, @Cast("int64_t") long root, @Cast("int64_t*") LongPointer groups, @Cast("int64_t") long groupSize);
    public native @NoException(true) IDistCollectiveLayer addDistCollective(@ByRef ITensor input, @Cast("nvinfer1::CollectiveOperation") int distCollectiveOp,
            @Cast("nvinfer1::ReduceOperation") int reduceOp, @Cast("int64_t") long root, @Cast("int64_t*") LongBuffer groups, @Cast("int64_t") long groupSize);
    public native @NoException(true) IDistCollectiveLayer addDistCollective(@ByRef ITensor input, CollectiveOperation distCollectiveOp,
            ReduceOperation reduceOp, @Cast("int64_t") long root, @Cast("int64_t*") long[] groups, @Cast("int64_t") long groupSize);
    public native @NoException(true) IDistCollectiveLayer addDistCollective(@ByRef ITensor input, @Cast("nvinfer1::CollectiveOperation") int distCollectiveOp,
            @Cast("nvinfer1::ReduceOperation") int reduceOp, @Cast("int64_t") long root, @Cast("int64_t*") LongPointer groups, @Cast("int64_t") long groupSize);
    public native @NoException(true) IDistCollectiveLayer addDistCollective(@ByRef ITensor input, CollectiveOperation distCollectiveOp,
