...
public class IRuntime extends INoCopy {
    ...
    //!
    //!
    public native @Cast("bool") @NoException(true) boolean setDLAWorkspaceAllocationStrategy(DLAWorkspaceAllocationStrategy strategy);
    public native @Cast("bool") @NoException(true) boolean setDLAWorkspaceAllocationStrategy(@Cast("nvinfer1::DLAWorkspaceAllocationStrategy") int strategy);
    ...
    //!
    //!
    public native @NoException(true) DLAWorkspaceAllocationStrategy getDLAWorkspaceAllocationStrategy();
    ...
    //!
    //!
    public native ICudaEngine deserializeCudaEngine(@ByRef IStreamReaderV2 streamReader);
