...
public class IPluginV2Ext extends IPluginV2 {
    ...
    public native void configurePlugin(@Const Dims inputDims, int nbInputs, @Const Dims outputDims,
                                     ...
                                     @Cast("const bool*") BoolPointer inputIsBroadcast, @Cast("const bool*") BoolPointer outputIsBroadcast, PluginFormat floatFormat, int maxBatchSize);
    public native void configurePlugin(@Const Dims inputDims, int nbInputs, @Const Dims outputDims,
                                     int nbOutputs, @Cast("nvinfer1::DataType*") IntBuffer inputTypes, @Cast("nvinfer1::DataType*") IntBuffer outputTypes,
                                     @Cast("const bool*") boolean[] inputIsBroadcast, @Cast("const bool*") boolean[] outputIsBroadcast, @Cast("nvinfer1::PluginFormat") byte floatFormat, int maxBatchSize);
    public native void configurePlugin(@Const Dims inputDims, int nbInputs, @Const Dims outputDims,
