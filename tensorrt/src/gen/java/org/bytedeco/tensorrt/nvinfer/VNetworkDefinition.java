...
public class VNetworkDefinition extends VRoot {
    ...
    public native @NoException(true) INormalizationLayer addNormalizationV2(
            @ByRef ITensor input, @ByRef ITensor scale, @ByRef ITensor bias, @Cast("uint32_t") int axesMask);
    public native @NoException(true) IMoELayer addMoE(
            @ByRef ITensor hiddenStates, @ByRef ITensor selectedExpertsForTokens, @ByRef ITensor scoresForSelectedExperts);
