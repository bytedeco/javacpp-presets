...
public class IBuilderConfig extends Pointer {
    ...
    //!
    //!
    public native @Cast("bool") boolean setTacticSources(@Cast("nvinfer1::TacticSources") int tacticSources);
     ...
     *  */
    public native @Cast("nvinfer1::TacticSources") int getTacticSources();
}
