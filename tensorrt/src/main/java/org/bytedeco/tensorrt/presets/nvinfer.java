...
@Properties(
    ...
    value = {
        @Platform(
            ...
            link = "nvinfer@.10",
            preload = "nvinfer_builder_resource@.10.10.0"
        ),
        @Platform(
            value = "linux-arm64",
...
public class nvinfer implements LoadEnabled, InfoMapper {
    ...
    public void map(InfoMap infoMap) {
        infoMap.put(new Info().enumerate())
               .put(new Info("NV_TENSORRT_FINAL", "_TENSORRT_FINAL", "_TENSORRT_OVERRIDE", "TENSORRTAPI", "TRT_DEPRECATED_ENUM").cppTypes().annotations())
