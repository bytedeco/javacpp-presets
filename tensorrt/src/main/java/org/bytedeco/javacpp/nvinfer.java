...
// #define NV_TENSORRT_FINAL final
// #else
// #define NV_TENSORRT_FINAL
// #endif
...
@Namespace("nvinfer1") public static class ITensor extends Pointer {
    ...
    */
     ...
     *
     * Not currently supported. Will be used for RNNv2 layer to allow keeping
     * sequence lengths on host in input.
     *
...
@Namespace("nvinfer1") public static class ISoftMaxLayer extends ILayer {
    ...
    /**
     * \brief set the axes along which softmax occurs.
     *
     * This is a bitmap of axes over which to reduce. Bit 0 is the major axis (excluding the batch dimension)
     *
     * Currently only one axis is supported. The default axis is the number of non-batch axes in the tensor minus three (e.g.
     * for an NCHW input it would be 0, and the value of axes would be 1<<0), or 0 if there are fewer than 3 non-batch axes.
     *
     * @param axes the axes along which concatenation occurs
     */
    public native void setAxes(@Cast("uint32_t") int axes);

    /**
     * \brief get the axes along which softmax occurs.
     *
     * @see setAxes
     *
     */
...
@Namespace("nvinfer1") public static class IShuffleLayer extends ILayer {
    ...
    * Positive integers can also be used to specify dimension sizes.
    *
...
@Namespace("nvinfer1") public static class INetworkDefinition extends Pointer {
    ...
    */
     ...
     * the second contains index positions for the values.
     *
     * @param input the input tensor to the layer
     *
