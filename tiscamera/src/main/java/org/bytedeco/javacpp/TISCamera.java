...
@Name("std::vector<tcam::MemoryBuffer*>") public static class MemoryBufferVector extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public MemoryBufferVector(Pointer p) { super(p); }
    public MemoryBufferVector(MemoryBuffer value) { this(1); put(0, value); }
    public MemoryBufferVector(MemoryBuffer ... array) { this(array.length); put(array); }
    public MemoryBufferVector()       { allocate();  }
    public MemoryBufferVector(long n) { allocate(n); }
    private native void allocate();
    private native void allocate(@Cast("size_t") long n);
    public native @Name("operator=") @ByRef MemoryBufferVector put(@ByRef MemoryBufferVector x);
    ...
    @Index public native MemoryBuffer get(@Cast("size_t") long i);
    public native MemoryBufferVector put(@Cast("size_t") long i, MemoryBuffer value);
    ...
    @NoOffset @Name("iterator") public static class Iterator extends Pointer {
        ...
        public native @Name("operator++") @ByRef Iterator increment();
        public native @Name("operator==") boolean equals(@ByRef Iterator it);
        public native @Name("operator*") MemoryBuffer get();
    }
    ...
    public MemoryBufferVector push_back(MemoryBuffer value) {
        long size = size();
        resize(size + 1);
        return put(size, value);
    }
    public MemoryBufferVector put(MemoryBuffer value) {
        if (size() != 1) { resize(1); }
        return put(0, value);
    }
    public MemoryBufferVector put(MemoryBuffer ... array) {
        if (size() != array.length) { resize(array.length); }
        for (int i = 0; i < array.length; i++) {
            put(i, array[i]);
        }
...
@Namespace("tcam") public static class SinkInterface extends Pointer {
    ...
    public native void push_image(@SharedPtr MemoryBuffer arg0);

    public native void requeue_buffer(@SharedPtr MemoryBuffer arg0);
...
@Namespace("tcam") @NoOffset public static class DeviceInterface extends PropertyImpl {
     ...
     */
    public native @Cast("bool") boolean initialize_buffers_ptr(@ByVal MemoryBufferVector arg0);
