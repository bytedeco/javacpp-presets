// Targeted by JavaCPP version 1.2.3: DO NOT EDIT THIS FILE
...
@Namespace("tensorflow") public static class FileStatistics extends Pointer {
    static { Loader.load(); }
...
@Opaque public static class TF_NodeDescription extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public TF_NodeDescription() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TF_NodeDescription(Pointer p) { super(p); }
}
...
@Opaque public static class TF_Node extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public TF_Node() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TF_Node(Pointer p) { super(p); }
}
...
public static class TF_Port extends Pointer {
  ...
  public native TF_Node node(); public native TF_Port node(TF_Node node);
  public native int index(); public native TF_Port index(int index);  // Specifies the index of the input or output within node.
}
...
public static native TF_NodeDescription TF_NewNode(TF_Graph graph, @Cast("const char*") BytePointer op_type,
                                      @Cast("const char*") BytePointer node_name);
public static native TF_NodeDescription TF_NewNode(TF_Graph graph, String op_type,
                                      String node_name);

// Specify the device for `desc`.  Defaults to empty, meaning unconstrained.
public static native void TF_SetDevice(TF_NodeDescription desc, @Cast("const char*") BytePointer device);
public static native void TF_SetDevice(TF_NodeDescription desc, String device);
...
public static native void TF_AddInput(TF_NodeDescription desc, @ByVal TF_Port input);

// For inputs that take a list of tensors.
// inputs must point to TF_Port[num_inputs].
public static native void TF_AddInputList(TF_NodeDescription desc, @Const TF_Port inputs,
                            int num_inputs);

// Call once per control input to `desc`.
public static native void TF_AddControlInput(TF_NodeDescription desc, TF_Node input);
...
public static native void TF_SetAttrString(TF_NodeDescription desc, @Cast("const char*") BytePointer attr_name,
                             @Const Pointer value, int length);
public static native void TF_SetAttrString(TF_NodeDescription desc, String attr_name,
                             @Const Pointer value, int length);
// `values` and `lengths` both must have lengths `num_values`.
// `values[i]` must point to a string of length `lengths[i]` bytes.
public static native void TF_SetAttrStringList(TF_NodeDescription desc,
...
public static native void TF_SetAttrStringList(TF_NodeDescription desc,
                                 ...
                                 @Cast("const void*const*") @ByPtrPtr Pointer values, @Const int[] lengths,
                                 int num_values);
public static native void TF_SetAttrInt(TF_NodeDescription desc, @Cast("const char*") BytePointer attr_name,
                          @Cast("int64_t") long value);
public static native void TF_SetAttrInt(TF_NodeDescription desc, String attr_name,
                          @Cast("int64_t") long value);
public static native void TF_SetAttrIntList(TF_NodeDescription desc, @Cast("const char*") BytePointer attr_name,
                              @Cast("const int64_t*") LongPointer values, int num_values);
public static native void TF_SetAttrIntList(TF_NodeDescription desc, String attr_name,
                              @Cast("const int64_t*") LongBuffer values, int num_values);
public static native void TF_SetAttrIntList(TF_NodeDescription desc, @Cast("const char*") BytePointer attr_name,
                              @Cast("const int64_t*") long[] values, int num_values);
public static native void TF_SetAttrIntList(TF_NodeDescription desc, String attr_name,
                              @Cast("const int64_t*") LongPointer values, int num_values);
public static native void TF_SetAttrIntList(TF_NodeDescription desc, @Cast("const char*") BytePointer attr_name,
                              @Cast("const int64_t*") LongBuffer values, int num_values);
public static native void TF_SetAttrIntList(TF_NodeDescription desc, String attr_name,
                              @Cast("const int64_t*") long[] values, int num_values);
public static native void TF_SetAttrFloat(TF_NodeDescription desc, @Cast("const char*") BytePointer attr_name,
                            float value);
public static native void TF_SetAttrFloat(TF_NodeDescription desc, String attr_name,
                            float value);
public static native void TF_SetAttrFloatList(TF_NodeDescription desc, @Cast("const char*") BytePointer attr_name,
                                @Const FloatPointer values, int num_values);
public static native void TF_SetAttrFloatList(TF_NodeDescription desc, String attr_name,
                                @Const FloatBuffer values, int num_values);
public static native void TF_SetAttrFloatList(TF_NodeDescription desc, @Cast("const char*") BytePointer attr_name,
...
public static native void TF_SetAttrFloatList(TF_NodeDescription desc, String attr_name,
                                @Const float[] values, int num_values);
public static native void TF_SetAttrBool(TF_NodeDescription desc, @Cast("const char*") BytePointer attr_name,
                           @Cast("unsigned char") byte value);
public static native void TF_SetAttrBool(TF_NodeDescription desc, String attr_name,
                           @Cast("unsigned char") byte value);
public static native void TF_SetAttrBoolList(TF_NodeDescription desc, @Cast("const char*") BytePointer attr_name,
                               @Cast("const unsigned char*") BytePointer values, int num_values);
public static native void TF_SetAttrBoolList(TF_NodeDescription desc, String attr_name,
...
public static native void TF_SetAttrBoolList(TF_NodeDescription desc, String attr_name,
                               @Cast("const unsigned char*") byte[] values, int num_values);
public static native void TF_SetAttrType(TF_NodeDescription desc, @Cast("const char*") BytePointer attr_name,
                           @Cast("TF_DataType") int value);
public static native void TF_SetAttrType(TF_NodeDescription desc, String attr_name,
                           @Cast("TF_DataType") int value);
public static native void TF_SetAttrTypeList(TF_NodeDescription desc, @Cast("const char*") BytePointer attr_name,
                               @Cast("const TF_DataType*") IntPointer values, int num_values);
public static native void TF_SetAttrTypeList(TF_NodeDescription desc, String attr_name,
                               @Cast("const TF_DataType*") IntBuffer values, int num_values);
public static native void TF_SetAttrTypeList(TF_NodeDescription desc, @Cast("const char*") BytePointer attr_name,
                               @Cast("const TF_DataType*") int[] values, int num_values);
public static native void TF_SetAttrTypeList(TF_NodeDescription desc, String attr_name,
                               @Cast("const TF_DataType*") IntPointer values, int num_values);
public static native void TF_SetAttrTypeList(TF_NodeDescription desc, @Cast("const char*") BytePointer attr_name,
                               @Cast("const TF_DataType*") IntBuffer values, int num_values);
...
public static native void TF_SetAttrShape(TF_NodeDescription desc, @Cast("const char*") BytePointer attr_name,
                            @Cast("const int64_t*") LongPointer dims, int num_dims);
public static native void TF_SetAttrShape(TF_NodeDescription desc, String attr_name,
...
public static native void TF_SetAttrShapeList(TF_NodeDescription desc, @Cast("const char*") BytePointer attr_name,
...
public static native void TF_SetAttrShapeList(TF_NodeDescription desc, @Cast("const char*") BytePointer attr_name,
                                ...
                                int num_shapes);
public static native void TF_SetAttrShapeList(TF_NodeDescription desc, String attr_name,
...
public static native void TF_SetAttrTensorShapeProto(TF_NodeDescription desc,
...
public static native void TF_SetAttrTensorShapeProtoList(TF_NodeDescription desc,
                                           @Cast("const char*") BytePointer attr_name,
...
public static native void TF_SetAttrTensor(TF_NodeDescription desc, @Cast("const char*") BytePointer attr_name,
                             TF_Tensor value, TF_Status status);
public static native void TF_SetAttrTensor(TF_NodeDescription desc, String attr_name,
                             TF_Tensor value, TF_Status status);
...
public static native void TF_SetAttrTensorList(TF_NodeDescription desc,
                                 @Cast("const char*") BytePointer attr_name,
...
// buffer.
public static native void TF_SetAttrToAttrValueProto(TF_NodeDescription desc,
...
public static native TF_Node TF_FinishNode(TF_NodeDescription desc, TF_Status status);

// TF_Node functions.  Nodes are immutable once created, so these are all
// query functions.

public static native @Cast("const char*") BytePointer TF_NodeName(TF_Node node);
public static native @Cast("const char*") BytePointer TF_NodeOpType(TF_Node node);
public static native @Cast("const char*") BytePointer TF_NodeDevice(TF_Node node);

public static native int TF_NodeNumOutputs(TF_Node node);
public static native @Cast("TF_DataType") int TF_NodeOutputType(@ByVal TF_Port node_out);
public static native int TF_NodeOutputListLength(TF_Node node, @Cast("const char*") BytePointer arg_name,
                                   TF_Status status);
public static native int TF_NodeOutputListLength(TF_Node node, String arg_name,
                                   TF_Status status);

public static native int TF_NodeNumInputs(TF_Node node);
public static native @Cast("TF_DataType") int TF_NodeInputType(@ByVal TF_Port node_in);
public static native int TF_NodeInputListLength(TF_Node node, @Cast("const char*") BytePointer arg_name,
                                  TF_Status status);
public static native int TF_NodeInputListLength(TF_Node node, String arg_name,
                                  TF_Status status);
...
public static native @ByVal TF_Port TF_NodeInput(@ByVal TF_Port node_in);
...
public static native int TF_NodeOutputNumConsumers(@ByVal TF_Port node_out);
...
public static native int TF_NodeOutputConsumers(@ByVal TF_Port node_out, TF_Port consumers,
                                  int max_consumers);

// Get the number of control inputs to a node.
public static native int TF_NodeNumControlInputs(TF_Node node);
...
public static native int TF_NodeGetControlInputs(TF_Node node, @Cast("TF_Node**") PointerPointer control_inputs,
                                   int max_control_inputs);
public static native int TF_NodeGetControlInputs(TF_Node node, @ByPtrPtr TF_Node control_inputs,
                                   int max_control_inputs);
...
// graph.
public static native int TF_NodeNumControlOutputs(TF_Node node);
...
public static native int TF_NodeGetControlOutputs(TF_Node node, @Cast("TF_Node**") PointerPointer control_outputs,
                                    int max_control_outputs);
public static native int TF_NodeGetControlOutputs(TF_Node node, @ByPtrPtr TF_Node control_outputs,
                                    int max_control_outputs);

// Sets `output_attr_value` to the binary-serialized AttrValue proto
// representation of the value of the `attr_name` attr of `node`.
public static native void TF_NodeGetAttrValueProto(TF_Node node, @Cast("const char*") BytePointer attr_name,
                                     TF_Buffer output_attr_value,
                                     TF_Status status);
public static native void TF_NodeGetAttrValueProto(TF_Node node, String attr_name,
                                     TF_Buffer output_attr_value,
                                     TF_Status status);

// Returns the node in the graph with `node_name`. Returns nullptr if
// no node found.
public static native TF_Node TF_GraphNodeByName(TF_Graph graph, @Cast("const char*") BytePointer node_name);
public static native TF_Node TF_GraphNodeByName(TF_Graph graph, String node_name);
...
// }
public static native TF_Node TF_GraphNextNode(TF_Graph graph, @Cast("size_t*") SizeTPointer pos);
...
public static native void TF_NodeToNodeDef(TF_Node node, TF_Buffer output_node_def,
                             TF_Status status);
...
public static native void TF_SessionRun(TF_SessionWithGraph session,
                          ...
                          int noutputs,
                          @Cast("const TF_Node*const*") PointerPointer target_nodes, int ntargets,
...
public static native void TF_SessionRun(TF_SessionWithGraph session,
                          ...
                          int noutputs,
                          @Const @ByPtrPtr TF_Node target_nodes, int ntargets,
                          TF_Buffer run_metadata,
                          TF_Status arg11);
...
public static native void TF_SessionPRunSetup(TF_SessionWithGraph arg0,
                                ...
                                @Cast("const TF_Node*const*") PointerPointer target_nodes,
                                int ntargets,
...
public static native void TF_SessionPRunSetup(TF_SessionWithGraph arg0,
                                @Const TF_Port inputs, int ninputs,
                                @Const TF_Port outputs, int noutputs,
                                @Const @ByPtrPtr TF_Node target_nodes,
                                int ntargets,
