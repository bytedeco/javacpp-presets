...
public class UnsortedSegmentProd extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native UnsortedSegmentProd operation(Operation setter);
  public native @ByRef Output output(); public native UnsortedSegmentProd output(Output setter);
}
