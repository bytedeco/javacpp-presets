...
public class OrderedMapUnstage extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native OrderedMapUnstage operation(Operation setter);
  public native @ByRef @Cast("tensorflow::OutputList*") OutputVector values(); public native OrderedMapUnstage values(OutputVector setter);
}
