...
public class NonMaxSuppressionV2 extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native NonMaxSuppressionV2 operation(Operation setter);
  public native @ByRef Output selected_indices(); public native NonMaxSuppressionV2 selected_indices(Output setter);
}
