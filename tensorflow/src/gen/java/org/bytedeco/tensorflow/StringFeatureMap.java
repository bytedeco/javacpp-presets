...
@Name("google::protobuf::Map<std::string,tensorflow::Feature>") @Properties(inherit = org.bytedeco.tensorflow.presets.tensorflow.class)
public class StringFeatureMap extends Pointer {
    static { Loader.load(); }
