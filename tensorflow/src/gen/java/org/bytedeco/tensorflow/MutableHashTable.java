...
public class MutableHashTable extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native MutableHashTable operation(Operation setter);
  public native @ByRef Output table_handle(); public native MutableHashTable table_handle(Output setter);
}
