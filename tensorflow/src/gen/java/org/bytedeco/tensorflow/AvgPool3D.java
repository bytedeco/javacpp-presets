...
public class AvgPool3D extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native AvgPool3D operation(Operation setter);
  public native @ByRef Output output(); public native AvgPool3D output(Output setter);
}
