...
public class All extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native All operation(Operation setter);
  public native @ByRef Output output(); public native All output(Output setter);
}
