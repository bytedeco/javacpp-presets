...
public class SequenceExample extends MessageLite {
    static { Loader.load(); }
    ...
    @Override public SequenceExample getPointer(long i) {
        return new SequenceExample((Pointer)this).position(position + i);
    }
