...
public class OrderedMapIncompleteSize extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native OrderedMapIncompleteSize operation(Operation setter);
  public native @ByRef Output size(); public native OrderedMapIncompleteSize size(Output setter);
}
