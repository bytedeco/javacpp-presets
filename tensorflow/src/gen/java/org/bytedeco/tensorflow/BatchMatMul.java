...
public class BatchMatMul extends Pointer {
  ...
  public native @ByRef Operation operation(); public native BatchMatMul operation(Operation setter);
  public native @ByRef Output output(); public native BatchMatMul output(Output setter);
}
