...
public class ApplyGradientDescent extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native ApplyGradientDescent operation(Operation setter);
  public native @ByRef Output out(); public native ApplyGradientDescent out(Output setter);
}
