...
public class DivNoNan extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native DivNoNan operation(Operation setter);
  public native @ByRef Output z(); public native DivNoNan z(Output setter);
}
