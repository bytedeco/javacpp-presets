...
public class FusedBatchNorm extends Pointer {
  ...
  public native @ByRef Operation operation(); public native FusedBatchNorm operation(Operation setter);
  public native @ByRef Output y(); public native FusedBatchNorm y(Output setter);
  public native @ByRef Output batch_mean(); public native FusedBatchNorm batch_mean(Output setter);
  public native @ByRef Output batch_variance(); public native FusedBatchNorm batch_variance(Output setter);
  public native @ByRef Output reserve_space_1(); public native FusedBatchNorm reserve_space_1(Output setter);
  public native @ByRef Output reserve_space_2(); public native FusedBatchNorm reserve_space_2(Output setter);
}
