...
public class MapSize extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native MapSize operation(Operation setter);
  public native @ByRef Output size(); public native MapSize size(Output setter);
}
