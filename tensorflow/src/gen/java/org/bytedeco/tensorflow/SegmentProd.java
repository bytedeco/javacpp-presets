...
public class SegmentProd extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native SegmentProd operation(Operation setter);
  public native @ByRef Output output(); public native SegmentProd output(Output setter);
}
