...
public class FunctionDefLibrary extends MessageLite {
    static { Loader.load(); }
    ...
    @Override public FunctionDefLibrary getPointer(long i) {
        return new FunctionDefLibrary((Pointer)this).position(position + i);
    }
