...
public class SquaredDifference extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native SquaredDifference operation(Operation setter);
  public native @ByRef Output z(); public native SquaredDifference z(Output setter);
}
