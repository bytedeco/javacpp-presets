...
public class ScatterSub extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native ScatterSub operation(Operation setter);
  public native @ByRef Output output_ref(); public native ScatterSub output_ref(Output setter);
}
