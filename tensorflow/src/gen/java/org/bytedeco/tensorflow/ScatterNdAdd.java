...
public class ScatterNdAdd extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native ScatterNdAdd operation(Operation setter);
  public native @ByRef Output output_ref(); public native ScatterNdAdd output_ref(Output setter);
}
