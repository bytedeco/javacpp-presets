...
public class RealDiv extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native RealDiv operation(Operation setter);
  public native @ByRef Output z(); public native RealDiv z(Output setter);
}
