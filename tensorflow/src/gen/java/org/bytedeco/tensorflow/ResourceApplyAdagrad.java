...
public class ResourceApplyAdagrad extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native ResourceApplyAdagrad operation(Operation setter);
}
