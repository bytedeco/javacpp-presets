...
public class QuantizedDepthwiseConv2DWithBias extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public QuantizedDepthwiseConv2DWithBias(Pointer p) { super(p); }
  ...
  public QuantizedDepthwiseConv2DWithBias(@Const @ByRef Scope scope,
  ...
  public native @ByRef Operation operation(); public native QuantizedDepthwiseConv2DWithBias operation(Operation setter);
  public native @ByRef Output output(); public native QuantizedDepthwiseConv2DWithBias output(Output setter);
  public native @ByRef Output min_output(); public native QuantizedDepthwiseConv2DWithBias min_output(Output setter);
  public native @ByRef Output max_output(); public native QuantizedDepthwiseConv2DWithBias max_output(Output setter);
}
