...
public class Multiply extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native Multiply operation(Operation setter);
  public native @ByRef Output z(); public native Multiply z(Output setter);
}
