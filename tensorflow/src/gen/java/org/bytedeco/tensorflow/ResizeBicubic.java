...
public class ResizeBicubic extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native ResizeBicubic operation(Operation setter);
  public native @ByRef Output resized_images(); public native ResizeBicubic resized_images(Output setter);
}
