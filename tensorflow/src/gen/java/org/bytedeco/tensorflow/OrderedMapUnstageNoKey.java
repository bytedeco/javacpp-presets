...
public class OrderedMapUnstageNoKey extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native OrderedMapUnstageNoKey operation(Operation setter);
  public native @ByRef Output key(); public native OrderedMapUnstageNoKey key(Output setter);
  public native @ByRef @Cast("tensorflow::OutputList*") OutputVector values(); public native OrderedMapUnstageNoKey values(OutputVector setter);
}
