...
public class QuantizedMatMulWithBiasAndRelu extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public QuantizedMatMulWithBiasAndRelu(Pointer p) { super(p); }
  ...
  public QuantizedMatMulWithBiasAndRelu(@Const @ByRef Scope scope,
                                 @ByVal Input a, @ByVal Input b,
                                 @ByVal Input bias, @ByVal Input min_a, @ByVal Input max_a,
  ...
  public QuantizedMatMulWithBiasAndRelu(@Const @ByRef Scope scope,
                                 @ByVal Input a, @ByVal Input b,
                                 @ByVal Input bias, @ByVal Input min_a, @ByVal Input max_a,
                                 @ByVal Input min_b, @ByVal Input max_b, @Const @ByRef Attrs attrs) { super((Pointer)null); allocate(scope, a, b, bias, min_a, max_a, min_b, max_b, attrs); }
  private native void allocate(@Const @ByRef Scope scope,
                                 @ByVal Input a, @ByVal Input b,
                                 @ByVal Input bias, @ByVal Input min_a, @ByVal Input max_a,
                                 @ByVal Input min_b, @ByVal Input max_b, @Const @ByRef Attrs attrs);
  ...
  public native @ByRef Operation operation(); public native QuantizedMatMulWithBiasAndRelu operation(Operation setter);
  public native @ByRef Output out(); public native QuantizedMatMulWithBiasAndRelu out(Output setter);
  public native @ByRef Output min_out(); public native QuantizedMatMulWithBiasAndRelu min_out(Output setter);
  public native @ByRef Output max_out(); public native QuantizedMatMulWithBiasAndRelu max_out(Output setter);
}
