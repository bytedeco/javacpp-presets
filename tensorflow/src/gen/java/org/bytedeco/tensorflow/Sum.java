...
public class Sum extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native Sum operation(Operation setter);
  public native @ByRef Output output(); public native Sum output(Output setter);
}
