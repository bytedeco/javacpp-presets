...
public class GreaterEqual extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native GreaterEqual operation(Operation setter);
  public native @ByRef Output z(); public native GreaterEqual z(Output setter);
}
