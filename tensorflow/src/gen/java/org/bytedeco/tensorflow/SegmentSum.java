...
public class SegmentSum extends Pointer {
  ...
  public native @ByRef Operation operation(); public native SegmentSum operation(Operation setter);
  public native @ByRef Output output(); public native SegmentSum output(Output setter);
}
