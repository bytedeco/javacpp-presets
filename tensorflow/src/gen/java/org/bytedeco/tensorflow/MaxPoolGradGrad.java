...
public class MaxPoolGradGrad extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native MaxPoolGradGrad operation(Operation setter);
  public native @ByRef Output output(); public native MaxPoolGradGrad output(Output setter);
}
