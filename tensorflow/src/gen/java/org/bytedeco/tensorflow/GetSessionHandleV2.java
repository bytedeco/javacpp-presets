...
public class GetSessionHandleV2 extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native GetSessionHandleV2 operation(Operation setter);
  public native @ByRef Output handle(); public native GetSessionHandleV2 handle(Output setter);
}
