...
public class SparseApplyAdagrad extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native SparseApplyAdagrad operation(Operation setter);
  public native @ByRef Output out(); public native SparseApplyAdagrad out(Output setter);
}
