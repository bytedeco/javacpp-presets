...
@Name("std::vector<std::pair<unsigned,unsigned> >") @Properties(inherit = org.bytedeco.tensorflow.presets.tensorflow.class)
public class IntIntPairVector extends Pointer {
    ...
    @Index(function = "at") public native @Cast("unsigned") int first(@Cast("size_t") long i); public native IntIntPairVector first(@Cast("size_t") long i, int first);
    @Index(function = "at") public native @Cast("unsigned") int second(@Cast("size_t") long i);  public native IntIntPairVector second(@Cast("size_t") long i, int second);
