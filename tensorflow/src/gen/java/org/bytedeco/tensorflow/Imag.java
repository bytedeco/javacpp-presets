...
public class Imag extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native Imag operation(Operation setter);
  public native @ByRef Output output(); public native Imag output(Output setter);
}
