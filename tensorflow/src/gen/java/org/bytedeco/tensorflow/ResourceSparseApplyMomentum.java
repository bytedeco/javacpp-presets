...
public class ResourceSparseApplyMomentum extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native ResourceSparseApplyMomentum operation(Operation setter);
}
