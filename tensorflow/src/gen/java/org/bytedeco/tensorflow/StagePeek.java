...
public class StagePeek extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native StagePeek operation(Operation setter);
  public native @ByRef @Cast("tensorflow::OutputList*") OutputVector values(); public native StagePeek values(OutputVector setter);
}
