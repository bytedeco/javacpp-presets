...
public class QuantizedConv2DWithBiasAndReluAndRequantize extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public QuantizedConv2DWithBiasAndReluAndRequantize(Pointer p) { super(p); }
  ...
  public QuantizedConv2DWithBiasAndReluAndRequantize(@Const @ByRef Scope scope,
                                              @ByVal Input input,
                                              @ByVal Input filter,
                                              @ByVal Input bias,
                                              ...
                                              @ByVal Input max_freezed_output, @ArraySlice IntPointer strides,
  ...
  public QuantizedConv2DWithBiasAndReluAndRequantize(@Const @ByRef Scope scope,
                                              ...
                                              @ByVal Input max_filter,
                                              @ByVal Input min_freezed_output,
                                              @ByVal Input max_freezed_output, @ArraySlice IntBuffer strides,
  ...
  public QuantizedConv2DWithBiasAndReluAndRequantize(@Const @ByRef Scope scope,
                                              ...
                                              @ByVal Input max_filter,
                                              @ByVal Input min_freezed_output,
                                              @ByVal Input max_freezed_output, @ArraySlice int[] strides,
                                              @StringPiece BytePointer padding) { super((Pointer)null); allocate(scope, input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, strides, padding); }
  private native void allocate(@Const @ByRef Scope scope,
                                              @ByVal Input input,
                                              @ByVal Input filter,
  ...
  public native @ByRef Operation operation(); public native QuantizedConv2DWithBiasAndReluAndRequantize operation(Operation operation);
  public native @ByRef Output output(); public native QuantizedConv2DWithBiasAndReluAndRequantize output(Output output);
  public native @ByRef Output min_output(); public native QuantizedConv2DWithBiasAndReluAndRequantize min_output(Output min_output);
  public native @ByRef Output max_output(); public native QuantizedConv2DWithBiasAndReluAndRequantize max_output(Output max_output);
}
