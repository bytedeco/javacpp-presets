...
public class Less extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native Less operation(Operation setter);
  public native @ByRef Output z(); public native Less z(Output setter);
}
