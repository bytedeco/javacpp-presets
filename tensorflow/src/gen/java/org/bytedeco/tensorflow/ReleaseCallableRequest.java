...
public class ReleaseCallableRequest extends MessageLite {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ReleaseCallableRequest(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ReleaseCallableRequest(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ReleaseCallableRequest position(long position) {
        return (ReleaseCallableRequest)super.position(position);
    }
    @Override public ReleaseCallableRequest getPointer(long i) {
        return new ReleaseCallableRequest((Pointer)this).position(position + i);
    }

  public ReleaseCallableRequest() { super((Pointer)null); allocate(); }
  private native void allocate();

  public ReleaseCallableRequest(@Const @ByRef ReleaseCallableRequest from) { super((Pointer)null); allocate(from); }
  private native void allocate(@Const @ByRef ReleaseCallableRequest from);

  public native @ByRef @Name("operator =") ReleaseCallableRequest put(@Const @ByRef ReleaseCallableRequest from);
  ...
  public static native @Const @ByRef ReleaseCallableRequest default_instance();

  public static native void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  public static native @Const ReleaseCallableRequest internal_default_instance();
  @MemberGetter public static native int kIndexInFileMessages();
  public static final int kIndexInFileMessages = kIndexInFileMessages();

  public native void UnsafeArenaSwap(ReleaseCallableRequest other);
  public native void Swap(ReleaseCallableRequest other);
  

  // implements Message ----------------------------------------------

  public native ReleaseCallableRequest New();

  public native ReleaseCallableRequest New(Arena arena);
  public native void CopyFrom(@Cast("const google::protobuf::Message*") @ByRef MessageLite from);
  public native void MergeFrom(@Cast("const google::protobuf::Message*") @ByRef MessageLite from);
  public native void CopyFrom(@Const @ByRef ReleaseCallableRequest from);
  public native void MergeFrom(@Const @ByRef ReleaseCallableRequest from);
