...
public class QuantizedConv2DWithBiasAndRequantize extends Pointer {
  ...
  public native @ByRef Operation operation(); public native QuantizedConv2DWithBiasAndRequantize operation(Operation setter);
  public native @ByRef Output output(); public native QuantizedConv2DWithBiasAndRequantize output(Output setter);
  public native @ByRef Output min_output(); public native QuantizedConv2DWithBiasAndRequantize min_output(Output setter);
  public native @ByRef Output max_output(); public native QuantizedConv2DWithBiasAndRequantize max_output(Output setter);
}
