...
//   #endif
  ...
  public native @Deprecated @StdString @Cast({"char*", "std::string*"}) BytePointer unsafe_arena_release_job_name();
  public native @Deprecated void unsafe_arena_set_allocated_job_name(
...
//   #endif
  ...
  public native @Deprecated @StdString @Cast({"char*", "std::string*"}) BytePointer unsafe_arena_release_protocol();
  public native @Deprecated void unsafe_arena_set_allocated_protocol(
