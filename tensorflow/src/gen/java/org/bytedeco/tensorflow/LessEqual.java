...
public class LessEqual extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native LessEqual operation(Operation setter);
  public native @ByRef Output z(); public native LessEqual z(Output setter);
}
