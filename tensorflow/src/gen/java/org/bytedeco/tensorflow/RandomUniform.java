...
public class RandomUniform extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native RandomUniform operation(Operation setter);
  public native @ByRef Output output(); public native RandomUniform output(Output setter);
}
