...
public class Mean extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native Mean operation(Operation setter);
  public native @ByRef Output output(); public native Mean output(Output setter);
}
