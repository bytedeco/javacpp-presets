...
public class ScatterMin extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native ScatterMin operation(Operation setter);
  public native @ByRef Output output_ref(); public native ScatterMin output_ref(Output setter);
}
