...
@Name("std::unordered_map<std::string,tensorflow::DataType>") @Properties(inherit = org.bytedeco.tensorflow.presets.tensorflow.class)
public class VarToDataTypeMap extends Pointer {
    static { Loader.load(); }
