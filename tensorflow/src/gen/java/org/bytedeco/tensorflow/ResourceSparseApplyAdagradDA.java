...
public class ResourceSparseApplyAdagradDA extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native ResourceSparseApplyAdagradDA operation(Operation setter);
}
