...
public class ScatterNdUpdate extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native ScatterNdUpdate operation(Operation setter);
  public native @ByRef Output output_ref(); public native ScatterNdUpdate output_ref(Output setter);
}
