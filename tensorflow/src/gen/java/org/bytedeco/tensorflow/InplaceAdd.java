...
public class InplaceAdd extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native InplaceAdd operation(Operation setter);
  public native @ByRef Output y(); public native InplaceAdd y(Output setter);
}
