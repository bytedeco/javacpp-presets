...
public class MapUnstageNoKey extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native MapUnstageNoKey operation(Operation setter);
  public native @ByRef Output key(); public native MapUnstageNoKey key(Output setter);
  public native @ByRef @Cast("tensorflow::OutputList*") OutputVector values(); public native MapUnstageNoKey values(OutputVector setter);
}
