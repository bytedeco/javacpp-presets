...
public class ResourceSparseApplyProximalAdagrad extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native ResourceSparseApplyProximalAdagrad operation(Operation setter);
}
