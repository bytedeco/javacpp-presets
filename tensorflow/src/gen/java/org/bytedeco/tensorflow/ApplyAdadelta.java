...
public class ApplyAdadelta extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native ApplyAdadelta operation(Operation setter);
  public native @ByRef Output out(); public native ApplyAdadelta out(Output setter);
}
