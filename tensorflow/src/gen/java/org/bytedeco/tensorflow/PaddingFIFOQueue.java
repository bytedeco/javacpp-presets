...
public class PaddingFIFOQueue extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native PaddingFIFOQueue operation(Operation setter);
  public native @ByRef Output handle(); public native PaddingFIFOQueue handle(Output setter);
}
