...
public class ScatterAdd extends Pointer {
  ...
  public native @ByRef Operation operation(); public native ScatterAdd operation(Operation setter);
  public native @ByRef Output output_ref(); public native ScatterAdd output_ref(Output setter);
}
