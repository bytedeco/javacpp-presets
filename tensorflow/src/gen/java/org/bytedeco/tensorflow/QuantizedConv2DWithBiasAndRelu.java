...
public class QuantizedConv2DWithBiasAndRelu extends Pointer {
  ...
  public native @ByRef Operation operation(); public native QuantizedConv2DWithBiasAndRelu operation(Operation operation);
  public native @ByRef Output output(); public native QuantizedConv2DWithBiasAndRelu output(Output output);
  public native @ByRef Output min_output(); public native QuantizedConv2DWithBiasAndRelu min_output(Output min_output);
  public native @ByRef Output max_output(); public native QuantizedConv2DWithBiasAndRelu max_output(Output max_output);
}
