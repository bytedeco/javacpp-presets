...
public class Max extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native Max operation(Operation setter);
  public native @ByRef Output output(); public native Max output(Output setter);
}
