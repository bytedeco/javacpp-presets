...
public class RandomShuffleQueue extends Pointer {
  ...
  public static class Attrs extends Pointer {
    ...
    public native @Cast("tensorflow::int64") long min_after_dequeue_(); public native Attrs min_after_dequeue_(long setter);
  ...
  public native @ByRef Operation operation(); public native RandomShuffleQueue operation(Operation setter);
  public native @ByRef Output handle(); public native RandomShuffleQueue handle(Output setter);
}
