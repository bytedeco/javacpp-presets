...
public class ApplyProximalGradientDescent extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native ApplyProximalGradientDescent operation(Operation setter);
  public native @ByRef Output out(); public native ApplyProximalGradientDescent out(Output setter);
}
