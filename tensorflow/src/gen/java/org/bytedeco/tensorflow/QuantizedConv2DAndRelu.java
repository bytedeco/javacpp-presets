...
public class QuantizedConv2DAndRelu extends Pointer {
  ...
  public native @ByRef Operation operation(); public native QuantizedConv2DAndRelu operation(Operation setter);
  public native @ByRef Output output(); public native QuantizedConv2DAndRelu output(Output setter);
  public native @ByRef Output min_output(); public native QuantizedConv2DAndRelu min_output(Output setter);
  public native @ByRef Output max_output(); public native QuantizedConv2DAndRelu max_output(Output setter);
}
