...
public class StageSize extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native StageSize operation(Operation setter);
  public native @ByRef Output size(); public native StageSize size(Output setter);
}
