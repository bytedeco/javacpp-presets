...
public class Conv2DBackpropFilter extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native Conv2DBackpropFilter operation(Operation setter);
  public native @ByRef Output output(); public native Conv2DBackpropFilter output(Output setter);
}
