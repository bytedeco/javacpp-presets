...
@Name("std::vector<tensorflow::TensorShapeProto*>") @Properties(inherit = org.bytedeco.tensorflow.presets.tensorflow.class)
public class TensorShapeProtoVector extends Pointer {
    ...
    @Index(function = "at") public native TensorShapeProto get(@Cast("size_t") long i);
    public native TensorShapeProtoVector put(@Cast("size_t") long i, TensorShapeProto value);

    public native @ByVal Iterator insert(@ByVal Iterator pos, TensorShapeProto value);
