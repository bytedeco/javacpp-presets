...
public class MaxPool3DGradGrad extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native MaxPool3DGradGrad operation(Operation setter);
  public native @ByRef Output output(); public native MaxPool3DGradGrad output(Output setter);
}
