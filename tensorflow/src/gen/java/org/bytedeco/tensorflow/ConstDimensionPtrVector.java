...
@Name("std::vector<const tensorflow::shape_inference::Dimension*>") @Properties(inherit = org.bytedeco.tensorflow.presets.tensorflow.class)
public class ConstDimensionPtrVector extends Pointer {
    static { Loader.load(); }
