...
public class LogicalOr extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native LogicalOr operation(Operation setter);
  public native @ByRef Output z(); public native LogicalOr z(Output setter);
}
