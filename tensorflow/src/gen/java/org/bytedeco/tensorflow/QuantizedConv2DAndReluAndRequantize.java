...
public class QuantizedConv2DAndReluAndRequantize extends Pointer {
  ...
  public native @ByRef Operation operation(); public native QuantizedConv2DAndReluAndRequantize operation(Operation setter);
  public native @ByRef Output output(); public native QuantizedConv2DAndReluAndRequantize output(Output setter);
  public native @ByRef Output min_output(); public native QuantizedConv2DAndReluAndRequantize min_output(Output setter);
  public native @ByRef Output max_output(); public native QuantizedConv2DAndReluAndRequantize max_output(Output setter);
}
