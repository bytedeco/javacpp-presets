...
public class Div extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native Div operation(Operation setter);
  public native @ByRef Output z(); public native Div z(Output setter);
}
