...
public class OrderedMapSize extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native OrderedMapSize operation(Operation setter);
  public native @ByRef Output size(); public native OrderedMapSize size(Output setter);
}
