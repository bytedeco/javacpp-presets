...
public class Minimum extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native Minimum operation(Operation setter);
  public native @ByRef Output z(); public native Minimum z(Output setter);
}
