...
public class TFRecordReader extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native TFRecordReader operation(Operation setter);
  public native @ByRef Output reader_handle(); public native TFRecordReader reader_handle(Output setter);
}
