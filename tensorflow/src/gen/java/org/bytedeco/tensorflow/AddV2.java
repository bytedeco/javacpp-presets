...
public class AddV2 extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native AddV2 operation(Operation setter);
  public native @ByRef Output z(); public native AddV2 z(Output setter);
}
