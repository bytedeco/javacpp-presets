...
public class MaxPoolGrad extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native MaxPoolGrad operation(Operation setter);
  public native @ByRef Output output(); public native MaxPoolGrad output(Output setter);
}
