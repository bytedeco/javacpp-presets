...
public class FusedBatchNormGradV2 extends Pointer {
  ...
  public native @ByRef Operation operation(); public native FusedBatchNormGradV2 operation(Operation setter);
  public native @ByRef Output x_backprop(); public native FusedBatchNormGradV2 x_backprop(Output setter);
  public native @ByRef Output scale_backprop(); public native FusedBatchNormGradV2 scale_backprop(Output setter);
  public native @ByRef Output offset_backprop(); public native FusedBatchNormGradV2 offset_backprop(Output setter);
  public native @ByRef Output reserve_space_3(); public native FusedBatchNormGradV2 reserve_space_3(Output setter);
  public native @ByRef Output reserve_space_4(); public native FusedBatchNormGradV2 reserve_space_4(Output setter);
}
