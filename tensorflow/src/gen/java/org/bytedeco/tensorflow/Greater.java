...
public class Greater extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native Greater operation(Operation setter);
  public native @ByRef Output z(); public native Greater z(Output setter);
}
