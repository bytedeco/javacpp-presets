...
public class ResourceSparseApplyFtrlV2 extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native ResourceSparseApplyFtrlV2 operation(Operation setter);
}
