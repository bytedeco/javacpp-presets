...
public class FloorDiv extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native FloorDiv operation(Operation setter);
  public native @ByRef Output z(); public native FloorDiv z(Output setter);
}
