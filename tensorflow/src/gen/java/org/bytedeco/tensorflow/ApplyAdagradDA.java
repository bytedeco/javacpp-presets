...
public class ApplyAdagradDA extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native ApplyAdagradDA operation(Operation setter);
  public native @ByRef Output out(); public native ApplyAdagradDA out(Output setter);
}
