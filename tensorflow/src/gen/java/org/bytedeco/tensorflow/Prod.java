...
public class Prod extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native Prod operation(Operation setter);
  public native @ByRef Output output(); public native Prod output(Output setter);
}
