...
public class Conv3DBackpropFilterV2 extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native Conv3DBackpropFilterV2 operation(Operation setter);
  public native @ByRef Output output(); public native Conv3DBackpropFilterV2 output(Output setter);
}
