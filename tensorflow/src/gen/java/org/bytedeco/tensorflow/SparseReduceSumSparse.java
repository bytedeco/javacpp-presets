...
public class SparseReduceSumSparse extends Pointer {
  ...
  public native @ByRef Operation operation(); public native SparseReduceSumSparse operation(Operation setter);
  public native @ByRef Output output_indices(); public native SparseReduceSumSparse output_indices(Output setter);
  public native @ByRef Output output_values(); public native SparseReduceSumSparse output_values(Output setter);
  public native @ByRef Output output_shape(); public native SparseReduceSumSparse output_shape(Output setter);
}
