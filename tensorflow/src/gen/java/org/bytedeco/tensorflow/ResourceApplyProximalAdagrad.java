...
public class ResourceApplyProximalAdagrad extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native ResourceApplyProximalAdagrad operation(Operation setter);
}
