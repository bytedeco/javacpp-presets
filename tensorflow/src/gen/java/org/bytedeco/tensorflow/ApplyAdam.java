...
public class ApplyAdam extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native ApplyAdam operation(Operation setter);
  public native @ByRef Output out(); public native ApplyAdam out(Output setter);
}
