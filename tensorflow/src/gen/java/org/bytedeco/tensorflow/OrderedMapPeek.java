...
public class OrderedMapPeek extends Pointer {
    static { Loader.load(); }
  ...
  public native @ByRef Operation operation(); public native OrderedMapPeek operation(Operation setter);
  public native @ByRef @Cast("tensorflow::OutputList*") OutputVector values(); public native OrderedMapPeek values(OutputVector setter);
}
