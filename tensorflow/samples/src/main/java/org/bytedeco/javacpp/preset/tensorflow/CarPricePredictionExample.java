package org.bytedeco.javacpp.preset.tensorflow;

import static org.bytedeco.javacpp.tensorflow.AddSymbolicGradients;
...
public class CarPricePredictionExample {
	...
	static class CarDataset {
		...
		public CarDataset() throws IOException {			
			try(InputStream is = CarPricePredictionExample.class.getResourceAsStream("normalized_car_features.csv")) {
