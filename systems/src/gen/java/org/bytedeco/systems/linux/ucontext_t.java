...
public class ucontext_t extends Pointer {
    ...
    public native @Cast("unsigned long long int") long __ssp(int i); public native ucontext_t __ssp(int i, long setter);
    @MemberGetter public native @Cast("unsigned long long int*") LongPointer __ssp();
  }
