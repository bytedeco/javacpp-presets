...
public class sigvec extends Pointer {
    ...
    public native __sighandler_t sv_handler(); public native sigvec sv_handler(__sighandler_t setter);	/* Signal handler.  */
    public native int sv_mask(); public native sigvec sv_mask(int setter);		/* Mask of signals to be blocked.  */

    public native int sv_flags(); public native sigvec sv_flags(int setter);		/* Flags (see below).  */
