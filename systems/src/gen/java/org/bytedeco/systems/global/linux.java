...
/* %eax */
public static final int bit_AVXVNNI =	(1 << 4);
public static final int bit_AVX512BF16 =	(1 << 5);
public static final int bit_HRESET =	(1 << 22);
...
public static final int bit_ENQCMD =	(1 << 29);
public static final int bit_CLDEMOTE =	(1 << 25);
public static final int bit_KL =		(1 << 23);

/* %edx */
public static final int bit_AVX5124VNNIW = (1 << 2);
public static final int bit_AVX5124FMAPS = (1 << 3);
public static final int bit_AVX512VP2INTERSECT =	(1 << 8);
public static final int bit_IBT =	(1 << 20);
public static final int bit_UINTR = (1 << 5);
public static final int bit_PCONFIG =	(1 << 18);
public static final int bit_SERIALIZE =	(1 << 14);
public static final int bit_TSXLDTRK =    (1 << 16);
public static final int bit_AMX_BF16 =    (1 << 22);
public static final int bit_AMX_TILE =    (1 << 24);
public static final int bit_AMX_INT8 =    (1 << 25);
...
/* %ebx */
public static final int bit_AESKLE =	( 1<<0 );
public static final int bit_WIDEKL =	( 1<<2 );
...
public static native void __cpuidex(IntPointer __cpuid_info, int __leaf, int __subleaf);
public static native void __cpuidex(IntBuffer __cpuid_info, int __leaf, int __subleaf);
public static native void __cpuidex(int[] __cpuid_info, int __leaf, int __subleaf);
...
// Targeting ../linux/dl_find_object.java



/* If ADDRESS is found in an object, fill in *RESULT and return 0.
   Otherwise, return -1.  */
public static native int _dl_find_object(Pointer __address, dl_find_object __result);
...
public static final int PF_MCTP =		45;	/* Management component transport protocol.  */
public static final int PF_MAX =		46;	/* For now..  */
...
public static final int AF_MCTP =		PF_MCTP;
...
public static native int __memcmpeq(@Const Pointer __s1, @Const Pointer __s2, @Cast("size_t") long __n);
...
public static native @Cast("const char*") BytePointer strerrordesc_np(int __err);
/* Return a string with the error name in ERR.  */
public static native @Cast("const char*") BytePointer strerrorname_np(int __err);
// # endif
// #endif
...
public static native @Cast("const char*") BytePointer sigabbrev_np(int __sig);
/* Return a string describing the meaning of the signal number in SIG,
   the result is not translated.  */
public static native @Cast("const char*") BytePointer sigdescr_np(int __sig);
// # endif
...
public static native int timespec_getres(timespec __ts, int __base);
// # else
// # endif
// #endif
...
public static native int posix_spawn_file_actions_addclosefrom_np(posix_spawn_file_actions_t arg0,
					  int __from);

/* Add an action to set the process group of the forground process group
   associated with the terminal TCFD.  */
public static native int posix_spawn_file_actions_addtcsetpgrp_np(posix_spawn_file_actions_t arg0,
					  int __tcfd);
...
public static native int execveat(int __fd, @Cast("const char*") BytePointer __path, @Cast("char*const*") PointerPointer __argv,
                     @Cast("char*const*") PointerPointer __envp, int __flags);
public static native int execveat(int __fd, @Cast("const char*") BytePointer __path, @Cast("char*const*") @ByPtrPtr BytePointer __argv,
                     @Cast("char*const*") @ByPtrPtr BytePointer __envp, int __flags);
public static native int execveat(int __fd, String __path, @Cast("char*const*") @ByPtrPtr ByteBuffer __argv,
                     @Cast("char*const*") @ByPtrPtr ByteBuffer __envp, int __flags);
public static native int execveat(int __fd, @Cast("const char*") BytePointer __path, @Cast("char*const*") @ByPtrPtr byte[] __argv,
                     @Cast("char*const*") @ByPtrPtr byte[] __envp, int __flags);
public static native int execveat(int __fd, String __path, @Cast("char*const*") @ByPtrPtr BytePointer __argv,
                     @Cast("char*const*") @ByPtrPtr BytePointer __envp, int __flags);
public static native int execveat(int __fd, @Cast("const char*") BytePointer __path, @Cast("char*const*") @ByPtrPtr ByteBuffer __argv,
                     @Cast("char*const*") @ByPtrPtr ByteBuffer __envp, int __flags);
public static native int execveat(int __fd, String __path, @Cast("char*const*") @ByPtrPtr byte[] __argv,
                     @Cast("char*const*") @ByPtrPtr byte[] __envp, int __flags);
// #endif
...
public static native void closefrom(int __lowfd);
// #endif
...
public static native @Cast("__pid_t") int _Fork();
// #endif
...
public static native int close_range(@Cast("unsigned int") int __fd, @Cast("unsigned int") int __max_fd,
			int __flags);
// #endif
...
/* Wait for a child to die.  When one does, put its status in *STAT_LOC
   ...
   This function is a cancellation point and therefore not marked with
   __THROW.  */
public static native @Cast("__pid_t") @Name("wait") int _wait(IntPointer __stat_loc);
public static native @Cast("__pid_t") @Name("wait") int _wait(IntBuffer __stat_loc);
public static native @Cast("__pid_t") @Name("wait") int _wait(int[] __stat_loc);
...
/* Wait for a child matching PID to die.
   ...
   This function is a cancellation point and therefore not marked with
   __THROW.  */
public static native @Cast("__pid_t") int waitpid(@Cast("__pid_t") int __pid, IntPointer __stat_loc, int __options);
public static native @Cast("__pid_t") int waitpid(@Cast("__pid_t") int __pid, IntBuffer __stat_loc, int __options);
public static native @Cast("__pid_t") int waitpid(@Cast("__pid_t") int __pid, int[] __stat_loc, int __options);
...
/* Wait for a child to exit.  When one does, put its status in *STAT_LOC and
   ...
   otherwise don't.  */
// # ifndef __USE_TIME_BITS64
public static native @Cast("__pid_t") int wait3(IntPointer __stat_loc, int __options,
		      rusage __usage);
public static native @Cast("__pid_t") int wait3(IntBuffer __stat_loc, int __options,
		      rusage __usage);
public static native @Cast("__pid_t") int wait3(int[] __stat_loc, int __options,
		      rusage __usage);
// # else
// # endif
// #endif
...
public static native @Cast("__pid_t") int wait4(@Cast("__pid_t") int __pid, IntPointer __stat_loc, int __options,
		      rusage __usage);
public static native @Cast("__pid_t") int wait4(@Cast("__pid_t") int __pid, IntBuffer __stat_loc, int __options,
		      rusage __usage);
public static native @Cast("__pid_t") int wait4(@Cast("__pid_t") int __pid, int[] __stat_loc, int __options,
		      rusage __usage);
// # else
// # endif
// #endif /* Use misc.  */
...
// Parsed from bits/struct_stat.h
...
public static final int _BITS_STRUCT_STAT_H =	1;
...
// Parsed from bits/types/struct_shmid_ds.h
