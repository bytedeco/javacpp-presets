...
public class OBJECTID extends Pointer {
    ...
    @Override public OBJECTID position(long position) {
     ...
     // size is 20
    public native @ByRef GUID Lineage(); public native OBJECTID Lineage(GUID Lineage);
    public native @Cast("DWORD") int Uniquifier(); public native OBJECTID Uniquifier(int Uniquifier);
}
