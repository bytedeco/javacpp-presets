...
public class FILETIME extends Pointer {
    ...
    public native @Cast("DWORD") int dwLowDateTime(); public native FILETIME dwLowDateTime(int dwLowDateTime);
    public native @Cast("DWORD") int dwHighDateTime(); public native FILETIME dwHighDateTime(int dwHighDateTime);
}
