...
public class NUMA_NODE_RELATIONSHIP extends Pointer {
    ...
    public native @Cast("DWORD") int NodeNumber(); public native NUMA_NODE_RELATIONSHIP NodeNumber(int NodeNumber);
    public native @Cast("BYTE") byte Reserved(int i); public native NUMA_NODE_RELATIONSHIP Reserved(int i, byte Reserved);
    @MemberGetter public native @Cast("BYTE*") BytePointer Reserved();
    public native @ByRef GROUP_AFFINITY GroupMask(); public native NUMA_NODE_RELATIONSHIP GroupMask(GROUP_AFFINITY GroupMask);
}
