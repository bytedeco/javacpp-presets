...
public class PROCESSOR_NUMBER extends Pointer {
    ...
    public native @Cast("WORD") short Group(); public native PROCESSOR_NUMBER Group(short Group);
    public native @Cast("BYTE") byte Number(); public native PROCESSOR_NUMBER Number(byte Number);
    public native @Cast("BYTE") byte Reserved(); public native PROCESSOR_NUMBER Reserved(byte Reserved);
}
