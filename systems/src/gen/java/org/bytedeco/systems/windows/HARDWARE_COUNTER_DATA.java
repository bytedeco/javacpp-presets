...
public class HARDWARE_COUNTER_DATA extends Pointer {
    ...
    public native @Cast("HARDWARE_COUNTER_TYPE") int Type(); public native HARDWARE_COUNTER_DATA Type(int Type);
    public native @Cast("DWORD") int Reserved(); public native HARDWARE_COUNTER_DATA Reserved(int Reserved);
    public native @Cast("DWORD64") long Value(); public native HARDWARE_COUNTER_DATA Value(long Value);
}
