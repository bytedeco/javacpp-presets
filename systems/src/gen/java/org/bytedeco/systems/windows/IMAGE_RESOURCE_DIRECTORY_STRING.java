...
public class IMAGE_RESOURCE_DIRECTORY_STRING extends Pointer {
    ...
    public native @Cast("WORD") short Length(); public native IMAGE_RESOURCE_DIRECTORY_STRING Length(short Length);
    public native @Cast("CHAR") byte NameString(int i); public native IMAGE_RESOURCE_DIRECTORY_STRING NameString(int i, byte NameString);
