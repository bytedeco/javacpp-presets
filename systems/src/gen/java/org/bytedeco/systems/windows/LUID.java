...
public class LUID extends Pointer {
    ...
    public native @Cast("DWORD") int LowPart(); public native LUID LowPart(int LowPart);
    public native @Cast("LONG") int HighPart(); public native LUID HighPart(int HighPart);
}
