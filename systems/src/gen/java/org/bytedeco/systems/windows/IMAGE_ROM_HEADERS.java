...
public class IMAGE_ROM_HEADERS extends Pointer {
    ...
    public native @ByRef IMAGE_FILE_HEADER FileHeader(); public native IMAGE_ROM_HEADERS FileHeader(IMAGE_FILE_HEADER FileHeader);
    public native @ByRef IMAGE_ROM_OPTIONAL_HEADER OptionalHeader(); public native IMAGE_ROM_HEADERS OptionalHeader(IMAGE_ROM_OPTIONAL_HEADER OptionalHeader);
}
