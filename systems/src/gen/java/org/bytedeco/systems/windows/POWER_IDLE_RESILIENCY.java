...
public class POWER_IDLE_RESILIENCY extends Pointer {
    ...
    public native @Cast("DWORD") int CoalescingTimeout(); public native POWER_IDLE_RESILIENCY CoalescingTimeout(int CoalescingTimeout);
    public native @Cast("DWORD") int IdleResiliencyPeriod(); public native POWER_IDLE_RESILIENCY IdleResiliencyPeriod(int IdleResiliencyPeriod);
}
