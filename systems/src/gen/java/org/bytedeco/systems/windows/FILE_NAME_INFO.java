...
public class FILE_NAME_INFO extends Pointer {
    ...
    public native @Cast("DWORD") int FileNameLength(); public native FILE_NAME_INFO FileNameLength(int FileNameLength);
    public native @Cast("WCHAR") char FileName(int i); public native FILE_NAME_INFO FileName(int i, char FileName);
