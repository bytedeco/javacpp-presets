...
public class TRANSACTIONMANAGER_LOGPATH_INFORMATION extends Pointer {
    ...
    public native @Cast("DWORD") int LogPathLength(); public native TRANSACTIONMANAGER_LOGPATH_INFORMATION LogPathLength(int LogPathLength);
    public native @Cast("WCHAR") char LogPath(int i); public native TRANSACTIONMANAGER_LOGPATH_INFORMATION LogPath(int i, char LogPath);
