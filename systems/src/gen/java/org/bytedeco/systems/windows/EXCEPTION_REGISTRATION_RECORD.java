...
public class EXCEPTION_REGISTRATION_RECORD extends Pointer {
    ...
    public native EXCEPTION_REGISTRATION_RECORD Next(); public native EXCEPTION_REGISTRATION_RECORD Next(EXCEPTION_REGISTRATION_RECORD Next);
    public native @Cast("PEXCEPTION_ROUTINE") EXCEPTION_ROUTINE Handler(); public native EXCEPTION_REGISTRATION_RECORD Handler(EXCEPTION_ROUTINE Handler);
}
