...
public class HW_PROFILE_INFOW extends Pointer {
    ...
    public native @Cast("DWORD") int dwDockInfo(); public native HW_PROFILE_INFOW dwDockInfo(int dwDockInfo);
    public native @Cast("WCHAR") char szHwProfileGuid(int i); public native HW_PROFILE_INFOW szHwProfileGuid(int i, char szHwProfileGuid);
    @MemberGetter public native @Cast("WCHAR*") CharPointer szHwProfileGuid();
    public native @Cast("WCHAR") char szHwProfileName(int i); public native HW_PROFILE_INFOW szHwProfileName(int i, char szHwProfileName);
