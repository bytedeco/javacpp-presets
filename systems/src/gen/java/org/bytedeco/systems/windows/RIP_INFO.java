...
public class RIP_INFO extends Pointer {
    ...
    public native @Cast("DWORD") int dwError(); public native RIP_INFO dwError(int dwError);
    public native @Cast("DWORD") int dwType(); public native RIP_INFO dwType(int dwType);
}
