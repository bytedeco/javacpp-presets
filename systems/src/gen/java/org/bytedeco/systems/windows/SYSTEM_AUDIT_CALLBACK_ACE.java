...
public class SYSTEM_AUDIT_CALLBACK_ACE extends Pointer {
    ...
    public native @ByRef ACE_HEADER Header(); public native SYSTEM_AUDIT_CALLBACK_ACE Header(ACE_HEADER Header);
    public native @Cast("ACCESS_MASK") int Mask(); public native SYSTEM_AUDIT_CALLBACK_ACE Mask(int Mask);
    public native @Cast("DWORD") int SidStart(); public native SYSTEM_AUDIT_CALLBACK_ACE SidStart(int SidStart);
