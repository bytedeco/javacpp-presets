...
public class WOW64_DESCRIPTOR_TABLE_ENTRY extends Pointer {
    ...
    public native @Cast("DWORD") int Selector(); public native WOW64_DESCRIPTOR_TABLE_ENTRY Selector(int Selector);
    public native @ByRef WOW64_LDT_ENTRY Descriptor(); public native WOW64_DESCRIPTOR_TABLE_ENTRY Descriptor(WOW64_LDT_ENTRY Descriptor);
}
