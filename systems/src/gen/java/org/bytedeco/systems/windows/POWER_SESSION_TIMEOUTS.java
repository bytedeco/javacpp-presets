...
public class POWER_SESSION_TIMEOUTS extends Pointer {
    ...
    public native @Cast("DWORD") int InputTimeout(); public native POWER_SESSION_TIMEOUTS InputTimeout(int InputTimeout);
    public native @Cast("DWORD") int DisplayTimeout(); public native POWER_SESSION_TIMEOUTS DisplayTimeout(int DisplayTimeout);
}
