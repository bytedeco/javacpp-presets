...
public class TAPE_ERASE extends Pointer {
    ...
    public native @Cast("DWORD") int Type(); public native TAPE_ERASE Type(int Type);
    public native @Cast("BOOLEAN") boolean Immediate(); public native TAPE_ERASE Immediate(boolean Immediate);
}
