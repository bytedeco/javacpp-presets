...
public class PROCESS_MITIGATION_DYNAMIC_CODE_POLICY extends Pointer {
    ...
    @Override public PROCESS_MITIGATION_DYNAMIC_CODE_POLICY getPointer(long i) {
        ...
        public native @Cast("DWORD") int Flags(); public native PROCESS_MITIGATION_DYNAMIC_CODE_POLICY Flags(int setter);
            ...
            public native @Cast("DWORD") @NoOffset int AllowThreadOptOut(); public native PROCESS_MITIGATION_DYNAMIC_CODE_POLICY AllowThreadOptOut(int setter);
            public native @Cast("DWORD") @NoOffset int AllowRemoteDowngrade(); public native PROCESS_MITIGATION_DYNAMIC_CODE_POLICY AllowRemoteDowngrade(int setter);
            public native @Cast("DWORD") @NoOffset int AuditProhibitDynamicCode(); public native PROCESS_MITIGATION_DYNAMIC_CODE_POLICY AuditProhibitDynamicCode(int setter);
