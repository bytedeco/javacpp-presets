...
public class PROCESS_MITIGATION_DYNAMIC_CODE_POLICY extends Pointer {
    ...
    @Override public PROCESS_MITIGATION_DYNAMIC_CODE_POLICY position(long position) {
        ...
        public native @Cast("DWORD") int Flags(); public native PROCESS_MITIGATION_DYNAMIC_CODE_POLICY Flags(int Flags);
            public native @Cast("DWORD") @NoOffset int ProhibitDynamicCode(); public native PROCESS_MITIGATION_DYNAMIC_CODE_POLICY ProhibitDynamicCode(int ProhibitDynamicCode);
            public native @Cast("DWORD") @NoOffset int ReservedFlags(); public native PROCESS_MITIGATION_DYNAMIC_CODE_POLICY ReservedFlags(int ReservedFlags);
}
