...
public class ACCESS_DENIED_ACE extends Pointer {
    ...
    public native @ByRef ACE_HEADER Header(); public native ACCESS_DENIED_ACE Header(ACE_HEADER Header);
    public native @Cast("ACCESS_MASK") int Mask(); public native ACCESS_DENIED_ACE Mask(int Mask);
    public native @Cast("DWORD") int SidStart(); public native ACCESS_DENIED_ACE SidStart(int SidStart);
}
