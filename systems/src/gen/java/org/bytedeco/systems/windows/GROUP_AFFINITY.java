...
public class GROUP_AFFINITY extends Pointer {
    ...
    public native @Cast("KAFFINITY") long Mask(); public native GROUP_AFFINITY Mask(long Mask);
    public native @Cast("WORD") short Group(); public native GROUP_AFFINITY Group(short Group);
    public native @Cast("WORD") short Reserved(int i); public native GROUP_AFFINITY Reserved(int i, short Reserved);
