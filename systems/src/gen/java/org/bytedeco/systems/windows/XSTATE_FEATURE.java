...
public class XSTATE_FEATURE extends Pointer {
    ...
    public native @Cast("DWORD") int Offset(); public native XSTATE_FEATURE Offset(int Offset);
    public native @Cast("DWORD") int Size(); public native XSTATE_FEATURE Size(int Size);
}
