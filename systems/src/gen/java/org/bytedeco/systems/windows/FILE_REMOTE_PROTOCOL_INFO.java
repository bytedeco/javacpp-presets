...
public class FILE_REMOTE_PROTOCOL_INFO extends Pointer {
    ...
    // Structure Version
    public native @Cast("USHORT") short StructureVersion(); public native FILE_REMOTE_PROTOCOL_INFO StructureVersion(short setter);     // 1 for Win7, 2 for Win8 SMB3, 3 for Blue SMB3.
