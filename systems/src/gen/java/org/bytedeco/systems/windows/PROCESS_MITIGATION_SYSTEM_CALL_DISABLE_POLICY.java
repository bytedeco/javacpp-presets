...
public class PROCESS_MITIGATION_SYSTEM_CALL_DISABLE_POLICY extends Pointer {
    ...
    @Override public PROCESS_MITIGATION_SYSTEM_CALL_DISABLE_POLICY position(long position) {
        ...
        public native @Cast("DWORD") int Flags(); public native PROCESS_MITIGATION_SYSTEM_CALL_DISABLE_POLICY Flags(int Flags);
            public native @Cast("DWORD") @NoOffset int DisallowWin32kSystemCalls(); public native PROCESS_MITIGATION_SYSTEM_CALL_DISABLE_POLICY DisallowWin32kSystemCalls(int DisallowWin32kSystemCalls);
            public native @Cast("DWORD") @NoOffset int ReservedFlags(); public native PROCESS_MITIGATION_SYSTEM_CALL_DISABLE_POLICY ReservedFlags(int ReservedFlags);
}
