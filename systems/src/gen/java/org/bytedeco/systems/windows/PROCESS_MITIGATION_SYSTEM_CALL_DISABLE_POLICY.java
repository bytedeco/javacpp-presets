...
public class PROCESS_MITIGATION_SYSTEM_CALL_DISABLE_POLICY extends Pointer {
    ...
    @Override public PROCESS_MITIGATION_SYSTEM_CALL_DISABLE_POLICY getPointer(long i) {
        ...
        public native @Cast("DWORD") int Flags(); public native PROCESS_MITIGATION_SYSTEM_CALL_DISABLE_POLICY Flags(int setter);
            ...
            public native @Cast("DWORD") @NoOffset int AuditDisallowWin32kSystemCalls(); public native PROCESS_MITIGATION_SYSTEM_CALL_DISABLE_POLICY AuditDisallowWin32kSystemCalls(int setter);
            public native @Cast("DWORD") @NoOffset int DisallowFsctlSystemCalls(); public native PROCESS_MITIGATION_SYSTEM_CALL_DISABLE_POLICY DisallowFsctlSystemCalls(int setter);
            public native @Cast("DWORD") @NoOffset int AuditDisallowFsctlSystemCalls(); public native PROCESS_MITIGATION_SYSTEM_CALL_DISABLE_POLICY AuditDisallowFsctlSystemCalls(int setter);
