...
public class SET_POWER_SETTING_VALUE extends Pointer {
    ...
    //
    public native @Cast("DWORD") int Version(); public native SET_POWER_SETTING_VALUE Version(int Version);


    //
    // GUID representing the power setting being applied.
    //
    public native @ByRef GUID Guid(); public native SET_POWER_SETTING_VALUE Guid(GUID Guid);
    ...
    // AC, DC, thermal, ...
    //
    public native @Cast("SYSTEM_POWER_CONDITION") int PowerCondition(); public native SET_POWER_SETTING_VALUE PowerCondition(int PowerCondition);

    //
    // Length (in bytes) of the 'Data' member.
    //
    public native @Cast("DWORD") int DataLength(); public native SET_POWER_SETTING_VALUE DataLength(int DataLength);

    //
    // Data which contains the actual setting value.
    //
    public native @Cast("BYTE") byte Data(int i); public native SET_POWER_SETTING_VALUE Data(int i, byte Data);
