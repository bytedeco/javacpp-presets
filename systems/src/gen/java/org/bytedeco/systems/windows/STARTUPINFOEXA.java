...
public class STARTUPINFOEXA extends Pointer {
    ...
    public native @ByRef STARTUPINFOA StartupInfo(); public native STARTUPINFOEXA StartupInfo(STARTUPINFOA StartupInfo);
    public native _PROC_THREAD_ATTRIBUTE_LIST lpAttributeList(); public native STARTUPINFOEXA lpAttributeList(_PROC_THREAD_ATTRIBUTE_LIST lpAttributeList);
}
