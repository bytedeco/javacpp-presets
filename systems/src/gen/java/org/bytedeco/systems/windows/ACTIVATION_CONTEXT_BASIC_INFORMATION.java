...
public class ACTIVATION_CONTEXT_BASIC_INFORMATION extends Pointer {
    ...
    public native @Cast("HANDLE") Pointer hActCtx(); public native ACTIVATION_CONTEXT_BASIC_INFORMATION hActCtx(Pointer hActCtx);
    public native @Cast("DWORD") int dwFlags(); public native ACTIVATION_CONTEXT_BASIC_INFORMATION dwFlags(int dwFlags);
}
