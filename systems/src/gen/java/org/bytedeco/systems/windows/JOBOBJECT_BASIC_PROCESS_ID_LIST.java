...
public class JOBOBJECT_BASIC_PROCESS_ID_LIST extends Pointer {
    ...
    public native @Cast("DWORD") int NumberOfAssignedProcesses(); public native JOBOBJECT_BASIC_PROCESS_ID_LIST NumberOfAssignedProcesses(int NumberOfAssignedProcesses);
    public native @Cast("DWORD") int NumberOfProcessIdsInList(); public native JOBOBJECT_BASIC_PROCESS_ID_LIST NumberOfProcessIdsInList(int NumberOfProcessIdsInList);
    public native @Cast("ULONG_PTR") long ProcessIdList(int i); public native JOBOBJECT_BASIC_PROCESS_ID_LIST ProcessIdList(int i, long ProcessIdList);
