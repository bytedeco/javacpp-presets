...
public class FILE_SEGMENT_ELEMENT extends Pointer {
    ...
    public native @Cast("PVOID64") Pointer Buffer(); public native FILE_SEGMENT_ELEMENT Buffer(Pointer Buffer);
    public native @Cast("ULONGLONG") long Alignment(); public native FILE_SEGMENT_ELEMENT Alignment(long Alignment);
}
