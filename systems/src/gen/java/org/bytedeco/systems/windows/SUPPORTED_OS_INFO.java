...
public class SUPPORTED_OS_INFO extends Pointer {
    ...
    public native @Cast("WORD") short OsCount(); public native SUPPORTED_OS_INFO OsCount(short OsCount);
    public native @Cast("WORD") short MitigationExist(); public native SUPPORTED_OS_INFO MitigationExist(short MitigationExist);
    public native @Cast("WORD") short OsList(int i); public native SUPPORTED_OS_INFO OsList(int i, short OsList);
