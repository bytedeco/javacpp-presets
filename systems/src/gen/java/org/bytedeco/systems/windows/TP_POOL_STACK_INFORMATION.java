...
public class TP_POOL_STACK_INFORMATION extends Pointer {
    ...
    public native @Cast("SIZE_T") long StackReserve(); public native TP_POOL_STACK_INFORMATION StackReserve(long StackReserve);
    public native @Cast("SIZE_T") long StackCommit(); public native TP_POOL_STACK_INFORMATION StackCommit(long StackCommit);
}
