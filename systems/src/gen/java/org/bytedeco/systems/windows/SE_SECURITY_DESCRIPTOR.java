...
public class SE_SECURITY_DESCRIPTOR extends Pointer {
    ...
    public native @Cast("DWORD") int Size(); public native SE_SECURITY_DESCRIPTOR Size(int Size);
    public native @Cast("DWORD") int Flags(); public native SE_SECURITY_DESCRIPTOR Flags(int Flags);
    public native @Cast("PSECURITY_DESCRIPTOR") Pointer SecurityDescriptor(); public native SE_SECURITY_DESCRIPTOR SecurityDescriptor(Pointer SecurityDescriptor);
}
