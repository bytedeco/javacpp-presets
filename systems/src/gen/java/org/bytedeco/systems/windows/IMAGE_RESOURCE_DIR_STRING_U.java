...
public class IMAGE_RESOURCE_DIR_STRING_U extends Pointer {
    ...
    public native @Cast("WORD") short Length(); public native IMAGE_RESOURCE_DIR_STRING_U Length(short Length);
    public native @Cast("WCHAR") char NameString(int i); public native IMAGE_RESOURCE_DIR_STRING_U NameString(int i, char NameString);
