...
public class PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY extends Pointer {
    ...
    @Override public PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY getPointer(long i) {
        return new PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY((Pointer)this).offsetAddress(i);
    }
        ...
        public native @Cast("DWORD") int Flags(); public native PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY Flags(int setter);
            ...
            public native @Cast("DWORD") @NoOffset int StoreSignedOnly(); public native PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY StoreSignedOnly(int setter);
            public native @Cast("DWORD") @NoOffset int MitigationOptIn(); public native PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY MitigationOptIn(int setter);
            public native @Cast("DWORD") @NoOffset int AuditMicrosoftSignedOnly(); public native PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY AuditMicrosoftSignedOnly(int setter);
            public native @Cast("DWORD") @NoOffset int AuditStoreSignedOnly(); public native PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY AuditStoreSignedOnly(int setter);
