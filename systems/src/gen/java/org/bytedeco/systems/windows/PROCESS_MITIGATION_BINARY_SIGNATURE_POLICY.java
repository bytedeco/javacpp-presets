...
public class PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY extends Pointer {
    ...
    @Override public PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY position(long position) {
        ...
        public native @Cast("DWORD") int Flags(); public native PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY Flags(int Flags);
            public native @Cast("DWORD") @NoOffset int MicrosoftSignedOnly(); public native PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY MicrosoftSignedOnly(int MicrosoftSignedOnly);
            public native @Cast("DWORD") @NoOffset int ReservedFlags(); public native PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY ReservedFlags(int ReservedFlags);
}
