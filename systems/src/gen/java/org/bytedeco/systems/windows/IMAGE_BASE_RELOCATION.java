...
public class IMAGE_BASE_RELOCATION extends Pointer {
    ...
    public native @Cast("DWORD") int VirtualAddress(); public native IMAGE_BASE_RELOCATION VirtualAddress(int VirtualAddress);
    public native @Cast("DWORD") int SizeOfBlock(); public native IMAGE_BASE_RELOCATION SizeOfBlock(int SizeOfBlock);
//  WORD    TypeOffset[1];
}
