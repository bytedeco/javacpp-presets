...
public class MESSAGE_RESOURCE_ENTRY extends Pointer {
    ...
    public native @Cast("WORD") short Length(); public native MESSAGE_RESOURCE_ENTRY Length(short Length);
    public native @Cast("WORD") short Flags(); public native MESSAGE_RESOURCE_ENTRY Flags(short Flags);
    public native @Cast("BYTE") byte Text(int i); public native MESSAGE_RESOURCE_ENTRY Text(int i, byte Text);
