...
public class ACL_SIZE_INFORMATION extends Pointer {
    ...
    public native @Cast("DWORD") int AceCount(); public native ACL_SIZE_INFORMATION AceCount(int AceCount);
    public native @Cast("DWORD") int AclBytesInUse(); public native ACL_SIZE_INFORMATION AclBytesInUse(int AclBytesInUse);
    public native @Cast("DWORD") int AclBytesFree(); public native ACL_SIZE_INFORMATION AclBytesFree(int AclBytesFree);
}
