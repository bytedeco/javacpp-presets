...
public class UMS_CREATE_THREAD_ATTRIBUTES extends Pointer {
    ...
    public native @Cast("DWORD") int UmsVersion(); public native UMS_CREATE_THREAD_ATTRIBUTES UmsVersion(int UmsVersion);   
        public native @Cast("PVOID") Pointer UmsContext(); public native UMS_CREATE_THREAD_ATTRIBUTES UmsContext(Pointer UmsContext);   
        public native @Cast("PVOID") Pointer UmsCompletionList(); public native UMS_CREATE_THREAD_ATTRIBUTES UmsCompletionList(Pointer UmsCompletionList);   
}
