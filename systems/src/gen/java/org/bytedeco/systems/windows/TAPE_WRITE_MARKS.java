...
public class TAPE_WRITE_MARKS extends Pointer {
    ...
    public native @Cast("DWORD") int Type(); public native TAPE_WRITE_MARKS Type(int Type);
    public native @Cast("DWORD") int Count(); public native TAPE_WRITE_MARKS Count(int Count);
    public native @Cast("BOOLEAN") boolean Immediate(); public native TAPE_WRITE_MARKS Immediate(boolean Immediate);
}
