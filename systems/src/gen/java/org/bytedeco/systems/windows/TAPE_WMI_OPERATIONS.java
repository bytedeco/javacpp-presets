...
public class TAPE_WMI_OPERATIONS extends Pointer {
   ...
   public native @Cast("DWORD") int Method(); public native TAPE_WMI_OPERATIONS Method(int Method);
   public native @Cast("DWORD") int DataBufferSize(); public native TAPE_WMI_OPERATIONS DataBufferSize(int DataBufferSize);
   public native @Cast("PVOID") Pointer DataBuffer(); public native TAPE_WMI_OPERATIONS DataBuffer(Pointer DataBuffer);
}
