...
public class STARTUPINFOEXW extends Pointer {
    ...
    public native @ByRef STARTUPINFOW StartupInfo(); public native STARTUPINFOEXW StartupInfo(STARTUPINFOW StartupInfo);
    public native _PROC_THREAD_ATTRIBUTE_LIST lpAttributeList(); public native STARTUPINFOEXW lpAttributeList(_PROC_THREAD_ATTRIBUTE_LIST lpAttributeList);
}
