...
public class FLOAT128 extends Pointer {
    ...
    public native @Cast("__int64") long LowPart(); public native FLOAT128 LowPart(long LowPart);
    public native @Cast("__int64") long HighPart(); public native FLOAT128 HighPart(long HighPart);
}
