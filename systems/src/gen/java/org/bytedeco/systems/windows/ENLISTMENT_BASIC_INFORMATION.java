...
public class ENLISTMENT_BASIC_INFORMATION extends Pointer {
    ...
    public native @ByRef GUID EnlistmentId(); public native ENLISTMENT_BASIC_INFORMATION EnlistmentId(GUID EnlistmentId);
    public native @ByRef GUID TransactionId(); public native ENLISTMENT_BASIC_INFORMATION TransactionId(GUID TransactionId);
    public native @ByRef GUID ResourceManagerId(); public native ENLISTMENT_BASIC_INFORMATION ResourceManagerId(GUID ResourceManagerId);
}
