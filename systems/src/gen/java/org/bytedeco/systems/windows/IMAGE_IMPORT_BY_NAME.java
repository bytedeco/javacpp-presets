...
public class IMAGE_IMPORT_BY_NAME extends Pointer {
    ...
    public native @Cast("WORD") short Hint(); public native IMAGE_IMPORT_BY_NAME Hint(short Hint);
    public native @Cast("CHAR") byte Name(int i); public native IMAGE_IMPORT_BY_NAME Name(int i, byte Name);
