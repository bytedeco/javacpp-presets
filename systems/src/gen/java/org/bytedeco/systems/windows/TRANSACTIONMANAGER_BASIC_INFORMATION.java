...
public class TRANSACTIONMANAGER_BASIC_INFORMATION extends Pointer {
    ...
    public native @ByRef GUID TmIdentity(); public native TRANSACTIONMANAGER_BASIC_INFORMATION TmIdentity(GUID TmIdentity);
    public native @ByRef LARGE_INTEGER VirtualClock(); public native TRANSACTIONMANAGER_BASIC_INFORMATION VirtualClock(LARGE_INTEGER VirtualClock);
}
