...
public class IMAGE_ARCHIVE_MEMBER_HEADER extends Pointer {
    ...
    public native @Cast("BYTE") byte Name(int i); public native IMAGE_ARCHIVE_MEMBER_HEADER Name(int i, byte Name);
    @MemberGetter public native @Cast("BYTE*") BytePointer Name();                          // File member name - `/' terminated.
    public native @Cast("BYTE") byte Date(int i); public native IMAGE_ARCHIVE_MEMBER_HEADER Date(int i, byte Date);
    @MemberGetter public native @Cast("BYTE*") BytePointer Date();                          // File member date - decimal.
    public native @Cast("BYTE") byte UserID(int i); public native IMAGE_ARCHIVE_MEMBER_HEADER UserID(int i, byte UserID);
    @MemberGetter public native @Cast("BYTE*") BytePointer UserID();                         // File member user id - decimal.
    public native @Cast("BYTE") byte GroupID(int i); public native IMAGE_ARCHIVE_MEMBER_HEADER GroupID(int i, byte GroupID);
    @MemberGetter public native @Cast("BYTE*") BytePointer GroupID();                        // File member group id - decimal.
    public native @Cast("BYTE") byte Mode(int i); public native IMAGE_ARCHIVE_MEMBER_HEADER Mode(int i, byte Mode);
    @MemberGetter public native @Cast("BYTE*") BytePointer Mode();                           // File member mode - octal.
    public native @Cast("BYTE") byte Size(int i); public native IMAGE_ARCHIVE_MEMBER_HEADER Size(int i, byte Size);
    @MemberGetter public native @Cast("BYTE*") BytePointer Size();                          // File member size - decimal.
    public native @Cast("BYTE") byte EndHeader(int i); public native IMAGE_ARCHIVE_MEMBER_HEADER EndHeader(int i, byte EndHeader);
