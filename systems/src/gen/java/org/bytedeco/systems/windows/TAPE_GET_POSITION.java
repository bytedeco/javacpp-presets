...
public class TAPE_GET_POSITION extends Pointer {
    ...
    public native @Cast("DWORD") int Type(); public native TAPE_GET_POSITION Type(int Type);
    public native @Cast("DWORD") int Partition(); public native TAPE_GET_POSITION Partition(int Partition);
    public native @ByRef LARGE_INTEGER Offset(); public native TAPE_GET_POSITION Offset(LARGE_INTEGER Offset);
}
