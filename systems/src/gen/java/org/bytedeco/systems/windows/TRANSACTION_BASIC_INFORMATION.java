...
public class TRANSACTION_BASIC_INFORMATION extends Pointer {
    ...
    public native @ByRef GUID TransactionId(); public native TRANSACTION_BASIC_INFORMATION TransactionId(GUID TransactionId);
    public native @Cast("DWORD") int State(); public native TRANSACTION_BASIC_INFORMATION State(int State);
    public native @Cast("DWORD") int Outcome(); public native TRANSACTION_BASIC_INFORMATION Outcome(int Outcome);
}
