...
public class linux extends org.bytedeco.javacpp.presets.linux {
    static { Loader.load(); }
...
public static class Dl_serpath extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
  ...
  public native @Cast("char*") BytePointer dls_name(); public native Dl_serpath dls_name(BytePointer dls_name);		/* Name of library search path directory.  */
  public native @Cast("unsigned int") int dls_flags(); public native Dl_serpath dls_flags(int dls_flags);	/* Indicates where this directory came from. */
}

/* This is the structure that must be passed (by reference) to `dlinfo' for
   the RTLD_DI_SERINFO and RTLD_DI_SERINFOSIZE requests.  */
public static class Dl_serinfo extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
  ...
  public native @Cast("size_t") long dls_size(); public native Dl_serinfo dls_size(long dls_size);		/* Size in bytes of the whole buffer.  */
  public native @Cast("unsigned int") int dls_cnt(); public native Dl_serinfo dls_cnt(int dls_cnt);		/* Number of elements in `dls_serpath'.  */
  public native @ByRef Dl_serpath dls_serpath(int i); public native Dl_serinfo dls_serpath(int i, Dl_serpath dls_serpath);
...
@Namespace @Name("void") @Opaque public static class nl_catd extends Pointer {
...
@Name("__locale_struct") public static class locale_t extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class iovec extends Pointer {
    ...
    public native Pointer iov_base(); public native iovec iov_base(Pointer iov_base);	/* Pointer to data.  */
    public native @Cast("size_t") long iov_len(); public native iovec iov_len(long iov_len);	/* Length of data.  */
  }
...
public static class sockaddr_storage extends Pointer {
    ...
    public native @Cast("sa_family_t") short ss_family(); public native sockaddr_storage ss_family(short ss_family);	/* Address family, etc.  */
    public native @Cast("char") byte __ss_padding(int i); public native sockaddr_storage __ss_padding(int i, byte __ss_padding);
    @MemberGetter public native @Cast("char*") BytePointer __ss_padding();
    public native @Cast("unsigned long int") long __ss_align(); public native sockaddr_storage __ss_align(long __ss_align);	/* Force desired alignment.  */
  }
...
// #ifdef __USE_GNU
/* For `recvmmsg'.  */
public static class mmsghdr extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class cmsghdr extends Pointer {
    ...
    public native @Cast("size_t") long cmsg_len(); public native cmsghdr cmsg_len(long cmsg_len);		/* Length of data in cmsg_data plus length
				   of cmsghdr structure.
				   !! The type should be socklen_t but the
				   definition of the kernel is incompatible
				   with this.  */
    public native int cmsg_level(); public native cmsghdr cmsg_level(int cmsg_level);		/* Originating protocol.  */
    public native int cmsg_type(); public native cmsghdr cmsg_type(int cmsg_type);		/* Protocol specific type.  */
...
public static class ucred extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class osockaddr extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class lldiv_t extends Pointer {
    ...
    public native long quot(); public native lldiv_t quot(long quot);		/* Quotient.  */
    public native long rem(); public native lldiv_t rem(long rem);		/* Remainder.  */
  }
...
public static class random_data extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class drand48_data extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class __func extends FunctionPointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
...
public static class __func_int_Pointer extends FunctionPointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
...
public static class __compar_fn_t extends FunctionPointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
...
// #endif
// #ifdef __USE_GNU
public static class __compar_d_fn_t extends FunctionPointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public    __compar_d_fn_t(Pointer p) { super(p); }
    protected __compar_d_fn_t() { allocate(); }
    private native void allocate();
...
@Name("struct timezone") public static class timezone extends Pointer {
    ...
    public native int tz_minuteswest(); public native timezone tz_minuteswest(int tz_minuteswest);		/* Minutes west of GMT.  */
    public native int tz_dsttime(); public native timezone tz_dsttime(int tz_dsttime);		/* Nonzero if DST is ever in effect.  */
  }
// #else
// #endif
...
public static class itimerval extends Pointer {
    ...
    public native @ByRef timeval it_interval(); public native itimerval it_interval(timeval it_interval);
    /* Time to the next timer expiration.  */
    public native @ByRef timeval it_value(); public native itimerval it_value(timeval it_value);
  }
...
public static class utimbuf extends Pointer {
    ...
    public native @Cast("__time_t") long actime(); public native utimbuf actime(long actime);		/* Access time.  */
    public native @Cast("__time_t") long modtime(); public native utimbuf modtime(long modtime);		/* Modification time.  */
  }
...
@Name("struct stat") public static class stat extends Pointer {
    ...
    public native @Cast("__dev_t") long st_dev(); public native stat st_dev(long st_dev);		/* Device.  */
// #if __WORDSIZE == 32
// #endif
// #if __WORDSIZE == 64 || !defined __USE_FILE_OFFSET64
    public native @Cast("__ino_t") long st_ino(); public native stat st_ino(long st_ino);		/* File serial number.	*/
// #else
// #endif
// #if __WORDSIZE == 32
// #else
    public native @Cast("__nlink_t") long st_nlink(); public native stat st_nlink(long st_nlink);		/* Link count.  */
    public native @Cast("__mode_t") int st_mode(); public native stat st_mode(int st_mode);		/* File mode.  */
// #endif
    public native @Cast("__uid_t") int st_uid(); public native stat st_uid(int st_uid);		/* User ID of the file's owner.	*/
    public native @Cast("__gid_t") int st_gid(); public native stat st_gid(int st_gid);		/* Group ID of the file's group.*/
// #if __WORDSIZE == 64
    public native int __pad0(); public native stat __pad0(int __pad0);
// #endif
    public native @Cast("__dev_t") long st_rdev(); public native stat st_rdev(long st_rdev);		/* Device number, if device.  */
// #if __WORDSIZE == 32
// #endif
// #if __WORDSIZE == 64 || !defined __USE_FILE_OFFSET64
    public native @Cast("__off_t") long st_size(); public native stat st_size(long st_size);			/* Size of file, in bytes.  */
// #else
// #endif
    public native @Cast("__blksize_t") long st_blksize(); public native stat st_blksize(long st_blksize);	/* Optimal block size for I/O.  */
// #if __WORDSIZE == 64 || !defined __USE_FILE_OFFSET64
    public native @Cast("__blkcnt_t") long st_blocks(); public native stat st_blocks(long st_blocks);		/* Number 512-byte blocks allocated. */
// #else
// #endif
// #if defined __USE_MISC || defined __USE_XOPEN2K8
    ...
    public native @ByRef timespec st_atim(); public native stat st_atim(timespec st_atim);		/* Time of last access.  */
    public native @ByRef timespec st_mtim(); public native stat st_mtim(timespec st_mtim);		/* Time of last modification.  */
    public native @ByRef timespec st_ctim(); public native stat st_ctim(timespec st_ctim);		/* Time of last status change.  */
// #else
// #endif
// #if __WORDSIZE == 64
    public native long __unused(int i); public native stat __unused(int i, long __unused);
...
public static class group extends Pointer {
    ...
    public native @Cast("char*") BytePointer gr_name(); public native group gr_name(BytePointer gr_name);		/* Group name.	*/
    public native @Cast("char*") BytePointer gr_passwd(); public native group gr_passwd(BytePointer gr_passwd);		/* Password.	*/
    public native @Cast("__gid_t") int gr_gid(); public native group gr_gid(int gr_gid);		/* Group ID.	*/
    public native @Cast("char*") BytePointer gr_mem(int i); public native group gr_mem(int i, BytePointer gr_mem);
    public native @Cast("char**") PointerPointer gr_mem(); public native group gr_mem(PointerPointer gr_mem);		/* Member list.	*/
  }
...
@Name("sigval_t") public static class sigval extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class sigevent_t extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
@Name("__sigset_t") public static class sigset_t extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    ...
    public native @Cast("unsigned long int") long __val(int i); public native sigset_t __val(int i, long __val);
...
public static class _fpreg extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public _fpreg() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public _fpreg(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public _fpreg(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public _fpreg position(long position) {
        return (_fpreg)super.position(position);
    }

  public native @Cast("unsigned short") short significand(int i); public native _fpreg significand(int i, short significand);
  @MemberGetter public native @Cast("unsigned short*") ShortPointer significand();
  public native @Cast("unsigned short") short exponent(); public native _fpreg exponent(short exponent);
}

public static class _fpxreg extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public _fpxreg() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public _fpxreg(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public _fpxreg(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public _fpxreg position(long position) {
        return (_fpxreg)super.position(position);
    }

  public native @Cast("unsigned short") short significand(int i); public native _fpxreg significand(int i, short significand);
  @MemberGetter public native @Cast("unsigned short*") ShortPointer significand();
  public native @Cast("unsigned short") short exponent(); public native _fpxreg exponent(short exponent);
  public native @Cast("unsigned short") short padding(int i); public native _fpxreg padding(int i, short padding);
  @MemberGetter public native @Cast("unsigned short*") ShortPointer padding();
}

public static class _xmmreg extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public _xmmreg() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public _xmmreg(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public _xmmreg(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public _xmmreg position(long position) {
        return (_xmmreg)super.position(position);
    }

  public native @Cast("__uint32_t") int element(int i); public native _xmmreg element(int i, int element);
  @MemberGetter public native @Cast("__uint32_t*") IntPointer element();
}
...
public static class _fpstate extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public _fpstate() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public _fpstate(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public _fpstate(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public _fpstate position(long position) {
        return (_fpstate)super.position(position);
    }

  /* FPU environment matching the 64-bit FXSAVE layout.  */
  public native @Cast("__uint16_t") short cwd(); public native _fpstate cwd(short cwd);
  public native @Cast("__uint16_t") short swd(); public native _fpstate swd(short swd);
  public native @Cast("__uint16_t") short ftw(); public native _fpstate ftw(short ftw);
  public native @Cast("__uint16_t") short fop(); public native _fpstate fop(short fop);
  public native @Cast("__uint64_t") long rip(); public native _fpstate rip(long rip);
  public native @Cast("__uint64_t") long rdp(); public native _fpstate rdp(long rdp);
  public native @Cast("__uint32_t") int mxcsr(); public native _fpstate mxcsr(int mxcsr);
  public native @Cast("__uint32_t") int mxcr_mask(); public native _fpstate mxcr_mask(int mxcr_mask);
  public native @ByRef _fpxreg _st(int i); public native _fpstate _st(int i, _fpxreg _st);
  @MemberGetter public native _fpxreg _st();
  public native @ByRef _xmmreg _xmm(int i); public native _fpstate _xmm(int i, _xmmreg _xmm);
  @MemberGetter public native _xmmreg _xmm();
  public native @Cast("__uint32_t") int padding(int i); public native _fpstate padding(int i, int padding);
  @MemberGetter public native @Cast("__uint32_t*") IntPointer padding();
}

public static class sigcontext extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public sigcontext() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public sigcontext(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public sigcontext(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public sigcontext position(long position) {
        return (sigcontext)super.position(position);
    }

  public native @Cast("unsigned long") long r8(); public native sigcontext r8(long r8);
  public native @Cast("unsigned long") long r9(); public native sigcontext r9(long r9);
  public native @Cast("unsigned long") long r10(); public native sigcontext r10(long r10);
  public native @Cast("unsigned long") long r11(); public native sigcontext r11(long r11);
  public native @Cast("unsigned long") long r12(); public native sigcontext r12(long r12);
  public native @Cast("unsigned long") long r13(); public native sigcontext r13(long r13);
  public native @Cast("unsigned long") long r14(); public native sigcontext r14(long r14);
  public native @Cast("unsigned long") long r15(); public native sigcontext r15(long r15);
  public native @Cast("unsigned long") long rdi(); public native sigcontext rdi(long rdi);
  public native @Cast("unsigned long") long rsi(); public native sigcontext rsi(long rsi);
  public native @Cast("unsigned long") long rbp(); public native sigcontext rbp(long rbp);
  public native @Cast("unsigned long") long rbx(); public native sigcontext rbx(long rbx);
  public native @Cast("unsigned long") long rdx(); public native sigcontext rdx(long rdx);
  public native @Cast("unsigned long") long rax(); public native sigcontext rax(long rax);
  public native @Cast("unsigned long") long rcx(); public native sigcontext rcx(long rcx);
  public native @Cast("unsigned long") long rsp(); public native sigcontext rsp(long rsp);
  public native @Cast("unsigned long") long rip(); public native sigcontext rip(long rip);
  public native @Cast("unsigned long") long eflags(); public native sigcontext eflags(long eflags);
  public native @Cast("unsigned short") short cs(); public native sigcontext cs(short cs);
  public native @Cast("unsigned short") short gs(); public native sigcontext gs(short gs);
  public native @Cast("unsigned short") short fs(); public native sigcontext fs(short fs);
  public native @Cast("unsigned short") short __pad0(); public native sigcontext __pad0(short __pad0);
  public native @Cast("unsigned long") long err(); public native sigcontext err(long err);
  public native @Cast("unsigned long") long trapno(); public native sigcontext trapno(long trapno);
  public native @Cast("unsigned long") long oldmask(); public native sigcontext oldmask(long oldmask);
  public native @Cast("unsigned long") long cr2(); public native sigcontext cr2(long cr2);
  public native _fpstate fpstate(); public native sigcontext fpstate(_fpstate fpstate);
  public native @Cast("unsigned long") long __reserved1(int i); public native sigcontext __reserved1(int i, long __reserved1);
...
@Name("struct sigstack") public static class sigstack extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    ...
    public native Pointer ss_sp(); public native sigstack ss_sp(Pointer ss_sp);		/* Signal stack pointer.  */
    public native int ss_onstack(); public native sigstack ss_onstack(int ss_onstack);		/* Nonzero if executing on this stack.  */
  }
...
public static class stack_t extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class __sighandler_t extends FunctionPointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
...
public static class _libc_fpxreg extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public _libc_fpxreg() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public _libc_fpxreg(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public _libc_fpxreg(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public _libc_fpxreg position(long position) {
        return (_libc_fpxreg)super.position(position);
    }

  public native @Cast("unsigned short int") short significand(int i); public native _libc_fpxreg significand(int i, short significand);
  @MemberGetter public native @Cast("unsigned short int*") ShortPointer significand();
  public native @Cast("unsigned short int") short exponent(); public native _libc_fpxreg exponent(short exponent);
  public native @Cast("unsigned short int") short padding(int i); public native _libc_fpxreg padding(int i, short padding);
  @MemberGetter public native @Cast("unsigned short int*") ShortPointer padding();
}

public static class _libc_xmmreg extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public _libc_xmmreg() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public _libc_xmmreg(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public _libc_xmmreg(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public _libc_xmmreg position(long position) {
        return (_libc_xmmreg)super.position(position);
    }

  public native @Cast("__uint32_t") int element(int i); public native _libc_xmmreg element(int i, int element);
  @MemberGetter public native @Cast("__uint32_t*") IntPointer element();
}

public static class _libc_fpstate extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public _libc_fpstate() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public _libc_fpstate(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public _libc_fpstate(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public _libc_fpstate position(long position) {
        return (_libc_fpstate)super.position(position);
    }

  /* 64-bit FXSAVE format.  */
  public native @Cast("__uint16_t") short cwd(); public native _libc_fpstate cwd(short cwd);
  public native @Cast("__uint16_t") short swd(); public native _libc_fpstate swd(short swd);
  public native @Cast("__uint16_t") short ftw(); public native _libc_fpstate ftw(short ftw);
  public native @Cast("__uint16_t") short fop(); public native _libc_fpstate fop(short fop);
  public native @Cast("__uint64_t") long rip(); public native _libc_fpstate rip(long rip);
  public native @Cast("__uint64_t") long rdp(); public native _libc_fpstate rdp(long rdp);
  public native @Cast("__uint32_t") int mxcsr(); public native _libc_fpstate mxcsr(int mxcsr);
  public native @Cast("__uint32_t") int mxcr_mask(); public native _libc_fpstate mxcr_mask(int mxcr_mask);
  public native @ByRef _libc_fpxreg _st(int i); public native _libc_fpstate _st(int i, _libc_fpxreg _st);
  @MemberGetter public native _libc_fpxreg _st();
  public native @ByRef _libc_xmmreg _xmm(int i); public native _libc_fpstate _xmm(int i, _libc_xmmreg _xmm);
  @MemberGetter public native _libc_xmmreg _xmm();
  public native @Cast("__uint32_t") int padding(int i); public native _libc_fpstate padding(int i, int padding);
  @MemberGetter public native @Cast("__uint32_t*") IntPointer padding();
}
...
public static class mcontext_t extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
/* Userlevel context.  */
public static class ucontext_t extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    ...
    public native @ByRef _libc_fpstate __fpregs_mem(); public native ucontext_t __fpregs_mem(_libc_fpstate __fpregs_mem);
  }
...
public static class __fn_Pointer extends FunctionPointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
...
public static class __sched_param extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    ...
    public native int __sched_priority(); public native __sched_param __sched_priority(int __sched_priority);
  }
...
public static class cpu_set_t extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
  ...
  public native @Cast("__cpu_mask") long __bits(int i); public native cpu_set_t __bits(int i, long __bits);
...
public static class posix_spawnattr_t extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
public static class posix_spawn_file_actions_t extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
  ...
  public native int __allocated(); public native posix_spawn_file_actions_t __allocated(int __allocated);
  public native int __used(); public native posix_spawn_file_actions_t __used(int __used);
  public native @Cast("__spawn_action*") Pointer __actions(); public native posix_spawn_file_actions_t __actions(Pointer __actions);
  public native int __pad(int i); public native posix_spawn_file_actions_t __pad(int i, int __pad);
  @MemberGetter public native @Cast("int*") IntPointer __pad();
}
...
// #ifdef __USE_LARGEFILE64
public static class rlimit64 extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    ...
    /* The current (soft) limit.  */
    public native @Cast("rlim64_t") long rlim_cur(); public native rlimit64 rlim_cur(long rlim_cur);
    /* The hard limit.  */
    public native @Cast("rlim64_t") long rlim_max(); public native rlimit64 rlim_max(long rlim_max);
 }
// #endif
...
@Name("struct sysinfo") public static class sysinfo extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
...
@Opaque public static class module extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public module() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
...
public static native void mark_tech_preview(@Cast("const char*") BytePointer msg, module mod);
public static native void mark_tech_preview(String msg, module mod);
// #else
// #endif
