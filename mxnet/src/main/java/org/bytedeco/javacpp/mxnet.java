 ...
 * @return 0 when success, -1 when failure happens.
 */
public static native int MXSetProfilerConfig(int mode, @Cast("const char*") BytePointer filename);
public static native int MXSetProfilerConfig(int mode, String filename);
/**
