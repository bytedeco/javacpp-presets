...
public static class CustomOpInfo extends Pointer {
  ...
  public static class Forward_int_PointerPointer_IntPointer_IntPointer_boolean extends FunctionPointer {
      static { Loader.load(); }
      /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
      public    Forward_int_PointerPointer_IntPointer_IntPointer_boolean(Pointer p) { super(p); }
      protected Forward_int_PointerPointer_IntPointer_IntPointer_boolean() { allocate(); }
      private native void allocate();
      public native @Cast("bool") boolean call(int arg0, @Cast("void**") PointerPointer arg1, IntPointer arg2,
                    @Const IntPointer arg3, @Cast("const bool") boolean arg4);
  }
  public native Forward_int_PointerPointer_IntPointer_IntPointer_boolean forward(); public native CustomOpInfo forward(Forward_int_PointerPointer_IntPointer_IntPointer_boolean forward);
  public static class Backward_int_PointerPointer_IntPointer_IntPointer_boolean extends FunctionPointer {
      static { Loader.load(); }
      /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
      public    Backward_int_PointerPointer_IntPointer_IntPointer_boolean(Pointer p) { super(p); }
      protected Backward_int_PointerPointer_IntPointer_IntPointer_boolean() { allocate(); }
      private native void allocate();
      public native @Cast("bool") boolean call(int arg0, @Cast("void**") PointerPointer arg1, IntPointer arg2,
                     @Const IntPointer arg3, @Cast("const bool") boolean arg4);
  }
  public native Backward_int_PointerPointer_IntPointer_IntPointer_boolean backward(); public native CustomOpInfo backward(Backward_int_PointerPointer_IntPointer_IntPointer_boolean backward);
}
...
public static class CustomOpPropInfo extends Pointer {
  ...
  public static class List_arguments_PointerPointer extends FunctionPointer {
      static { Loader.load(); }
      /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
      public    List_arguments_PointerPointer(Pointer p) { super(p); }
      protected List_arguments_PointerPointer() { allocate(); }
      private native void allocate();
      public native @Cast("bool") boolean call(@Cast("char***") PointerPointer arg0);
  }
  public native List_arguments_PointerPointer list_arguments(); public native CustomOpPropInfo list_arguments(List_arguments_PointerPointer list_arguments);
  public static class List_outputs_PointerPointer extends FunctionPointer {
      static { Loader.load(); }
      /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
      public    List_outputs_PointerPointer(Pointer p) { super(p); }
      protected List_outputs_PointerPointer() { allocate(); }
      private native void allocate();
      public native @Cast("bool") boolean call(@Cast("char***") PointerPointer arg0);
  }
  public native List_outputs_PointerPointer list_outputs(); public native CustomOpPropInfo list_outputs(List_outputs_PointerPointer list_outputs);
  public static class Infer_shape_int_IntPointer_PointerPointer extends FunctionPointer {
      static { Loader.load(); }
      /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
      public    Infer_shape_int_IntPointer_PointerPointer(Pointer p) { super(p); }
      protected Infer_shape_int_IntPointer_PointerPointer() { allocate(); }
      private native void allocate();
      public native @Cast("bool") boolean call(int arg0, IntPointer arg1, @Cast("unsigned**") PointerPointer arg2);
  }
  public native Infer_shape_int_IntPointer_PointerPointer infer_shape(); public native CustomOpPropInfo infer_shape(Infer_shape_int_IntPointer_PointerPointer infer_shape);
  public static class Declare_backward_dependency_IntPointer_IntPointer_IntPointer_IntPointer_PointerPointer extends FunctionPointer {
      static { Loader.load(); }
      /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
      public    Declare_backward_dependency_IntPointer_IntPointer_IntPointer_IntPointer_PointerPointer(Pointer p) { super(p); }
      protected Declare_backward_dependency_IntPointer_IntPointer_IntPointer_IntPointer_PointerPointer() { allocate(); }
      private native void allocate();
      public native @Cast("bool") boolean call(@Const IntPointer arg0, @Const IntPointer arg1,
                                        @Const IntPointer arg2, IntPointer arg3,
                                        @Cast("int**") PointerPointer arg4);
  }
  public native Declare_backward_dependency_IntPointer_IntPointer_IntPointer_IntPointer_PointerPointer declare_backward_dependency(); public native CustomOpPropInfo declare_backward_dependency(Declare_backward_dependency_IntPointer_IntPointer_IntPointer_IntPointer_PointerPointer declare_backward_dependency);
  public static class Create_operator_BytePointer_int_PointerPointer_IntPointer_IntPointer_CustomOpInfo extends FunctionPointer {
      static { Loader.load(); }
      /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
      public    Create_operator_BytePointer_int_PointerPointer_IntPointer_IntPointer_CustomOpInfo(Pointer p) { super(p); }
      protected Create_operator_BytePointer_int_PointerPointer_IntPointer_IntPointer_CustomOpInfo() { allocate(); }
      private native void allocate();
      public native @Cast("bool") boolean call(@Cast("const char*") BytePointer arg0, int arg1, @Cast("unsigned**") PointerPointer arg2,
                                     IntPointer arg3, IntPointer arg4, CustomOpInfo arg5);
  }
  public native Create_operator_BytePointer_int_PointerPointer_IntPointer_IntPointer_CustomOpInfo create_operator(); public native CustomOpPropInfo create_operator(Create_operator_BytePointer_int_PointerPointer_IntPointer_IntPointer_CustomOpInfo create_operator);
  public static class List_auxiliary_states_PointerPointer extends FunctionPointer {
      static { Loader.load(); }
      /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
      public    List_auxiliary_states_PointerPointer(Pointer p) { super(p); }
      protected List_auxiliary_states_PointerPointer() { allocate(); }
      private native void allocate();
      public native @Cast("bool") boolean call(@Cast("char***") PointerPointer arg0);
  }
  public native List_auxiliary_states_PointerPointer list_auxiliary_states(); public native CustomOpPropInfo list_auxiliary_states(List_auxiliary_states_PointerPointer list_auxiliary_states);
}
