...
public class augru_forward extends primitive {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public augru_forward(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public augru_forward(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public augru_forward position(long position) {
        return (augru_forward)super.position(position);
    }
    @Override public augru_forward getPointer(long i) {
        return new augru_forward((Pointer)this).offsetAddress(i);
    }
    ...
    /** Default constructor. Produces an empty object. */
    public augru_forward() { super((Pointer)null); allocate(); }
    private native void allocate();

    /** Constructs an AUGRU forward propagation primitive.
     *  @param pd Primitive descriptor for an AUGRU forward propagation
     *      primitive. */
    public augru_forward(@Const @ByRef primitive_desc pd) { super((Pointer)null); allocate(pd); }
