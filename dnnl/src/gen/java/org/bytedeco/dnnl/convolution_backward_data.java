...
public class convolution_backward_data extends primitive {
    ...
    public static class primitive_desc extends org.bytedeco.dnnl.primitive_desc {
        ...
        public primitive_desc(@Const @ByRef engine aengine, algorithm aalgorithm,
                        ...
                        @Const @ByRef org.bytedeco.dnnl.memory.desc diff_dst_desc, @Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer strides,
                        @Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer padding_l, @Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer padding_r,
                        @Const @ByRef convolution_forward.primitive_desc hint_fwd_pd) { super((Pointer)null); allocate(aengine, aalgorithm, diff_src_desc, weights_desc, diff_dst_desc, strides, padding_l, padding_r, hint_fwd_pd); }
        private native void allocate(@Const @ByRef engine aengine, algorithm aalgorithm,
                        @Const @ByRef org.bytedeco.dnnl.memory.desc diff_src_desc,
                        @Const @ByRef org.bytedeco.dnnl.memory.desc weights_desc,
                        @Const @ByRef org.bytedeco.dnnl.memory.desc diff_dst_desc, @Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer strides,
        ...
        public primitive_desc(@Const @ByRef engine aengine, algorithm aalgorithm,
                        ...
                        @Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer dilates, @Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer padding_l,
                        @Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer padding_r,
                        @Const @ByRef convolution_forward.primitive_desc hint_fwd_pd) { super((Pointer)null); allocate(aengine, aalgorithm, diff_src_desc, weights_desc, diff_dst_desc, strides, dilates, padding_l, padding_r, hint_fwd_pd); }
        private native void allocate(@Const @ByRef engine aengine, algorithm aalgorithm,
                        @Const @ByRef org.bytedeco.dnnl.memory.desc diff_src_desc,
                        @Const @ByRef org.bytedeco.dnnl.memory.desc weights_desc,
                        @Const @ByRef org.bytedeco.dnnl.memory.desc diff_dst_desc, @Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer strides,
    ...
    public convolution_backward_data(
