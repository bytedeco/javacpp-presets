...
public class deconvolution_backward_data extends primitive {
    ...
    @Override public deconvolution_backward_data getPointer(long i) {
        return new deconvolution_backward_data((Pointer)this).offsetAddress(i);
    }
    ...
    public static class primitive_desc extends org.bytedeco.dnnl.primitive_desc {
        ...
        public primitive_desc(@Const @ByRef engine aengine, algorithm aalgorithm,
                        ...
                        @Cast("bool") boolean allow_empty/*=false*/) { super((Pointer)null); allocate(aengine, aalgorithm, diff_src_desc, weights_desc, diff_dst_desc, strides, padding_l, padding_r, hint_fwd_pd, attr, allow_empty); }
        ...
        public primitive_desc(@Const @ByRef engine aengine, algorithm aalgorithm,
                        ...
                        @Const @ByRef org.bytedeco.dnnl.memory.desc diff_dst_desc, @Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer strides,
                        @Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer padding_l, @Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer padding_r,
                        @Const @ByRef deconvolution_forward.primitive_desc hint_fwd_pd) { super((Pointer)null); allocate(aengine, aalgorithm, diff_src_desc, weights_desc, diff_dst_desc, strides, padding_l, padding_r, hint_fwd_pd); }
        private native void allocate(@Const @ByRef engine aengine, algorithm aalgorithm,
                        @Const @ByRef org.bytedeco.dnnl.memory.desc diff_src_desc,
                        @Const @ByRef org.bytedeco.dnnl.memory.desc weights_desc,
                        @Const @ByRef org.bytedeco.dnnl.memory.desc diff_dst_desc, @Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer strides,
        ...
        public primitive_desc(@Const @ByRef engine aengine, algorithm aalgorithm,
                        ...
                        @Const @ByRef deconvolution_forward.primitive_desc hint_fwd_pd,
                        @Const @ByRef(nullValue = "dnnl::primitive_attr()") primitive_attr attr,
                        @Cast("bool") boolean allow_empty/*=false*/) { super((Pointer)null); allocate(aengine, aalgorithm, diff_src_desc, weights_desc, diff_dst_desc, strides, dilates, padding_l, padding_r, hint_fwd_pd, attr, allow_empty); }
        private native void allocate(@Const @ByRef engine aengine, algorithm aalgorithm,
                        @Const @ByRef org.bytedeco.dnnl.memory.desc diff_src_desc,
                        @Const @ByRef org.bytedeco.dnnl.memory.desc weights_desc,
                        @Const @ByRef org.bytedeco.dnnl.memory.desc diff_dst_desc, @Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer strides,
        ...
        public primitive_desc(@Const @ByRef engine aengine, algorithm aalgorithm,
                        ...
                        @Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer dilates, @Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer padding_l,
                        @Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer padding_r,
                        @Const @ByRef deconvolution_forward.primitive_desc hint_fwd_pd) { super((Pointer)null); allocate(aengine, aalgorithm, diff_src_desc, weights_desc, diff_dst_desc, strides, dilates, padding_l, padding_r, hint_fwd_pd); }
        private native void allocate(@Const @ByRef engine aengine, algorithm aalgorithm,
                        @Const @ByRef org.bytedeco.dnnl.memory.desc diff_src_desc,
                        @Const @ByRef org.bytedeco.dnnl.memory.desc weights_desc,
                        @Const @ByRef org.bytedeco.dnnl.memory.desc diff_dst_desc, @Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer strides,
    ...
    public deconvolution_backward_data(
