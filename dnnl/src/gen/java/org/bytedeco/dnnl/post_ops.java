...
public class post_ops extends dnnl_post_ops_handle {
    ...
    ///
    public native void append_binary(algorithm aalgorithm, @Const @ByRef org.bytedeco.dnnl.memory.desc src1_desc,
                @Const @ByRef org.bytedeco.dnnl.memory.desc src2_desc);
    public native void append_binary(@Cast("dnnl::algorithm") int aalgorithm, @Const @ByRef org.bytedeco.dnnl.memory.desc src1_desc,
                @Const @ByRef org.bytedeco.dnnl.memory.desc src2_desc);
    ...
    ///
    ///
    public native void get_params_binary(int index, @ByRef @Cast("dnnl::algorithm*") IntPointer aalgorithm,
                @ByRef org.bytedeco.dnnl.memory.desc src1_desc, @ByRef org.bytedeco.dnnl.memory.desc src2_desc);
    public native void get_params_binary(int index, @ByRef @Cast("dnnl::algorithm*") IntBuffer aalgorithm,
                @ByRef org.bytedeco.dnnl.memory.desc src1_desc, @ByRef org.bytedeco.dnnl.memory.desc src2_desc);
    public native void get_params_binary(int index, @ByRef @Cast("dnnl::algorithm*") int[] aalgorithm,
                @ByRef org.bytedeco.dnnl.memory.desc src1_desc, @ByRef org.bytedeco.dnnl.memory.desc src2_desc);
