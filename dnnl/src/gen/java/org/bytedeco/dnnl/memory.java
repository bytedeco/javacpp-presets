...
// #endif
        ...
        public final int value;
        private sparse_encoding(int v) { this.value = v; }
        private sparse_encoding(sparse_encoding e) { this.value = e.value; }
        public sparse_encoding intern() { for (sparse_encoding e : values()) if (e.value == value) return e; return this; }
        @Override public String toString() { return intern().name(); }
    }
...
///
    ...
    @Name("desc") public static class desc extends dnnl_memory_desc_handle {
        ...
        ///
        ///
        public static native @ByVal desc csr(@Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer adims, memory.data_type adata_type, @Cast("dnnl::memory::dim") long nnz,
                        memory.data_type index_dt, memory.data_type pointer_dt,
                        @Cast("bool") boolean allow_empty/*=false*/);
        public static native @ByVal desc csr(@Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer adims, memory.data_type adata_type, @Cast("dnnl::memory::dim") long nnz,
                        memory.data_type index_dt, memory.data_type pointer_dt);
        public static native @ByVal desc csr(@Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongBuffer adims, memory.data_type adata_type, @Cast("dnnl::memory::dim") long nnz,
                        memory.data_type index_dt, memory.data_type pointer_dt,
                        @Cast("bool") boolean allow_empty/*=false*/);
        public static native @ByVal desc csr(@Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongBuffer adims, memory.data_type adata_type, @Cast("dnnl::memory::dim") long nnz,
                        memory.data_type index_dt, memory.data_type pointer_dt);
        public static native @ByVal desc csr(@Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef long[] adims, memory.data_type adata_type, @Cast("dnnl::memory::dim") long nnz,
                        memory.data_type index_dt, memory.data_type pointer_dt,
                        @Cast("bool") boolean allow_empty/*=false*/);
        public static native @ByVal desc csr(@Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef long[] adims, memory.data_type adata_type, @Cast("dnnl::memory::dim") long nnz,
                        memory.data_type index_dt, memory.data_type pointer_dt);
        ...
        ///
        ///
        public static native @ByVal desc coo(@Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer adims, memory.data_type adata_type, @Cast("dnnl::memory::dim") long nnz,
                        memory.data_type index_dt, @Cast("bool") boolean allow_empty/*=false*/);
        public static native @ByVal desc coo(@Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer adims, memory.data_type adata_type, @Cast("dnnl::memory::dim") long nnz,
                        memory.data_type index_dt);
        public static native @ByVal desc coo(@Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongBuffer adims, memory.data_type adata_type, @Cast("dnnl::memory::dim") long nnz,
                        memory.data_type index_dt, @Cast("bool") boolean allow_empty/*=false*/);
        public static native @ByVal desc coo(@Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongBuffer adims, memory.data_type adata_type, @Cast("dnnl::memory::dim") long nnz,
                        memory.data_type index_dt);
        public static native @ByVal desc coo(@Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef long[] adims, memory.data_type adata_type, @Cast("dnnl::memory::dim") long nnz,
                        memory.data_type index_dt, @Cast("bool") boolean allow_empty/*=false*/);
        public static native @ByVal desc coo(@Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef long[] adims, memory.data_type adata_type, @Cast("dnnl::memory::dim") long nnz,
                        memory.data_type index_dt);
        ...
        ///
        public static native @ByVal desc packed(@Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer adims, memory.data_type adata_type, @Cast("dnnl::memory::dim") long nnz,
                        @Cast("bool") boolean allow_empty/*=false*/);
        public static native @ByVal desc packed(@Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongPointer adims, memory.data_type adata_type, @Cast("dnnl::memory::dim") long nnz);
        public static native @ByVal desc packed(@Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongBuffer adims, memory.data_type adata_type, @Cast("dnnl::memory::dim") long nnz,
                        @Cast("bool") boolean allow_empty/*=false*/);
        public static native @ByVal desc packed(@Const @Cast({"dnnl_dim_t*", "std::vector<dnnl_dim_t>&"}) @StdVector("dnnl_dim_t") @ByRef LongBuffer adims, memory.data_type adata_type, @Cast("dnnl::memory::dim") long nnz);
...
// #endif
         ...
         * 
         *  @return A number of handles. */
        
        ///
        public native int get_num_handles();

        /** Returns a number of non-zero entries of the memory descriptor.
         * 
         *  @return A number non-zero entries. */
        
        ///
        public native @Cast("dnnl::memory::dim") long get_nnz();

        /** Returns the sparse encoding of the memory descriptor.
         * 
         *  @return the sparse encoding kind.
         *  @see \ref dev_guide_sparsity */
        
        ///
        public native memory.sparse_encoding get_sparse_encoding();
        ...
        ///
        public native memory.data_type get_data_type(int index/*=0*/);
        ...
        public native @Cast("size_t") long get_size(int index/*=0*/);
    ...
    ///
    public memory(@Const @ByRef org.bytedeco.dnnl.memory.desc md, @Const @ByRef engine aengine, @Cast({"void**", "std::vector<void*>&"}) @StdVector("void*") @ByVal PointerPointer handles) { super((Pointer)null); allocate(md, aengine, handles); }
    private native void allocate(@Const @ByRef org.bytedeco.dnnl.memory.desc md, @Const @ByRef engine aengine, @Cast({"void**", "std::vector<void*>&"}) @StdVector("void*") @ByVal PointerPointer handles);
    ...
    ///
    public native Pointer get_data_handle(int index/*=0*/);
     ...
     *  @param index Index of the buffer. Defaults to 0. */
    public native void unmap_data(Pointer mapped_ptr, int index/*=0*/);
