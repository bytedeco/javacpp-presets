...
public class gru_backward extends primitive {
    ...
    public static class primitive_desc extends rnn_primitive_desc_base {
        ...
        public primitive_desc(@Const @ByRef engine aengine, prop_kind aprop_kind,
                        ...
                        @Cast("bool") boolean allow_empty/*=false*/) { super((Pointer)null); allocate(aengine, aprop_kind, direction, src_layer_desc, src_iter_desc, weights_layer_desc, weights_iter_desc, bias_desc, dst_layer_desc, dst_iter_desc, diff_src_layer_desc, diff_src_iter_desc, diff_weights_layer_desc, diff_weights_iter_desc, diff_bias_desc, diff_dst_layer_desc, diff_dst_iter_desc, hint_fwd_pd, attr, allow_empty); }
        ...
        public primitive_desc(@Const @ByRef engine aengine, prop_kind aprop_kind,
                        ...
                        @Const @ByRef org.bytedeco.dnnl.memory.desc diff_dst_layer_desc,
                        @Const @ByRef org.bytedeco.dnnl.memory.desc diff_dst_iter_desc,
                        @Const @ByRef gru_forward.primitive_desc hint_fwd_pd) { super((Pointer)null); allocate(aengine, aprop_kind, direction, src_layer_desc, src_iter_desc, weights_layer_desc, weights_iter_desc, bias_desc, dst_layer_desc, dst_iter_desc, diff_src_layer_desc, diff_src_iter_desc, diff_weights_layer_desc, diff_weights_iter_desc, diff_bias_desc, diff_dst_layer_desc, diff_dst_iter_desc, hint_fwd_pd); }
        private native void allocate(@Const @ByRef engine aengine, prop_kind aprop_kind,
                        rnn_direction direction, @Const @ByRef org.bytedeco.dnnl.memory.desc src_layer_desc,
                        @Const @ByRef org.bytedeco.dnnl.memory.desc src_iter_desc,
                        @Const @ByRef org.bytedeco.dnnl.memory.desc weights_layer_desc,
