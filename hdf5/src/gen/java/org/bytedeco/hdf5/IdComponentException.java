...
public class IdComponentException extends Exception {
    static { Loader.load(); }
    ...
    @Override public IdComponentException getPointer(long i) {
        return new IdComponentException((Pointer)this).position(position + i);
    }
