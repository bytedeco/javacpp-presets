...
public class H5Object extends H5Location {
    ...
    public H5Object(H5Location pointer) { super((Pointer)null); allocate(pointer); }
    @Namespace private native @Name("static_cast<H5::H5Object*>") void allocate(H5Location pointer);
