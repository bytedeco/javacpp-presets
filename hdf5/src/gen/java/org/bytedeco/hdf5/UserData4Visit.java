...
public class UserData4Visit extends Pointer {
    ...
    @Override public UserData4Visit position(long position) {
        ...
        public native visit_operator_t op(); public native UserData4Visit op(visit_operator_t op);
        public native Pointer opData(); public native UserData4Visit opData(Pointer opData);
        public native H5Object obj(); public native UserData4Visit obj(H5Object obj);
}
