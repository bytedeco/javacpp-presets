...
public class StrType extends AtomType {
    ...
    public StrType(H5Location pointer) { super((Pointer)null); allocate(pointer); }
    @Namespace private native @Name("static_cast<H5::StrType*>") void allocate(H5Location pointer);
