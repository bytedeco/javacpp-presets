...
public class H5File extends Group {
    ...
    public H5File(H5Location pointer) { super((Pointer)null); allocate(pointer); }
    @Namespace private native @Name("static_cast<H5::H5File*>") void allocate(H5Location pointer);
    ...
    private native void allocate(String name, @Cast("unsigned int") int flags);
    public H5File(@Cast("const char*") BytePointer name, @Cast("unsigned int") int flags, @Const @ByRef FileAccPropList access_plist) { super((Pointer)null); allocate(name, flags, access_plist); }
    private native void allocate(@Cast("const char*") BytePointer name, @Cast("unsigned int") int flags, @Const @ByRef FileAccPropList access_plist);
    public H5File(String name, @Cast("unsigned int") int flags, @Const @ByRef FileAccPropList access_plist) { super((Pointer)null); allocate(name, flags, access_plist); }
    private native void allocate(String name, @Cast("unsigned int") int flags, @Const @ByRef FileAccPropList access_plist);
