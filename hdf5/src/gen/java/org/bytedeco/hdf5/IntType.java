...
public class IntType extends AtomType {
    ...
    public IntType(H5Location pointer) { super((Pointer)null); allocate(pointer); }
    @Namespace private native @Name("static_cast<H5::IntType*>") void allocate(H5Location pointer);
