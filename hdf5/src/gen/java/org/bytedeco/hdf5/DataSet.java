...
public class DataSet extends H5Object {
    ...
    @Namespace public static native @Name("static_cast<H5::AbstractDs*>") AbstractDs asAbstractDs(DataSet pointer);
        ...
        public native void fillMemBuf(@Const Pointer _fill, @Const @ByRef DataType fill_type, Pointer buf, @Const @ByRef DataType buf_type, @Const @ByRef DataSpace space);
