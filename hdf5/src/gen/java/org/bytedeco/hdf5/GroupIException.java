...
public class GroupIException extends Exception {
    static { Loader.load(); }
    ...
    @Override public GroupIException getPointer(long i) {
        return new GroupIException((Pointer)this).position(position + i);
    }
