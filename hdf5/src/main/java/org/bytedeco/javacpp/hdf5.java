...
public static final int H5_HAVE_FSEEKO = 1;

/* Define to 1 if you have the `fseeko64' function. */
public static final int H5_HAVE_FSEEKO64 = 1;

/* Define to 1 if you have the `fstat64' function. */
public static final int H5_HAVE_FSTAT64 = 1;

/* Define to 1 if you have the `ftello' function. */
public static final int H5_HAVE_FTELLO = 1;

/* Define to 1 if you have the `ftello64' function. */
public static final int H5_HAVE_FTELLO64 = 1;

/* Define to 1 if you have the `ftruncate64' function. */
public static final int H5_HAVE_FTRUNCATE64 = 1;
...
public static final int H5_HAVE_LSEEK64 = 1;
...
public static final int H5_HAVE_PTHREAD_H = 1;
...
public static final int H5_HAVE_SIGSETJMP = 1;
...
public static final int H5_HAVE_STAT64 = 1;
...
public static final String H5_PACKAGE_STRING = "HDF5 1.10.1";
...
public static final String H5_PACKAGE_VERSION = "1.10.1";
...
public static final String H5_PRINTF_LL_WIDTH = "unknown";
...
public static final int H5_SIZEOF_OFF64_T = 8;
...
public static final int H5_SYSTEM_SCOPE_THREADS = 1;
...
public static final String H5_VERSION = "1.10.1";
...
public static final int H5_VERS_RELEASE =	1;	/* For tweaks, bug-fixes, or development     */
public static final String H5_VERS_SUBRELEASE = "";	/* For pre-releases like snap0       */
				/* Empty string for real releases.           */
public static final String H5_VERS_INFO =    "HDF5 library version: 1.10.1";      /* Full version string */
...
public static class H5AC_cache_image_config_t extends Pointer {
    ...
    public native int version(); public native H5AC_cache_image_config_t version(int version);
    public native @Cast("hbool_t") boolean generate_image(); public native H5AC_cache_image_config_t generate_image(boolean generate_image);
    public native @Cast("hbool_t") boolean save_resize_status(); public native H5AC_cache_image_config_t save_resize_status(boolean save_resize_status);
    public native int entry_ageout(); public native H5AC_cache_image_config_t entry_ageout(int entry_ageout);
}
...
public static native @Cast("herr_t") int H5PLappend(@Cast("const char*") BytePointer plugin_path);
public static native @Cast("herr_t") int H5PLappend(String plugin_path);
public static native @Cast("herr_t") int H5PLprepend(@Cast("const char*") BytePointer plugin_path);
public static native @Cast("herr_t") int H5PLprepend(String plugin_path);
public static native @Cast("herr_t") int H5PLreplace(@Cast("const char*") BytePointer plugin_path, @Cast("unsigned int") int index);
public static native @Cast("herr_t") int H5PLreplace(String plugin_path, @Cast("unsigned int") int index);
...
@NoOffset public static class PacketTable extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
...
@Namespace("H5") public static class ObjHeaderIException extends Exception {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
...
*/
// Class forwarding
@Namespace("H5") @Opaque public static class LinkAccPropList extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public LinkAccPropList() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
...
*/
//  Inheritance: DataType -> H5Object -> H5Location -> IdComponent
@Namespace("H5") public static class ArrayType extends DataType {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
...
@Namespace("H5") @NoOffset public static class H5File extends Group {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
