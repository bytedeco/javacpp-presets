...
*/
// Inheritance: PropList -> IdComponent
@Namespace("H5") @NoOffset public static class LinkAccPropList extends PropList {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
...
*/
// Inheritance: PropList -> IdComponent
@Namespace("H5") @NoOffset public static class LinkCreatPropList extends PropList {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
