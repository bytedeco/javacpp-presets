...
// #if FF_API_FORMAT_FILENAME
     ...
     */
    public native @Cast("char") @Deprecated byte filename(int i); public native AVFormatContext filename(int i, byte filename);
...
// #endif
     ...
     * Freed by libavformat in avformat_free_context().
     */
    public native @Cast("char*") BytePointer url(); public native AVFormatContext url(BytePointer url);
