...
public class avcodec extends org.bytedeco.javacpp.avcodec.avcodec_presets {
    static { Loader.load(); }
...
// Targeting AVCodecDescriptor.java
...
// Targeting AVPanScan.java


// Targeting AVCPBProperties.java
...
// Targeting AVPacketSideData.java


// Targeting AVPacket.java
...
// Targeting AVCodecInternal.java
...
// Targeting AVCodecHWConfig.java


// Targeting AVCodecDefault.java


// Targeting AVCodec.java



// #if FF_API_CODEC_GET_SET
@NoException public static native @Deprecated int av_codec_get_max_lowres(@Const AVCodec codec);
// Targeting MpegEncContext.java
...
// Targeting AVSubtitleRect.java


// Targeting AVSubtitle.java


// Targeting AVCodecParameters.java
 ...
 * @param frame [out]  The AVFrame in which to store decoded audio samples.
 ...
 * @param got_frame_ptr [out]  Zero if no frame could be decoded, otherwise it is
 ...
 *
 * @param avctx the codec context
 * @param picture [out]  The AVFrame in which the decoded video frame will be stored.
 ...
 *            fields possible.
 * @param got_picture_ptr [in,out]  Zero if no frame could be decompressed, otherwise, it is nonzero.
...
// Targeting AVCodecParserContext.java


// Targeting AVCodecParser.java
 ...
 * @param frame [in]  AVFrame containing the raw audio data to be encoded.
 ...
 *                  avctx->frame_size for all frames except the last.
 *                  The final frame may be smaller than avctx->frame_size.
 * @param got_packet_ptr [out]  This field is set to 1 by libavcodec if the
 ...
 *                  If this function fails or produces no output, avpkt will be
 *                  freed using av_packet_unref().
 * @param frame [in]  AVFrame containing the raw video data to be encoded.
 *                  May be NULL when flushing an encoder that has the
 *                  AV_CODEC_CAP_DELAY capability set.
 * @param got_packet_ptr [out]  This field is set to 1 by libavcodec if the
 *                            output packet is non-empty, and to 0 if it is
...
// Targeting Func_AVCodecContext_Pointer.java
...
// Targeting Func_AVCodecContext_Pointer_int_int.java
...
// Targeting AVBitStreamFilterContext.java


// Targeting AVBSFInternal.java


// Targeting AVBSFContext.java


// Targeting AVBitStreamFilter.java
