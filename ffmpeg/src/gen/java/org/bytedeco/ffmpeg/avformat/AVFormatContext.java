...
public class AVFormatContext extends Pointer {
     ...
     */
    public native @Cast("unsigned int") int nb_stream_groups(); public native AVFormatContext nb_stream_groups(int setter);
    /**
     ...
     * Freed by libavformat in avformat_free_context().
     */
    public native AVStreamGroup stream_groups(int i); public native AVFormatContext stream_groups(int i, AVStreamGroup setter);
    public native @Cast("AVStreamGroup**") PointerPointer stream_groups(); public native AVFormatContext stream_groups(PointerPointer setter);
...
public static final int AVFMT_AVOID_NEG_TS_MAKE_ZERO =         2;
     ...
     */
    public native @Cast("char*") BytePointer name(); public native AVFormatContext name(BytePointer setter);
}
