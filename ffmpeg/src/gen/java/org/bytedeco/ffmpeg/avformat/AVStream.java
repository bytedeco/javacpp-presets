...
// #if FF_API_LAVF_FFSERVER
     ...
     * @deprecated unused
     */
    public native @Cast("char*") @Deprecated BytePointer recommended_encoder_configuration(); public native AVStream recommended_encoder_configuration(BytePointer recommended_encoder_configuration);
// #endif
...
public static final int MAX_STD_TIMEBASES = (30*12+30+3+6);
     ...
     */
        ...
        @Name({"info", ".frame_delay_evidence"}) public native int info_frame_delay_evidence(int i); public native AVStream info_frame_delay_evidence(int i, int info_frame_delay_evidence);
