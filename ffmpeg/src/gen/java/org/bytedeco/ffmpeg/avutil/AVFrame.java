 ...
 */
public static final int AV_FRAME_FLAG_LOSSLESS =        (1 << 5);
/**
 * \}
 */
...
public static final int FF_DECODE_ERROR_DECODE_SLICES =       8;
     ...
     */
    public native Pointer private_ref(); public native AVFrame private_ref(Pointer setter);
     ...
     * - decoding: Set by libavcodec
     */
    public native @Cast("AVAlphaMode") int alpha_mode(); public native AVFrame alpha_mode(int setter);
}
