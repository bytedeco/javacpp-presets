...
public class AVBufferSrcParameters extends Pointer {
     ...
     */
    public native @Cast("AVColorSpace") int color_space(); public native AVBufferSrcParameters color_space(int setter);
    public native @Cast("AVColorRange") int color_range(); public native AVBufferSrcParameters color_range(int setter);

    public native AVFrameSideData side_data(int i); public native AVBufferSrcParameters side_data(int i, AVFrameSideData setter);
    public native @Cast("AVFrameSideData**") PointerPointer side_data(); public native AVBufferSrcParameters side_data(PointerPointer setter);
    public native int nb_side_data(); public native AVBufferSrcParameters nb_side_data(int setter);

    /**
     * Video only, the alpha mode.
     */
    public native @Cast("AVAlphaMode") int alpha_mode(); public native AVBufferSrcParameters alpha_mode(int setter);
}
