...
public class AVFilterLink extends Pointer {
    ...
    public native AVFrameSideData side_data(int i); public native AVFilterLink side_data(int i, AVFrameSideData setter);
    public native @Cast("AVFrameSideData**") PointerPointer side_data(); public native AVFilterLink side_data(PointerPointer setter);
    public native int nb_side_data(); public native AVFilterLink nb_side_data(int setter);

    /** alpha mode (for videos with an alpha channel) */
    public native @Cast("AVAlphaMode") int alpha_mode(); public native AVFilterLink alpha_mode(int setter);
