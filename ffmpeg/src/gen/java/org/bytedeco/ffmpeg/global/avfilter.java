 ...
 */
@NoException public static native AVBufferRef avfilter_link_get_hw_frames_ctx(AVFilterLink link);
...
@NoException public static native @Cast("AVAlphaMode") int av_buffersink_get_alpha_mode(@Const AVFilterContext ctx);
...
@NoException public static native @Cast("const AVFrameSideData*const*") PointerPointer av_buffersink_get_side_data(@Const AVFilterContext ctx,
                                                          IntPointer nb_side_data);
@NoException public static native @Const @ByPtrPtr AVFrameSideData av_buffersink_get_side_data(@Const AVFilterContext ctx,
                                                          IntBuffer nb_side_data);
@NoException public static native @Const @ByPtrPtr AVFrameSideData av_buffersink_get_side_data(@Const AVFilterContext ctx,
                                                          int[] nb_side_data);
 ...
 */
@NoException public static native int av_buffersrc_get_status(AVFilterContext ctx);
...
public static final int LIBAVFILTER_VERSION_MAJOR =  11;
...
public static final boolean FF_API_BUFFERSINK_OPTS = (LIBAVFILTER_VERSION_MAJOR < 12);
public static final boolean FF_API_CONTEXT_PUBLIC =  (LIBAVFILTER_VERSION_MAJOR < 12);
public static final boolean FF_API_LIBNPP_SUPPORT =  (LIBAVFILTER_VERSION_MAJOR < 12);
