 ...
 */
@NoException public static native int av_buffer_replace(@Cast("AVBufferRef**") PointerPointer dst, AVBufferRef src);
@NoException public static native int av_buffer_replace(@ByPtrPtr AVBufferRef dst, AVBufferRef src);
...
// #endif
    ...
    AV_PIX_FMT_NB = AV_PIX_FMT_GBRP + 125;
 ...
 */
@NoException public static native @Const @Deprecated AVClass av_opt_child_class_next(@Const AVClass parent, @Const AVClass prev);
// #endif
...
public static final String FFMPEG_VERSION = "4.4.1";
 ...
 */
@NoException public static native @Cast("AVAdler") long av_adler32_update(@Cast("AVAdler") long adler, @Cast("const uint8_t*") BytePointer buf,
                          @Cast("unsigned int") int len);
@NoException public static native @Cast("AVAdler") long av_adler32_update(@Cast("AVAdler") long adler, @Cast("const uint8_t*") ByteBuffer buf,
                          @Cast("unsigned int") int len);
@NoException public static native @Cast("AVAdler") long av_adler32_update(@Cast("AVAdler") long adler, @Cast("const uint8_t*") byte[] buf,
                          @Cast("unsigned int") int len);
// #else
// #endif
