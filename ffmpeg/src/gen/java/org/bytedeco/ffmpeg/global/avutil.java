 ...
 * @return a non-negative number on success, a negative error code on failure
 */
@NoException public static native int av_fifo_peek(AVFifo f, Pointer buf, @Cast("size_t") long nb_elems, @Cast("size_t") long offset);
 ...
 * @return a non-negative number on success, a negative error code on failure
 */
@NoException public static native int av_fifo_peek_to_cb(AVFifo f, AVFifoCB write_cb, Pointer opaque,
