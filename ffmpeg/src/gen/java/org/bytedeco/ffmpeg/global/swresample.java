 ...
 */
@NoException public static native int swr_convert(SwrContext s, @Cast("uint8_t*const*") PointerPointer out, int out_count,
                                @Cast("const uint8_t*const*") PointerPointer in, int in_count);
@NoException public static native int swr_convert(SwrContext s, @Cast("uint8_t*const*") @ByPtrPtr BytePointer out, int out_count,
                                @Cast("const uint8_t*const*") @ByPtrPtr BytePointer in, int in_count);
@NoException public static native int swr_convert(SwrContext s, @Cast("uint8_t*const*") @ByPtrPtr ByteBuffer out, int out_count,
                                @Cast("const uint8_t*const*") @ByPtrPtr ByteBuffer in, int in_count);
@NoException public static native int swr_convert(SwrContext s, @Cast("uint8_t*const*") @ByPtrPtr byte[] out, int out_count,
                                @Cast("const uint8_t*const*") @ByPtrPtr byte[] in, int in_count);
...
public static final int LIBSWRESAMPLE_VERSION_MAJOR =   6;
