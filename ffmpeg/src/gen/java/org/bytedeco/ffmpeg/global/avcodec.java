...
// #endif
    ...
    AV_CODEC_ID_ADPCM_IMA_XBOX = 0x11000 + 52,
    AV_CODEC_ID_ADPCM_SANYO = 0x11000 + 53,
    AV_CODEC_ID_ADPCM_IMA_HVQM4 = 0x11000 + 54,
    AV_CODEC_ID_ADPCM_IMA_PDA = 0x11000 + 55,
    AV_CODEC_ID_ADPCM_N64 = 0x11000 + 56,
    AV_CODEC_ID_ADPCM_IMA_HVQM2 = 0x11000 + 57,
    AV_CODEC_ID_ADPCM_IMA_MAGIX = 0x11000 + 58,
    AV_CODEC_ID_ADPCM_PSXC = 0x11000 + 59,
    AV_CODEC_ID_ADPCM_CIRCUS = 0x11000 + 60,
    AV_CODEC_ID_ADPCM_IMA_ESCAPE = 0x11000 + 61,
    ...
    AV_CODEC_ID_G728 = 0x15000 + 107,
    AV_CODEC_ID_AHX = 0x15000 + 108,
    ...
    AV_CODEC_ID_IVTV_VBI = 0x17000 + 26,
    ...
    AV_CODEC_ID_SMPTE_436M_ANC = 0x18000 + 13,
 ...
 * be expected.
 */
public static final int AV_CODEC_PROP_ENHANCEMENT =   (1 << 5);
...
public static final int AV_PROFILE_PRORES_RAW =       0;
public static final int AV_PROFILE_PRORES_RAW_HQ =    1;
...
public static final int AV_PROFILE_APV_422_10 =  33;
public static final int AV_PROFILE_APV_422_12 =  44;
public static final int AV_PROFILE_APV_444_10 =  55;
public static final int AV_PROFILE_APV_444_12 =  66;
public static final int AV_PROFILE_APV_4444_10 = 77;
public static final int AV_PROFILE_APV_4444_12 = 88;
public static final int AV_PROFILE_APV_400_10 =  99;
...
// Targeting ../avcodec/AVRTCPSenderReport.java
 ...
 *                           similar.
 */
@NoException public static native int av_packet_side_data_from_frame(@Cast("AVPacketSideData**") PointerPointer sd, IntPointer nb_sd,
                                   @Const AVFrameSideData src, @Cast("unsigned int") int flags);
@NoException public static native int av_packet_side_data_from_frame(@ByPtrPtr AVPacketSideData sd, IntPointer nb_sd,
                                   @Const AVFrameSideData src, @Cast("unsigned int") int flags);
@NoException public static native int av_packet_side_data_from_frame(@ByPtrPtr AVPacketSideData sd, IntBuffer nb_sd,
                                   @Const AVFrameSideData src, @Cast("unsigned int") int flags);
@NoException public static native int av_packet_side_data_from_frame(@ByPtrPtr AVPacketSideData sd, int[] nb_sd,
                                   @Const AVFrameSideData src, @Cast("unsigned int") int flags);
/**
 ...
 *                           similar.
 */
@NoException public static native int av_packet_side_data_to_frame(@Cast("AVFrameSideData***") @ByPtrPtr PointerPointer sd, IntPointer nb_sd,
                                 @Const AVPacketSideData src, @Cast("unsigned int") int flags);
@NoException public static native int av_packet_side_data_to_frame(@Cast("AVFrameSideData***") @ByPtrPtr PointerPointer sd, IntBuffer nb_sd,
                                 @Const AVPacketSideData src, @Cast("unsigned int") int flags);
@NoException public static native int av_packet_side_data_to_frame(@Cast("AVFrameSideData***") @ByPtrPtr PointerPointer sd, int[] nb_sd,
                                 @Const AVPacketSideData src, @Cast("unsigned int") int flags);
 ...
 */
@NoException public static native AVContainerFifo av_container_fifo_alloc_avpacket(@Cast("unsigned") int flags);
 ...
 * {@code AVCodecContext.delay}. No effect when frame threading is disabled, or on
 * encoding.
 */
public static final int AV_CODEC_RECEIVE_FRAME_FLAG_SYNCHRONOUS = (1 << 0);
 ...
 */
@NoException public static native int avcodec_receive_frame_flags(AVCodecContext avctx, AVFrame frame, @Cast("unsigned") int flags);

/**
 * Alias for {@code avcodec_receive_frame_flags(avctx, frame, 0)}.
 */
 ...
 * @return 0 on success, < 0 otherwise
 */
@NoException public static native @Platform("android") int av_jni_set_android_app_ctx(Pointer app_ctx, Pointer log_ctx);
 ...
 */
@NoException public static native @Platform("android") Pointer av_jni_get_android_app_ctx();
...
public static final int LIBAVCODEC_VERSION_MAJOR =  62;
...
public static final boolean FF_API_INIT_PACKET =         (LIBAVCODEC_VERSION_MAJOR < 63);

public static final boolean FF_API_V408_CODECID =        (LIBAVCODEC_VERSION_MAJOR < 63);
public static final boolean FF_API_CODEC_PROPS =         (LIBAVCODEC_VERSION_MAJOR < 63);
public static final boolean FF_API_EXR_GAMMA =           (LIBAVCODEC_VERSION_MAJOR < 63);
public static final boolean FF_API_INTRA_DC_PRECISION =  (LIBAVCODEC_VERSION_MAJOR < 63);

public static final boolean FF_API_NVDEC_OLD_PIX_FMTS =  (LIBAVCODEC_VERSION_MAJOR < 63);

public static final boolean FF_API_PARSER_PRIVATE =      (LIBAVCODEC_VERSION_MAJOR < 63);
public static final boolean FF_API_PARSER_CODECID =      (LIBAVCODEC_VERSION_MAJOR < 63);

// reminder to remove the OMX encoder on next major bump
public static final boolean FF_CODEC_OMX =               (LIBAVCODEC_VERSION_MAJOR < 63);
// reminder to remove Sonic Lossy/Lossless encoders on next major bump
public static final boolean FF_CODEC_SONIC_ENC =         (LIBAVCODEC_VERSION_MAJOR < 63);
// reminder to remove Sonic decoder on next-next major bump
public static final boolean FF_CODEC_SONIC_DEC =         (LIBAVCODEC_VERSION_MAJOR < 63);
