 ...
 * instead.
 */
@NoException public static native @Deprecated int avcodec_close(AVCodecContext avctx);
// #endif
...
public static final int LIBAVCODEC_VERSION_MAJOR =  61;
...
public static final boolean FF_API_INIT_PACKET =         (LIBAVCODEC_VERSION_MAJOR < 62);
public static final boolean FF_API_SUBFRAMES =           (LIBAVCODEC_VERSION_MAJOR < 62);
public static final boolean FF_API_TICKS_PER_FRAME =     (LIBAVCODEC_VERSION_MAJOR < 62);
public static final boolean FF_API_DROPCHANGED =         (LIBAVCODEC_VERSION_MAJOR < 62);
