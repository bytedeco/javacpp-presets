...
public static final int AVPROBE_SCORE_MIME_BONUS = 30;
/** maximum score */
...
public static final int
    /**
     * Send a RTSP {@code SET_PARAMETER} request to the server
     *
...
// Targeting ../avformat/AVRTSPCommandRequest.java


// Targeting ../avformat/AVRTSPResponse.java
 ...
 */
@NoException public static native int avformat_send_command(AVFormatContext s, @Cast("AVFormatCommandID") int id, Pointer data);
 ...
 *                  documentation of the respective ::AVFormatCommandID.
 */
@NoException public static native int avformat_receive_command_reply(AVFormatContext s, @Cast("AVFormatCommandID") int id, @Cast("void**") PointerPointer data_out);
@NoException public static native int avformat_receive_command_reply(AVFormatContext s, @Cast("AVFormatCommandID") int id, @Cast("void**") @ByPtrPtr Pointer data_out);
...
public static final int AV_FRAME_FILENAME_FLAGS_IGNORE_TRUNCATION = 2;
 ...
 * @return <0 on error
 */
@NoException public static native int av_mime_codec_str(@Const AVCodecParameters par,
                      @ByVal AVRational frame_rate, @Cast("AVBPrint*") Pointer out);
...
public static final int LIBAVFORMAT_VERSION_MAJOR =  62;
 ...
 *
 */
public static final boolean FF_API_COMPUTE_PKT_FIELDS2 =      (LIBAVFORMAT_VERSION_MAJOR < 63);

public static final boolean FF_API_INTERNAL_TIMING =          (LIBAVFORMAT_VERSION_MAJOR < 63);

public static final boolean FF_API_NO_DEFAULT_TLS_VERIFY =    (LIBAVFORMAT_VERSION_MAJOR < 63);
...
public static final int LIBAVFORMAT_VERSION_MICRO = 102;
