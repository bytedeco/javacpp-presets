...
// #if FF_API_INTRA_DC_PRECISION
     ...
     */
    public native @Deprecated int intra_dc_precision(); public native AVCodecContext intra_dc_precision(int setter);
// #endif
...
public static final int FF_DCT_NEON =    7;
...
// #if FF_API_CODEC_PROPS
     ...
     * - decoding: set by libavcodec
     */
    public native @Cast("unsigned") @Deprecated int properties(); public native AVCodecContext properties(int setter);
...
public static final int FF_SUB_CHARENC_MODE_IGNORE =       2;
     ...
     */
    public native IntPointer side_data_prefer_packet(); public native AVCodecContext side_data_prefer_packet(IntPointer setter);
    /**
     * Number of entries in side_data_prefer_packet.
     */
    public native @Cast("unsigned") int nb_side_data_prefer_packet(); public native AVCodecContext nb_side_data_prefer_packet(int setter);
     ...
     * - decoding: may be set by libavcodec in avcodec_open2().
     */
    public native AVFrameSideData decoded_side_data(int i); public native AVCodecContext decoded_side_data(int i, AVFrameSideData setter);
    public native @Cast("AVFrameSideData**") PointerPointer decoded_side_data(); public native AVCodecContext decoded_side_data(PointerPointer setter);
    public native int nb_decoded_side_data(); public native AVCodecContext nb_decoded_side_data(int setter);
     ...
     * - decoding: Set by libavcodec
     */
    public native @Cast("AVAlphaMode") int alpha_mode(); public native AVCodecContext alpha_mode(int setter);
}
