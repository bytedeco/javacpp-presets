 ...
 * @author Samuel Audet
 */
@Properties(inherit=avfilter_presets.class, target="org.bytedeco.javacpp.avdevice", global="avdevice", value={
    @Platform(cinclude="<libavdevice/avdevice.h>", link="avdevice@.58"),
    @Platform(value="windows", preload="avdevice-58") })
public class avdevice_presets implements InfoMapper {
