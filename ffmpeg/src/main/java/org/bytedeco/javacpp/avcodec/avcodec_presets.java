 ...
 * @author Samuel Audet
 */
@Properties(inherit=swresample_presets.class, target="org.bytedeco.javacpp.avcodec", global="avcodec", value={
...
public class avcodec_presets implements InfoMapper {
