 ...
 * @author Samuel Audet
 */
@Properties(inherit=avcodec_presets.class, target="org.bytedeco.javacpp.avformat", global="avformat", value={
    @Platform(cinclude={"<libavformat/avio.h>", "<libavformat/avformat.h>"}, link="avformat@.58"),
    @Platform(value="windows", preload="avformat-58") })
public class avformat_presets implements InfoMapper {
