...
public class PlatformType extends Pointer {
  ...
  public native @Cast("char") byte platform(int i); public native PlatformType platform(int i, byte platform);
  @MemberGetter public native @Cast("char*") BytePointer platform();       // 0 terminated string
  public native @Cast("char") byte base_platform(int i); public native PlatformType base_platform(int i, byte base_platform);
