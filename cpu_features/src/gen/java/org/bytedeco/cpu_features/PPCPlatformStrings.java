...
public class PPCPlatformStrings extends Pointer {
  ...
  public native @Cast("char") byte platform(int i); public native PPCPlatformStrings platform(int i, byte platform);
  @MemberGetter public native @Cast("char*") BytePointer platform();  // 0 terminated string
  public native @Cast("char") byte model(int i); public native PPCPlatformStrings model(int i, byte model);
  @MemberGetter public native @Cast("char*") BytePointer model();     // 0 terminated string
  public native @Cast("char") byte machine(int i); public native PPCPlatformStrings machine(int i, byte machine);
  @MemberGetter public native @Cast("char*") BytePointer machine();   // 0 terminated string
  public native @Cast("char") byte cpu(int i); public native PPCPlatformStrings cpu(int i, byte cpu);
  @MemberGetter public native @Cast("char*") BytePointer cpu();       // 0 terminated string
  public native @ByRef PlatformType type(); public native PPCPlatformStrings type(PlatformType type);
}
