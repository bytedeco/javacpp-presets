...
public class MipsFeatures extends Pointer {
  ...
  public native @NoOffset int msa(); public native MipsFeatures msa(int msa);  // MIPS SIMD Architecture
                // https://www.mips.com/products/architectures/ase/simd/
  public native @NoOffset int eva(); public native MipsFeatures eva(int eva);  // Enhanced Virtual Addressing
