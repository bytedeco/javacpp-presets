...
public class HardwareCapabilities extends Pointer {
  ...
  public native @Cast("unsigned long") long hwcaps(); public native HardwareCapabilities hwcaps(long hwcaps);
  public native @Cast("unsigned long") long hwcaps2(); public native HardwareCapabilities hwcaps2(long hwcaps2);
}
