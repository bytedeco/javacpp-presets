...
public class Aarch64Info extends Pointer {
  ...
  public native @ByRef Aarch64Features features(); public native Aarch64Info features(Aarch64Features features);
  public native int implementer(); public native Aarch64Info implementer(int implementer);
  public native int variant(); public native Aarch64Info variant(int variant);
  public native int part(); public native Aarch64Info part(int part);
  public native int revision(); public native Aarch64Info revision(int revision);
}
