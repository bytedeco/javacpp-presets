...
@Name("dai::PropertiesSerializable<dai::Properties,dai::MessageDemuxProperties>") @Properties(inherit = org.bytedeco.depthai.presets.depthai.class)
public class MessageDemuxPropertiesSerializable extends DaiProperties {
    static { Loader.load(); }
    /** Default native constructor. */
    public MessageDemuxPropertiesSerializable() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public MessageDemuxPropertiesSerializable(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public MessageDemuxPropertiesSerializable(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public MessageDemuxPropertiesSerializable position(long position) {
        return (MessageDemuxPropertiesSerializable)super.position(position);
    }
    @Override public MessageDemuxPropertiesSerializable getPointer(long i) {
        return new MessageDemuxPropertiesSerializable((Pointer)this).offsetAddress(i);
    }
