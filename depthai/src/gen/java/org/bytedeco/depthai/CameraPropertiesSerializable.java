...
@Name("dai::PropertiesSerializable<dai::Properties,dai::CameraProperties>") @Properties(inherit = org.bytedeco.depthai.presets.depthai.class)
public class CameraPropertiesSerializable extends DaiProperties {
    static { Loader.load(); }
    /** Default native constructor. */
    public CameraPropertiesSerializable() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public CameraPropertiesSerializable(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public CameraPropertiesSerializable(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public CameraPropertiesSerializable position(long position) {
        return (CameraPropertiesSerializable)super.position(position);
    }
    @Override public CameraPropertiesSerializable getPointer(long i) {
        return new CameraPropertiesSerializable((Pointer)this).offsetAddress(i);
    }
