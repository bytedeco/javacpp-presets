...
@Name("dai::PropertiesSerializable<dai::Properties,dai::SyncProperties>") @Properties(inherit = org.bytedeco.depthai.presets.depthai.class)
public class SyncPropertiesSerializable extends DaiProperties {
    static { Loader.load(); }
    /** Default native constructor. */
    public SyncPropertiesSerializable() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public SyncPropertiesSerializable(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public SyncPropertiesSerializable(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public SyncPropertiesSerializable position(long position) {
        return (SyncPropertiesSerializable)super.position(position);
    }
    @Override public SyncPropertiesSerializable getPointer(long i) {
        return new SyncPropertiesSerializable((Pointer)this).offsetAddress(i);
    }
