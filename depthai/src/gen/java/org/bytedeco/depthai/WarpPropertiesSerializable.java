...
@Name("dai::PropertiesSerializable<dai::Properties,dai::WarpProperties>") @Properties(inherit = org.bytedeco.depthai.presets.depthai.class)
public class WarpPropertiesSerializable extends DaiProperties {
    static { Loader.load(); }
    /** Default native constructor. */
    public WarpPropertiesSerializable() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public WarpPropertiesSerializable(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public WarpPropertiesSerializable(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public WarpPropertiesSerializable position(long position) {
        return (WarpPropertiesSerializable)super.position(position);
    }
    @Override public WarpPropertiesSerializable getPointer(long i) {
        return new WarpPropertiesSerializable((Pointer)this).offsetAddress(i);
    }
