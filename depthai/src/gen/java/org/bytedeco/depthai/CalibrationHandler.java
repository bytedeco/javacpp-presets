...
public class CalibrationHandler extends Pointer {
     ...
     */
    public native float getBaselineDistance(CameraBoardSocket cam1/*=dai::CameraBoardSocket::CAM_C*/,
                                  CameraBoardSocket cam2/*=dai::CameraBoardSocket::CAM_B*/,
                                  @Cast("bool") boolean useSpecTranslation/*=true*/);
    public native float getBaselineDistance();
    public native float getBaselineDistance(@Cast("dai::CameraBoardSocket") int cam1/*=dai::CameraBoardSocket::CAM_C*/,
                                  @Cast("dai::CameraBoardSocket") int cam2/*=dai::CameraBoardSocket::CAM_B*/,
                                  @Cast("bool") boolean useSpecTranslation/*=true*/);
     ...
     * @param boardCustom Sets a custom board (Default empty string).
     */
    public native void setBoardInfo(@StdString BytePointer deviceName,
                          @StdString BytePointer productName,
                          @StdString BytePointer boardName,
                          @StdString BytePointer boardRev,
                          @StdString BytePointer boardConf,
                          @StdString BytePointer hardwareConf,
    ...
    public native void setBoardInfo(@StdString BytePointer deviceName,
                          ...
                          @Cast("uint64_t") long batchTime,
                          @Cast("uint32_t") int boardOptions);
    public native void setBoardInfo(@StdString ByteBuffer deviceName,
                          @StdString ByteBuffer productName,
                          @StdString ByteBuffer boardName,
                          @StdString ByteBuffer boardRev,
                          @StdString ByteBuffer boardConf,
                          @StdString ByteBuffer hardwareConf,
    ...
    public native void setBoardInfo(@StdString ByteBuffer deviceName,
                          ...
                          @Cast("uint64_t") long batchTime,
                          @Cast("uint32_t") int boardOptions);
    public native void setBoardInfo(@StdString String deviceName,
                          @StdString String productName,
                          @StdString String boardName,
                          @StdString String boardRev,
                          @StdString String boardConf,
                          @StdString String hardwareConf,
     ...
     * @param deviceName Sets device name.
     */
    public native void setDeviceName(@StdString BytePointer deviceName);
    public native void setDeviceName(@StdString ByteBuffer deviceName);
    public native void setDeviceName(@StdString String deviceName);
