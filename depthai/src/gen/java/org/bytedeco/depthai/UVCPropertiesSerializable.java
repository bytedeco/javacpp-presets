...
@Name("dai::PropertiesSerializable<dai::Properties,dai::UVCProperties>") @Properties(inherit = org.bytedeco.depthai.presets.depthai.class)
public class UVCPropertiesSerializable extends DaiProperties {
    static { Loader.load(); }
    /** Default native constructor. */
    public UVCPropertiesSerializable() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public UVCPropertiesSerializable(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public UVCPropertiesSerializable(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public UVCPropertiesSerializable position(long position) {
        return (UVCPropertiesSerializable)super.position(position);
    }
    @Override public UVCPropertiesSerializable getPointer(long i) {
        return new UVCPropertiesSerializable((Pointer)this).offsetAddress(i);
    }
