...
public class XLinkStream extends Pointer {
    ...
    public XLinkStream(@Const @ByRef XLinkConnection conn, @StdString ByteBuffer name, @Cast("std::size_t") long maxWriteSize) { super((Pointer)null); allocate(conn, name, maxWriteSize); }
    private native void allocate(@Const @ByRef XLinkConnection conn, @StdString ByteBuffer name, @Cast("std::size_t") long maxWriteSize);
