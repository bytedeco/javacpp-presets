...
public class Node extends Pointer {
    ...
    @NoOffset public static class Output extends Pointer {
        ...
        public Output(@ByRef Node par, @StdString ByteBuffer n, @Cast("dai::Node::Output::Type") int t, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, n, t, types); }
        private native void allocate(@ByRef Node par, @StdString ByteBuffer n, @Cast("dai::Node::Output::Type") int t, @StdVector DatatypeHierarchy types);
        public Output(@ByRef Node par, @StdString String n, Type t, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, n, t, types); }
        private native void allocate(@ByRef Node par, @StdString String n, Type t, @StdVector DatatypeHierarchy types);
        public Output(@ByRef Node par, @StdString BytePointer n, @Cast("dai::Node::Output::Type") int t, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, n, t, types); }
        private native void allocate(@ByRef Node par, @StdString BytePointer n, @Cast("dai::Node::Output::Type") int t, @StdVector DatatypeHierarchy types);
        public Output(@ByRef Node par, @StdString ByteBuffer n, Type t, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, n, t, types); }
        private native void allocate(@ByRef Node par, @StdString ByteBuffer n, Type t, @StdVector DatatypeHierarchy types);
        ...
        public Output(@ByRef Node par, @StdString ByteBuffer group, @StdString ByteBuffer n, @Cast("dai::Node::Output::Type") int t, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, group, n, t, types); }
        private native void allocate(@ByRef Node par, @StdString ByteBuffer group, @StdString ByteBuffer n, @Cast("dai::Node::Output::Type") int t, @StdVector DatatypeHierarchy types);
        public Output(@ByRef Node par, @StdString String group, @StdString String n, Type t, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, group, n, t, types); }
        private native void allocate(@ByRef Node par, @StdString String group, @StdString String n, Type t, @StdVector DatatypeHierarchy types);
        public Output(@ByRef Node par, @StdString BytePointer group, @StdString BytePointer n, @Cast("dai::Node::Output::Type") int t, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, group, n, t, types); }
        private native void allocate(@ByRef Node par, @StdString BytePointer group, @StdString BytePointer n, @Cast("dai::Node::Output::Type") int t, @StdVector DatatypeHierarchy types);
        public Output(@ByRef Node par, @StdString ByteBuffer group, @StdString ByteBuffer n, Type t, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, group, n, t, types); }
        private native void allocate(@ByRef Node par, @StdString ByteBuffer group, @StdString ByteBuffer n, Type t, @StdVector DatatypeHierarchy types);
    ...
    @NoOffset public static class OutputMap extends StringNodeOutputMap {
        ...
        public OutputMap(@StdString ByteBuffer name, @ByVal Output defaultOutput) { super((Pointer)null); allocate(name, defaultOutput); }
        private native void allocate(@StdString ByteBuffer name, @ByVal Output defaultOutput);
        ...
        public native @ByRef @Name("operator []") Output get(@StdString ByteBuffer key);
    ...
    @NoOffset public static class Input extends Pointer {
        ...
        private native void allocate(@ByRef Node par, @StdString BytePointer n, Type t, @StdVector DatatypeHierarchy types);
        public Input(@ByRef Node par, @StdString ByteBuffer n, @Cast("dai::Node::Input::Type") int t, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, n, t, types); }
        private native void allocate(@ByRef Node par, @StdString ByteBuffer n, @Cast("dai::Node::Input::Type") int t, @StdVector DatatypeHierarchy types);
        public Input(@ByRef Node par, @StdString String n, Type t, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, n, t, types); }
        private native void allocate(@ByRef Node par, @StdString String n, Type t, @StdVector DatatypeHierarchy types);
        public Input(@ByRef Node par, @StdString BytePointer n, @Cast("dai::Node::Input::Type") int t, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, n, t, types); }
        private native void allocate(@ByRef Node par, @StdString BytePointer n, @Cast("dai::Node::Input::Type") int t, @StdVector DatatypeHierarchy types);
        public Input(@ByRef Node par, @StdString ByteBuffer n, Type t, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, n, t, types); }
        private native void allocate(@ByRef Node par, @StdString ByteBuffer n, Type t, @StdVector DatatypeHierarchy types);
        ...
        public Input(@ByRef Node par, @StdString ByteBuffer n, @Cast("dai::Node::Input::Type") int t, @Cast("bool") boolean blocking, int queueSize, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, n, t, blocking, queueSize, types); }
        private native void allocate(@ByRef Node par, @StdString ByteBuffer n, @Cast("dai::Node::Input::Type") int t, @Cast("bool") boolean blocking, int queueSize, @StdVector DatatypeHierarchy types);
        public Input(@ByRef Node par, @StdString String n, Type t, @Cast("bool") boolean blocking, int queueSize, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, n, t, blocking, queueSize, types); }
        private native void allocate(@ByRef Node par, @StdString String n, Type t, @Cast("bool") boolean blocking, int queueSize, @StdVector DatatypeHierarchy types);
        public Input(@ByRef Node par, @StdString BytePointer n, @Cast("dai::Node::Input::Type") int t, @Cast("bool") boolean blocking, int queueSize, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, n, t, blocking, queueSize, types); }
        private native void allocate(@ByRef Node par, @StdString BytePointer n, @Cast("dai::Node::Input::Type") int t, @Cast("bool") boolean blocking, int queueSize, @StdVector DatatypeHierarchy types);
        public Input(@ByRef Node par, @StdString ByteBuffer n, Type t, @Cast("bool") boolean blocking, int queueSize, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, n, t, blocking, queueSize, types); }
        private native void allocate(@ByRef Node par, @StdString ByteBuffer n, Type t, @Cast("bool") boolean blocking, int queueSize, @StdVector DatatypeHierarchy types);
        ...
        public Input(@ByRef Node par, @StdString ByteBuffer n, @Cast("dai::Node::Input::Type") int t, @Cast("bool") boolean blocking, int queueSize, @Cast("bool") boolean waitForMessage, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, n, t, blocking, queueSize, waitForMessage, types); }
        private native void allocate(@ByRef Node par, @StdString ByteBuffer n, @Cast("dai::Node::Input::Type") int t, @Cast("bool") boolean blocking, int queueSize, @Cast("bool") boolean waitForMessage, @StdVector DatatypeHierarchy types);
        public Input(@ByRef Node par, @StdString String n, Type t, @Cast("bool") boolean blocking, int queueSize, @Cast("bool") boolean waitForMessage, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, n, t, blocking, queueSize, waitForMessage, types); }
        private native void allocate(@ByRef Node par, @StdString String n, Type t, @Cast("bool") boolean blocking, int queueSize, @Cast("bool") boolean waitForMessage, @StdVector DatatypeHierarchy types);
        public Input(@ByRef Node par, @StdString BytePointer n, @Cast("dai::Node::Input::Type") int t, @Cast("bool") boolean blocking, int queueSize, @Cast("bool") boolean waitForMessage, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, n, t, blocking, queueSize, waitForMessage, types); }
        private native void allocate(@ByRef Node par, @StdString BytePointer n, @Cast("dai::Node::Input::Type") int t, @Cast("bool") boolean blocking, int queueSize, @Cast("bool") boolean waitForMessage, @StdVector DatatypeHierarchy types);
        public Input(@ByRef Node par, @StdString ByteBuffer n, Type t, @Cast("bool") boolean blocking, int queueSize, @Cast("bool") boolean waitForMessage, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, n, t, blocking, queueSize, waitForMessage, types); }
        private native void allocate(@ByRef Node par, @StdString ByteBuffer n, Type t, @Cast("bool") boolean blocking, int queueSize, @Cast("bool") boolean waitForMessage, @StdVector DatatypeHierarchy types);
        ...
        public Input(@ByRef Node par, @StdString ByteBuffer group, @StdString ByteBuffer n, @Cast("dai::Node::Input::Type") int t, @Cast("bool") boolean blocking, int queueSize, @Cast("bool") boolean waitForMessage, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, group, n, t, blocking, queueSize, waitForMessage, types); }
        private native void allocate(@ByRef Node par, @StdString ByteBuffer group, @StdString ByteBuffer n, @Cast("dai::Node::Input::Type") int t, @Cast("bool") boolean blocking, int queueSize, @Cast("bool") boolean waitForMessage, @StdVector DatatypeHierarchy types);
        public Input(@ByRef Node par, @StdString String group, @StdString String n, Type t, @Cast("bool") boolean blocking, int queueSize, @Cast("bool") boolean waitForMessage, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, group, n, t, blocking, queueSize, waitForMessage, types); }
        private native void allocate(@ByRef Node par, @StdString String group, @StdString String n, Type t, @Cast("bool") boolean blocking, int queueSize, @Cast("bool") boolean waitForMessage, @StdVector DatatypeHierarchy types);
        public Input(@ByRef Node par, @StdString BytePointer group, @StdString BytePointer n, @Cast("dai::Node::Input::Type") int t, @Cast("bool") boolean blocking, int queueSize, @Cast("bool") boolean waitForMessage, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, group, n, t, blocking, queueSize, waitForMessage, types); }
        private native void allocate(@ByRef Node par, @StdString BytePointer group, @StdString BytePointer n, @Cast("dai::Node::Input::Type") int t, @Cast("bool") boolean blocking, int queueSize, @Cast("bool") boolean waitForMessage, @StdVector DatatypeHierarchy types);
        public Input(@ByRef Node par, @StdString ByteBuffer group, @StdString ByteBuffer n, Type t, @Cast("bool") boolean blocking, int queueSize, @Cast("bool") boolean waitForMessage, @StdVector DatatypeHierarchy types) { super((Pointer)null); allocate(par, group, n, t, blocking, queueSize, waitForMessage, types); }
        private native void allocate(@ByRef Node par, @StdString ByteBuffer group, @StdString ByteBuffer n, Type t, @Cast("bool") boolean blocking, int queueSize, @Cast("bool") boolean waitForMessage, @StdVector DatatypeHierarchy types);
    ...
    @NoOffset public static class InputMap extends StringNodeInputMap {
        ...
        public InputMap(@StdString ByteBuffer name, @ByVal Input defaultInput) { super((Pointer)null); allocate(name, defaultInput); }
        private native void allocate(@StdString ByteBuffer name, @ByVal Input defaultInput);
        ...
        public native @ByRef @Name("operator []") Input get(@StdString ByteBuffer key);
