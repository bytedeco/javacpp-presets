...
public class BootloaderConfig extends Pointer {
    ...
    public native @Cast("uint32_t") int userBlSize(); public native BootloaderConfig userBlSize(int setter);
    public native @Cast("uint32_t") int userBlChecksum(); public native BootloaderConfig userBlChecksum(int setter);
}
