...
public class RawImgDetections extends RawBuffer {
    ...
    public native @Cast("int64_t") long sequenceNum(); public native RawImgDetections sequenceNum(long setter);  // increments for each frame
    public native @ByRef Timestamp ts(); public native RawImgDetections ts(Timestamp setter);        // generation timestamp, synced to host time
    public native @ByRef Timestamp tsDevice(); public native RawImgDetections tsDevice(Timestamp setter);  // generation timestamp, direct device monotonic clock
