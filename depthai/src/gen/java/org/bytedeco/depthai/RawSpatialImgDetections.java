...
public class RawSpatialImgDetections extends RawBuffer {
    ...
    public native @Cast("int64_t") long sequenceNum(); public native RawSpatialImgDetections sequenceNum(long setter);  // increments for each frame
    public native @ByRef Timestamp ts(); public native RawSpatialImgDetections ts(Timestamp setter);        // generation timestamp, synced to host time
    public native @ByRef Timestamp tsDevice(); public native RawSpatialImgDetections tsDevice(Timestamp setter);  // generation timestamp, direct device monotonic clock
