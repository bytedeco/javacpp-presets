...
public class SpatialLocationCalculatorConfig extends Buffer {
     ...
     */
    public native @ByRef SpatialLocationCalculatorConfig set(@ByVal RawSpatialLocationCalculatorConfig config);

    /**
     * Retrieve configuration data for SpatialLocationCalculator.
     * @return config for SpatialLocationCalculator
     */
    public native @ByVal RawSpatialLocationCalculatorConfig get();
}
