...
public class RawSpatialLocations extends RawBuffer {
    ...
    public native @Cast("int64_t") long sequenceNum(); public native RawSpatialLocations sequenceNum(long setter);  // increments for each frame
    public native @ByRef Timestamp ts(); public native RawSpatialLocations ts(Timestamp setter);        // generation timestamp, synced to host time
    public native @ByRef Timestamp tsDevice(); public native RawSpatialLocations tsDevice(Timestamp setter);  // generation timestamp, direct device monotonic clock
