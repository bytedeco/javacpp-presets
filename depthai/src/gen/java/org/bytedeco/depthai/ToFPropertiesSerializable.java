...
@Name("dai::PropertiesSerializable<dai::Properties,dai::ToFProperties>") @Properties(inherit = org.bytedeco.depthai.presets.depthai.class)
public class ToFPropertiesSerializable extends DaiProperties {
    static { Loader.load(); }
    /** Default native constructor. */
    public ToFPropertiesSerializable() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ToFPropertiesSerializable(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ToFPropertiesSerializable(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public ToFPropertiesSerializable position(long position) {
        return (ToFPropertiesSerializable)super.position(position);
    }
    @Override public ToFPropertiesSerializable getPointer(long i) {
        return new ToFPropertiesSerializable((Pointer)this).offsetAddress(i);
    }
