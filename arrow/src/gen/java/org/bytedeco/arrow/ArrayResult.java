...
@Name("arrow::Result<std::shared_ptr<arrow::Array> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class ArrayResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ArrayResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ArrayResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ArrayResult position(long position) {
   ...
   *  Result. */
  public ArrayResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ArrayResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public ArrayResult(@SharedPtr @Cast({"", "std::shared_ptr<arrow::Array>"}) Array value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::Array>"}) Array value);
  ...
  ///
  ///
  public ArrayResult(@Const @ByRef ArrayResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef ArrayResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) ArrayResult put(@Const @ByRef ArrayResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ArrayResult other);
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::Array>"}) Array ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::Array>"}) Array MoveValueUnsafe();
}
