...
public class ArrayResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef ArrayResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") ArrayResult put(@Const @ByRef ArrayResult other);
  ...
  public native @SharedPtr @ByRef Array ValueUnsafe();
