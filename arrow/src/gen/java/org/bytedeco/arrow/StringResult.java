...
@Name("arrow::Result<std::string>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class StringResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public StringResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public StringResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public StringResult position(long position) {
        return (StringResult)super.position(position);
    }
    @Override public StringResult getPointer(long i) {
        return new StringResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public StringResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public StringResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public StringResult(@StdString String value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@StdString String value);
  public StringResult(@StdString BytePointer value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@StdString BytePointer value);
  ...
  ///
  ///
  public StringResult(@Const @ByRef StringResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef StringResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) StringResult put(@Const @ByRef StringResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef StringResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @StdString @ByRef @Cast({"char*", "std::string*"}) BytePointer ValueOrDie();
  public native @StdString @ByRef @Name("operator *") @Cast({"char*", "std::string*"}) BytePointer multiply();
  
  ///
  ///
  public native @StdString @Name("operator ->") @Cast({"char*", "std::string*"}) BytePointer access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @StdString String ValueUnsafe();
// #else
// #endif

  

  public native @StdString String MoveValueUnsafe();
}
