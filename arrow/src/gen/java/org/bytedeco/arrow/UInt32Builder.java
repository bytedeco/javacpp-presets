...
public class UInt32Builder extends ArrayBuilder {
   ...
   *  @return Status */
  public native @ByVal Status AppendValues(@Cast("const arrow::NumericBuilder<arrow::UInt32Type>::value_type*") IntPointer values, @Cast("int64_t") long length, @Cast("const uint8_t*") BytePointer bitmap,
                        @Cast("int64_t") long bitmap_offset);
  public native @ByVal Status AppendValues(@Cast("const arrow::NumericBuilder<arrow::UInt32Type>::value_type*") IntBuffer values, @Cast("int64_t") long length, @Cast("const uint8_t*") ByteBuffer bitmap,
                        @Cast("int64_t") long bitmap_offset);
  public native @ByVal Status AppendValues(@Cast("const arrow::NumericBuilder<arrow::UInt32Type>::value_type*") int[] values, @Cast("int64_t") long length, @Cast("const uint8_t*") byte[] bitmap,
                        @Cast("int64_t") long bitmap_offset);
