...
@Name("std::vector<std::shared_ptr<arrow::ChunkedArray> >") @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class ChunkedArrayVector extends Pointer {
    static { Loader.load(); }
    ...
    public native @Name("operator =") @ByRef ChunkedArrayVector put(@ByRef ChunkedArrayVector x);
    ...
    public ChunkedArray[] get() {
        ChunkedArray[] array = new ChunkedArray[size() < Integer.MAX_VALUE ? (int)size() : Integer.MAX_VALUE];
