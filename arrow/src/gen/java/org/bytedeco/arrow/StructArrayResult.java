...
public class StructArrayResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef StructArrayResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") StructArrayResult put(@Const @ByRef StructArrayResult other);
