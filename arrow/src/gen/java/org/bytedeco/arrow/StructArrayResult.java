...
@Name("arrow::Result<std::shared_ptr<arrow::StructArray> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class StructArrayResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public StructArrayResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public StructArrayResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public StructArrayResult getPointer(long i) {
        return new StructArrayResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public StructArrayResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public StructArrayResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@SharedPtr @ByRef(true) StructArray value);
  ...
  ///
  ///
  public StructArrayResult(@Const @ByRef StructArrayResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef StructArrayResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) StructArrayResult put(@Const @ByRef StructArrayResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef StructArrayResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef StructArray ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") StructArray multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") StructArray access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @SharedPtr @ByRef StructArray ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr @ByVal StructArray MoveValueUnsafe();
}
