...
public class FileSelector extends Pointer {
  ...
  /** The behavior if {@code base_dir} doesn't exist in the filesystem.  If false,
   *  an error is returned.  If true, an empty selection is returned. */
  public native @Cast("bool") boolean allow_non_existent(); public native FileSelector allow_non_existent(boolean setter);
