...
@Name("arrow::Result<std::unique_ptr<arrow::DictionaryUnifier> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class DictionaryUnifierResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public DictionaryUnifierResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public DictionaryUnifierResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public DictionaryUnifierResult getPointer(long i) {
        return new DictionaryUnifierResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public DictionaryUnifierResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public DictionaryUnifierResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public DictionaryUnifierResult(@UniquePtr DictionaryUnifier value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@UniquePtr DictionaryUnifier value);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef DictionaryUnifierResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @UniquePtr DictionaryUnifier ValueOrDie();
  public native @UniquePtr @Name("operator *") DictionaryUnifier multiply();
  
  ///
  ///
  public native @UniquePtr @Name("operator ->") DictionaryUnifier access();
...
// #endif
  ...
  public native @UniquePtr DictionaryUnifier MoveValueUnsafe();
}
