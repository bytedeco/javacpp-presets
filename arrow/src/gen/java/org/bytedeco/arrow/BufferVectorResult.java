...
public class BufferVectorResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef BufferVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") BufferVectorResult put(@Const @ByRef BufferVectorResult other);
