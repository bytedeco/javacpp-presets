...
public class SelectionVectorResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef SelectionVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") SelectionVectorResult put(@Const @ByRef SelectionVectorResult other);
  ...
  public native @SharedPtr @ByRef SelectionVector ValueUnsafe();
