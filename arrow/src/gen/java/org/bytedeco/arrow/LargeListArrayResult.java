...
public class LargeListArrayResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef LargeListArrayResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") LargeListArrayResult put(@Const @ByRef LargeListArrayResult other);
  ...
  public native @SharedPtr @ByRef LargeListArray ValueUnsafe();
