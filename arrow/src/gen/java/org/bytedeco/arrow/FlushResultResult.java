...
public class FlushResultResult extends Pointer {
  ...
  private native void allocate(@ByVal Compressor.FlushResult value);
  ...
  private native void allocate(@Const @ByRef FlushResultResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") FlushResultResult put(@Const @ByRef FlushResultResult other);
