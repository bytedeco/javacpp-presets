...
public class ScalarResult extends Pointer {
  ...
  @NoException private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::Scalar>"}) Scalar value);
  ...
  private native void allocate(@Const @ByRef ScalarResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") ScalarResult put(@Const @ByRef ScalarResult other);
  ...
  public native @SharedPtr @ByRef Scalar ValueUnsafe();
