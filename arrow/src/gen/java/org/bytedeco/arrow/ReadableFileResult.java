...
public class ReadableFileResult extends Pointer {
  ...
  @NoException private native void allocate(@SharedPtr ReadableFile value);
  ...
  private native void allocate(@Const @ByRef ReadableFileResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") ReadableFileResult put(@Const @ByRef ReadableFileResult other);
