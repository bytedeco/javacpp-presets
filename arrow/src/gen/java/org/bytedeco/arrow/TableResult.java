...
public class TableResult extends Pointer {
  ...
  @NoException private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::Table>"}) Table value);
  ...
  private native void allocate(@Const @ByRef TableResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") TableResult put(@Const @ByRef TableResult other);
