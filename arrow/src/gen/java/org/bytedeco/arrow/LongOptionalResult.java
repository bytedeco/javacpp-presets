...
public class LongOptionalResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef LongOptionalResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") LongOptionalResult put(@Const @ByRef LongOptionalResult other);
  ...
  public native @ByRef LongOptional ValueUnsafe();
