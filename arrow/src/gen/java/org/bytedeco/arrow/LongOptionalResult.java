...
@Name("arrow::Result<arrow::util::optional<int64_t> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class LongOptionalResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public LongOptionalResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public LongOptionalResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public LongOptionalResult position(long position) {
        return (LongOptionalResult)super.position(position);
    }
    @Override public LongOptionalResult getPointer(long i) {
        return new LongOptionalResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public LongOptionalResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public LongOptionalResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public LongOptionalResult(@ByRef(true) LongOptional value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@ByRef(true) LongOptional value);
  ...
  ///
  ///
  public LongOptionalResult(@Const @ByRef LongOptionalResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef LongOptionalResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) LongOptionalResult put(@Const @ByRef LongOptionalResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef LongOptionalResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef LongOptional ValueOrDie();
  public native @ByRef @Name("operator *") LongOptional multiply();
  
  ///
  ///
  public native @Name("operator ->") LongOptional access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef LongOptional ValueUnsafe();
// #else
// #endif

  

  public native @ByVal LongOptional MoveValueUnsafe();
}
