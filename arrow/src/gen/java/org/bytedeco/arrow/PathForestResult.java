...
@Name("arrow::Result<arrow::fs::PathForest>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class PathForestResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public PathForestResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public PathForestResult(long size) { super((Pointer)null); allocateArray(size); }
   ...
   *  Result. */
  public PathForestResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public PathForestResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public PathForestResult(@ByVal PathForest value) { super((Pointer)null); allocate(value); }
  @NoException private native void allocate(@ByVal PathForest value);
  ...
  ///
  ///
  public PathForestResult(@Const @ByRef PathForestResult other) { super((Pointer)null); allocate(other); }
  private native void allocate(@Const @ByRef PathForestResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") PathForestResult put(@Const @ByRef PathForestResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef PathForestResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef PathForest ValueOrDie();
  
  ///
  ///
  public native @ByRef @Name("operator *") PathForest multiply();
  ...
  public native @ByRef PathForest ValueUnsafe();

  

  public native @ByVal PathForest MoveValueUnsafe();
}
