...
public class FieldRefResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef FieldRefResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") FieldRefResult put(@Const @ByRef FieldRefResult other);
  ...
  public native @ByRef FieldRef ValueUnsafe();
