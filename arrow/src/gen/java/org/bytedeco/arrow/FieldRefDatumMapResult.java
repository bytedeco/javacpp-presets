...
@Name("arrow::Result<std::unordered_map<arrow::FieldRef,arrow::Datum,arrow::FieldRef::Hash> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class FieldRefDatumMapResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FieldRefDatumMapResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FieldRefDatumMapResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public FieldRefDatumMapResult position(long position) {
        return (FieldRefDatumMapResult)super.position(position);
    }
    @Override public FieldRefDatumMapResult getPointer(long i) {
        return new FieldRefDatumMapResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public FieldRefDatumMapResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FieldRefDatumMapResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) FieldRefDatumMap value);
  ...
  ///
  ///
  public FieldRefDatumMapResult(@Const @ByRef FieldRefDatumMapResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef FieldRefDatumMapResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) FieldRefDatumMapResult put(@Const @ByRef FieldRefDatumMapResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FieldRefDatumMapResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef FieldRefDatumMap ValueOrDie();
  public native @ByRef @Name("operator *") FieldRefDatumMap multiply();
  
  ///
  ///
  public native @Name("operator ->") FieldRefDatumMap access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef FieldRefDatumMap ValueUnsafe();
// #else
// #endif

  

  public native @ByVal FieldRefDatumMap MoveValueUnsafe();
}
