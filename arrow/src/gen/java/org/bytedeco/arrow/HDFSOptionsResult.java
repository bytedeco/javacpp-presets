...
@Name("arrow::Result<arrow::fs::HdfsOptions>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class HDFSOptionsResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public HDFSOptionsResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public HDFSOptionsResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public HDFSOptionsResult position(long position) {
        return (HDFSOptionsResult)super.position(position);
    }
    @Override public HDFSOptionsResult getPointer(long i) {
        return new HDFSOptionsResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public HDFSOptionsResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public HDFSOptionsResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) HdfsOptions value);
  ...
  ///
  ///
  public HDFSOptionsResult(@Const @ByRef HDFSOptionsResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef HDFSOptionsResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) HDFSOptionsResult put(@Const @ByRef HDFSOptionsResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef HdfsOptions ValueOrDie();
  public native @ByRef @Name("operator *") HdfsOptions multiply();
  
  ///
  ///
  public native @Name("operator ->") HdfsOptions access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef HdfsOptions ValueUnsafe();
// #else
// #endif

  

  public native @ByVal HdfsOptions MoveValueUnsafe();
}
