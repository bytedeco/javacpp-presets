...
public class HDFSOptionsResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef HDFSOptionsResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") HDFSOptionsResult put(@Const @ByRef HDFSOptionsResult other);
