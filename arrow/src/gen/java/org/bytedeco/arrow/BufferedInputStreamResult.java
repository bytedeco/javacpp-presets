...
public class BufferedInputStreamResult extends Pointer {
    ...
    @Override public BufferedInputStreamResult getPointer(long i) {
        return new BufferedInputStreamResult((Pointer)this).position(position + i);
    }
  ...
  @NoException private native void allocate(@SharedPtr BufferedInputStream value);
  ...
  private native void allocate(@Const @ByRef BufferedInputStreamResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") BufferedInputStreamResult put(@Const @ByRef BufferedInputStreamResult other);
