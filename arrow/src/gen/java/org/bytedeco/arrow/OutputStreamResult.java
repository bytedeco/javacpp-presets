...
public class OutputStreamResult extends Pointer {
  ...
  @NoException(true) private native void allocate(@Const @ByRef OutputStreamResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) OutputStreamResult put(@Const @ByRef OutputStreamResult other);
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @SharedPtr OutputStream ValueUnsafe();
// #else
// #endif
