...
@Name("arrow::Result<std::shared_ptr<arrow::io::OutputStream> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class OutputStreamResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public OutputStreamResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public OutputStreamResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public OutputStreamResult getPointer(long i) {
        return new OutputStreamResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public OutputStreamResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public OutputStreamResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public OutputStreamResult(@SharedPtr OutputStream value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr OutputStream value);
  ...
  ///
  ///
  public OutputStreamResult(@Const @ByRef OutputStreamResult other) { super((Pointer)null); allocate(other); }
  private native void allocate(@Const @ByRef OutputStreamResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") OutputStreamResult put(@Const @ByRef OutputStreamResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef OutputStreamResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef @Cast({"", "std::shared_ptr<arrow::io::OutputStream>*"}) OutputStream ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") @Cast({"", "std::shared_ptr<arrow::io::OutputStream>*"}) OutputStream multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") @Cast({"", "std::shared_ptr<arrow::io::OutputStream>*"}) OutputStream access();
  ...
  public native @SharedPtr @ByRef @Cast({"", "std::shared_ptr<arrow::io::OutputStream>*"}) OutputStream ValueUnsafe();

  

  public native @SharedPtr OutputStream MoveValueUnsafe();
}
