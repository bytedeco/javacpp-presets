...
public class SchemaResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef SchemaResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") SchemaResult put(@Const @ByRef SchemaResult other);
  ...
  public native @SharedPtr @ByRef Schema ValueUnsafe();
