...
public class CompressedOutputStreamResult extends Pointer {
  ...
  @NoException private native void allocate(@SharedPtr CompressedOutputStream value);
  ...
  private native void allocate(@Const @ByRef CompressedOutputStreamResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") CompressedOutputStreamResult put(@Const @ByRef CompressedOutputStreamResult other);
