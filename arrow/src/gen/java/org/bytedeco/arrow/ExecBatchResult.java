...
public class ExecBatchResult extends Pointer {
  ...
  ///
  ///
  public ExecBatchResult(@Cast("const arrow::Result<arrow::compute::ExecBatch>*") @ByRef ExecBatchResult other) { super((Pointer)null); allocate(other); }
  private native void allocate(@Cast("const arrow::Result<arrow::compute::ExecBatch>*") @ByRef ExecBatchResult other);
  ...
  ///
  ///
  public native @Cast("arrow::Result<arrow::compute::ExecBatch>*") @ByRef @Name("operator =") ExecBatchResult put(@Cast("const arrow::Result<arrow::compute::ExecBatch>*") @ByRef ExecBatchResult other);
  ...
  public native @ByRef ExecBatch ValueUnsafe();
