...
public class CompressedInputStreamResult extends Pointer {
    ...
    @Override public CompressedInputStreamResult getPointer(long i) {
        return new CompressedInputStreamResult((Pointer)this).position(position + i);
    }
  ...
  @NoException private native void allocate(@SharedPtr CompressedInputStream value);
  ...
  private native void allocate(@Const @ByRef CompressedInputStreamResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") CompressedInputStreamResult put(@Const @ByRef CompressedInputStreamResult other);
