...
public class MessageSharedResult extends Pointer {
  ...
  ///
  ///
  public MessageSharedResult(@SharedPtr Message value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr Message value);
  ...
  private native void allocate(@Const @ByRef MessageSharedResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") MessageSharedResult put(@Const @ByRef MessageSharedResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr Message ValueOrDie();
  public native @SharedPtr @Name("operator *") Message multiply();
  ...
  public native @SharedPtr Message MoveValueUnsafe();
}
