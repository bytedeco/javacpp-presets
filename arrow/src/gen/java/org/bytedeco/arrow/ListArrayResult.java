...
public class ListArrayResult extends Pointer {
    ...
    public ListArrayResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ListArrayResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public ListArrayResult getPointer(long i) {
        return new ListArrayResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ListArrayResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ListArrayResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@SharedPtr @ByRef(true) ListArray value);
  ...
  ///
  ///
  public ListArrayResult(@Const @ByRef ListArrayResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef ListArrayResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) ListArrayResult put(@Const @ByRef ListArrayResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ListArrayResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef ListArray ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") ListArray multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") ListArray access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @SharedPtr @ByRef ListArray ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr @ByVal ListArray MoveValueUnsafe();
}
