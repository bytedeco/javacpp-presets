...
public class ListArrayResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef ListArrayResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") ListArrayResult put(@Const @ByRef ListArrayResult other);
  ...
  public native @SharedPtr @ByRef ListArray ValueUnsafe();
