...
public class DatumResult extends Pointer {
  ...
  private native void allocate(@ByVal Datum value);
  ...
  private native void allocate(@Const @ByRef DatumResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") DatumResult put(@Const @ByRef DatumResult other);
