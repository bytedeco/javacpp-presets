...
public class BufferOutputStreamResult extends Pointer {
  ...
  @NoException private native void allocate(@SharedPtr BufferOutputStream value);
  ...
  private native void allocate(@Const @ByRef BufferOutputStreamResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") BufferOutputStreamResult put(@Const @ByRef BufferOutputStreamResult other);
