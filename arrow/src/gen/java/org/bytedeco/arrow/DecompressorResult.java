...
public class DecompressorResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef DecompressorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") DecompressorResult put(@Const @ByRef DecompressorResult other);
