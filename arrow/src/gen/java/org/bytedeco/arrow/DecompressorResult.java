...
@Name("arrow::Result<std::shared_ptr<arrow::util::Decompressor> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class DecompressorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public DecompressorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public DecompressorResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public DecompressorResult position(long position) {
        return (DecompressorResult)super.position(position);
    }
    @Override public DecompressorResult getPointer(long i) {
        return new DecompressorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public DecompressorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public DecompressorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public DecompressorResult(@SharedPtr Decompressor value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr Decompressor value);
  ...
  ///
  ///
  public DecompressorResult(@Const @ByRef DecompressorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef DecompressorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) DecompressorResult put(@Const @ByRef DecompressorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef DecompressorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr Decompressor ValueOrDie();
  public native @SharedPtr @Name("operator *") Decompressor multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") Decompressor access();
...
// #endif
  ...
  public native @SharedPtr Decompressor MoveValueUnsafe();
}
