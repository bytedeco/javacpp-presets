...
public class RecordBatchStreamReaderResult extends Pointer {
  ...
  @NoException private native void allocate(@SharedPtr RecordBatchStreamReader value);
  ...
  private native void allocate(@Const @ByRef RecordBatchStreamReaderResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") RecordBatchStreamReaderResult put(@Const @ByRef RecordBatchStreamReaderResult other);
