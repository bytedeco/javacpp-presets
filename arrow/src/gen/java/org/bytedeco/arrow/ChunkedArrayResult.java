...
public class ChunkedArrayResult extends Pointer {
  ...
  @NoException private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::ChunkedArray>"}) ChunkedArray value);
  ...
  private native void allocate(@Const @ByRef ChunkedArrayResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") ChunkedArrayResult put(@Const @ByRef ChunkedArrayResult other);
