...
@Name("arrow::Result<std::shared_ptr<arrow::io::MemoryMappedFile> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class MemoryMappedFileResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public MemoryMappedFileResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public MemoryMappedFileResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public MemoryMappedFileResult position(long position) {
        return (MemoryMappedFileResult)super.position(position);
    }
    @Override public MemoryMappedFileResult getPointer(long i) {
        return new MemoryMappedFileResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public MemoryMappedFileResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public MemoryMappedFileResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public MemoryMappedFileResult(@SharedPtr MemoryMappedFile value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr MemoryMappedFile value);
  ...
  ///
  ///
  public MemoryMappedFileResult(@Const @ByRef MemoryMappedFileResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef MemoryMappedFileResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) MemoryMappedFileResult put(@Const @ByRef MemoryMappedFileResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef MemoryMappedFileResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr MemoryMappedFile ValueOrDie();
  public native @SharedPtr @Name("operator *") MemoryMappedFile multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") MemoryMappedFile access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @SharedPtr MemoryMappedFile ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr MemoryMappedFile MoveValueUnsafe();
}
