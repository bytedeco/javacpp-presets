...
public class MemoryMappedFileResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef MemoryMappedFileResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") MemoryMappedFileResult put(@Const @ByRef MemoryMappedFileResult other);
