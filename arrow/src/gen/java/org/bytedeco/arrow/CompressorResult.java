...
public class CompressorResult extends Pointer {
  ...
  @NoException private native void allocate(@SharedPtr Compressor value);
  ...
  private native void allocate(@Const @ByRef CompressorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") CompressorResult put(@Const @ByRef CompressorResult other);
