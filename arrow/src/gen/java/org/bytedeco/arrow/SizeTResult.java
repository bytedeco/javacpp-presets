...
public class SizeTResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef SizeTResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") SizeTResult put(@Const @ByRef SizeTResult other);
  ...
  public native @Cast("size_t*") @ByRef SizeTPointer ValueUnsafe();
