...
public class ScalarKernelResult extends Pointer {
  ...
  @NoException private native void allocate(ScalarKernel value);
  ...
  private native void allocate(@Cast("const arrow::Result<arrow::compute::ScalarKernel*>*") @ByRef ScalarKernelResult other);
  ...
  ///
  ///
  public native @Cast("arrow::Result<arrow::compute::ScalarKernel*>*") @ByRef @Name("operator =") ScalarKernelResult put(@Cast("const arrow::Result<arrow::compute::ScalarKernel*>*") @ByRef ScalarKernelResult other);
