...
@Name("arrow::Result<std::shared_ptr<arrow::ipc::RecordBatchWriter> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class RecordBatchWriterSharedResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public RecordBatchWriterSharedResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public RecordBatchWriterSharedResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public RecordBatchWriterSharedResult getPointer(long i) {
        return new RecordBatchWriterSharedResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public RecordBatchWriterSharedResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public RecordBatchWriterSharedResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public RecordBatchWriterSharedResult(@SharedPtr RecordBatchWriter value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr RecordBatchWriter value);
  ...
  ///
  ///
  public RecordBatchWriterSharedResult(@Const @ByRef RecordBatchWriterSharedResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef RecordBatchWriterSharedResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) RecordBatchWriterSharedResult put(@Const @ByRef RecordBatchWriterSharedResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef RecordBatchWriterSharedResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr RecordBatchWriter ValueOrDie();
  public native @SharedPtr @Name("operator *") RecordBatchWriter multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") RecordBatchWriter access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @SharedPtr RecordBatchWriter ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr RecordBatchWriter MoveValueUnsafe();
}
