...
public class RecordBatchWriterSharedResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef RecordBatchWriterSharedResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") RecordBatchWriterSharedResult put(@Const @ByRef RecordBatchWriterSharedResult other);
