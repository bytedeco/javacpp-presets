...
@Name("arrow::Result<arrow::Decimal256>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class Decimal256Result extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public Decimal256Result(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public Decimal256Result(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public Decimal256Result position(long position) {
        return (Decimal256Result)super.position(position);
    }
    @Override public Decimal256Result getPointer(long i) {
        return new Decimal256Result((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public Decimal256Result() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public Decimal256Result(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public Decimal256Result(@ByRef(true) Decimal256 value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@ByRef(true) Decimal256 value);
  ...
  ///
  ///
  public Decimal256Result(@Const @ByRef Decimal256Result other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef Decimal256Result other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) Decimal256Result put(@Const @ByRef Decimal256Result other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef Decimal256Result other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef Decimal256 ValueOrDie();
  public native @ByRef @Name("operator *") Decimal256 multiply();
  
  ///
  ///
  public native @Name("operator ->") Decimal256 access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef Decimal256 ValueUnsafe();
// #else
// #endif

  

  public native @ByVal Decimal256 MoveValueUnsafe();
}
