...
public class StreamingReaderResult extends Pointer {
    ...
    @Override public StreamingReaderResult getPointer(long i) {
        return new StreamingReaderResult((Pointer)this).offsetAddress(i);
    }
  ...
  ///
  ///
  public StreamingReaderResult(@SharedPtr @Cast({"", "std::shared_ptr<arrow::csv::StreamingReader>"}) StreamingReader value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::csv::StreamingReader>"}) StreamingReader value);
  ...
  @NoException(true) private native void allocate(@Const @ByRef StreamingReaderResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) StreamingReaderResult put(@Const @ByRef StreamingReaderResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef StreamingReader ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") StreamingReader multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") StreamingReader access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::csv::StreamingReader>"}) StreamingReader ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::csv::StreamingReader>"}) StreamingReader MoveValueUnsafe();
}
