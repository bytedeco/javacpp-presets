...
public class CompressResultResult extends Pointer {
    ...
    @Override public CompressResultResult getPointer(long i) {
        return new CompressResultResult((Pointer)this).position(position + i);
    }
  ...
  private native void allocate(@Const @ByRef CompressResultResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") CompressResultResult put(@Const @ByRef CompressResultResult other);
  ...
  public native @ByRef Compressor.CompressResult ValueUnsafe();
