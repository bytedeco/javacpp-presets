...
public class StringPairResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef StringPairResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") StringPairResult put(@Const @ByRef StringPairResult other);
  ...
  public native @ByRef StringPair ValueUnsafe();
