...
@Name("arrow::Result<std::pair<std::string,std::string> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class StringPairResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public StringPairResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public StringPairResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public StringPairResult position(long position) {
        return (StringPairResult)super.position(position);
    }
    @Override public StringPairResult getPointer(long i) {
        return new StringPairResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public StringPairResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public StringPairResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public StringPairResult(@Const @ByRef StringPairResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef StringPairResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) StringPairResult put(@Const @ByRef StringPairResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef StringPairResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef StringPair ValueOrDie();
  public native @ByRef @Name("operator *") StringPair multiply();
  
  ///
  ///
  public native @Name("operator ->") StringPair access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef StringPair ValueUnsafe();
// #else
// #endif

  

  public native @ByVal StringPair MoveValueUnsafe();
}
