...
public class BooleanArray extends PrimitiveArray {
  ...
  private native void allocate(@Cast("int64_t") long length, @Const @SharedPtr @ByRef ArrowBuffer data,
                 @Const @SharedPtr @ByRef(nullValue = "std::shared_ptr<arrow::Buffer>(nullptr)") ArrowBuffer null_bitmap,
                 @Cast("int64_t") long null_count/*=arrow::kUnknownNullCount*/, @Cast("int64_t") long offset/*=0*/);
  public BooleanArray(@Cast("int64_t") long length, @Const @SharedPtr @ByRef ArrowBuffer data) { super((Pointer)null); allocate(length, data); }
  private native void allocate(@Cast("int64_t") long length, @Const @SharedPtr @ByRef ArrowBuffer data);
