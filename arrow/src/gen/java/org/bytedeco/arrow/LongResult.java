...
@Name("arrow::Result<int64_t>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class LongResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public LongResult(Pointer p) { super(p); }
  ...
  @NoException(true) private native void allocate(@Cast("int64_t&&") long value);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef LongResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @Cast("int64_t*") @ByRef LongPointer ValueOrDie();
  public native @Cast("int64_t*") @ByRef @Name("operator *") LongPointer multiply();
  
  ///
  ///
  public native @Cast("int64_t*") @Name("operator ->") LongPointer access();
...
// #endif
  ...
  public native @Cast("int64_t") long MoveValueUnsafe();
}
