...
public class RecordBatchFileReaderResult extends Pointer {
  ...
  ///
  ///
  public RecordBatchFileReaderResult(@SharedPtr RecordBatchFileReader value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr RecordBatchFileReader value);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr RecordBatchFileReader ValueOrDie();
  public native @SharedPtr @Name("operator *") RecordBatchFileReader multiply();
  ...
  public native @SharedPtr RecordBatchFileReader ValueUnsafe();

  

  public native @SharedPtr RecordBatchFileReader MoveValueUnsafe();
}
