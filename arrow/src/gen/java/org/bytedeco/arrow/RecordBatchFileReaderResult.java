...
public class RecordBatchFileReaderResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef RecordBatchFileReaderResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") RecordBatchFileReaderResult put(@Const @ByRef RecordBatchFileReaderResult other);
  ...
  public native @SharedPtr @ByRef RecordBatchFileReader ValueUnsafe();
