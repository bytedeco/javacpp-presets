...
@Name("arrow::Result<std::shared_ptr<arrow::ipc::RecordBatchFileReader> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class RecordBatchFileReaderResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public RecordBatchFileReaderResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public RecordBatchFileReaderResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public RecordBatchFileReaderResult getPointer(long i) {
        return new RecordBatchFileReaderResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public RecordBatchFileReaderResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public RecordBatchFileReaderResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public RecordBatchFileReaderResult(@SharedPtr @Cast({"", "std::shared_ptr<arrow::ipc::RecordBatchFileReader>"}) RecordBatchFileReader value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::ipc::RecordBatchFileReader>"}) RecordBatchFileReader value);
  ...
  ///
  ///
  public RecordBatchFileReaderResult(@Const @ByRef RecordBatchFileReaderResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef RecordBatchFileReaderResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) RecordBatchFileReaderResult put(@Const @ByRef RecordBatchFileReaderResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef RecordBatchFileReaderResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef RecordBatchFileReader ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") RecordBatchFileReader multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") RecordBatchFileReader access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::ipc::RecordBatchFileReader>"}) RecordBatchFileReader ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::ipc::RecordBatchFileReader>"}) RecordBatchFileReader MoveValueUnsafe();
}
