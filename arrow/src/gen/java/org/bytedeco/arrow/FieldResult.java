...
@Name("arrow::Result<std::shared_ptr<arrow::Field> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class FieldResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FieldResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FieldResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public FieldResult getPointer(long i) {
        return new FieldResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public FieldResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FieldResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::Field>"}) Field value);
  ...
  ///
  ///
  public FieldResult(@Const @ByRef FieldResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef FieldResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) FieldResult put(@Const @ByRef FieldResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FieldResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef Field ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") Field multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") Field access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::Field>"}) Field ValueUnsafe();
// #else
// #endif
