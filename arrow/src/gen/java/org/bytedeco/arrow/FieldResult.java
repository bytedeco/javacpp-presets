...
public class FieldResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef FieldResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") FieldResult put(@Const @ByRef FieldResult other);
  ...
  public native @SharedPtr @ByRef Field ValueUnsafe();
