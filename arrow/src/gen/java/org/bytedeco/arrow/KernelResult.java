...
@Name("arrow::Result<arrow::compute::Kernel*>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class KernelResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public KernelResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public KernelResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public KernelResult position(long position) {
        return (KernelResult)super.position(position);
    }
    @Override public KernelResult getPointer(long i) {
        return new KernelResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public KernelResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public KernelResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public KernelResult(Kernel value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(Kernel value);
  ...
  ///
  ///
  public KernelResult(@Cast("const arrow::Result<arrow::compute::Kernel*>*") @ByRef KernelResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Cast("const arrow::Result<arrow::compute::Kernel*>*") @ByRef KernelResult other);
  ...
  ///
  ///
  public native @Cast("arrow::Result<arrow::compute::Kernel*>*") @ByRef @Name("operator =") @NoException(true) KernelResult put(@Cast("const arrow::Result<arrow::compute::Kernel*>*") @ByRef KernelResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Cast("const arrow::Result<arrow::compute::Kernel*>*") @ByRef KernelResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByPtrRef Kernel ValueOrDie();
  public native @ByPtrRef @Name("operator *") Kernel multiply();
  
  ///
  ///
  public native @Cast("arrow::compute::Kernel**") @Name("operator ->") PointerPointer access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @ByPtrRef Kernel ValueUnsafe();
// #else
// #endif

  

  public native Kernel MoveValueUnsafe();
}
