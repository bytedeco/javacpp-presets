...
public class KernelResult extends Pointer {
  ...
  private native void allocate(@Cast("const arrow::Result<arrow::compute::Kernel*>*") @ByRef KernelResult other);
  ...
  ///
  ///
  public native @Cast("arrow::Result<arrow::compute::Kernel*>*") @ByRef @Name("operator =") KernelResult put(@Cast("const arrow::Result<arrow::compute::Kernel*>*") @ByRef KernelResult other);
