...
public class FileOutputStreamResult extends Pointer {
  ...
  @NoException private native void allocate(@SharedPtr FileOutputStream value);
  ...
  private native void allocate(@Const @ByRef FileOutputStreamResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") FileOutputStreamResult put(@Const @ByRef FileOutputStreamResult other);
  ...
  public native @SharedPtr @ByRef @Cast({"", "std::shared_ptr<arrow::io::FileOutputStream>*"}) FileOutputStream ValueUnsafe();
