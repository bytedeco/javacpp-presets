...
public class VectorKernelResult extends Pointer {
  ...
  private native void allocate(@Cast("const arrow::Result<arrow::compute::VectorKernel*>*") @ByRef VectorKernelResult other);
  ...
  ///
  ///
  public native @Cast("arrow::Result<arrow::compute::VectorKernel*>*") @ByRef @Name("operator =") VectorKernelResult put(@Cast("const arrow::Result<arrow::compute::VectorKernel*>*") @ByRef VectorKernelResult other);
