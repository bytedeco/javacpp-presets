...
@Name("arrow::Result<arrow::compute::VectorKernel*>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class VectorKernelResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public VectorKernelResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public VectorKernelResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public VectorKernelResult position(long position) {
        return (VectorKernelResult)super.position(position);
    }
    @Override public VectorKernelResult getPointer(long i) {
        return new VectorKernelResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public VectorKernelResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public VectorKernelResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public VectorKernelResult(VectorKernel value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(VectorKernel value);
  ...
  ///
  ///
  public VectorKernelResult(@Cast("const arrow::Result<arrow::compute::VectorKernel*>*") @ByRef VectorKernelResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Cast("const arrow::Result<arrow::compute::VectorKernel*>*") @ByRef VectorKernelResult other);
  ...
  ///
  ///
  public native @Cast("arrow::Result<arrow::compute::VectorKernel*>*") @ByRef @Name("operator =") @NoException(true) VectorKernelResult put(@Cast("const arrow::Result<arrow::compute::VectorKernel*>*") @ByRef VectorKernelResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Cast("const arrow::Result<arrow::compute::VectorKernel*>*") @ByRef VectorKernelResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByPtrRef VectorKernel ValueOrDie();
  public native @ByPtrRef @Name("operator *") VectorKernel multiply();
  
  ///
  ///
  public native @Cast("arrow::compute::VectorKernel**") @Name("operator ->") PointerPointer access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @ByPtrRef VectorKernel ValueUnsafe();
// #else
// #endif

  

  public native VectorKernel MoveValueUnsafe();
}
