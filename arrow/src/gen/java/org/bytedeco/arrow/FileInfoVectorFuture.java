...
@Name("arrow::Future<std::vector<arrow::fs::FileInfo> >") @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class FileInfoVectorFuture extends Pointer {
  ...
  public native @ByVal FileInfoVectorResult MoveResult();
