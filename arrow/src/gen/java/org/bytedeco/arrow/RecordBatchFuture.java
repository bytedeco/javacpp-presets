...
@Name("arrow::Future<std::shared_ptr<arrow::RecordBatch> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class RecordBatchFuture extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public RecordBatchFuture(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public RecordBatchFuture(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public RecordBatchFuture position(long position) {
        return (RecordBatchFuture)super.position(position);
    }
    @Override public RecordBatchFuture getPointer(long i) {
        return new RecordBatchFuture((Pointer)this).offsetAddress(i);
    }
  ...
  public RecordBatchFuture() { super((Pointer)null); allocate(); }
  ...
  ///
  public native @Const @ByRef RecordBatchResult result();
  ...
  public native @ByRef(true) RecordBatchResult MoveResult();
  ...
  public native void MarkFinished(@ByVal RecordBatchResult res);
  ...
  public static native @ByVal RecordBatchFuture Make();

  /** \brief Producer API: instantiate a finished Future */
  public static native @ByVal RecordBatchFuture MakeFinished(@ByVal RecordBatchResult res);
  ...
  public RecordBatchFuture(@SharedPtr @Cast({"", "std::shared_ptr<arrow::RecordBatch>"}) RecordBatch val) { super((Pointer)null); allocate(val); }
  private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::RecordBatch>"}) RecordBatch val);

  /** \brief Implicit constructor to create a future from a Result, enabling use
   *      of macros like ARROW_ASSIGN_OR_RAISE. */
  public RecordBatchFuture(@ByVal RecordBatchResult res) { super((Pointer)null); allocate(res); }
  private native void allocate(@ByVal RecordBatchResult res);

  /** \brief Implicit constructor to create a future from a Status, enabling use
   *      of macros like ARROW_RETURN_NOT_OK. */
  public RecordBatchFuture(@ByVal Status s) { super((Pointer)null); allocate(s); }
