...
@Name("arrow::Future<std::shared_ptr<arrow::ipc::RecordBatchFileReader> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class RecordBatchFileReaderFuture extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public RecordBatchFileReaderFuture(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public RecordBatchFileReaderFuture(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public RecordBatchFileReaderFuture position(long position) {
        return (RecordBatchFileReaderFuture)super.position(position);
    }
    @Override public RecordBatchFileReaderFuture getPointer(long i) {
        return new RecordBatchFileReaderFuture((Pointer)this).offsetAddress(i);
    }
  ...
  public RecordBatchFileReaderFuture() { super((Pointer)null); allocate(); }
  ...
  ///
  public native @Const @ByRef RecordBatchFileReaderResult result();
  ...
  public native @ByRef(true) RecordBatchFileReaderResult MoveResult();
  ...
  public native void MarkFinished(@ByVal RecordBatchFileReaderResult res);
  ...
  public static native @ByVal RecordBatchFileReaderFuture Make();

  /** \brief Producer API: instantiate a finished Future */
  public static native @ByVal RecordBatchFileReaderFuture MakeFinished(@ByVal RecordBatchFileReaderResult res);
  ...
  public RecordBatchFileReaderFuture(@SharedPtr @Cast({"", "std::shared_ptr<arrow::ipc::RecordBatchFileReader>"}) RecordBatchFileReader val) { super((Pointer)null); allocate(val); }
  private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::ipc::RecordBatchFileReader>"}) RecordBatchFileReader val);

  /** \brief Implicit constructor to create a future from a Result, enabling use
   *      of macros like ARROW_ASSIGN_OR_RAISE. */
  public RecordBatchFileReaderFuture(@ByVal RecordBatchFileReaderResult res) { super((Pointer)null); allocate(res); }
  private native void allocate(@ByVal RecordBatchFileReaderResult res);

  /** \brief Implicit constructor to create a future from a Status, enabling use
   *      of macros like ARROW_RETURN_NOT_OK. */
  public RecordBatchFileReaderFuture(@ByVal Status s) { super((Pointer)null); allocate(s); }
