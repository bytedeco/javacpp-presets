...
@Name("arrow::Future<std::shared_ptr<arrow::ipc::Message> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class MessageFuture extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public MessageFuture(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public MessageFuture(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public MessageFuture position(long position) {
        return (MessageFuture)super.position(position);
    }
    @Override public MessageFuture getPointer(long i) {
        return new MessageFuture((Pointer)this).offsetAddress(i);
    }
  ...
  public MessageFuture() { super((Pointer)null); allocate(); }
  ...
  ///
  public native @Const @ByRef MessageSharedResult result();
  ...
  public native @ByRef(true) MessageSharedResult MoveResult();
  ...
  public native void MarkFinished(@ByVal MessageSharedResult res);
  ...
  public static native @ByVal MessageFuture Make();

  /** \brief Producer API: instantiate a finished Future */
  public static native @ByVal MessageFuture MakeFinished(@ByVal MessageSharedResult res);
  ...
  public MessageFuture(@SharedPtr @Cast({"", "std::shared_ptr<arrow::ipc::Message>"}) Message val) { super((Pointer)null); allocate(val); }
  private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::ipc::Message>"}) Message val);

  /** \brief Implicit constructor to create a future from a Result, enabling use
   *      of macros like ARROW_ASSIGN_OR_RAISE. */
  public MessageFuture(@ByVal MessageSharedResult res) { super((Pointer)null); allocate(res); }
  private native void allocate(@ByVal MessageSharedResult res);

  /** \brief Implicit constructor to create a future from a Status, enabling use
   *      of macros like ARROW_RETURN_NOT_OK. */
  public MessageFuture(@ByVal Status s) { super((Pointer)null); allocate(s); }
