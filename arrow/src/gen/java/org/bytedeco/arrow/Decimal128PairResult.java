...
@Name("arrow::Result<std::pair<arrow::Decimal128,arrow::Decimal128> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class Decimal128PairResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public Decimal128PairResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public Decimal128PairResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public Decimal128PairResult position(long position) {
        return (Decimal128PairResult)super.position(position);
    }
    @Override public Decimal128PairResult getPointer(long i) {
        return new Decimal128PairResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public Decimal128PairResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public Decimal128PairResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public Decimal128PairResult(@ByRef(true) Decimal128Pair value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@ByRef(true) Decimal128Pair value);
  ...
  ///
  ///
  public Decimal128PairResult(@Const @ByRef Decimal128PairResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef Decimal128PairResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) Decimal128PairResult put(@Const @ByRef Decimal128PairResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef Decimal128PairResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef Decimal128Pair ValueOrDie();
  public native @ByRef @Name("operator *") Decimal128Pair multiply();
  
  ///
  ///
  public native @Name("operator ->") Decimal128Pair access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef Decimal128Pair ValueUnsafe();
// #else
// #endif

  

  public native @ByVal Decimal128Pair MoveValueUnsafe();
}
