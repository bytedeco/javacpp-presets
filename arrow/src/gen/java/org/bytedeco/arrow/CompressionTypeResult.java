...
@Name("arrow::Result<arrow::Compression::type>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class CompressionTypeResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public CompressionTypeResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public CompressionTypeResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public CompressionTypeResult getPointer(long i) {
        return new CompressionTypeResult((Pointer)this).offsetAddress(i);
    }
  ...
  @NoException(true) private native void allocate(@Cast("arrow::Compression::type&&") Compression.type value);
  public CompressionTypeResult(@Cast("arrow::Compression::type") int value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@Cast("arrow::Compression::type") int value);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef CompressionTypeResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef @Cast("arrow::Compression::type*") IntPointer ValueOrDie();
  public native @ByRef @Name("operator *") @Cast("arrow::Compression::type*") IntPointer multiply();
  
  ///
  ///
  public native @Name("operator ->") @Cast("arrow::Compression::type*") IntPointer access();
