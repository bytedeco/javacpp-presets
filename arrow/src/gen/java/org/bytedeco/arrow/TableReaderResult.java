...
public class TableReaderResult extends Pointer {
  ...
  @NoException private native void allocate(@SharedPtr TableReader value);
  ...
  private native void allocate(@Const @ByRef TableReaderResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") TableReaderResult put(@Const @ByRef TableReaderResult other);
