...
@Name("arrow::Future<std::shared_ptr<arrow::io::InputStream> >") @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class InputStreamFuture extends Pointer {
  ...
  public native @ByVal InputStreamResult MoveResult();
