...
public class RecordBatchVectorResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef RecordBatchVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") RecordBatchVectorResult put(@Const @ByRef RecordBatchVectorResult other);
  ...
  public native @ByRef RecordBatchVector ValueUnsafe();
