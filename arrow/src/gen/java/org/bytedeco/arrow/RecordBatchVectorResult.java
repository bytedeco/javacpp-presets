...
@Name("arrow::Result<std::vector<std::shared_ptr<arrow::RecordBatch> > >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class RecordBatchVectorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public RecordBatchVectorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public RecordBatchVectorResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public RecordBatchVectorResult getPointer(long i) {
        return new RecordBatchVectorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public RecordBatchVectorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public RecordBatchVectorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) RecordBatchVector value);
  ...
  ///
  ///
  public RecordBatchVectorResult(@Const @ByRef RecordBatchVectorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef RecordBatchVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) RecordBatchVectorResult put(@Const @ByRef RecordBatchVectorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef RecordBatchVectorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef RecordBatchVector ValueOrDie();
  public native @ByRef @Name("operator *") RecordBatchVector multiply();
  
  ///
  ///
  public native @Name("operator ->") RecordBatchVector access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef RecordBatchVector ValueUnsafe();
// #else
// #endif

  

  public native @ByVal RecordBatchVector MoveValueUnsafe();
}
