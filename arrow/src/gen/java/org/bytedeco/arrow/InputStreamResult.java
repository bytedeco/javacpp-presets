...
public class InputStreamResult extends Pointer {
  ...
  ///
  ///
  public InputStreamResult(@SharedPtr InputStream value) { super((Pointer)null); allocate(value); }
  @NoException private native void allocate(@SharedPtr InputStream value);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr InputStream ValueOrDie();
  
  ///
  ///
  public native @SharedPtr @Name("operator *") InputStream multiply();
  ...
  public native @SharedPtr InputStream ValueUnsafe();

  

  public native @SharedPtr InputStream MoveValueUnsafe();
}
