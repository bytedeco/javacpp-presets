...
@Name("arrow::Result<std::shared_ptr<arrow::io::InputStream> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class InputStreamResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public InputStreamResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public InputStreamResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public InputStreamResult position(long position) {
        return (InputStreamResult)super.position(position);
    }
    @Override public InputStreamResult getPointer(long i) {
        return new InputStreamResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public InputStreamResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public InputStreamResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public InputStreamResult(@SharedPtr @Cast({"", "std::shared_ptr<arrow::io::InputStream>"}) InputStream value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::io::InputStream>"}) InputStream value);
  ...
  ///
  ///
  public InputStreamResult(@Const @ByRef InputStreamResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef InputStreamResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) InputStreamResult put(@Const @ByRef InputStreamResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef InputStreamResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef InputStream ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") InputStream multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") InputStream access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::io::InputStream>"}) InputStream ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::io::InputStream>"}) InputStream MoveValueUnsafe();
}
