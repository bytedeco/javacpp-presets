...
public class InputStreamResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef InputStreamResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") InputStreamResult put(@Const @ByRef InputStreamResult other);
  ...
  public native @SharedPtr @ByRef InputStream ValueUnsafe();
