...
@Name("arrow::Result<std::vector<std::shared_ptr<arrow::ChunkedArray> > >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class ChunkedArrayVectorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ChunkedArrayVectorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ChunkedArrayVectorResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public ChunkedArrayVectorResult getPointer(long i) {
        return new ChunkedArrayVectorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ChunkedArrayVectorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ChunkedArrayVectorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) ChunkedArrayVector value);
  ...
  ///
  ///
  public ChunkedArrayVectorResult(@Const @ByRef ChunkedArrayVectorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef ChunkedArrayVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) ChunkedArrayVectorResult put(@Const @ByRef ChunkedArrayVectorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ChunkedArrayVectorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef ChunkedArrayVector ValueOrDie();
  public native @ByRef @Name("operator *") ChunkedArrayVector multiply();
  
  ///
  ///
  public native @Name("operator ->") ChunkedArrayVector access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef ChunkedArrayVector ValueUnsafe();
// #else
// #endif

  

  public native @ByVal ChunkedArrayVector MoveValueUnsafe();
}
