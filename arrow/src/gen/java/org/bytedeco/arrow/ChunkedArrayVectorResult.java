...
public class ChunkedArrayVectorResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef ChunkedArrayVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") ChunkedArrayVectorResult put(@Const @ByRef ChunkedArrayVectorResult other);
  ...
  public native @ByRef ChunkedArrayVector ValueUnsafe();
