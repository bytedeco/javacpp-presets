...
@Name("arrow::Result<arrow::compute::ExecNode*>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class ExecNodeResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ExecNodeResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ExecNodeResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ExecNodeResult position(long position) {
        return (ExecNodeResult)super.position(position);
    }
    @Override public ExecNodeResult getPointer(long i) {
        return new ExecNodeResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ExecNodeResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ExecNodeResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public ExecNodeResult(ExecNode value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(ExecNode value);
  ...
  ///
  ///
  public ExecNodeResult(@Const @ByRef ExecNodeResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef ExecNodeResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) ExecNodeResult put(@Const @ByRef ExecNodeResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ExecNodeResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByPtrRef ExecNode ValueOrDie();
  public native @ByPtrRef @Name("operator *") ExecNode multiply();
  
  ///
  ///
  public native @Cast("arrow::compute::ExecNode**") @Name("operator ->") PointerPointer access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @ByPtrRef ExecNode ValueUnsafe();
// #else
// #endif

  

  public native ExecNode MoveValueUnsafe();
}
