...
public class DataTypeResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef DataTypeResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") DataTypeResult put(@Const @ByRef DataTypeResult other);
  ...
  public native @SharedPtr @ByRef @Cast({"", "std::shared_ptr<arrow::DataType>*"}) DataType ValueUnsafe();
