...
public class DataTypeResult extends Pointer {
    ...
    public DataTypeResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public DataTypeResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public DataTypeResult getPointer(long i) {
        return new DataTypeResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public DataTypeResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public DataTypeResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType value);
  ...
  ///
  ///
  public DataTypeResult(@Const @ByRef DataTypeResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef DataTypeResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) DataTypeResult put(@Const @ByRef DataTypeResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef @Cast({"", "std::shared_ptr<arrow::DataType>*"}) DataType ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") @Cast({"", "std::shared_ptr<arrow::DataType>*"}) DataType multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") @Cast({"", "std::shared_ptr<arrow::DataType>*"}) DataType access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType MoveValueUnsafe();
}
