...
@Name("arrow::Result<std::vector<arrow::fs::FileStats> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class FileStatsVectorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FileStatsVectorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FileStatsVectorResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public FileStatsVectorResult position(long position) {
        return (FileStatsVectorResult)super.position(position);
    }
   ...
   *  Result. */
  public FileStatsVectorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FileStatsVectorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public FileStatsVectorResult(@ByVal FileStatsVector value) { super((Pointer)null); allocate(value); }
  private native void allocate(@ByVal FileStatsVector value);
  ...
  ///
  ///
  public FileStatsVectorResult(@Const @ByRef FileStatsVectorResult other) { super((Pointer)null); allocate(other); }
  private native void allocate(@Const @ByRef FileStatsVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") FileStatsVectorResult put(@Const @ByRef FileStatsVectorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FileStatsVectorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef FileStatsVector ValueOrDie();
  
  ///
  ///
  public native @ByRef @Name("operator *") FileStatsVector multiply();
