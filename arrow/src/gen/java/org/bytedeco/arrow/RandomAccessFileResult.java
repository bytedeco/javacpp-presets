...
public class RandomAccessFileResult extends Pointer {
  ...
  ///
  ///
  public RandomAccessFileResult(@SharedPtr RandomAccessFile value) { super((Pointer)null); allocate(value); }
  private native void allocate(@SharedPtr RandomAccessFile value);
  ...
  private native void allocate(@Const @ByRef RandomAccessFileResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") RandomAccessFileResult put(@Const @ByRef RandomAccessFileResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr RandomAccessFile ValueOrDie();
  
  ///
  ///
  public native @SharedPtr @Name("operator *") RandomAccessFile multiply();
