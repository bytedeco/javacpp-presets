...
public class RandomAccessFileResult extends Pointer {
  ...
  @NoException private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::io::RandomAccessFile>"}) RandomAccessFile value);
  ...
  public native @SharedPtr @ByRef RandomAccessFile ValueUnsafe();
