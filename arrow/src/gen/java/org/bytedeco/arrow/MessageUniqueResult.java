...
@Name("arrow::Result<std::unique_ptr<arrow::ipc::Message> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class MessageUniqueResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public MessageUniqueResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public MessageUniqueResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public MessageUniqueResult getPointer(long i) {
        return new MessageUniqueResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public MessageUniqueResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public MessageUniqueResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public MessageUniqueResult(@UniquePtr Message value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@UniquePtr Message value);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef MessageUniqueResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @UniquePtr Message ValueOrDie();
  public native @UniquePtr @Name("operator *") Message multiply();
  
  ///
  ///
  public native @UniquePtr @Name("operator ->") Message access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @UniquePtr Message ValueUnsafe();
// #else
// #endif

  

  public native @UniquePtr Message MoveValueUnsafe();
}
