...
public class HadoopFileSystem extends IOFileSystem {
  ...
  public native @Deprecated @ByVal Status OpenWriteable(@StdString String path, @Cast("bool") boolean append, int buffer_size,
                         short replication, @Cast("int64_t") long default_block_size,
                         @SharedPtr HdfsOutputStream file);
  public native @Deprecated @ByVal Status OpenWriteable(@StdString BytePointer path, @Cast("bool") boolean append, int buffer_size,
                         short replication, @Cast("int64_t") long default_block_size,
                         @SharedPtr HdfsOutputStream file);

  public native @Deprecated @ByVal Status OpenWriteable(@StdString String path, @Cast("bool") boolean append,
                         @SharedPtr HdfsOutputStream file);
  public native @Deprecated @ByVal Status OpenWriteable(@StdString BytePointer path, @Cast("bool") boolean append,
                         @SharedPtr HdfsOutputStream file);
}
