...
@Name("arrow::Result<std::shared_ptr<arrow::SparseTensor> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class SparseTensorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public SparseTensorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public SparseTensorResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public SparseTensorResult position(long position) {
        return (SparseTensorResult)super.position(position);
    }
   ...
   *  Result. */
  public SparseTensorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public SparseTensorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public SparseTensorResult(@SharedPtr SparseTensor value) { super((Pointer)null); allocate(value); }
  private native void allocate(@SharedPtr SparseTensor value);
  ...
  ///
  ///
  public SparseTensorResult(@Const @ByRef SparseTensorResult other) { super((Pointer)null); allocate(other); }
  private native void allocate(@Const @ByRef SparseTensorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef SparseTensorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr SparseTensor ValueOrDie();
  
  ///
  ///
  public native @SharedPtr @Name("operator *") SparseTensor multiply();
