...
public class SchemaVectorResult extends Pointer {
  ...
  private native void allocate(@ByVal SchemaVector value);
  ...
  private native void allocate(@Const @ByRef SchemaVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") SchemaVectorResult put(@Const @ByRef SchemaVectorResult other);
