...
public class BinaryArrayResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef BinaryArrayResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") BinaryArrayResult put(@Const @ByRef BinaryArrayResult other);
