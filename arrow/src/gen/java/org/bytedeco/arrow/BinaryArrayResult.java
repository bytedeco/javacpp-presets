...
@Name("arrow::Result<std::shared_ptr<arrow::BinaryArray> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class BinaryArrayResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public BinaryArrayResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public BinaryArrayResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public BinaryArrayResult getPointer(long i) {
        return new BinaryArrayResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public BinaryArrayResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public BinaryArrayResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@SharedPtr @ByRef(true) BinaryArray value);
  ...
  ///
  ///
  public BinaryArrayResult(@Const @ByRef BinaryArrayResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef BinaryArrayResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) BinaryArrayResult put(@Const @ByRef BinaryArrayResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef BinaryArrayResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef BinaryArray ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") BinaryArray multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") BinaryArray access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @SharedPtr @ByRef BinaryArray ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr @ByVal BinaryArray MoveValueUnsafe();
}
