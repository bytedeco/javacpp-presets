...
public class Decimal128Result extends Pointer {
  ...
  private native void allocate(@Const @ByRef Decimal128Result other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") Decimal128Result put(@Const @ByRef Decimal128Result other);
