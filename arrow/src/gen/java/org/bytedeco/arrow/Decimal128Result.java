...
@Name("arrow::Result<arrow::Decimal128>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class Decimal128Result extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public Decimal128Result(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public Decimal128Result(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public Decimal128Result getPointer(long i) {
        return new Decimal128Result((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public Decimal128Result() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public Decimal128Result(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) Decimal128 value);
  ...
  ///
  ///
  public Decimal128Result(@Const @ByRef Decimal128Result other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef Decimal128Result other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) Decimal128Result put(@Const @ByRef Decimal128Result other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef Decimal128Result other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef Decimal128 ValueOrDie();
  public native @ByRef @Name("operator *") Decimal128 multiply();
  
  ///
  ///
  public native @Name("operator ->") Decimal128 access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef Decimal128 ValueUnsafe();
// #else
// #endif

  

  public native @ByVal Decimal128 MoveValueUnsafe();
}
