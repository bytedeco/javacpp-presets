...
@Namespace("parquet") public static native @StdString String FormatStatValue(org.bytedeco.parquet.Type.type parquet_type,
                                           @StdString String val);
@Namespace("parquet") public static native @StdString BytePointer FormatStatValue(@Cast("parquet::Type::type") int parquet_type,
                                           @StdString BytePointer val);
...
// Targeting ../../parquet/CompressedDataPage.java
...
@Namespace("parquet") public static native @SharedPtr FileMetaData ReadMetaData(@SharedPtr RandomAccessFile source);
