...
@Name("arrow::Result<arrow::util::Decompressor::DecompressResult>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class DecompressResultResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public DecompressResultResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public DecompressResultResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public DecompressResultResult getPointer(long i) {
        return new DecompressResultResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public DecompressResultResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public DecompressResultResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) Decompressor.DecompressResult value);
  ...
  ///
  ///
  public DecompressResultResult(@Const @ByRef DecompressResultResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef DecompressResultResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) DecompressResultResult put(@Const @ByRef DecompressResultResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef Decompressor.DecompressResult ValueOrDie();
  public native @ByRef @Name("operator *") Decompressor.DecompressResult multiply();
  
  ///
  ///
  public native @Name("operator ->") Decompressor.DecompressResult access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef Decompressor.DecompressResult ValueUnsafe();
// #else
// #endif

  

  public native @ByVal Decompressor.DecompressResult MoveValueUnsafe();
}
