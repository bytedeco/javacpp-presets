...
@Name("arrow::Result<arrow::util::Compressor::EndResult>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class EndResultResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public EndResultResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public EndResultResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public EndResultResult getPointer(long i) {
        return new EndResultResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public EndResultResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public EndResultResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) Compressor.EndResult value);
  ...
  ///
  ///
  public EndResultResult(@Const @ByRef EndResultResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef EndResultResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) EndResultResult put(@Const @ByRef EndResultResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef Compressor.EndResult ValueOrDie();
  public native @ByRef @Name("operator *") Compressor.EndResult multiply();
  
  ///
  ///
  public native @Name("operator ->") Compressor.EndResult access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef Compressor.EndResult ValueUnsafe();
// #else
// #endif

  

  public native @ByVal Compressor.EndResult MoveValueUnsafe();
}
