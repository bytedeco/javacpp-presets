...
@Name("arrow::TemporalScalar<arrow::Time64Type>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class BaseBaseTime64Scalar extends Scalar {
    static { Loader.load(); }

  
  
    public BaseBaseTime64Scalar(@SharedPtr @Cast({"", "std::shared_ptr<arrow::DataType>"}) DataType type) { super((Pointer)null); allocate(type); }
  ...
  public native @Cast("arrow::TemporalScalar<arrow::Time64Type>::ValueType") long value(); public native BaseBaseTime64Scalar value(long setter);
}
