...
@Name("arrow::Result<arrow::Iterator<std::shared_ptr<arrow::Buffer> > >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class BufferIteratorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public BufferIteratorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public BufferIteratorResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public BufferIteratorResult getPointer(long i) {
        return new BufferIteratorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public BufferIteratorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public BufferIteratorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) BufferIterator value);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef BufferIteratorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef BufferIterator ValueOrDie();
  public native @ByRef @Name("operator *") BufferIterator multiply();
  
  ///
  ///
  public native @Name("operator ->") BufferIterator access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef BufferIterator ValueUnsafe();
// #else
// #endif

  

  public native @ByVal BufferIterator MoveValueUnsafe();
}
