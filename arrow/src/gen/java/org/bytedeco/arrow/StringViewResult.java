...
@Name("arrow::Result<arrow::util::string_view>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class StringViewResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public StringViewResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public StringViewResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public StringViewResult position(long position) {
        return (StringViewResult)super.position(position);
    }
    @Override public StringViewResult getPointer(long i) {
        return new StringViewResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public StringViewResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public StringViewResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public StringViewResult(@Const @ByRef StringViewResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef StringViewResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) StringViewResult put(@Const @ByRef StringViewResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef StringViewResult other);
