...
public class StringViewResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef StringViewResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") StringViewResult put(@Const @ByRef StringViewResult other);
