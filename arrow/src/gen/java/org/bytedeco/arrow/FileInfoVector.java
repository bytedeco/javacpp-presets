...
@Name("std::vector<arrow::fs::FileInfo>") @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class FileInfoVector extends Pointer {
    static { Loader.load(); }
    ...
    public native @ByVal Iterator insert(@ByVal Iterator pos, @ByRef FileInfo value);
