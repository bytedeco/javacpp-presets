...
public class StopSourceResult extends Pointer {
  ...
  @NoException(true) private native void allocate(@Const @ByRef StopSourceResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) StopSourceResult put(@Const @ByRef StopSourceResult other);
