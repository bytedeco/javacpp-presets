...
@Name("arrow::Result<arrow::StopSource*>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class StopSourceResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public StopSourceResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public StopSourceResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public StopSourceResult position(long position) {
        return (StopSourceResult)super.position(position);
    }
    @Override public StopSourceResult getPointer(long i) {
        return new StopSourceResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public StopSourceResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public StopSourceResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public StopSourceResult(StopSource value) { super((Pointer)null); allocate(value); }
  @NoException private native void allocate(StopSource value);
  ...
  ///
  ///
  public StopSourceResult(@Const @ByRef StopSourceResult other) { super((Pointer)null); allocate(other); }
  private native void allocate(@Const @ByRef StopSourceResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") StopSourceResult put(@Const @ByRef StopSourceResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef StopSourceResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByPtrRef StopSource ValueOrDie();
  public native @ByPtrRef @Name("operator *") StopSource multiply();
  
  ///
  ///
  public native @Cast("arrow::StopSource**") @Name("operator ->") PointerPointer access();
  ...
  public native @ByPtrRef StopSource ValueUnsafe();

  

  public native StopSource MoveValueUnsafe();
}
