...
@Name("arrow::Result<std::unique_ptr<arrow::ipc::RecordBatchWriter> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class RecordBatchWriterUniqueResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public RecordBatchWriterUniqueResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public RecordBatchWriterUniqueResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public RecordBatchWriterUniqueResult getPointer(long i) {
        return new RecordBatchWriterUniqueResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public RecordBatchWriterUniqueResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public RecordBatchWriterUniqueResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public RecordBatchWriterUniqueResult(@UniquePtr RecordBatchWriter value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@UniquePtr RecordBatchWriter value);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef RecordBatchWriterUniqueResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @UniquePtr RecordBatchWriter ValueOrDie();
  public native @UniquePtr @Name("operator *") RecordBatchWriter multiply();
  
  ///
  ///
  public native @UniquePtr @Name("operator ->") RecordBatchWriter access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @UniquePtr RecordBatchWriter ValueUnsafe();
// #else
// #endif

  

  public native @UniquePtr RecordBatchWriter MoveValueUnsafe();
}
