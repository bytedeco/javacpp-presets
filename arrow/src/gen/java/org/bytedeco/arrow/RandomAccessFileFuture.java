...
@Name("arrow::Future<std::shared_ptr<arrow::io::RandomAccessFile> >") @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class RandomAccessFileFuture extends Pointer {
  ...
  public native @ByVal RandomAccessFileResult MoveResult();
