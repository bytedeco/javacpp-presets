...
@Name("arrow::Result<std::shared_ptr<const arrow::KeyValueMetadata> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class KeyValueMetadataResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public KeyValueMetadataResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public KeyValueMetadataResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public KeyValueMetadataResult position(long position) {
        return (KeyValueMetadataResult)super.position(position);
    }
    @Override public KeyValueMetadataResult getPointer(long i) {
        return new KeyValueMetadataResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public KeyValueMetadataResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public KeyValueMetadataResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public KeyValueMetadataResult(@SharedPtr @Cast({"const arrow::KeyValueMetadata*", "std::shared_ptr<const arrow::KeyValueMetadata>"}) KeyValueMetadata value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr @Cast({"const arrow::KeyValueMetadata*", "std::shared_ptr<const arrow::KeyValueMetadata>"}) KeyValueMetadata value);
  ...
  ///
  ///
  public KeyValueMetadataResult(@Const @ByRef KeyValueMetadataResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef KeyValueMetadataResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) KeyValueMetadataResult put(@Const @ByRef KeyValueMetadataResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef KeyValueMetadataResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef @Cast("const arrow::KeyValueMetadata*") KeyValueMetadata ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") @Cast("const arrow::KeyValueMetadata*") KeyValueMetadata multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") @Cast("const arrow::KeyValueMetadata*") KeyValueMetadata access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @SharedPtr @Cast({"const arrow::KeyValueMetadata*", "std::shared_ptr<const arrow::KeyValueMetadata>"}) KeyValueMetadata ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr @Cast({"const arrow::KeyValueMetadata*", "std::shared_ptr<const arrow::KeyValueMetadata>"}) KeyValueMetadata MoveValueUnsafe();
}
