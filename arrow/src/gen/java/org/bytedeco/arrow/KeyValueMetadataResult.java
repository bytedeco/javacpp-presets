...
public class KeyValueMetadataResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef KeyValueMetadataResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") KeyValueMetadataResult put(@Const @ByRef KeyValueMetadataResult other);
  ...
  public native @SharedPtr @ByRef @Cast("const arrow::KeyValueMetadata*") KeyValueMetadata ValueUnsafe();
