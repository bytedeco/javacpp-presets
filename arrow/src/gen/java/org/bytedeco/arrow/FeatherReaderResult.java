...
public class FeatherReaderResult extends Pointer {
  ...
  @NoException private native void allocate(@SharedPtr Reader value);
  ...
  private native void allocate(@Const @ByRef FeatherReaderResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") FeatherReaderResult put(@Const @ByRef FeatherReaderResult other);
