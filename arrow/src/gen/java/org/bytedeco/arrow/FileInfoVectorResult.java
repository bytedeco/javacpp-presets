...
public class FileInfoVectorResult extends Pointer {
  ...
  ///
  ///
  public FileInfoVectorResult(@StdVector FileInfo value) { super((Pointer)null); allocate(value); }
  @NoException private native void allocate(@StdVector FileInfo value);
  ...
  private native void allocate(@Const @ByRef FileInfoVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") FileInfoVectorResult put(@Const @ByRef FileInfoVectorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @StdVector FileInfo ValueOrDie();
  
  ///
  ///
  public native @StdVector @Name("operator *") FileInfo multiply();
  ...
  public native @StdVector FileInfo ValueUnsafe();

  

  public native @StdVector FileInfo MoveValueUnsafe();
}
