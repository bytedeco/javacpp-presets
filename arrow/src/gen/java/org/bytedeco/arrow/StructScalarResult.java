...
public class StructScalarResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef StructScalarResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") StructScalarResult put(@Const @ByRef StructScalarResult other);
