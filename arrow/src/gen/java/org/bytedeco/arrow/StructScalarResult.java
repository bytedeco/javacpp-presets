...
@Name("arrow::Result<std::shared_ptr<arrow::StructScalar> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class StructScalarResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public StructScalarResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public StructScalarResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public StructScalarResult position(long position) {
        return (StructScalarResult)super.position(position);
    }
    @Override public StructScalarResult getPointer(long i) {
        return new StructScalarResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public StructScalarResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public StructScalarResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public StructScalarResult(@SharedPtr StructScalar value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr StructScalar value);
  ...
  ///
  ///
  public StructScalarResult(@Const @ByRef StructScalarResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef StructScalarResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) StructScalarResult put(@Const @ByRef StructScalarResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef StructScalarResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr StructScalar ValueOrDie();
  public native @SharedPtr @Name("operator *") StructScalar multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") StructScalar access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @SharedPtr StructScalar ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr StructScalar MoveValueUnsafe();
}
