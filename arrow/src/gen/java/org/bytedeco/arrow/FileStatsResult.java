...
@Name("arrow::Result<arrow::fs::FileStats>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class FileStatsResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FileStatsResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FileStatsResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public FileStatsResult position(long position) {
        return (FileStatsResult)super.position(position);
    }
   ...
   *  Result. */
  public FileStatsResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FileStatsResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public FileStatsResult(@ByVal FileStats value) { super((Pointer)null); allocate(value); }
  private native void allocate(@ByVal FileStats value);
  ...
  ///
  ///
  public FileStatsResult(@Const @ByRef FileStatsResult other) { super((Pointer)null); allocate(other); }
  private native void allocate(@Const @ByRef FileStatsResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") FileStatsResult put(@Const @ByRef FileStatsResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FileStatsResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef FileStats ValueOrDie();
  
  ///
  ///
  public native @ByRef @Name("operator *") FileStats multiply();
