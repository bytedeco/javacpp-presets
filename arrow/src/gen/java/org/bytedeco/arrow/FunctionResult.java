...
public class FunctionResult extends Pointer {
  ...
  @NoException private native void allocate(@SharedPtr Function value);
  ...
  private native void allocate(@Const @ByRef FunctionResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") FunctionResult put(@Const @ByRef FunctionResult other);
