...
public class Decimal128 extends BasicDecimal128 {
  ...
  public native @ByVal Status Divide(@Const @ByRef Decimal128 divisor, Decimal128 result,
  ...
  public static native @ByVal Status FromString(@StdString String s, Decimal128 out,
                             IntPointer precision/*=nullptr*/, IntPointer scale/*=nullptr*/);
  public static native @ByVal Status FromString(@StdString String s, Decimal128 out);
  public static native @ByVal Status FromString(@StdString BytePointer s, Decimal128 out,
                             IntBuffer precision/*=nullptr*/, IntBuffer scale/*=nullptr*/);
  public static native @ByVal Status FromString(@StdString BytePointer s, Decimal128 out);
  public static native @ByVal Status FromString(@StdString String s, Decimal128 out,
  ...
  public static native @ByVal Status FromBigEndian(@Cast("const uint8_t*") BytePointer data, int length, Decimal128 out);
  public static native @ByVal Status FromBigEndian(@Cast("const uint8_t*") ByteBuffer data, int length, Decimal128 out);
  public static native @ByVal Status FromBigEndian(@Cast("const uint8_t*") byte[] data, int length, Decimal128 out);

  /** \brief Convert Decimal128 from one scale to another */
  public native @ByVal Status Rescale(int original_scale, int new_scale, Decimal128 out);
