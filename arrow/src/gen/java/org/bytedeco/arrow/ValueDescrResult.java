...
public class ValueDescrResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef ValueDescrResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") ValueDescrResult put(@Const @ByRef ValueDescrResult other);
  ...
  public native @ByRef ValueDescr ValueUnsafe();
