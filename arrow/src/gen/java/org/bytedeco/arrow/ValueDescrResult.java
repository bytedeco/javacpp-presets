...
@Name("arrow::Result<arrow::ValueDescr>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class ValueDescrResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ValueDescrResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ValueDescrResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ValueDescrResult position(long position) {
        return (ValueDescrResult)super.position(position);
    }
    @Override public ValueDescrResult getPointer(long i) {
        return new ValueDescrResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ValueDescrResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ValueDescrResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) ValueDescr value);
  ...
  ///
  ///
  public ValueDescrResult(@Const @ByRef ValueDescrResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef ValueDescrResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) ValueDescrResult put(@Const @ByRef ValueDescrResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ValueDescrResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef ValueDescr ValueOrDie();
  public native @ByRef @Name("operator *") ValueDescr multiply();
  
  ///
  ///
  public native @Name("operator ->") ValueDescr access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef ValueDescr ValueUnsafe();
// #else
// #endif

  

  public native @ByVal ValueDescr MoveValueUnsafe();
}
