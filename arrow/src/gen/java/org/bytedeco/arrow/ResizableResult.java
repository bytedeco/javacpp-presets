...
public class ResizableResult extends Pointer {
    ...
    @Override public ResizableResult getPointer(long i) {
        return new ResizableResult((Pointer)this).position(position + i);
    }
  ...
  private native void allocate(@Const @ByRef ResizableResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") ResizableResult put(@Const @ByRef ResizableResult other);
