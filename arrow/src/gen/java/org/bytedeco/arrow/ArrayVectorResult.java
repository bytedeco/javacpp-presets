...
@Name("arrow::Result<arrow::ArrayVector>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class ArrayVectorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ArrayVectorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ArrayVectorResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public ArrayVectorResult getPointer(long i) {
        return new ArrayVectorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ArrayVectorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ArrayVectorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) ArrayVector value);
  ...
  ///
  ///
  public ArrayVectorResult(@Const @ByRef ArrayVectorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef ArrayVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) ArrayVectorResult put(@Const @ByRef ArrayVectorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ArrayVectorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef ArrayVector ValueOrDie();
  public native @ByRef @Name("operator *") ArrayVector multiply();
  
  ///
  ///
  public native @Name("operator ->") ArrayVector access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef ArrayVector ValueUnsafe();
// #else
// #endif

  

  public native @ByVal ArrayVector MoveValueUnsafe();
}
