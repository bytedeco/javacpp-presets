...
public class ArrayVectorResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef ArrayVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") ArrayVectorResult put(@Const @ByRef ArrayVectorResult other);
