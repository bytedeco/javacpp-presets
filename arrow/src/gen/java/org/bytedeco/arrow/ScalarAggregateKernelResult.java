...
public class ScalarAggregateKernelResult extends Pointer {
  ...
  private native void allocate(@Cast("const arrow::Result<arrow::compute::ScalarAggregateKernel*>*") @ByRef ScalarAggregateKernelResult other);
  ...
  ///
  ///
  public native @Cast("arrow::Result<arrow::compute::ScalarAggregateKernel*>*") @ByRef @Name("operator =") ScalarAggregateKernelResult put(@Cast("const arrow::Result<arrow::compute::ScalarAggregateKernel*>*") @ByRef ScalarAggregateKernelResult other);
