...
@Name("arrow::Result<arrow::compute::ScalarAggregateKernel*>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class ScalarAggregateKernelResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ScalarAggregateKernelResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ScalarAggregateKernelResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ScalarAggregateKernelResult position(long position) {
        return (ScalarAggregateKernelResult)super.position(position);
    }
    @Override public ScalarAggregateKernelResult getPointer(long i) {
        return new ScalarAggregateKernelResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ScalarAggregateKernelResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ScalarAggregateKernelResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public ScalarAggregateKernelResult(ScalarAggregateKernel value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(ScalarAggregateKernel value);
  ...
  ///
  ///
  public ScalarAggregateKernelResult(@Cast("const arrow::Result<arrow::compute::ScalarAggregateKernel*>*") @ByRef ScalarAggregateKernelResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Cast("const arrow::Result<arrow::compute::ScalarAggregateKernel*>*") @ByRef ScalarAggregateKernelResult other);
  ...
  ///
  ///
  public native @Cast("arrow::Result<arrow::compute::ScalarAggregateKernel*>*") @ByRef @Name("operator =") @NoException(true) ScalarAggregateKernelResult put(@Cast("const arrow::Result<arrow::compute::ScalarAggregateKernel*>*") @ByRef ScalarAggregateKernelResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Cast("const arrow::Result<arrow::compute::ScalarAggregateKernel*>*") @ByRef ScalarAggregateKernelResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByPtrRef ScalarAggregateKernel ValueOrDie();
  public native @ByPtrRef @Name("operator *") ScalarAggregateKernel multiply();
  
  ///
  ///
  public native @Cast("arrow::compute::ScalarAggregateKernel**") @Name("operator ->") PointerPointer access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @ByPtrRef ScalarAggregateKernel ValueUnsafe();
// #else
// #endif

  

  public native ScalarAggregateKernel MoveValueUnsafe();
}
