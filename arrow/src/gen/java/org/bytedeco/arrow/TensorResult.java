...
@Name("arrow::Result<std::shared_ptr<arrow::Tensor> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class TensorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TensorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public TensorResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public TensorResult getPointer(long i) {
        return new TensorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public TensorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public TensorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public TensorResult(@SharedPtr Tensor value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr Tensor value);
  ...
  ///
  ///
  public TensorResult(@Const @ByRef TensorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef TensorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) TensorResult put(@Const @ByRef TensorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef TensorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr Tensor ValueOrDie();
  public native @SharedPtr @Name("operator *") Tensor multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") Tensor access();
...
// #endif
  ...
  public native @SharedPtr Tensor MoveValueUnsafe();
}
