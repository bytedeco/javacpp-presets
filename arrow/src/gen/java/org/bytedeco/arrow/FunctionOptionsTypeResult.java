...
@Name("arrow::Result<arrow::compute::FunctionOptionsType*>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class FunctionOptionsTypeResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FunctionOptionsTypeResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FunctionOptionsTypeResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public FunctionOptionsTypeResult position(long position) {
        return (FunctionOptionsTypeResult)super.position(position);
    }
    @Override public FunctionOptionsTypeResult getPointer(long i) {
        return new FunctionOptionsTypeResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public FunctionOptionsTypeResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FunctionOptionsTypeResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public FunctionOptionsTypeResult(FunctionOptionsType value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(FunctionOptionsType value);
  ...
  ///
  ///
  public FunctionOptionsTypeResult(@Cast("const arrow::Result<arrow::compute::FunctionOptionsType*>*") @ByRef FunctionOptionsTypeResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Cast("const arrow::Result<arrow::compute::FunctionOptionsType*>*") @ByRef FunctionOptionsTypeResult other);
  ...
  ///
  ///
  public native @Cast("arrow::Result<arrow::compute::FunctionOptionsType*>*") @ByRef @Name("operator =") @NoException(true) FunctionOptionsTypeResult put(@Cast("const arrow::Result<arrow::compute::FunctionOptionsType*>*") @ByRef FunctionOptionsTypeResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Cast("const arrow::Result<arrow::compute::FunctionOptionsType*>*") @ByRef FunctionOptionsTypeResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByPtrRef FunctionOptionsType ValueOrDie();
  public native @ByPtrRef @Name("operator *") FunctionOptionsType multiply();
  
  ///
  ///
  public native @Cast("arrow::compute::FunctionOptionsType**") @Name("operator ->") PointerPointer access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @ByPtrRef FunctionOptionsType ValueUnsafe();
// #else
// #endif

  

  public native FunctionOptionsType MoveValueUnsafe();
}
