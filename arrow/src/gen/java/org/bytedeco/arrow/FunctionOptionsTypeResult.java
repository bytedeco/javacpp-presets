...
public class FunctionOptionsTypeResult extends Pointer {
  ...
  private native void allocate(@Cast("const arrow::Result<arrow::compute::FunctionOptionsType*>*") @ByRef FunctionOptionsTypeResult other);
  ...
  ///
  ///
  public native @Cast("arrow::Result<arrow::compute::FunctionOptionsType*>*") @ByRef @Name("operator =") FunctionOptionsTypeResult put(@Cast("const arrow::Result<arrow::compute::FunctionOptionsType*>*") @ByRef FunctionOptionsTypeResult other);
