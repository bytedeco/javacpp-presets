...
public class FileInfoResult extends Pointer {
    ...
    @Override public FileInfoResult getPointer(long i) {
        return new FileInfoResult((Pointer)this).position(position + i);
    }
  ...
  ///
  ///
  public FileInfoResult(@ByVal FileInfo value) { super((Pointer)null); allocate(value); }
  @NoException private native void allocate(@ByVal FileInfo value);
  ...
  private native void allocate(@Const @ByRef FileInfoResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") FileInfoResult put(@Const @ByRef FileInfoResult other);
  ...
  public native @ByRef FileInfo ValueUnsafe();
