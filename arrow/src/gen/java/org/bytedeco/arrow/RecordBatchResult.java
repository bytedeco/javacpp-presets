...
@Name("arrow::Result<std::shared_ptr<arrow::RecordBatch> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class RecordBatchResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public RecordBatchResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public RecordBatchResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public RecordBatchResult position(long position) {
        return (RecordBatchResult)super.position(position);
    }
    @Override public RecordBatchResult getPointer(long i) {
        return new RecordBatchResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public RecordBatchResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public RecordBatchResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public RecordBatchResult(@SharedPtr @Cast({"", "std::shared_ptr<arrow::RecordBatch>"}) RecordBatch value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::RecordBatch>"}) RecordBatch value);
  ...
  ///
  ///
  public RecordBatchResult(@Const @ByRef RecordBatchResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef RecordBatchResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) RecordBatchResult put(@Const @ByRef RecordBatchResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef RecordBatchResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef RecordBatch ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") RecordBatch multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") RecordBatch access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::RecordBatch>"}) RecordBatch ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::RecordBatch>"}) RecordBatch MoveValueUnsafe();
}
