...
public class RecordBatchResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef RecordBatchResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") RecordBatchResult put(@Const @ByRef RecordBatchResult other);
  ...
  public native @SharedPtr @ByRef RecordBatch ValueUnsafe();
