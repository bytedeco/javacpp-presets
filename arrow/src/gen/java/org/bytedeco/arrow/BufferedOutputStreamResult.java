...
public class BufferedOutputStreamResult extends Pointer {
  ...
  @NoException private native void allocate(@SharedPtr BufferedOutputStream value);
  ...
  private native void allocate(@Const @ByRef BufferedOutputStreamResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") BufferedOutputStreamResult put(@Const @ByRef BufferedOutputStreamResult other);
