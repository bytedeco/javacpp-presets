...
@Name("arrow::Result<std::shared_ptr<arrow::ArrayData> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class ArrayDataResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ArrayDataResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ArrayDataResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ArrayDataResult position(long position) {
   ...
   *  Result. */
  public ArrayDataResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ArrayDataResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public ArrayDataResult(@SharedPtr @Cast({"", "std::shared_ptr<arrow::ArrayData>"}) ArrayData value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr @Cast({"", "std::shared_ptr<arrow::ArrayData>"}) ArrayData value);
  ...
  ///
  ///
  public ArrayDataResult(@Const @ByRef ArrayDataResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef ArrayDataResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) ArrayDataResult put(@Const @ByRef ArrayDataResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ArrayDataResult other);
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::ArrayData>"}) ArrayData ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr @Cast({"", "std::shared_ptr<arrow::ArrayData>"}) ArrayData MoveValueUnsafe();
}
