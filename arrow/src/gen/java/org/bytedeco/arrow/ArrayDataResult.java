...
public class ArrayDataResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef ArrayDataResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") ArrayDataResult put(@Const @ByRef ArrayDataResult other);
  ...
  public native @SharedPtr @ByRef ArrayData ValueUnsafe();
