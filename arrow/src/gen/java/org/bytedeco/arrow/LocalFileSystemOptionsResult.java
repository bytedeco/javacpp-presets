...
@Name("arrow::Result<arrow::fs::LocalFileSystemOptions>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class LocalFileSystemOptionsResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public LocalFileSystemOptionsResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public LocalFileSystemOptionsResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public LocalFileSystemOptionsResult getPointer(long i) {
        return new LocalFileSystemOptionsResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public LocalFileSystemOptionsResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public LocalFileSystemOptionsResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) LocalFileSystemOptions value);
  ...
  ///
  ///
  public LocalFileSystemOptionsResult(@Const @ByRef LocalFileSystemOptionsResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef LocalFileSystemOptionsResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) LocalFileSystemOptionsResult put(@Const @ByRef LocalFileSystemOptionsResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef LocalFileSystemOptions ValueOrDie();
  public native @ByRef @Name("operator *") LocalFileSystemOptions multiply();
  
  ///
  ///
  public native @Name("operator ->") LocalFileSystemOptions access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef LocalFileSystemOptions ValueUnsafe();
// #else
// #endif

  

  public native @ByVal LocalFileSystemOptions MoveValueUnsafe();
}
