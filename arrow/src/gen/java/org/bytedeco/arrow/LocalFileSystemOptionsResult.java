...
public class LocalFileSystemOptionsResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef LocalFileSystemOptionsResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") LocalFileSystemOptionsResult put(@Const @ByRef LocalFileSystemOptionsResult other);
  ...
  public native @ByRef LocalFileSystemOptions ValueUnsafe();
