...
@Name("arrow::Future<arrow::util::optional<int64_t> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class LongOptionalFuture extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public LongOptionalFuture(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public LongOptionalFuture(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public LongOptionalFuture position(long position) {
        return (LongOptionalFuture)super.position(position);
    }
    @Override public LongOptionalFuture getPointer(long i) {
        return new LongOptionalFuture((Pointer)this).offsetAddress(i);
    }
  ...
  public LongOptionalFuture() { super((Pointer)null); allocate(); }
  ...
  ///
  public native @Const @ByRef LongOptionalResult result();
  ...
  public native @ByRef(true) LongOptionalResult MoveResult();
  ...
  public native void MarkFinished(@ByVal LongOptionalResult res);
  ...
  public static native @ByVal LongOptionalFuture Make();

  /** \brief Producer API: instantiate a finished Future */
  public static native @ByVal LongOptionalFuture MakeFinished(@ByVal LongOptionalResult res);
  ...
  public LongOptionalFuture(@ByVal @Cast("arrow::Future<arrow::util::optional<int64_t> >::ValueType*") LongOptional val) { super((Pointer)null); allocate(val); }
  private native void allocate(@ByVal @Cast("arrow::Future<arrow::util::optional<int64_t> >::ValueType*") LongOptional val);

  /** \brief Implicit constructor to create a future from a Result, enabling use
   *      of macros like ARROW_ASSIGN_OR_RAISE. */
  public LongOptionalFuture(@ByVal LongOptionalResult res) { super((Pointer)null); allocate(res); }
  private native void allocate(@ByVal LongOptionalResult res);

  /** \brief Implicit constructor to create a future from a Status, enabling use
   *      of macros like ARROW_RETURN_NOT_OK. */
  public LongOptionalFuture(@ByVal Status s) { super((Pointer)null); allocate(s); }
