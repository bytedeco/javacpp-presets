...
@Name("arrow::Result<std::shared_ptr<arrow::ipc::RecordBatchReader> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class RecordBatchReaderSharedResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public RecordBatchReaderSharedResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public RecordBatchReaderSharedResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public RecordBatchReaderSharedResult position(long position) {
        return (RecordBatchReaderSharedResult)super.position(position);
    }
    @Override public RecordBatchReaderSharedResult getPointer(long i) {
        return new RecordBatchReaderSharedResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public RecordBatchReaderSharedResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public RecordBatchReaderSharedResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public RecordBatchReaderSharedResult(@SharedPtr RecordBatchReader value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr RecordBatchReader value);
  ...
  ///
  ///
  public RecordBatchReaderSharedResult(@Const @ByRef RecordBatchReaderSharedResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef RecordBatchReaderSharedResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) RecordBatchReaderSharedResult put(@Const @ByRef RecordBatchReaderSharedResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef RecordBatchReaderSharedResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr RecordBatchReader ValueOrDie();
  public native @SharedPtr @Name("operator *") RecordBatchReader multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") RecordBatchReader access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @SharedPtr RecordBatchReader ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr RecordBatchReader MoveValueUnsafe();
}
