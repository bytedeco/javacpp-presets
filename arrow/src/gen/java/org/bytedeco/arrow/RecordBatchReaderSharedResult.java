...
public class RecordBatchReaderSharedResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef RecordBatchReaderSharedResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") RecordBatchReaderSharedResult put(@Const @ByRef RecordBatchReaderSharedResult other);
