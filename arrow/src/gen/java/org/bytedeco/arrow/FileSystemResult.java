...
public class FileSystemResult extends Pointer {
  ...
  @NoException private native void allocate(@SharedPtr FileSystem value);
  ...
  private native void allocate(@Const @ByRef FileSystemResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") FileSystemResult put(@Const @ByRef FileSystemResult other);
