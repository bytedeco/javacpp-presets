...
public class Arity extends Pointer {
  ...
  public Arity(int num_args, @Cast("bool") boolean is_varargs/*=false*/) { super((Pointer)null); allocate(num_args, is_varargs); }
  private native void allocate(int num_args, @Cast("bool") boolean is_varargs/*=false*/);
  public Arity(int num_args) { super((Pointer)null); allocate(num_args); }
  private native void allocate(int num_args);
