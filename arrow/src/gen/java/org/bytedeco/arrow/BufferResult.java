...
@Name("arrow::Result<std::shared_ptr<arrow::Buffer> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class BufferResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public BufferResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public BufferResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public BufferResult position(long position) {
        return (BufferResult)super.position(position);
    }
    @Override public BufferResult getPointer(long i) {
        return new BufferResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public BufferResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public BufferResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public BufferResult(@SharedPtr ArrowBuffer value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr ArrowBuffer value);
  ...
  ///
  ///
  public BufferResult(@Const @ByRef BufferResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef BufferResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) BufferResult put(@Const @ByRef BufferResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef BufferResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef @Cast({"", "std::shared_ptr<arrow::Buffer>*"}) ArrowBuffer ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") @Cast({"", "std::shared_ptr<arrow::Buffer>*"}) ArrowBuffer multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") @Cast({"", "std::shared_ptr<arrow::Buffer>*"}) ArrowBuffer access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @SharedPtr ArrowBuffer ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr ArrowBuffer MoveValueUnsafe();
}
