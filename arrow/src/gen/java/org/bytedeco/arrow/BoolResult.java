...
public class BoolResult extends Pointer {
    ...
    @Override public BoolResult getPointer(long i) {
        return new BoolResult((Pointer)this).offsetAddress(i);
    }
  ...
  @NoException(true) private native void allocate(@Cast("bool&&") boolean value);
  ...
  @NoException(true) private native void allocate(@Const @ByRef BoolResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) BoolResult put(@Const @ByRef BoolResult other);
  ...
  ///
  ///
  public native @Cast("bool*") @Name("operator ->") BoolPointer access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Cast("const bool") boolean ValueUnsafe();
// #else
// #endif
