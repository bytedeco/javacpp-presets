...
public class DictionaryVectorResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef DictionaryVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") DictionaryVectorResult put(@Const @ByRef DictionaryVectorResult other);
  ...
  public native @ByRef DictionaryVector ValueUnsafe();
