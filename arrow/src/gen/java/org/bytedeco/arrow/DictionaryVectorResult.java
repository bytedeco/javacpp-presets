...
@Name("arrow::Result<arrow::ipc::DictionaryVector>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class DictionaryVectorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public DictionaryVectorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public DictionaryVectorResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public DictionaryVectorResult position(long position) {
        return (DictionaryVectorResult)super.position(position);
    }
    @Override public DictionaryVectorResult getPointer(long i) {
        return new DictionaryVectorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public DictionaryVectorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public DictionaryVectorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) DictionaryVector value);
  ...
  ///
  ///
  public DictionaryVectorResult(@Const @ByRef DictionaryVectorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef DictionaryVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) DictionaryVectorResult put(@Const @ByRef DictionaryVectorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef DictionaryVectorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef DictionaryVector ValueOrDie();
  public native @ByRef @Name("operator *") DictionaryVector multiply();
  
  ///
  ///
  public native @Name("operator ->") DictionaryVector access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef DictionaryVector ValueUnsafe();
// #else
// #endif

  

  public native @ByVal DictionaryVector MoveValueUnsafe();
}
