...
@Name("arrow::Future<std::vector<std::shared_ptr<arrow::RecordBatch> > >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow.class)
public class RecordBatchVectorFuture extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public RecordBatchVectorFuture(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public RecordBatchVectorFuture(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public RecordBatchVectorFuture position(long position) {
        return (RecordBatchVectorFuture)super.position(position);
    }
    @Override public RecordBatchVectorFuture getPointer(long i) {
        return new RecordBatchVectorFuture((Pointer)this).offsetAddress(i);
    }
  ...
  public RecordBatchVectorFuture() { super((Pointer)null); allocate(); }
  ...
  ///
  public native @Const @ByRef RecordBatchVectorResult result();
  ...
  public native @ByRef(true) RecordBatchVectorResult MoveResult();
  ...
  public native void MarkFinished(@ByVal RecordBatchVectorResult res);
  ...
  public static native @ByVal RecordBatchVectorFuture Make();

  /** \brief Producer API: instantiate a finished Future */
  public static native @ByVal RecordBatchVectorFuture MakeFinished(@ByVal RecordBatchVectorResult res);
  ...
  public RecordBatchVectorFuture(@ByVal @Cast("arrow::Future<std::vector<std::shared_ptr<arrow::RecordBatch> > >::ValueType*") RecordBatchVector val) { super((Pointer)null); allocate(val); }
  private native void allocate(@ByVal @Cast("arrow::Future<std::vector<std::shared_ptr<arrow::RecordBatch> > >::ValueType*") RecordBatchVector val);

  /** \brief Implicit constructor to create a future from a Result, enabling use
   *      of macros like ARROW_ASSIGN_OR_RAISE. */
  public RecordBatchVectorFuture(@ByVal RecordBatchVectorResult res) { super((Pointer)null); allocate(res); }
  private native void allocate(@ByVal RecordBatchVectorResult res);

  /** \brief Implicit constructor to create a future from a Status, enabling use
   *      of macros like ARROW_RETURN_NOT_OK. */
  public RecordBatchVectorFuture(@ByVal Status s) { super((Pointer)null); allocate(s); }
