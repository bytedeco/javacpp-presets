...
@Name("arrow::Result<std::vector<arrow::dataset::EnumeratedRecordBatch> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class EnumeratedRecordBatchResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public EnumeratedRecordBatchResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public EnumeratedRecordBatchResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public EnumeratedRecordBatchResult position(long position) {
        return (EnumeratedRecordBatchResult)super.position(position);
    }
    @Override public EnumeratedRecordBatchResult getPointer(long i) {
        return new EnumeratedRecordBatchResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public EnumeratedRecordBatchResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public EnumeratedRecordBatchResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public EnumeratedRecordBatchResult(@StdVector EnumeratedRecordBatch value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@StdVector EnumeratedRecordBatch value);
  ...
  ///
  ///
  public EnumeratedRecordBatchResult(@Const @ByRef EnumeratedRecordBatchResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef EnumeratedRecordBatchResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) EnumeratedRecordBatchResult put(@Const @ByRef EnumeratedRecordBatchResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef EnumeratedRecordBatchResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @StdVector EnumeratedRecordBatch ValueOrDie();
  public native @StdVector @Name("operator *") EnumeratedRecordBatch multiply();
  
  ///
  ///
  public native @StdVector @Name("operator ->") EnumeratedRecordBatch access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @StdVector EnumeratedRecordBatch ValueUnsafe();
// #else
// #endif

  

  public native @StdVector EnumeratedRecordBatch MoveValueUnsafe();
}
