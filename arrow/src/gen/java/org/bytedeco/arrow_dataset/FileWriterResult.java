...
public class FileWriterResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef FileWriterResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") FileWriterResult put(@Const @ByRef FileWriterResult other);
