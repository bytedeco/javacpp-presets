...
@Name("arrow::Result<std::shared_ptr<arrow::dataset::FileWriter> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class FileWriterResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FileWriterResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FileWriterResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public FileWriterResult position(long position) {
        return (FileWriterResult)super.position(position);
    }
    @Override public FileWriterResult getPointer(long i) {
        return new FileWriterResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public FileWriterResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FileWriterResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public FileWriterResult(@SharedPtr FileWriter value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr FileWriter value);
  ...
  ///
  ///
  public FileWriterResult(@Const @ByRef FileWriterResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef FileWriterResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) FileWriterResult put(@Const @ByRef FileWriterResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FileWriterResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr FileWriter ValueOrDie();
  public native @SharedPtr @Name("operator *") FileWriter multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") FileWriter access();
...
// #endif
  ...
  public native @SharedPtr FileWriter MoveValueUnsafe();
}
