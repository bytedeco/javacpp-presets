...
@Name("arrow::Result<arrow::dataset::TaggedRecordBatchGenerator>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class TaggedRecordBatchGeneratorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TaggedRecordBatchGeneratorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public TaggedRecordBatchGeneratorResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public TaggedRecordBatchGeneratorResult position(long position) {
        return (TaggedRecordBatchGeneratorResult)super.position(position);
    }
    @Override public TaggedRecordBatchGeneratorResult getPointer(long i) {
        return new TaggedRecordBatchGeneratorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public TaggedRecordBatchGeneratorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public TaggedRecordBatchGeneratorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) TaggedRecordBatchGenerator value);
  ...
  ///
  ///
  public TaggedRecordBatchGeneratorResult(@Const @ByRef TaggedRecordBatchGeneratorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef TaggedRecordBatchGeneratorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) TaggedRecordBatchGeneratorResult put(@Const @ByRef TaggedRecordBatchGeneratorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef TaggedRecordBatchGeneratorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef TaggedRecordBatchGenerator ValueOrDie();
  public native @ByRef @Name("operator *") TaggedRecordBatchGenerator multiply();
  
  ///
  ///
  public native @Name("operator ->") TaggedRecordBatchGenerator access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef TaggedRecordBatchGenerator ValueUnsafe();
// #else
// #endif

  

  public native @ByVal TaggedRecordBatchGenerator MoveValueUnsafe();
}
