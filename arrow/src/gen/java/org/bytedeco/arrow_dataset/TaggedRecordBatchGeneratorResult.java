...
public class TaggedRecordBatchGeneratorResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef TaggedRecordBatchGeneratorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") TaggedRecordBatchGeneratorResult put(@Const @ByRef TaggedRecordBatchGeneratorResult other);
  ...
  public native @ByRef TaggedRecordBatchGenerator ValueUnsafe();
