...
@Name("arrow::Result<std::unique_ptr<arrow::dataset::ScanTask> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class ScanTaskResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ScanTaskResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ScanTaskResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public ScanTaskResult getPointer(long i) {
        return new ScanTaskResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ScanTaskResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ScanTaskResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@UniquePtr @ByRef(true) ScanTask value);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ScanTaskResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @UniquePtr @ByRef ScanTask ValueOrDie();
  public native @UniquePtr @ByRef @Name("operator *") ScanTask multiply();
  
  ///
  ///
  public native @UniquePtr @Name("operator ->") ScanTask access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @UniquePtr @ByRef ScanTask ValueUnsafe();
// #else
// #endif

  

  public native @UniquePtr @ByVal ScanTask MoveValueUnsafe();
}
