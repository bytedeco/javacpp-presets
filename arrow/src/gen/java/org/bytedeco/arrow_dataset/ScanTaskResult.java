...
public class ScanTaskResult extends Pointer {
  ...
  ///
  ///
  public ScanTaskResult(@UniquePtr ScanTask value) { super((Pointer)null); allocate(value); }
  private native void allocate(@UniquePtr ScanTask value);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @UniquePtr ScanTask ValueOrDie();
  
  ///
  ///
  public native @UniquePtr @Name("operator *") ScanTask multiply();
