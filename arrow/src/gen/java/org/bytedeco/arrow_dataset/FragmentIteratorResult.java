...
public class FragmentIteratorResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef FragmentIteratorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") FragmentIteratorResult put(@Const @ByRef FragmentIteratorResult other);
  ...
  public native @ByRef FragmentIterator ValueUnsafe();
