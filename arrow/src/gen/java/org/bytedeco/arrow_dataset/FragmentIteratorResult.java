...
@Name("arrow::Result<arrow::Iterator<std::shared_ptr<arrow::dataset::Fragment> > >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class FragmentIteratorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FragmentIteratorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FragmentIteratorResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public FragmentIteratorResult position(long position) {
        return (FragmentIteratorResult)super.position(position);
    }
    @Override public FragmentIteratorResult getPointer(long i) {
        return new FragmentIteratorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public FragmentIteratorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FragmentIteratorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) FragmentIterator value);
  ...
  ///
  ///
  public FragmentIteratorResult(@Const @ByRef FragmentIteratorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef FragmentIteratorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) FragmentIteratorResult put(@Const @ByRef FragmentIteratorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FragmentIteratorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef FragmentIterator ValueOrDie();
  public native @ByRef @Name("operator *") FragmentIterator multiply();
  
  ///
  ///
  public native @Name("operator ->") FragmentIterator access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef FragmentIterator ValueUnsafe();
// #else
// #endif

  

  public native @ByVal FragmentIterator MoveValueUnsafe();
}
