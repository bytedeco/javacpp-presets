...
@Name("arrow::Result<arrow::dataset::RecordBatchGenerator>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class RecordBatchGeneratorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public RecordBatchGeneratorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public RecordBatchGeneratorResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public RecordBatchGeneratorResult position(long position) {
        return (RecordBatchGeneratorResult)super.position(position);
    }
    @Override public RecordBatchGeneratorResult getPointer(long i) {
        return new RecordBatchGeneratorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public RecordBatchGeneratorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public RecordBatchGeneratorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public RecordBatchGeneratorResult(@ByRef(true) RecordBatchGenerator value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@ByRef(true) RecordBatchGenerator value);
  ...
  ///
  ///
  public RecordBatchGeneratorResult(@Const @ByRef RecordBatchGeneratorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef RecordBatchGeneratorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) RecordBatchGeneratorResult put(@Const @ByRef RecordBatchGeneratorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef RecordBatchGeneratorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef RecordBatchGenerator ValueOrDie();
  public native @ByRef @Name("operator *") RecordBatchGenerator multiply();
  
  ///
  ///
  public native @Name("operator ->") RecordBatchGenerator access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef RecordBatchGenerator ValueUnsafe();
// #else
// #endif

  

  public native @ByVal RecordBatchGenerator MoveValueUnsafe();
}
