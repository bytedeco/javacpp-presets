...
public class RecordBatchGeneratorResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef RecordBatchGeneratorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") RecordBatchGeneratorResult put(@Const @ByRef RecordBatchGeneratorResult other);
  ...
  public native @ByRef RecordBatchGenerator ValueUnsafe();
