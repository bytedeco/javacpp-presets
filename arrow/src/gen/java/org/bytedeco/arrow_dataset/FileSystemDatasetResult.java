...
@Name("arrow::Result<std::shared_ptr<arrow::dataset::FileSystemDataset> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class FileSystemDatasetResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FileSystemDatasetResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FileSystemDatasetResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public FileSystemDatasetResult position(long position) {
        return (FileSystemDatasetResult)super.position(position);
    }
    @Override public FileSystemDatasetResult getPointer(long i) {
        return new FileSystemDatasetResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public FileSystemDatasetResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FileSystemDatasetResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public FileSystemDatasetResult(@SharedPtr FileSystemDataset value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr FileSystemDataset value);
  ...
  ///
  ///
  public FileSystemDatasetResult(@Const @ByRef FileSystemDatasetResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef FileSystemDatasetResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) FileSystemDatasetResult put(@Const @ByRef FileSystemDatasetResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FileSystemDatasetResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr FileSystemDataset ValueOrDie();
  public native @SharedPtr @Name("operator *") FileSystemDataset multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") FileSystemDataset access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @SharedPtr FileSystemDataset ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr FileSystemDataset MoveValueUnsafe();
}
