...
public class FileSystemDatasetResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef FileSystemDatasetResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") FileSystemDatasetResult put(@Const @ByRef FileSystemDatasetResult other);
