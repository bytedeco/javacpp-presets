...
@Name("arrow::Iterator<arrow::dataset::EnumeratedRecordBatch>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class EnumeratedRecordBatchIterator extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public EnumeratedRecordBatchIterator(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public EnumeratedRecordBatchIterator(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public EnumeratedRecordBatchIterator position(long position) {
        return (EnumeratedRecordBatchIterator)super.position(position);
    }
    @Override public EnumeratedRecordBatchIterator getPointer(long i) {
        return new EnumeratedRecordBatchIterator((Pointer)this).offsetAddress(i);
    }
  ...
  public EnumeratedRecordBatchIterator() { super((Pointer)null); allocate(); }
  ...
  public native @Cast("bool") boolean Equals(@Const @ByRef EnumeratedRecordBatchIterator other);
  ...
  @NoOffset public static class RangeIterator extends Pointer {
    ...
    public RangeIterator(@ByVal EnumeratedRecordBatchIterator i) { super((Pointer)null); allocate(i); }
    private native void allocate(@ByVal EnumeratedRecordBatchIterator i);
  ...
  public native @ByVal EnumeratedRecordBatchResult ToVector();
}
