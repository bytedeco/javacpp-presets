...
public class TaggedRecordBatchVectorResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef TaggedRecordBatchVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") TaggedRecordBatchVectorResult put(@Const @ByRef TaggedRecordBatchVectorResult other);
