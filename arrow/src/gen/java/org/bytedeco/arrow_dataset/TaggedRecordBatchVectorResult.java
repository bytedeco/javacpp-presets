...
@Name("arrow::Result<std::vector<arrow::dataset::TaggedRecordBatch> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class TaggedRecordBatchVectorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TaggedRecordBatchVectorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public TaggedRecordBatchVectorResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public TaggedRecordBatchVectorResult position(long position) {
        return (TaggedRecordBatchVectorResult)super.position(position);
    }
    @Override public TaggedRecordBatchVectorResult getPointer(long i) {
        return new TaggedRecordBatchVectorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public TaggedRecordBatchVectorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public TaggedRecordBatchVectorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public TaggedRecordBatchVectorResult(@StdVector TaggedRecordBatch value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@StdVector TaggedRecordBatch value);
  ...
  ///
  ///
  public TaggedRecordBatchVectorResult(@Const @ByRef TaggedRecordBatchVectorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef TaggedRecordBatchVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) TaggedRecordBatchVectorResult put(@Const @ByRef TaggedRecordBatchVectorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef TaggedRecordBatchVectorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @StdVector TaggedRecordBatch ValueOrDie();
  public native @StdVector @Name("operator *") TaggedRecordBatch multiply();
  
  ///
  ///
  public native @StdVector @Name("operator ->") TaggedRecordBatch access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @StdVector TaggedRecordBatch ValueUnsafe();
// #else
// #endif

  

  public native @StdVector TaggedRecordBatch MoveValueUnsafe();
}
