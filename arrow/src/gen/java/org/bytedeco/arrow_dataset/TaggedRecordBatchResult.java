...
public class TaggedRecordBatchResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef TaggedRecordBatchResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") TaggedRecordBatchResult put(@Const @ByRef TaggedRecordBatchResult other);
  ...
  public native @ByRef TaggedRecordBatch ValueUnsafe();
