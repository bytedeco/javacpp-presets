...
@Name("arrow::Result<arrow::dataset::TaggedRecordBatch>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class TaggedRecordBatchResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TaggedRecordBatchResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public TaggedRecordBatchResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public TaggedRecordBatchResult position(long position) {
        return (TaggedRecordBatchResult)super.position(position);
    }
    @Override public TaggedRecordBatchResult getPointer(long i) {
        return new TaggedRecordBatchResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public TaggedRecordBatchResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public TaggedRecordBatchResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public TaggedRecordBatchResult(@ByRef(true) TaggedRecordBatch value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@ByRef(true) TaggedRecordBatch value);
  ...
  ///
  ///
  public TaggedRecordBatchResult(@Const @ByRef TaggedRecordBatchResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef TaggedRecordBatchResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) TaggedRecordBatchResult put(@Const @ByRef TaggedRecordBatchResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef TaggedRecordBatchResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef TaggedRecordBatch ValueOrDie();
  public native @ByRef @Name("operator *") TaggedRecordBatch multiply();
  
  ///
  ///
  public native @Name("operator ->") TaggedRecordBatch access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef TaggedRecordBatch ValueUnsafe();
// #else
// #endif

  

  public native @ByVal TaggedRecordBatch MoveValueUnsafe();
}
