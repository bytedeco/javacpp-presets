...
@Name("arrow::Result<std::shared_ptr<arrow::dataset::Partitioning> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class PartitioningResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public PartitioningResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public PartitioningResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public PartitioningResult position(long position) {
        return (PartitioningResult)super.position(position);
    }
    @Override public PartitioningResult getPointer(long i) {
        return new PartitioningResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public PartitioningResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public PartitioningResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public PartitioningResult(@SharedPtr Partitioning value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr Partitioning value);
  ...
  ///
  ///
  public PartitioningResult(@Const @ByRef PartitioningResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef PartitioningResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) PartitioningResult put(@Const @ByRef PartitioningResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef PartitioningResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr Partitioning ValueOrDie();
  public native @SharedPtr @Name("operator *") Partitioning multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") Partitioning access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @SharedPtr Partitioning ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr Partitioning MoveValueUnsafe();
}
