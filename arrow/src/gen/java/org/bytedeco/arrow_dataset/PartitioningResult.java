...
public class PartitioningResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef PartitioningResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") PartitioningResult put(@Const @ByRef PartitioningResult other);
