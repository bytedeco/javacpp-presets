...
public class UnionDatasetResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef UnionDatasetResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") UnionDatasetResult put(@Const @ByRef UnionDatasetResult other);
  ...
  public native @SharedPtr @ByRef UnionDataset ValueUnsafe();
