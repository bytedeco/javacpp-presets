...
@Name("arrow::Result<std::shared_ptr<arrow::dataset::UnionDataset> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class UnionDatasetResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public UnionDatasetResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public UnionDatasetResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public UnionDatasetResult position(long position) {
        return (UnionDatasetResult)super.position(position);
    }
    @Override public UnionDatasetResult getPointer(long i) {
        return new UnionDatasetResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public UnionDatasetResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public UnionDatasetResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@SharedPtr @ByRef(true) UnionDataset value);
  ...
  ///
  ///
  public UnionDatasetResult(@Const @ByRef UnionDatasetResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef UnionDatasetResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) UnionDatasetResult put(@Const @ByRef UnionDatasetResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef UnionDatasetResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef UnionDataset ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") UnionDataset multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") UnionDataset access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @SharedPtr @ByRef UnionDataset ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr @ByVal UnionDataset MoveValueUnsafe();
}
