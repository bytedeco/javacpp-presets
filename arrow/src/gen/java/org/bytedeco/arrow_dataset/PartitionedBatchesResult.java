...
@Name("arrow::Result<arrow::dataset::Partitioning::PartitionedBatches>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class PartitionedBatchesResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public PartitionedBatchesResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public PartitionedBatchesResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public PartitionedBatchesResult position(long position) {
        return (PartitionedBatchesResult)super.position(position);
    }
    @Override public PartitionedBatchesResult getPointer(long i) {
        return new PartitionedBatchesResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public PartitionedBatchesResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public PartitionedBatchesResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) Partitioning.PartitionedBatches value);
  ...
  ///
  ///
  public PartitionedBatchesResult(@Const @ByRef PartitionedBatchesResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef PartitionedBatchesResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) PartitionedBatchesResult put(@Const @ByRef PartitionedBatchesResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef PartitionedBatchesResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef Partitioning.PartitionedBatches ValueOrDie();
  public native @ByRef @Name("operator *") Partitioning.PartitionedBatches multiply();
  
  ///
  ///
  public native @Name("operator ->") Partitioning.PartitionedBatches access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef Partitioning.PartitionedBatches ValueUnsafe();
// #else
// #endif

  

  public native @ByVal Partitioning.PartitionedBatches MoveValueUnsafe();
}
