...
public class PartitionedBatchesResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef PartitionedBatchesResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") PartitionedBatchesResult put(@Const @ByRef PartitionedBatchesResult other);
  ...
  public native @ByRef Partitioning.PartitionedBatches ValueUnsafe();
