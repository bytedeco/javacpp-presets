...
public class ScanTaskVectorResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef ScanTaskVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") ScanTaskVectorResult put(@Const @ByRef ScanTaskVectorResult other);
  ...
  public native @ByRef ScanTaskVector ValueUnsafe();
