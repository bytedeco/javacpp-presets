...
@Name("arrow::Result<std::vector<std::unique_ptr<arrow::dataset::ScanTask> > >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class ScanTaskVectorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ScanTaskVectorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ScanTaskVectorResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ScanTaskVectorResult position(long position) {
        return (ScanTaskVectorResult)super.position(position);
    }
    @Override public ScanTaskVectorResult getPointer(long i) {
        return new ScanTaskVectorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ScanTaskVectorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ScanTaskVectorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) ScanTaskVector value);
  ...
  ///
  ///
  public ScanTaskVectorResult(@Const @ByRef ScanTaskVectorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef ScanTaskVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) ScanTaskVectorResult put(@Const @ByRef ScanTaskVectorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ScanTaskVectorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef ScanTaskVector ValueOrDie();
  public native @ByRef @Name("operator *") ScanTaskVector multiply();
  
  ///
  ///
  public native @Name("operator ->") ScanTaskVector access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef ScanTaskVector ValueUnsafe();
// #else
// #endif

  

  public native @ByVal ScanTaskVector MoveValueUnsafe();
}
