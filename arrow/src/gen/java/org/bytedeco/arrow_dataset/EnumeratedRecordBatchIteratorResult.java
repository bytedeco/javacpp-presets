...
public class EnumeratedRecordBatchIteratorResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef EnumeratedRecordBatchIteratorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") EnumeratedRecordBatchIteratorResult put(@Const @ByRef EnumeratedRecordBatchIteratorResult other);
  ...
  public native @ByRef EnumeratedRecordBatchIterator ValueUnsafe();
