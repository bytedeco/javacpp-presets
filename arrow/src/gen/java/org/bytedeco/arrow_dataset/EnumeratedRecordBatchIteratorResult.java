...
@Name("arrow::Result<arrow::dataset::EnumeratedRecordBatchIterator>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class EnumeratedRecordBatchIteratorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public EnumeratedRecordBatchIteratorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public EnumeratedRecordBatchIteratorResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public EnumeratedRecordBatchIteratorResult position(long position) {
        return (EnumeratedRecordBatchIteratorResult)super.position(position);
    }
    @Override public EnumeratedRecordBatchIteratorResult getPointer(long i) {
        return new EnumeratedRecordBatchIteratorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public EnumeratedRecordBatchIteratorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public EnumeratedRecordBatchIteratorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) EnumeratedRecordBatchIterator value);
  ...
  ///
  ///
  public EnumeratedRecordBatchIteratorResult(@Const @ByRef EnumeratedRecordBatchIteratorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef EnumeratedRecordBatchIteratorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) EnumeratedRecordBatchIteratorResult put(@Const @ByRef EnumeratedRecordBatchIteratorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef EnumeratedRecordBatchIteratorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef EnumeratedRecordBatchIterator ValueOrDie();
  public native @ByRef @Name("operator *") EnumeratedRecordBatchIterator multiply();
  
  ///
  ///
  public native @Name("operator ->") EnumeratedRecordBatchIterator access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef EnumeratedRecordBatchIterator ValueUnsafe();
// #else
// #endif

  

  public native @ByVal EnumeratedRecordBatchIterator MoveValueUnsafe();
}
