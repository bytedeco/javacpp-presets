...
@Name("arrow::Result<std::shared_ptr<arrow::dataset::Fragment> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class FragmentResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FragmentResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FragmentResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public FragmentResult getPointer(long i) {
        return new FragmentResult((Pointer)this).offsetAddress(i);
    }
  ...
  @NoException(true) private native void allocate(@SharedPtr @ByRef(true) Fragment value);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FragmentResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef Fragment ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") Fragment multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") Fragment access();
...
// #endif
  ...
  public native @SharedPtr @ByVal Fragment MoveValueUnsafe();
}
