...
public class HivePartitioning extends KeyValuePartitioning {
  ...
  public static native @ByVal KeyOptional ParseKey(@StdString String segment,
                                        @StdString String null_fallback);
  public static native @ByVal KeyOptional ParseKey(@StdString BytePointer segment,
                                        @StdString BytePointer null_fallback);
