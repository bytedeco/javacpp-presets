...
public class ParquetFileFragmentResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef ParquetFileFragmentResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") ParquetFileFragmentResult put(@Const @ByRef ParquetFileFragmentResult other);
