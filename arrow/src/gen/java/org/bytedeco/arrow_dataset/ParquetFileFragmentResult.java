...
@Name("arrow::Result<std::shared_ptr<arrow::dataset::ParquetFileFragment> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class ParquetFileFragmentResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ParquetFileFragmentResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ParquetFileFragmentResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ParquetFileFragmentResult position(long position) {
        return (ParquetFileFragmentResult)super.position(position);
    }
    @Override public ParquetFileFragmentResult getPointer(long i) {
        return new ParquetFileFragmentResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ParquetFileFragmentResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ParquetFileFragmentResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public ParquetFileFragmentResult(@SharedPtr ParquetFileFragment value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr ParquetFileFragment value);
  ...
  ///
  ///
  public ParquetFileFragmentResult(@Const @ByRef ParquetFileFragmentResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef ParquetFileFragmentResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) ParquetFileFragmentResult put(@Const @ByRef ParquetFileFragmentResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ParquetFileFragmentResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr ParquetFileFragment ValueOrDie();
  public native @SharedPtr @Name("operator *") ParquetFileFragment multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") ParquetFileFragment access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @SharedPtr ParquetFileFragment ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr ParquetFileFragment MoveValueUnsafe();
}
