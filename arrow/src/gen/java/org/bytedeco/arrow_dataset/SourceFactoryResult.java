...
@Name("arrow::Result<std::shared_ptr<arrow::dataset::SourceFactory> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class SourceFactoryResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public SourceFactoryResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public SourceFactoryResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public SourceFactoryResult position(long position) {
        return (SourceFactoryResult)super.position(position);
    }
   ...
   *  Result. */
  public SourceFactoryResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public SourceFactoryResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public SourceFactoryResult(@SharedPtr @ByVal SourceFactory value) { super((Pointer)null); allocate(value); }
  private native void allocate(@SharedPtr @ByVal SourceFactory value);
  ...
  ///
  ///
  public SourceFactoryResult(@Const @ByRef SourceFactoryResult other) { super((Pointer)null); allocate(other); }
  private native void allocate(@Const @ByRef SourceFactoryResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") SourceFactoryResult put(@Const @ByRef SourceFactoryResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef SourceFactoryResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef SourceFactory ValueOrDie();
  
  ///
  ///
  public native @SharedPtr @ByRef @Name("operator *") SourceFactory multiply();
