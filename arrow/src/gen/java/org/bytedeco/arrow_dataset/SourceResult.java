...
@Name("arrow::Result<std::shared_ptr<arrow::dataset::Source> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class SourceResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public SourceResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public SourceResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public SourceResult position(long position) {
        return (SourceResult)super.position(position);
    }
   ...
   *  Result. */
  public SourceResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public SourceResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public SourceResult(@SharedPtr @ByVal Source value) { super((Pointer)null); allocate(value); }
  private native void allocate(@SharedPtr @ByVal Source value);
  ...
  ///
  ///
  public SourceResult(@Const @ByRef SourceResult other) { super((Pointer)null); allocate(other); }
  private native void allocate(@Const @ByRef SourceResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") SourceResult put(@Const @ByRef SourceResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef SourceResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef Source ValueOrDie();
  
  ///
  ///
  public native @SharedPtr @ByRef @Name("operator *") Source multiply();
