...
@Name("arrow::Result<std::shared_ptr<arrow::dataset::WriteTask> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class WriteTaskResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public WriteTaskResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public WriteTaskResult(long size) { super((Pointer)null); allocateArray(size); }
   ...
   *  Result. */
  public WriteTaskResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public WriteTaskResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public WriteTaskResult(@SharedPtr WriteTask value) { super((Pointer)null); allocate(value); }
  @NoException private native void allocate(@SharedPtr WriteTask value);
  ...
  ///
  ///
  public WriteTaskResult(@Const @ByRef WriteTaskResult other) { super((Pointer)null); allocate(other); }
  private native void allocate(@Const @ByRef WriteTaskResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") WriteTaskResult put(@Const @ByRef WriteTaskResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef WriteTaskResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr WriteTask ValueOrDie();
  
  ///
  ///
  public native @SharedPtr @Name("operator *") WriteTask multiply();
  ...
  public native @SharedPtr WriteTask ValueUnsafe();

  

  public native @SharedPtr WriteTask MoveValueUnsafe();
}
