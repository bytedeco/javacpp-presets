...
@Name("arrow::Result<arrow::dataset::TaggedRecordBatchIterator>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class TaggedRecordBatchIteratorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public TaggedRecordBatchIteratorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public TaggedRecordBatchIteratorResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public TaggedRecordBatchIteratorResult position(long position) {
        return (TaggedRecordBatchIteratorResult)super.position(position);
    }
    @Override public TaggedRecordBatchIteratorResult getPointer(long i) {
        return new TaggedRecordBatchIteratorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public TaggedRecordBatchIteratorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public TaggedRecordBatchIteratorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public TaggedRecordBatchIteratorResult(@ByRef(true) TaggedRecordBatchIterator value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@ByRef(true) TaggedRecordBatchIterator value);
  ...
  ///
  ///
  public TaggedRecordBatchIteratorResult(@Const @ByRef TaggedRecordBatchIteratorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef TaggedRecordBatchIteratorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) TaggedRecordBatchIteratorResult put(@Const @ByRef TaggedRecordBatchIteratorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef TaggedRecordBatchIteratorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef TaggedRecordBatchIterator ValueOrDie();
  public native @ByRef @Name("operator *") TaggedRecordBatchIterator multiply();
  
  ///
  ///
  public native @Name("operator ->") TaggedRecordBatchIterator access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef TaggedRecordBatchIterator ValueUnsafe();
// #else
// #endif

  

  public native @ByVal TaggedRecordBatchIterator MoveValueUnsafe();
}
