...
public class ScannerResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef ScannerResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") ScannerResult put(@Const @ByRef ScannerResult other);
  ...
  public native @SharedPtr @ByRef Scanner ValueUnsafe();
