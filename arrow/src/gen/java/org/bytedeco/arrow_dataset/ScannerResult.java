...
@Name("arrow::Result<std::shared_ptr<arrow::dataset::Scanner> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class ScannerResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ScannerResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ScannerResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ScannerResult position(long position) {
        return (ScannerResult)super.position(position);
    }
    @Override public ScannerResult getPointer(long i) {
        return new ScannerResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ScannerResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ScannerResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public ScannerResult(@SharedPtr @ByRef(true) Scanner value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr @ByRef(true) Scanner value);
  ...
  ///
  ///
  public ScannerResult(@Const @ByRef ScannerResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef ScannerResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) ScannerResult put(@Const @ByRef ScannerResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ScannerResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef Scanner ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") Scanner multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") Scanner access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @SharedPtr @ByRef Scanner ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr @ByVal Scanner MoveValueUnsafe();
}
