...
public class ScannerResult extends Pointer {
  ...
  ///
  ///
  public ScannerResult(@SharedPtr @ByVal Scanner value) { super((Pointer)null); allocate(value); }
  @NoException private native void allocate(@SharedPtr @ByVal Scanner value);
