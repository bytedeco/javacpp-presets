...
public class ExpressionResult extends Pointer {
    ...
    public ExpressionResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ExpressionResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ExpressionResult position(long position) {
        return (ExpressionResult)super.position(position);
    }
    @Override public ExpressionResult getPointer(long i) {
        return new ExpressionResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ExpressionResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ExpressionResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) Expression value);
  ...
  ///
  ///
  public ExpressionResult(@Const @ByRef ExpressionResult other) { super((Pointer)null); allocate(other); }
  private native void allocate(@Const @ByRef ExpressionResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") ExpressionResult put(@Const @ByRef ExpressionResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ExpressionResult other);
  ...
  ///
  ///
  public native @Name("operator ->") Expression access();
