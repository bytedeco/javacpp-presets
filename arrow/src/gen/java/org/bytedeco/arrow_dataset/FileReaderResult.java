...
@Name("arrow::Result<std::unique_ptr<parquet::arrow::FileReader> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class FileReaderResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FileReaderResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FileReaderResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public FileReaderResult position(long position) {
        return (FileReaderResult)super.position(position);
    }
    @Override public FileReaderResult getPointer(long i) {
        return new FileReaderResult((Pointer)this).offsetAddress(i);
    }
  ...
  @NoException(true) private native void allocate(@UniquePtr @ByRef(true) FileReader value);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FileReaderResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @UniquePtr @ByRef FileReader ValueOrDie();
  public native @UniquePtr @ByRef @Name("operator *") FileReader multiply();
  
  ///
  ///
  public native @UniquePtr @Name("operator ->") FileReader access();
...
// #endif
  ...
  public native @UniquePtr @ByVal FileReader MoveValueUnsafe();
}
