...
public class FileFragmentResult extends Pointer {
    ...
    @Override public FileFragmentResult getPointer(long i) {
        return new FileFragmentResult((Pointer)this).offsetAddress(i);
    }
  ...
  @NoException(true) private native void allocate(@SharedPtr @ByRef(true) FileFragment value);
  ...
  @NoException(true) private native void allocate(@Const @ByRef FileFragmentResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) FileFragmentResult put(@Const @ByRef FileFragmentResult other);
  ...
  ///
  ///
  public native @SharedPtr @Name("operator ->") FileFragment access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @SharedPtr @ByRef FileFragment ValueUnsafe();
// #else
// #endif
