...
@Name("arrow::Result<std::shared_ptr<arrow::dataset::DatasetFactory> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class DatasetFactoryResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public DatasetFactoryResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public DatasetFactoryResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public DatasetFactoryResult getPointer(long i) {
        return new DatasetFactoryResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public DatasetFactoryResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public DatasetFactoryResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@SharedPtr @ByRef(true) DatasetFactory value);
  ...
  ///
  ///
  public DatasetFactoryResult(@Const @ByRef DatasetFactoryResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef DatasetFactoryResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) DatasetFactoryResult put(@Const @ByRef DatasetFactoryResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef DatasetFactoryResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef DatasetFactory ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") DatasetFactory multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") DatasetFactory access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @SharedPtr @ByRef DatasetFactory ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr @ByVal DatasetFactory MoveValueUnsafe();
}
