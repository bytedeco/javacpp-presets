...
public class DatasetFactoryResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef DatasetFactoryResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") DatasetFactoryResult put(@Const @ByRef DatasetFactoryResult other);
  ...
  public native @SharedPtr @ByRef DatasetFactory ValueUnsafe();
