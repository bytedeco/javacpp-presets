...
public class FragmentVectorResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef FragmentVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") FragmentVectorResult put(@Const @ByRef FragmentVectorResult other);
