...
@Name("arrow::Result<std::vector<std::shared_ptr<arrow::dataset::Fragment> > >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class FragmentVectorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FragmentVectorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FragmentVectorResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public FragmentVectorResult position(long position) {
        return (FragmentVectorResult)super.position(position);
    }
    @Override public FragmentVectorResult getPointer(long i) {
        return new FragmentVectorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public FragmentVectorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FragmentVectorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public FragmentVectorResult(@SharedPtr @StdVector Fragment value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@SharedPtr @StdVector Fragment value);
  ...
  ///
  ///
  public FragmentVectorResult(@Const @ByRef FragmentVectorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef FragmentVectorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) FragmentVectorResult put(@Const @ByRef FragmentVectorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FragmentVectorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @StdVector Fragment ValueOrDie();
  public native @SharedPtr @StdVector @Name("operator *") Fragment multiply();
  
  ///
  ///
  public native @SharedPtr @StdVector @Name("operator ->") Fragment access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @SharedPtr @StdVector Fragment ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr @StdVector Fragment MoveValueUnsafe();
}
