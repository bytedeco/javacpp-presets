...
public class ScanTaskIteratorResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef ScanTaskIteratorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") ScanTaskIteratorResult put(@Const @ByRef ScanTaskIteratorResult other);
  ...
  public native @ByRef ScanTaskIterator ValueUnsafe();
