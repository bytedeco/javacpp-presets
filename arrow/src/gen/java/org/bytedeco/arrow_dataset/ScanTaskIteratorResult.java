...
@Name("arrow::Result<arrow::dataset::ScanTaskIterator>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class ScanTaskIteratorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ScanTaskIteratorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ScanTaskIteratorResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ScanTaskIteratorResult position(long position) {
        return (ScanTaskIteratorResult)super.position(position);
    }
    @Override public ScanTaskIteratorResult getPointer(long i) {
        return new ScanTaskIteratorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ScanTaskIteratorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ScanTaskIteratorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) ScanTaskIterator value);
  ...
  ///
  ///
  public ScanTaskIteratorResult(@Const @ByRef ScanTaskIteratorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef ScanTaskIteratorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) ScanTaskIteratorResult put(@Const @ByRef ScanTaskIteratorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ScanTaskIteratorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef ScanTaskIterator ValueOrDie();
  public native @ByRef @Name("operator *") ScanTaskIterator multiply();
  
  ///
  ///
  public native @Name("operator ->") ScanTaskIterator access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef ScanTaskIterator ValueUnsafe();
// #else
// #endif

  

  public native @ByVal ScanTaskIterator MoveValueUnsafe();
}
