...
public class DatasetResult extends Pointer {
  ...
  @NoException(true) private native void allocate(@SharedPtr @ByRef(true) Dataset value);
  ...
  @NoException(true) private native void allocate(@Const @ByRef DatasetResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) DatasetResult put(@Const @ByRef DatasetResult other);
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @SharedPtr @ByRef Dataset ValueUnsafe();
// #else
// #endif
