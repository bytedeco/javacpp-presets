...
@Name("arrow::Result<std::shared_ptr<arrow::internal::ThreadPool> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class ThreadPoolResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ThreadPoolResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ThreadPoolResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public ThreadPoolResult position(long position) {
   ...
   *  Result. */
  public ThreadPoolResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ThreadPoolResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public ThreadPoolResult(@SharedPtr ThreadPool value) { super((Pointer)null); allocate(value); }
  @NoException private native void allocate(@SharedPtr ThreadPool value);
  ...
  ///
  ///
  public ThreadPoolResult(@Const @ByRef ThreadPoolResult other) { super((Pointer)null); allocate(other); }
  private native void allocate(@Const @ByRef ThreadPoolResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") ThreadPoolResult put(@Const @ByRef ThreadPoolResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ThreadPoolResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr ThreadPool ValueOrDie();
  
  ///
  ///
  public native @SharedPtr @Name("operator *") ThreadPool multiply();
  ...
  public native @SharedPtr ThreadPool ValueUnsafe();

  

  public native @SharedPtr ThreadPool MoveValueUnsafe();
}
