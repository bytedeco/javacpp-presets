...
@Name("arrow::Result<std::shared_ptr<arrow::dataset::ScannerBuilder> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class ScannerBuilderResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ScannerBuilderResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public ScannerBuilderResult(long size) { super((Pointer)null); allocateArray(size); }
    ...
    @Override public ScannerBuilderResult getPointer(long i) {
        return new ScannerBuilderResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public ScannerBuilderResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public ScannerBuilderResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@SharedPtr @ByRef(true) ScannerBuilder value);
  ...
  ///
  ///
  public ScannerBuilderResult(@Const @ByRef ScannerBuilderResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef ScannerBuilderResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) ScannerBuilderResult put(@Const @ByRef ScannerBuilderResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef ScannerBuilderResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @SharedPtr @ByRef ScannerBuilder ValueOrDie();
  public native @SharedPtr @ByRef @Name("operator *") ScannerBuilder multiply();
  
  ///
  ///
  public native @SharedPtr @Name("operator ->") ScannerBuilder access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @SharedPtr @ByRef ScannerBuilder ValueUnsafe();
// #else
// #endif

  

  public native @SharedPtr @ByVal ScannerBuilder MoveValueUnsafe();
}
