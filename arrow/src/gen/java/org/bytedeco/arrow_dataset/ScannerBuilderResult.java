...
public class ScannerBuilderResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef ScannerBuilderResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") ScannerBuilderResult put(@Const @ByRef ScannerBuilderResult other);
  ...
  public native @SharedPtr @ByRef ScannerBuilder ValueUnsafe();
