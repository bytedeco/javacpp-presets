...
@Name("arrow::Result<arrow::dataset::EnumeratedRecordBatchGenerator>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class EnumeratedRecordBatchGeneratorResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public EnumeratedRecordBatchGeneratorResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public EnumeratedRecordBatchGeneratorResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public EnumeratedRecordBatchGeneratorResult position(long position) {
        return (EnumeratedRecordBatchGeneratorResult)super.position(position);
    }
    @Override public EnumeratedRecordBatchGeneratorResult getPointer(long i) {
        return new EnumeratedRecordBatchGeneratorResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public EnumeratedRecordBatchGeneratorResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public EnumeratedRecordBatchGeneratorResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) EnumeratedRecordBatchGenerator value);
  ...
  ///
  ///
  public EnumeratedRecordBatchGeneratorResult(@Const @ByRef EnumeratedRecordBatchGeneratorResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef EnumeratedRecordBatchGeneratorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) EnumeratedRecordBatchGeneratorResult put(@Const @ByRef EnumeratedRecordBatchGeneratorResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef EnumeratedRecordBatchGeneratorResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef EnumeratedRecordBatchGenerator ValueOrDie();
  public native @ByRef @Name("operator *") EnumeratedRecordBatchGenerator multiply();
  
  ///
  ///
  public native @Name("operator ->") EnumeratedRecordBatchGenerator access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef EnumeratedRecordBatchGenerator ValueUnsafe();
// #else
// #endif

  

  public native @ByVal EnumeratedRecordBatchGenerator MoveValueUnsafe();
}
