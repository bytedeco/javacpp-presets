...
public class EnumeratedRecordBatchGeneratorResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef EnumeratedRecordBatchGeneratorResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") EnumeratedRecordBatchGeneratorResult put(@Const @ByRef EnumeratedRecordBatchGeneratorResult other);
  ...
  public native @ByRef EnumeratedRecordBatchGenerator ValueUnsafe();
