...
public class KeyOptionalResult extends Pointer {
  ...
  private native void allocate(@Const @ByRef KeyOptionalResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") KeyOptionalResult put(@Const @ByRef KeyOptionalResult other);
  ...
  public native @ByRef KeyOptional ValueUnsafe();
