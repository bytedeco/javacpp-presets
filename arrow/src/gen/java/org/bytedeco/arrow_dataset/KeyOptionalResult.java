 ...
 *  }</pre> */
@Name("arrow::Result<arrow::util::optional<arrow::dataset::KeyValuePartitioning::Key> >") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_dataset.class)
public class KeyOptionalResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public KeyOptionalResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public KeyOptionalResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public KeyOptionalResult position(long position) {
        return (KeyOptionalResult)super.position(position);
    }
    @Override public KeyOptionalResult getPointer(long i) {
        return new KeyOptionalResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public KeyOptionalResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public KeyOptionalResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  ///
  ///
  public KeyOptionalResult(@ByRef(true) KeyOptional value) { super((Pointer)null); allocate(value); }
  @NoException(true) private native void allocate(@ByRef(true) KeyOptional value);
  ...
  ///
  ///
  public KeyOptionalResult(@Const @ByRef KeyOptionalResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef KeyOptionalResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) KeyOptionalResult put(@Const @ByRef KeyOptionalResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef KeyOptionalResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef KeyOptional ValueOrDie();
  public native @ByRef @Name("operator *") KeyOptional multiply();
  
  ///
  ///
  public native @Name("operator ->") KeyOptional access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef KeyOptional ValueUnsafe();
// #else
// #endif

  

  public native @ByVal KeyOptional MoveValueUnsafe();
}
