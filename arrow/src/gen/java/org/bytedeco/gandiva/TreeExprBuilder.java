...
public class TreeExprBuilder extends Pointer {
    ...
    @Override public TreeExprBuilder getPointer(long i) {
        return new TreeExprBuilder((Pointer)this).offsetAddress(i);
    }
  ...
  public static native @SharedPtr Node MakeInExpressionDecimal(
        @SharedPtr Node node, @ByRef DecimalScalar128Set constants);
  ...
  public static native @SharedPtr Node MakeInExpressionFloat(@SharedPtr Node node,
                                         @Const @ByRef FloatSet constants);

  /** \brief creates an in expression for double */
  public static native @SharedPtr Node MakeInExpressionDouble(@SharedPtr Node node,
                                          @Const @ByRef DoubleSet constants);
