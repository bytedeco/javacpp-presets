...
public class Configuration extends Pointer {
    ...
    @Override public Configuration getPointer(long i) {
        return new Configuration((Pointer)this).offsetAddress(i);
    }
  ...
  public native @Cast("bool") boolean target_host_cpu();

  public native void set_optimize(@Cast("bool") boolean optimize);
  public native void target_host_cpu(@Cast("bool") boolean target_host_cpu);
}
