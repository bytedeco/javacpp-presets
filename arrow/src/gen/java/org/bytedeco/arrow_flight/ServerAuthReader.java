...
public class ServerAuthReader extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public ServerAuthReader(Pointer p) { super(p); }

  public native @ByVal Status Read(@StdString @Cast({"char*", "std::string*"}) BytePointer token);
}
