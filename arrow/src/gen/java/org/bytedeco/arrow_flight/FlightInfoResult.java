 ...
 *  }</pre> */
@Name("arrow::Result<arrow::flight::FlightInfo>") @NoOffset @Properties(inherit = org.bytedeco.arrow.presets.arrow_flight.class)
public class FlightInfoResult extends Pointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public FlightInfoResult(Pointer p) { super(p); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public FlightInfoResult(long size) { super((Pointer)null); allocateArray(size); }
    private native void allocateArray(long size);
    @Override public FlightInfoResult position(long position) {
        return (FlightInfoResult)super.position(position);
    }
    @Override public FlightInfoResult getPointer(long i) {
        return new FlightInfoResult((Pointer)this).offsetAddress(i);
    }
   ...
   *  Result. */
  public FlightInfoResult() { super((Pointer)null); allocate(); }
  ...
  ///
  ///
  public FlightInfoResult(@Const @ByRef Status status) { super((Pointer)null); allocate(status); }
  ...
  @NoException(true) private native void allocate(@ByRef(true) FlightInfo value);
  ...
  ///
  ///
  public FlightInfoResult(@Const @ByRef FlightInfoResult other) { super((Pointer)null); allocate(other); }
  @NoException(true) private native void allocate(@Const @ByRef FlightInfoResult other);
  ...
  ///
  ///
  public native @ByRef @Name("operator =") @NoException(true) FlightInfoResult put(@Const @ByRef FlightInfoResult other);
  ...
  ///
  public native @Cast("bool") boolean Equals(@Const @ByRef FlightInfoResult other);
   ...
   * 
   *  @return The stored {@code T} value. */
  public native @ByRef FlightInfo ValueOrDie();
  public native @ByRef @Name("operator *") FlightInfo multiply();
  
  ///
  ///
  public native @Name("operator ->") FlightInfo access();
...
// #if __cpp_constexpr >= 201304L  // non-const constexpr
  public native @Const @ByRef FlightInfo ValueUnsafe();
// #else
// #endif

  

  public native @ByVal FlightInfo MoveValueUnsafe();
}
