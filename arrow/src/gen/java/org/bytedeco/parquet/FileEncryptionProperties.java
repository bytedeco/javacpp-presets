...
public class FileEncryptionProperties extends Pointer {
  ...
  @NoOffset public static class Builder extends Pointer {
    ...
    public native Builder encrypted_columns(
            @Cast("const parquet::ColumnPathToEncryptionPropertiesMap*") @ByRef ColumnDecryptionPropertiesStringMap encrypted_columns);
  ...
  public native @ByVal @Cast("parquet::ColumnPathToEncryptionPropertiesMap*") ColumnDecryptionPropertiesStringMap encrypted_columns();
}
