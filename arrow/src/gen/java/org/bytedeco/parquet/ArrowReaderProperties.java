...
public class ArrowReaderProperties extends Pointer {
    ...
    @Override public ArrowReaderProperties getPointer(long i) {
        return new ArrowReaderProperties((Pointer)this).offsetAddress(i);
    }
  ...
  public native @Const @ByRef CacheOptions cache_options();

  /** Set execution context for read coalescing. */
  public native void set_io_context(@Const @ByRef IOContext ctx);

  public native @Const @ByRef IOContext io_context();

  /** Set timestamp unit to use for deprecated INT96-encoded timestamps
   *  (default is NANO). */
  public native void set_coerce_int96_timestamp_unit(TimeUnit.type unit);
  public native void set_coerce_int96_timestamp_unit(@Cast("arrow::TimeUnit::type") int unit);

  public native TimeUnit.type coerce_int96_timestamp_unit();
}
