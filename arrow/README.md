 ...
 * Arrow 0.16.0  https://arrow.apache.org/
 ...
 * https://github.com/apache/arrow/blob/apache-arrow-0.16.0/cpp/examples/arrow/row-wise-conversion-example.cc
...
<project>
    ...
    <dependencies>
        <dependency>
            ...
            <version>0.16.0-1.5.3-SNAPSHOT</version>
        </dependency>
    </dependencies>
    <build>
