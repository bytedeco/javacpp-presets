 ...
 * Arrow 1.0.1  https://arrow.apache.org/
 ...
 * https://github.com/apache/arrow/blob/apache-arrow-1.0.1/cpp/examples/arrow/row-wise-conversion-example.cc
...
<project>
    ...
    <dependencies>
        <dependency>
            ...
            <version>1.0.1-1.5.4-SNAPSHOT</version>
        </dependency>
    </dependencies>
    <build>
