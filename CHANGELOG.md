 ...
 * Upgrade presets for OpenCV 4.12.0, FFmpeg 8.0.1, DNNL 3.10.2, CUDA 13.1.0, cuDNN 9.17.1.4, NCCL 2.28.9, nvCOMP 5.1.0.21, CPython 3.14.1, NumPy 2.3.5, SciPy 1.16.3, LLVM 21.1.7, libffi 3.5.2, Leptonica 1.86.0, PyTorch 2.9.1, SentencePiece 0.2.1, TensorFlow Lite 2.20.0, TensorRT 10.14.1.48, Triton Inference Server 2.64.0, ONNX 1.20.0, ONNX Runtime 1.23.2, and their dependencies
