 ...
 * Upgrade presets for OpenCV 4.12.0, FFmpeg 8.0, DNNL 3.9.2, CUDA 13.0.2, cuDNN 9.14.0, NCCL 2.28.3, nvCOMP 5.0.0.6, CPython 3.14.0, NumPy 2.3.4, SciPy 1.16.2, LLVM 21.1.0, libffi 3.5.2, PyTorch 2.9.0, SentencePiece 0.2.1, TensorFlow Lite 2.20.0, TensorRT 10.13.3.9, Triton Inference Server 2.61.0, ONNX 1.19.1, ONNX Runtime 1.23.2, and their dependencies
