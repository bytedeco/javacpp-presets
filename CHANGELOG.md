 ...
 * Upgrade presets for OpenCV 4.12.0, FFmpeg 8.0.1, DNNL 3.10.2, CUDA 13.0.2, cuDNN 9.14.0, NCCL 2.28.3, nvCOMP 5.0.0.6, CPython 3.14.1, NumPy 2.3.5, SciPy 1.16.3, LLVM 21.1.7, libffi 3.5.2, Leptonica 1.86.0, PyTorch 2.9.1, SentencePiece 0.2.1, TensorFlow Lite 2.20.0, TensorRT 10.13.3.9, Triton Inference Server 2.61.0, ONNX 1.20.0, ONNX Runtime 1.23.2, and their dependencies
