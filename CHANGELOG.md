 ...
 * Add presets for librealsense2 2.25.0
 * Upgrade presets for OpenCV 4.1.1, FFmpeg 4.2.1, librealsense 1.12.4, MKL-DNN 0.21, OpenBLAS 0.3.7, GSL 2.6, CPython 3.7.4, NumPy 1.17.2, CUDA 10.1 Update 2, cuDNN 7.6.2, NCCL 2.4.8, LLVM 8.0.1, MXNet 1.5.1.rc0, TensorFlow 1.15.0-rc1, nGraph 0.25.0, Qt 5.13.1, cpu_features 0.4.1, and their dependencies
