 ...
 * Upgrade presets for OpenCV 4.6.0, FFmpeg 5.1.1, HDF5 1.12.2, LZ4 1.9.4, DNNL 2.6.2, OpenBLAS 0.3.21 ([issue #1171](https://github.com/bytedeco/javacpp-presets/issues/1171)), CPython 3.10.7, NumPy 1.23.3, SciPy 1.9.1, Gym 0.26.1, LLVM 15.0.1, Tesseract 5.2.0, CUDA 11.6.2, NCCL 2.12.7, OpenCL 3.0.11, MXNet 1.9.1, PyTorch 1.12.1, TensorFlow Lite 2.10.0, Triton Inference Server 2.24.0, ALE 0.8.0, DepthAI 2.17.4, ONNX 1.12.0, ONNX Runtime 1.12.1, TVM 0.9.0, Skia 2.88.0, cpu_features 0.7.0, ModSecurity 3.0.8, and their dependencies
