 ...
 * Introduce `macosx-arm64` builds for DNNL, OpenCL ([issue #1681](https://github.com/bytedeco/javacpp-presets/issues/1681)) and enable for ONNX Runtime ([pull #1689](https://github.com/bytedeco/javacpp-presets/pull/1689))
 ...
 * Upgrade presets for OpenCV 4.12.0, FFmpeg 8.0, DNNL 3.9.1, CPython 3.13.6, NumPy 2.3.2, SciPy 1.16.1, LLVM 21.1.0, libffi 3.5.2, PyTorch 2.8.0, SentencePiece 0.2.1, TensorFlow Lite 2.20.0, ONNX 1.18.0, ONNX Runtime 1.22.2, and their dependencies
