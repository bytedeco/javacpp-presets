 ...
 * Upgrade presets for OpenCV 4.5.4, FFmpeg 4.4.1, Arrow 6.0.0, MKL 2021.4, DNNL 2.4.2, OpenBLAS 0.3.18, FFTW 3.3.10, CPython 3.10.0, NumPy 1.21.3, SciPy 1.7.1, Gym 0.21.0, LLVM 13.0.0, libpostal 1.1, Leptonica 1.82.0, Tesseract 5.0.0, CUDA 11.4.2, cuDNN 8.2.4, NCCL 2.11.4, PyTorch 1.10.0, TensorFlow Lite 2.7.0, ALE 0.7.2, DepthAI 2.11.1, ONNX 1.10.2, ONNX Runtime 1.9.1, and their dependencies
