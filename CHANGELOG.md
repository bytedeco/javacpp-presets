 ...
 * Upgrade presets for OpenCV 4.2.0, FFmpeg 4.2.2, Spinnaker 1.27.0.48, HDF5 1.12.0, MKL 2020.0, MKL-DNN 0.21.3, DNNL 1.2.1, OpenBLAS 0.3.8, CPython 3.7.6, NumPy 1.18.1, LLVM 9.0.1, CUDA 10.2, cuDNN 7.6.5, NCCL 2.5.6, MXNet 1.6.0, TensorFlow 1.15.2, TensorRT 7.0, ALE 0.6.1, Leptonica 1.79.0, Tesseract 4.1.1, ONNX Runtime 1.1.2, Qt 5.14.1, Skia 1.68.1, and their dependencies
