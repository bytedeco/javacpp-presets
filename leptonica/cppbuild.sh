...
case $PLATFORM in
    ...
    linux-x86)
        ...
        make install
        cd ../leptonica-$LEPTONICA_VERSION
        PKG_CONFIG_PATH=../lib/pkgconfig/ ./configure --prefix=$INSTALL_PATH CFLAGS="-pthread -I$INSTALL_PATH/include/" LDFLAGS="-L$INSTALL_PATH/lib/" --disable-programs
        make -j $MAKEJ
        make install-strip
        ;;
    linux-x86_64)
    ...
    linux-armhf)
        ...
        make install
        cd ../leptonica-$LEPTONICA_VERSION
        PKG_CONFIG_PATH=../lib/pkgconfig/ CC="arm-linux-gnueabihf-gcc -fPIC" ./configure --prefix=$INSTALL_PATH CFLAGS="-pthread -I$INSTALL_PATH/include/" LDFLAGS="-L$INSTALL_PATH/lib/"  --host=arm-linux-gnueabihf --disable-programs
        make -j $MAKEJ
        make install-strip
        ;;
    linux-arm64)
        ...
        make install
        cd ../leptonica-$LEPTONICA_VERSION
        PKG_CONFIG_PATH=../lib/pkgconfig/ CC="aarch64-linux-gnu-gcc -fPIC" ./configure --prefix=$INSTALL_PATH CFLAGS="-pthread -I$INSTALL_PATH/include/" LDFLAGS="-L$INSTALL_PATH/lib/"  --host=aarch64-linux-gnu --disable-programs
        make -j $MAKEJ
        make install-strip
        ;;
    linux-ppc64le)
    ...
    windows-x86)
        ...
        make install
        cd ../leptonica-$LEPTONICA_VERSION
        PKG_CONFIG_PATH=../lib/pkgconfig/ ./configure --prefix=$INSTALL_PATH CFLAGS="-pthread -I$INSTALL_PATH/include/" LDFLAGS="-L$INSTALL_PATH/lib/ -Wl,$INSTALL_PATH/lib/*.a" --build=i686-w64-mingw32 --disable-programs
        make -j $MAKEJ
        make install-strip
        ;;
    windows-x86_64)
        ...
        make install
        cd ../leptonica-$LEPTONICA_VERSION
        PKG_CONFIG_PATH=../lib/pkgconfig/ ./configure --prefix=$INSTALL_PATH CFLAGS="-pthread -I$INSTALL_PATH/include/" LDFLAGS="-L$INSTALL_PATH/lib/ -Wl,$INSTALL_PATH/lib/*.a" --build=x86_64-w64-mingw32 --disable-programs
        make -j $MAKEJ
        make install-strip
        ;;
    *)
