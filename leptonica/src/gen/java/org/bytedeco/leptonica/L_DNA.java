...
@Name("L_Dna") @Properties(inherit = org.bytedeco.leptonica.presets.leptonica.class)
public class L_DNA extends Pointer {
    ...
    public native @Cast("l_atomic") int refcount(); public native L_DNA refcount(int setter);
