...
/** Array of points */
@Name("Pta") @Properties(inherit = org.bytedeco.leptonica.presets.leptonica.class)
public class PTA extends Pointer {
    ...
    public native @Cast("l_atomic") int refcount(); public native PTA refcount(int setter);
    /** arrays of floats                  */
