...
@Name("FPix") @Properties(inherit = org.bytedeco.leptonica.presets.leptonica.class)
public class FPIX extends AbstractFPIX {
    ...
    @Override public FPIX getPointer(long i) {
        return new FPIX((Pointer)this).offsetAddress(i);
    }
    ...
    public native @Cast("l_atomic") int refcount(); public native FPIX refcount(int setter);
