...
@Name("Sarray") @Properties(inherit = org.bytedeco.leptonica.presets.leptonica.class)
public class SARRAY extends Pointer {
    ...
    public native @Cast("l_atomic") int refcount(); public native SARRAY refcount(int setter);
    /** string array                        */
