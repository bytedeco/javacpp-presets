...
@Name("L_Bytea") @Properties(inherit = org.bytedeco.leptonica.presets.leptonica.class)
public class L_BYTEA extends Pointer {
    ...
    public native @Cast("l_atomic") int refcount(); public native L_BYTEA refcount(int setter);
    /** data array                               */
