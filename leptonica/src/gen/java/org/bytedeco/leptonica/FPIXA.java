...
/** Array of FPix */
@Name("FPixa") @Properties(inherit = org.bytedeco.leptonica.presets.leptonica.class)
public class FPIXA extends Pointer {
    ...
    public native @Cast("l_atomic") int refcount(); public native FPIXA refcount(int setter);
