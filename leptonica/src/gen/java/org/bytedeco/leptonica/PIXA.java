...
/** Array of pix */
@Name("Pixa") @Properties(inherit = org.bytedeco.leptonica.presets.leptonica.class)
public class PIXA extends Pointer {
    ...
    public native @Cast("l_atomic") int refcount(); public native PIXA refcount(int setter);
