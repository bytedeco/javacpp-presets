package org.bytedeco.javacpp.samples.qt;
...
import org.bytedeco.javacpp.QtCore.*;
import org.bytedeco.javacpp.QtGui.*;
import org.bytedeco.javacpp.QtWidgets.*;
import org.bytedeco.javacpp.QtWidgets.QSystemTrayIcon.ActivationReason;
...
public class SystemTrayIconExample {
  ...
  private static PointerPointer<BytePointer> argv;
  ...
  public static class Window extends QDialog {
    ...
    public Window() {
      ...
      ActivatedCallback iconActivatedCallback = new ActivatedCallback() {
        @Override
        public void activated(ActivationReason reason) {
...
//    @Override
    ...
    private void createMessageGroupBox() {
      ...
      typeComboBox.addItem(tr("None"), new QVariant(MessageIcon.NoIcon.value));
      typeComboBox.addItem(style().standardIcon(
          QStyle.SP_MessageBoxInformation), tr("Information"),
          new QVariant(MessageIcon.Information.value));
      typeComboBox.addItem(style().standardIcon(
          QStyle.SP_MessageBoxWarning), tr("Warning"),
          new QVariant(MessageIcon.Warning.value));
      typeComboBox.addItem(style().standardIcon(
          QStyle.SP_MessageBoxCritical), tr("Critical"),
          new QVariant(MessageIcon.Critical.value));
      typeComboBox.addItem(new QIcon(), tr("Custom icon"),
          new QVariant(MessageIcon.NoIcon.value));
