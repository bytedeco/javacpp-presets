...
@Name("std::vector<std::vector<std::pair<const char*,float> > >") public static class StringFloatPairVectorVector extends Pointer {
    static { Loader.load(); }
...
public static native TessResultRenderer TessPDFRendererCreate(@Cast("const char*") BytePointer outputbase, @Cast("const char*") BytePointer datadir,
                                                             @Cast("BOOL") boolean textonly, int jpg_quality);
