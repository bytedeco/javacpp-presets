...
public class CharWriteCallback extends Pointer {
    ...
    @Override public CharWriteCallback getPointer(long i) {
        return new CharWriteCallback((Pointer)this).position(position + i);
    }

  @Virtual(true) public native @Cast("bool") boolean Run(@Cast("FILE*") Pointer arg0, @ByRef @Cast("const char") byte arg1);
}
