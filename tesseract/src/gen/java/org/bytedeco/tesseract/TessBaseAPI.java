...
// #endif
   ...
   */
  public native float GetGradient();
...
*/
   ...
   * data structures.
   */
  public native @Cast("char*") BytePointer GetPAGEText(ETEXT_DESC monitor, int page_number);

  /**
   * Make an XML-formatted string with PAGE markup from the internal
   * data structures.
   */
  public native @Cast("char*") BytePointer GetPAGEText(int page_number);
