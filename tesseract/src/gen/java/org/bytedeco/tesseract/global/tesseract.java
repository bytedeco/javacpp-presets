...
public static final String TESSERACT_VERSION_STR = "5.5.3";
...
// Targeting ../TessPAGERenderer.java
...
public static native TessResultRenderer TessPAGERendererCreate(@Cast("const char*") BytePointer outputbase);
 ...
 *
 * \note Tesseract does NOT take ownership of the Pix structure. The caller
 ...
 * @return A newly allocated string, or NULL on error.
 */
public static native @Cast("char*") BytePointer TessBaseAPIGetPAGEText(TessBaseAPI handle, int page_number);
