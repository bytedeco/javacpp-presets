...
@Properties(value = {
    ...
    @Platform(value = {"linux-x86_64", "macosx-x86_64"}, extension = "-gpu", link = {"opencv_cudev@.3.4", "opencv_core@.3.4", "opencv_imgproc@.3.4"}),
    @Platform(value = "windows-x86_64",                  extension = "-gpu", link = {"opencv_cudev341", "opencv_core341", "opencv_imgproc341"})},
