...
@Properties(inherit = {opencv_calib3d.class, opencv_features2d.class, opencv_photo.class, opencv_video.class,
    ...
    @Platform(include = {
        ...
        "<opencv2/videostab/ring_buffer.hpp>", "<opencv2/videostab.hpp>"}, link = "opencv_videostab@.3.1", preload = "opencv_cuda@.3.1"),
    @Platform(value = "windows", link = "opencv_videostab310", preload = "opencv_cuda310")},
