...
import org.bytedeco.javacpp.opencv_imgcodecs.opencv_imgcodecs_presets;
 ...
 * @author Samuel Audet
 */
@Properties(inherit = opencv_imgcodecs_presets.class, value = {
    @Platform(include = {/*"<opencv2/videoio/videoio_c.h>",*/ "<opencv2/videoio.hpp>"}, link = "opencv_videoio@.4.0"),
...
public class opencv_videoio_presets implements InfoMapper {
