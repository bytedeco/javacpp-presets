...
package org.bytedeco.javacpp.opencv_cudaobjdetect;
...
@Properties(
    inherit = {
        ...
        opencv_cudawarping_presets.class,
    },
    value = {
        @Platform(
            include = "<opencv2/cudaobjdetect.hpp>",
            link = "opencv_cudaobjdetect@.4.0",
            preload = "opencv_cudalegacy@.4.0",
            extension = "-gpu"
        ),
        @Platform(
            value = "windows",
    ...
    global = "opencv_cudaobjdetect"
)
public class opencv_cudaobjdetect_presets implements InfoMapper {
