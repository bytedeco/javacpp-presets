...
import org.bytedeco.javacpp.opencv_dnn.opencv_dnn_presets;
 ...
 */
@Properties(inherit = {opencv_dnn_presets.class, opencv_features2d_presets.class, opencv_ml_presets.class}, value = {
...
public class opencv_text_presets implements InfoMapper {
