...
@Properties(inherit = {opencv_highgui_presets.class, opencv_features2d_presets.class}, value = {
    ...
    @Platform(value = "windows", link = "opencv_calib3d400")},
        target = "org.bytedeco.javacpp.opencv_calib3d",
        helper = "org.bytedeco.javacpp.opencv_calib3d.opencv_calib3d_helper",
        global = "opencv_calib3d"
)
public class opencv_calib3d_presets implements InfoMapper {
