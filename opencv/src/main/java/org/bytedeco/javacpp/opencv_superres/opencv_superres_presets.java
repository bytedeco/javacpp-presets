 ...
 * @author Samuel Audet
 */
@Properties(inherit = {opencv_objdetect_presets.class, opencv_optflow_presets.class}, value = {
    ...
    @Platform(value = "windows", link = "opencv_superres401",
        ...
        global = "opencv_superres"
)
public class opencv_superres_presets implements InfoMapper {
