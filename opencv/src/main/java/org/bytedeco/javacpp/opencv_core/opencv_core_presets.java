...
@Properties(value = {
    ...
    @Platform(value = "windows", define = "_WIN32_WINNT 0x0502", link =  {"opencv_core400", "opencv_imgproc400"}, preload = {
        ...
        "vcruntime140", "msvcp140", "concrt140", "vcomp140", "opencv_cudev400"}),
    ...
    @Platform(value = {"linux-x86_64", "macosx-x86_64", "windows-x86_64"}, extension = "-gpu")},
        target = "org.bytedeco.javacpp.opencv_core",
        helper = "org.bytedeco.javacpp.opencv_core.opencv_core_helper",
        global = "opencv_core"
)
public class opencv_core_presets implements LoadEnabled, InfoMapper {
    ...
    public void map(InfoMap infoMap) {
        infoMap.put(new Info("algorithm", "map", "opencv_adapters.h").skip())
               ...
               .put(new Info("IplConvKernel").base("org.bytedeco.javacpp.opencv_imgproc.AbstractIplConvKernel"))
               ...
               .put(new Info("CvHistogram").base("org.bytedeco.javacpp.opencv_imgproc.AbstractCvHistogram"))
