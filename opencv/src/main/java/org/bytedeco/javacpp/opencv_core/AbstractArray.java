...
public abstract class AbstractArray extends Pointer implements Indexable {
    ...
    /** @return {@link #arrayData()} wrapped in a {@link java.nio.Buffer} of appropriate type starting at given index */
    ...
    public CvSize cvSize() { return opencv_core.cvSize(arrayWidth(), arrayHeight()); }
