 ...
 * @author Samuel Audet
 */
@Properties(inherit = {opencv_calib3d_presets.class, opencv_features2d_presets.class}, value = {
    ...
    @Platform(value = "windows", link = "opencv_ximgproc400")},
        ...
        global = "opencv_ximgproc"
)
public class opencv_ximgproc_presets implements InfoMapper {
