...
@Properties(
    inherit = {opencv_calib3d_presets.class, opencv_flann_presets.class, opencv_highgui_presets.class, opencv_video_presets.class},
    value = {
        @Platform(
    ...
    global = "opencv_bgsegm"
)
public class opencv_bgsegm_presets implements InfoMapper {
