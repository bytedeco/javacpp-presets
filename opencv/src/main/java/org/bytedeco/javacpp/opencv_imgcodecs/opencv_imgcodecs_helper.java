...
package org.bytedeco.javacpp.opencv_imgcodecs;

// required by javac to resolve circular dependencies
import org.bytedeco.javacpp.opencv_core.*;

import static org.bytedeco.javacpp.opencv_core.opencv_core.*;
import static org.bytedeco.javacpp.opencv_imgcodecs.opencv_imgcodecs.IMREAD_COLOR;
import static org.bytedeco.javacpp.opencv_imgcodecs.opencv_imgcodecs.imwrite;
import static org.bytedeco.javacpp.opencv_imgproc.opencv_imgproc.CV_BGR2BGRA;
import static org.bytedeco.javacpp.opencv_imgproc.opencv_imgproc.CV_BGR2RGBA;
import static org.bytedeco.javacpp.opencv_imgproc.opencv_imgproc.cvCvtColor;


public class opencv_imgcodecs_helper extends opencv_imgcodecs_presets {
    ...
    public static IplImage cvLoadImage(String filename, int iscolor) {
        return new IplImage(cvClone(cvIplImage(opencv_imgcodecs.imread(filename, iscolor))));
    }
