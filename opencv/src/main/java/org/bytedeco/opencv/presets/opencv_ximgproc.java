...
@Properties(
    ...
    value = {
        @Platform(include = {"<opencv2/ximgproc.hpp>", "opencv2/ximgproc/edge_filter.hpp", "opencv2/ximgproc/disparity_filter.hpp",
            ...
            "opencv2/ximgproc/color_match.hpp", "opencv2/ximgproc/radon_transform.hpp", "opencv2/ximgproc/find_ellipses.hpp"}, link = "opencv_ximgproc@.411"),
        @Platform(value = "ios", preload = "libopencv_ximgproc"),
        @Platform(value = "windows", link = "opencv_ximgproc4110")},
