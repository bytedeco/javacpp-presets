...
@Properties(
    ...
    value = {
        @Platform(include = {"<opencv2/bioinspired.hpp>", "opencv2/bioinspired/bioinspired.hpp", "opencv2/bioinspired/retina.hpp",
            "opencv2/bioinspired/retinafasttonemapping.hpp", "opencv2/bioinspired/transientareassegmentationmodule.hpp"}, link = "opencv_bioinspired@.411"),
        @Platform(value = "ios", preload = "libopencv_bioinspired"),
        @Platform(value = "windows", link = "opencv_bioinspired4110")
    },
