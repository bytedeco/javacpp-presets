...
@Properties(
    ...
    value = {
        @Platform(include = {
            ...
            link = "opencv_stitching@.414", preload = {"opencv_cuda@.414", "opencv_cudaarithm@.414", "opencv_cudafilters@.414",
            "opencv_cudaimgproc@.414", "opencv_cudawarping@.414", "opencv_cudafeatures2d@.414", "opencv_cudalegacy@.414"}),
        @Platform(value = "ios", preload = "libopencv_stitching"),
        @Platform(value = "windows", link = "opencv_stitching4140", preload = {"opencv_cuda4140", "opencv_cudaarithm4140", "opencv_cudafilters4140",
            "opencv_cudaimgproc4140", "opencv_cudawarping4140", "opencv_cudafeatures2d4140", "opencv_cudalegacy4140"})},
