...
@Properties(
    ...
    value = {
        @Platform(include = {
            ...
            link = "opencv_stitching@.405", preload = {"opencv_cuda@.405", "opencv_cudaarithm@.405", "opencv_cudafilters@.405",
            "opencv_cudaimgproc@.405", "opencv_cudawarping@.405", "opencv_cudafeatures2d@.405", "opencv_cudalegacy@.405"}),
