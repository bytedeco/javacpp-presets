...
@Properties(
    ...
    value = {
        @Platform(include = {"<opencv2/xfeatures2d.hpp>", "<opencv2/xfeatures2d/nonfree.hpp>"}, link = "opencv_xfeatures2d@.408",
            preload = {"opencv_cuda@.408", "opencv_cudaarithm@.408"}),
        @Platform(value = "ios", preload = "libopencv_xfeatures2d"),
        @Platform(value = "windows", link = "opencv_xfeatures2d481",
            preload = {"opencv_cuda481", "opencv_cudaarithm481"})},
