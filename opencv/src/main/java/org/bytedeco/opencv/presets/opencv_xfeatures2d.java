...
@Properties(
    ...
    value = {
        @Platform(include = {"<opencv2/xfeatures2d.hpp>", "<opencv2/xfeatures2d/nonfree.hpp>"}, link = "opencv_xfeatures2d@.411",
            preload = {"opencv_cuda@.411", "opencv_cudaarithm@.411"}),
        @Platform(value = "ios", preload = "libopencv_xfeatures2d"),
        @Platform(value = "windows", link = "opencv_xfeatures2d4110",
            preload = {"opencv_cuda4110", "opencv_cudaarithm4110"})},
