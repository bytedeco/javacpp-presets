...
@Properties(
    ...
    value = {
        @Platform(include = {
            "<opencv2/signal.hpp>", "<opencv2/signal/signal_resample.hpp>"}, link = "opencv_signal@.410"),
        @Platform(value = "ios", preload = "libopencv_signal"),
        @Platform(value = "windows", link = "opencv_signal4100")},
