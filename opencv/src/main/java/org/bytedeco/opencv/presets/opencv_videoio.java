...
@Properties(
    ...
    value = {
        @Platform(include = {/*"<opencv2/videoio/videoio_c.h>",*/ "<opencv2/videoio.hpp>"}, link = "opencv_videoio@.413"),
        ...
        @Platform(value = "macosx", preload = "OrbbecSDK@.1.9"),
        @Platform(value = "windows", link = "opencv_videoio4130", preload = {"opencv_ffmpeg4130", "opencv_ffmpeg4130_64"})},
