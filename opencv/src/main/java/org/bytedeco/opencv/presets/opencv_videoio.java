...
@Properties(
    ...
    value = {
        @Platform(include = {/*"<opencv2/videoio/videoio_c.h>",*/ "<opencv2/videoio.hpp>"}, link = "opencv_videoio@.4.2"),
        ...
        @Platform(value = "windows", link = "opencv_videoio420", preload = {"opencv_ffmpeg420", "opencv_ffmpeg420_64"})},
