...
@Properties(
    ...
    value = {
        @Platform(include = {/*"<opencv2/videoio/videoio_c.h>",*/ "<opencv2/videoio.hpp>"}, link = "opencv_videoio@.412"),
        ...
        @Platform(value = "windows", link = "opencv_videoio4120", preload = {"opencv_ffmpeg4120", "opencv_ffmpeg4120_64"})},
