...
@Properties(
    ...
    value = {
        @Platform(include = {/*"<opencv2/videoio/videoio_c.h>",*/ "<opencv2/videoio.hpp>"}, link = "opencv_videoio@.4.5"),
        ...
        @Platform(value = "windows", link = "opencv_videoio452", preload = {"opencv_ffmpeg452", "opencv_ffmpeg452_64"})},
