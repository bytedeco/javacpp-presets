...
@Properties(
    ...
    value = {
        @Platform(include = {/*"<opencv2/videoio/videoio_c.h>",*/ "<opencv2/videoio.hpp>"}, link = "opencv_videoio@.414"),
        ...
        @Platform(value = "windows", link = "opencv_videoio4140", preload = {"opencv_ffmpeg4140", "opencv_ffmpeg4140_64"})},
