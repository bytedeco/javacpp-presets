...
@Properties(
    ...
    value = {
        @Platform(include = {/*"<opencv2/videoio/videoio_c.h>",*/ "<opencv2/videoio.hpp>"}, link = "opencv_videoio@.4.1"),
        ...
        @Platform(value = "windows", link = "opencv_videoio411", preload = {"opencv_ffmpeg411", "opencv_ffmpeg411_64"})},
