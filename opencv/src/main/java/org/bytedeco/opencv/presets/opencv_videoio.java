...
@Properties(
    ...
    value = {
        @Platform(include = {/*"<opencv2/videoio/videoio_c.h>",*/ "<opencv2/videoio.hpp>"}, link = "opencv_videoio@.405"),
        ...
        @Platform(value = "windows", link = "opencv_videoio455", preload = {"opencv_ffmpeg455", "opencv_ffmpeg455_64"})},
