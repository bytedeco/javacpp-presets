...
@Properties(
    ...
    value = {
        @Platform(
            ...
            link = "opencv_cudaimgproc@.413",
            extension = "-gpu"
        ),
        @Platform(
            value = "windows",
            link = "opencv_cudaimgproc4130",
            extension = "-gpu"
        )
    },
    target = "org.bytedeco.opencv.opencv_cudaimgproc",
    global = "org.bytedeco.opencv.global.opencv_cudaimgproc"
)
