...
@Properties(
    ...
    value = {
        @Platform(include = {
            ...
            "<opencv2/videostab/ring_buffer.hpp>", "<opencv2/videostab.hpp>"}, link = "opencv_videostab@.410",
            preload = {"opencv_cuda@.410", "opencv_cudaarithm@.410", "opencv_cudafilters@.410",
        ...
        @Platform(value = "windows", link = "opencv_videostab4100",
