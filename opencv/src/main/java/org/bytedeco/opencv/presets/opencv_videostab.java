...
@Properties(
    ...
    value = {
        @Platform(include = {
            ...
            "<opencv2/videostab/ring_buffer.hpp>", "<opencv2/videostab.hpp>"}, link = "opencv_videostab@.414",
            preload = {"opencv_cuda@.414", "opencv_cudaarithm@.414", "opencv_cudafilters@.414",
                "opencv_cudaimgproc@.414", "opencv_cudafeatures2d@.414", "opencv_cudalegacy@.414",
                "opencv_cudaoptflow@.414", "opencv_cudawarping@.414"}),
        @Platform(value = "ios", preload = "libopencv_videostab"),
        @Platform(value = "windows", link = "opencv_videostab4140",
            preload = {"opencv_cuda4140", "opencv_cudaarithm4140", "opencv_cudafilters4140",
                "opencv_cudaimgproc4140", "opencv_cudafeatures2d4140", "opencv_cudalegacy4140",
                "opencv_cudaoptflow4140", "opencv_cudawarping4140"})},
