...
@Properties(
    ...
    value = {
        @Platform(include = {
            ...
            "<opencv2/videostab/ring_buffer.hpp>", "<opencv2/videostab.hpp>"}, link = "opencv_videostab@.4.4",
            preload = {"opencv_cuda@.4.4", "opencv_cudaarithm@.4.4", "opencv_cudafilters@.4.4",
                "opencv_cudaimgproc@.4.4", "opencv_cudafeatures2d@.4.4", "opencv_cudalegacy@.4.4",
                "opencv_cudaoptflow@.4.4", "opencv_cudawarping@.4.4"}),
        @Platform(value = "ios", preload = "libopencv_videostab"),
        @Platform(value = "windows", link = "opencv_videostab440",
            preload = {"opencv_cuda440", "opencv_cudaarithm440", "opencv_cudafilters440",
                "opencv_cudaimgproc440", "opencv_cudafeatures2d440", "opencv_cudalegacy440",
                "opencv_cudaoptflow440", "opencv_cudawarping440"})},
