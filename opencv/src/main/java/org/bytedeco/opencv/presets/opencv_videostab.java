...
@Properties(
    ...
    value = {
        @Platform(include = {
            ...
            "<opencv2/videostab/ring_buffer.hpp>", "<opencv2/videostab.hpp>"}, link = "opencv_videostab@.4.5",
            preload = {"opencv_cuda@.4.5", "opencv_cudaarithm@.4.5", "opencv_cudafilters@.4.5",
        ...
        @Platform(value = "windows", link = "opencv_videostab450",
            preload = {"opencv_cuda450", "opencv_cudaarithm450", "opencv_cudafilters450",
                "opencv_cudaimgproc450", "opencv_cudafeatures2d450", "opencv_cudalegacy450",
                "opencv_cudaoptflow450", "opencv_cudawarping450"})},
