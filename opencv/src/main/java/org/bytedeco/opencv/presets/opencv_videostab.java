...
@Properties(
    ...
    value = {
        @Platform(include = {
            ...
            "<opencv2/videostab/ring_buffer.hpp>", "<opencv2/videostab.hpp>"}, link = "opencv_videostab@.413",
            preload = {"opencv_cuda@.413", "opencv_cudaarithm@.413", "opencv_cudafilters@.413",
        ...
        @Platform(value = "windows", link = "opencv_videostab4130",
            preload = {"opencv_cuda4130", "opencv_cudaarithm4130", "opencv_cudafilters4130",
