...
@Properties(
    ...
    value = {
        @Platform(include = {
            ...
            "<opencv2/videostab/ring_buffer.hpp>", "<opencv2/videostab.hpp>"}, link = "opencv_videostab@.412",
            preload = {"opencv_cuda@.412", "opencv_cudaarithm@.412", "opencv_cudafilters@.412",
        ...
        @Platform(value = "windows", link = "opencv_videostab4120",
            preload = {"opencv_cuda4120", "opencv_cudaarithm4120", "opencv_cudafilters4120",
