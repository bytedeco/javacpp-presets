...
@Properties(
    ...
    value = {
        @Platform(include = {
            ...
            "<opencv2/videostab/ring_buffer.hpp>", "<opencv2/videostab.hpp>"}, link = "opencv_videostab@.4.3",
            preload = {"opencv_cuda@.4.3", "opencv_cudaarithm@.4.3", "opencv_cudafilters@.4.3",
        ...
        @Platform(value = "windows", link = "opencv_videostab430",
            preload = {"opencv_cuda430", "opencv_cudaarithm430", "opencv_cudafilters430",
