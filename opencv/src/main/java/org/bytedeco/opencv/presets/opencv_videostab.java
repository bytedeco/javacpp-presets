...
@Properties(
    ...
    value = {
        @Platform(include = {
            ...
            "<opencv2/videostab/ring_buffer.hpp>", "<opencv2/videostab.hpp>"}, link = "opencv_videostab@.4.2",
            preload = {"opencv_cuda@.4.2", "opencv_cudaarithm@.4.2", "opencv_cudafilters@.4.2",
        ...
        @Platform(value = "windows", link = "opencv_videostab420",
            preload = {"opencv_cuda420", "opencv_cudaarithm420", "opencv_cudafilters420",
