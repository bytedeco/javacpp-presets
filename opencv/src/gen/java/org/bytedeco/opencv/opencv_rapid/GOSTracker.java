...
public class GOSTracker extends Tracker {
    static { Loader.load(); }
    ...
    public static native @Ptr OLSTracker create(@ByVal UMat pts3d, @ByVal UMat tris, int histBins/*=4*/, @Cast("uchar") byte sobelThesh/*=10*/);
    public static native @Ptr OLSTracker create(@ByVal UMat pts3d, @ByVal UMat tris);
    public static native @Ptr OLSTracker create(@ByVal GpuMat pts3d, @ByVal GpuMat tris, int histBins/*=4*/, @Cast("uchar") byte sobelThesh/*=10*/);
