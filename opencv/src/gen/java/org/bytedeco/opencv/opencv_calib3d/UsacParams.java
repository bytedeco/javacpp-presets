...
public class UsacParams extends Pointer {
 ...
 // in alphabetical order
    ...
    public native @Cast("cv::PolishingMethod") int final_polisher(); public native UsacParams final_polisher(int setter);
    public native int final_polisher_iterations(); public native UsacParams final_polisher_iterations(int setter);
}
