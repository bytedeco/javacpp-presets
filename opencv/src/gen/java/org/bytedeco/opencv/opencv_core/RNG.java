...
public class RNG extends Pointer {
    ...
    */
    public RNG(@Cast("uint64") long state) { super((Pointer)null); allocate(state); }
    private native void allocate(@Cast("uint64") long state);
    ...
    */
    ...
    public native @Cast("uint64") long state(); public native RNG state(long setter);
