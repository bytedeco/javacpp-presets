...
public class UMat extends Pointer {
    ...
    public static native @ByVal UMat diag(@Const @ByRef UMat d, @Cast("cv::UMatUsageFlags") int usageFlags);
    public static native @ByVal UMat diag(@Const @ByRef UMat d);  // OpenCV 5.0: remove abi compatibility overload
    ...
    public static native @ByVal UMat zeros(int rows, int cols, int type, @Cast("cv::UMatUsageFlags") int usageFlags);
    public static native @ByVal UMat zeros(@ByVal Size size, int type, @Cast("cv::UMatUsageFlags") int usageFlags);
    public static native @ByVal UMat zeros(int ndims, @Const IntPointer sz, int type, @Cast("cv::UMatUsageFlags") int usageFlags);
    ...
    public static native @ByVal UMat zeros(int rows, int cols, int type);  // OpenCV 5.0: remove abi compatibility overload
    public static native @ByVal UMat zeros(@ByVal Size size, int type);  // OpenCV 5.0: remove abi compatibility overload
      // OpenCV 5.0: remove abi compatibility overload
    public static native @ByVal UMat ones(int rows, int cols, int type, @Cast("cv::UMatUsageFlags") int usageFlags);
    public static native @ByVal UMat ones(@ByVal Size size, int type, @Cast("cv::UMatUsageFlags") int usageFlags);
    public static native @ByVal UMat ones(int ndims, @Const IntPointer sz, int type, @Cast("cv::UMatUsageFlags") int usageFlags);
    ...
    public static native @ByVal UMat ones(int rows, int cols, int type);  // OpenCV 5.0: remove abi compatibility overload
    public static native @ByVal UMat ones(@ByVal Size size, int type);  // OpenCV 5.0: remove abi compatibility overload
      // OpenCV 5.0: remove abi compatibility overload
    public static native @ByVal UMat eye(int rows, int cols, int type, @Cast("cv::UMatUsageFlags") int usageFlags);
    public static native @ByVal UMat eye(@ByVal Size size, int type, @Cast("cv::UMatUsageFlags") int usageFlags);
    public static native @ByVal UMat eye(int rows, int cols, int type);  // OpenCV 5.0: remove abi compatibility overload
    public static native @ByVal UMat eye(@ByVal Size size, int type);  // OpenCV 5.0: remove abi compatibility overload
