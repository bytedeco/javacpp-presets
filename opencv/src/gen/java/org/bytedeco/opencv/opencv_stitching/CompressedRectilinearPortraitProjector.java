...
public class CompressedRectilinearPortraitProjector extends ProjectorBase {
    ...
    @Override public CompressedRectilinearPortraitProjector getPointer(long i) {
        return new CompressedRectilinearPortraitProjector(this).position(position + i);
    }

    public native float a(); public native CompressedRectilinearPortraitProjector a(float setter);
    public native float b(); public native CompressedRectilinearPortraitProjector b(float setter);
