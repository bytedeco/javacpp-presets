...
public class MercatorProjector extends ProjectorBase {
    static { Loader.load(); }
    ...
    @Override public MercatorProjector getPointer(long i) {
        return new MercatorProjector((Pointer)this).offsetAddress(i);
    }
