...
public class ConvolutionLayer extends BaseConvolutionLayer {
        ...
        public native @Cast("bool") boolean isConv2D(); public native ConvolutionLayer isConv2D(boolean setter); // Should be deleted after fastconv branch support Conv1D and Conv3D.
