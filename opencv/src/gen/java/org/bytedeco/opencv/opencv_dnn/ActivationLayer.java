...
public class ActivationLayer extends Layer {
        ...
        public native void forwardSlice(@Const int[] src, @Const int[] lut, int[] dst, int len,
                                          @Cast("size_t") long outPlaneSize, int cn0, int cn1);
        public native void forwardSlice(@Const BytePointer src, @Const BytePointer lut, BytePointer dst, int len,
                                          @Cast("size_t") long outPlaneSize, int cn0, int cn1);
        public native void forwardSlice(@Const ByteBuffer src, @Const ByteBuffer lut, ByteBuffer dst, int len,
                                          @Cast("size_t") long outPlaneSize, int cn0, int cn1);
        public native void forwardSlice(@Const byte[] src, @Const byte[] lut, byte[] dst, int len,
                                          @Cast("size_t") long outPlaneSize, int cn0, int cn1);
    }
