 ...
 */
@Namespace("cv::rapid") public static native void drawCorrespondencies(@ByVal Mat bundle, @ByVal Mat srcLocations,
                                       @ByVal Mat newLocations, @ByVal(nullValue = "cv::InputArray(cv::noArray())") Mat colors);
@Namespace("cv::rapid") public static native void drawCorrespondencies(@ByVal Mat bundle, @ByVal Mat srcLocations,
                                       @ByVal Mat newLocations);
@Namespace("cv::rapid") public static native void drawCorrespondencies(@ByVal UMat bundle, @ByVal UMat srcLocations,
                                       @ByVal UMat newLocations, @ByVal(nullValue = "cv::InputArray(cv::noArray())") UMat colors);
@Namespace("cv::rapid") public static native void drawCorrespondencies(@ByVal UMat bundle, @ByVal UMat srcLocations,
                                       @ByVal UMat newLocations);
@Namespace("cv::rapid") public static native void drawCorrespondencies(@ByVal GpuMat bundle, @ByVal GpuMat srcLocations,
                                       @ByVal GpuMat newLocations, @ByVal(nullValue = "cv::InputArray(cv::noArray())") GpuMat colors);
@Namespace("cv::rapid") public static native void drawCorrespondencies(@ByVal GpuMat bundle, @ByVal GpuMat srcLocations,
                                       @ByVal GpuMat newLocations);
/**
 ...
 */
@Namespace("cv::rapid") public static native void findCorrespondencies(@ByVal Mat bundle, @ByVal Mat srcLocations, @ByVal Mat newLocations,
                                       @ByVal(nullValue = "cv::OutputArray(cv::noArray())") Mat response);
@Namespace("cv::rapid") public static native void findCorrespondencies(@ByVal Mat bundle, @ByVal Mat srcLocations, @ByVal Mat newLocations);
@Namespace("cv::rapid") public static native void findCorrespondencies(@ByVal UMat bundle, @ByVal UMat srcLocations, @ByVal UMat newLocations,
                                       @ByVal(nullValue = "cv::OutputArray(cv::noArray())") UMat response);
@Namespace("cv::rapid") public static native void findCorrespondencies(@ByVal UMat bundle, @ByVal UMat srcLocations, @ByVal UMat newLocations);
@Namespace("cv::rapid") public static native void findCorrespondencies(@ByVal GpuMat bundle, @ByVal GpuMat srcLocations, @ByVal GpuMat newLocations,
 ...
 */
@Namespace("cv::rapid") public static native void filterCorrespondencies(@ByVal Mat pts2d, @ByVal Mat pts3d, @ByVal Mat mask);
@Namespace("cv::rapid") public static native void filterCorrespondencies(@ByVal UMat pts2d, @ByVal UMat pts3d, @ByVal UMat mask);
@Namespace("cv::rapid") public static native void filterCorrespondencies(@ByVal GpuMat pts2d, @ByVal GpuMat pts3d, @ByVal GpuMat mask);
