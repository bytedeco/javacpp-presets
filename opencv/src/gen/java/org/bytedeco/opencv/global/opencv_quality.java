...
// convert mse to psnr
@Namespace("cv::quality::quality_utils") public static native double mse_to_psnr(double mse, double max_pixel_value);

// convert scalar of mses to psnrs
@Namespace("cv::quality::quality_utils") public static native @ByVal Scalar mse_to_psnr(@ByVal Scalar mse, double max_pixel_value);
