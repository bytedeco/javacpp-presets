...
public class FormatInfo extends Pointer {
    ...
    public native @Cast("cv::cudacodec::SurfaceFormat") int surfaceFormat(); public native FormatInfo surfaceFormat(int setter);
    ...
    public native @Cast("cv::cudacodec::ColorSpaceStandard") int colorSpaceStandard(); public native FormatInfo colorSpaceStandard(int setter);
