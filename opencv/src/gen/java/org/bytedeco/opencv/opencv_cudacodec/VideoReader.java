...
public class VideoReader extends Pointer {
    ...
    */
     ...
     */
    public native @Cast("bool") boolean set(@Cast("const cv::cudacodec::ColorFormat") int colorFormat, @Cast("const cv::cudacodec::BitDepth") int bitDepth/*=cv::cudacodec::BitDepth::UNCHANGED*/, @Cast("const bool") boolean planar/*=false*/);
