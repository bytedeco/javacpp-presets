...
public class LUCID extends Feature2D {
    ...
    public native void setLucidKernel(int lucid_kernel);
    public native int getLucidKernel();

    public native void setBlurKernel(int blur_kernel);
    public native int getBlurKernel();
