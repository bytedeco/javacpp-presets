...
public class VideoCapture extends Pointer {
    ...
    */
    ...
    See cv::VideoCaptureProperties
    */
    public VideoCapture(@Ptr IStreamReader source, int apiPreference, @StdVector @Cast({"int*", "std::vector<int>&"}) IntPointer params) { super((Pointer)null); allocate(source, apiPreference, params); }
    private native void allocate(@Ptr IStreamReader source, int apiPreference, @StdVector @Cast({"int*", "std::vector<int>&"}) IntPointer params);
    public VideoCapture(@Ptr IStreamReader source, int apiPreference, @StdVector @Cast({"int*", "std::vector<int>&"}) IntBuffer params) { super((Pointer)null); allocate(source, apiPreference, params); }
    private native void allocate(@Ptr IStreamReader source, int apiPreference, @StdVector @Cast({"int*", "std::vector<int>&"}) IntBuffer params);
    public VideoCapture(@Ptr IStreamReader source, int apiPreference, @StdVector @Cast({"int*", "std::vector<int>&"}) int[] params) { super((Pointer)null); allocate(source, apiPreference, params); }
    private native void allocate(@Ptr IStreamReader source, int apiPreference, @StdVector @Cast({"int*", "std::vector<int>&"}) int[] params);
    ...
    */
    ...
    The method first calls VideoCapture::release to close the already opened file or camera.
     */
    public native @Cast("bool") boolean open(@Ptr IStreamReader source, int apiPreference, @StdVector @Cast({"int*", "std::vector<int>&"}) IntPointer params);
    public native @Cast("bool") boolean open(@Ptr IStreamReader source, int apiPreference, @StdVector @Cast({"int*", "std::vector<int>&"}) IntBuffer params);
    public native @Cast("bool") boolean open(@Ptr IStreamReader source, int apiPreference, @StdVector @Cast({"int*", "std::vector<int>&"}) int[] params);
