...
public class Dictionary extends Pointer {
     ...
     * Returns reference to the marker id in the dictionary (if any) and its rotation.
     */
    public native @Cast("bool") boolean identify(@Const @ByRef Mat onlyCellPixelRatio, @ByRef IntPointer idx, @ByRef IntPointer rotation, double maxCorrectionRate, float validBitIdThreshold);
    public native @Cast("bool") boolean identify(@Const @ByRef Mat onlyCellPixelRatio, @ByRef IntBuffer idx, @ByRef IntBuffer rotation, double maxCorrectionRate, float validBitIdThreshold);
    public native @Cast("bool") boolean identify(@Const @ByRef Mat onlyCellPixelRatio, @ByRef int[] idx, @ByRef int[] rotation, double maxCorrectionRate, float validBitIdThreshold);

    /** \brief Returns Hamming distance of the input bits to the specific id.
     *
     * If {@code allRotations} flag is set, the four possible marker rotations are considered
     */
     ...
     * cell pixel ratio and the dictionary bit value is greater than {@code validBitIdThreshold}.
     * If {@code allRotations} is set, the four possible marker rotations are considered.
     *
     ...
     */
    public native int getDistanceToId(@ByVal Mat onlyCellPixelRatio, int id, @Cast("bool") boolean allRotations, float validBitIdThreshold);
    public native int getDistanceToId(@ByVal UMat onlyCellPixelRatio, int id, @Cast("bool") boolean allRotations, float validBitIdThreshold);
    public native int getDistanceToId(@ByVal GpuMat onlyCellPixelRatio, int id, @Cast("bool") boolean allRotations, float validBitIdThreshold);
    ...
    /** \brief Get ground truth bits float
      */
     public native @ByVal Mat getMarkerBits(int markerId, int rotationId/*=0*/);
     public native @ByVal Mat getMarkerBits(int markerId);
}
