...
@Name("cv::detail::PaniniWarper") @Properties(inherit = org.bytedeco.javacpp.opencv_stitching.opencv_stitching_presets.class)
public class DetailPaniniWarper extends RotationWarper {
    static { Loader.load(); }
