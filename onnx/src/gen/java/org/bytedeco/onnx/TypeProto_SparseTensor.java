...
public class TypeProto_SparseTensor extends MessageLite {
    ...
    @Override public TypeProto_SparseTensor getPointer(long i) {
        return new TypeProto_SparseTensor((Pointer)this).offsetAddress(i);
    }
  ...
  public native void UnsafeArenaSwap(TypeProto_SparseTensor other);

  // implements Message ----------------------------------------------

  public native TypeProto_SparseTensor New(Arena arena/*=nullptr*/);
