...
public class FunctionProto extends MessageLite {
  ...
  public native @Cast("bool") boolean has_overload();
  public native void clear_overload();
  public native @StdString BytePointer overload();
  public native @StdString @Cast({"char*", "std::string*"}) BytePointer mutable_overload();
  public native @StdString @Cast({"char*", "std::string*"}) BytePointer release_overload();
  public native void set_allocated_overload(@StdString @Cast({"char*", "std::string*"}) BytePointer overload);
}
