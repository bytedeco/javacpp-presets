...
public class TypeProto_Sequence extends MessageLite {
  ...
  public native void UnsafeArenaSwap(TypeProto_Sequence other);

  // implements Message ----------------------------------------------

  public native TypeProto_Sequence New(Arena arena/*=nullptr*/);
  ...
  public native void unsafe_arena_set_allocated_elem_type(
        TypeProto elem_type);
