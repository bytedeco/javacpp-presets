...
public class OpSchemaRegistry extends ISchemaRegistry {
  ...
  public static class OpSchemaRegisterOnce extends Pointer {
    ...
    public OpSchemaRegisterOnce(
            ...
            @Cast("bool") boolean fail_duplicate_schema/*=true*/) { super((Pointer)null); allocate(op_schema, opset_version_to_load, fail_duplicate_schema); }
    private native void allocate(
            @ByVal OpSchema op_schema,
            int opset_version_to_load/*=0*/,
            @Cast("bool") boolean fail_duplicate_schema/*=true*/);
    public OpSchemaRegisterOnce(
            @ByVal OpSchema op_schema) { super((Pointer)null); allocate(op_schema); }
    private native void allocate(
            @ByVal OpSchema op_schema);
  ...
  public static native @ByVal OpSchemaVector get_all_schemas_with_history();

  public static native @ByVal OpSchemaVector get_all_schemas();
}
