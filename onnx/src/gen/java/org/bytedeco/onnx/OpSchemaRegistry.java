...
public class OpSchemaRegistry extends ISchemaRegistry {
  ...
  @NoOffset public static class DomainToVersionRange extends Pointer {
    ...
    public native void UpdateDomainToVersion(@StdString BytePointer domain, int min_version, int max_version, int last_release_version/*=-1*/);
    public native void UpdateDomainToVersion(@StdString BytePointer domain, int min_version, int max_version);
    public native void UpdateDomainToVersion(@StdString String domain, int min_version, int max_version, int last_release_version/*=-1*/);
  ...
  public static class OpSchemaRegisterOnce extends Pointer {
    ...
    public OpSchemaRegisterOnce(@ByVal OpSchema op_schema, int opset_version_to_load/*=0*/, @Cast("bool") boolean fail_duplicate_schema/*=true*/) { super((Pointer)null); allocate(op_schema, opset_version_to_load, fail_duplicate_schema); }
    private native void allocate(@ByVal OpSchema op_schema, int opset_version_to_load/*=0*/, @Cast("bool") boolean fail_duplicate_schema/*=true*/);
    public OpSchemaRegisterOnce(@ByVal OpSchema op_schema) { super((Pointer)null); allocate(op_schema); }
    private native void allocate(@ByVal OpSchema op_schema);
    public static native void OpSchemaRegisterNoExcept(@ByRef(true) OpSchema op_schema, int opset_version_to_load/*=0*/, @Cast("bool") boolean fail_duplicate_schema/*=true*/);
    public static native void OpSchemaRegisterNoExcept(@ByRef(true) OpSchema op_schema);
    public static native void OpSchemaRegisterImpl(@ByRef(true) OpSchema op_schema, int opset_version_to_load/*=0*/, @Cast("bool") boolean fail_duplicate_schema/*=true*/);
    public static native void OpSchemaRegisterImpl(@ByRef(true) OpSchema op_schema);
  }

  public static native void OpSchemaDeregister(@StdString BytePointer op_type, int version, @StdString BytePointer domain/*=ONNX_DOMAIN*/);
  public static native void OpSchemaDeregister(@StdString BytePointer op_type, int version);
  public static native void OpSchemaDeregister(@StdString String op_type, int version, @StdString String domain/*=ONNX_DOMAIN*/);
  public static native void OpSchemaDeregister(@StdString String op_type, int version);
