...
public class UnknownFieldSet extends Pointer {
    ...
    @Override public UnknownFieldSet getPointer(long i) {
        return new UnknownFieldSet((Pointer)this).offsetAddress(i);
    }
  ...
  public static native void MergeToInternalMetadata(@Const @ByRef UnknownFieldSet other,
  ...
  public native void AddVarint(int number, @Cast("uint64_t") long value);
  public native void AddFixed32(int number, @Cast("uint32_t") int value);
  public native void AddFixed64(int number, @Cast("uint64_t") long value);
  ...
  public static native @Const @ByRef UnknownFieldSet default_instance();
}
