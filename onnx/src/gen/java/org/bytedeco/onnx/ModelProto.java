...
public class ModelProto extends MessageLite {
  ...
  public native void UnsafeArenaSwap(ModelProto other);

  // implements Message ----------------------------------------------

  public native ModelProto New(Arena arena/*=nullptr*/);
  ...
  public native int configuration_size();
  public native void clear_configuration();
  public native DeviceConfigurationProto mutable_configuration(int index);
  public native @Const @ByRef DeviceConfigurationProto configuration(int index);
  public native DeviceConfigurationProto add_configuration();
  ...
  public native void unsafe_arena_set_allocated_graph(
        GraphProto graph);
  public native GraphProto unsafe_arena_release_graph();
  ...
  public native @Cast("int64_t") long model_version();
  public native void set_model_version(@Cast("int64_t") long value);
}
