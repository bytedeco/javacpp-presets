...
public class DataPropagationContextImpl extends DataPropagationContext {
  ...
  public DataPropagationContextImpl(
        ...
        @Cast("onnx::shape_inference::DataValueMap*") @ByRef StringTensorShapeProtoMap generatedShapeData) { super((Pointer)null); allocate(n, valueTypesByName, inputDataByName, generatedShapeData); }
  private native void allocate(
        @ByRef NodeProto n,
        @Const @ByRef StringTypeProtoMap valueTypesByName,
        @Const @ByRef StringTensorProtoMap inputDataByName,
        @Cast("onnx::shape_inference::DataValueMap*") @ByRef StringTensorShapeProtoMap generatedShapeData);
  ...
  public native @Cast("onnx::shape_inference::DataValueMap*") @ByRef StringTensorShapeProtoMap generatedShapeData_(); public native DataPropagationContextImpl generatedShapeData_(StringTensorShapeProtoMap setter);
