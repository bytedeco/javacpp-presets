...
public class Status extends Pointer {
  ...
  public Status(@Cast("onnx::Common::StatusCategory") int category, @Cast("onnx::Common::StatusCode") int code, @StdString BytePointer msg) { super((Pointer)null); allocate(category, code, msg); }
  private native void allocate(@Cast("onnx::Common::StatusCategory") int category, @Cast("onnx::Common::StatusCode") int code, @StdString BytePointer msg);
  public Status(@Cast("onnx::Common::StatusCategory") int category, @Cast("onnx::Common::StatusCode") int code, @StdString String msg) { super((Pointer)null); allocate(category, code, msg); }
  private native void allocate(@Cast("onnx::Common::StatusCategory") int category, @Cast("onnx::Common::StatusCode") int code, @StdString String msg);

  public Status(@Cast("onnx::Common::StatusCategory") int category, @Cast("onnx::Common::StatusCode") int code) { super((Pointer)null); allocate(category, code); }
  private native void allocate(@Cast("onnx::Common::StatusCategory") int category, @Cast("onnx::Common::StatusCode") int code);
  ...
  public native @Cast("onnx::Common::StatusCode") @NoException(true) int Code();
