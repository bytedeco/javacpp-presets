...
public class FunctionBodyHelper extends Pointer {
  ...
  @NoOffset public static class AttributeProtoWrapper extends Pointer {
    ...
    public AttributeProtoWrapper(@ByVal AttributeProto attr_prot) { super((Pointer)null); allocate(attr_prot); }
    private native void allocate(@ByVal AttributeProto attr_prot);
  }
