...
public class Arena extends Pointer {
  ...
  public Arena(@Cast("char*") BytePointer initial_block, @Cast("size_t") long initial_block_size) { super((Pointer)null); allocate(initial_block, initial_block_size); }
  private native void allocate(@Cast("char*") BytePointer initial_block, @Cast("size_t") long initial_block_size);
  public Arena(@Cast("char*") ByteBuffer initial_block, @Cast("size_t") long initial_block_size) { super((Pointer)null); allocate(initial_block, initial_block_size); }
  private native void allocate(@Cast("char*") ByteBuffer initial_block, @Cast("size_t") long initial_block_size);
  public Arena(@Cast("char*") byte[] initial_block, @Cast("size_t") long initial_block_size) { super((Pointer)null); allocate(initial_block, initial_block_size); }
  private native void allocate(@Cast("char*") byte[] initial_block, @Cast("size_t") long initial_block_size);
  ...
  public native void Init(@Const @ByRef ArenaOptions arg0);
  ...
  public native Pointer AllocateAligned(@Cast("size_t") long size, @Cast("size_t") long align/*=8*/);
  public native Pointer AllocateAligned(@Cast("size_t") long size);
  ...
  public native @Cast("uint64_t") long SpaceAllocated();
  // Returns the total space used by the arena. Similar to SpaceAllocated but
  // does not include free space and block overhead. The total space returned
  // may not include space used by other threads executing concurrently with
  // the call to this method.
  public native @Cast("uint64_t") long SpaceUsed();
  ...
  public native @Cast("uint64_t") long Reset();
  ...
  public static native Arena InternalCreateMessageOwnedArena();

  // Checks whether this arena is message-owned.  For internal use only.
  public native @Cast("bool") boolean InternalIsMessageOwnedArena();
