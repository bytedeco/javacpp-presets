...
public class NodeProto extends MessageLite {
  ...
  public native int device_configurations_size();
  public native void clear_device_configurations();
  public native NodeDeviceConfigurationProto mutable_device_configurations(int index);
  public native @Const @ByRef NodeDeviceConfigurationProto device_configurations(int index);
  public native NodeDeviceConfigurationProto add_device_configurations();
