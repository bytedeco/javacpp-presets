...
public class Value extends Pointer {
  ...
  public Value(@ByRef(true) Value arg0) { super((Pointer)null); allocate(arg0); }
  private native void allocate(@ByRef(true) Value arg0);
  public native @ByRef @Name("operator =") Value put(@ByRef(true) Value arg0);
  ...
  public native Value setUniqueName(@StdString BytePointer name, @Cast("bool") boolean update_related_names/*=true*/);
  public native Value setUniqueName(@StdString BytePointer name);
  public native Value setUniqueName(@StdString String name, @Cast("bool") boolean update_related_names/*=true*/);
  ...
  public native Value copyMetadata(@Const Value from);

  public native @UniquePtr TypeProto type();
}
