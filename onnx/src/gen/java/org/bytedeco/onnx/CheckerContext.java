...
public class CheckerContext extends Pointer {
    ...
    @Override public CheckerContext getPointer(long i) {
        return new CheckerContext((Pointer)this).offsetAddress(i);
    }
  ...
  public native @Cast("bool") boolean skip_opset_compatibility_check();

  public native void set_skip_opset_compatibility_check(@Cast("bool") boolean value);

  public native @Cast("bool") boolean check_custom_domain();

  public native void set_check_custom_domain(@Cast("bool") boolean value);
