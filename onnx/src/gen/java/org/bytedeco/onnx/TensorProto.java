...
public class TensorProto extends MessageLite {
  ...
  public native TensorProto New(Arena arena/*=nullptr*/);
  ...
  @MemberGetter public static native @Cast("const onnx::TensorProto::DataType") int FLOAT8E4M3FN();
  public static final int FLOAT8E4M3FN = FLOAT8E4M3FN();
  @MemberGetter public static native @Cast("const onnx::TensorProto::DataType") int FLOAT8E4M3FNUZ();
  public static final int FLOAT8E4M3FNUZ = FLOAT8E4M3FNUZ();
  @MemberGetter public static native @Cast("const onnx::TensorProto::DataType") int FLOAT8E5M2();
  public static final int FLOAT8E5M2 = FLOAT8E5M2();
  @MemberGetter public static native @Cast("const onnx::TensorProto::DataType") int FLOAT8E5M2FNUZ();
  public static final int FLOAT8E5M2FNUZ = FLOAT8E5M2FNUZ();
  @MemberGetter public static native @Cast("const onnx::TensorProto::DataType") int UINT4();
  public static final int UINT4 = UINT4();
  @MemberGetter public static native @Cast("const onnx::TensorProto::DataType") int INT4();
  public static final int INT4 = INT4();
  @MemberGetter public static native @Cast("const onnx::TensorProto::DataType") int FLOAT4E2M1();
  ...
  public native int int32_data(int index);
  public native void set_int32_data(int index, int value);
  public native void add_int32_data(int value);
  ...
  public native @Cast("int64_t") long int64_data(int index);
  public native void set_int64_data(int index, @Cast("int64_t") long value);
  public native void add_int64_data(@Cast("int64_t") long value);
  ...
  public native @Cast("uint64_t") long uint64_data(int index);
  public native void set_uint64_data(int index, @Cast("uint64_t") long value);
  public native void add_uint64_data(@Cast("uint64_t") long value);
  ...
  public native void unsafe_arena_set_allocated_segment(
        TensorProto_Segment segment);
  public native TensorProto_Segment unsafe_arena_release_segment();
