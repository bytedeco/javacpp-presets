...
public class TypeProto extends MessageLite {
  ...
  public native void UnsafeArenaSwap(TypeProto other);

  // implements Message ----------------------------------------------

  public native TypeProto New(Arena arena/*=nullptr*/);
  ...
  public native void unsafe_arena_set_allocated_tensor_type(
        TypeProto_Tensor tensor_type);
  public native TypeProto_Tensor unsafe_arena_release_tensor_type();
  ...
  public native void unsafe_arena_set_allocated_sequence_type(
        TypeProto_Sequence sequence_type);
  public native TypeProto_Sequence unsafe_arena_release_sequence_type();
  ...
  public native void unsafe_arena_set_allocated_map_type(
        TypeProto_Map map_type);
  public native TypeProto_Map unsafe_arena_release_map_type();
  ...
  public native void unsafe_arena_set_allocated_optional_type(
        TypeProto_Optional optional_type);
  public native TypeProto_Optional unsafe_arena_release_optional_type();
  ...
  public native void unsafe_arena_set_allocated_sparse_tensor_type(
        TypeProto_SparseTensor sparse_tensor_type);
  public native TypeProto_SparseTensor unsafe_arena_release_sparse_tensor_type();
  ...
  public native void unsafe_arena_set_allocated_opaque_type(
        TypeProto_Opaque opaque_type);
  public native TypeProto_Opaque unsafe_arena_release_opaque_type();
