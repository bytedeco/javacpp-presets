...
@Name("std::map<int,chilitags::Quad>") public static class TagCornerMap extends Pointer {
    ...
    @Index(function = "at") public native @ByRef @Cast("chilitags::Quad*") FloatPointer get(int i);
...
@Name("std::map<std::string,chilitags::Chilitags3D_<float>::TransformMatrix>") public static class TagPoseMap extends Pointer {
    ...
    @Index(function = "at") public native @ByRef @Cast("chilitags::Chilitags3D_<float>::TransformMatrix*") FloatPointer get(@StdString BytePointer i);
...
@Name("std::map<std::string,chilitags::Chilitags3D_<double>::TransformMatrix>") public static class TagPoseMapd extends Pointer {
    ...
    @Index(function = "at") public native @ByRef @Cast("chilitags::Chilitags3D_<double>::TransformMatrix*") DoublePointer get(@StdString BytePointer i);
